...
class SmartPalletCreateFormBody extends Component {
  state = {
  ...
  componentDidMount() {
    ...
    const formValue = SmartPalletBase.unpackObjectToFormValues(initValue)
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.location} {...formItemLayout}>
                  {getFieldDecorator('location', {
                    ...
                    <SmallTextInput minLength={7} maxLength={104} size="large"  placeholder={fieldLabels.location} />
                  )}
                </Form.Item>
              </Col>
              ...
              <Col lg={24} md={24} sm={24} >
                <Form.Item label={fieldLabels.warehouse} {...formItemLayout}>
                  ...
                  <CandidateList
                    ...
                    requestFunction={SmartPalletService.queryCandidates}  />
...
}))(Form.create()(SmartPalletCreateFormBody))
