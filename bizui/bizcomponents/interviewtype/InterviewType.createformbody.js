...
class InterviewTypeCreateFormBody extends Component {
  state = {
  ...
  componentDidMount() {
    ...
    const formValue = InterviewTypeBase.unpackObjectToFormValues(initValue)
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.code} {...formItemLayout}>
                  {getFieldDecorator('code', {
                    ...
                    <SmallTextInput minLength={3} maxLength={32} size="large"  placeholder={fieldLabels.code} />
                  )}
                </Form.Item>
              </Col>
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.detailDescription} {...formItemLayout}>
                  {getFieldDecorator('detailDescription', {
                    ...
                    <SmallTextInput minLength={16} maxLength={244} size="large"  placeholder={fieldLabels.detailDescription} />
                  )}
                </Form.Item>
              </Col>
              ...
              <Col lg={24} md={24} sm={24} style={{"display":"none"}}>
                <Form.Item label={fieldLabels.company} {...formItemLayout}>
                  ...
                  <CandidateList
		                 ...
		                 ownerId={owner.id}
		                 scenarioCode={"assign"}
		                 listType={"interview_type"}
		                 targetType={"retail_store_country_center"}

                    requestFunction={InterviewTypeService.queryCandidates}  />
...
}))(Form.create()(InterviewTypeCreateFormBody))
