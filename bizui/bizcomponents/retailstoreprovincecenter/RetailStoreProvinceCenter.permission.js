...
<Description term="更新于">{ moment(retailStoreProvinceCenter.lastUpdateTime).format('YYYY-MM-DD')}</Description> 
...
class RetailStoreProvinceCenterPermission extends Component {
  ...
  render() {
    ...
    const  returnURL = `/retailStoreProvinceCenter/${id}/workbench`
