...
import styles from './ShippingSpace.updateform.less'
...
class ShippingSpaceUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const shippingSpaceId = values.id

        const parameters = { ...values, shippingSpaceId, }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateShippingSpace`,
          payload: {
            id: owner.id,
            type: 'shippingSpace',
            parameters,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextShippingSpaceUpdateRow`,
        payload: {
          id: owner.id,
          type: 'shippingSpace',
          selectedRows,
...
}))(Form.create()(ShippingSpaceUpdateForm))
