...
const internalSummaryOf = (item, targetComponents)=>{
	...
	return GlobalComponents.WechatWorkappIdentityBase.renderItemOfList(item, targetComponents)

}



class WechatWorkappIdentityProfile extends Component {
  ...
  render() {
    ...
    const  returnURL = `/wechatWorkappIdentity/${id}/dashboard`
...
}))(Form.create()(WechatWorkappIdentityProfile))
