...
class AccountingPeriodCreateFormBody extends Component {
  ...
  componentDidMount() {
    ...
    const formValue = AccountingPeriodBase.unpackObjectToFormValues(initValue)
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.name} {...formItemLayout}>
                  {getFieldDecorator('name', {
                    ...
                    <SmallTextInput minLength={3} maxLength={32} size="large"  placeholder={fieldLabels.name} />
                  )}
                </Form.Item>
              </Col>
