...
class EmployeeEducationCreateFormBody extends Component {
  state = {
  ...
  componentDidMount() {
    ...
    const formValue = EmployeeEducationBase.unpackObjectToFormValues(initValue)
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.type} {...formItemLayout}>
                  {getFieldDecorator('type', {
                    ...
                    <SmallTextInput minLength={1} maxLength={16} size="large"  placeholder={fieldLabels.type} />
                  )}
                </Form.Item>
              </Col>
              ...
              <Col lg={24} md={24} sm={24} >
                <Form.Item label={fieldLabels.employee} {...formItemLayout}>
                  ...
                  <CandidateList
                    ...
                    requestFunction={EmployeeEducationService.queryCandidates}  />
...
}))(Form.create()(EmployeeEducationCreateFormBody))
