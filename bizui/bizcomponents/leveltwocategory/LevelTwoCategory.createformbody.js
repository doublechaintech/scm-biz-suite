...
class LevelTwoCategoryCreateFormBody extends Component {
  state = {
  ...
  componentDidMount() {
    ...
    const formValue = LevelTwoCategoryBase.unpackObjectToFormValues(initValue)
              ...
              <Col lg={24} md={24} sm={24} >
                <Form.Item label={fieldLabels.parentCategory} {...formItemLayout}>
                  ...
                  <CandidateList
                    ...
                    requestFunction={LevelTwoCategoryService.queryCandidates}  />
...
}))(Form.create()(LevelTwoCategoryCreateFormBody))
