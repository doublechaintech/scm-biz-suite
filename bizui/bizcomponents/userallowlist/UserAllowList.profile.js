...
const internalSummaryOf = (item, targetComponents)=>{
	...
	return GlobalComponents.UserAllowListBase.renderItemOfList(item, targetComponents)

}



class UserAllowListProfile extends Component {
  ...
  render() {
    ...
    const  returnURL = `/userAllowList/${id}/dashboard`
...
}))(Form.create()(UserAllowListProfile))
