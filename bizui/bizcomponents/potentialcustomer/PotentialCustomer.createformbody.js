...
class PotentialCustomerCreateFormBody extends Component {
  state = {
  ...
  componentDidMount() {
    ...
    const formValue = PotentialCustomerBase.unpackObjectToFormValues(initValue)
...
}))(Form.create()(PotentialCustomerCreateFormBody))
