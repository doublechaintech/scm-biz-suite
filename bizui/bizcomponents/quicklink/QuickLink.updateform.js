...
import styles from './QuickLink.updateform.less'
...
class QuickLinkUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const quickLinkId = values.id

        const parameters = { ...values, quickLinkId, }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateQuickLink`,
          payload: {
            id: owner.id,
            type: 'quickLink',
            parameters,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextQuickLinkUpdateRow`,
        payload: {
          id: owner.id,
          type: 'quickLink',
          selectedRows,
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.linkTarget} {...formItemLayout}>
                  {getFieldDecorator('linkTarget', {
                    ...
                    <SmallTextInput size="large"  placeholder={fieldLabels.linkTarget} />
...
}))(Form.create()(QuickLinkUpdateForm))
