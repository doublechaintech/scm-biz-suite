...
import styles from './TruckDriver.workbench.less'
...
const internalSummaryOf = (cardsData,targetComponent) =>{
	...
	const truckDriver = cardsData.cardsSource
...
class TruckDriverWorkbench extends Component {
...
}))(Form.create()(TruckDriverWorkbench))
