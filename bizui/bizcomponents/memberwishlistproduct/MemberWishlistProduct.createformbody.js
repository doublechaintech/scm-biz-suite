...
class MemberWishlistProductCreateFormBody extends Component {
  state = {
  ...
  componentDidMount() {
    ...
    const formValue = MemberWishlistProductBase.unpackObjectToFormValues(initValue)
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.name} {...formItemLayout}>
                  {getFieldDecorator('name', {
                    ...
                    <SmallTextInput minLength={2} maxLength={20} size="large"  placeholder={fieldLabels.name} />
                  )}
                </Form.Item>
              </Col>
              ...
              <Col lg={24} md={24} sm={24} >
                <Form.Item label={fieldLabels.owner} {...formItemLayout}>
                  ...
                  <CandidateList
                    ...
                    requestFunction={MemberWishlistProductService.queryCandidates}  />
...
}))(Form.create()(MemberWishlistProductCreateFormBody))
