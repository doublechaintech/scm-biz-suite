...
class ConsumerOrderLineItemCreateFormBody extends Component {
  ...
  componentDidMount() {
    ...
    const formValue = ConsumerOrderLineItemBase.unpackObjectToFormValues(initValue)
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.quantity} {...formItemLayout}>
                  {getFieldDecorator('quantity', {
                    ...
                    <SmallTextInput minLength={0} maxLength={1000.00} size="large"  placeholder={fieldLabels.quantity} />
                  )}
                </Form.Item>
              </Col>
