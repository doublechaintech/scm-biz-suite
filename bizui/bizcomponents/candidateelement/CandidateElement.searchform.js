...
class CandidateElementSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      candidateElementList: 1,
      'candidateElementList.searchField': fieldName,
      'candidateElementList.searchVerb': 'startsWith',
      'candidateElementList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      const {listName} = owner
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'eq', 'container'))
      ...
      dispatch({
        ...
        candidateElementSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                    <Form.Item label={fieldLabels.container}>
                  {getFieldDecorator('container', {initialValue: tryinit('container')})(
                  ...
                  <CandidateList 
		                 ...
		                 ownerId={owner.id}
		                 scenarioCode={"search"}
		                 listType={"candidate_element"} 
		                 targetType={"candidate_container"} 
                 
                    requestFunction={CandidateElementService.queryCandidates} useForSearch />
