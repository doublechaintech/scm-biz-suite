...
import styles from './LevelOneDepartment.updateform.less'
...
class LevelOneDepartmentUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const levelOneDepartmentId = values.id

        const parameters = { ...values, levelOneDepartmentId, }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateLevelOneDepartment`,
          payload: {
            id: owner.id,
            type: 'levelOneDepartment',
            parameters,
            selectedRows,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextLevelOneDepartmentUpdateRow`,
        payload: {
          id: owner.id,
          type: 'levelOneDepartment',
          selectedRows,
	...
	const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"Update")}一级部门: {(currentUpdateIndex+1)}/{selectedRows.length}</div>)
    }
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.manager} {...formItemLayout}>
                  {getFieldDecorator('manager', {
                    ...
                    <SmallTextInput size="large"  placeholder={fieldLabels.manager} />
...
}))(Form.create()(LevelOneDepartmentUpdateForm))
