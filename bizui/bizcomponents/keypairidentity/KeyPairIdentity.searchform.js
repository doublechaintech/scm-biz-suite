...
import styles from './KeyPairIdentity.search.less'
...
class KeyPairIdentitySearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      keyPairIdentityList: 1,
      'keyPairIdentityList.searchField': fieldName,
      'keyPairIdentityList.searchVerb': 'startsWith',
      'keyPairIdentityList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        keyPairIdentitySearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                  ...
                  <CandidateList 
		                 ...
		                 ownerId={owner.id}
		                 scenarioCode={"search"}
		                 listType={"key_pair_identity"} 
		                 targetType={"public_key_type"} 
                 
                    requestFunction={KeyPairIdentityService.queryCandidates} useForSearch />
...
export default Form.create()(KeyPairIdentitySearchForm)
