...
class KeyPairIdentityCreateFormBody extends Component {
  state = {
  ...
  componentDidMount() {
    ...
    const formValue = KeyPairIdentityBase.unpackObjectToFormValues(initValue)
              ...
              <Col lg={24} md={24} sm={24} >
                <Form.Item label={fieldLabels.keyType} {...formItemLayout}>
                  ...
                  <CandidateList
                    ...
                    requestFunction={KeyPairIdentityService.queryCandidates}  />
...
}))(Form.create()(KeyPairIdentityCreateFormBody))
