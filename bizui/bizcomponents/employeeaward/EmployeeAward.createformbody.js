...
class EmployeeAwardCreateFormBody extends Component {
  state = {
  ...
  componentDidMount() {
    ...
    const formValue = EmployeeAwardBase.unpackObjectToFormValues(initValue)
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.type} {...formItemLayout}>
                  {getFieldDecorator('type', {
                    ...
                    <SmallTextInput minLength={2} maxLength={20} size="large"  placeholder={fieldLabels.type} />
                  )}
                </Form.Item>
              </Col>
              ...
              <Col lg={24} md={24} sm={24} >
                <Form.Item label={fieldLabels.employee} {...formItemLayout}>
                  ...
                  <CandidateList
                    ...
                    requestFunction={EmployeeAwardService.queryCandidates}  />
...
}))(Form.create()(EmployeeAwardCreateFormBody))
