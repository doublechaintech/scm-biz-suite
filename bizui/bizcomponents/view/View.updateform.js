...
import styles from './View.updateform.less'
...
class ViewUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const viewId = values.id

        const parameters = { ...values, viewId, }
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextViewUpdateRow`,
        payload: {
          id: owner.id,
          type: 'view',
          selectedRows,
	...
	const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"Update")}观: {(currentUpdateIndex+1)}/{selectedRows.length}</div>)
    }
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.who} {...formItemLayout}>
                  {getFieldDecorator('who', {
                    ...
                    <SmallTextInput size="large"  placeholder={fieldLabels.who} />
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.assessment} {...formItemLayout}>
                  {getFieldDecorator('assessment', {
                    initialValue: selectedRow.assessment,
                    rules: [{ required: true, message: appLocaleName(userContext,"PleaseInput") }],
                  })(
                    <SmallTextInput size="large"  placeholder={fieldLabels.assessment} />
