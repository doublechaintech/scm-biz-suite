...
class ViewSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {ViewTable} = GlobalComponents;
    const {ViewSearchForm} = GlobalComponents;
    const {ViewModalTable} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        ...
        {showDeletionDialog(this,ViewModalTable,"viewIds")}
...
export default Form.create()(ViewSearch)
