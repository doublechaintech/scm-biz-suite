...
import styles from './Scoring.updateform.less'
...
class ScoringUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const scoringId = values.id

        const parameters = { ...values, scoringId, }
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextScoringUpdateRow`,
        payload: {
          id: owner.id,
          type: 'scoring',
          selectedRows,
	...
	const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"Update")}评分: {(currentUpdateIndex+1)}/{selectedRows.length}</div>)
    }
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.scoredBy} {...formItemLayout}>
                  {getFieldDecorator('scoredBy', {
                    ...
                    <SmallTextInput size="large"  placeholder={fieldLabels.scoredBy} />
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.score} {...formItemLayout}>
                  {getFieldDecorator('score', {
                    ...
                    <SmallTextInput size="large"  placeholder={fieldLabels.score} />
