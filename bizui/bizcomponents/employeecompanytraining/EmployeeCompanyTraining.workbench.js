...
import styles from './EmployeeCompanyTraining.workbench.less'
...
const internalSummaryOf = (cardsData,targetComponent) =>{
	...
	const employeeCompanyTraining = cardsData.cardsSource
	const {EmployeeCompanyTrainingService} = GlobalComponents
	const userContext = null
	return (
	<div>
	<DescriptionList className={styles.headerList} size="small" col="4">
<Description term="ID" style={{wordBreak: 'break-all'}}>{employeeCompanyTraining.id}</Description> 
...
class EmployeeCompanyTrainingWorkbench extends Component {
...
}))(Form.create()(EmployeeCompanyTrainingWorkbench))
