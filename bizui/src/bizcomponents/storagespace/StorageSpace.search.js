...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{storageSpaceList:selectedRows}} owner={owner}  
...
class StorageSpaceSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {StorageSpaceTable} = GlobalComponents;
    const {StorageSpaceSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <StorageSpaceSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,StorageSpaceModalTable,"storageSpaceIds")}
...
export default Form.create()(StorageSpaceSearch)
