 ...
 getNavMenuItems = (targetObject, style, customTheme) => {
	  ...
	  <Menu
       ...
       >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/storageSpace/${this.props.storageSpace.id}/dashboard`}><Icon type="dashboard" style={{marginRight:"20px"}}/><span>{appLocaleName(userContext,"Dashboard")}</span></Link>
             </Menu.Item>
  ...
  getGoodsShelfCreateForm = () => {
    ...
    return connect(state => ({
      ...
      searchFormParameters: state._storageSpace.goodsShelfSearchFormParameters,
      loading: state._storageSpace.loading,
      owner: { type: '_storageSpace', id: state._storageSpace.id, referenceName: 'storageSpace', listName: 'goodsShelfList', ref:state._storageSpace, listDisplayName: appLocaleName(userContext,"List")}, // this is for model namespace and
  ...
  getGoodsShelfUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_storageSpace', id: state._storageSpace.id, listName: 'goodsShelfList', ref:state._storageSpace, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
