...
import styles from './StorageSpace.search.less'
...
class StorageSpaceSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      storageSpaceList: 1,
      'storageSpaceList.searchField': fieldName,
      'storageSpaceList.searchVerb': 'startsWith',
      'storageSpaceList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`storageSpaceList.searchField`] = fieldName
    value[`storageSpaceList.searchVerb`] =  searchVerb
    value[`storageSpaceList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
      params['storageSpaceList'] = 1
      params['storageSpaceList.orderBy.0'] = "id"
      params['storageSpaceList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        storageSpaceSearchFormParameters: filterObjectKeys(fieldsValue),
...
=======
                    requestFunction={StorageSpaceService.requestCandidateWarehouse} useForSearch />
...
export default Form.create()(StorageSpaceSearchForm)
