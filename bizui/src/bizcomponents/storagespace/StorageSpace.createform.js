...
=======
import StorageSpaceCreateFormBody from './StorageSpace.createformbody'
...
const testValues = {
  ...
  totalArea: '1876平方米',
<<<<<<< HEAD
  latitude: '41.2054580185286',
  longitude: '130.01132225376838',
=======
...
class StorageSpaceCreateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, ...imagesValues }
        dispatch({
          type: `${owner.type}/addStorageSpace`,
          payload: { id: owner.id, type: 'storageSpace', parameters, continueNext: true },
        })
      })
    }
...
<<<<<<< HEAD
      dispatch({
        ...
        payload: { id: owner.id, type: 'storageSpace',listName:'存货区列表' },
=======
     
      dispatch({
        type: `${owner.type}/goback`,
        payload: { id: owner.id, type: 'storageSpace',listName:appLocaleName(userContext,"List") },
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      })
    }
...
}))(Form.create()(StorageSpaceCreateForm))
