...
const testValues = {
  ...
  verificationCode: '0',
  verificationCodeExpire: '2019-03-13 22:24:02',
  lastLoginTime: '2019-03-20 18:46:08',
  domainId: 'UD000001',
}
*/
...
class SecUserCreateForm extends Component {
  ...
  render() {
	...
	return (
      <PageHeaderLayout
        title={`${appLocaleName(userContext,"CreateNew")}SEC的用户`}
        content={`${appLocaleName(userContext,"CreateNew")}SEC的用户`}
