...
class OriginalVoucherAuditingSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {OriginalVoucherAuditingTable} = GlobalComponents;
    const {OriginalVoucherAuditingSearchForm} = GlobalComponents;
    const {OriginalVoucherAuditingModalTable} = GlobalComponents;
        ...
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <OriginalVoucherAuditingSearchForm {...this.props} />
            </div>
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
        ...
        {showDeletionDialog(this,OriginalVoucherAuditingModalTable,"originalVoucherAuditingIds")}
...
export default Form.create()(OriginalVoucherAuditingSearch)
