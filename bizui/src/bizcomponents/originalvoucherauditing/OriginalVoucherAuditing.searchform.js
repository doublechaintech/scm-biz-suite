...
import styles from './OriginalVoucherAuditing.search.less'
...
class OriginalVoucherAuditingSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      originalVoucherAuditingList: 1,
      'originalVoucherAuditingList.searchField': fieldName,
      'originalVoucherAuditingList.searchVerb': 'startsWith',
      'originalVoucherAuditingList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`originalVoucherAuditingList.searchField`] = fieldName
    value[`originalVoucherAuditingList.searchVerb`] =  searchVerb
    value[`originalVoucherAuditingList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
      params['originalVoucherAuditingList'] = 1
      params['originalVoucherAuditingList.orderBy.0'] = "id"
      params['originalVoucherAuditingList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        originalVoucherAuditingSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(OriginalVoucherAuditingSearchForm)
