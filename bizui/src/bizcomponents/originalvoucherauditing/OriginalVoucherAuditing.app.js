  ...
  getNavMenuItems = (targetObject) => {
    ...
    return (
       ...
       <Menu.Item key="preference">
               <Link to={`/originalVoucherAuditing/${this.props.originalVoucherAuditing.id}/preference`}><Icon type="setting" /><span>{appLocaleName(userContext,"Preference")}</span></Link>
             </Menu.Item>
