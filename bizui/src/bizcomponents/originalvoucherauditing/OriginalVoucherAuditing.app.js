...
class OriginalVoucherAuditingBizApp extends React.PureComponent {
  ...
  getNavMenuItems = (targetObject) => {
    ...
    return (
		  ...
		  <Menu
           ...
           >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/originalVoucherAuditing/${this.props.originalVoucherAuditing.id}/dashboard`}><Icon type="dashboard" /><span>仪表板</span></Link>
             </Menu.Item>
       ...
       <Menu.Item key="preference">
               <Link to={`/originalVoucherAuditing/${this.props.originalVoucherAuditing.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
  ...
  getOriginalVoucherCreateForm = () => {
    ...
    return connect(state => ({
      ...
      searchFormParameters: state._originalVoucherAuditing.originalVoucherSearchFormParameters,
      loading: state._originalVoucherAuditing.loading,
      owner: { type: '_originalVoucherAuditing', id: state._originalVoucherAuditing.id, referenceName: 'auditing', listName: 'originalVoucherList', ref:state._originalVoucherAuditing, listDisplayName: '原始凭证列表'}, // this is for model namespace and
  ...
  getOriginalVoucherUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_originalVoucherAuditing', id: state._originalVoucherAuditing.id, listName: 'originalVoucherList', ref:state._originalVoucherAuditing, listDisplayName: '原始凭证列表' }, // this is for model namespace and
  ...
  buildRouters = () =>{
  	...
  	const {OriginalVoucherAuditingPreference} = GlobalComponents
  	
  	
  	const routers=[
  	{path:"/originalVoucherAuditing/:id/dashboard", component: OriginalVoucherAuditingDashboard},
  	{path:"/originalVoucherAuditing/:id/preference", component: OriginalVoucherAuditingPreference},
  ...
  handleOpenChange = (openKeys) => {
   ...
   render() {
     ...
     //const {OriginalVoucherAuditingEditDetail} = GlobalComponents
     //const {OriginalVoucherAuditingViewDetail} = GlobalComponents
