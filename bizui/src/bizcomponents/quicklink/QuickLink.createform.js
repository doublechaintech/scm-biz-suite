...
import QuickLinkCreateFormBody from './QuickLink.createformbody'
...
class QuickLinkCreateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          ...
          payload: { id: owner.id, type: 'quickLink', parameters, continueNext: true },
        })
      })
    }
	...
	return (
      <PageHeaderLayout
        ...
        content={`${appLocaleName(userContext,"CreateNew")}快速链接`}
        wrapperClassName={styles.advancedForm}
      >
   			
   		<QuickLinkCreateFormBody	 {...this.props} />
...
}))(Form.create()(QuickLinkCreateForm))
