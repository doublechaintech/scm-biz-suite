...
import styles from './QuickLink.search.less'
...
class QuickLinkSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      quickLinkList: 1,
      'quickLinkList.searchField': fieldName,
      'quickLinkList.searchVerb': 'startsWith',
      'quickLinkList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      const {listName} = owner
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'contains', 'linkTarget'))
      ...
      dispatch({
        ...
        quickLinkSearchFormParameters: filterObjectKeys(fieldsValue),
    ...
    return (
      <Form onSubmit={this.handleSearch} layout="inline">
        <Row gutter={{ md: 8, lg: 24, xl: 48 }}>
          ...
          <Col md={8} sm={24}>
            <FormItem label={fieldLabels.linkTarget}>
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"app"} 
                    requestFunction={QuickLinkService.requestCandidateApp} useForSearch />
...
export default Form.create()(QuickLinkSearchForm)
