...
constructor(props) {
 ...
 getNavMenuItems = (targetObject, style, customTheme) => {
	  ...
	  <Menu
       ...
       >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/employeeLeave/${this.props.employeeLeave.id}/dashboard`}><Icon type="dashboard" style={{marginRight:"20px"}}/><span>{appLocaleName(userContext,"Dashboard")}</span></Link>
             </Menu.Item>
  ...
  buildRouters = () =>{
  	...
  	const routers=[
  	{path:"/employeeLeave/:id/dashboard", component: EmployeeLeaveDashboard},
