...
import styles from './EmployeeLeave.search.less'
...
class EmployeeLeaveSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      employeeLeaveList: 1,
      'employeeLeaveList.searchField': fieldName,
      'employeeLeaveList.searchVerb': 'startsWith',
      'employeeLeaveList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`employeeLeaveList.searchField`] = fieldName
    value[`employeeLeaveList.searchVerb`] =  searchVerb
    value[`employeeLeaveList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'eq', 'who'))
...
=======
      ...
      const {listName} = owner
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'eq', 'who'))
...
<<<<<<< HEAD
      params['employeeLeaveList'] = 1
      params['employeeLeaveList.orderBy.0'] = "id"
      params['employeeLeaveList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        employeeLeaveSearchFormParameters: filterObjectKeys(fieldsValue),
...
=======
               {getFieldDecorator('who', {initialValue: tryinit('who')})(
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
...
=======
                 requestFunction={EmployeeLeaveService.requestCandidateWho} useForSearch />
...
=======
                    requestFunction={EmployeeLeaveService.requestCandidateType} useForSearch />
...
export default Form.create()(EmployeeLeaveSearchForm)
