...
import styles from './EmployeeAward.updateform.less'
...
class EmployeeAwardUpdateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
        ...
        const employeeAwardId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, employeeAwardId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateEmployeeAward`,
          payload: {
            id: owner.id,
            type: 'employeeAward',
            parameters,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextEmployeeAwardUpdateRow`,
        payload: {
          id: owner.id,
          type: 'employeeAward',
          selectedRows,
...
<<<<<<< HEAD
    ...
    return (
      <PageHeaderLayout
        title={"更新员工嘉奖"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新员工嘉奖"
...
=======
	...
	const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"Update")}员工嘉奖: {(currentUpdateIndex+1)}/{selectedRows.length}</div>)
    }
...
}))(Form.create()(EmployeeAwardUpdateForm))
