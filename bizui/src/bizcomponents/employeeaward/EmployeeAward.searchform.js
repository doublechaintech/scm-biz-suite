...
import styles from './EmployeeAward.search.less'
...
class EmployeeAwardSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      employeeAwardList: 1,
      'employeeAwardList.searchField': fieldName,
      'employeeAwardList.searchVerb': 'startsWith',
      'employeeAwardList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`employeeAwardList.searchField`] = fieldName
    value[`employeeAwardList.searchVerb`] =  searchVerb
    value[`employeeAwardList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
      params['employeeAwardList'] = 1
      params['employeeAwardList.orderBy.0'] = "id"
      params['employeeAwardList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        employeeAwardSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(EmployeeAwardSearchForm)
