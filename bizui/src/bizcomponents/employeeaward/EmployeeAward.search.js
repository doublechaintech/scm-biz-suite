...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{employeeAwardList:selectedRows}} owner={owner}  
...
class EmployeeAwardSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {EmployeeAwardTable} = GlobalComponents;
    const {EmployeeAwardSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        ...
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <EmployeeAwardSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,EmployeeAwardModalTable,"employeeAwardIds")}
...
export default Form.create()(EmployeeAwardSearch)
