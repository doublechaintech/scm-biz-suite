...
import styles from './AccountingDocumentConfirmation.search.less'
...
class AccountingDocumentConfirmationSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      accountingDocumentConfirmationList: 1,
      'accountingDocumentConfirmationList.searchField': fieldName,
      'accountingDocumentConfirmationList.searchVerb': 'startsWith',
      'accountingDocumentConfirmationList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`accountingDocumentConfirmationList.searchField`] = fieldName
    value[`accountingDocumentConfirmationList.searchVerb`] =  searchVerb
    value[`accountingDocumentConfirmationList.searchValue`] = fieldValue
=======
...
=======
      ...
      const {listName} = owner
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'contains', 'comments'))
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
...
<<<<<<< HEAD
      params['accountingDocumentConfirmationList'] = 1
      params['accountingDocumentConfirmationList.orderBy.0'] = "id"
      params['accountingDocumentConfirmationList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        accountingDocumentConfirmationSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(AccountingDocumentConfirmationSearchForm)
