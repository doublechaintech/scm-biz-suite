...
class AccountingDocumentConfirmationSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {AccountingDocumentConfirmationTable} = GlobalComponents;
    const {AccountingDocumentConfirmationSearchForm} = GlobalComponents;
    const {AccountingDocumentConfirmationModalTable} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <AccountingDocumentConfirmationSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,AccountingDocumentConfirmationModalTable,"accountingDocumentConfirmationIds")}
...
export default Form.create()(AccountingDocumentConfirmationSearch)
