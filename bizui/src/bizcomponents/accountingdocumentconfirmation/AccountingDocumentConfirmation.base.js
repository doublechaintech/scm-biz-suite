...
const displayColumns = [
  { title: '序号', debugtype: 'string', dataIndex: 'id', width: '20', render: (text, record)=>renderTextCell(text,record,'accountingDocumentConfirmation') },
...
const AccountingDocumentConfirmationBase={menuData,displayColumns,fieldLabels,displayColumns}
