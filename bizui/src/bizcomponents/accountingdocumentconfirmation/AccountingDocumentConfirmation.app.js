...
<<<<<<< HEAD
    ...
    return (
		  ...
		  <Menu
           ...
           >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/accountingDocumentConfirmation/${this.props.accountingDocumentConfirmation.id}/dashboard`}><Icon type="dashboard" /><span>仪表板</span></Link>
             </Menu.Item>
       ...
       <Menu.Item key="preference">
               <Link to={`/accountingDocumentConfirmation/${this.props.accountingDocumentConfirmation.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
    ...
    return (
	  <Menu
       ...
       >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/accountingDocumentConfirmation/${this.props.accountingDocumentConfirmation.id}/dashboard`}><Icon type="dashboard" style={{marginRight:"20px"}}/><span>{appLocaleName(userContext,"Dashboard")}</span></Link>
             </Menu.Item>
...
<<<<<<< HEAD
      ...
      searchFormParameters: state._accountingDocumentConfirmation.accountingDocumentSearchFormParameters,
      loading: state._accountingDocumentConfirmation.loading,
      owner: { type: '_accountingDocumentConfirmation', id: state._accountingDocumentConfirmation.id, referenceName: 'confirmation', listName: 'accountingDocumentList', ref:state._accountingDocumentConfirmation, listDisplayName: '会计凭证列表'}, // this is for model namespace and
=======
      returnURL: `/accountingDocumentConfirmation/${state._accountingDocumentConfirmation.id}/list`,
      currentPage: state._accountingDocumentConfirmation.accountingDocumentCurrentPageNumber,
      searchFormParameters: state._accountingDocumentConfirmation.accountingDocumentSearchFormParameters,
      loading: state._accountingDocumentConfirmation.loading,
...
<<<<<<< HEAD
      owner: { type: '_accountingDocumentConfirmation', id: state._accountingDocumentConfirmation.id, listName: 'accountingDocumentList', ref:state._accountingDocumentConfirmation, listDisplayName: '会计凭证列表' }, // this is for model namespace and
=======
...
<<<<<<< HEAD
  	const {AccountingDocumentConfirmationPreference} = GlobalComponents
=======
...
<<<<<<< HEAD
  	{path:"/accountingDocumentConfirmation/:id/preference", component: AccountingDocumentConfirmationPreference},
=======
...
<<<<<<< HEAD
     ...
     //const {AccountingDocumentConfirmationEditDetail} = GlobalComponents
     //const {AccountingDocumentConfirmationViewDetail} = GlobalComponents
...
=======
 ...
 <Header>
        ...
        <Col {...naviBarResponsiveStyle} >
            <Dropdown overlay= {this.getNavMenuItems(this.props.accountingDocumentConfirmation)}>
