...
=======
    ...
    const {searchLocalData}=GlobalComponents.AccountingDocumentConfirmationBase
...
=======
      {this.state.showSearch&&(
        ...
        <div style={{backgroundColor:'black'}}  onClick={()=>hideSearchResult()}  >{searchLocalData(this.props.accountingDocumentConfirmation,this.state.searchKeyword)}</div>
