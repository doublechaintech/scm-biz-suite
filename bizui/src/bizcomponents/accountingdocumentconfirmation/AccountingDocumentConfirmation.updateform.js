...
import styles from './AccountingDocumentConfirmation.updateform.less'
...
class AccountingDocumentConfirmationUpdateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
        ...
        const accountingDocumentConfirmationId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, accountingDocumentConfirmationId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateAccountingDocumentConfirmation`,
          payload: {
            id: owner.id,
            type: 'accountingDocumentConfirmation',
            parameters,
            selectedRows,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextAccountingDocumentConfirmationUpdateRow`,
        payload: {
          id: owner.id,
          type: 'accountingDocumentConfirmation',
          selectedRows,
...
<<<<<<< HEAD
    ...
    return (
      <PageHeaderLayout
        title={"更新会计的确认文件"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新会计的确认文件"
...
=======
	...
	const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"Update")}会计的确认文件: {(currentUpdateIndex+1)}/{selectedRows.length}</div>)
    }
...
}))(Form.create()(AccountingDocumentConfirmationUpdateForm))
