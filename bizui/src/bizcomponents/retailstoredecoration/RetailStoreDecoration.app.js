...
<<<<<<< HEAD
    ...
    return (
		  ...
		  <Menu
           ...
           >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/retailStoreDecoration/${this.props.retailStoreDecoration.id}/dashboard`}><Icon type="dashboard" /><span>仪表板</span></Link>
             </Menu.Item>
       ...
       <Menu.Item key="preference">
               <Link to={`/retailStoreDecoration/${this.props.retailStoreDecoration.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
    ...
    return (
	  <Menu
       ...
       >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/retailStoreDecoration/${this.props.retailStoreDecoration.id}/dashboard`}><Icon type="dashboard" style={{marginRight:"20px"}}/><span>{appLocaleName(userContext,"Dashboard")}</span></Link>
             </Menu.Item>
...
<<<<<<< HEAD
      ...
      searchFormParameters: state._retailStoreDecoration.retailStoreSearchFormParameters,
      loading: state._retailStoreDecoration.loading,
      owner: { type: '_retailStoreDecoration', id: state._retailStoreDecoration.id, referenceName: 'decoration', listName: 'retailStoreList', ref:state._retailStoreDecoration, listDisplayName: '双链小超列表'}, // this is for model namespace and
=======
...
<<<<<<< HEAD
      owner: { type: '_retailStoreDecoration', id: state._retailStoreDecoration.id, listName: 'retailStoreList', ref:state._retailStoreDecoration, listDisplayName: '双链小超列表' }, // this is for model namespace and
=======
...
<<<<<<< HEAD
     ...
     //const {RetailStoreDecorationEditDetail} = GlobalComponents
     //const {RetailStoreDecorationViewDetail} = GlobalComponents
...
=======
 ...
 <Header>
        ...
        <Col {...naviBarResponsiveStyle} >
            <Dropdown overlay= {this.getNavMenuItems(this.props.retailStoreDecoration)}>
