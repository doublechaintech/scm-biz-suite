...
const internalSummaryOf = (item, targetComponents)=>{
	...
	return GlobalComponents.RetailStoreDecorationBase.renderItemOfList(item, targetComponents)

}



class RetailStoreDecorationProfile extends Component {
...
}))(Form.create()(RetailStoreDecorationProfile))
