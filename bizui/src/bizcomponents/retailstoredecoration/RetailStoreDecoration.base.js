...
const renderItemOfList=(retailStoreDecoration, targetComponent, columCount, listName)=>{
  ...
  const userContext = null
  return (
    <Card key={`${listName}-${retailStoreDecoration.id}`} style={{marginTop:"10px"}}>
...
const RetailStoreDecorationBase={menuData,settingMenuData,displayColumns,fieldLabels,renderItemOfList, stepOf, searchLocalData}
