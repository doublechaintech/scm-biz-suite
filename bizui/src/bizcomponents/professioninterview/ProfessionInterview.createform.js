...
=======
import ProfessionInterviewCreateFormBody from './ProfessionInterview.createformbody'
...
const testValues = {
  who: '技术部',
<<<<<<< HEAD
  interviewTime: '2018-08-22',
=======
  interviewTime: '2018-05-05',
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
...
class ProfessionInterviewCreateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, ...imagesValues }
        dispatch({
          type: `${owner.type}/addProfessionInterview`,
          payload: { id: owner.id, type: 'professionInterview', parameters, continueNext: true },
        })
      })
    }
...
<<<<<<< HEAD
      dispatch({
        ...
        payload: { id: owner.id, type: 'professionInterview',listName:'专业面试列表' },
=======
     
      dispatch({
        type: `${owner.type}/goback`,
        payload: { id: owner.id, type: 'professionInterview',listName:appLocaleName(userContext,"List") },
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      })
    }
...
=======
	...
	return (
      ...
      >
   		...
   		<ProfessionInterviewCreateFormBody	 {...this.props} />
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
...
}))(Form.create()(ProfessionInterviewCreateForm))
