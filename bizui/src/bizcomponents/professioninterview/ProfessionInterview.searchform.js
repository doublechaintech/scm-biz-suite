...
import styles from './ProfessionInterview.search.less'
...
class ProfessionInterviewSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      professionInterviewList: 1,
      'professionInterviewList.searchField': fieldName,
      'professionInterviewList.searchVerb': 'startsWith',
      'professionInterviewList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`professionInterviewList.searchField`] = fieldName
    value[`professionInterviewList.searchVerb`] =  searchVerb
    value[`professionInterviewList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
      params['professionInterviewList'] = 1
      params['professionInterviewList.orderBy.0'] = "id"
      params['professionInterviewList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        professionInterviewSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(ProfessionInterviewSearchForm)
