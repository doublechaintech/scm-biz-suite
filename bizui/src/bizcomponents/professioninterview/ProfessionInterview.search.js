...
class ProfessionInterviewSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {ProfessionInterviewTable} = GlobalComponents;
    const {ProfessionInterviewSearchForm} = GlobalComponents;
    const {ProfessionInterviewModalTable} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <ProfessionInterviewSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,ProfessionInterviewModalTable,"professionInterviewIds")}
...
export default Form.create()(ProfessionInterviewSearch)
