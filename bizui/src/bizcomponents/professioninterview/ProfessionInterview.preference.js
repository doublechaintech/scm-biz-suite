...
const internalImageListOf = (professionInterview) =>{
...
const internalSettingListOf = (professionInterview) =>{
	const userContext = null
	const optionList = [ 
	]
...
const handleTransferSearch =(targetComponent,filterKey,newRequest)=>{
  ...
  const pageNo = 1;
  const candidateReferenceService = ProfessionInterviewService[candidateServiceName] 
...
const executeTrans = (professionInterview,targetComponent) =>{
...
const buildTransferModal = (professionInterview,targetComponent) => {
...
<Modal title={transferModalTitle}
          ...
          onOk={()=>executeTrans(professionInterview,targetComponent)}
...
const internalRenderExtraHeader = (professionInterview) =>{
	return null
}
const internalRenderExtraFooter = (professionInterview) =>{
	return null
}
...
class ProfessionInterviewPreference extends Component {
...
}))(Form.create()(ProfessionInterviewPreference))
