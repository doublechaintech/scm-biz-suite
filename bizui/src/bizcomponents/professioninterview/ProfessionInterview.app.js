...
=======
    ...
    const {searchLocalData}=GlobalComponents.ProfessionInterviewBase
...
=======
      {this.state.showSearch&&(
        ...
        <div style={{backgroundColor:'black'}}  onClick={()=>hideSearchResult()}  >{searchLocalData(this.props.professionInterview,this.state.searchKeyword)}</div>
