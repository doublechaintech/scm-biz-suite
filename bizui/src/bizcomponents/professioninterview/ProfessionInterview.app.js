...
<<<<<<< HEAD
    ...
    return (
       ...
       <Menu.Item key="preference">
               <Link to={`/professionInterview/${this.props.professionInterview.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
    ...
    return (
	  <Menu
       ...
       >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/professionInterview/${this.props.professionInterview.id}/dashboard`}><Icon type="dashboard" style={{marginRight:"20px"}}/><span>{appLocaleName(userContext,"Dashboard")}</span></Link>
             </Menu.Item>
...
<<<<<<< HEAD
      ...
      searchFormParameters: state._professionInterview.employeeSearchFormParameters,
      loading: state._professionInterview.loading,
      owner: { type: '_professionInterview', id: state._professionInterview.id, referenceName: 'professionInterview', listName: 'employeeList', ref:state._professionInterview, listDisplayName: '员工列表'}, // this is for model namespace and
=======
      returnURL: `/professionInterview/${state._professionInterview.id}/list`,
      currentPage: state._professionInterview.employeeCurrentPageNumber,
      searchFormParameters: state._professionInterview.employeeSearchFormParameters,
      loading: state._professionInterview.loading,
...
<<<<<<< HEAD
  	const {ProfessionInterviewPreference} = GlobalComponents
=======
...
<<<<<<< HEAD
  	{path:"/professionInterview/:id/preference", component: ProfessionInterviewPreference},
=======
...
=======
 ...
 <Header>
        ...
        <Col {...naviBarResponsiveStyle} >
            <Dropdown overlay= {this.getNavMenuItems(this.props.professionInterview)}>
