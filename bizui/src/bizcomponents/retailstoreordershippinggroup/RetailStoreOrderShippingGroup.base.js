...
const renderItemOfList=(retailStoreOrderShippingGroup, targetComponent, columCount, listName)=>{
  ...
  const userContext = null
  return (
    <Card key={`${listName}-${retailStoreOrderShippingGroup.id}`} style={{marginTop:"10px"}}>
