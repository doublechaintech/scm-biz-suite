...
class RetailStoreOrderShippingGroupCreateFormBody extends Component {
  state = {
  ...
  componentDidMount() {
    ...
    const formValue = RetailStoreOrderShippingGroupBase.unpackObjectToFormValues(initValue)
              ...
              <Col lg={24} md={24} sm={24} >
                <Form.Item label={fieldLabels.bizOrder} {...formItemLayout}>
                  ...
                  <CandidateList
                    ...
                    requestFunction={RetailStoreOrderShippingGroupService.queryCandidates}  />
...
}))(Form.create()(RetailStoreOrderShippingGroupCreateFormBody))
