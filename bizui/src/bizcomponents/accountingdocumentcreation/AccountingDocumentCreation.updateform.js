...
import styles from './AccountingDocumentCreation.updateform.less'
...
class AccountingDocumentCreationUpdateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
        ...
        const accountingDocumentCreationId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, accountingDocumentCreationId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateAccountingDocumentCreation`,
          payload: {
            id: owner.id,
            type: 'accountingDocumentCreation',
            parameters,
            selectedRows,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextAccountingDocumentCreationUpdateRow`,
        payload: {
          id: owner.id,
          type: 'accountingDocumentCreation',
          selectedRows,
...
<<<<<<< HEAD
    ...
    return (
      <PageHeaderLayout
        title={"更新会计文件的创建"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新会计文件的创建"
...
=======
	...
	const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"Update")}会计文件的创建: {(currentUpdateIndex+1)}/{selectedRows.length}</div>)
    }
...
}))(Form.create()(AccountingDocumentCreationUpdateForm))
