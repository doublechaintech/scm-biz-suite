...
class AccountingDocumentCreationSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {AccountingDocumentCreationTable} = GlobalComponents;
    const {AccountingDocumentCreationSearchForm} = GlobalComponents;
    const {AccountingDocumentCreationModalTable} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <AccountingDocumentCreationSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,AccountingDocumentCreationModalTable,"accountingDocumentCreationIds")}
...
export default Form.create()(AccountingDocumentCreationSearch)
