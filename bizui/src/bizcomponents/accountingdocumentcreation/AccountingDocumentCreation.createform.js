...
import styles from './AccountingDocumentCreation.createform.less'
...
=======
import AccountingDocumentCreationCreateFormBody from './AccountingDocumentCreation.createformbody'
...
class AccountingDocumentCreationCreateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, ...imagesValues }
        dispatch({
          type: `${owner.type}/addAccountingDocumentCreation`,
          payload: { id: owner.id, type: 'accountingDocumentCreation', parameters, continueNext: true },
        })
      })
    }
...
<<<<<<< HEAD
      dispatch({
        ...
        payload: { id: owner.id, type: 'accountingDocumentCreation',listName:'会计文件的创建列表' },
=======
     
      dispatch({
        type: `${owner.type}/goback`,
        payload: { id: owner.id, type: 'accountingDocumentCreation',listName:appLocaleName(userContext,"List") },
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      })
    }
...
=======
	...
	return (
      ...
      >
   		...
   		<AccountingDocumentCreationCreateFormBody	 {...this.props} />
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
...
}))(Form.create()(AccountingDocumentCreationCreateForm))
