...
import styles from './AccountingDocumentCreation.search.less'
...
class AccountingDocumentCreationSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      accountingDocumentCreationList: 1,
      'accountingDocumentCreationList.searchField': fieldName,
      'accountingDocumentCreationList.searchVerb': 'startsWith',
      'accountingDocumentCreationList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`accountingDocumentCreationList.searchField`] = fieldName
    value[`accountingDocumentCreationList.searchVerb`] =  searchVerb
    value[`accountingDocumentCreationList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
      params['accountingDocumentCreationList'] = 1
      params['accountingDocumentCreationList.orderBy.0'] = "id"
      params['accountingDocumentCreationList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        accountingDocumentCreationSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(AccountingDocumentCreationSearchForm)
