...
import styles from './SmartPallet.search.less'
...
class SmartPalletSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      smartPalletList: 1,
      'smartPalletList.searchField': fieldName,
      'smartPalletList.searchVerb': 'startsWith',
      'smartPalletList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`smartPalletList.searchField`] = fieldName
    value[`smartPalletList.searchVerb`] =  searchVerb
    value[`smartPalletList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
      params['smartPalletList'] = 1
      params['smartPalletList.orderBy.0'] = "id"
      params['smartPalletList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        smartPalletSearchFormParameters: filterObjectKeys(fieldsValue),
...
=======
                    requestFunction={SmartPalletService.requestCandidateWarehouse} useForSearch />
...
export default Form.create()(SmartPalletSearchForm)
