...
=======
import SmartPalletCreateFormBody from './SmartPallet.createformbody'
...
const testValues = {
  ...
  totalArea: '1876平方米',
<<<<<<< HEAD
  latitude: '42.63510236174434',
  longitude: '129.6534029090999',
=======
  latitude: '40.6133997276123',
  longitude: '131.64800028304728',
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
  warehouseId: 'W000001',
}
*/
...
class SmartPalletCreateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, ...imagesValues }
        dispatch({
          type: `${owner.type}/addSmartPallet`,
          payload: { id: owner.id, type: 'smartPallet', parameters, continueNext: true },
        })
      })
    }
...
<<<<<<< HEAD
      dispatch({
        ...
        payload: { id: owner.id, type: 'smartPallet',listName:'智能托盘列表' },
=======
     
      dispatch({
        type: `${owner.type}/goback`,
        payload: { id: owner.id, type: 'smartPallet',listName:appLocaleName(userContext,"List") },
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      })
    }
...
}))(Form.create()(SmartPalletCreateForm))
