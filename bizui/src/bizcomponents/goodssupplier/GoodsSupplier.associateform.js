...
class GoodsSupplierAssociateForm extends Component {
  state = {
 ...
 <Modal
	...
	<SupplierProductModalTable data={data.supplierProductList} owner={owner} />
...
}))(Form.create()(GoodsSupplierAssociateForm))
