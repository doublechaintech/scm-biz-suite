...
const internalImageListOf = (goodsSupplier) =>{
...
const internalSettingListOf = (goodsSupplier) =>{
...
const handleTransferSearch =(targetComponent,filterKey,newRequest)=>{
  ...
  const pageNo = 1;
  const candidateReferenceService = GoodsSupplierService[candidateServiceName] 
...
const executeTrans = (goodsSupplier,targetComponent) =>{
...
const buildTransferModal = (goodsSupplier,targetComponent) => {
...
<Modal title={transferModalTitle}
          ...
          onOk={()=>executeTrans(goodsSupplier,targetComponent)}
...
const internalRenderExtraHeader = (goodsSupplier) =>{
	return null
}
const internalRenderExtraFooter = (goodsSupplier) =>{
	return null
}
...
class GoodsSupplierPreference extends Component {
  ...
  render() {
    ...
    const { id,displayName, supplierProductCount, supplyOrderCount, accountSetCount } = this.props.goodsSupplier
...
}))(Form.create()(GoodsSupplierPreference))
