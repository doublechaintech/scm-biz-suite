...
import styles from './GoodsSupplier.updateform.less'
...
class GoodsSupplierUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const goodsSupplierId = values.id

        const parameters = { ...values, goodsSupplierId, }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateGoodsSupplier`,
          payload: {
            id: owner.id,
            type: 'goodsSupplier',
            parameters,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextGoodsSupplierUpdateRow`,
        payload: {
          id: owner.id,
          type: 'goodsSupplier',
          selectedRows,
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.supplyProduct} {...formItemLayout}>
                  {getFieldDecorator('supplyProduct', {
                    ...
                    <SmallTextInput size="large"  placeholder={fieldLabels.supplyProduct} />
...
}))(Form.create()(GoodsSupplierUpdateForm))
