...
import styles from './GoodsSupplier.createform.less'
...
=======
import GoodsSupplierCreateFormBody from './GoodsSupplier.createformbody'
...
class GoodsSupplierCreateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, ...imagesValues }
        dispatch({
          type: `${owner.type}/addGoodsSupplier`,
          payload: { id: owner.id, type: 'goodsSupplier', parameters, continueNext: true },
        })
      })
    }
...
}))(Form.create()(GoodsSupplierCreateForm))
