...
class GoodsSupplierCreateFormBody extends Component {
  state = {
  ...
  componentDidMount() {
    ...
    const formValue = GoodsSupplierBase.unpackObjectToFormValues(initValue)
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.supplyProduct} {...formItemLayout}>
                  {getFieldDecorator('supplyProduct', {
                    ...
                    <SmallTextInput minLength={1} maxLength={16} size="large"  placeholder={fieldLabels.supplyProduct} />
                  )}
                </Form.Item>
              </Col>
              ...
              <Col lg={24} md={24} sm={24} style={{"display":"none"}}>
                <Form.Item label={fieldLabels.belongTo} {...formItemLayout}>
                  ...
                  <CandidateList
                    ...
                    requestFunction={GoodsSupplierService.queryCandidates}  />
...
}))(Form.create()(GoodsSupplierCreateFormBody))
