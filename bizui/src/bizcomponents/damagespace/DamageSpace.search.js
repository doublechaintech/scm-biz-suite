...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{damageSpaceList:selectedRows}} owner={owner}  
...
class DamageSpaceSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {DamageSpaceTable} = GlobalComponents;
    const {DamageSpaceSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        ...
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <DamageSpaceSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,DamageSpaceModalTable,"damageSpaceIds")}
...
export default Form.create()(DamageSpaceSearch)
