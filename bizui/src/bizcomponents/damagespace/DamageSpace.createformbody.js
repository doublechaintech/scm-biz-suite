...
class DamageSpaceCreateFormBody extends Component {
  ...
  componentDidMount() {
    ...
    const formValue = DamageSpaceBase.unpackObjectToFormValues(initValue)
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.location} {...formItemLayout}>
                  {getFieldDecorator('location', {
                    ...
                    <SmallTextInput minLength={6} maxLength={80} size="large"  placeholder={fieldLabels.location} />
                  )}
                </Form.Item>
              </Col>
              ...
              <Col lg={24} md={24} sm={24} >
                <Form.Item label={fieldLabels.warehouse} {...formItemLayout}>
                  ...
                  <CandidateList
                    ...
                    requestFunction={DamageSpaceService.queryCandidates}  />
