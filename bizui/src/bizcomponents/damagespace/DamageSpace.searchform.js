...
import styles from './DamageSpace.search.less'
...
class DamageSpaceSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      damageSpaceList: 1,
      'damageSpaceList.searchField': fieldName,
      'damageSpaceList.searchVerb': 'startsWith',
      'damageSpaceList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`damageSpaceList.searchField`] = fieldName
    value[`damageSpaceList.searchVerb`] =  searchVerb
    value[`damageSpaceList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
      params['damageSpaceList'] = 1
      params['damageSpaceList.orderBy.0'] = "id"
      params['damageSpaceList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        damageSpaceSearchFormParameters: filterObjectKeys(fieldsValue),
...
=======
                    requestFunction={DamageSpaceService.requestCandidateWarehouse} useForSearch />
...
export default Form.create()(DamageSpaceSearchForm)
