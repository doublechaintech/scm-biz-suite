...
class KeyPairIdentitySearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {KeyPairIdentityTable} = GlobalComponents;
    const {KeyPairIdentitySearchForm} = GlobalComponents;
    const {KeyPairIdentityModalTable} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        ...
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <KeyPairIdentitySearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,KeyPairIdentityModalTable,"keyPairIdentityIds")}
...
export default Form.create()(KeyPairIdentitySearch)
