...
import styles from './EmployeeQualifier.updateform.less'
...
class EmployeeQualifierUpdateForm extends Component {
  state = {
  ...
  getSelectedRow() {
    ...
    const convertiedValues = selectedRows.map((item) => {
      return {
        ...item,
        qualifiedTime: moment(item.qualifiedTime),
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
        ...
        const employeeQualifierId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, employeeQualifierId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateEmployeeQualifier`,
          payload: {
            id: owner.id,
            type: 'employeeQualifier',
            parameters,
            selectedRows,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextEmployeeQualifierUpdateRow`,
        payload: {
          id: owner.id,
          type: 'employeeQualifier',
          selectedRows,
...
<<<<<<< HEAD
    ...
    return (
      <PageHeaderLayout
        title={"更新员工资质"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新员工资质"
...
=======
	...
	const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"Update")}员工资质: {(currentUpdateIndex+1)}/{selectedRows.length}</div>)
    }
              ...
              <Col lg={12} md={12} sm={24}>
                <Form.Item label={fieldLabels.qualifiedTime} {...formItemLayout}>
                  {getFieldDecorator('qualifiedTime', {
                    ...
                    rules: [{ required: true, message: '请输入合格的时间' }],
                  })(
                    <DatePicker format="YYYY-MM-DD" placeholder="请输入合格的时间" />
=======
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.qualifiedTime} {...formItemLayout}>
                  {getFieldDecorator('qualifiedTime', {
...
}))(Form.create()(EmployeeQualifierUpdateForm))
