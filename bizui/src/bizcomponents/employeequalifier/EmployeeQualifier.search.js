...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{employeeQualifierList:selectedRows}} owner={owner}  
...
class EmployeeQualifierSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {EmployeeQualifierTable} = GlobalComponents;
    const {EmployeeQualifierSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={`${displayName}:${this.props.name}列表`}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <EmployeeQualifierSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,EmployeeQualifierModalTable,"employeeQualifierIds")}
...
export default Form.create()(EmployeeQualifierSearch)
