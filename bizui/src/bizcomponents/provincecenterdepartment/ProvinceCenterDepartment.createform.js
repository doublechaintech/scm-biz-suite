...
import styles from './ProvinceCenterDepartment.createform.less'
...
=======
import ProvinceCenterDepartmentCreateFormBody from './ProvinceCenterDepartment.createformbody'
...
class ProvinceCenterDepartmentCreateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, ...imagesValues }
        dispatch({
          type: `${owner.type}/addProvinceCenterDepartment`,
          payload: { id: owner.id, type: 'provinceCenterDepartment', parameters, continueNext: true },
        })
      })
    }
...
<<<<<<< HEAD
      dispatch({
        ...
        payload: { id: owner.id, type: 'provinceCenterDepartment',listName:'省中心列表' },
=======
     
      dispatch({
        type: `${owner.type}/goback`,
        payload: { id: owner.id, type: 'provinceCenterDepartment',listName:appLocaleName(userContext,"List") },
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      })
    }
...
=======
	...
	return (
      ...
      >
   		...
   		<ProvinceCenterDepartmentCreateFormBody	 {...this.props} />
...
}))(Form.create()(ProvinceCenterDepartmentCreateForm))
