...
import styles from './ProvinceCenterDepartment.updateform.less'
...
class ProvinceCenterDepartmentUpdateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
        ...
        const provinceCenterDepartmentId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, provinceCenterDepartmentId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateProvinceCenterDepartment`,
          payload: {
            id: owner.id,
            type: 'provinceCenterDepartment',
            parameters,
            selectedRows,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextProvinceCenterDepartmentUpdateRow`,
        payload: {
          id: owner.id,
          type: 'provinceCenterDepartment',
          selectedRows,
...
<<<<<<< HEAD
    ...
    return (
      <PageHeaderLayout
        title={"更新省中心"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新省中心"
...
=======
	...
	const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"Update")}省中心: {(currentUpdateIndex+1)}/{selectedRows.length}</div>)
    }
...
}))(Form.create()(ProvinceCenterDepartmentUpdateForm))
