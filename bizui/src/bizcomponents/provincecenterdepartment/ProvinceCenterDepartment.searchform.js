...
class ProvinceCenterDepartmentSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      provinceCenterDepartmentList: 1,
      'provinceCenterDepartmentList.searchField': fieldName,
      'provinceCenterDepartmentList.searchVerb': 'startsWith',
      'provinceCenterDepartmentList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`provinceCenterDepartmentList.searchField`] = fieldName
    value[`provinceCenterDepartmentList.searchVerb`] =  searchVerb
    value[`provinceCenterDepartmentList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      const paramList = []
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'eq', 'provinceCenter'))
      ...
      params['provinceCenterDepartmentList'] = 1
      params['provinceCenterDepartmentList.orderBy.0'] = "id"
      params['provinceCenterDepartmentList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        provinceCenterDepartmentSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                    <Form.Item label="省中心">
                  {getFieldDecorator('provinceCenter', {
                  ...
                  <SelectObject 
                    ...
                    requestFunction={ProvinceCenterDepartmentService.requestCandidateProvinceCenter}/>
...
export default Form.create()(ProvinceCenterDepartmentSearchForm)
