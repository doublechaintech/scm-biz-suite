...
import styles from './ProvinceCenterDepartment.preference.less'
...
const internalImageListOf = (provinceCenterDepartment) =>{
<<<<<<< HEAD
...
const internalSettingListOf = (provinceCenterDepartment) =>{
<<<<<<< HEAD
...
const handleTransferSearch =(targetComponent,filterKey,newRequest)=>{
  ...
  const pageNo = 1;
  const candidateReferenceService = ProvinceCenterDepartmentService[candidateServiceName] 
...
const executeTrans = (provinceCenterDepartment,targetComponent) =>{
  ...
  validateFieldsAndScroll((error, values) => {
    ...
    const id=provinceCenterDepartment.id;
    const serviceNameToCall = transferServiceName;

    const payload = {parameters,id,serviceNameToCall}
    
    //targetComponent.setState({transferModalVisiable:false})
    dispatch({type:"_provinceCenterDepartment/doJob",payload: payload})
...
const buildTransferModal = (provinceCenterDepartment,targetComponent) => {
...
<Modal title={transferModalTitle}
          ...
          onOk={()=>executeTrans(provinceCenterDepartment,targetComponent)}
...
const internalRenderExtraHeader = (provinceCenterDepartment) =>{
	return null
}
const internalRenderExtraFooter = (provinceCenterDepartment) =>{
	return null
}
...
=======
<Description term="省中心">{provinceCenterDepartment.provinceCenter==null?appLocaleName(userContext,"NotAssigned"):provinceCenterDepartment.provinceCenter.displayName}
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
 <Icon type="swap" onClick={()=>
  showTransferModel(targetComponent,"省中心","retailStoreProvinceCenter","requestCandidateProvinceCenter",
	      "transferToAnotherProvinceCenter","anotherProvinceCenterId",provinceCenterDepartment.provinceCenter?provinceCenterDepartment.provinceCenter.id:"")} 
...
class ProvinceCenterDepartmentPreference extends Component {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
  ...
  render() {
    ...
    const { id,displayName, provinceCenterEmployeeCount } = this.props.provinceCenterDepartment
...
}))(Form.create()(ProvinceCenterDepartmentPreference))
