...
=======
import LevelThreeDepartmentCreateFormBody from './LevelThreeDepartment.createformbody'
...
class LevelThreeDepartmentCreateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, ...imagesValues }
        dispatch({
          type: `${owner.type}/addLevelThreeDepartment`,
          payload: { id: owner.id, type: 'levelThreeDepartment', parameters, continueNext: true },
        })
      })
    }
...
<<<<<<< HEAD
      dispatch({
        ...
        payload: { id: owner.id, type: 'levelThreeDepartment',listName:'三级部门列表' },
=======
     
      dispatch({
        type: `${owner.type}/goback`,
        payload: { id: owner.id, type: 'levelThreeDepartment',listName:appLocaleName(userContext,"List") },
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      })
    }
...
=======
    ...
    const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"CreateNew")}三级部门</div>)
    }
	...
	return (
      ...
      >
   		...
   		<LevelThreeDepartmentCreateFormBody	 {...this.props} />
...
}))(Form.create()(LevelThreeDepartmentCreateForm))
