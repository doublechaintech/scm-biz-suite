...
class LevelThreeDepartmentCreateFormBody extends Component {
  ...
  componentDidMount() {
    ...
    const formValue = LevelThreeDepartmentBase.unpackObjectToFormValues(initValue)
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.name} {...formItemLayout}>
                  {getFieldDecorator('name', {
                    ...
                    <SmallTextInput minLength={5} maxLength={52} size="large"  placeholder={fieldLabels.name} />
                  )}
                </Form.Item>
              </Col>
