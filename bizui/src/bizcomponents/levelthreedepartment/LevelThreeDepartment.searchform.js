...
import styles from './LevelThreeDepartment.search.less'
...
class LevelThreeDepartmentSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      levelThreeDepartmentList: 1,
      'levelThreeDepartmentList.searchField': fieldName,
      'levelThreeDepartmentList.searchVerb': 'startsWith',
      'levelThreeDepartmentList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`levelThreeDepartmentList.searchField`] = fieldName
    value[`levelThreeDepartmentList.searchVerb`] =  searchVerb
    value[`levelThreeDepartmentList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
      params['levelThreeDepartmentList'] = 1
      params['levelThreeDepartmentList.orderBy.0'] = "id"
      params['levelThreeDepartmentList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        levelThreeDepartmentSearchFormParameters: filterObjectKeys(fieldsValue),
...
<<<<<<< HEAD
                 requestFunction={LevelThreeDepartmentService.requestCandidateBelongsTo}/>
               
              
=======
                 requestFunction={LevelThreeDepartmentService.requestCandidateBelongsTo} useForSearch />
...
export default Form.create()(LevelThreeDepartmentSearchForm)
