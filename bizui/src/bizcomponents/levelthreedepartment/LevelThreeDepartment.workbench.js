...
import styles from './LevelThreeDepartment.workbench.less'
...
const internalSummaryOf = (cardsData,targetComponent) =>{
	...
	const levelThreeDepartment = cardsData.cardsSource
	const {LevelThreeDepartmentService} = GlobalComponents
	const userContext = null
	return (
	<div>
	<DescriptionList className={styles.headerList} size="small" col="4">
<Description term="ID" style={{wordBreak: 'break-all'}}>{levelThreeDepartment.id}</Description> 
...
class LevelThreeDepartmentWorkbench extends Component {
...
}))(Form.create()(LevelThreeDepartmentWorkbench))
