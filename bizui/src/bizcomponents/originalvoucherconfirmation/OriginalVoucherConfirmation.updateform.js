...
import styles from './OriginalVoucherConfirmation.updateform.less'
...
class OriginalVoucherConfirmationUpdateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
        ...
        const originalVoucherConfirmationId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, originalVoucherConfirmationId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateOriginalVoucherConfirmation`,
          payload: {
            id: owner.id,
            type: 'originalVoucherConfirmation',
            parameters,
            selectedRows,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextOriginalVoucherConfirmationUpdateRow`,
        payload: {
          id: owner.id,
          type: 'originalVoucherConfirmation',
          selectedRows,
...
<<<<<<< HEAD
    ...
    return (
      <PageHeaderLayout
        title={"更新原始凭证的确认"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新原始凭证的确认"
...
=======
	...
	const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"Update")}原始凭证的确认: {(currentUpdateIndex+1)}/{selectedRows.length}</div>)
    }
...
}))(Form.create()(OriginalVoucherConfirmationUpdateForm))
