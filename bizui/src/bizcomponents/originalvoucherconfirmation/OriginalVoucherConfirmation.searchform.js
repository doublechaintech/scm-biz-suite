...
import styles from './OriginalVoucherConfirmation.search.less'
...
class OriginalVoucherConfirmationSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      originalVoucherConfirmationList: 1,
      'originalVoucherConfirmationList.searchField': fieldName,
      'originalVoucherConfirmationList.searchVerb': 'startsWith',
      'originalVoucherConfirmationList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`originalVoucherConfirmationList.searchField`] = fieldName
    value[`originalVoucherConfirmationList.searchVerb`] =  searchVerb
    value[`originalVoucherConfirmationList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
      params['originalVoucherConfirmationList'] = 1
      params['originalVoucherConfirmationList.orderBy.0'] = "id"
      params['originalVoucherConfirmationList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        originalVoucherConfirmationSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(OriginalVoucherConfirmationSearchForm)
