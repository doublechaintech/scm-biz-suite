...
class OriginalVoucherConfirmationSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {OriginalVoucherConfirmationTable} = GlobalComponents;
    const {OriginalVoucherConfirmationSearchForm} = GlobalComponents;
    const {OriginalVoucherConfirmationModalTable} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <OriginalVoucherConfirmationSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,OriginalVoucherConfirmationModalTable,"originalVoucherConfirmationIds")}
...
export default Form.create()(OriginalVoucherConfirmationSearch)
