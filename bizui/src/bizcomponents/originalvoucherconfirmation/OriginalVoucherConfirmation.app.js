...
class OriginalVoucherConfirmationBizApp extends React.PureComponent {
  ...
  getNavMenuItems = (targetObject) => {
    ...
    return (
		  ...
		  <Menu
           ...
           >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/originalVoucherConfirmation/${this.props.originalVoucherConfirmation.id}/dashboard`}><Icon type="dashboard" /><span>仪表板</span></Link>
             </Menu.Item>
       ...
       <Menu.Item key="preference">
               <Link to={`/originalVoucherConfirmation/${this.props.originalVoucherConfirmation.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
  ...
  getOriginalVoucherCreateForm = () => {
    ...
    return connect(state => ({
      ...
      searchFormParameters: state._originalVoucherConfirmation.originalVoucherSearchFormParameters,
      loading: state._originalVoucherConfirmation.loading,
      owner: { type: '_originalVoucherConfirmation', id: state._originalVoucherConfirmation.id, referenceName: 'confirmation', listName: 'originalVoucherList', ref:state._originalVoucherConfirmation, listDisplayName: '原始凭证列表'}, // this is for model namespace and
  ...
  getOriginalVoucherUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_originalVoucherConfirmation', id: state._originalVoucherConfirmation.id, listName: 'originalVoucherList', ref:state._originalVoucherConfirmation, listDisplayName: '原始凭证列表' }, // this is for model namespace and
  ...
  buildRouters = () =>{
  	...
  	const {OriginalVoucherConfirmationPreference} = GlobalComponents
  	
  	
  	const routers=[
  	{path:"/originalVoucherConfirmation/:id/dashboard", component: OriginalVoucherConfirmationDashboard},
  	{path:"/originalVoucherConfirmation/:id/preference", component: OriginalVoucherConfirmationPreference},
  ...
  handleOpenChange = (openKeys) => {
   ...
   render() {
     ...
     //const {OriginalVoucherConfirmationEditDetail} = GlobalComponents
     //const {OriginalVoucherConfirmationViewDetail} = GlobalComponents
     ...
     <Layout>
       ...
       <Layout>
		 ...
		 {this.getNavMenuItems(this.props.originalVoucherConfirmation)}
