...
=======
    ...
    const {searchLocalData}=GlobalComponents.OriginalVoucherConfirmationBase
...
=======
      {this.state.showSearch&&(
        ...
        <div style={{backgroundColor:'black'}}  onClick={()=>hideSearchResult()}  >{searchLocalData(this.props.originalVoucherConfirmation,this.state.searchKeyword)}</div>
