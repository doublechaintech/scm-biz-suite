...
const internalSummaryOf = (item, targetComponents)=>{
	...
	return GlobalComponents.OriginalVoucherConfirmationBase.renderItemOfList(item, targetComponents)

}



class OriginalVoucherConfirmationProfile extends Component {
...
}))(Form.create()(OriginalVoucherConfirmationProfile))
