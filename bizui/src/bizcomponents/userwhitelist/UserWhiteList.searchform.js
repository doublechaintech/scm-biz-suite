...
class UserWhiteListSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      userWhiteListList: 1,
      'userWhiteListList.searchField': fieldName,
      'userWhiteListList.searchVerb': 'startsWith',
      'userWhiteListList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`userWhiteListList.searchField`] = fieldName
    value[`userWhiteListList.searchVerb`] =  searchVerb
    value[`userWhiteListList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'contains', 'userIdentity'))
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'contains', 'userSpecialFunctions'))
...
=======
      ...
      const {listName} = owner
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'contains', 'userIdentity'))
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'contains', 'userSpecialFunctions'))
...
<<<<<<< HEAD
      params['userWhiteListList'] = 1
      params['userWhiteListList.orderBy.0'] = "id"
      params['userWhiteListList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        userWhiteListSearchFormParameters: filterObjectKeys(fieldsValue),
...
=======
                    requestFunction={UserWhiteListService.requestCandidateDomain} useForSearch />
...
export default Form.create()(UserWhiteListSearchForm)
