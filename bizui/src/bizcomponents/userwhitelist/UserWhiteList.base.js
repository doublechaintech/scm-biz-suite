...
const displayColumns = [
  { title: fieldLabels.id, debugtype: 'string', dataIndex: 'id', width: '6', render: (text, record)=>renderTextCell(text,record,'userWhiteList') , sorter: true },
...
const renderItemOfList=(userWhiteList, targetComponent, columCount, listName)=>{
  ...
  const userContext = null
  return (
    <Card key={`${listName}-${userWhiteList.id}`} style={{marginTop:"10px"}}>
