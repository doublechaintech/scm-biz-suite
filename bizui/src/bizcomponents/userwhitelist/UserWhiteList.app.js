 ...
 getNavMenuItems = (targetObject, style, customTheme) => {
  ...
  getRequestTypeStepForm = () => {
    ...
    return connect(state => ({
      selectedRows: state._userWhiteList.selectedRows,
      role: "cq",
      currentUpdateIndex: state._userWhiteList.currentUpdateIndex,
      owner: { type: '_userWhiteList', id: state._userWhiteList.id, listName: 'nolist', ref:state._userWhiteList, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
  ...
  handleOpenChange = (openKeys) => {
   ...
   render() {
    ...
    const {searchLocalData}=GlobalComponents.UserWhiteListBase
    ...
    const renderMenuSwitch=()=>{
     ...
     <Layout>
      ...
      {this.state.showSearch&&(
        ...
        <div style={{backgroundColor:'black'}}  onClick={()=>hideSearchResult()}  >{searchLocalData(this.props.userWhiteList,this.state.searchKeyword)}</div>
       ...
       <Sider
        ...
        >
         ...
         {this.getNavMenuItems(this.props.userWhiteList,"inline","dark")}
