  ...
  render() {
	...
	return (
      <PageHeaderLayout
        ...
        content={`${appLocaleName(userContext,"CreateNew")}${window.trans('user_white_list')}`}
        wrapperClassName={styles.advancedForm}
      >
   			
   		<UserWhiteListCreateFormBody	 {...this.props} handleImageChange={this.handleImageChange}/>
