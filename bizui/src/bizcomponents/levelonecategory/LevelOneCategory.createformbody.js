...
class LevelOneCategoryCreateFormBody extends Component {
  state = {
  ...
  componentDidMount() {
    ...
    const formValue = LevelOneCategoryBase.unpackObjectToFormValues(initValue)
  ...
  render() {
    ...
    const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"CreateNew")}{window.trans('level_one_category')}</div>)
    }
              ...
              <Col lg={24} md={24} sm={24} >
                <Form.Item label={fieldLabels.catalog} {...formItemLayout}>
                  ...
                  <CandidateList
                    ...
                    requestFunction={LevelOneCategoryService.queryCandidates}  />
...
}))(Form.create()(LevelOneCategoryCreateFormBody))
