...
const internalSummaryOf = (item, targetComponents)=>{
	...
	return GlobalComponents.LevelOneCategoryBase.renderItemOfList(item, targetComponents)

}



class LevelOneCategoryProfile extends Component {
...
}))(Form.create()(LevelOneCategoryProfile))
