...
<Description term="目录">{levelOneCategory.catalog==null?appLocaleName(userContext,"NotAssigned"):levelOneCategory.catalog.displayName}
 <Icon type="swap" onClick={()=>
  showTransferModel(targetComponent,"目录","catalog","requestCandidateCatalog",
