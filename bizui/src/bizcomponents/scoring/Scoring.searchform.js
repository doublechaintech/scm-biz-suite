...
import styles from './Scoring.search.less'
...
class ScoringSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      scoringList: 1,
      'scoringList.searchField': fieldName,
      'scoringList.searchVerb': 'startsWith',
      'scoringList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`scoringList.searchField`] = fieldName
    value[`scoringList.searchVerb`] =  searchVerb
    value[`scoringList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'contains', 'scoredBy'))
...
=======
      ...
      const {listName} = owner
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'contains', 'scoredBy'))
...
<<<<<<< HEAD
      params['scoringList'] = 1
      params['scoringList.orderBy.0'] = "id"
      params['scoringList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        scoringSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(ScoringSearchForm)
