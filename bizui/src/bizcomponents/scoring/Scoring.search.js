...
class ScoringSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {ScoringTable} = GlobalComponents;
    const {ScoringSearchForm} = GlobalComponents;
    const {ScoringModalTable} = GlobalComponents;
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
        ...
        {showDeletionDialog(this,ScoringModalTable,"scoringIds")}
...
export default Form.create()(ScoringSearch)
