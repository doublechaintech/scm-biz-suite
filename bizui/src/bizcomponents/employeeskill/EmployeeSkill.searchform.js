...
import styles from './EmployeeSkill.search.less'
...
class EmployeeSkillSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      employeeSkillList: 1,
      'employeeSkillList.searchField': fieldName,
      'employeeSkillList.searchVerb': 'startsWith',
      'employeeSkillList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`employeeSkillList.searchField`] = fieldName
    value[`employeeSkillList.searchVerb`] =  searchVerb
    value[`employeeSkillList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'eq', 'skillType'))
...
=======
      ...
      const {listName} = owner
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'eq', 'skillType'))
...
<<<<<<< HEAD
      params['employeeSkillList'] = 1
      params['employeeSkillList.orderBy.0'] = "id"
      params['employeeSkillList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        employeeSkillSearchFormParameters: filterObjectKeys(fieldsValue),
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
               ...
               <SelectObject 
                 ...
                 targetType={"employee"} 
<<<<<<< HEAD
                 requestFunction={EmployeeSkillService.requestCandidateEmployee}/>
               
              
=======
                 requestFunction={EmployeeSkillService.requestCandidateEmployee} useForSearch />
...
<<<<<<< HEAD
                  {getFieldDecorator('skillType', {
                    initialValue: tryinit('skillType'),
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
                  ...
                  <SelectObject 
                    disabled={!availableForEdit('skillType')}
                    targetType={"skillType"} 
<<<<<<< HEAD
                    requestFunction={EmployeeSkillService.requestCandidateSkillType}/>
                  
=======
                    requestFunction={EmployeeSkillService.requestCandidateSkillType} useForSearch />
...
export default Form.create()(EmployeeSkillSearchForm)
