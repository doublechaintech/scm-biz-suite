...
const internalImageListOf = (employeeSkill) =>{
<<<<<<< HEAD
...
const internalSettingListOf = (employeeSkill) =>{
<<<<<<< HEAD
...
const handleTransferSearch =(targetComponent,filterKey,newRequest)=>{
  ...
  const pageNo = 1;
  const candidateReferenceService = EmployeeSkillService[candidateServiceName] 
...
const executeTrans = (employeeSkill,targetComponent) =>{
...
const buildTransferModal = (employeeSkill,targetComponent) => {
...
<Modal title={transferModalTitle}
          ...
          onOk={()=>executeTrans(employeeSkill,targetComponent)}
...
const internalRenderExtraHeader = (employeeSkill) =>{
	return null
}
const internalRenderExtraFooter = (employeeSkill) =>{
	return null
}
...
=======
	...
	<DescriptionList className={styles.headerList} size="small" col="4">
<Description term="序号">{employeeSkill.id}</Description> 
<Description term="员工">{employeeSkill.employee==null?appLocaleName(userContext,"NotAssigned"):employeeSkill.employee.displayName}
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
 <Icon type="swap" onClick={()=>
  showTransferModel(targetComponent,"员工","employee","requestCandidateEmployee",
	      "transferToAnotherEmployee","anotherEmployeeId",employeeSkill.employee?employeeSkill.employee.id:"")} 
  style={{fontSize: 20,color:"red"}} />
</Description>
<<<<<<< HEAD
<Description term="技能类型">{employeeSkill.skillType==null?"未分配":employeeSkill.skillType.displayName}
=======
<Description term="技能类型">{employeeSkill.skillType==null?appLocaleName(userContext,"NotAssigned"):employeeSkill.skillType.displayName}
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
 <Icon type="swap" onClick={()=>
  showTransferModel(targetComponent,"技能类型","skillType","requestCandidateSkillType",
	      "transferToAnotherSkillType","anotherSkillTypeId",employeeSkill.skillType?employeeSkill.skillType.id:"")} 
  style={{fontSize: 20,color:"red"}} />
</Description>
...
class EmployeeSkillPreference extends Component {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
  ...
  render() {
    ...
    const cardsData = {cardsName:"员工技能",cardsFor: "employeeSkill",cardsSource: this.props.employeeSkill,
  		subItems: [
...
}))(Form.create()(EmployeeSkillPreference))
