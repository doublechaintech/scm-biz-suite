...
const internalSummaryOf = (item, targetComponents)=>{
	...
	return GlobalComponents.FormMessageBase.renderItemOfList(item, targetComponents)

}



class FormMessageProfile extends Component {
...
}))(Form.create()(FormMessageProfile))
