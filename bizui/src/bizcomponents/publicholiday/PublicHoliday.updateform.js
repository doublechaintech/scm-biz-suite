...
import styles from './PublicHoliday.updateform.less'
...
class PublicHolidayUpdateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
        ...
        const publicHolidayId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, publicHolidayId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updatePublicHoliday`,
          payload: {
            id: owner.id,
            type: 'publicHoliday',
            parameters,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextPublicHolidayUpdateRow`,
        payload: {
          id: owner.id,
          type: 'publicHoliday',
          selectedRows,
...
<<<<<<< HEAD
    ...
    return (
      <PageHeaderLayout
        title={"更新公共假日"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新公共假日"
...
=======
	...
	const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"Update")}公共假日: {(currentUpdateIndex+1)}/{selectedRows.length}</div>)
    }
...
}))(Form.create()(PublicHolidayUpdateForm))
