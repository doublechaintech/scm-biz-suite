...
class PublicHolidaySearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      publicHolidayList: 1,
      'publicHolidayList.searchField': fieldName,
      'publicHolidayList.searchVerb': 'startsWith',
      'publicHolidayList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`publicHolidayList.searchField`] = fieldName
    value[`publicHolidayList.searchVerb`] =  searchVerb
    value[`publicHolidayList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
      params['publicHolidayList'] = 1
      params['publicHolidayList.orderBy.0'] = "id"
      params['publicHolidayList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        publicHolidaySearchFormParameters: filterObjectKeys(fieldsValue),
...
=======
                    requestFunction={PublicHolidayService.requestCandidateCompany} useForSearch />
...
export default Form.create()(PublicHolidaySearchForm)
