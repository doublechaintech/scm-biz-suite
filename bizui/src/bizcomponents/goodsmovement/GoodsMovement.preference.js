...
const internalImageListOf = (goodsMovement) =>{
<<<<<<< HEAD
...
const internalSettingListOf = (goodsMovement) =>{
<<<<<<< HEAD
...
const handleTransferSearch =(targetComponent,filterKey,newRequest)=>{
  ...
  const pageNo = 1;
  const candidateReferenceService = GoodsMovementService[candidateServiceName] 
...
const executeTrans = (goodsMovement,targetComponent) =>{
...
const buildTransferModal = (goodsMovement,targetComponent) => {
...
<Modal title={transferModalTitle}
          ...
          onOk={()=>executeTrans(goodsMovement,targetComponent)}
...
const internalRenderExtraHeader = (goodsMovement) =>{
	return null
}
const internalRenderExtraFooter = (goodsMovement) =>{
	return null
}
...
=======
<Description term="货物">{goodsMovement.goods==null?appLocaleName(userContext,"NotAssigned"):goodsMovement.goods.displayName}
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
 <Icon type="swap" onClick={()=>
  showTransferModel(targetComponent,"货物","goods","requestCandidateGoods",
	      "transferToAnotherGoods","anotherGoodsId",goodsMovement.goods?goodsMovement.goods.id:"")} 
...
class GoodsMovementPreference extends Component {
...
}))(Form.create()(GoodsMovementPreference))
