...
/*
const testValues = {
  moveTime: '2019-12-05 21:20:42',
  facility: '仓库货位',
  facilityId: '仓库货位',
  fromIp: '192.168.20.1',
  sessionId: 'FTYUIOLJYT^*(PLKJYT)',
  latitude: '42.289444378387316',
  longitude: '130.3964172005069',
  goodsId: 'G000001',
  ...
  render() {
	...
	return (
      <PageHeaderLayout
        ...
        content={`${appLocaleName(userContext,"CreateNew")}${window.trans('goods_movement')}`}
