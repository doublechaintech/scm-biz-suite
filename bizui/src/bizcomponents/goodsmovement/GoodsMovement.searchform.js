...
class GoodsMovementSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      goodsMovementList: 1,
      'goodsMovementList.searchField': fieldName,
      'goodsMovementList.searchVerb': 'startsWith',
      'goodsMovementList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      const paramList = []
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'contains', 'facility'))
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'contains', 'facilityId'))
      ...
      dispatch({
        ...
        goodsMovementSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(GoodsMovementSearchForm)
