...
class RetailStoreMemberGiftCardConsumeRecordCreateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, ...imagesValues }
        dispatch({
          type: `${owner.type}/addRetailStoreMemberGiftCardConsumeRecord`,
          payload: { id: owner.id, type: 'retailStoreMemberGiftCardConsumeRecord', parameters, continueNext: true },
        })
      })
    }
...
}))(Form.create()(RetailStoreMemberGiftCardConsumeRecordCreateForm))
