...
const internalImageListOf = (retailStoreMemberGiftCardConsumeRecord) =>{
<<<<<<< HEAD
...
const internalSettingListOf = (retailStoreMemberGiftCardConsumeRecord) =>{
<<<<<<< HEAD
...
const handleTransferSearch =(targetComponent,filterKey,newRequest)=>{
  ...
  const pageNo = 1;
  const candidateReferenceService = RetailStoreMemberGiftCardConsumeRecordService[candidateServiceName] 
...
const executeTrans = (retailStoreMemberGiftCardConsumeRecord,targetComponent) =>{
  ...
  validateFieldsAndScroll((error, values) => {
    ...
    const id=retailStoreMemberGiftCardConsumeRecord.id;
    const serviceNameToCall = transferServiceName;

    const payload = {parameters,id,serviceNameToCall}
    
    //targetComponent.setState({transferModalVisiable:false})
    dispatch({type:"_retailStoreMemberGiftCardConsumeRecord/doJob",payload: payload})
...
const buildTransferModal = (retailStoreMemberGiftCardConsumeRecord,targetComponent) => {
...
<Modal title={transferModalTitle}
          ...
          onOk={()=>executeTrans(retailStoreMemberGiftCardConsumeRecord,targetComponent)}
...
const internalRenderExtraHeader = (retailStoreMemberGiftCardConsumeRecord) =>{
	return null
}
const internalRenderExtraFooter = (retailStoreMemberGiftCardConsumeRecord) =>{
	return null
}
...
=======
<Description term="业主">{retailStoreMemberGiftCardConsumeRecord.owner==null?appLocaleName(userContext,"NotAssigned"):retailStoreMemberGiftCardConsumeRecord.owner.displayName}
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
 <Icon type="swap" onClick={()=>
  showTransferModel(targetComponent,"业主","retailStoreMemberGiftCard","requestCandidateOwner",
	      "transferToAnotherOwner","anotherOwnerId",retailStoreMemberGiftCardConsumeRecord.owner?retailStoreMemberGiftCardConsumeRecord.owner.id:"")} 
...
=======
<Description term="订单">{retailStoreMemberGiftCardConsumeRecord.bizOrder==null?appLocaleName(userContext,"NotAssigned"):retailStoreMemberGiftCardConsumeRecord.bizOrder.displayName}
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
 <Icon type="swap" onClick={()=>
  showTransferModel(targetComponent,"订单","consumerOrder","requestCandidateBizOrder",
	      "transferToAnotherBizOrder","anotherBizOrderId",retailStoreMemberGiftCardConsumeRecord.bizOrder?retailStoreMemberGiftCardConsumeRecord.bizOrder.id:"")} 
  style={{fontSize: 20,color:"red"}} />
</Description>
...
class RetailStoreMemberGiftCardConsumeRecordPreference extends Component {
...
}))(Form.create()(RetailStoreMemberGiftCardConsumeRecordPreference))
