...
class GoodsAllocationSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      goodsAllocationList: 1,
      'goodsAllocationList.searchField': fieldName,
      'goodsAllocationList.searchVerb': 'startsWith',
      'goodsAllocationList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`goodsAllocationList.searchField`] = fieldName
    value[`goodsAllocationList.searchVerb`] =  searchVerb
    value[`goodsAllocationList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'eq', 'goodsShelf'))
=======
      ...
      const {listName} = owner
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'eq', 'goodsShelf'))
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
...
<<<<<<< HEAD
      params['goodsAllocationList'] = 1
      params['goodsAllocationList.orderBy.0'] = "id"
      params['goodsAllocationList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        goodsAllocationSearchFormParameters: filterObjectKeys(fieldsValue),
...
<<<<<<< HEAD
                    requestFunction={GoodsAllocationService.requestCandidateGoodsShelf}/>
...
export default Form.create()(GoodsAllocationSearchForm)
