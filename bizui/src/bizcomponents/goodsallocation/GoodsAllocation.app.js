...
<<<<<<< HEAD
    ...
    return (
		  ...
		  <Menu
           ...
           >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/goodsAllocation/${this.props.goodsAllocation.id}/dashboard`}><Icon type="dashboard" /><span>仪表板</span></Link>
             </Menu.Item>
       ...
       <Menu.Item key="preference">
               <Link to={`/goodsAllocation/${this.props.goodsAllocation.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
    ...
    return (
	  <Menu
       ...
       >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/goodsAllocation/${this.props.goodsAllocation.id}/dashboard`}><Icon type="dashboard" style={{marginRight:"20px"}}/><span>{appLocaleName(userContext,"Dashboard")}</span></Link>
             </Menu.Item>
...
<<<<<<< HEAD
      ...
      searchFormParameters: state._goodsAllocation.goodsSearchFormParameters,
      loading: state._goodsAllocation.loading,
      owner: { type: '_goodsAllocation', id: state._goodsAllocation.id, referenceName: 'goodsAllocation', listName: 'goodsList', ref:state._goodsAllocation, listDisplayName: '货物列表'}, // this is for model namespace and
=======
      returnURL: `/goodsAllocation/${state._goodsAllocation.id}/list`,
      currentPage: state._goodsAllocation.goodsCurrentPageNumber,
      searchFormParameters: state._goodsAllocation.goodsSearchFormParameters,
      loading: state._goodsAllocation.loading,
      owner: { type: '_goodsAllocation', id: state._goodsAllocation.id, referenceName: 'goodsAllocation', listName: 'goodsList', ref:state._goodsAllocation, listDisplayName: appLocaleName(userContext,"List")}, // this is for model namespace and
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
    }))(GoodsCreateForm)
  }
...
<<<<<<< HEAD
      owner: { type: '_goodsAllocation', id: state._goodsAllocation.id, listName: 'goodsList', ref:state._goodsAllocation, listDisplayName: '货物列表' }, // this is for model namespace and
=======
      owner: { type: '_goodsAllocation', id: state._goodsAllocation.id, listName: 'goodsList', ref:state._goodsAllocation, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
    }))(GoodsUpdateForm)
  }
...
<<<<<<< HEAD
  	const {GoodsAllocationPreference} = GlobalComponents
=======
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
  	...
  	const routers=[
  	{path:"/goodsAllocation/:id/dashboard", component: GoodsAllocationDashboard},
<<<<<<< HEAD
  	{path:"/goodsAllocation/:id/preference", component: GoodsAllocationPreference},
=======
...
<<<<<<< HEAD
     ...
     //const {GoodsAllocationEditDetail} = GlobalComponents
     //const {GoodsAllocationViewDetail} = GlobalComponents
     ...
     <Layout>
       ...
       <Layout>
		 ...
		 {this.getNavMenuItems(this.props.goodsAllocation)}
...
=======
 ...
 <Header>
        ...
        <Col {...naviBarResponsiveStyle} >
            <Dropdown overlay= {this.getNavMenuItems(this.props.goodsAllocation)}>
