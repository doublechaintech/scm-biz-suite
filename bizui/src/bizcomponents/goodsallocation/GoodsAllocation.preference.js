...
const internalImageListOf = (goodsAllocation) =>{
<<<<<<< HEAD
...
const internalSettingListOf = (goodsAllocation) =>{
<<<<<<< HEAD
...
const handleTransferSearch =(targetComponent,filterKey,newRequest)=>{
  ...
  const pageNo = 1;
  const candidateReferenceService = GoodsAllocationService[candidateServiceName] 
...
const executeTrans = (goodsAllocation,targetComponent) =>{
...
const buildTransferModal = (goodsAllocation,targetComponent) => {
...
<Modal title={transferModalTitle}
          ...
          onOk={()=>executeTrans(goodsAllocation,targetComponent)}
...
const internalRenderExtraHeader = (goodsAllocation) =>{
	return null
}
const internalRenderExtraFooter = (goodsAllocation) =>{
	return null
}
...
<<<<<<< HEAD
<Description term="货架">{goodsAllocation.goodsShelf==null?"未分配":goodsAllocation.goodsShelf.displayName}
=======
<Description term="货架">{goodsAllocation.goodsShelf==null?appLocaleName(userContext,"NotAssigned"):goodsAllocation.goodsShelf.displayName}
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
 <Icon type="swap" onClick={()=>
  showTransferModel(targetComponent,"货架","goodsShelf","requestCandidateGoodsShelf",
	      "transferToAnotherGoodsShelf","anotherGoodsShelfId",goodsAllocation.goodsShelf?goodsAllocation.goodsShelf.id:"")} 
...
class GoodsAllocationPreference extends Component {
