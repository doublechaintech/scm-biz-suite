...
import styles from './RetailStoreOrderPaymentGroup.search.less'
...
class RetailStoreOrderPaymentGroupSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      retailStoreOrderPaymentGroupList: 1,
      'retailStoreOrderPaymentGroupList.searchField': fieldName,
      'retailStoreOrderPaymentGroupList.searchVerb': 'startsWith',
      'retailStoreOrderPaymentGroupList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`retailStoreOrderPaymentGroupList.searchField`] = fieldName
    value[`retailStoreOrderPaymentGroupList.searchVerb`] =  searchVerb
    value[`retailStoreOrderPaymentGroupList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'contains', 'cardNumber'))
=======
      ...
      const {listName} = owner
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'contains', 'cardNumber'))
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
...
<<<<<<< HEAD
      params['retailStoreOrderPaymentGroupList'] = 1
      params['retailStoreOrderPaymentGroupList.orderBy.0'] = "id"
      params['retailStoreOrderPaymentGroupList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        retailStoreOrderPaymentGroupSearchFormParameters: filterObjectKeys(fieldsValue),
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
                  ...
                  <SelectObject 
                    ...
                    targetType={"bizOrder"} 
<<<<<<< HEAD
                    requestFunction={RetailStoreOrderPaymentGroupService.requestCandidateBizOrder}/>
                  
=======
                    requestFunction={RetailStoreOrderPaymentGroupService.requestCandidateBizOrder} useForSearch />
...
export default Form.create()(RetailStoreOrderPaymentGroupSearchForm)
