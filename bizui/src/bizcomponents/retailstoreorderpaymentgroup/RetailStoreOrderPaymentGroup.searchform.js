...
componentDidMount() {
 ...
 <Col md={8} sm={24}>
                  ...
                  <CandidateList 
		                 ...
		                 ownerId={owner.id}
		                 scenarioCode={"search"}
		                 listType={"retail_store_order_payment_group"} 
		                 targetType={"retail_store_order"} 
                 
                    requestFunction={RetailStoreOrderPaymentGroupService.queryCandidates} useForSearch />
          ...
          <Col md={8} sm={24}>
            <FormItem label={fieldLabels.cardNumber}>
