...
const renderItemOfList=(retailStoreOrderPaymentGroup, targetComponent, columCount, listName)=>{
  ...
  const userContext = null
  return (
    <Card key={`${listName}-${retailStoreOrderPaymentGroup.id}`} style={{marginTop:"10px"}}>
...
const RetailStoreOrderPaymentGroupBase={menuData,settingMenuData,displayColumns,fieldLabels,renderItemOfList, stepOf, searchLocalData}
