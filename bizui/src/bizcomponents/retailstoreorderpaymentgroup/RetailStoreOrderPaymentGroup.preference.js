...
<Description term="订单">{retailStoreOrderPaymentGroup.bizOrder==null?appLocaleName(userContext,"NotAssigned"):retailStoreOrderPaymentGroup.bizOrder.displayName}
