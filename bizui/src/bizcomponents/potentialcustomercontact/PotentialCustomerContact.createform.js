...
=======
import PotentialCustomerContactCreateFormBody from './PotentialCustomerContact.createformbody'
...
const testValues = {
  name: '和连载客户的联系记录',
<<<<<<< HEAD
  contactDate: '2018-06-23',
=======
  contactDate: '2017-04-06',
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
  contactMethod: '电话',
  description: '转化希望很大',
...
class PotentialCustomerContactCreateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, ...imagesValues }
        dispatch({
          type: `${owner.type}/addPotentialCustomerContact`,
          payload: { id: owner.id, type: 'potentialCustomerContact', parameters, continueNext: true },
        })
      })
    }
...
<<<<<<< HEAD
      dispatch({
        ...
        payload: { id: owner.id, type: 'potentialCustomerContact',listName:'潜在客户联系列表' },
=======
     
      dispatch({
        type: `${owner.type}/goback`,
        payload: { id: owner.id, type: 'potentialCustomerContact',listName:appLocaleName(userContext,"List") },
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      })
    }
...
}))(Form.create()(PotentialCustomerContactCreateForm))
