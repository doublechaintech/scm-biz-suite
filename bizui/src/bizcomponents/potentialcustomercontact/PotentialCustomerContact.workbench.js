...
import styles from './PotentialCustomerContact.workbench.less'
...
class PotentialCustomerContactWorkbench extends Component {
...
}))(Form.create()(PotentialCustomerContactWorkbench))
