...
import styles from './ReportLine.search.less'
...
class ReportLineSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      reportLineList: 1,
      'reportLineList.searchField': fieldName,
      'reportLineList.searchVerb': 'startsWith',
      'reportLineList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`reportLineList.searchField`] = fieldName
    value[`reportLineList.searchVerb`] =  searchVerb
    value[`reportLineList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      params['reportLineList'] = 1
      params['reportLineList.orderBy.0'] = "id"
      params['reportLineList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        reportLineSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(ReportLineSearchForm)
