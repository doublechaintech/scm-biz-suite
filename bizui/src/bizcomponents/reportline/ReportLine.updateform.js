...
import styles from './ReportLine.updateform.less'
...
class ReportLineUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const reportLineId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, reportLineId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateReportLine`,
          payload: {
            id: owner.id,
            type: 'reportLine',
            parameters,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextReportLineUpdateRow`,
        payload: {
          id: owner.id,
          type: 'reportLine',
          selectedRows,
    ...
    return (
      <PageHeaderLayout
        title={"更新报告线"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新报告线"
              ...
              <Col lg={12} md={12} sm={24}>
                <Form.Item label={fieldLabels.january} {...formItemLayout}>
                  {getFieldDecorator('january', {
                    initialValue: selectedRow.january,
              ...
              <Col lg={12} md={12} sm={24}>
                <Form.Item label={fieldLabels.february} {...formItemLayout}>
                  {getFieldDecorator('february', {
                    initialValue: selectedRow.february,
              ...
              <Col lg={12} md={12} sm={24}>
                <Form.Item label={fieldLabels.march} {...formItemLayout}>
                  {getFieldDecorator('march', {
                    initialValue: selectedRow.march,
              ...
              <Col lg={12} md={12} sm={24}>
                <Form.Item label={fieldLabels.april} {...formItemLayout}>
                  {getFieldDecorator('april', {
                    initialValue: selectedRow.april,
              ...
              <Col lg={12} md={12} sm={24}>
                <Form.Item label={fieldLabels.august} {...formItemLayout}>
                  {getFieldDecorator('august', {
                    initialValue: selectedRow.august,
              ...
              <Col lg={12} md={12} sm={24}>
                <Form.Item label={fieldLabels.september} {...formItemLayout}>
                  {getFieldDecorator('september', {
                    initialValue: selectedRow.september,
              ...
              <Col lg={12} md={12} sm={24}>
                <Form.Item label={fieldLabels.october} {...formItemLayout}>
                  {getFieldDecorator('october', {
                    initialValue: selectedRow.october,
              ...
              <Col lg={12} md={12} sm={24}>
                <Form.Item label={fieldLabels.november} {...formItemLayout}>
                  {getFieldDecorator('november', {
                    initialValue: selectedRow.november,
              ...
              <Col lg={12} md={12} sm={24}>
                <Form.Item label={fieldLabels.december} {...formItemLayout}>
                  {getFieldDecorator('december', {
                    initialValue: selectedRow.december,
...
}))(Form.create()(ReportLineUpdateForm))
