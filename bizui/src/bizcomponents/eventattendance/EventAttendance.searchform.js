...
class EventAttendanceSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      eventAttendanceList: 1,
      'eventAttendanceList.searchField': fieldName,
      'eventAttendanceList.searchVerb': 'startsWith',
      'eventAttendanceList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`eventAttendanceList.searchField`] = fieldName
    value[`eventAttendanceList.searchVerb`] =  searchVerb
    value[`eventAttendanceList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'eq', 'cityEvent'))
...
=======
      ...
      const {listName} = owner
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'eq', 'cityEvent'))
...
<<<<<<< HEAD
      params['eventAttendanceList'] = 1
      params['eventAttendanceList.orderBy.0'] = "id"
      params['eventAttendanceList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        eventAttendanceSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(EventAttendanceSearchForm)
