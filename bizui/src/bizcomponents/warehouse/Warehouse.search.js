...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{warehouseList:selectedRows}} owner={owner}  
...
class WarehouseSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {WarehouseTable} = GlobalComponents;
    const {WarehouseSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <WarehouseSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,WarehouseModalTable,"warehouseIds")}
...
export default Form.create()(WarehouseSearch)
