...
import styles from './Warehouse.search.less'
...
class WarehouseSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      warehouseList: 1,
      'warehouseList.searchField': fieldName,
      'warehouseList.searchVerb': 'startsWith',
      'warehouseList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`warehouseList.searchField`] = fieldName
    value[`warehouseList.searchVerb`] =  searchVerb
    value[`warehouseList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
      params['warehouseList'] = 1
      params['warehouseList.orderBy.0'] = "id"
      params['warehouseList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        warehouseSearchFormParameters: filterObjectKeys(fieldsValue),
...
=======
                    requestFunction={WarehouseService.requestCandidateOwner} useForSearch />
...
export default Form.create()(WarehouseSearchForm)
