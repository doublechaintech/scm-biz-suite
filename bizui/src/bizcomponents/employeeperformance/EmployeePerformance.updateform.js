...
import styles from './EmployeePerformance.updateform.less'
...
class EmployeePerformanceUpdateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
        ...
        const employeePerformanceId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, employeePerformanceId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateEmployeePerformance`,
          payload: {
            id: owner.id,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextEmployeePerformanceUpdateRow`,
        payload: {
          id: owner.id,
          type: 'employeePerformance',
          selectedRows,
...
<<<<<<< HEAD
    ...
    return (
      <PageHeaderLayout
        title={"更新员工绩效"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新员工绩效"
...
=======
	...
	const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"Update")}员工绩效: {(currentUpdateIndex+1)}/{selectedRows.length}</div>)
    }
              ...
              <Col lg={12} md={12} sm={24}>
                <Form.Item label={fieldLabels.performanceComment} {...formItemLayout}>
                  {getFieldDecorator('performanceComment', {
                    ...
                    rules: [{ required: true, message: '请输入绩效评价' }],
                  })(
...
}))(Form.create()(EmployeePerformanceUpdateForm))
