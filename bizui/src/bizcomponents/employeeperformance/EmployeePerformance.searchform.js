...
class EmployeePerformanceSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      employeePerformanceList: 1,
      'employeePerformanceList.searchField': fieldName,
      'employeePerformanceList.searchVerb': 'startsWith',
      'employeePerformanceList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`employeePerformanceList.searchField`] = fieldName
    value[`employeePerformanceList.searchVerb`] =  searchVerb
    value[`employeePerformanceList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'contains', 'performanceComment'))
=======
      ...
      const {listName} = owner
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'contains', 'performanceComment'))
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
...
<<<<<<< HEAD
      params['employeePerformanceList'] = 1
      params['employeePerformanceList.orderBy.0'] = "id"
      params['employeePerformanceList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        employeePerformanceSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(EmployeePerformanceSearchForm)
