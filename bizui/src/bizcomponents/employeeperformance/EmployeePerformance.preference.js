...
const internalImageListOf = (employeePerformance) =>{
<<<<<<< HEAD
...
const internalSettingListOf = (employeePerformance) =>{
<<<<<<< HEAD
...
const handleTransferSearch =(targetComponent,filterKey,newRequest)=>{
  ...
  const pageNo = 1;
  const candidateReferenceService = EmployeePerformanceService[candidateServiceName] 
...
const executeTrans = (employeePerformance,targetComponent) =>{
...
const buildTransferModal = (employeePerformance,targetComponent) => {
...
<Modal title={transferModalTitle}
          ...
          onOk={()=>executeTrans(employeePerformance,targetComponent)}
...
const internalRenderExtraHeader = (employeePerformance) =>{
	return null
}
const internalRenderExtraFooter = (employeePerformance) =>{
	return null
}
...
=======
	...
	<DescriptionList className={styles.headerList} size="small" col="4">
<Description term="序号">{employeePerformance.id}</Description> 
<Description term="员工">{employeePerformance.employee==null?appLocaleName(userContext,"NotAssigned"):employeePerformance.employee.displayName}
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
 <Icon type="swap" onClick={()=>
  showTransferModel(targetComponent,"员工","employee","requestCandidateEmployee",
	      "transferToAnotherEmployee","anotherEmployeeId",employeePerformance.employee?employeePerformance.employee.id:"")} 
...
class EmployeePerformancePreference extends Component {
...
}))(Form.create()(EmployeePerformancePreference))
