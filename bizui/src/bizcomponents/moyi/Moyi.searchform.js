...
import styles from './Moyi.search.less'
...
class MoyiSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      moyiList: 1,
      'moyiList.searchField': fieldName,
      'moyiList.searchVerb': 'startsWith',
      'moyiList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`moyiList.searchField`] = fieldName
    value[`moyiList.searchVerb`] =  searchVerb
    value[`moyiList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      params['moyiList'] = 1
      params['moyiList.orderBy.0'] = "id"
      params['moyiList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        moyiSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(MoyiSearchForm)
