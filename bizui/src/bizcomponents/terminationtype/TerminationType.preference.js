...
const internalImageListOf = (terminationType) =>{
<<<<<<< HEAD
...
const internalSettingListOf = (terminationType) =>{
<<<<<<< HEAD
...
const handleTransferSearch =(targetComponent,filterKey,newRequest)=>{
  ...
  const pageNo = 1;
  const candidateReferenceService = TerminationTypeService[candidateServiceName] 
...
const executeTrans = (terminationType,targetComponent) =>{
...
const buildTransferModal = (terminationType,targetComponent) => {
...
<Modal title={transferModalTitle}
          ...
          onOk={()=>executeTrans(terminationType,targetComponent)}
...
const internalRenderExtraHeader = (terminationType) =>{
	return null
}
const internalRenderExtraFooter = (terminationType) =>{
	return null
}
...
class TerminationTypePreference extends Component {
...
}))(Form.create()(TerminationTypePreference))
