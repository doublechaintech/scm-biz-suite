...
const renderItemOfList=(terminationType, targetComponent, columCount)=>{
  ...
  const userContext = null
  return (
    <Card key={`terminationType-${terminationType.id}`} style={{marginTop:"10px"}}>
...
const TerminationTypeBase={menuData,settingMenuData,displayColumns,fieldLabels,renderItemOfList, stepOf, searchLocalData}
