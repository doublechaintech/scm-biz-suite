...
import styles from './TerminationType.createform.less'
...
class TerminationTypeCreateFormBody extends Component {
  state = {
  ...
  componentDidMount() {
    ...
    const formValue = TerminationTypeBase.unpackObjectToFormValues(initValue)
  ...
  render() {
    ...
    const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"CreateNew")}{window.trans('termination_type')}</div>)
    }
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.code} {...formItemLayout}>
                  {getFieldDecorator('code', {
                    ...
                    <SmallTextInput minLength={2} maxLength={28} size="large"  placeholder={fieldLabels.code} />
                  )}
                </Form.Item>
              </Col>
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.baseDescription} {...formItemLayout}>
                  {getFieldDecorator('baseDescription', {
                    ...
                    <SmallTextInput minLength={1} maxLength={16} size="large"  placeholder={fieldLabels.baseDescription} />
                  )}
                </Form.Item>
              </Col>
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.detailDescription} {...formItemLayout}>
                  {getFieldDecorator('detailDescription', {
                    ...
                    <SmallTextInput minLength={16} maxLength={248} size="large"  placeholder={fieldLabels.detailDescription} />
                  )}
                </Form.Item>
              </Col>
              ...
              <Col lg={24} md={24} sm={24} style={{"display":"none"}}>
                <Form.Item label={fieldLabels.company} {...formItemLayout}>
                  ...
                  <CandidateList
		                 ...
		                 ownerId={owner.id}
		                 scenarioCode={"assign"}
		                 listType={"termination_type"}
		                 targetType={"retail_store_country_center"}

                    requestFunction={TerminationTypeService.queryCandidates}  />
...
}))(Form.create()(TerminationTypeCreateFormBody))
