...
import styles from './MemberWishlistProduct.updateform.less'
...
class MemberWishlistProductUpdateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
        ...
        const memberWishlistProductId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, memberWishlistProductId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateMemberWishlistProduct`,
          payload: {
            id: owner.id,
            type: 'memberWishlistProduct',
            parameters,
            selectedRows,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextMemberWishlistProductUpdateRow`,
        payload: {
          id: owner.id,
          type: 'memberWishlistProduct',
          selectedRows,
...
<<<<<<< HEAD
    ...
    return (
      <PageHeaderLayout
        title={"更新会员收藏产品"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新会员收藏产品"
...
=======
	...
	const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"Update")}会员收藏产品: {(currentUpdateIndex+1)}/{selectedRows.length}</div>)
    }
...
}))(Form.create()(MemberWishlistProductUpdateForm))
