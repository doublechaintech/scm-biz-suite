...
import styles from './MemberWishlistProduct.search.less'
...
class MemberWishlistProductSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      memberWishlistProductList: 1,
      'memberWishlistProductList.searchField': fieldName,
      'memberWishlistProductList.searchVerb': 'startsWith',
      'memberWishlistProductList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`memberWishlistProductList.searchField`] = fieldName
    value[`memberWishlistProductList.searchVerb`] =  searchVerb
    value[`memberWishlistProductList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
      params['memberWishlistProductList'] = 1
      params['memberWishlistProductList.orderBy.0'] = "id"
      params['memberWishlistProductList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        memberWishlistProductSearchFormParameters: filterObjectKeys(fieldsValue),
...
=======
                    requestFunction={MemberWishlistProductService.requestCandidateOwner} useForSearch />
...
export default Form.create()(MemberWishlistProductSearchForm)
