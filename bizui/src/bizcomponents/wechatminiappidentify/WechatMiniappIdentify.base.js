...
const displayColumns = [
  { title: fieldLabels.id, debugtype: 'string', dataIndex: 'id', width: '6', render: (text, record)=>renderTextCell(text,record,'wechatMiniappIdentify') , sorter: true },
...
const renderItemOfList=(wechatMiniappIdentify, targetComponent, columCount, listName)=>{
  ...
  const userContext = null
  return (
    <Card key={`${listName}-${wechatMiniappIdentify.id}`} style={{marginTop:"10px"}}>
