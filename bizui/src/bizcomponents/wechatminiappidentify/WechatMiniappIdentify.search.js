...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{wechatMiniappIdentifyList:selectedRows}} owner={owner}  
...
class WechatMiniappIdentifySearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {WechatMiniappIdentifyTable} = GlobalComponents;
    const {WechatMiniappIdentifySearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <WechatMiniappIdentifySearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,WechatMiniappIdentifyModalTable,"wechatMiniappIdentifyIds")}
...
export default Form.create()(WechatMiniappIdentifySearch)
