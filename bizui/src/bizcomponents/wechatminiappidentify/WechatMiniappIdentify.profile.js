...
const internalSummaryOf = (item, targetComponents)=>{
	...
	return GlobalComponents.WechatMiniappIdentifyBase.renderItemOfList(item, targetComponents)

}



class WechatMiniappIdentifyProfile extends Component {
...
}))(Form.create()(WechatMiniappIdentifyProfile))
