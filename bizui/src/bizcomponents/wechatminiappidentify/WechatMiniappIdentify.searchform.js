...
import styles from './WechatMiniappIdentify.search.less'
...
class WechatMiniappIdentifySearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      wechatMiniappIdentifyList: 1,
      'wechatMiniappIdentifyList.searchField': fieldName,
      'wechatMiniappIdentifyList.searchVerb': 'startsWith',
      'wechatMiniappIdentifyList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        wechatMiniappIdentifySearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                  ...
                  <CandidateList 
		                 ...
		                 ownerId={owner.id}
		                 scenarioCode={"search"}
		                 listType={"wechat_miniapp_identify"} 
		                 targetType={"sec_user"} 
                 
                    requestFunction={WechatMiniappIdentifyService.queryCandidates} useForSearch />
...
export default Form.create()(WechatMiniappIdentifySearchForm)
