...
import styles from './OccupationType.updateform.less'
...
class OccupationTypeUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const occupationTypeId = values.id

        const parameters = { ...values, occupationTypeId, }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateOccupationType`,
          payload: {
            id: owner.id,
            type: 'occupationType',
            parameters,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextOccupationTypeUpdateRow`,
        payload: {
          id: owner.id,
          type: 'occupationType',
          selectedRows,
	...
	const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"Update")}职位类型: {(currentUpdateIndex+1)}/{selectedRows.length}</div>)
    }
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.detailDescription} {...formItemLayout}>
                  {getFieldDecorator('detailDescription', {
                    ...
                    <SmallTextInput size="large"  placeholder={fieldLabels.detailDescription} />
...
}))(Form.create()(OccupationTypeUpdateForm))
