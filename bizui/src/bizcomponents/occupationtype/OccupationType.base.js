...
<<<<<<< HEAD
  { title: '序号', debugtype: 'string', dataIndex: 'id', width: '20', render: (text, record)=>renderTextCell(text,record,'occupationType') },
...
const OccupationTypeBase={menuData,displayColumns,fieldLabels,displayColumns}
=======
