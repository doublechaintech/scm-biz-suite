...
const internalImageListOf = (occupationType) =>{
<<<<<<< HEAD
...
const internalSettingListOf = (occupationType) =>{
<<<<<<< HEAD
...
const handleTransferSearch =(targetComponent,filterKey,newRequest)=>{
  ...
  const pageNo = 1;
  const candidateReferenceService = OccupationTypeService[candidateServiceName] 
...
const executeTrans = (occupationType,targetComponent) =>{
...
const buildTransferModal = (occupationType,targetComponent) => {
...
<Modal title={transferModalTitle}
          ...
          onOk={()=>executeTrans(occupationType,targetComponent)}
...
const internalRenderExtraHeader = (occupationType) =>{
	return null
}
const internalRenderExtraFooter = (occupationType) =>{
	return null
}
...
class OccupationTypePreference extends Component {
...
}))(Form.create()(OccupationTypePreference))
