...
class MobileAppSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {MobileAppTable} = GlobalComponents;
    const {MobileAppSearchForm} = GlobalComponents;
    const {MobileAppModalTable} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        ...
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <MobileAppSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,MobileAppModalTable,"mobileAppIds")}
...
export default Form.create()(MobileAppSearch)
