...
class MobileAppSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      mobileAppList: 1,
      'mobileAppList.searchField': fieldName,
      'mobileAppList.searchVerb': 'startsWith',
      'mobileAppList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        mobileAppSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(MobileAppSearchForm)
