...
import styles from './RetailStoreCreation.search.less'
...
class RetailStoreCreationSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      retailStoreCreationList: 1,
      'retailStoreCreationList.searchField': fieldName,
      'retailStoreCreationList.searchVerb': 'startsWith',
      'retailStoreCreationList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`retailStoreCreationList.searchField`] = fieldName
    value[`retailStoreCreationList.searchVerb`] =  searchVerb
    value[`retailStoreCreationList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
      params['retailStoreCreationList'] = 1
      params['retailStoreCreationList.orderBy.0'] = "id"
      params['retailStoreCreationList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        retailStoreCreationSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(RetailStoreCreationSearchForm)
