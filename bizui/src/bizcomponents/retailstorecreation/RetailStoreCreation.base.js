...
const renderItemOfList=(retailStoreCreation, targetComponent, columCount, listName)=>{
  ...
  const userContext = null
  return (
    <Card key={`${listName}-${retailStoreCreation.id}`} style={{marginTop:"10px"}}>
...
const RetailStoreCreationBase={menuData,settingMenuData,displayColumns,fieldLabels,renderItemOfList, stepOf, searchLocalData}
