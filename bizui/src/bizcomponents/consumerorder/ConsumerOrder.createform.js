...
=======
import ConsumerOrderCreateFormBody from './ConsumerOrder.createformbody'
...
class ConsumerOrderCreateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, ...imagesValues }
        dispatch({
          type: `${owner.type}/addConsumerOrder`,
          payload: { id: owner.id, type: 'consumerOrder', parameters, continueNext: true },
        })
      })
    }
...
<<<<<<< HEAD
      dispatch({
        ...
        payload: { id: owner.id, type: 'consumerOrder',listName:'消费者订单列表' },
=======
     
      dispatch({
        type: `${owner.type}/goback`,
        payload: { id: owner.id, type: 'consumerOrder',listName:appLocaleName(userContext,"List") },
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      })
    }
...
=======
	...
	return (
      ...
      >
   		...
   		<ConsumerOrderCreateFormBody	 {...this.props} />
...
}))(Form.create()(ConsumerOrderCreateForm))
