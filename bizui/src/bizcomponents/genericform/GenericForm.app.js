 ...
 getNavMenuItems = (targetObject, style, customTheme) => {
  ...
  getFormMessageSearch = () => {
    ...
    return connect(state => ({
      rule: state.rule,
      name: window.mtrans('form_message','generic_form.form_message_list',false),
      role: "formMessage",
  ...
  getFormFieldMessageSearch = () => {
    ...
    return connect(state => ({
      rule: state.rule,
      name: window.mtrans('form_field_message','generic_form.form_field_message_list',false),
  ...
  getFormFieldSearch = () => {
    ...
    return connect(state => ({
      rule: state.rule,
      name: window.mtrans('form_field','generic_form.form_field_list',false),
      role: "formField",
  ...
  getFormActionSearch = () => {
    ...
    return connect(state => ({
      rule: state.rule,
      name: window.mtrans('form_action','generic_form.form_action_list',false),
      role: "formAction",
  ...
  handleOpenChange = (openKeys) => {
   ...
   render() {
    ...
    const {searchLocalData}=GlobalComponents.GenericFormBase
      ...
      {this.state.showSearch&&(
       ...
       <Sider
        ...
        >
         ...
         {this.getNavMenuItems(this.props.genericForm,"inline","dark")}
