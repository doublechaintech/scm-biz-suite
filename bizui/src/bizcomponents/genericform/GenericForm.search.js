...
class GenericFormSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <GenericFormSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,GenericFormModalTable,"genericFormIds")}
...
export default Form.create()(GenericFormSearch)
