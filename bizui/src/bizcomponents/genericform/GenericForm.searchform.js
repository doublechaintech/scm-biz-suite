...
import styles from './GenericForm.search.less'
...
class GenericFormSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      genericFormList: 1,
      'genericFormList.searchField': fieldName,
      'genericFormList.searchVerb': 'startsWith',
      'genericFormList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        genericFormSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(GenericFormSearchForm)
