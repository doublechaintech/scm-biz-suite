...
const internalSummaryOf = (item, targetComponents)=>{
	...
	return GlobalComponents.GenericFormBase.renderItemOfList(item, targetComponents)

}



class GenericFormProfile extends Component {
...
}))(Form.create()(GenericFormProfile))
