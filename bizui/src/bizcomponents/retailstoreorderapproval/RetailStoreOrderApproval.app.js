...
<<<<<<< HEAD
    ...
    return (
		  ...
		  <Menu
           ...
           >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/retailStoreOrderApproval/${this.props.retailStoreOrderApproval.id}/dashboard`}><Icon type="dashboard" /><span>仪表板</span></Link>
             </Menu.Item>
       ...
       <Menu.Item key="preference">
               <Link to={`/retailStoreOrderApproval/${this.props.retailStoreOrderApproval.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
...
<<<<<<< HEAD
      ...
      searchFormParameters: state._retailStoreOrderApproval.retailStoreOrderSearchFormParameters,
      loading: state._retailStoreOrderApproval.loading,
      owner: { type: '_retailStoreOrderApproval', id: state._retailStoreOrderApproval.id, referenceName: 'approval', listName: 'retailStoreOrderList', ref:state._retailStoreOrderApproval, listDisplayName: '生超的订单列表'}, // this is for model namespace and
=======
...
<<<<<<< HEAD
      owner: { type: '_retailStoreOrderApproval', id: state._retailStoreOrderApproval.id, listName: 'retailStoreOrderList', ref:state._retailStoreOrderApproval, listDisplayName: '生超的订单列表' }, // this is for model namespace and
=======
...
<<<<<<< HEAD
  	const {RetailStoreOrderApprovalPreference} = GlobalComponents
=======
...
<<<<<<< HEAD
  	{path:"/retailStoreOrderApproval/:id/preference", component: RetailStoreOrderApprovalPreference},
=======
...
<<<<<<< HEAD
     ...
     //const {RetailStoreOrderApprovalEditDetail} = GlobalComponents
     //const {RetailStoreOrderApprovalViewDetail} = GlobalComponents
     ...
     <Layout>
       ...
       <Layout>
		 ...
		 {this.getNavMenuItems(this.props.retailStoreOrderApproval)}
