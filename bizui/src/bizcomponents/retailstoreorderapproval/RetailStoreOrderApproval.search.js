...
class RetailStoreOrderApprovalSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {RetailStoreOrderApprovalTable} = GlobalComponents;
    const {RetailStoreOrderApprovalSearchForm} = GlobalComponents;
    const {RetailStoreOrderApprovalModalTable} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <RetailStoreOrderApprovalSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,RetailStoreOrderApprovalModalTable,"retailStoreOrderApprovalIds")}
...
export default Form.create()(RetailStoreOrderApprovalSearch)
