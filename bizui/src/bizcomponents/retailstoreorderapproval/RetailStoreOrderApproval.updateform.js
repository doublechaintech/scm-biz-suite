...
import styles from './RetailStoreOrderApproval.updateform.less'
import RetailStoreOrderApprovalBase from './RetailStoreOrderApproval.base'
<<<<<<< HEAD
=======
...
class RetailStoreOrderApprovalUpdateForm extends Component {
  state = {
  ...
  getSelectedRow() {
    ...
    const convertiedValues = selectedRows.map((item) => {
      return {
        ...item,
        approveTime: moment(item.approveTime),
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
    const {fieldLabels} = RetailStoreOrderApprovalBase
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
        ...
        const retailStoreOrderApprovalId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, retailStoreOrderApprovalId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateRetailStoreOrderApproval`,
          payload: {
            id: owner.id,
            type: 'retailStoreOrderApproval',
            parameters,
            selectedRows,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextRetailStoreOrderApprovalUpdateRow`,
        payload: {
          id: owner.id,
          type: 'retailStoreOrderApproval',
          selectedRows,
...
<<<<<<< HEAD
    ...
    return (
      <PageHeaderLayout
        title={"更新生超订单批准"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新生超订单批准"
...
=======
	...
	const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"Update")}生超订单批准: {(currentUpdateIndex+1)}/{selectedRows.length}</div>)
    }
              ...
              <Col lg={12} md={12} sm={24}>
                <Form.Item label={fieldLabels.approveTime} {...formItemLayout}>
                  {getFieldDecorator('approveTime', {
                    initialValue: selectedRow.approveTime,
...
}))(Form.create()(RetailStoreOrderApprovalUpdateForm))
