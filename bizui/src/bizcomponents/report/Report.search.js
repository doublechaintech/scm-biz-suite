...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{reportList:selectedRows}} owner={owner}  
...
class ReportSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {ReportTable} = GlobalComponents;
    const {ReportSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={`${displayName}:${this.props.name}列表`}>
        ...
        {showDeletionDialog(this,ReportModalTable,"reportIds")}
