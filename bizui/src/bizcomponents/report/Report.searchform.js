...
import styles from './Report.search.less'
...
class ReportSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      reportList: 1,
      'reportList.searchField': fieldName,
      'reportList.searchVerb': 'startsWith',
      'reportList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`reportList.searchField`] = fieldName
    value[`reportList.searchVerb`] =  searchVerb
    value[`reportList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      const paramList = []
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'contains', 'createdBy'))
      ...
      params['reportList'] = 1
      params['reportList.orderBy.0'] = "id"
      params['reportList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        reportSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"owner"} 
                    requestFunction={ReportService.requestCandidateOwner}/>
...
export default Form.create()(ReportSearchForm)
