...
class CompanyTrainingBizApp extends React.PureComponent {
  ...
  getNavMenuItems = (targetObject) => {
    ...
    return (
		  ...
		  <Menu
           ...
           >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/companyTraining/${this.props.companyTraining.id}/dashboard`}><Icon type="dashboard" /><span>仪表板</span></Link>
             </Menu.Item>
       ...
       <Menu.Item key="preference">
               <Link to={`/companyTraining/${this.props.companyTraining.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
  ...
  getEmployeeCompanyTrainingCreateForm = () => {
    ...
    return connect(state => ({
      ...
      searchFormParameters: state._companyTraining.employeeCompanyTrainingSearchFormParameters,
      loading: state._companyTraining.loading,
      owner: { type: '_companyTraining', id: state._companyTraining.id, referenceName: 'training', listName: 'employeeCompanyTrainingList', ref:state._companyTraining, listDisplayName: '员工参与的公司培训列表'}, // this is for model namespace and
  ...
  getEmployeeCompanyTrainingUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_companyTraining', id: state._companyTraining.id, listName: 'employeeCompanyTrainingList', ref:state._companyTraining, listDisplayName: '员工参与的公司培训列表' }, // this is for model namespace and
  ...
  buildRouters = () =>{
  	...
  	const {CompanyTrainingPreference} = GlobalComponents
  	
  	
  	const routers=[
  	{path:"/companyTraining/:id/dashboard", component: CompanyTrainingDashboard},
  	{path:"/companyTraining/:id/preference", component: CompanyTrainingPreference},
  ...
  handleOpenChange = (openKeys) => {
   ...
   render() {
     ...
     //const {CompanyTrainingEditDetail} = GlobalComponents
     //const {CompanyTrainingViewDetail} = GlobalComponents
