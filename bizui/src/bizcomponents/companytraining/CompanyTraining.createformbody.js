...
class CompanyTrainingCreateFormBody extends Component {
  ...
  componentDidMount() {
    ...
    const formValue = CompanyTrainingBase.unpackObjectToFormValues(initValue)
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.durationHours} {...formItemLayout}>
                  {getFieldDecorator('durationHours', {
                    ...
                    <SmallTextInput minLength={0} maxLength={3} size="large"  placeholder={fieldLabels.durationHours} />
                  )}
                </Form.Item>
              </Col>
