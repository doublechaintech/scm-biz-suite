...
import styles from './CompanyTraining.search.less'
...
class CompanyTrainingSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      companyTrainingList: 1,
      'companyTrainingList.searchField': fieldName,
      'companyTrainingList.searchVerb': 'startsWith',
      'companyTrainingList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`companyTrainingList.searchField`] = fieldName
    value[`companyTrainingList.searchVerb`] =  searchVerb
    value[`companyTrainingList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'eq', 'instructor'))
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'eq', 'trainingCourseType'))
=======
      ...
      const {listName} = owner
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'eq', 'instructor'))
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'eq', 'trainingCourseType'))
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
...
<<<<<<< HEAD
      params['companyTrainingList'] = 1
      params['companyTrainingList.orderBy.0'] = "id"
      params['companyTrainingList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        companyTrainingSearchFormParameters: filterObjectKeys(fieldsValue),
...
=======
                    requestFunction={CompanyTrainingService.requestCandidateCompany} useForSearch />
...
=======
                    requestFunction={CompanyTrainingService.requestCandidateInstructor} useForSearch />
...
=======
                    requestFunction={CompanyTrainingService.requestCandidateTrainingCourseType} useForSearch />
...
export default Form.create()(CompanyTrainingSearchForm)
