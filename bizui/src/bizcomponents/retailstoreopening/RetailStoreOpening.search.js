...
class RetailStoreOpeningSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {RetailStoreOpeningTable} = GlobalComponents;
    const {RetailStoreOpeningSearchForm} = GlobalComponents;
    const {RetailStoreOpeningModalTable} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={`${displayName}:${this.props.name}${appLocaleName(userContext,"List")}`}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <RetailStoreOpeningSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,RetailStoreOpeningModalTable,"retailStoreOpeningIds")}
...
export default Form.create()(RetailStoreOpeningSearch)
