...
const displayColumns = [
  { title: fieldLabels.id, debugtype: 'string', dataIndex: 'id', width: '6', render: (text, record)=>renderTextCell(text,record,'memberWishlist') , sorter: true },
...
const renderItemOfList=(memberWishlist, targetComponent, columCount, listName)=>{
  ...
  const userContext = null
  return (
    <Card key={`${listName}-${memberWishlist.id}`} style={{marginTop:"10px"}}>
