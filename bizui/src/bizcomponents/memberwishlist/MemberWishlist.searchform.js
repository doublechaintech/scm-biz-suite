...
import styles from './MemberWishlist.search.less'
...
class MemberWishlistSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      memberWishlistList: 1,
      'memberWishlistList.searchField': fieldName,
      'memberWishlistList.searchVerb': 'startsWith',
      'memberWishlistList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`memberWishlistList.searchField`] = fieldName
    value[`memberWishlistList.searchVerb`] =  searchVerb
    value[`memberWishlistList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
      params['memberWishlistList'] = 1
      params['memberWishlistList.orderBy.0'] = "id"
      params['memberWishlistList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        memberWishlistSearchFormParameters: filterObjectKeys(fieldsValue),
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
                  ...
                  <SelectObject 
                    ...
                    targetType={"owner"} 
<<<<<<< HEAD
                    requestFunction={MemberWishlistService.requestCandidateOwner}/>
                  
=======
                    requestFunction={MemberWishlistService.requestCandidateOwner} useForSearch />
...
export default Form.create()(MemberWishlistSearchForm)
