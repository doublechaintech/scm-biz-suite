...
import styles from './MemberWishlist.workbench.less'
...
const internalSummaryOf = (cardsData,targetComponent) =>{
	...
	const memberWishlist = cardsData.cardsSource
	const {MemberWishlistService} = GlobalComponents
	const userContext = null
	return (
	<div>
	<DescriptionList className={styles.headerList} size="small" col="4">
<Description term="ID" style={{wordBreak: 'break-all'}}>{memberWishlist.id}</Description> 
...
class MemberWishlistWorkbench extends Component {
...
}))(Form.create()(MemberWishlistWorkbench))
