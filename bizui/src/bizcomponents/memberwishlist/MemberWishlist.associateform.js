...
class MemberWishlistAssociateForm extends Component {
  state = {
 ...
 <Modal
	...
	<MemberWishlistProductModalTable data={data.memberWishlistProductList} owner={owner} />
...
}))(Form.create()(MemberWishlistAssociateForm))
