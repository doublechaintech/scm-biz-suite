...
const internalImageListOf = (memberWishlist) =>{
<<<<<<< HEAD
...
const internalSettingListOf = (memberWishlist) =>{
<<<<<<< HEAD
...
const handleTransferSearch =(targetComponent,filterKey,newRequest)=>{
  ...
  const pageNo = 1;
  const candidateReferenceService = MemberWishlistService[candidateServiceName] 
...
const executeTrans = (memberWishlist,targetComponent) =>{
...
const buildTransferModal = (memberWishlist,targetComponent) => {
...
<Modal title={transferModalTitle}
          ...
          onOk={()=>executeTrans(memberWishlist,targetComponent)}
...
const internalRenderExtraHeader = (memberWishlist) =>{
	return null
}
const internalRenderExtraFooter = (memberWishlist) =>{
	return null
}
...
=======
<Description term="业主">{memberWishlist.owner==null?appLocaleName(userContext,"NotAssigned"):memberWishlist.owner.displayName}
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
 <Icon type="swap" onClick={()=>
  showTransferModel(targetComponent,"业主","retailStoreMember","requestCandidateOwner",
	      "transferToAnotherOwner","anotherOwnerId",memberWishlist.owner?memberWishlist.owner.id:"")} 
...
class MemberWishlistPreference extends Component {
...
}))(Form.create()(MemberWishlistPreference))
