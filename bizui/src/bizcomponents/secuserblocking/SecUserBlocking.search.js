...
class SecUserBlockingSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {SecUserBlockingTable} = GlobalComponents;
    const {SecUserBlockingSearchForm} = GlobalComponents;
    const {SecUserBlockingModalTable} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <SecUserBlockingSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,SecUserBlockingModalTable,"secUserBlockingIds")}
...
export default Form.create()(SecUserBlockingSearch)
