...
import styles from './SecUserBlocking.search.less'
...
class SecUserBlockingSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      secUserBlockingList: 1,
      'secUserBlockingList.searchField': fieldName,
      'secUserBlockingList.searchVerb': 'startsWith',
      'secUserBlockingList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`secUserBlockingList.searchField`] = fieldName
    value[`secUserBlockingList.searchVerb`] =  searchVerb
    value[`secUserBlockingList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
      params['secUserBlockingList'] = 1
      params['secUserBlockingList.orderBy.0'] = "id"
      params['secUserBlockingList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        secUserBlockingSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(SecUserBlockingSearchForm)
