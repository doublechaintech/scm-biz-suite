...
=======
    ...
    const {searchLocalData}=GlobalComponents.OfferAcceptanceBase
...
=======
      {this.state.showSearch&&(
        ...
        <div style={{backgroundColor:'black'}}  onClick={()=>hideSearchResult()}  >{searchLocalData(this.props.offerAcceptance,this.state.searchKeyword)}</div>
