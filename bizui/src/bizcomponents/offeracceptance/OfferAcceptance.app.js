...
<<<<<<< HEAD
    ...
    return (
		  ...
		  <Menu
           ...
           >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/offerAcceptance/${this.props.offerAcceptance.id}/dashboard`}><Icon type="dashboard" /><span>仪表板</span></Link>
             </Menu.Item>
       ...
       <Menu.Item key="preference">
               <Link to={`/offerAcceptance/${this.props.offerAcceptance.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
    ...
    return (
	  <Menu
       ...
       >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/offerAcceptance/${this.props.offerAcceptance.id}/dashboard`}><Icon type="dashboard" style={{marginRight:"20px"}}/><span>{appLocaleName(userContext,"Dashboard")}</span></Link>
             </Menu.Item>
...
<<<<<<< HEAD
      ...
      searchFormParameters: state._offerAcceptance.employeeSearchFormParameters,
      loading: state._offerAcceptance.loading,
      owner: { type: '_offerAcceptance', id: state._offerAcceptance.id, referenceName: 'offerAcceptance', listName: 'employeeList', ref:state._offerAcceptance, listDisplayName: '员工列表'}, // this is for model namespace and
=======
      returnURL: `/offerAcceptance/${state._offerAcceptance.id}/list`,
      currentPage: state._offerAcceptance.employeeCurrentPageNumber,
      searchFormParameters: state._offerAcceptance.employeeSearchFormParameters,
      loading: state._offerAcceptance.loading,
...
<<<<<<< HEAD
      owner: { type: '_offerAcceptance', id: state._offerAcceptance.id, listName: 'employeeList', ref:state._offerAcceptance, listDisplayName: '员工列表' }, // this is for model namespace and
=======
...
=======
  	const {OfferAcceptancePermission} = GlobalComponents
  	const {OfferAcceptanceProfile} = GlobalComponents
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
...
=======
  	{path:"/offerAcceptance/:id/profile", component: OfferAcceptanceProfile},
  	{path:"/offerAcceptance/:id/permission", component: OfferAcceptancePermission},
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
...
<<<<<<< HEAD
     ...
     //const {OfferAcceptanceEditDetail} = GlobalComponents
     //const {OfferAcceptanceViewDetail} = GlobalComponents
...
=======
 ...
 <Header>
        ...
        <Col {...naviBarResponsiveStyle} >
            <Dropdown overlay= {this.getNavMenuItems(this.props.offerAcceptance)}>
