...
import styles from './OfferAcceptance.search.less'
...
class OfferAcceptanceSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      offerAcceptanceList: 1,
      'offerAcceptanceList.searchField': fieldName,
      'offerAcceptanceList.searchVerb': 'startsWith',
      'offerAcceptanceList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`offerAcceptanceList.searchField`] = fieldName
    value[`offerAcceptanceList.searchVerb`] =  searchVerb
    value[`offerAcceptanceList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
      params['offerAcceptanceList'] = 1
      params['offerAcceptanceList.orderBy.0'] = "id"
      params['offerAcceptanceList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        offerAcceptanceSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(OfferAcceptanceSearchForm)
