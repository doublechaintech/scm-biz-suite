...
const analyze = (targetObjectId) => {
  return get({
    url: `${PREFIX}transportTaskTrackManager/analyze/${targetObjectId}/`,
  })
}
...
const  initRequest = (data) => {
  ...
  return put({
    url: `${PREFIX}transportTaskTrackService/init/`,
    data,
  })
}
...
const TransportTaskTrackService = { view,
  ...
  transferToAnotherMovement, listFunctions, saveRequest,initRequest, processRequest, queryCandidates}
