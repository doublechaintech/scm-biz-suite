...
const internalImageListOf = (transportTaskTrack) =>{
<<<<<<< HEAD
...
const internalSettingListOf = (transportTaskTrack) =>{
<<<<<<< HEAD
...
const handleTransferSearch =(targetComponent,filterKey,newRequest)=>{
  ...
  const pageNo = 1;
  const candidateReferenceService = TransportTaskTrackService[candidateServiceName] 
...
const executeTrans = (transportTaskTrack,targetComponent) =>{
...
const buildTransferModal = (transportTaskTrack,targetComponent) => {
...
<Modal title={transferModalTitle}
          ...
          onOk={()=>executeTrans(transportTaskTrack,targetComponent)}
...
const internalRenderExtraHeader = (transportTaskTrack) =>{
	return null
}
const internalRenderExtraFooter = (transportTaskTrack) =>{
	return null
}
...
<<<<<<< HEAD
<Description term="运动">{transportTaskTrack.movement==null?"未分配":transportTaskTrack.movement.displayName}
=======
<Description term="运动">{transportTaskTrack.movement==null?appLocaleName(userContext,"NotAssigned"):transportTaskTrack.movement.displayName}
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
 <Icon type="swap" onClick={()=>
  showTransferModel(targetComponent,"运动","transportTask","requestCandidateMovement",
	      "transferToAnotherMovement","anotherMovementId",transportTaskTrack.movement?transportTaskTrack.movement.id:"")} 
...
class TransportTaskTrackPreference extends Component {
...
}))(Form.create()(TransportTaskTrackPreference))
