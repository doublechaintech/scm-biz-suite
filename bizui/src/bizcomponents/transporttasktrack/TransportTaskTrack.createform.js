...
import TransportTaskTrackCreateFormBody from './TransportTaskTrack.createformbody'
...
/*
const testValues = {
  trackTime: '2019-08-09',
  latitude: '31.716940801130278',
  longitude: '104.80437544339784',
  movementId: 'TT000001',
}
*/
...
class TransportTaskTrackCreateForm extends Component {
  state = {
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          ...
          payload: { id: owner.id, type: 'transportTaskTrack', parameters, continueNext: true },
        })
      })
    }
...
}))(Form.create()(TransportTaskTrackCreateForm))
