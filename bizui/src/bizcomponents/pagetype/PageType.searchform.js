...
class PageTypeSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      pageTypeList: 1,
      'pageTypeList.searchField': fieldName,
      'pageTypeList.searchVerb': 'startsWith',
      'pageTypeList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        pageTypeSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    requestFunction={PageTypeService.requestCandidateMobileApp} useForSearch />
...
export default Form.create()(PageTypeSearchForm)
