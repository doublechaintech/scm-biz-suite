...
export default {
  ...
  effects: {
    *view({ payload }, { call, put, select }) { 
      ...
      const data = yield call(PageTypeService.view, payload.id)
    ...
    *load({ payload }, { call, put }) { 
      const {PageTypeService} = GlobalComponents;
      //yield put({ type: 'showLoading', payload })
      const data = yield call(PageTypeService.load, payload.id, payload.parameters)
    ...
    *gotoUpdateForm({ payload }, { put }) {
      ...
      const location = { pathname: `/pageType/${id}/list/${role}UpdateForm`, state }
