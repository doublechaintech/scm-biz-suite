...
class PageTypeCreateFormBody extends Component {
  ...
  componentDidMount() {
    ...
    const formValue = PageTypeBase.unpackObjectToFormValues(initValue)
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.name} {...formItemLayout}>
                  {getFieldDecorator('name', {
                    ...
                    <SmallTextInput minLength={1} maxLength={40} size="large"  placeholder={fieldLabels.name} />
                  )}
                </Form.Item>
              </Col>
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.code} {...formItemLayout}>
                  {getFieldDecorator('code', {
                    ...
                    <SmallTextInput minLength={1} maxLength={40} size="large"  placeholder={fieldLabels.code} />
                  )}
                </Form.Item>
              </Col>
