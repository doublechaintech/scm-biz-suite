...
import styles from './ListAccess.search.less'
...
class ListAccessSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      listAccessList: 1,
      'listAccessList.searchField': fieldName,
      'listAccessList.searchVerb': 'startsWith',
      'listAccessList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`listAccessList.searchField`] = fieldName
    value[`listAccessList.searchVerb`] =  searchVerb
    value[`listAccessList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'contains', 'internalName'))
...
=======
      ...
      const {listName} = owner
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'contains', 'internalName'))
...
<<<<<<< HEAD
      params['listAccessList'] = 1
      params['listAccessList.orderBy.0'] = "id"
      params['listAccessList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        listAccessSearchFormParameters: filterObjectKeys(fieldsValue),
...
=======
                    requestFunction={ListAccessService.requestCandidateApp} useForSearch />
...
export default Form.create()(ListAccessSearchForm)
