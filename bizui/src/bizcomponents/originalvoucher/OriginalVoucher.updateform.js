...
import styles from './OriginalVoucher.updateform.less'
...
class OriginalVoucherUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const originalVoucherId = values.id

        const parameters = { ...values, originalVoucherId, }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateOriginalVoucher`,
          payload: {
            id: owner.id,
            type: 'originalVoucher',
            parameters,
            selectedRows,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextOriginalVoucherUpdateRow`,
        payload: {
          id: owner.id,
          type: 'originalVoucher',
          selectedRows,
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.madeBy} {...formItemLayout}>
                  {getFieldDecorator('madeBy', {
                    ...
                    <SmallTextInput size="large"  placeholder={fieldLabels.madeBy} />
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.receivedBy} {...formItemLayout}>
                  {getFieldDecorator('receivedBy', {
                    ...
                    <SmallTextInput size="large"  placeholder={fieldLabels.receivedBy} />
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.voucherType} {...formItemLayout}>
                  {getFieldDecorator('voucherType', {
                    ...
                    <SmallTextInput size="large"  placeholder={fieldLabels.voucherType} />
            ...
            <Row gutter={16}>
              ...
              <Form.Item>
                  {getFieldDecorator('voucherImage', {
                  	initialValue: selectedRow.voucherImage,
...
}))(Form.create()(OriginalVoucherUpdateForm))
