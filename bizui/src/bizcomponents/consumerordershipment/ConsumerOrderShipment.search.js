...
class ConsumerOrderShipmentSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {ConsumerOrderShipmentTable} = GlobalComponents;
    const {ConsumerOrderShipmentSearchForm} = GlobalComponents;
    const {ConsumerOrderShipmentModalTable} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <ConsumerOrderShipmentSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,ConsumerOrderShipmentModalTable,"consumerOrderShipmentIds")}
...
export default Form.create()(ConsumerOrderShipmentSearch)
