...
import styles from './ConsumerOrderShipment.search.less'
...
class ConsumerOrderShipmentSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      consumerOrderShipmentList: 1,
      'consumerOrderShipmentList.searchField': fieldName,
      'consumerOrderShipmentList.searchVerb': 'startsWith',
      'consumerOrderShipmentList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`consumerOrderShipmentList.searchField`] = fieldName
    value[`consumerOrderShipmentList.searchVerb`] =  searchVerb
    value[`consumerOrderShipmentList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      params['consumerOrderShipmentList'] = 1
      params['consumerOrderShipmentList.orderBy.0'] = "id"
      params['consumerOrderShipmentList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        consumerOrderShipmentSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(ConsumerOrderShipmentSearchForm)
