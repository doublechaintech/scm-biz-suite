...
class UserDomainSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      userDomainList: 1,
      'userDomainList.searchField': fieldName,
      'userDomainList.searchVerb': 'startsWith',
      'userDomainList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`userDomainList.searchField`] = fieldName
    value[`userDomainList.searchVerb`] =  searchVerb
    value[`userDomainList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      params['userDomainList'] = 1
      params['userDomainList.orderBy.0'] = "id"
      params['userDomainList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        userDomainSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(UserDomainSearchForm)
