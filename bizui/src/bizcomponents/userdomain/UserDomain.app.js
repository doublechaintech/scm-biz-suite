 ...
 getNavMenuItems = (targetObject, style, customTheme) => {
  ...
  getUserWhiteListSearch = () => {
    ...
    return connect(state => ({
      rule: state.rule,
      name: window.mtrans('user_white_list','user_domain.user_white_list_list',false),
      role: "userWhiteList",
  ...
  getPublicKeyTypeCreateForm = () => {
    ...
    return connect(state => ({
      ...
      searchFormParameters: state._userDomain.publicKeyTypeSearchFormParameters,
      loading: state._userDomain.loading,
      owner: { type: '_userDomain', id: state._userDomain.id, referenceName: 'domain', listName: 'publicKeyTypeList', ref:state._userDomain, listDisplayName: appLocaleName(userContext,"List")}, // this is for model namespace and
  ...
  getPublicKeyTypeUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      role: "publicKeyType",
      currentUpdateIndex: state._userDomain.currentUpdateIndex,
      owner: { type: '_userDomain', id: state._userDomain.id, listName: 'publicKeyTypeList', ref:state._userDomain, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
