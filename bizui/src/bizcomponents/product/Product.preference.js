...
<<<<<<< HEAD
<Description term="父类">{product.parentCategory==null?"未分配":product.parentCategory.displayName}
=======
<Description term="父类">{product.parentCategory==null?appLocaleName(userContext,"NotAssigned"):product.parentCategory.displayName}
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
 <Icon type="swap" onClick={()=>
  showTransferModel(targetComponent,"父类","levelThreeCategory","requestCandidateParentCategory",
