...
class AccountingPeriodSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      accountingPeriodList: 1,
      'accountingPeriodList.searchField': fieldName,
      'accountingPeriodList.searchVerb': 'startsWith',
      'accountingPeriodList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`accountingPeriodList.searchField`] = fieldName
    value[`accountingPeriodList.searchVerb`] =  searchVerb
    value[`accountingPeriodList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
      params['accountingPeriodList'] = 1
      params['accountingPeriodList.orderBy.0'] = "id"
      params['accountingPeriodList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        accountingPeriodSearchFormParameters: filterObjectKeys(fieldsValue),
...
=======
                    requestFunction={AccountingPeriodService.requestCandidateAccountSet} useForSearch />
...
export default Form.create()(AccountingPeriodSearchForm)
