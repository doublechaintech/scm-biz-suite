...
const showAssociateDialog = (targetComponent) => {
  ...
  const { PublicKeyTypeAssociateForm } = GlobalComponents
  ...
  <div>
	...
	visible={currentAssociateModal==='keyType'} 
	data={{keypairIdentifyList:selectedRows}} owner={owner}  
	onCancel={()=>toggleAssociateModalVisible(targetComponent,'keyType')} 
	onCreate={()=>toggleAssociateModalVisible(targetComponent,'keyType')}/> <SecUserAssociateForm 
...
class KeypairIdentifySearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {KeypairIdentifyTable} = GlobalComponents;
    const {KeypairIdentifySearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        ...
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <KeypairIdentifySearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,KeypairIdentifyModalTable,"keypairIdentifyIds")}
...
export default Form.create()(KeypairIdentifySearch)
