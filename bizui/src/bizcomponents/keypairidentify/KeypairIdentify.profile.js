...
const internalSummaryOf = (item, targetComponents)=>{
	...
	return GlobalComponents.KeypairIdentifyBase.renderItemOfList(item, targetComponents)

}



class KeypairIdentifyProfile extends Component {
...
}))(Form.create()(KeypairIdentifyProfile))
