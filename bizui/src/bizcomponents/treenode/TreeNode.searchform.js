...
import styles from './TreeNode.search.less'
...
class TreeNodeSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      treeNodeList: 1,
      'treeNodeList.searchField': fieldName,
      'treeNodeList.searchVerb': 'startsWith',
      'treeNodeList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      const {listName} = owner
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'contains', 'nodeId'))
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'contains', 'nodeType'))
      ...
      dispatch({
        ...
        treeNodeSearchFormParameters: filterObjectKeys(fieldsValue),
  ...
  renderSimpleForm() {
    ...
    return (
      <Form onSubmit={this.handleSearch} layout="inline">
       ...
       <Col md={8} sm={24}>
         <FormItem label={fieldLabels.nodeId}>
    ...
    return (
      <Form onSubmit={this.handleSearch} layout="inline">
        <Row gutter={{ md: 8, lg: 24, xl: 48 }}>
          ...
          <Col md={8} sm={24}>
            <FormItem label={fieldLabels.nodeType}>
...
export default Form.create()(TreeNodeSearchForm)
