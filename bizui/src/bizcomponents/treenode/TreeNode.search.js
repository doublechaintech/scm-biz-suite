...
class TreeNodeSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {TreeNodeTable} = GlobalComponents;
    const {TreeNodeSearchForm} = GlobalComponents;
    const {TreeNodeModalTable} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        ...
        {showDeletionDialog(this,TreeNodeModalTable,"treeNodeIds")}
...
export default Form.create()(TreeNodeSearch)
