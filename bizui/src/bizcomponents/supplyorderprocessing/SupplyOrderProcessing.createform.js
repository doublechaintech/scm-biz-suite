...
class SupplyOrderProcessingCreateForm extends Component {
  ...
  render() {
	...
	return (
      <PageHeaderLayout
        title={`${appLocaleName(userContext,"CreateNew")}Supply Order Processing`}
        content={`${appLocaleName(userContext,"CreateNew")}Supply Order Processing`}
