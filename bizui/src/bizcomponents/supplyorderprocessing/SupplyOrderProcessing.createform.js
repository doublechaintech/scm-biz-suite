...
=======
import SupplyOrderProcessingCreateFormBody from './SupplyOrderProcessing.createformbody'
...
const testValues = {
  who: '处理者',
<<<<<<< HEAD
  processTime: '2018-03-03',
=======
  processTime: '2018-08-25',
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
}
*/
...
class SupplyOrderProcessingCreateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, ...imagesValues }
        dispatch({
          type: `${owner.type}/addSupplyOrderProcessing`,
          payload: { id: owner.id, type: 'supplyOrderProcessing', parameters, continueNext: true },
        })
      })
    }
...
<<<<<<< HEAD
      dispatch({
        ...
        payload: { id: owner.id, type: 'supplyOrderProcessing',listName:'供应订单处理列表' },
=======
     
      dispatch({
        type: `${owner.type}/goback`,
        payload: { id: owner.id, type: 'supplyOrderProcessing',listName:appLocaleName(userContext,"List") },
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      })
    }
...
=======
	...
	return (
      <PageHeaderLayout
        ...
        content={`${appLocaleName(userContext,"CreateNew")}供应订单处理`}
        wrapperClassName={styles.advancedForm}
      >
   			
   		<SupplyOrderProcessingCreateFormBody	 {...this.props} />
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
...
}))(Form.create()(SupplyOrderProcessingCreateForm))
