...
export default {
  ...
  effects: {
    ...
    *addConsumerOrder({ payload }, { call, put }) {
      ...
      const location = { pathname: `/supplyOrderProcessing/${id}/list/ConsumerOrderList/Consumer Order+${appLocaleName(userContext,'List')}`, state: newState }
      yield put(routerRedux.push(location))
    },
    *updateConsumerOrder({ payload }, { call, put }) {
      ...
      const location = { pathname: `/supplyOrderProcessing/${id}/list/ConsumerOrderList/Consumer Order列表`, state: newPlayload }
      yield put(routerRedux.push(location))
    },
    ...
    *addSupplyOrder({ payload }, { call, put }) {
      ...
      const partialList = true
      const newState = {...data, partialList}
      const location = { pathname: `/supplyOrderProcessing/${id}/list/SupplyOrderList/Supply Order+${appLocaleName(userContext,'List')}`, state: newState }
      yield put(routerRedux.push(location))
    },
    *updateSupplyOrder({ payload }, { call, put }) {
      ...
      const location = { pathname: `/supplyOrderProcessing/${id}/list/SupplyOrderList/Supply Order列表`, state: newPlayload }
      yield put(routerRedux.push(location))
    },
