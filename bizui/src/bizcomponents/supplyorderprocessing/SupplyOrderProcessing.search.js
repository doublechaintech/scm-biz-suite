...
class SupplyOrderProcessingSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {SupplyOrderProcessingTable} = GlobalComponents;
    const {SupplyOrderProcessingSearchForm} = GlobalComponents;
    const {SupplyOrderProcessingModalTable} = GlobalComponents;
        ...
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <SupplyOrderProcessingSearchForm {...this.props} />
            </div>
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
        ...
        {showDeletionDialog(this,SupplyOrderProcessingModalTable,"supplyOrderProcessingIds")}
...
export default Form.create()(SupplyOrderProcessingSearch)
