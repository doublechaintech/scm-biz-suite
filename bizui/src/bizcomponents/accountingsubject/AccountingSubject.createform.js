...
import AccountingSubjectCreateFormBody from './AccountingSubject.createformbody'
...
class AccountingSubjectCreateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, ...imagesValues }
        dispatch({
          type: `${owner.type}/addAccountingSubject`,
          payload: { id: owner.id, type: 'accountingSubject', parameters, continueNext: true },
        })
      })
    }
	...
	return (
      <PageHeaderLayout
        ...
        content={`${appLocaleName(userContext,"CreateNew")}${window.trans('accounting_subject')}`}
        wrapperClassName={styles.advancedForm}
      >
   			
   		<AccountingSubjectCreateFormBody	 {...this.props} handleImageChange={this.handleImageChange}/>
...
}))(Form.create()(AccountingSubjectCreateForm))
