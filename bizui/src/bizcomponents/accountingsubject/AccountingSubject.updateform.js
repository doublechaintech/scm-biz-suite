...
import styles from './AccountingSubject.updateform.less'
...
class AccountingSubjectUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const accountingSubjectId = values.id

        const parameters = { ...values, accountingSubjectId, }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateAccountingSubject`,
          payload: {
            id: owner.id,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextAccountingSubjectUpdateRow`,
        payload: {
          id: owner.id,
          type: 'accountingSubject',
          selectedRows,
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.accountingSubjectCode} {...formItemLayout}>
                  {getFieldDecorator('accountingSubjectCode', {
                    ...
                    <SmallTextInput size="large"  placeholder={fieldLabels.accountingSubjectCode} />
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.accountingSubjectName} {...formItemLayout}>
                  {getFieldDecorator('accountingSubjectName', {
                    ...
                    <SmallTextInput size="large"  placeholder={fieldLabels.accountingSubjectName} />
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.accountingSubjectClassCode} {...formItemLayout}>
                  {getFieldDecorator('accountingSubjectClassCode', {
                    ...
                    <SmallTextInput size="large"  placeholder={fieldLabels.accountingSubjectClassCode} />
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.accountingSubjectClassName} {...formItemLayout}>
                  {getFieldDecorator('accountingSubjectClassName', {
                    ...
                    <SmallTextInput size="large"  placeholder={fieldLabels.accountingSubjectClassName} />
...
}))(Form.create()(AccountingSubjectUpdateForm))
