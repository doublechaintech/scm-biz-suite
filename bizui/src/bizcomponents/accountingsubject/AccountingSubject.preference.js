...
const internalImageListOf = (accountingSubject) =>{
<<<<<<< HEAD
...
const internalSettingListOf = (accountingSubject) =>{
<<<<<<< HEAD
...
const handleTransferSearch =(targetComponent,filterKey,newRequest)=>{
  ...
  const pageNo = 1;
  const candidateReferenceService = AccountingSubjectService[candidateServiceName] 
...
const executeTrans = (accountingSubject,targetComponent) =>{
...
const buildTransferModal = (accountingSubject,targetComponent) => {
...
<Modal title={transferModalTitle}
          ...
          onOk={()=>executeTrans(accountingSubject,targetComponent)}
...
const internalRenderExtraHeader = (accountingSubject) =>{
	return null
}
const internalRenderExtraFooter = (accountingSubject) =>{
	return null
}
...
=======
<Description term="账套">{accountingSubject.accountSet==null?appLocaleName(userContext,"NotAssigned"):accountingSubject.accountSet.displayName}
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
 <Icon type="swap" onClick={()=>
  showTransferModel(targetComponent,"账套","accountSet","requestCandidateAccountSet",
	      "transferToAnotherAccountSet","anotherAccountSetId",accountingSubject.accountSet?accountingSubject.accountSet.id:"")} 
...
class AccountingSubjectPreference extends Component {
...
}))(Form.create()(AccountingSubjectPreference))
