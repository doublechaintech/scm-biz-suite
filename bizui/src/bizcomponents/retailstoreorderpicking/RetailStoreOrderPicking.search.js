...
class RetailStoreOrderPickingSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {RetailStoreOrderPickingTable} = GlobalComponents;
    const {RetailStoreOrderPickingSearchForm} = GlobalComponents;
    const {RetailStoreOrderPickingModalTable} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <RetailStoreOrderPickingSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,RetailStoreOrderPickingModalTable,"retailStoreOrderPickingIds")}
...
export default Form.create()(RetailStoreOrderPickingSearch)
