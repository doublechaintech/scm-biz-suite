  ...
  getNavMenuItems = (targetObject) => {
    ...
    return (
       ...
       <Menu.Item key="preference">
               <Link to={`/retailStoreOrderPicking/${this.props.retailStoreOrderPicking.id}/preference`}><Icon type="setting" /><span>{appLocaleName(userContext,"Preference")}</span></Link>
             </Menu.Item>
