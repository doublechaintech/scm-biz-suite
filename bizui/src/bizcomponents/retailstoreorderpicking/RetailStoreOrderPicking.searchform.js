...
import styles from './RetailStoreOrderPicking.search.less'
...
class RetailStoreOrderPickingSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      retailStoreOrderPickingList: 1,
      'retailStoreOrderPickingList.searchField': fieldName,
      'retailStoreOrderPickingList.searchVerb': 'startsWith',
      'retailStoreOrderPickingList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`retailStoreOrderPickingList.searchField`] = fieldName
    value[`retailStoreOrderPickingList.searchVerb`] =  searchVerb
    value[`retailStoreOrderPickingList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
      params['retailStoreOrderPickingList'] = 1
      params['retailStoreOrderPickingList.orderBy.0'] = "id"
      params['retailStoreOrderPickingList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        retailStoreOrderPickingSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(RetailStoreOrderPickingSearchForm)
