...
import styles from './RetailStoreOrderPicking.updateform.less'
import RetailStoreOrderPickingBase from './RetailStoreOrderPicking.base'
<<<<<<< HEAD
=======
...
class RetailStoreOrderPickingUpdateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
    const {fieldLabels} = RetailStoreOrderPickingBase
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
        ...
        const retailStoreOrderPickingId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, retailStoreOrderPickingId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateRetailStoreOrderPicking`,
          payload: {
            id: owner.id,
            type: 'retailStoreOrderPicking',
            parameters,
            selectedRows,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextRetailStoreOrderPickingUpdateRow`,
        payload: {
          id: owner.id,
          type: 'retailStoreOrderPicking',
          selectedRows,
...
<<<<<<< HEAD
    ...
    return (
      <PageHeaderLayout
        title={"更新生超订单拣货"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新生超订单拣货"
...
=======
	...
	const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"Update")}生超订单拣货: {(currentUpdateIndex+1)}/{selectedRows.length}</div>)
    }
...
}))(Form.create()(RetailStoreOrderPickingUpdateForm))
