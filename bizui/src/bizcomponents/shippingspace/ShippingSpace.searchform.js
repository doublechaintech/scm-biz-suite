...
class ShippingSpaceSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      shippingSpaceList: 1,
      'shippingSpaceList.searchField': fieldName,
      'shippingSpaceList.searchVerb': 'startsWith',
      'shippingSpaceList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        shippingSpaceSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(ShippingSpaceSearchForm)
