...
import styles from './ShippingSpace.createform.less'
import {mapBackToImageValues, mapFromImageValues} from '../../axios/tools'
import GlobalComponents from '../../custcomponents';
import ShippingSpaceBase from './ShippingSpace.base'
import ShippingSpaceCreateFormBody from './ShippingSpace.createformbody'
...
const testValues = {
  ...
  totalArea: '1876平方米',
<<<<<<< HEAD
  latitude: '42.72531205971164',
  longitude: '130.2552626046859',
=======
  latitude: '40.320231108244',
  longitude: '130.60060801354265',
...
class ShippingSpaceCreateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, ...imagesValues }
        dispatch({
          type: `${owner.type}/addShippingSpace`,
          payload: { id: owner.id, type: 'shippingSpace', parameters, continueNext: true },
        })
      })
    }
	...
	return (
      ...
      >
   		...
   		<ShippingSpaceCreateFormBody	 {...this.props} handleImageChange={this.handleImageChange}/>
...
}))(Form.create()(ShippingSpaceCreateForm))
