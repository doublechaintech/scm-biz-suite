...
<<<<<<< HEAD
    ...
    return (
		  ...
		  <Menu
           ...
           >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/shippingSpace/${this.props.shippingSpace.id}/dashboard`}><Icon type="dashboard" /><span>仪表板</span></Link>
             </Menu.Item>
       ...
       <Menu.Item key="preference">
               <Link to={`/shippingSpace/${this.props.shippingSpace.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
    ...
    return (
	  <Menu
       ...
       >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/shippingSpace/${this.props.shippingSpace.id}/dashboard`}><Icon type="dashboard" style={{marginRight:"20px"}}/><span>{appLocaleName(userContext,"Dashboard")}</span></Link>
             </Menu.Item>
...
<<<<<<< HEAD
      ...
      searchFormParameters: state._shippingSpace.goodsSearchFormParameters,
      loading: state._shippingSpace.loading,
      owner: { type: '_shippingSpace', id: state._shippingSpace.id, referenceName: 'shippingSpace', listName: 'goodsList', ref:state._shippingSpace, listDisplayName: '货物列表'}, // this is for model namespace and
=======
...
<<<<<<< HEAD
      owner: { type: '_shippingSpace', id: state._shippingSpace.id, listName: 'goodsList', ref:state._shippingSpace, listDisplayName: '货物列表' }, // this is for model namespace and
=======
...
<<<<<<< HEAD
  	const {ShippingSpacePreference} = GlobalComponents
=======
...
<<<<<<< HEAD
  	{path:"/shippingSpace/:id/preference", component: ShippingSpacePreference},
=======
...
<<<<<<< HEAD
     ...
     //const {ShippingSpaceEditDetail} = GlobalComponents
     //const {ShippingSpaceViewDetail} = GlobalComponents
...
=======
 ...
 <Header>
        ...
        <Col {...naviBarResponsiveStyle} >
            <Dropdown overlay= {this.getNavMenuItems(this.props.shippingSpace)}>
