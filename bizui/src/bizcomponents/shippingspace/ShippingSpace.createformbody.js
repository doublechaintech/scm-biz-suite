...
class ShippingSpaceCreateFormBody extends Component {
  state = {
  ...
  componentDidMount() {
    ...
    const formValue = ShippingSpaceBase.unpackObjectToFormValues(initValue)
              ...
              <Col lg={24} md={24} sm={24} >
                <Form.Item label={fieldLabels.warehouse} {...formItemLayout}>
                  ...
                  <CandidateList
                    ...
                    requestFunction={ShippingSpaceService.queryCandidates}  />
...
}))(Form.create()(ShippingSpaceCreateFormBody))
