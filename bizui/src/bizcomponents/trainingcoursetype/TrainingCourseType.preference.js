...
const internalImageListOf = (trainingCourseType) =>{
...
const internalSettingListOf = (trainingCourseType) =>{
...
const handleTransferSearch =(targetComponent,filterKey,newRequest)=>{
  ...
  const pageNo = 1;
  const candidateReferenceService = TrainingCourseTypeService[candidateServiceName] 
...
const executeTrans = (trainingCourseType,targetComponent) =>{
...
const buildTransferModal = (trainingCourseType,targetComponent) => {
...
<Modal title={transferModalTitle}
          ...
          onOk={()=>executeTrans(trainingCourseType,targetComponent)}
...
const internalRenderExtraHeader = (trainingCourseType) =>{
	return null
}
const internalRenderExtraFooter = (trainingCourseType) =>{
	return null
}
...
class TrainingCourseTypePreference extends Component {
...
}))(Form.create()(TrainingCourseTypePreference))
