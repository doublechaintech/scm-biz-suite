...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{trainingCourseTypeList:selectedRows}} owner={owner}  
...
class TrainingCourseTypeSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {TrainingCourseTypeTable} = GlobalComponents;
    const {TrainingCourseTypeSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <TrainingCourseTypeSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,TrainingCourseTypeModalTable,"trainingCourseTypeIds")}
...
export default Form.create()(TrainingCourseTypeSearch)
