...
class TrainingCourseTypeSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      trainingCourseTypeList: 1,
      'trainingCourseTypeList.searchField': fieldName,
      'trainingCourseTypeList.searchVerb': 'startsWith',
      'trainingCourseTypeList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`trainingCourseTypeList.searchField`] = fieldName
    value[`trainingCourseTypeList.searchVerb`] =  searchVerb
    value[`trainingCourseTypeList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      params['trainingCourseTypeList'] = 1
      params['trainingCourseTypeList.orderBy.0'] = "id"
      params['trainingCourseTypeList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        trainingCourseTypeSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(TrainingCourseTypeSearchForm)
