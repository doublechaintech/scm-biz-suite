...
const internalImageListOf = (hrInterview) =>{
<<<<<<< HEAD
...
const internalSettingListOf = (hrInterview) =>{
<<<<<<< HEAD
...
const handleTransferSearch =(targetComponent,filterKey,newRequest)=>{
  ...
  const pageNo = 1;
  const candidateReferenceService = HrInterviewService[candidateServiceName] 
...
const executeTrans = (hrInterview,targetComponent) =>{
...
const buildTransferModal = (hrInterview,targetComponent) => {
...
<Modal title={transferModalTitle}
          ...
          onOk={()=>executeTrans(hrInterview,targetComponent)}
...
const internalRenderExtraHeader = (hrInterview) =>{
	return null
}
const internalRenderExtraFooter = (hrInterview) =>{
	return null
}
...
class HrInterviewPreference extends Component {
