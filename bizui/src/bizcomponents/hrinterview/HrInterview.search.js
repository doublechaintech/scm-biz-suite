...
class HrInterviewSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {HrInterviewTable} = GlobalComponents;
    const {HrInterviewSearchForm} = GlobalComponents;
    const {HrInterviewModalTable} = GlobalComponents;
        ...
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <HrInterviewSearchForm {...this.props} />
            </div>
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
        ...
        {showDeletionDialog(this,HrInterviewModalTable,"hrInterviewIds")}
...
export default Form.create()(HrInterviewSearch)
