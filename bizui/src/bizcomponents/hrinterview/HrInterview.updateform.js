...
import styles from './HrInterview.updateform.less'
...
class HrInterviewUpdateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
        ...
        const hrInterviewId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, hrInterviewId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateHrInterview`,
          payload: {
            id: owner.id,
            type: 'hrInterview',
            parameters,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextHrInterviewUpdateRow`,
        payload: {
          id: owner.id,
          type: 'hrInterview',
          selectedRows,
...
<<<<<<< HEAD
    ...
    return (
      <PageHeaderLayout
        title={"更新人力资源部面试"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新人力资源部面试"
...
=======
	...
	const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"Update")}人力资源部面试: {(currentUpdateIndex+1)}/{selectedRows.length}</div>)
    }
...
}))(Form.create()(HrInterviewUpdateForm))
