...
import styles from './HrInterview.search.less'
...
class HrInterviewSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      hrInterviewList: 1,
      'hrInterviewList.searchField': fieldName,
      'hrInterviewList.searchVerb': 'startsWith',
      'hrInterviewList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`hrInterviewList.searchField`] = fieldName
    value[`hrInterviewList.searchVerb`] =  searchVerb
    value[`hrInterviewList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
      params['hrInterviewList'] = 1
      params['hrInterviewList.orderBy.0'] = "id"
      params['hrInterviewList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        hrInterviewSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(HrInterviewSearchForm)
