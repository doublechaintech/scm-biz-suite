...
export default {
  ...
  effects: {
    ...
    *addAccountingSubject({ payload }, { call, put }) {
      ...
      const location = { pathname: `/accountSet/${id}/list/\AccountingSubjectList/会计科目列表`, state: newState }
      yield put(routerRedux.push(location))
    },
    ...
    *addAccountingPeriod({ payload }, { call, put }) {
      ...
      const partialList = true
      const newState = {...data, partialList}
      const location = { pathname: `/accountSet/${id}/list/\AccountingPeriodList/会计期间列表`, state: newState }
      yield put(routerRedux.push(location))
    },
    ...
    *addAccountingDocumentType({ payload }, { call, put }) {
      ...
      const partialList = true
      const newState = {...data, partialList}
      const location = { pathname: `/accountSet/${id}/list/\AccountingDocumentTypeList/会计凭证类型列表`, state: newState }
      yield put(routerRedux.push(location))
    },
