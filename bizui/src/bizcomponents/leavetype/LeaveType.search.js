...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{leaveTypeList:selectedRows}} owner={owner}  
...
class LeaveTypeSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {LeaveTypeTable} = GlobalComponents;
    const {LeaveTypeSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        ...
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <LeaveTypeSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,LeaveTypeModalTable,"leaveTypeIds")}
...
export default Form.create()(LeaveTypeSearch)
