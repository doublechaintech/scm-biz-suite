...
class LeaveTypeCreateFormBody extends Component {
  state = {
  ...
  componentDidMount() {
    ...
    const formValue = LeaveTypeBase.unpackObjectToFormValues(initValue)
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.description} {...formItemLayout}>
                  {getFieldDecorator('description', {
                    ...
                    <SmallTextInput minLength={1} maxLength={16} size="large"  placeholder={fieldLabels.description} />
                  )}
                </Form.Item>
              </Col>
              ...
              <Col lg={24} md={24} sm={24} style={{"display":"none"}}>
                <Form.Item label={fieldLabels.company} {...formItemLayout}>
                  ...
                  <CandidateList
                    ...
                    requestFunction={LeaveTypeService.queryCandidates}  />
...
}))(Form.create()(LeaveTypeCreateFormBody))
