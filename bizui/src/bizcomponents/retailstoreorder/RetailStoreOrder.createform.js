...
=======
import RetailStoreOrderCreateFormBody from './RetailStoreOrder.createformbody'
...
class RetailStoreOrderCreateForm extends Component {
  state = {
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          ...
          payload: { id: owner.id, type: 'retailStoreOrder', parameters, continueNext: true },
        })
      })
    }
...
<<<<<<< HEAD
      dispatch({
        ...
        payload: { id: owner.id, type: 'retailStoreOrder',listName:'生超的订单列表' },
=======
...
}))(Form.create()(RetailStoreOrderCreateForm))
