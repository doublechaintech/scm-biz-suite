...
class RetailStoreOrderSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      retailStoreOrderList: 1,
      'retailStoreOrderList.searchField': fieldName,
      'retailStoreOrderList.searchVerb': 'startsWith',
      'retailStoreOrderList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`retailStoreOrderList.searchField`] = fieldName
    value[`retailStoreOrderList.searchVerb`] =  searchVerb
    value[`retailStoreOrderList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      params['retailStoreOrderList'] = 1
      params['retailStoreOrderList.orderBy.0'] = "id"
      params['retailStoreOrderList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        retailStoreOrderSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(RetailStoreOrderSearchForm)
