...
import styles from './RetailStoreCountryCenter.search.less'
...
class RetailStoreCountryCenterSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      retailStoreCountryCenterList: 1,
      'retailStoreCountryCenterList.searchField': fieldName,
      'retailStoreCountryCenterList.searchVerb': 'startsWith',
      'retailStoreCountryCenterList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`retailStoreCountryCenterList.searchField`] = fieldName
    value[`retailStoreCountryCenterList.searchVerb`] =  searchVerb
    value[`retailStoreCountryCenterList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'contains', 'serviceNumber'))
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'contains', 'webSite'))
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'contains', 'address'))
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'contains', 'operatedBy'))
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'contains', 'legalRepresentative'))
...
=======
      ...
      const {listName} = owner
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'contains', 'serviceNumber'))
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'contains', 'webSite'))
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'contains', 'address'))
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'contains', 'operatedBy'))
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'contains', 'legalRepresentative'))
...
<<<<<<< HEAD
      params['retailStoreCountryCenterList'] = 1
      params['retailStoreCountryCenterList.orderBy.0'] = "id"
      params['retailStoreCountryCenterList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        retailStoreCountryCenterSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(RetailStoreCountryCenterSearchForm)
