...
import styles from './RetailStoreCountryCenter.workbench.less'
...
class RetailStoreCountryCenterWorkbench extends Component {
...
}))(Form.create()(RetailStoreCountryCenterWorkbench))
