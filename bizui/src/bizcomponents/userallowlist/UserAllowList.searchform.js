...
import styles from './UserAllowList.search.less'
import GlobalComponents from '../../custcomponents'
import CandidateList from '../../components/CandidateList'
import appLocaleName from '../../common/Locale.tool'
import UserAllowListBase from './UserAllowList.base'
const FormItem = Form.Item
const { Option } = Select
const getValue = obj => Object.keys(obj).map(key => obj[key]).join(',')
const {fieldLabels} = UserAllowListBase
...
class UserAllowListSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      userAllowListList: 1,
      'userAllowListList.searchField': fieldName,
      'userAllowListList.searchVerb': 'startsWith',
      'userAllowListList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        userAllowListSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                  ...
                  <CandidateList 
		                 ...
		                 ownerId={owner.id}
		                 scenarioCode={"search"}
		                 listType={"user_allow_list"} 
		                 targetType={"user_domain"} 
                 
                    requestFunction={UserAllowListService.queryCandidates} useForSearch />
...
export default Form.create()(UserAllowListSearchForm)
