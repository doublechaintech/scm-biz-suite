...
import styles from './UserAllowList.updateform.less'
...
class UserAllowListUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const userAllowListId = values.id

        const parameters = { ...values, userAllowListId, }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateUserAllowList`,
          payload: {
            id: owner.id,
            type: 'userAllowList',
            parameters,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextUserAllowListUpdateRow`,
        payload: {
          id: owner.id,
          type: 'userAllowList',
          selectedRows,
	...
	const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"Update")}用户权限列表: {(currentUpdateIndex+1)}/{selectedRows.length}</div>)
    }
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.userIdentity} {...formItemLayout}>
                  {getFieldDecorator('userIdentity', {
                    ...
                    <SmallTextInput size="large"  placeholder={fieldLabels.userIdentity} />
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.userSpecialFunctions} {...formItemLayout}>
                  {getFieldDecorator('userSpecialFunctions', {
                    ...
                    <SmallTextInput size="large"  placeholder={fieldLabels.userSpecialFunctions} />
...
}))(Form.create()(UserAllowListUpdateForm))
