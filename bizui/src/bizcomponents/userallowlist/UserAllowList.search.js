...
class UserAllowListSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {UserAllowListTable} = GlobalComponents;
    const {UserAllowListSearchForm} = GlobalComponents;
    const {UserAllowListModalTable} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        ...
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <UserAllowListSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,UserAllowListModalTable,"userAllowListIds")}
...
export default Form.create()(UserAllowListSearch)
