...
class OfferApprovalBizApp extends React.PureComponent {
  ...
  getNavMenuItems = (targetObject) => {
    ...
    return (
		  ...
		  <Menu
           ...
           >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/offerApproval/${this.props.offerApproval.id}/dashboard`}><Icon type="dashboard" /><span>仪表板</span></Link>
             </Menu.Item>
       ...
       <Menu.Item key="preference">
               <Link to={`/offerApproval/${this.props.offerApproval.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
  ...
  getEmployeeCreateForm = () => {
    ...
    return connect(state => ({
      ...
      searchFormParameters: state._offerApproval.employeeSearchFormParameters,
      loading: state._offerApproval.loading,
      owner: { type: '_offerApproval', id: state._offerApproval.id, referenceName: 'offerApproval', listName: 'employeeList', ref:state._offerApproval, listDisplayName: '员工列表'}, // this is for model namespace and
    }))(EmployeeCreateForm)
  }
  ...
  getEmployeeUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_offerApproval', id: state._offerApproval.id, listName: 'employeeList', ref:state._offerApproval, listDisplayName: '员工列表' }, // this is for model namespace and
    }))(EmployeeUpdateForm)
  }
  ...
  buildRouters = () =>{
  	...
  	const {OfferApprovalPreference} = GlobalComponents
  	
  	
  	const routers=[
  	{path:"/offerApproval/:id/dashboard", component: OfferApprovalDashboard},
  	{path:"/offerApproval/:id/preference", component: OfferApprovalPreference},
  ...
  handleOpenChange = (openKeys) => {
   ...
   render() {
     ...
     //const {OfferApprovalEditDetail} = GlobalComponents
     //const {OfferApprovalViewDetail} = GlobalComponents
     ...
     <Layout>
       ...
       <Layout>
		 ...
		 {this.getNavMenuItems(this.props.offerApproval)}
