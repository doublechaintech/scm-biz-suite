...
import styles from './OfferApproval.createform.less'
...
=======
import OfferApprovalCreateFormBody from './OfferApproval.createformbody'
...
class OfferApprovalCreateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, ...imagesValues }
        dispatch({
          type: `${owner.type}/addOfferApproval`,
          payload: { id: owner.id, type: 'offerApproval', parameters, continueNext: true },
        })
      })
    }
...
<<<<<<< HEAD
      dispatch({
        ...
        payload: { id: owner.id, type: 'offerApproval',listName:'审批工作要约列表' },
=======
     
      dispatch({
        type: `${owner.type}/goback`,
        payload: { id: owner.id, type: 'offerApproval',listName:appLocaleName(userContext,"List") },
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      })
    }
...
=======
	...
	return (
      ...
      >
   		...
   		<OfferApprovalCreateFormBody	 {...this.props} />
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
...
}))(Form.create()(OfferApprovalCreateForm))
