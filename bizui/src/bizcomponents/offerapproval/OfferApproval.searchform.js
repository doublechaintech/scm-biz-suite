...
import styles from './OfferApproval.search.less'
...
class OfferApprovalSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      offerApprovalList: 1,
      'offerApprovalList.searchField': fieldName,
      'offerApprovalList.searchVerb': 'startsWith',
      'offerApprovalList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`offerApprovalList.searchField`] = fieldName
    value[`offerApprovalList.searchVerb`] =  searchVerb
    value[`offerApprovalList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
      params['offerApprovalList'] = 1
      params['offerApprovalList.orderBy.0'] = "id"
      params['offerApprovalList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        offerApprovalSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(OfferApprovalSearchForm)
