...
class OfferApprovalSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {OfferApprovalTable} = GlobalComponents;
    const {OfferApprovalSearchForm} = GlobalComponents;
    const {OfferApprovalModalTable} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <OfferApprovalSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,OfferApprovalModalTable,"offerApprovalIds")}
...
export default Form.create()(OfferApprovalSearch)
