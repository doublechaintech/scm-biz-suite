...
import styles from './OfferApproval.updateform.less'
import OfferApprovalBase from './OfferApproval.base'
<<<<<<< HEAD
=======
...
class OfferApprovalUpdateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
        ...
        const offerApprovalId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, offerApprovalId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateOfferApproval`,
          payload: {
            id: owner.id,
            type: 'offerApproval',
            parameters,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextOfferApprovalUpdateRow`,
        payload: {
          id: owner.id,
          type: 'offerApproval',
          selectedRows,
...
<<<<<<< HEAD
    ...
    return (
      <PageHeaderLayout
        title={"更新审批工作要约"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新审批工作要约"
...
=======
	...
	const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"Update")}审批工作要约: {(currentUpdateIndex+1)}/{selectedRows.length}</div>)
    }
...
}))(Form.create()(OfferApprovalUpdateForm))
