...
const renderSettingMenu = (cardsData,targetComponent) =>{
  ...
  return (<Menu>
		...
		<Menu.Item key="permission">
  			<Link to={`/offerApproval/${targetComponent.props.offerApproval.id}/profile`}><Icon type="cluster"  twoToneColor="#52c41a"/><span>{appLocaleName(userContext,"Profile")}</span></Link>
			</Menu.Item>
		</Menu>)
