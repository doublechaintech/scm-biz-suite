...
const internalImageListOf = (offerApproval) =>{
...
const internalSettingListOf = (offerApproval) =>{
...
const handleTransferSearch =(targetComponent,filterKey,newRequest)=>{
  ...
  const pageNo = 1;
  const candidateReferenceService = OfferApprovalService[candidateServiceName] 
...
const executeTrans = (offerApproval,targetComponent) =>{
...
const buildTransferModal = (offerApproval,targetComponent) => {
...
<Modal title={transferModalTitle}
          ...
          onOk={()=>executeTrans(offerApproval,targetComponent)}
...
const internalRenderExtraHeader = (offerApproval) =>{
	return null
}
const internalRenderExtraFooter = (offerApproval) =>{
	return null
}
...
class OfferApprovalPreference extends Component {
...
}))(Form.create()(OfferApprovalPreference))
