...
=======
import ReceivingSpaceCreateFormBody from './ReceivingSpace.createformbody'
...
const testValues = {
  ...
  totalArea: '1876平方米',
<<<<<<< HEAD
  latitude: '40.175476527548746',
  longitude: '129.93404136860386',
=======
...
class ReceivingSpaceCreateForm extends Component {
  state = {
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          ...
          payload: { id: owner.id, type: 'receivingSpace', parameters, continueNext: true },
        })
      })
    }
...
<<<<<<< HEAD
      dispatch({
        ...
        payload: { id: owner.id, type: 'receivingSpace',listName:'收货区列表' },
=======
...
=======
	...
	return (
      ...
      >
   		...
   		<ReceivingSpaceCreateFormBody	 {...this.props} />
...
}))(Form.create()(ReceivingSpaceCreateForm))
