...
const testValues = {
  ...
  totalArea: '1876平方米',
  latitude: '42.57248091674726',
  longitude: '131.53416913858194',
  warehouseId: 'W000001',
}
*/
...
class ReceivingSpaceCreateForm extends Component {
  ...
  render() {
	...
	return (
      <PageHeaderLayout
        title={`${appLocaleName(userContext,"CreateNew")}Receiving Space`}
        content={`${appLocaleName(userContext,"CreateNew")}Receiving Space`}
