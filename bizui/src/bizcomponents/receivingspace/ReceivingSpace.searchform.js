...
import styles from './ReceivingSpace.search.less'
...
class ReceivingSpaceSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      receivingSpaceList: 1,
      'receivingSpaceList.searchField': fieldName,
      'receivingSpaceList.searchVerb': 'startsWith',
      'receivingSpaceList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`receivingSpaceList.searchField`] = fieldName
    value[`receivingSpaceList.searchVerb`] =  searchVerb
    value[`receivingSpaceList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
      params['receivingSpaceList'] = 1
      params['receivingSpaceList.orderBy.0'] = "id"
      params['receivingSpaceList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        receivingSpaceSearchFormParameters: filterObjectKeys(fieldsValue),
...
=======
                    requestFunction={ReceivingSpaceService.requestCandidateWarehouse} useForSearch />
...
export default Form.create()(ReceivingSpaceSearchForm)
