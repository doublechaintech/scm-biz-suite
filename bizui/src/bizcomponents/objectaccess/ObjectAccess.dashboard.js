...
<Description term="对象类型" style={{wordBreak: 'break-all'}}>{objectAccess.objectType}</Description> 
<Description term="表" style={{wordBreak: 'break-all'}}>{objectAccess.list1}</Description> 
<Description term="清单" style={{wordBreak: 'break-all'}}>{objectAccess.list2}</Description> 
<Description term="目录3" style={{wordBreak: 'break-all'}}>{objectAccess.list3}</Description> 
<Description term="清单" style={{wordBreak: 'break-all'}}>{objectAccess.list4}</Description> 
<Description term="列表6" style={{wordBreak: 'break-all'}}>{objectAccess.list5}</Description> 
<Description term="list6" style={{wordBreak: 'break-all'}}>{objectAccess.list6}</Description> 
<Description term="list7" style={{wordBreak: 'break-all'}}>{objectAccess.list7}</Description> 
<Description term="list8" style={{wordBreak: 'break-all'}}>{objectAccess.list8}</Description> 
<Description term="list9" style={{wordBreak: 'break-all'}}>{objectAccess.list9}</Description> 
