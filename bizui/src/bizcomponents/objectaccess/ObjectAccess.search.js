...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{objectAccessList:selectedRows}} owner={owner}  
...
class ObjectAccessSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    return (
      <PageHeaderLayout title={`${displayName}:${this.props.name}列表`}>
        ...
        {showDeletionDialog(this,ObjectAccessModalTable,"objectAccessIds")}
...
export default Form.create()(ObjectAccessSearch)
