...
import styles from './LevelTwoDepartment.createform.less'
...
=======
import LevelTwoDepartmentCreateFormBody from './LevelTwoDepartment.createformbody'
...
class LevelTwoDepartmentCreateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
    ...
    const {fieldLabels} = LevelTwoDepartmentBase
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, ...imagesValues }
        dispatch({
          type: `${owner.type}/addLevelTwoDepartment`,
          payload: { id: owner.id, type: 'levelTwoDepartment', parameters, continueNext: true },
        })
      })
    }
...
<<<<<<< HEAD
      dispatch({
        ...
        payload: { id: owner.id, type: 'levelTwoDepartment',listName:'二级部门列表' },
=======
     
      dispatch({
        type: `${owner.type}/goback`,
        payload: { id: owner.id, type: 'levelTwoDepartment',listName:appLocaleName(userContext,"List") },
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      })
    }
...
}))(Form.create()(LevelTwoDepartmentCreateForm))
