...
const showAssociateDialog = (targetComponent) => {
  ...
  const { LevelOneDepartmentAssociateForm } = GlobalComponents
  ...
  <div>
	...
	data={{levelTwoDepartmentList:selectedRows}} owner={owner}  
...
class LevelTwoDepartmentSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {LevelTwoDepartmentTable} = GlobalComponents;
    const {LevelTwoDepartmentSearchForm} = GlobalComponents;
    const {LevelTwoDepartmentModalTable} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        ...
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <LevelTwoDepartmentSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,LevelTwoDepartmentModalTable,"levelTwoDepartmentIds")}
...
export default Form.create()(LevelTwoDepartmentSearch)
