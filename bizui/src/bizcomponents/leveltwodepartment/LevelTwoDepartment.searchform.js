...
import styles from './LevelTwoDepartment.search.less'
...
class LevelTwoDepartmentSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      levelTwoDepartmentList: 1,
      'levelTwoDepartmentList.searchField': fieldName,
      'levelTwoDepartmentList.searchVerb': 'startsWith',
      'levelTwoDepartmentList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`levelTwoDepartmentList.searchField`] = fieldName
    value[`levelTwoDepartmentList.searchVerb`] =  searchVerb
    value[`levelTwoDepartmentList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
      params['levelTwoDepartmentList'] = 1
      params['levelTwoDepartmentList.orderBy.0'] = "id"
      params['levelTwoDepartmentList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        levelTwoDepartmentSearchFormParameters: filterObjectKeys(fieldsValue),
...
<<<<<<< HEAD
                 requestFunction={LevelTwoDepartmentService.requestCandidateBelongsTo}/>
               
              
=======
                 requestFunction={LevelTwoDepartmentService.requestCandidateBelongsTo} useForSearch />
...
export default Form.create()(LevelTwoDepartmentSearchForm)
