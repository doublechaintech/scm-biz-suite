 ...
 getNavMenuItems = (targetObject, style, customTheme) => {
    ...
    return (
	  <Menu
       ...
       <Menu.Item key="workbench">
        <Link to={`/levelTwoDepartment/${this.props.levelTwoDepartment.id}/workbench`}><Icon type="solution" style={{marginRight:"20px"}}/><span>工作台</span></Link>
      </Menu.Item>
        ...
        {filteredMenuItemsGroup(targetObject,this).map((groupedMenuItem,index)=>{
          return(
    <SubMenu id={`submenu-vg${index}`}  key={`vg${index}`} title={<span><Icon type={viewGroupIconNameOf('level_two_department',`${groupedMenuItem.viewGroup}`)} style={{marginRight:"20px"}} /><span>{viewGroupDisplayNameOf('level_two_department',`${groupedMenuItem.viewGroup}`)}</span></span>} >
  ...
  getLevelThreeDepartmentSearch = () => {
    ...
    return connect(state => ({
      ...
      returnURL: `/levelTwoDepartment/${state._levelTwoDepartment.id}/workbench`,
  ...
  getLevelThreeDepartmentCreateForm = () => {
    ...
    return connect(state => ({
      ...
      searchFormParameters: state._levelTwoDepartment.levelThreeDepartmentSearchFormParameters,
      loading: state._levelTwoDepartment.loading,
      owner: { type: '_levelTwoDepartment', id: state._levelTwoDepartment.id || this.getOwnerId(), referenceName: 'belongsTo', listName: 'levelThreeDepartmentList', ref:state._levelTwoDepartment, listDisplayName: appLocaleName(userContext,"List")}, // this is for model namespace and
  ...
  getLevelThreeDepartmentUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      role: "levelThreeDepartment",
      currentUpdateIndex: state._levelTwoDepartment.currentUpdateIndex || 0,
      owner: { type: '_levelTwoDepartment', id: state._levelTwoDepartment.id || this.getOwnerId(), listName: 'levelThreeDepartmentList', ref:state._levelTwoDepartment, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
  ...
  getRequestTypeStepForm = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_levelTwoDepartment', id: state._levelTwoDepartment.id, listName: 'nolist', ref:state._levelTwoDepartment, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
  ...
  buildRouters = () =>{
    const {LevelTwoDepartmentWorkbench} = GlobalComponents
    ...
    const routers=[
    {path:"/levelTwoDepartment/:id/workbench", component: LevelTwoDepartmentWorkbench},
