...
class LevelTwoDepartmentAssociateForm extends Component {
  state = {
 ...
 <Modal
	...
	<LevelThreeDepartmentModalTable data={data.levelThreeDepartmentList} owner={owner} />
...
}))(Form.create()(LevelTwoDepartmentAssociateForm))
