...
import styles from './EmployeeEducation.search.less'
...
class EmployeeEducationSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      employeeEducationList: 1,
      'employeeEducationList.searchField': fieldName,
      'employeeEducationList.searchVerb': 'startsWith',
      'employeeEducationList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`employeeEducationList.searchField`] = fieldName
    value[`employeeEducationList.searchVerb`] =  searchVerb
    value[`employeeEducationList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
      params['employeeEducationList'] = 1
      params['employeeEducationList.orderBy.0'] = "id"
      params['employeeEducationList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        employeeEducationSearchFormParameters: filterObjectKeys(fieldsValue),
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
               ...
               <SelectObject 
                 ...
                 targetType={"employee"} 
<<<<<<< HEAD
                 requestFunction={EmployeeEducationService.requestCandidateEmployee}/>
               
              
=======
                 requestFunction={EmployeeEducationService.requestCandidateEmployee} useForSearch />
...
export default Form.create()(EmployeeEducationSearchForm)
