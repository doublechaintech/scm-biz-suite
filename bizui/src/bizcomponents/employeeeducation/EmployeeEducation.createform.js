...
import styles from './EmployeeEducation.createform.less'
...
=======
import EmployeeEducationCreateFormBody from './EmployeeEducation.createformbody'
...
const testValues = {
<<<<<<< HEAD
  completeTime: '2017-02-15',
=======
  completeTime: '2019-08-20',
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
  type: '小学',
  remark: '考试成绩当年第一名',
  employeeId: 'E000001',
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, ...imagesValues }
        dispatch({
          type: `${owner.type}/addEmployeeEducation`,
          payload: { id: owner.id, type: 'employeeEducation', parameters, continueNext: true },
        })
      })
    }
...
<<<<<<< HEAD
      dispatch({
        ...
        payload: { id: owner.id, type: 'employeeEducation',listName:'员工教育列表' },
=======
     
      dispatch({
        type: `${owner.type}/goback`,
        payload: { id: owner.id, type: 'employeeEducation',listName:appLocaleName(userContext,"List") },
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      })
    }
...
}))(Form.create()(EmployeeEducationCreateForm))
