...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{employeeEducationList:selectedRows}} owner={owner}  
...
class EmployeeEducationSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {EmployeeEducationTable} = GlobalComponents;
    const {EmployeeEducationSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        ...
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <EmployeeEducationSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,EmployeeEducationModalTable,"employeeEducationIds")}
...
export default Form.create()(EmployeeEducationSearch)
