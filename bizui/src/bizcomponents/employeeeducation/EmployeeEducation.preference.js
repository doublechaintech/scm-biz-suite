...
const internalImageListOf = (employeeEducation) =>{
<<<<<<< HEAD
...
const internalSettingListOf = (employeeEducation) =>{
<<<<<<< HEAD
...
const handleTransferSearch =(targetComponent,filterKey,newRequest)=>{
  ...
  const pageNo = 1;
  const candidateReferenceService = EmployeeEducationService[candidateServiceName] 
...
const executeTrans = (employeeEducation,targetComponent) =>{
...
const buildTransferModal = (employeeEducation,targetComponent) => {
...
<Modal title={transferModalTitle}
          ...
          onOk={()=>executeTrans(employeeEducation,targetComponent)}
...
const internalRenderExtraHeader = (employeeEducation) =>{
	return null
}
const internalRenderExtraFooter = (employeeEducation) =>{
	return null
}
...
=======
	...
	<DescriptionList className={styles.headerList} size="small" col="4">
<Description term="序号">{employeeEducation.id}</Description> 
<Description term="员工">{employeeEducation.employee==null?appLocaleName(userContext,"NotAssigned"):employeeEducation.employee.displayName}
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
 <Icon type="swap" onClick={()=>
  showTransferModel(targetComponent,"员工","employee","requestCandidateEmployee",
	      "transferToAnotherEmployee","anotherEmployeeId",employeeEducation.employee?employeeEducation.employee.id:"")} 
...
class EmployeeEducationPreference extends Component {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
  ...
  render() {
    ...
    const cardsData = {cardsName:"员工教育",cardsFor: "employeeEducation",cardsSource: this.props.employeeEducation,
  		subItems: [
...
}))(Form.create()(EmployeeEducationPreference))
