...
import styles from './EmployeeEducation.updateform.less'
import EmployeeEducationBase from './EmployeeEducation.base'
<<<<<<< HEAD
=======
...
class EmployeeEducationUpdateForm extends Component {
  state = {
  ...
  getSelectedRow() {
    ...
    const convertiedValues = selectedRows.map((item) => {
      return {
        ...item,
        completeTime: moment(item.completeTime),
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
    const {fieldLabels} = EmployeeEducationBase
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
        ...
        const employeeEducationId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, employeeEducationId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateEmployeeEducation`,
          payload: {
            id: owner.id,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextEmployeeEducationUpdateRow`,
        payload: {
          id: owner.id,
          type: 'employeeEducation',
          selectedRows,
...
<<<<<<< HEAD
    ...
    return (
      <PageHeaderLayout
        title={"更新员工教育"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新员工教育"
...
=======
	...
	const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"Update")}员工教育: {(currentUpdateIndex+1)}/{selectedRows.length}</div>)
    }
              ...
              <Col lg={12} md={12} sm={24}>
                <Form.Item label={fieldLabels.completeTime} {...formItemLayout}>
                  {getFieldDecorator('completeTime', {
                    initialValue: selectedRow.completeTime,
...
}))(Form.create()(EmployeeEducationUpdateForm))
