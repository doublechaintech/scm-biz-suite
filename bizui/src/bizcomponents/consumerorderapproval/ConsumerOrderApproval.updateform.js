...
import styles from './ConsumerOrderApproval.updateform.less'
...
class ConsumerOrderApprovalUpdateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
    const {fieldLabels} = ConsumerOrderApprovalBase
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
        ...
        const consumerOrderApprovalId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, consumerOrderApprovalId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateConsumerOrderApproval`,
          payload: {
            id: owner.id,
            type: 'consumerOrderApproval',
            parameters,
            selectedRows,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextConsumerOrderApprovalUpdateRow`,
        payload: {
          id: owner.id,
          type: 'consumerOrderApproval',
          selectedRows,
...
<<<<<<< HEAD
    ...
    return (
      <PageHeaderLayout
        title={"更新消费者的订单审批"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新消费者的订单审批"
...
=======
	...
	const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"Update")}消费者的订单审批: {(currentUpdateIndex+1)}/{selectedRows.length}</div>)
    }
...
}))(Form.create()(ConsumerOrderApprovalUpdateForm))
