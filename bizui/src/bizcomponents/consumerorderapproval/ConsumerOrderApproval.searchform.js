...
class ConsumerOrderApprovalSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      consumerOrderApprovalList: 1,
      'consumerOrderApprovalList.searchField': fieldName,
      'consumerOrderApprovalList.searchVerb': 'startsWith',
      'consumerOrderApprovalList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        consumerOrderApprovalSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(ConsumerOrderApprovalSearchForm)
