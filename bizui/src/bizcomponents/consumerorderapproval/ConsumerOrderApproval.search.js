...
class ConsumerOrderApprovalSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {ConsumerOrderApprovalTable} = GlobalComponents;
    const {ConsumerOrderApprovalSearchForm} = GlobalComponents;
    const {ConsumerOrderApprovalModalTable} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <ConsumerOrderApprovalSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,ConsumerOrderApprovalModalTable,"consumerOrderApprovalIds")}
...
export default Form.create()(ConsumerOrderApprovalSearch)
