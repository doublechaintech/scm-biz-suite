...
class AccountingDocumentSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      accountingDocumentList: 1,
      'accountingDocumentList.searchField': fieldName,
      'accountingDocumentList.searchVerb': 'startsWith',
      'accountingDocumentList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`accountingDocumentList.searchField`] = fieldName
    value[`accountingDocumentList.searchVerb`] =  searchVerb
    value[`accountingDocumentList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      const paramList = []
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'eq', 'documentType'))
      ...
      params['accountingDocumentList'] = 1
      params['accountingDocumentList.orderBy.0'] = "id"
      params['accountingDocumentList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        accountingDocumentSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(AccountingDocumentSearchForm)
