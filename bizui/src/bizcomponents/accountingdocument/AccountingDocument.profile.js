...
const internalSummaryOf = (item, targetComponents)=>{
	...
	return GlobalComponents.AccountingDocumentBase.renderItemOfList(item, targetComponents)

}



class AccountingDocumentProfile extends Component {
...
}))(Form.create()(AccountingDocumentProfile))
