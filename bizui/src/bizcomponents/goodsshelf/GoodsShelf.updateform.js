...
import styles from './GoodsShelf.updateform.less'
...
class GoodsShelfUpdateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
        ...
        const goodsShelfId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, goodsShelfId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateGoodsShelf`,
          payload: {
            id: owner.id,
            type: 'goodsShelf',
            parameters,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextGoodsShelfUpdateRow`,
        payload: {
          id: owner.id,
          type: 'goodsShelf',
          selectedRows,
...
<<<<<<< HEAD
    ...
    return (
      <PageHeaderLayout
        title={"更新货架"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新货架"
...
=======
	...
	const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"Update")}货架: {(currentUpdateIndex+1)}/{selectedRows.length}</div>)
    }
...
}))(Form.create()(GoodsShelfUpdateForm))
