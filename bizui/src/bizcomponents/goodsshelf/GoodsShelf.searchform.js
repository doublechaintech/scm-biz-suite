...
componentDidMount() {
  ...
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`goodsShelfList.searchField`] = fieldName
    value[`goodsShelfList.searchVerb`] =  searchVerb
    value[`goodsShelfList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      const paramList = []
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'eq', 'storageSpace'))
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'eq', 'supplierSpace'))
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'eq', 'damageSpace'))
      ...
      params['goodsShelfList'] = 1
      params['goodsShelfList.orderBy.0'] = "id"
      params['goodsShelfList.descOrAsc.0'] = "desc"
