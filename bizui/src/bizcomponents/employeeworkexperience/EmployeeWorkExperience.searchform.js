...
class EmployeeWorkExperienceSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      employeeWorkExperienceList: 1,
      'employeeWorkExperienceList.searchField': fieldName,
      'employeeWorkExperienceList.searchVerb': 'startsWith',
      'employeeWorkExperienceList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`employeeWorkExperienceList.searchField`] = fieldName
    value[`employeeWorkExperienceList.searchVerb`] =  searchVerb
    value[`employeeWorkExperienceList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'contains', 'company'))
...
=======
      ...
      const {listName} = owner
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'contains', 'company'))
...
<<<<<<< HEAD
      params['employeeWorkExperienceList'] = 1
      params['employeeWorkExperienceList.orderBy.0'] = "id"
      params['employeeWorkExperienceList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        employeeWorkExperienceSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(EmployeeWorkExperienceSearchForm)
