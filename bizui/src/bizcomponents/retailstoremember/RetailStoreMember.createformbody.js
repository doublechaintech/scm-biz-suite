...
class RetailStoreMemberCreateFormBody extends Component {
  state = {
  ...
  componentDidMount() {
    ...
    const formValue = RetailStoreMemberBase.unpackObjectToFormValues(initValue)
              ...
              <Col lg={24} md={24} sm={24} style={{"display":"none"}}>
                <Form.Item label={fieldLabels.owner} {...formItemLayout}>
                  ...
                  <CandidateList
                    ...
                    requestFunction={RetailStoreMemberService.queryCandidates}  />
...
}))(Form.create()(RetailStoreMemberCreateFormBody))
