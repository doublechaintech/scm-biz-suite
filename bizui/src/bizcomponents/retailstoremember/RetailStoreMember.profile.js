...
const internalSummaryOf = (item, targetComponents)=>{
	...
	return GlobalComponents.RetailStoreMemberBase.renderItemOfList(item, targetComponents)
...
class RetailStoreMemberProfile extends Component {
  ...
  render() {
    ...
    const cardsData = {cardsName:"Retail Store Member",cardsFor: "retailStoreMember",cardsSource: retailStoreMember,
  		subItems: [
