...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{retailStoreMemberList:selectedRows}} owner={owner}  
...
class RetailStoreMemberSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {RetailStoreMemberTable} = GlobalComponents;
    const {RetailStoreMemberSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={`${displayName}:${this.props.name}列表`}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <RetailStoreMemberSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,RetailStoreMemberModalTable,"retailStoreMemberIds")}
...
export default Form.create()(RetailStoreMemberSearch)
