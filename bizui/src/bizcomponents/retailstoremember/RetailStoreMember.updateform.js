...
import styles from './RetailStoreMember.updateform.less'
...
class RetailStoreMemberUpdateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
        ...
        const retailStoreMemberId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, retailStoreMemberId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateRetailStoreMember`,
          payload: {
            id: owner.id,
            type: 'retailStoreMember',
            parameters,
            selectedRows,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextRetailStoreMemberUpdateRow`,
        payload: {
          id: owner.id,
          type: 'retailStoreMember',
          selectedRows,
...
<<<<<<< HEAD
    ...
    return (
      <PageHeaderLayout
        title={"更新生超会员"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新生超会员"
...
=======
	...
	const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"Update")}生超会员: {(currentUpdateIndex+1)}/{selectedRows.length}</div>)
    }
...
}))(Form.create()(RetailStoreMemberUpdateForm))
