...
import styles from './RetailStoreMember.search.less'
...
class RetailStoreMemberSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      retailStoreMemberList: 1,
      'retailStoreMemberList.searchField': fieldName,
      'retailStoreMemberList.searchVerb': 'startsWith',
      'retailStoreMemberList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`retailStoreMemberList.searchField`] = fieldName
    value[`retailStoreMemberList.searchVerb`] =  searchVerb
    value[`retailStoreMemberList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
      params['retailStoreMemberList'] = 1
      params['retailStoreMemberList.orderBy.0'] = "id"
      params['retailStoreMemberList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        retailStoreMemberSearchFormParameters: filterObjectKeys(fieldsValue),
...
=======
                    requestFunction={RetailStoreMemberService.requestCandidateOwner} useForSearch />
...
export default Form.create()(RetailStoreMemberSearchForm)
