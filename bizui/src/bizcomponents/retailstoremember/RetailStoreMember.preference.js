...
const internalImageListOf = (retailStoreMember) =>{
<<<<<<< HEAD
...
const internalSettingListOf = (retailStoreMember) =>{
<<<<<<< HEAD
...
const handleTransferSearch =(targetComponent,filterKey,newRequest)=>{
  ...
  const pageNo = 1;
  const candidateReferenceService = RetailStoreMemberService[candidateServiceName] 
...
const executeTrans = (retailStoreMember,targetComponent) =>{
...
const buildTransferModal = (retailStoreMember,targetComponent) => {
...
<Modal title={transferModalTitle}
          ...
          onOk={()=>executeTrans(retailStoreMember,targetComponent)}
...
const internalRenderExtraFooter = (retailStoreMember) =>{
	return null
}
...
class RetailStoreMemberPreference extends Component {
...
}))(Form.create()(RetailStoreMemberPreference))
