...
import styles from './RetailStore.updateform.less'
...
class RetailStoreUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const retailStoreId = values.id

        const parameters = { ...values, retailStoreId, }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateRetailStore`,
          payload: {
            id: owner.id,
            type: 'retailStore',
            parameters,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextRetailStoreUpdateRow`,
        payload: {
          id: owner.id,
          type: 'retailStore',
          selectedRows,
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.telephone} {...formItemLayout}>
                  {getFieldDecorator('telephone', {
                    ...
                    <SmallTextInput size="large"  placeholder={fieldLabels.telephone} />
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.owner} {...formItemLayout}>
                  {getFieldDecorator('owner', {
                    ...
                    <SmallTextInput size="large"  placeholder={fieldLabels.owner} />
...
}))(Form.create()(RetailStoreUpdateForm))
