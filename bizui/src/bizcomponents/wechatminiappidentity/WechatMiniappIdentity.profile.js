...
const internalSummaryOf = (item, targetComponents)=>{
	...
	return GlobalComponents.WechatMiniappIdentityBase.renderItemOfList(item, targetComponents)

}



class WechatMiniappIdentityProfile extends Component {
  ...
  render() {
    ...
    const  returnURL = `/wechatMiniappIdentity/${id}/dashboard`
...
}))(Form.create()(WechatMiniappIdentityProfile))
