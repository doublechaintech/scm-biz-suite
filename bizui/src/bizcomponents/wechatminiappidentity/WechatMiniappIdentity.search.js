...
class WechatMiniappIdentitySearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {WechatMiniappIdentityTable} = GlobalComponents;
    const {WechatMiniappIdentitySearchForm} = GlobalComponents;
    const {WechatMiniappIdentityModalTable} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        ...
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <WechatMiniappIdentitySearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,WechatMiniappIdentityModalTable,"wechatMiniappIdentityIds")}
...
export default Form.create()(WechatMiniappIdentitySearch)
