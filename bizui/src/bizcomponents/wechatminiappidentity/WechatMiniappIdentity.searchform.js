...
import styles from './WechatMiniappIdentity.search.less'
...
class WechatMiniappIdentitySearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      wechatMiniappIdentityList: 1,
      'wechatMiniappIdentityList.searchField': fieldName,
      'wechatMiniappIdentityList.searchVerb': 'startsWith',
      'wechatMiniappIdentityList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      const {listName} = owner
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'contains', 'unionId'))
      ...
      dispatch({
        ...
        wechatMiniappIdentitySearchFormParameters: filterObjectKeys(fieldsValue),
  ...
  renderSimpleForm() {
    ...
    return (
      <Form onSubmit={this.handleSearch} layout="inline">
       ...
       <Col md={8} sm={24}>
         <FormItem label={fieldLabels.openId}>
    ...
    return (
      <Form onSubmit={this.handleSearch} layout="inline">
        <Row gutter={{ md: 8, lg: 24, xl: 48 }}>
          ...
          <Col md={8} sm={24}>
            <FormItem label={fieldLabels.appId}>
          ...
          <Col md={8} sm={24}>
            <FormItem label={fieldLabels.unionId}>
 ...
 <Col md={8} sm={24}>
                  ...
                  <CandidateList 
                    ...
                    requestFunction={WechatMiniappIdentityService.queryCandidates} useForSearch />
...
export default Form.create()(WechatMiniappIdentitySearchForm)
