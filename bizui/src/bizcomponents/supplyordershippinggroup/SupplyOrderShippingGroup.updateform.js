...
import styles from './SupplyOrderShippingGroup.updateform.less'
...
class SupplyOrderShippingGroupUpdateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
        ...
        const supplyOrderShippingGroupId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, supplyOrderShippingGroupId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateSupplyOrderShippingGroup`,
          payload: {
            id: owner.id,
            type: 'supplyOrderShippingGroup',
            parameters,
            selectedRows,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextSupplyOrderShippingGroupUpdateRow`,
        payload: {
          id: owner.id,
          type: 'supplyOrderShippingGroup',
          selectedRows,
...
<<<<<<< HEAD
    ...
    return (
      <PageHeaderLayout
        title={"更新供应订单送货分组"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新供应订单送货分组"
...
=======
	...
	const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"Update")}供应订单送货分组: {(currentUpdateIndex+1)}/{selectedRows.length}</div>)
    }
...
}))(Form.create()(SupplyOrderShippingGroupUpdateForm))
