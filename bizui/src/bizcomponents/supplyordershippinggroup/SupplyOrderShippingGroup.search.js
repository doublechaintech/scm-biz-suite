...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{supplyOrderShippingGroupList:selectedRows}} owner={owner}  
...
class SupplyOrderShippingGroupSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {SupplyOrderShippingGroupTable} = GlobalComponents;
    const {SupplyOrderShippingGroupSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={`${displayName}:${this.props.name}${appLocaleName(userContext,"List")}`}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <SupplyOrderShippingGroupSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,SupplyOrderShippingGroupModalTable,"supplyOrderShippingGroupIds")}
...
export default Form.create()(SupplyOrderShippingGroupSearch)
