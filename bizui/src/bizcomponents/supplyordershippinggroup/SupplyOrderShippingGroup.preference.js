...
const internalImageListOf = (supplyOrderShippingGroup) =>{
<<<<<<< HEAD
...
const internalSettingListOf = (supplyOrderShippingGroup) =>{
<<<<<<< HEAD
...
const handleTransferSearch =(targetComponent,filterKey,newRequest)=>{
  ...
  const pageNo = 1;
  const candidateReferenceService = SupplyOrderShippingGroupService[candidateServiceName] 
...
const executeTrans = (supplyOrderShippingGroup,targetComponent) =>{
  ...
  validateFieldsAndScroll((error, values) => {
    ...
    const id=supplyOrderShippingGroup.id;
    const serviceNameToCall = transferServiceName;

    const payload = {parameters,id,serviceNameToCall}
    
    //targetComponent.setState({transferModalVisiable:false})
    dispatch({type:"_supplyOrderShippingGroup/doJob",payload: payload})
...
const buildTransferModal = (supplyOrderShippingGroup,targetComponent) => {
...
<Modal title={transferModalTitle}
          ...
          onOk={()=>executeTrans(supplyOrderShippingGroup,targetComponent)}
...
const internalRenderExtraHeader = (supplyOrderShippingGroup) =>{
	return null
}
const internalRenderExtraFooter = (supplyOrderShippingGroup) =>{
	return null
}
...
=======
<Description term="订单">{supplyOrderShippingGroup.bizOrder==null?appLocaleName(userContext,"NotAssigned"):supplyOrderShippingGroup.bizOrder.displayName}
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
 <Icon type="swap" onClick={()=>
  showTransferModel(targetComponent,"订单","supplyOrder","requestCandidateBizOrder",
	      "transferToAnotherBizOrder","anotherBizOrderId",supplyOrderShippingGroup.bizOrder?supplyOrderShippingGroup.bizOrder.id:"")} 
...
class SupplyOrderShippingGroupPreference extends Component {
...
}))(Form.create()(SupplyOrderShippingGroupPreference))
