...
class SupplyOrderShippingGroupSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      supplyOrderShippingGroupList: 1,
      'supplyOrderShippingGroupList.searchField': fieldName,
      'supplyOrderShippingGroupList.searchVerb': 'startsWith',
      'supplyOrderShippingGroupList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`supplyOrderShippingGroupList.searchField`] = fieldName
    value[`supplyOrderShippingGroupList.searchVerb`] =  searchVerb
    value[`supplyOrderShippingGroupList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      params['supplyOrderShippingGroupList'] = 1
      params['supplyOrderShippingGroupList.orderBy.0'] = "id"
      params['supplyOrderShippingGroupList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        supplyOrderShippingGroupSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(SupplyOrderShippingGroupSearchForm)
