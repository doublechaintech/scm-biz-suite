...
const showAssociateDialog = (targetComponent) => {
  ...
  const { GoodsShelfStockCountAssociateForm } = GlobalComponents
  ...
  <div>
	...
	visible={currentAssociateModal==='stockCount'} 
	data={{stockCountIssueTrackList:selectedRows}} owner={owner}  
	onCancel={()=>toggleAssociateModalVisible(targetComponent,'stockCount')} 
	onCreate={()=>toggleAssociateModalVisible(targetComponent,'stockCount')}/> 
...
class StockCountIssueTrackSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {StockCountIssueTrackTable} = GlobalComponents;
    const {StockCountIssueTrackSearchForm} = GlobalComponents;
    const {StockCountIssueTrackModalTable} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <StockCountIssueTrackSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,StockCountIssueTrackModalTable,"stockCountIssueTrackIds")}
...
export default Form.create()(StockCountIssueTrackSearch)
