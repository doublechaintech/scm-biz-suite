...
=======
import StockCountIssueTrackCreateFormBody from './StockCountIssueTrack.createformbody'
...
class StockCountIssueTrackCreateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, ...imagesValues }
        dispatch({
          type: `${owner.type}/addStockCountIssueTrack`,
          payload: { id: owner.id, type: 'stockCountIssueTrack', parameters, continueNext: true },
        })
      })
    }
...
<<<<<<< HEAD
      dispatch({
        ...
        payload: { id: owner.id, type: 'stockCountIssueTrack',listName:'库存计数问题跟踪列表' },
=======
     
      dispatch({
        type: `${owner.type}/goback`,
        payload: { id: owner.id, type: 'stockCountIssueTrack',listName:appLocaleName(userContext,"List") },
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      })
    }
...
}))(Form.create()(StockCountIssueTrackCreateForm))
