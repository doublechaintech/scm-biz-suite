...
import styles from './StockCountIssueTrack.search.less'
...
class StockCountIssueTrackSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      stockCountIssueTrackList: 1,
      'stockCountIssueTrackList.searchField': fieldName,
      'stockCountIssueTrackList.searchVerb': 'startsWith',
      'stockCountIssueTrackList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`stockCountIssueTrackList.searchField`] = fieldName
    value[`stockCountIssueTrackList.searchVerb`] =  searchVerb
    value[`stockCountIssueTrackList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'eq', 'stockCount'))
=======
      ...
      const {listName} = owner
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'eq', 'stockCount'))
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
...
<<<<<<< HEAD
      params['stockCountIssueTrackList'] = 1
      params['stockCountIssueTrackList.orderBy.0'] = "id"
      params['stockCountIssueTrackList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        stockCountIssueTrackSearchFormParameters: filterObjectKeys(fieldsValue),
...
=======
                    requestFunction={StockCountIssueTrackService.requestCandidateStockCount} useForSearch />
...
export default Form.create()(StockCountIssueTrackSearchForm)
