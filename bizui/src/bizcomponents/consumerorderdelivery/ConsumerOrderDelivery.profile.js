...
const internalSummaryOf = (item, targetComponents)=>{
	...
	return GlobalComponents.ConsumerOrderDeliveryBase.renderItemOfList(item, targetComponents)

}



class ConsumerOrderDeliveryProfile extends Component {
...
}))(Form.create()(ConsumerOrderDeliveryProfile))
