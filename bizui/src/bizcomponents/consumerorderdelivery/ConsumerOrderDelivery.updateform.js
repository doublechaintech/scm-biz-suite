...
import styles from './ConsumerOrderDelivery.updateform.less'
...
class ConsumerOrderDeliveryUpdateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
        ...
        const consumerOrderDeliveryId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, consumerOrderDeliveryId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateConsumerOrderDelivery`,
          payload: {
            id: owner.id,
            type: 'consumerOrderDelivery',
            parameters,
            selectedRows,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextConsumerOrderDeliveryUpdateRow`,
        payload: {
          id: owner.id,
          type: 'consumerOrderDelivery',
          selectedRows,
...
<<<<<<< HEAD
    ...
    return (
      <PageHeaderLayout
        title={"更新消费者订单交货"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新消费者订单交货"
...
}))(Form.create()(ConsumerOrderDeliveryUpdateForm))
