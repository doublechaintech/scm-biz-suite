...
class ConsumerOrderDeliverySearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {ConsumerOrderDeliveryTable} = GlobalComponents;
    const {ConsumerOrderDeliverySearchForm} = GlobalComponents;
    const {ConsumerOrderDeliveryModalTable} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <ConsumerOrderDeliverySearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,ConsumerOrderDeliveryModalTable,"consumerOrderDeliveryIds")}
...
export default Form.create()(ConsumerOrderDeliverySearch)
