...
import styles from './ConsumerOrderDelivery.search.less'
...
class ConsumerOrderDeliverySearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      consumerOrderDeliveryList: 1,
      'consumerOrderDeliveryList.searchField': fieldName,
      'consumerOrderDeliveryList.searchVerb': 'startsWith',
      'consumerOrderDeliveryList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`consumerOrderDeliveryList.searchField`] = fieldName
    value[`consumerOrderDeliveryList.searchVerb`] =  searchVerb
    value[`consumerOrderDeliveryList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      params['consumerOrderDeliveryList'] = 1
      params['consumerOrderDeliveryList.orderBy.0'] = "id"
      params['consumerOrderDeliveryList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        consumerOrderDeliverySearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(ConsumerOrderDeliverySearchForm)
