...
import styles from './WarehouseAsset.updateform.less'
...
class WarehouseAssetUpdateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
        ...
        const warehouseAssetId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, warehouseAssetId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateWarehouseAsset`,
          payload: {
            id: owner.id,
            type: 'warehouseAsset',
            parameters,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextWarehouseAssetUpdateRow`,
        payload: {
          id: owner.id,
          type: 'warehouseAsset',
          selectedRows,
...
<<<<<<< HEAD
    ...
    return (
      <PageHeaderLayout
        title={"更新仓库资产"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新仓库资产"
...
=======
	...
	const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"Update")}仓库资产: {(currentUpdateIndex+1)}/{selectedRows.length}</div>)
    }
              ...
              <Col lg={12} md={12} sm={24}>
                <Form.Item label={fieldLabels.position} {...formItemLayout}>
                  {getFieldDecorator('position', {
                    initialValue: selectedRow.position,
...
}))(Form.create()(WarehouseAssetUpdateForm))
