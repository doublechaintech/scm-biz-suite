...
import styles from './WarehouseAsset.search.less'
...
class WarehouseAssetSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      warehouseAssetList: 1,
      'warehouseAssetList.searchField': fieldName,
      'warehouseAssetList.searchVerb': 'startsWith',
      'warehouseAssetList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`warehouseAssetList.searchField`] = fieldName
    value[`warehouseAssetList.searchVerb`] =  searchVerb
    value[`warehouseAssetList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'contains', 'position'))
...
=======
      ...
      const {listName} = owner
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'contains', 'position'))
...
<<<<<<< HEAD
      params['warehouseAssetList'] = 1
      params['warehouseAssetList.orderBy.0'] = "id"
      params['warehouseAssetList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        warehouseAssetSearchFormParameters: filterObjectKeys(fieldsValue),
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
                  ...
                  <SelectObject 
                    ...
                    targetType={"owner"} 
<<<<<<< HEAD
                    requestFunction={WarehouseAssetService.requestCandidateOwner}/>
                  
=======
                    requestFunction={WarehouseAssetService.requestCandidateOwner} useForSearch />
...
export default Form.create()(WarehouseAssetSearchForm)
