...
import styles from './CityPartner.search.less'
...
class CityPartnerSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      cityPartnerList: 1,
      'cityPartnerList.searchField': fieldName,
      'cityPartnerList.searchVerb': 'startsWith',
      'cityPartnerList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`cityPartnerList.searchField`] = fieldName
    value[`cityPartnerList.searchVerb`] =  searchVerb
    value[`cityPartnerList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
      params['cityPartnerList'] = 1
      params['cityPartnerList.orderBy.0'] = "id"
      params['cityPartnerList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        cityPartnerSearchFormParameters: filterObjectKeys(fieldsValue),
...
=======
                    requestFunction={CityPartnerService.requestCandidateCityServiceCenter} useForSearch />
...
export default Form.create()(CityPartnerSearchForm)
