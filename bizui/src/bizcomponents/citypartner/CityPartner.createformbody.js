...
class CityPartnerCreateFormBody extends Component {
  state = {
  ...
  componentDidMount() {
    ...
    const formValue = CityPartnerBase.unpackObjectToFormValues(initValue)
              ...
              <Col lg={24} md={24} sm={24} >
                <Form.Item label={fieldLabels.cityServiceCenter} {...formItemLayout}>
                  ...
                  <CandidateList
		                 ...
		                 ownerId={owner.id}
		                 scenarioCode={"assign"}
		                 listType={"city_partner"}
		                 targetType={"retail_store_city_service_center"}

                    requestFunction={CityPartnerService.queryCandidates}  />
...
}))(Form.create()(CityPartnerCreateFormBody))
