...
const internalImageListOf = (cityPartner) =>{
<<<<<<< HEAD
...
const internalSettingListOf = (cityPartner) =>{
<<<<<<< HEAD
...
const handleTransferSearch =(targetComponent,filterKey,newRequest)=>{
  ...
  const pageNo = 1;
  const candidateReferenceService = CityPartnerService[candidateServiceName] 
...
const executeTrans = (cityPartner,targetComponent) =>{
...
const buildTransferModal = (cityPartner,targetComponent) => {
...
<Modal title={transferModalTitle}
          ...
          onOk={()=>executeTrans(cityPartner,targetComponent)}
...
const internalRenderExtraHeader = (cityPartner) =>{
	return null
}
const internalRenderExtraFooter = (cityPartner) =>{
	return null
}
...
=======
<Description term="城市服务中心">{cityPartner.cityServiceCenter==null?appLocaleName(userContext,"NotAssigned"):cityPartner.cityServiceCenter.displayName}
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
 <Icon type="swap" onClick={()=>
  showTransferModel(targetComponent,"城市服务中心","retailStoreCityServiceCenter","requestCandidateCityServiceCenter",
	      "transferToAnotherCityServiceCenter","anotherCityServiceCenterId",cityPartner.cityServiceCenter?cityPartner.cityServiceCenter.id:"")} 
...
class CityPartnerPreference extends Component {
...
}))(Form.create()(CityPartnerPreference))
