...
const displayColumns = [
  { title: '序号', debugtype: 'string', dataIndex: 'id', width: '20', render: (text, record)=>renderTextCell(text,record,'cityPartner') },
...
const CityPartnerBase={menuData,displayColumns,fieldLabels,displayColumns}
