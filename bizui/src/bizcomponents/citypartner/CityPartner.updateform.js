...
import styles from './CityPartner.updateform.less'
...
class CityPartnerUpdateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
        ...
        const cityPartnerId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, cityPartnerId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateCityPartner`,
          payload: {
            id: owner.id,
            type: 'cityPartner',
            parameters,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextCityPartnerUpdateRow`,
        payload: {
          id: owner.id,
          type: 'cityPartner',
          selectedRows,
...
<<<<<<< HEAD
    ...
    return (
      <PageHeaderLayout
        title={"更新城市合伙人"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新城市合伙人"
...
=======
	...
	const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"Update")}城市合伙人: {(currentUpdateIndex+1)}/{selectedRows.length}</div>)
    }
...
}))(Form.create()(CityPartnerUpdateForm))
