...
import styles from './RetailStoreInvestmentInvitation.updateform.less'
...
class RetailStoreInvestmentInvitationUpdateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
        ...
        const retailStoreInvestmentInvitationId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, retailStoreInvestmentInvitationId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateRetailStoreInvestmentInvitation`,
          payload: {
            id: owner.id,
            type: 'retailStoreInvestmentInvitation',
            parameters,
            selectedRows,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextRetailStoreInvestmentInvitationUpdateRow`,
        payload: {
          id: owner.id,
          type: 'retailStoreInvestmentInvitation',
          selectedRows,
...
<<<<<<< HEAD
    ...
    return (
      <PageHeaderLayout
        title={"更新生超招商"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新生超招商"
...
=======
	...
	const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"Update")}生超招商: {(currentUpdateIndex+1)}/{selectedRows.length}</div>)
    }
...
}))(Form.create()(RetailStoreInvestmentInvitationUpdateForm))
