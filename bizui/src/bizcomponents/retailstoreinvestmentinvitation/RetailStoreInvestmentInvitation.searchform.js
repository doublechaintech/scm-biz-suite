...
class RetailStoreInvestmentInvitationSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      retailStoreInvestmentInvitationList: 1,
      'retailStoreInvestmentInvitationList.searchField': fieldName,
      'retailStoreInvestmentInvitationList.searchVerb': 'startsWith',
      'retailStoreInvestmentInvitationList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`retailStoreInvestmentInvitationList.searchField`] = fieldName
    value[`retailStoreInvestmentInvitationList.searchVerb`] =  searchVerb
    value[`retailStoreInvestmentInvitationList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      params['retailStoreInvestmentInvitationList'] = 1
      params['retailStoreInvestmentInvitationList.orderBy.0'] = "id"
      params['retailStoreInvestmentInvitationList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        retailStoreInvestmentInvitationSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(RetailStoreInvestmentInvitationSearchForm)
