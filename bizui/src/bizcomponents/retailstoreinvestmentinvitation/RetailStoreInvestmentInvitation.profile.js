...
const internalSummaryOf = (item, targetComponents)=>{
	...
	return GlobalComponents.RetailStoreInvestmentInvitationBase.renderItemOfList(item, targetComponents)
...
class RetailStoreInvestmentInvitationProfile extends Component {
  ...
  render() {
    ...
    const  returnURL = `/retailStoreInvestmentInvitation/${id}/dashboard`
