...
const internalImageListOf = (transportTask) =>{
<<<<<<< HEAD
...
const internalSettingListOf = (transportTask) =>{
<<<<<<< HEAD
...
const handleTransferSearch =(targetComponent,filterKey,newRequest)=>{
  ...
  const pageNo = 1;
  const candidateReferenceService = TransportTaskService[candidateServiceName] 
...
const executeTrans = (transportTask,targetComponent) =>{
...
const buildTransferModal = (transportTask,targetComponent) => {
...
<Modal title={transferModalTitle}
          ...
          onOk={()=>executeTrans(transportTask,targetComponent)}
...
const internalRenderExtraHeader = (transportTask) =>{
	return null
}
const internalRenderExtraFooter = (transportTask) =>{
	return null
}
...
=======
<Description term="结束">{transportTask.end==null?appLocaleName(userContext,"NotAssigned"):transportTask.end.displayName}
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
 <Icon type="swap" onClick={()=>
  showTransferModel(targetComponent,"结束","retailStore","requestCandidateEnd",
	      "transferToAnotherEnd","anotherEndId",transportTask.end?transportTask.end.id:"")} 
  style={{fontSize: 20,color:"red"}} />
</Description>
<<<<<<< HEAD
<Description term="司机">{transportTask.driver==null?"未分配":transportTask.driver.displayName}
=======
<Description term="司机">{transportTask.driver==null?appLocaleName(userContext,"NotAssigned"):transportTask.driver.displayName}
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
 <Icon type="swap" onClick={()=>
  showTransferModel(targetComponent,"司机","truckDriver","requestCandidateDriver",
	      "transferToAnotherDriver","anotherDriverId",transportTask.driver?transportTask.driver.id:"")} 
  style={{fontSize: 20,color:"red"}} />
</Description>
<<<<<<< HEAD
<Description term="卡车">{transportTask.truck==null?"未分配":transportTask.truck.displayName}
=======
<Description term="卡车">{transportTask.truck==null?appLocaleName(userContext,"NotAssigned"):transportTask.truck.displayName}
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
 <Icon type="swap" onClick={()=>
  showTransferModel(targetComponent,"卡车","transportTruck","requestCandidateTruck",
	      "transferToAnotherTruck","anotherTruckId",transportTask.truck?transportTask.truck.id:"")} 
  style={{fontSize: 20,color:"red"}} />
</Description>
<<<<<<< HEAD
<Description term="属于">{transportTask.belongsTo==null?"未分配":transportTask.belongsTo.displayName}
=======
<Description term="属于">{transportTask.belongsTo==null?appLocaleName(userContext,"NotAssigned"):transportTask.belongsTo.displayName}
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
 <Icon type="swap" onClick={()=>
  showTransferModel(targetComponent,"属于","transportFleet","requestCandidateBelongsTo",
	      "transferToAnotherBelongsTo","anotherBelongsToId",transportTask.belongsTo?transportTask.belongsTo.id:"")} 
  style={{fontSize: 20,color:"red"}} />
</Description>
...
class TransportTaskPreference extends Component {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
  ...
  render() {
    ...
    const { id,displayName, goodsCount, transportTaskTrackCount } = this.props.transportTask
...
}))(Form.create()(TransportTaskPreference))
