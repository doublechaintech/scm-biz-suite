...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{consumerOrderPaymentGroupList:selectedRows}} owner={owner}  
...
class ConsumerOrderPaymentGroupSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {ConsumerOrderPaymentGroupTable} = GlobalComponents;
    const {ConsumerOrderPaymentGroupSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={`${displayName}:${this.props.name}${appLocaleName(userContext,"List")}`}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <ConsumerOrderPaymentGroupSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,ConsumerOrderPaymentGroupModalTable,"consumerOrderPaymentGroupIds")}
...
export default Form.create()(ConsumerOrderPaymentGroupSearch)
