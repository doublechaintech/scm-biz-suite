...
constructor(props) {
 ...
 getNavMenuItems = (targetObject, style, customTheme) => {
	  ...
	  <Menu
       ...
       >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/consumerOrderPaymentGroup/${this.props.consumerOrderPaymentGroup.id}/dashboard`}><Icon type="dashboard" style={{marginRight:"20px"}}/><span>{appLocaleName(userContext,"Dashboard")}</span></Link>
             </Menu.Item>
  ...
  buildRouters = () =>{
  	...
  	const routers=[
  	{path:"/consumerOrderPaymentGroup/:id/dashboard", component: ConsumerOrderPaymentGroupDashboard},
