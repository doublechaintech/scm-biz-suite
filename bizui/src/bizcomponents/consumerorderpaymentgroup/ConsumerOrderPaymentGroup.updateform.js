...
import styles from './ConsumerOrderPaymentGroup.updateform.less'
...
class ConsumerOrderPaymentGroupUpdateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
        ...
        const consumerOrderPaymentGroupId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, consumerOrderPaymentGroupId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateConsumerOrderPaymentGroup`,
          payload: {
            id: owner.id,
            type: 'consumerOrderPaymentGroup',
            parameters,
            selectedRows,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextConsumerOrderPaymentGroupUpdateRow`,
        payload: {
          id: owner.id,
          type: 'consumerOrderPaymentGroup',
          selectedRows,
...
<<<<<<< HEAD
    ...
    return (
      <PageHeaderLayout
        title={"更新消费者订单付款组"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新消费者订单付款组"
...
=======
	...
	const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"Update")}消费者订单付款组: {(currentUpdateIndex+1)}/{selectedRows.length}</div>)
    }
...
}))(Form.create()(ConsumerOrderPaymentGroupUpdateForm))
