...
import styles from './ConsumerOrderPaymentGroup.preference.less'
...
const internalImageListOf = (consumerOrderPaymentGroup) =>{
<<<<<<< HEAD
...
const internalSettingListOf = (consumerOrderPaymentGroup) =>{
<<<<<<< HEAD
...
const handleTransferSearch =(targetComponent,filterKey,newRequest)=>{
  ...
  const pageNo = 1;
  const candidateReferenceService = ConsumerOrderPaymentGroupService[candidateServiceName] 
...
const executeTrans = (consumerOrderPaymentGroup,targetComponent) =>{
  ...
  validateFieldsAndScroll((error, values) => {
    ...
    const id=consumerOrderPaymentGroup.id;
    const serviceNameToCall = transferServiceName;

    const payload = {parameters,id,serviceNameToCall}
    
    //targetComponent.setState({transferModalVisiable:false})
    dispatch({type:"_consumerOrderPaymentGroup/doJob",payload: payload})
...
const buildTransferModal = (consumerOrderPaymentGroup,targetComponent) => {
...
<Modal title={transferModalTitle}
          ...
          onOk={()=>executeTrans(consumerOrderPaymentGroup,targetComponent)}
...
const internalRenderExtraHeader = (consumerOrderPaymentGroup) =>{
	return null
}
const internalRenderExtraFooter = (consumerOrderPaymentGroup) =>{
	return null
}
...
<<<<<<< HEAD
<Description term="订单">{consumerOrderPaymentGroup.bizOrder==null?"未分配":consumerOrderPaymentGroup.bizOrder.displayName}
=======
<Description term="订单">{consumerOrderPaymentGroup.bizOrder==null?appLocaleName(userContext,"NotAssigned"):consumerOrderPaymentGroup.bizOrder.displayName}
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
 <Icon type="swap" onClick={()=>
  showTransferModel(targetComponent,"订单","consumerOrder","requestCandidateBizOrder",
	      "transferToAnotherBizOrder","anotherBizOrderId",consumerOrderPaymentGroup.bizOrder?consumerOrderPaymentGroup.bizOrder.id:"")} 
...
class ConsumerOrderPaymentGroupPreference extends Component {
...
}))(Form.create()(ConsumerOrderPaymentGroupPreference))
