...
const internalSummaryOf = (item, targetComponents)=>{
	...
	return GlobalComponents.ConsumerOrderPaymentGroupBase.renderItemOfList(item, targetComponents)

}



class ConsumerOrderPaymentGroupProfile extends Component {
...
}))(Form.create()(ConsumerOrderPaymentGroupProfile))
