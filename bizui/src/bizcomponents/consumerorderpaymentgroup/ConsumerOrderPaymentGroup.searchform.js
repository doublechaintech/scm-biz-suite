...
import styles from './ConsumerOrderPaymentGroup.search.less'
...
class ConsumerOrderPaymentGroupSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      consumerOrderPaymentGroupList: 1,
      'consumerOrderPaymentGroupList.searchField': fieldName,
      'consumerOrderPaymentGroupList.searchVerb': 'startsWith',
      'consumerOrderPaymentGroupList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`consumerOrderPaymentGroupList.searchField`] = fieldName
    value[`consumerOrderPaymentGroupList.searchVerb`] =  searchVerb
    value[`consumerOrderPaymentGroupList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
      params['consumerOrderPaymentGroupList'] = 1
      params['consumerOrderPaymentGroupList.orderBy.0'] = "id"
      params['consumerOrderPaymentGroupList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        consumerOrderPaymentGroupSearchFormParameters: filterObjectKeys(fieldsValue),
...
=======
                    requestFunction={ConsumerOrderPaymentGroupService.requestCandidateBizOrder} useForSearch />
...
export default Form.create()(ConsumerOrderPaymentGroupSearchForm)
