...
const renderItemOfList=(consumerOrderPaymentGroup, targetComponent, columCount, listName)=>{
  ...
  const userContext = null
  return (
    <Card key={`${listName}-${consumerOrderPaymentGroup.id}`} style={{marginTop:"10px"}}>
