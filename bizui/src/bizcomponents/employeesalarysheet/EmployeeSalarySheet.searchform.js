...
class EmployeeSalarySheetSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      employeeSalarySheetList: 1,
      'employeeSalarySheetList.searchField': fieldName,
      'employeeSalarySheetList.searchVerb': 'startsWith',
      'employeeSalarySheetList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`employeeSalarySheetList.searchField`] = fieldName
    value[`employeeSalarySheetList.searchVerb`] =  searchVerb
    value[`employeeSalarySheetList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      params['employeeSalarySheetList'] = 1
      params['employeeSalarySheetList.orderBy.0'] = "id"
      params['employeeSalarySheetList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        employeeSalarySheetSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(EmployeeSalarySheetSearchForm)
