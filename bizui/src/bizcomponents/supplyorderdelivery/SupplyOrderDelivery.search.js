...
class SupplyOrderDeliverySearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {SupplyOrderDeliveryTable} = GlobalComponents;
    const {SupplyOrderDeliverySearchForm} = GlobalComponents;
    const {SupplyOrderDeliveryModalTable} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <SupplyOrderDeliverySearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,SupplyOrderDeliveryModalTable,"supplyOrderDeliveryIds")}
...
export default Form.create()(SupplyOrderDeliverySearch)
