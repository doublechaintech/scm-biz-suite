...
=======
      const location = { pathname: `/supplyOrderDelivery/${id}/list/ConsumerOrderList/消费者订单+${appLocaleName(userContext,'List')}`, state: newState }
      yield put(routerRedux.push(location))
    },
    *updateConsumerOrder({ payload }, { call, put }) {
      const userContext = null
...
=======
      const location = { pathname: `/supplyOrderDelivery/${id}/list/SupplyOrderList/供应订单+${appLocaleName(userContext,'List')}`, state: newState }
      yield put(routerRedux.push(location))
    },
    *updateSupplyOrder({ payload }, { call, put }) {
      const userContext = null
