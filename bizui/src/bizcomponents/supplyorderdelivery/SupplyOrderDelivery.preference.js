...
const internalImageListOf = (supplyOrderDelivery) =>{
...
const internalSettingListOf = (supplyOrderDelivery) =>{
	const userContext = null
	const optionList = [ 
	]
...
const handleTransferSearch =(targetComponent,filterKey,newRequest)=>{
  ...
  const pageNo = 1;
  const candidateReferenceService = SupplyOrderDeliveryService[candidateServiceName] 
...
const executeTrans = (supplyOrderDelivery,targetComponent) =>{
...
const buildTransferModal = (supplyOrderDelivery,targetComponent) => {
...
<Modal title={transferModalTitle}
          ...
          onOk={()=>executeTrans(supplyOrderDelivery,targetComponent)}
...
const internalRenderExtraHeader = (supplyOrderDelivery) =>{
	return null
}
const internalRenderExtraFooter = (supplyOrderDelivery) =>{
	return null
}
...
class SupplyOrderDeliveryPreference extends Component {
...
}))(Form.create()(SupplyOrderDeliveryPreference))
