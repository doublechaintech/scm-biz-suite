...
const internalSummaryOf = (item, targetComponents)=>{
	...
	return GlobalComponents.SupplyOrderDeliveryBase.renderItemOfList(item, targetComponents)
...
class SupplyOrderDeliveryProfile extends Component {
  ...
  render() {
    ...
    const cardsData = {cardsName:"Supply Order Delivery",cardsFor: "supplyOrderDelivery",cardsSource: supplyOrderDelivery,
  		subItems: [
