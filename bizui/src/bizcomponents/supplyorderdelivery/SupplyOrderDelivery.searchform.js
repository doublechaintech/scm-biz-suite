...
import styles from './SupplyOrderDelivery.search.less'
...
class SupplyOrderDeliverySearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      supplyOrderDeliveryList: 1,
      'supplyOrderDeliveryList.searchField': fieldName,
      'supplyOrderDeliveryList.searchVerb': 'startsWith',
      'supplyOrderDeliveryList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`supplyOrderDeliveryList.searchField`] = fieldName
    value[`supplyOrderDeliveryList.searchVerb`] =  searchVerb
    value[`supplyOrderDeliveryList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      params['supplyOrderDeliveryList'] = 1
      params['supplyOrderDeliveryList.orderBy.0'] = "id"
      params['supplyOrderDeliveryList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        supplyOrderDeliverySearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(SupplyOrderDeliverySearchForm)
