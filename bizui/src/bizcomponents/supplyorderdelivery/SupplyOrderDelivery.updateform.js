...
import styles from './SupplyOrderDelivery.updateform.less'
...
class SupplyOrderDeliveryUpdateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
        ...
        const supplyOrderDeliveryId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, supplyOrderDeliveryId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateSupplyOrderDelivery`,
          payload: {
            id: owner.id,
            type: 'supplyOrderDelivery',
            parameters,
            selectedRows,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextSupplyOrderDeliveryUpdateRow`,
        payload: {
          id: owner.id,
          type: 'supplyOrderDelivery',
          selectedRows,
...
<<<<<<< HEAD
    ...
    return (
      <PageHeaderLayout
        title={"更新供应订单交货"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新供应订单交货"
...
=======
	...
	const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"Update")}供应订单交货: {(currentUpdateIndex+1)}/{selectedRows.length}</div>)
    }
...
}))(Form.create()(SupplyOrderDeliveryUpdateForm))
