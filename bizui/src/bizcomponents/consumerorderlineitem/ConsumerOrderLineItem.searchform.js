...
import styles from './ConsumerOrderLineItem.search.less'
...
class ConsumerOrderLineItemSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      consumerOrderLineItemList: 1,
      'consumerOrderLineItemList.searchField': fieldName,
      'consumerOrderLineItemList.searchVerb': 'startsWith',
      'consumerOrderLineItemList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`consumerOrderLineItemList.searchField`] = fieldName
    value[`consumerOrderLineItemList.searchVerb`] =  searchVerb
    value[`consumerOrderLineItemList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
      params['consumerOrderLineItemList'] = 1
      params['consumerOrderLineItemList.orderBy.0'] = "id"
      params['consumerOrderLineItemList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        consumerOrderLineItemSearchFormParameters: filterObjectKeys(fieldsValue),
...
=======
                 requestFunction={ConsumerOrderLineItemService.requestCandidateBizOrder} useForSearch />
...
export default Form.create()(ConsumerOrderLineItemSearchForm)
