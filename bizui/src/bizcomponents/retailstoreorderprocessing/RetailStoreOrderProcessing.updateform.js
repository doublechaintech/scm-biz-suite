...
import styles from './RetailStoreOrderProcessing.updateform.less'
...
class RetailStoreOrderProcessingUpdateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
        ...
        const retailStoreOrderProcessingId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, retailStoreOrderProcessingId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateRetailStoreOrderProcessing`,
          payload: {
            id: owner.id,
            type: 'retailStoreOrderProcessing',
            parameters,
            selectedRows,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextRetailStoreOrderProcessingUpdateRow`,
        payload: {
          id: owner.id,
          type: 'retailStoreOrderProcessing',
          selectedRows,
...
<<<<<<< HEAD
    ...
    return (
      <PageHeaderLayout
        title={"更新生超订单处理"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新生超订单处理"
...
=======
	...
	const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"Update")}生超订单处理: {(currentUpdateIndex+1)}/{selectedRows.length}</div>)
    }
...
}))(Form.create()(RetailStoreOrderProcessingUpdateForm))
