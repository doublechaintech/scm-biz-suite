...
import styles from './RetailStoreOrderProcessing.search.less'
...
class RetailStoreOrderProcessingSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      retailStoreOrderProcessingList: 1,
      'retailStoreOrderProcessingList.searchField': fieldName,
      'retailStoreOrderProcessingList.searchVerb': 'startsWith',
      'retailStoreOrderProcessingList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`retailStoreOrderProcessingList.searchField`] = fieldName
    value[`retailStoreOrderProcessingList.searchVerb`] =  searchVerb
    value[`retailStoreOrderProcessingList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      params['retailStoreOrderProcessingList'] = 1
      params['retailStoreOrderProcessingList.orderBy.0'] = "id"
      params['retailStoreOrderProcessingList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        retailStoreOrderProcessingSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(RetailStoreOrderProcessingSearchForm)
