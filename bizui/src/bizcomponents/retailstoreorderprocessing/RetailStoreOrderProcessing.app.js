...
constructor(props) {
  ...
  handleOpenChange = (openKeys) => {
   ...
   render() {
    ...
    const {searchLocalData}=GlobalComponents.RetailStoreOrderProcessingBase
 ...
 <Header style={{ position: 'fixed', zIndex: 1, width: '100%' }}>
      ...
      {this.state.showSearch&&(
        ...
        <div style={{backgroundColor:'black'}}  onClick={()=>hideSearchResult()}  >{searchLocalData(this.props.retailStoreOrderProcessing,this.state.searchKeyword)}</div>
