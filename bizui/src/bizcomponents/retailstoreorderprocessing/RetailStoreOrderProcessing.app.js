...
<<<<<<< HEAD
    ...
    return (
		  ...
		  <Menu
           ...
           >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/retailStoreOrderProcessing/${this.props.retailStoreOrderProcessing.id}/dashboard`}><Icon type="dashboard" /><span>仪表板</span></Link>
             </Menu.Item>
       ...
       <Menu.Item key="preference">
               <Link to={`/retailStoreOrderProcessing/${this.props.retailStoreOrderProcessing.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
    ...
    return (
	  <Menu
       ...
       >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/retailStoreOrderProcessing/${this.props.retailStoreOrderProcessing.id}/dashboard`}><Icon type="dashboard" style={{marginRight:"20px"}}/><span>{appLocaleName(userContext,"Dashboard")}</span></Link>
             </Menu.Item>
...
<<<<<<< HEAD
      ...
      searchFormParameters: state._retailStoreOrderProcessing.retailStoreOrderSearchFormParameters,
      loading: state._retailStoreOrderProcessing.loading,
      owner: { type: '_retailStoreOrderProcessing', id: state._retailStoreOrderProcessing.id, referenceName: 'processing', listName: 'retailStoreOrderList', ref:state._retailStoreOrderProcessing, listDisplayName: '生超的订单列表'}, // this is for model namespace and
=======
      returnURL: `/retailStoreOrderProcessing/${state._retailStoreOrderProcessing.id}/list`,
      currentPage: state._retailStoreOrderProcessing.retailStoreOrderCurrentPageNumber,
      searchFormParameters: state._retailStoreOrderProcessing.retailStoreOrderSearchFormParameters,
      loading: state._retailStoreOrderProcessing.loading,
...
<<<<<<< HEAD
      owner: { type: '_retailStoreOrderProcessing', id: state._retailStoreOrderProcessing.id, listName: 'retailStoreOrderList', ref:state._retailStoreOrderProcessing, listDisplayName: '生超的订单列表' }, // this is for model namespace and
=======
...
<<<<<<< HEAD
  	const {RetailStoreOrderProcessingPreference} = GlobalComponents
=======
...
<<<<<<< HEAD
  	{path:"/retailStoreOrderProcessing/:id/preference", component: RetailStoreOrderProcessingPreference},
=======
...
<<<<<<< HEAD
     ...
     //const {RetailStoreOrderProcessingEditDetail} = GlobalComponents
     //const {RetailStoreOrderProcessingViewDetail} = GlobalComponents
...
=======
 ...
 <Header>
        ...
        <Col {...naviBarResponsiveStyle} >
            <Dropdown overlay= {this.getNavMenuItems(this.props.retailStoreOrderProcessing)}>
