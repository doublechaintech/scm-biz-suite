...
class RetailStoreOrderProcessingSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {RetailStoreOrderProcessingTable} = GlobalComponents;
    const {RetailStoreOrderProcessingSearchForm} = GlobalComponents;
    const {RetailStoreOrderProcessingModalTable} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={`${displayName}:${this.props.name}${appLocaleName(userContext,"List")}`}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <RetailStoreOrderProcessingSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,RetailStoreOrderProcessingModalTable,"retailStoreOrderProcessingIds")}
...
export default Form.create()(RetailStoreOrderProcessingSearch)
