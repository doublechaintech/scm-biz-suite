...
import styles from './WechatWorkappIdentify.search.less'
...
class WechatWorkappIdentifySearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      wechatWorkappIdentifyList: 1,
      'wechatWorkappIdentifyList.searchField': fieldName,
      'wechatWorkappIdentifyList.searchVerb': 'startsWith',
      'wechatWorkappIdentifyList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        wechatWorkappIdentifySearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                  ...
                  <CandidateList 
		                 ...
		                 ownerId={owner.id}
		                 scenarioCode={"search"}
		                 listType={"wechat_workapp_identify"} 
		                 targetType={"sec_user"} 
                 
                    requestFunction={WechatWorkappIdentifyService.queryCandidates} useForSearch />
...
export default Form.create()(WechatWorkappIdentifySearchForm)
