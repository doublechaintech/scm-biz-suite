...
const displayColumns = [
  { title: fieldLabels.id, debugtype: 'string', dataIndex: 'id', width: '6', render: (text, record)=>renderTextCell(text,record,'wechatWorkappIdentify') , sorter: true },
...
const renderItemOfList=(wechatWorkappIdentify, targetComponent, columCount, listName)=>{
  ...
  const userContext = null
  return (
    <Card key={`${listName}-${wechatWorkappIdentify.id}`} style={{marginTop:"10px"}}>
