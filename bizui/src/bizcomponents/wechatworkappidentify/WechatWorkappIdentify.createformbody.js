...
const testValues = {
  ...
  userId: 'user123',
  lastLoginTime: '2020-05-02 06:19:07',
  secUserId: 'SU000001',
}
*/
...
class WechatWorkappIdentifyCreateFormBody extends Component {
  state = {
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.secUser} {...formItemLayout}>
                  ...
                  <CandidateList 
                    ...
                    requestFunction={WechatWorkappIdentifyService.queryCandidates}  />
...
}))(Form.create()(WechatWorkappIdentifyCreateFormBody))
