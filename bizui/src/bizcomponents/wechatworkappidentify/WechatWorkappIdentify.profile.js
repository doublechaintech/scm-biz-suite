...
const internalSummaryOf = (item, targetComponents)=>{
	...
	return GlobalComponents.WechatWorkappIdentifyBase.renderItemOfList(item, targetComponents)

}



class WechatWorkappIdentifyProfile extends Component {
...
}))(Form.create()(WechatWorkappIdentifyProfile))
