...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{wechatWorkappIdentifyList:selectedRows}} owner={owner}  
...
class WechatWorkappIdentifySearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {WechatWorkappIdentifyTable} = GlobalComponents;
    const {WechatWorkappIdentifySearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <WechatWorkappIdentifySearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,WechatWorkappIdentifyModalTable,"wechatWorkappIdentifyIds")}
...
export default Form.create()(WechatWorkappIdentifySearch)
