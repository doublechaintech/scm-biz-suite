...
class RetailStoreProvinceCenterCreateFormBody extends Component {
  state = {
  ...
  componentDidMount() {
    ...
    const formValue = RetailStoreProvinceCenterBase.unpackObjectToFormValues(initValue)
              ...
              <Col lg={24} md={24} sm={24} style={{"display":"none"}}>
                <Form.Item label={fieldLabels.country} {...formItemLayout}>
                  ...
                  <CandidateList
                    ...
                    requestFunction={RetailStoreProvinceCenterService.queryCandidates}  />
...
}))(Form.create()(RetailStoreProvinceCenterCreateFormBody))
