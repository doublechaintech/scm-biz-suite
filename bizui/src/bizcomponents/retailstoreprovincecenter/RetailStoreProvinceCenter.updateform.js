...
import styles from './RetailStoreProvinceCenter.updateform.less'
...
class RetailStoreProvinceCenterUpdateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
        ...
        const retailStoreProvinceCenterId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, retailStoreProvinceCenterId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateRetailStoreProvinceCenter`,
          payload: {
            id: owner.id,
            type: 'retailStoreProvinceCenter',
            parameters,
            selectedRows,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextRetailStoreProvinceCenterUpdateRow`,
        payload: {
          id: owner.id,
          type: 'retailStoreProvinceCenter',
          selectedRows,
...
<<<<<<< HEAD
    ...
    return (
      <PageHeaderLayout
        title={"更新双链小超省中心"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新双链小超省中心"
...
=======
	...
	const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"Update")}双链小超省中心: {(currentUpdateIndex+1)}/{selectedRows.length}</div>)
    }
...
}))(Form.create()(RetailStoreProvinceCenterUpdateForm))
