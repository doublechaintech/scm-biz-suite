...
import styles from './RetailStoreProvinceCenter.search.less'
...
class RetailStoreProvinceCenterSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      retailStoreProvinceCenterList: 1,
      'retailStoreProvinceCenterList.searchField': fieldName,
      'retailStoreProvinceCenterList.searchVerb': 'startsWith',
      'retailStoreProvinceCenterList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`retailStoreProvinceCenterList.searchField`] = fieldName
    value[`retailStoreProvinceCenterList.searchVerb`] =  searchVerb
    value[`retailStoreProvinceCenterList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'eq', 'country'))
=======
      ...
      const {listName} = owner
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'eq', 'country'))
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
...
<<<<<<< HEAD
      params['retailStoreProvinceCenterList'] = 1
      params['retailStoreProvinceCenterList.orderBy.0'] = "id"
      params['retailStoreProvinceCenterList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        retailStoreProvinceCenterSearchFormParameters: filterObjectKeys(fieldsValue),
...
<<<<<<< HEAD
                  ...
                    initialValue: tryinit('country'),
                   
                  })(
=======
                  {getFieldDecorator('country', {initialValue: tryinit('country')})(
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
                  
                  <SelectObject 
                    disabled={!availableForEdit('country')}
                    targetType={"country"} 
<<<<<<< HEAD
                    requestFunction={RetailStoreProvinceCenterService.requestCandidateCountry}/>
                  
=======
                    requestFunction={RetailStoreProvinceCenterService.requestCandidateCountry} useForSearch />
...
export default Form.create()(RetailStoreProvinceCenterSearchForm)
