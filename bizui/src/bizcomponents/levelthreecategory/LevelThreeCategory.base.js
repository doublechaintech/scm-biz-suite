...
const renderItemOfList=(levelThreeCategory, targetComponent, columCount)=>{
  ...
  const userContext = null
  return (
    <Card key={`levelThreeCategory-${levelThreeCategory.id}`} style={{marginTop:"10px"}}>
	...
	<Col span={20}>
      ...
      <DescriptionList  key={levelThreeCategory.id} size="small" col={displayColumnsCount} >
        ...
        <Description term={fieldLabels.parentCategory}>{renderReferenceItem(levelThreeCategory.parentCategory)}</Description>
