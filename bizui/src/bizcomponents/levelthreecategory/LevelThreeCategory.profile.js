...
const internalSummaryOf = (item, targetComponents)=>{
	...
	return GlobalComponents.LevelThreeCategoryBase.renderItemOfList(item, targetComponents)
...
class LevelThreeCategoryProfile extends Component {
  ...
  render() {
    ...
    const cardsData = {cardsName:"Level Three Category",cardsFor: "levelThreeCategory",cardsSource: levelThreeCategory,
  		subItems: [
