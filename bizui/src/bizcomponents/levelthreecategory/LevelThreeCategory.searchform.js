...
class LevelThreeCategorySearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      levelThreeCategoryList: 1,
      'levelThreeCategoryList.searchField': fieldName,
      'levelThreeCategoryList.searchVerb': 'startsWith',
      'levelThreeCategoryList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`levelThreeCategoryList.searchField`] = fieldName
    value[`levelThreeCategoryList.searchVerb`] =  searchVerb
    value[`levelThreeCategoryList.searchValue`] = fieldValue
=======
...
=======
      ...
      const {listName} = owner
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'eq', 'parentCategory'))
...
<<<<<<< HEAD
      params['levelThreeCategoryList'] = 1
      params['levelThreeCategoryList.orderBy.0'] = "id"
      params['levelThreeCategoryList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        levelThreeCategorySearchFormParameters: filterObjectKeys(fieldsValue),
...
<<<<<<< HEAD
                 requestFunction={LevelThreeCategoryService.requestCandidateParentCategory}/>
               
              
=======
                 requestFunction={LevelThreeCategoryService.requestCandidateParentCategory} useForSearch />
...
export default Form.create()(LevelThreeCategorySearchForm)
