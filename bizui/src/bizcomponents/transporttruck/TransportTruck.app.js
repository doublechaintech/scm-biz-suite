...
import styles from './TransportTruck.app.less'
...
<<<<<<< HEAD
    ...
    return (
		  ...
		  <Menu
           ...
           >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/transportTruck/${this.props.transportTruck.id}/dashboard`}><Icon type="dashboard" /><span>仪表板</span></Link>
             </Menu.Item>
       ...
       <Menu.Item key="preference">
               <Link to={`/transportTruck/${this.props.transportTruck.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
...
<<<<<<< HEAD
      ...
      searchFormParameters: state._transportTruck.transportTaskSearchFormParameters,
      loading: state._transportTruck.loading,
      owner: { type: '_transportTruck', id: state._transportTruck.id, referenceName: 'truck', listName: 'transportTaskList', ref:state._transportTruck, listDisplayName: '运输任务列表'}, // this is for model namespace and
=======
      returnURL: `/transportTruck/${state._transportTruck.id}/list`,
      currentPage: state._transportTruck.transportTaskCurrentPageNumber,
      searchFormParameters: state._transportTruck.transportTaskSearchFormParameters,
      loading: state._transportTruck.loading,
...
<<<<<<< HEAD
      owner: { type: '_transportTruck', id: state._transportTruck.id, listName: 'transportTaskList', ref:state._transportTruck, listDisplayName: '运输任务列表' }, // this is for model namespace and
=======
...
<<<<<<< HEAD
  	const {TransportTruckPreference} = GlobalComponents
=======
...
<<<<<<< HEAD
  	{path:"/transportTruck/:id/preference", component: TransportTruckPreference},
=======
...
<<<<<<< HEAD
     ...
     //const {TransportTruckEditDetail} = GlobalComponents
     //const {TransportTruckViewDetail} = GlobalComponents
     ...
     <Layout>
       ...
       <Layout>
		 ...
		 {this.getNavMenuItems(this.props.transportTruck)}
...
=======
 ...
 <Header>
        ...
        <Col {...naviBarResponsiveStyle} >
            <Dropdown overlay= {this.getNavMenuItems(this.props.transportTruck)}>
