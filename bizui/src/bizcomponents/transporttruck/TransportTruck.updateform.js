...
class TransportTruckUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, transportTruckId, }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateTransportTruck`,
          payload: {
            id: owner.id,
            type: 'transportTruck',
            parameters,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextTransportTruckUpdateRow`,
        payload: {
          id: owner.id,
          type: 'transportTruck',
          selectedRows,
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.plateNumber} {...formItemLayout}>
                  {getFieldDecorator('plateNumber', {
                    ...
                    <SmallTextInput size="large"  placeholder={fieldLabels.plateNumber} />
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.contactNumber} {...formItemLayout}>
                  {getFieldDecorator('contactNumber', {
                    ...
                    <SmallTextInput size="large"  placeholder={fieldLabels.contactNumber} />
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.vehicleLicenseNumber} {...formItemLayout}>
                  {getFieldDecorator('vehicleLicenseNumber', {
                    ...
                    <SmallTextInput size="large"  placeholder={fieldLabels.vehicleLicenseNumber} />
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.engineNumber} {...formItemLayout}>
                  {getFieldDecorator('engineNumber', {
                    ...
                    <SmallTextInput size="large"  placeholder={fieldLabels.engineNumber} />
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.mileage} {...formItemLayout}>
                  {getFieldDecorator('mileage', {
                    ...
                    <SmallTextInput size="large"  placeholder={fieldLabels.mileage} />
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.bodyColor} {...formItemLayout}>
                  {getFieldDecorator('bodyColor', {
                    ...
                    <SmallTextInput size="large"  placeholder={fieldLabels.bodyColor} />
...
}))(Form.create()(TransportTruckUpdateForm))
