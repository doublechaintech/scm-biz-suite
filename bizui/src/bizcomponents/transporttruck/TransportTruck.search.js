...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{transportTruckList:selectedRows}} owner={owner}  
...
class TransportTruckSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {TransportTruckTable} = GlobalComponents;
    const {TransportTruckSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <TransportTruckSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,TransportTruckModalTable,"transportTruckIds")}
...
export default Form.create()(TransportTruckSearch)
