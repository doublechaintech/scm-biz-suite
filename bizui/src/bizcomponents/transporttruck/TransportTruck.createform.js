...
import TransportTruckCreateFormBody from './TransportTruck.createformbody'
...
class TransportTruckCreateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, ...imagesValues }
        dispatch({
          type: `${owner.type}/addTransportTruck`,
          payload: { id: owner.id, type: 'transportTruck', parameters, continueNext: true },
        })
      })
    }
...
}))(Form.create()(TransportTruckCreateForm))
