...
class ConsumerOrderProcessingSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {ConsumerOrderProcessingTable} = GlobalComponents;
    const {ConsumerOrderProcessingSearchForm} = GlobalComponents;
    const {ConsumerOrderProcessingModalTable} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <ConsumerOrderProcessingSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,ConsumerOrderProcessingModalTable,"consumerOrderProcessingIds")}
...
export default Form.create()(ConsumerOrderProcessingSearch)
