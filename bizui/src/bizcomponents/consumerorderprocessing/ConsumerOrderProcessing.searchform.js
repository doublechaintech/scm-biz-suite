...
import styles from './ConsumerOrderProcessing.search.less'
...
class ConsumerOrderProcessingSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      consumerOrderProcessingList: 1,
      'consumerOrderProcessingList.searchField': fieldName,
      'consumerOrderProcessingList.searchVerb': 'startsWith',
      'consumerOrderProcessingList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`consumerOrderProcessingList.searchField`] = fieldName
    value[`consumerOrderProcessingList.searchVerb`] =  searchVerb
    value[`consumerOrderProcessingList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
      params['consumerOrderProcessingList'] = 1
      params['consumerOrderProcessingList.orderBy.0'] = "id"
      params['consumerOrderProcessingList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        consumerOrderProcessingSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(ConsumerOrderProcessingSearchForm)
