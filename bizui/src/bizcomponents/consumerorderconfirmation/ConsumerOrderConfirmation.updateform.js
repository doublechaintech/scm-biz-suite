...
import styles from './ConsumerOrderConfirmation.updateform.less'
...
class ConsumerOrderConfirmationUpdateForm extends Component {
  state = {
  ...
  getSelectedRow() {
    ...
    const convertiedValues = selectedRows.map((item) => {
      return {
        ...item,
        confirmTime: moment(item.confirmTime),
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
        ...
        const consumerOrderConfirmationId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, consumerOrderConfirmationId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateConsumerOrderConfirmation`,
          payload: {
            id: owner.id,
            type: 'consumerOrderConfirmation',
            parameters,
            selectedRows,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextConsumerOrderConfirmationUpdateRow`,
        payload: {
          id: owner.id,
          type: 'consumerOrderConfirmation',
          selectedRows,
...
<<<<<<< HEAD
    ...
    return (
      <PageHeaderLayout
        title={"更新客户订单确认"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新客户订单确认"
...
=======
	...
	const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"Update")}客户订单确认: {(currentUpdateIndex+1)}/{selectedRows.length}</div>)
    }
...
}))(Form.create()(ConsumerOrderConfirmationUpdateForm))
