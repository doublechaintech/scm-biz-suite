...
const menuData = {menuName:"Consumer Order Confirmation", menuFor: "consumerOrderConfirmation",
  		subItems: [
...
const ConsumerOrderConfirmationBase={menuData,displayColumns,fieldLabels,renderItemOfList}
