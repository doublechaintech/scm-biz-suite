...
import styles from './ConsumerOrderConfirmation.preference.less'
...
const internalImageListOf = (consumerOrderConfirmation) =>{
<<<<<<< HEAD
...
const internalSettingListOf = (consumerOrderConfirmation) =>{
<<<<<<< HEAD
...
const handleTransferSearch =(targetComponent,filterKey,newRequest)=>{
  ...
  const pageNo = 1;
  const candidateReferenceService = ConsumerOrderConfirmationService[candidateServiceName] 
...
const executeTrans = (consumerOrderConfirmation,targetComponent) =>{
  ...
  validateFieldsAndScroll((error, values) => {
    ...
    const id=consumerOrderConfirmation.id;
    const serviceNameToCall = transferServiceName;

    const payload = {parameters,id,serviceNameToCall}
    
    //targetComponent.setState({transferModalVisiable:false})
    dispatch({type:"_consumerOrderConfirmation/doJob",payload: payload})
...
const buildTransferModal = (consumerOrderConfirmation,targetComponent) => {
...
<Modal title={transferModalTitle}
          ...
          onOk={()=>executeTrans(consumerOrderConfirmation,targetComponent)}
...
const internalRenderExtraHeader = (consumerOrderConfirmation) =>{
	return null
}
const internalRenderExtraFooter = (consumerOrderConfirmation) =>{
	return null
}
...
class ConsumerOrderConfirmationPreference extends Component {
...
}))(Form.create()(ConsumerOrderConfirmationPreference))
