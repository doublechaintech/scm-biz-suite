...
const internalSummaryOf = (item, targetComponents)=>{
	...
	return GlobalComponents.ConsumerOrderConfirmationBase.renderItemOfList(item, targetComponents)

}



class ConsumerOrderConfirmationProfile extends Component {
...
}))(Form.create()(ConsumerOrderConfirmationProfile))
