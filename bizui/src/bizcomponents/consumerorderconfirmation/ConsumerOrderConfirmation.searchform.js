...
import styles from './ConsumerOrderConfirmation.search.less'
...
class ConsumerOrderConfirmationSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      consumerOrderConfirmationList: 1,
      'consumerOrderConfirmationList.searchField': fieldName,
      'consumerOrderConfirmationList.searchVerb': 'startsWith',
      'consumerOrderConfirmationList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`consumerOrderConfirmationList.searchField`] = fieldName
    value[`consumerOrderConfirmationList.searchVerb`] =  searchVerb
    value[`consumerOrderConfirmationList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      params['consumerOrderConfirmationList'] = 1
      params['consumerOrderConfirmationList.orderBy.0'] = "id"
      params['consumerOrderConfirmationList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        consumerOrderConfirmationSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(ConsumerOrderConfirmationSearchForm)
