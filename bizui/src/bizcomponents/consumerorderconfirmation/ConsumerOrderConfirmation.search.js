...
class ConsumerOrderConfirmationSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {ConsumerOrderConfirmationTable} = GlobalComponents;
    const {ConsumerOrderConfirmationSearchForm} = GlobalComponents;
    const {ConsumerOrderConfirmationModalTable} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <ConsumerOrderConfirmationSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,ConsumerOrderConfirmationModalTable,"consumerOrderConfirmationIds")}
...
export default Form.create()(ConsumerOrderConfirmationSearch)
