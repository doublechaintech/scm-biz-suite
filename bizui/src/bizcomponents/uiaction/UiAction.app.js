...
constructor(props) {
 ...
 getNavMenuItems = (targetObject, style, customTheme) => {
	  ...
	  <Menu
       ...
       >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/uiAction/${this.props.uiAction.id}/dashboard`}><Icon type="dashboard" style={{marginRight:"20px"}}/><span>{appLocaleName(userContext,"Dashboard")}</span></Link>
             </Menu.Item>
  ...
  buildRouters = () =>{
  	...
  	const routers=[
  	{path:"/uiAction/:id/dashboard", component: UiActionDashboard},
