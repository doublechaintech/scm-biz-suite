...
import styles from './UiAction.search.less'
...
class UiActionSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      uiActionList: 1,
      'uiActionList.searchField': fieldName,
      'uiActionList.searchVerb': 'startsWith',
      'uiActionList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      const {listName} = owner
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'contains', 'brief'))
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'contains', 'linkToUrl'))
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'contains', 'extraData'))
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'eq', 'page'))
      ...
      dispatch({
        ...
        uiActionSearchFormParameters: filterObjectKeys(fieldsValue),
    ...
    return (
      <Form onSubmit={this.handleSearch} layout="inline">
        <Row gutter={{ md: 8, lg: 24, xl: 48 }}>
          ...
          <Col md={8} sm={24}>
            <FormItem label={fieldLabels.icon}>
          ...
          <Col md={8} sm={24}>
            <FormItem label={fieldLabels.brief}>
          ...
          <Col md={8} sm={24}>
            <FormItem label={fieldLabels.linkToUrl}>
          ...
          <Col md={8} sm={24}>
            <FormItem label={fieldLabels.extraData}>
 ...
 <Col md={8} sm={24}>
                    <Form.Item label={fieldLabels.page}>
                  {getFieldDecorator('page', {initialValue: tryinit('page')})(
                  
                  <SelectObject 
                    disabled={!availableForEdit('page')}
                    targetType={"page"} 
                    requestFunction={UiActionService.requestCandidatePage} useForSearch />
...
export default Form.create()(UiActionSearchForm)
