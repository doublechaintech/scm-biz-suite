...
import UiActionCreateFormBody from './UiAction.createformbody'
...
class UiActionCreateForm extends Component {
  state = {
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          ...
          payload: { id: owner.id, type: 'uiAction', parameters, continueNext: true },
        })
      })
    }
...
}))(Form.create()(UiActionCreateForm))
