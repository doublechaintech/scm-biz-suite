...
import styles from './WechatWorkappIdentity.search.less'
import GlobalComponents from '../../custcomponents'
import CandidateList from '../../components/CandidateList'
import appLocaleName from '../../common/Locale.tool'
import WechatWorkappIdentityBase from './WechatWorkappIdentity.base'
const FormItem = Form.Item
const { Option } = Select
const getValue = obj => Object.keys(obj).map(key => obj[key]).join(',')
const {fieldLabels} = WechatWorkappIdentityBase
...
class WechatWorkappIdentitySearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      wechatWorkappIdentityList: 1,
      'wechatWorkappIdentityList.searchField': fieldName,
      'wechatWorkappIdentityList.searchVerb': 'startsWith',
      'wechatWorkappIdentityList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      const {listName} = owner
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'contains', 'corpId'))
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'contains', 'userId'))
      ...
      dispatch({
        ...
        wechatWorkappIdentitySearchFormParameters: filterObjectKeys(fieldsValue),
  ...
  renderSimpleForm() {
    ...
    return (
      <Form onSubmit={this.handleSearch} layout="inline">
       ...
       <Col md={8} sm={24}>
         <FormItem label={fieldLabels.corpId}>
    ...
    return (
      <Form onSubmit={this.handleSearch} layout="inline">
        <Row gutter={{ md: 8, lg: 24, xl: 48 }}>
          ...
          <Col md={8} sm={24}>
            <FormItem label={fieldLabels.userId}>
 ...
 <Col md={8} sm={24}>
                  ...
                  <CandidateList 
		                 ...
		                 ownerId={owner.id}
		                 scenarioCode={"search"}
		                 listType={"wechat_workapp_identity"} 
		                 targetType={"sec_user"} 
                 
                    requestFunction={WechatWorkappIdentityService.queryCandidates} useForSearch />
...
export default Form.create()(WechatWorkappIdentitySearchForm)
