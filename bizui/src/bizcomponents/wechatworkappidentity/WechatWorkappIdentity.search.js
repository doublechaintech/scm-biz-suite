...
class WechatWorkappIdentitySearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {WechatWorkappIdentityTable} = GlobalComponents;
    const {WechatWorkappIdentitySearchForm} = GlobalComponents;
    const {WechatWorkappIdentityModalTable} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        ...
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <WechatWorkappIdentitySearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,WechatWorkappIdentityModalTable,"wechatWorkappIdentityIds")}
...
export default Form.create()(WechatWorkappIdentitySearch)
