...
import styles from './WechatWorkappIdentity.updateform.less'
...
class WechatWorkappIdentityUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const wechatWorkappIdentityId = values.id

        const parameters = { ...values, wechatWorkappIdentityId, }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateWechatWorkappIdentity`,
          payload: {
            id: owner.id,
            type: 'wechatWorkappIdentity',
            parameters,
            selectedRows,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextWechatWorkappIdentityUpdateRow`,
        payload: {
          id: owner.id,
          type: 'wechatWorkappIdentity',
          selectedRows,
	...
	const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"Update")}企业微信认证: {(currentUpdateIndex+1)}/{selectedRows.length}</div>)
    }
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.corpId} {...formItemLayout}>
                  {getFieldDecorator('corpId', {
                    ...
                    <SmallTextInput size="large"  placeholder={fieldLabels.corpId} />
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.userId} {...formItemLayout}>
                  {getFieldDecorator('userId', {
                    ...
                    <SmallTextInput size="large"  placeholder={fieldLabels.userId} />
...
}))(Form.create()(WechatWorkappIdentityUpdateForm))
