...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{interviewTypeList:selectedRows}} owner={owner}  
...
class InterviewTypeSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {InterviewTypeTable} = GlobalComponents;
    const {InterviewTypeSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        ...
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <InterviewTypeSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,InterviewTypeModalTable,"interviewTypeIds")}
...
export default Form.create()(InterviewTypeSearch)
