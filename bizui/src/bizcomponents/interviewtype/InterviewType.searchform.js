...
import styles from './InterviewType.search.less'
...
class InterviewTypeSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      interviewTypeList: 1,
      'interviewTypeList.searchField': fieldName,
      'interviewTypeList.searchVerb': 'startsWith',
      'interviewTypeList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`interviewTypeList.searchField`] = fieldName
    value[`interviewTypeList.searchVerb`] =  searchVerb
    value[`interviewTypeList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
      params['interviewTypeList'] = 1
      params['interviewTypeList.orderBy.0'] = "id"
      params['interviewTypeList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        interviewTypeSearchFormParameters: filterObjectKeys(fieldsValue),
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
                  ...
                  <SelectObject 
                    ...
                    targetType={"company"} 
<<<<<<< HEAD
                    requestFunction={InterviewTypeService.requestCandidateCompany}/>
                  
=======
                    requestFunction={InterviewTypeService.requestCandidateCompany} useForSearch />
...
export default Form.create()(InterviewTypeSearchForm)
