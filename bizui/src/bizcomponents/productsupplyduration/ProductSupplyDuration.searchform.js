...
class ProductSupplyDurationSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      productSupplyDurationList: 1,
      'productSupplyDurationList.searchField': fieldName,
      'productSupplyDurationList.searchVerb': 'startsWith',
      'productSupplyDurationList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        productSupplyDurationSearchFormParameters: filterObjectKeys(fieldsValue),
  ...
  renderSimpleForm() {
    ...
    return (
      <Form onSubmit={this.handleSearch} layout="inline">
       ...
       <Col md={8} sm={24}>
         <FormItem label={fieldLabels.duration}>
 ...
 <Col md={8} sm={24}>
                  ...
                  <CandidateList 
                    ...
                    requestFunction={ProductSupplyDurationService.queryCandidates} useForSearch />
...
export default Form.create()(ProductSupplyDurationSearchForm)
