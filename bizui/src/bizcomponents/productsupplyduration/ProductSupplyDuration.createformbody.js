...
import styles from './ProductSupplyDuration.createform.less'
...
class ProductSupplyDurationCreateFormBody extends Component {
  state = {
  ...
  componentDidMount() {
    ...
    const formValue = ProductSupplyDurationBase.unpackObjectToFormValues(initValue)
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.quantity} {...formItemLayout}>
                  {getFieldDecorator('quantity', {
                    ...
                    <SmallTextInput minLength={0} maxLength={500} size="large"  placeholder={fieldLabels.quantity} />
                  )}
                </Form.Item>
              </Col>
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.duration} {...formItemLayout}>
                  {getFieldDecorator('duration', {
                    ...
                    <SmallTextInput minLength={1} maxLength={8} size="large"  placeholder={fieldLabels.duration} />
                  )}
                </Form.Item>
              </Col>
              ...
              <Col lg={24} md={24} sm={24} >
                <Form.Item label={fieldLabels.product} {...formItemLayout}>
                  ...
                  <CandidateList
		                 ...
		                 ownerId={owner.id}
		                 scenarioCode={"assign"}
		                 listType={"product_supply_duration"}
		                 targetType={"supplier_product"}

                    requestFunction={ProductSupplyDurationService.queryCandidates}  />
...
}))(Form.create()(ProductSupplyDurationCreateFormBody))
