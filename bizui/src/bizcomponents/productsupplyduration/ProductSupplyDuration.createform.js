...
class ProductSupplyDurationCreateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, ...imagesValues }
        dispatch({
          type: `${owner.type}/addProductSupplyDuration`,
          payload: { id: owner.id, type: 'productSupplyDuration', parameters, continueNext: true },
        })
      })
    }
	...
	return (
      <PageHeaderLayout
        title={`${appLocaleName(userContext,"CreateNew")}Product Supply Duration`}
        content={`${appLocaleName(userContext,"CreateNew")}Product Supply Duration`}
...
}))(Form.create()(ProductSupplyDurationCreateForm))
