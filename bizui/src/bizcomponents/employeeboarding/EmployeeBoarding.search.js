...
class EmployeeBoardingSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {EmployeeBoardingTable} = GlobalComponents;
    const {EmployeeBoardingSearchForm} = GlobalComponents;
    const {EmployeeBoardingModalTable} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <EmployeeBoardingSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,EmployeeBoardingModalTable,"employeeBoardingIds")}
...
export default Form.create()(EmployeeBoardingSearch)
