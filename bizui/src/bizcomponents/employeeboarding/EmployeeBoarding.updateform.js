...
import styles from './EmployeeBoarding.updateform.less'
...
class EmployeeBoardingUpdateForm extends Component {
  state = {
  ...
  getSelectedRow() {
    ...
    const convertiedValues = selectedRows.map((item) => {
      return {
        ...item,
        employTime: moment(item.employTime),
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
        ...
        const employeeBoardingId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, employeeBoardingId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateEmployeeBoarding`,
          payload: {
            id: owner.id,
            type: 'employeeBoarding',
            parameters,
            selectedRows,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextEmployeeBoardingUpdateRow`,
        payload: {
          id: owner.id,
          type: 'employeeBoarding',
          selectedRows,
...
<<<<<<< HEAD
    ...
    return (
      <PageHeaderLayout
        title={"更新员工入职"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新员工入职"
...
=======
	...
	const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"Update")}员工入职: {(currentUpdateIndex+1)}/{selectedRows.length}</div>)
    }
              ...
              <Col lg={12} md={12} sm={24}>
                <Form.Item label={fieldLabels.employTime} {...formItemLayout}>
                  {getFieldDecorator('employTime', {
                    initialValue: selectedRow.employTime,
...
}))(Form.create()(EmployeeBoardingUpdateForm))
