...
<<<<<<< HEAD
    ...
    return (
		  ...
		  <Menu
           ...
           >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/employeeBoarding/${this.props.employeeBoarding.id}/dashboard`}><Icon type="dashboard" /><span>仪表板</span></Link>
             </Menu.Item>
       ...
       <Menu.Item key="preference">
               <Link to={`/employeeBoarding/${this.props.employeeBoarding.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
    ...
    return (
	  <Menu
       ...
       >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/employeeBoarding/${this.props.employeeBoarding.id}/dashboard`}><Icon type="dashboard" style={{marginRight:"20px"}}/><span>{appLocaleName(userContext,"Dashboard")}</span></Link>
             </Menu.Item>
...
<<<<<<< HEAD
      ...
      searchFormParameters: state._employeeBoarding.employeeSearchFormParameters,
      loading: state._employeeBoarding.loading,
      owner: { type: '_employeeBoarding', id: state._employeeBoarding.id, referenceName: 'employeeBoarding', listName: 'employeeList', ref:state._employeeBoarding, listDisplayName: '员工列表'}, // this is for model namespace and
=======
      returnURL: `/employeeBoarding/${state._employeeBoarding.id}/list`,
      currentPage: state._employeeBoarding.employeeCurrentPageNumber,
      searchFormParameters: state._employeeBoarding.employeeSearchFormParameters,
      loading: state._employeeBoarding.loading,
...
<<<<<<< HEAD
      owner: { type: '_employeeBoarding', id: state._employeeBoarding.id, listName: 'employeeList', ref:state._employeeBoarding, listDisplayName: '员工列表' }, // this is for model namespace and
=======
...
<<<<<<< HEAD
  	const {EmployeeBoardingPreference} = GlobalComponents
=======
...
<<<<<<< HEAD
  	{path:"/employeeBoarding/:id/preference", component: EmployeeBoardingPreference},
=======
...
<<<<<<< HEAD
     ...
     //const {EmployeeBoardingEditDetail} = GlobalComponents
     //const {EmployeeBoardingViewDetail} = GlobalComponents
...
=======
 ...
 <Header>
        ...
        <Col {...naviBarResponsiveStyle} >
            <Dropdown overlay= {this.getNavMenuItems(this.props.employeeBoarding)}>
