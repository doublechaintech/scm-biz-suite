...
import styles from './EmployeeBoarding.search.less'
...
class EmployeeBoardingSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      employeeBoardingList: 1,
      'employeeBoardingList.searchField': fieldName,
      'employeeBoardingList.searchVerb': 'startsWith',
      'employeeBoardingList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`employeeBoardingList.searchField`] = fieldName
    value[`employeeBoardingList.searchVerb`] =  searchVerb
    value[`employeeBoardingList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
      params['employeeBoardingList'] = 1
      params['employeeBoardingList.orderBy.0'] = "id"
      params['employeeBoardingList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        employeeBoardingSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(EmployeeBoardingSearchForm)
