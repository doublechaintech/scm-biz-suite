...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{instructorList:selectedRows}} owner={owner}  
...
class InstructorSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {InstructorTable} = GlobalComponents;
    const {InstructorSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        ...
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <InstructorSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,InstructorModalTable,"instructorIds")}
...
export default Form.create()(InstructorSearch)
