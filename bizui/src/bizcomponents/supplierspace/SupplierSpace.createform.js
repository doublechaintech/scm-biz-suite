...
const testValues = {
  ...
  totalArea: '1876平方米',
<<<<<<< HEAD
  latitude: '40.05506037627094',
  longitude: '129.69575475457037',
=======
  latitude: '40.596521046150954',
  longitude: '129.94685491032268',
...
class SupplierSpaceCreateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, ...imagesValues }
        dispatch({
          type: `${owner.type}/addSupplierSpace`,
          payload: { id: owner.id, type: 'supplierSpace', parameters, continueNext: true },
        })
      })
    }
	...
	return (
      ...
      >
   		...
   		<SupplierSpaceCreateFormBody	 {...this.props} handleImageChange={this.handleImageChange}/>
...
}))(Form.create()(SupplierSpaceCreateForm))
