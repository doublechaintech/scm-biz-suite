...
const renderItemOfList=(retailStoreCityServiceCenter, targetComponent, columCount, listName)=>{
  ...
  const userContext = null
  return (
    <Card key={`${listName}-${retailStoreCityServiceCenter.id}`} style={{marginTop:"10px"}}>
