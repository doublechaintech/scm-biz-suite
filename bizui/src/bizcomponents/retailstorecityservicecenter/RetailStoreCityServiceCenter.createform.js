...
=======
import RetailStoreCityServiceCenterCreateFormBody from './RetailStoreCityServiceCenter.createformbody'
...
class RetailStoreCityServiceCenterCreateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, ...imagesValues }
        dispatch({
          type: `${owner.type}/addRetailStoreCityServiceCenter`,
          payload: { id: owner.id, type: 'retailStoreCityServiceCenter', parameters, continueNext: true },
        })
      })
    }
...
<<<<<<< HEAD
      dispatch({
        ...
        payload: { id: owner.id, type: 'retailStoreCityServiceCenter',listName:'双链小超城市服务中心列表' },
=======
     
      dispatch({
        type: `${owner.type}/goback`,
        payload: { id: owner.id, type: 'retailStoreCityServiceCenter',listName:appLocaleName(userContext,"List") },
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      })
    }
...
<<<<<<< HEAD
    ...
    return (
      <PageHeaderLayout
        title="新建一个双链小超城市服务中心"
        content="新建一个双链小超城市服务中心"
...
=======
	...
	return (
      ...
      >
   		...
   		<RetailStoreCityServiceCenterCreateFormBody	 {...this.props} />
...
}))(Form.create()(RetailStoreCityServiceCenterCreateForm))
