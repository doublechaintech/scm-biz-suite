...
import styles from './RetailStoreCityServiceCenter.updateform.less'
...
class RetailStoreCityServiceCenterUpdateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
        ...
        const retailStoreCityServiceCenterId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, retailStoreCityServiceCenterId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateRetailStoreCityServiceCenter`,
          payload: {
            id: owner.id,
            type: 'retailStoreCityServiceCenter',
            parameters,
            selectedRows,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextRetailStoreCityServiceCenterUpdateRow`,
        payload: {
          id: owner.id,
          type: 'retailStoreCityServiceCenter',
          selectedRows,
...
<<<<<<< HEAD
    ...
    return (
      <PageHeaderLayout
        title={"更新双链小超城市服务中心"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新双链小超城市服务中心"
...
=======
	...
	const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"Update")}双链小超城市服务中心: {(currentUpdateIndex+1)}/{selectedRows.length}</div>)
    }
...
}))(Form.create()(RetailStoreCityServiceCenterUpdateForm))
