...
import styles from './CandidateElement.updateform.less'
...
class CandidateElementUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const candidateElementId = values.id

        const parameters = { ...values, candidateElementId, }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateCandidateElement`,
          payload: {
            id: owner.id,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextCandidateElementUpdateRow`,
        payload: {
          id: owner.id,
          type: 'candidateElement',
          selectedRows,
	...
	const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"Update")}候选人元素: {(currentUpdateIndex+1)}/{selectedRows.length}</div>)
    }
          ...
          <Form >
            <Row gutter={16}>
              ...
              <Form.Item>
               ...
               <PrivateImageEditInput buttonTitle={fieldLabels.image}/>
                )} </Form.Item>
              </Col>
...
}))(Form.create()(CandidateElementUpdateForm))
