...
class CandidateElementCreateFormBody extends Component {
  state = {
  ...
  componentDidMount() {
    ...
    const formValue = CandidateElementBase.unpackObjectToFormValues(initValue)
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.type} {...formItemLayout}>
                  {getFieldDecorator('type', {
                    ...
                    <SmallTextInput minLength={1} maxLength={200} size="large"  placeholder={fieldLabels.type} />
                  )}
                </Form.Item>
              </Col>
              ...
              <Col lg={24} md={24} sm={24} style={{"display":"none"}}>
                <Form.Item label={fieldLabels.container} {...formItemLayout}>
                  ...
                  <CandidateList
                    ...
                    requestFunction={CandidateElementService.queryCandidates}  />
