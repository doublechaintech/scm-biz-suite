...
const internalSummaryOf = (item, targetComponents)=>{
	...
	return GlobalComponents.CandidateElementBase.renderItemOfList(item, targetComponents)

}



class CandidateElementProfile extends Component {
...
}))(Form.create()(CandidateElementProfile))
