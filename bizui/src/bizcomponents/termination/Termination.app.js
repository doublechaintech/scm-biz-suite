...
import styles from './Termination.app.less'
...
class TerminationBizApp extends React.PureComponent {
  constructor(props) {
    super(props)
<<<<<<< HEAD
...
<<<<<<< HEAD
    ...
    return (
		  ...
		  <Menu
           ...
           >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/termination/${this.props.termination.id}/dashboard`}><Icon type="dashboard" /><span>仪表板</span></Link>
             </Menu.Item>
       ...
       <Menu.Item key="preference">
               <Link to={`/termination/${this.props.termination.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
    ...
    return (
	  <Menu
       ...
       >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/termination/${this.props.termination.id}/dashboard`}><Icon type="dashboard" style={{marginRight:"20px"}}/><span>{appLocaleName(userContext,"Dashboard")}</span></Link>
             </Menu.Item>
...
<<<<<<< HEAD
      ...
      searchFormParameters: state._termination.employeeSearchFormParameters,
      loading: state._termination.loading,
      owner: { type: '_termination', id: state._termination.id, referenceName: 'termination', listName: 'employeeList', ref:state._termination, listDisplayName: '员工列表'}, // this is for model namespace and
=======
...
<<<<<<< HEAD
      owner: { type: '_termination', id: state._termination.id, listName: 'employeeList', ref:state._termination, listDisplayName: '员工列表' }, // this is for model namespace and
=======
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
  ...
  buildRouters = () =>{
  	const {TerminationDashboard} = GlobalComponents
<<<<<<< HEAD
  	const {TerminationPreference} = GlobalComponents
=======
  	const {TerminationPermission} = GlobalComponents
  	const {TerminationProfile} = GlobalComponents
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
  	
  	
  	const routers=[
  	{path:"/termination/:id/dashboard", component: TerminationDashboard},
<<<<<<< HEAD
  	{path:"/termination/:id/preference", component: TerminationPreference},
=======
  	{path:"/termination/:id/profile", component: TerminationProfile},
...
<<<<<<< HEAD
     ...
     //const {TerminationEditDetail} = GlobalComponents
     //const {TerminationViewDetail} = GlobalComponents
     ...
     <Layout>
       ...
       <Layout>
		 ...
		 {this.getNavMenuItems(this.props.termination)}
