...
const internalSummaryOf = (item, targetComponents)=>{
	...
	return GlobalComponents.TerminationBase.renderItemOfList(item, targetComponents)

}



class TerminationProfile extends Component {
...
}))(Form.create()(TerminationProfile))
