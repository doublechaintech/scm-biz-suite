...
class TransportFleetAssociateForm extends Component {
  state = {
 ...
 const {TransportTruckModalTable} = GlobalComponents;
 const {TruckDriverModalTable} = GlobalComponents;
 ...
 <Modal
	...
	<TransportTruckModalTable data={data.transportTruckList} owner={owner} />
	<TruckDriverModalTable data={data.truckDriverList} owner={owner} />
...
}))(Form.create()(TransportFleetAssociateForm))
