...
class TransportFleetCreateFormBody extends Component {
  state = {
  ...
  componentDidMount() {
    ...
    const formValue = TransportFleetBase.unpackObjectToFormValues(initValue)
              ...
              <Col lg={24} md={24} sm={24} style={{"display":"none"}}>
                <Form.Item label={fieldLabels.owner} {...formItemLayout}>
                  ...
                  <CandidateList
                    ...
                    requestFunction={TransportFleetService.queryCandidates}  />
...
}))(Form.create()(TransportFleetCreateFormBody))
