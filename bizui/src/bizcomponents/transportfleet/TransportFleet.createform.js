...
import styles from './TransportFleet.createform.less'
...
=======
import TransportFleetCreateFormBody from './TransportFleet.createformbody'
...
class TransportFleetCreateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, ...imagesValues }
        dispatch({
          type: `${owner.type}/addTransportFleet`,
          payload: { id: owner.id, type: 'transportFleet', parameters, continueNext: true },
        })
      })
    }
...
<<<<<<< HEAD
      dispatch({
        ...
        payload: { id: owner.id, type: 'transportFleet',listName:'运输车队列表' },
=======
     
      dispatch({
        type: `${owner.type}/goback`,
        payload: { id: owner.id, type: 'transportFleet',listName:appLocaleName(userContext,"List") },
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      })
    }
...
=======
	...
	return (
      ...
      >
   		...
   		<TransportFleetCreateFormBody	 {...this.props} />
...
}))(Form.create()(TransportFleetCreateForm))
