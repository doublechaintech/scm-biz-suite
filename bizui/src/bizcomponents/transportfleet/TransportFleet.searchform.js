...
import styles from './TransportFleet.search.less'
...
class TransportFleetSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      transportFleetList: 1,
      'transportFleetList.searchField': fieldName,
      'transportFleetList.searchVerb': 'startsWith',
      'transportFleetList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`transportFleetList.searchField`] = fieldName
    value[`transportFleetList.searchVerb`] =  searchVerb
    value[`transportFleetList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
      params['transportFleetList'] = 1
      params['transportFleetList.orderBy.0'] = "id"
      params['transportFleetList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        transportFleetSearchFormParameters: filterObjectKeys(fieldsValue),
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
                  ...
                  <SelectObject 
                    ...
                    targetType={"owner"} 
<<<<<<< HEAD
                    requestFunction={TransportFleetService.requestCandidateOwner}/>
                  
=======
                    requestFunction={TransportFleetService.requestCandidateOwner} useForSearch />
...
export default Form.create()(TransportFleetSearchForm)
