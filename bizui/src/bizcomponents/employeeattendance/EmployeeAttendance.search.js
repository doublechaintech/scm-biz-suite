...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{employeeAttendanceList:selectedRows}} owner={owner}  
...
class EmployeeAttendanceSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {EmployeeAttendanceTable} = GlobalComponents;
    const {EmployeeAttendanceSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={`${displayName}:${this.props.name}${appLocaleName(userContext,"List")}`}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <EmployeeAttendanceSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,EmployeeAttendanceModalTable,"employeeAttendanceIds")}
...
export default Form.create()(EmployeeAttendanceSearch)
