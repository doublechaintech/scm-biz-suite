...
const internalImageListOf = (employeeAttendance) =>{
<<<<<<< HEAD
...
const internalSettingListOf = (employeeAttendance) =>{
<<<<<<< HEAD
...
const handleTransferSearch =(targetComponent,filterKey,newRequest)=>{
  ...
  const pageNo = 1;
  const candidateReferenceService = EmployeeAttendanceService[candidateServiceName] 
...
const executeTrans = (employeeAttendance,targetComponent) =>{
...
const buildTransferModal = (employeeAttendance,targetComponent) => {
...
<Modal title={transferModalTitle}
          ...
          onOk={()=>executeTrans(employeeAttendance,targetComponent)}
...
const internalRenderExtraHeader = (employeeAttendance) =>{
	return null
}
const internalRenderExtraFooter = (employeeAttendance) =>{
	return null
}
...
=======
	...
	<DescriptionList className={styles.headerList} size="small" col="4">
<Description term="序号">{employeeAttendance.id}</Description> 
<Description term="员工">{employeeAttendance.employee==null?appLocaleName(userContext,"NotAssigned"):employeeAttendance.employee.displayName}
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
 <Icon type="swap" onClick={()=>
  showTransferModel(targetComponent,"员工","employee","requestCandidateEmployee",
	      "transferToAnotherEmployee","anotherEmployeeId",employeeAttendance.employee?employeeAttendance.employee.id:"")} 
...
class EmployeeAttendancePreference extends Component {
...
}))(Form.create()(EmployeeAttendancePreference))
