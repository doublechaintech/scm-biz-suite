...
import styles from './EmployeeAttendance.search.less'
...
class EmployeeAttendanceSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      employeeAttendanceList: 1,
      'employeeAttendanceList.searchField': fieldName,
      'employeeAttendanceList.searchVerb': 'startsWith',
      'employeeAttendanceList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`employeeAttendanceList.searchField`] = fieldName
    value[`employeeAttendanceList.searchVerb`] =  searchVerb
    value[`employeeAttendanceList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
      params['employeeAttendanceList'] = 1
      params['employeeAttendanceList.orderBy.0'] = "id"
      params['employeeAttendanceList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        employeeAttendanceSearchFormParameters: filterObjectKeys(fieldsValue),
...
=======
                 requestFunction={EmployeeAttendanceService.requestCandidateEmployee} useForSearch />
...
export default Form.create()(EmployeeAttendanceSearchForm)
