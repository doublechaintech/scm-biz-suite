...
/*
const testValues = {
  enterTime: '2019-03-03',
  leaveTime: '2018-07-21',
  durationHours: '7',
  remark: '今天状态不错啊',
  employeeId: 'E000001',
}
...
class EmployeeAttendanceCreateForm extends Component {
  ...
  render() {
	...
	return (
      <PageHeaderLayout
        title={`${appLocaleName(userContext,"CreateNew")}Employee Attendance`}
        content={`${appLocaleName(userContext,"CreateNew")}Employee Attendance`}
