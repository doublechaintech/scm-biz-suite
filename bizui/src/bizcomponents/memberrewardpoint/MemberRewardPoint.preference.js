...
const internalImageListOf = (memberRewardPoint) =>{
<<<<<<< HEAD
...
const internalSettingListOf = (memberRewardPoint) =>{
<<<<<<< HEAD
...
const handleTransferSearch =(targetComponent,filterKey,newRequest)=>{
  ...
  const pageNo = 1;
  const candidateReferenceService = MemberRewardPointService[candidateServiceName] 
...
const executeTrans = (memberRewardPoint,targetComponent) =>{
...
const buildTransferModal = (memberRewardPoint,targetComponent) => {
...
<Modal title={transferModalTitle}
          ...
          onOk={()=>executeTrans(memberRewardPoint,targetComponent)}
...
const internalRenderExtraHeader = (memberRewardPoint) =>{
	return null
}
const internalRenderExtraFooter = (memberRewardPoint) =>{
	return null
}
...
=======
<Description term="业主">{memberRewardPoint.owner==null?appLocaleName(userContext,"NotAssigned"):memberRewardPoint.owner.displayName}
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
 <Icon type="swap" onClick={()=>
  showTransferModel(targetComponent,"业主","retailStoreMember","requestCandidateOwner",
	      "transferToAnotherOwner","anotherOwnerId",memberRewardPoint.owner?memberRewardPoint.owner.id:"")} 
...
class MemberRewardPointPreference extends Component {
...
}))(Form.create()(MemberRewardPointPreference))
