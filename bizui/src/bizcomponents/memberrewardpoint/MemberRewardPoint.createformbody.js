...
class MemberRewardPointCreateFormBody extends Component {
  state = {
  ...
  componentDidMount() {
    ...
    const formValue = MemberRewardPointBase.unpackObjectToFormValues(initValue)
...
}))(Form.create()(MemberRewardPointCreateFormBody))
