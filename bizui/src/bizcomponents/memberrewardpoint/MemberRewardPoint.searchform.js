...
import styles from './MemberRewardPoint.search.less'
...
class MemberRewardPointSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      memberRewardPointList: 1,
      'memberRewardPointList.searchField': fieldName,
      'memberRewardPointList.searchVerb': 'startsWith',
      'memberRewardPointList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`memberRewardPointList.searchField`] = fieldName
    value[`memberRewardPointList.searchVerb`] =  searchVerb
    value[`memberRewardPointList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
      params['memberRewardPointList'] = 1
      params['memberRewardPointList.orderBy.0'] = "id"
      params['memberRewardPointList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        memberRewardPointSearchFormParameters: filterObjectKeys(fieldsValue),
...
=======
                    requestFunction={MemberRewardPointService.requestCandidateOwner} useForSearch />
...
export default Form.create()(MemberRewardPointSearchForm)
