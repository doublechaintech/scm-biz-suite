...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{memberRewardPointList:selectedRows}} owner={owner}  
...
class MemberRewardPointSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {MemberRewardPointTable} = GlobalComponents;
    const {MemberRewardPointSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <MemberRewardPointSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,MemberRewardPointModalTable,"memberRewardPointIds")}
...
export default Form.create()(MemberRewardPointSearch)
