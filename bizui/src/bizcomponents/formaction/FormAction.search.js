...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{formActionList:selectedRows}} owner={owner}  
...
class FormActionSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {FormActionTable} = GlobalComponents;
    const {FormActionSearchForm} = GlobalComponents;
    const {FormActionModalTable} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <FormActionSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,FormActionModalTable,"formActionIds")}
...
export default Form.create()(FormActionSearch)
