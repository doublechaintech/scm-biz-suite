...
import FormActionCreateFormBody from './FormAction.createformbody'
  ...
  render() {
    ...
    const goback = () => {
      ...
      dispatch({
        ...
        payload: { id: owner.id, type: 'formAction',listName:appLocaleName(userContext,"List") },
      })
    }
...
<<<<<<< HEAD
        content={`${appLocaleName(userContext,"CreateNew")}表单动作`}
=======
        content={`${appLocaleName(userContext,"CreateNew")}${window.trans('form_action')}`}
>>>>>>> ea67698ef1c4e94c89147baaf9f93aa768973fbe
        wrapperClassName={styles.advancedForm}
      >
   			
   		<FormActionCreateFormBody	 {...this.props} />
