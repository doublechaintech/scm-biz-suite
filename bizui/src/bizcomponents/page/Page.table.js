...
import styles from './Page.table.less'
    ...
    const operationColumn={
      ...
      render: (text, record) => (
        <span>
          ...
          { hasReadPermission(metaInfo)&&<Link to={`/page/${record.id}/dashboard`}>{appLocaleName(userContext,"View")}</Link>}
