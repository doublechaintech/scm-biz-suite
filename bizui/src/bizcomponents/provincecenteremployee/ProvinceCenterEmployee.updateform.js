...
import styles from './ProvinceCenterEmployee.updateform.less'
...
class ProvinceCenterEmployeeUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const provinceCenterEmployeeId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, provinceCenterEmployeeId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateProvinceCenterEmployee`,
          payload: {
            id: owner.id,
            type: 'provinceCenterEmployee',
            parameters,
            selectedRows,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextProvinceCenterEmployeeUpdateRow`,
        payload: {
          id: owner.id,
          type: 'provinceCenterEmployee',
          selectedRows,
    ...
    return (
      <PageHeaderLayout
        title={"更新省中心员工"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新省中心员工"
...
}))(Form.create()(ProvinceCenterEmployeeUpdateForm))
