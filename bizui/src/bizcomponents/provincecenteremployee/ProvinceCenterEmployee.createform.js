...
import ProvinceCenterEmployeeCreateFormBody from './ProvinceCenterEmployee.createformbody'
...
class ProvinceCenterEmployeeCreateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, ...imagesValues }
        dispatch({
          type: `${owner.type}/addProvinceCenterEmployee`,
          payload: { id: owner.id, type: 'provinceCenterEmployee', parameters, continueNext: true },
        })
      })
    }
...
}))(Form.create()(ProvinceCenterEmployeeCreateForm))
