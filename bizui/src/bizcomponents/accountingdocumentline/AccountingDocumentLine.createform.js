...
=======
import AccountingDocumentLineCreateFormBody from './AccountingDocumentLine.createformbody'
...
class AccountingDocumentLineCreateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, ...imagesValues }
        dispatch({
          type: `${owner.type}/addAccountingDocumentLine`,
          payload: { id: owner.id, type: 'accountingDocumentLine', parameters, continueNext: true },
        })
      })
    }
...
<<<<<<< HEAD
      dispatch({
        ...
        payload: { id: owner.id, type: 'accountingDocumentLine',listName:'会计凭证行列表' },
=======
     
      dispatch({
        type: `${owner.type}/goback`,
        payload: { id: owner.id, type: 'accountingDocumentLine',listName:appLocaleName(userContext,"List") },
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      })
    }
              ...
              <Col lg={12} md={12} sm={24}>
                <Form.Item label={fieldLabels.accountingSubject} {...formItemLayout}>
                  {getFieldDecorator('accountingSubjectId', {
                    ...
                    rules: [{ required: true, message: '请输入会计科目' }],
                  })(
...
}))(Form.create()(AccountingDocumentLineCreateForm))
