...
import styles from './AccountingDocumentLine.workbench.less'
...
class AccountingDocumentLineWorkbench extends Component {
...
}))(Form.create()(AccountingDocumentLineWorkbench))
