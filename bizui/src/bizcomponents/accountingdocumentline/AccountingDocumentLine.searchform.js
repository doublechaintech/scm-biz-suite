...
class AccountingDocumentLineSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      accountingDocumentLineList: 1,
      'accountingDocumentLineList.searchField': fieldName,
      'accountingDocumentLineList.searchVerb': 'startsWith',
      'accountingDocumentLineList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        accountingDocumentLineSearchFormParameters: filterObjectKeys(fieldsValue),
    ...
    return (
      <Form onSubmit={this.handleSearch} layout="inline">
        <Row gutter={{ md: 8, lg: 24, xl: 48 }}>
          ...
          <Col md={8} sm={24}>
            <FormItem label={fieldLabels.direct}>
 ...
 <Col md={8} sm={24}>
                  ...
                  <CandidateList 
                    ...
                    requestFunction={AccountingDocumentLineService.queryCandidates} useForSearch />
                  	
                 
                  )}
                </Form.Item></Col>
 <Col md={8} sm={24}>
                    <Form.Item label={fieldLabels.accountingSubject}>
...
export default Form.create()(AccountingDocumentLineSearchForm)
