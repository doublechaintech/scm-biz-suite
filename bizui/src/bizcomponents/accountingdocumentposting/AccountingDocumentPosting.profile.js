...
const internalSummaryOf = (item, targetComponents)=>{
	...
	return GlobalComponents.AccountingDocumentPostingBase.renderItemOfList(item, targetComponents)

}



class AccountingDocumentPostingProfile extends Component {
...
}))(Form.create()(AccountingDocumentPostingProfile))
