...
<<<<<<< HEAD
    ...
    return (
		  ...
		  <Menu
           ...
           >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/accountingDocumentPosting/${this.props.accountingDocumentPosting.id}/dashboard`}><Icon type="dashboard" /><span>仪表板</span></Link>
             </Menu.Item>
       ...
       <Menu.Item key="preference">
               <Link to={`/accountingDocumentPosting/${this.props.accountingDocumentPosting.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
    ...
    return (
	  <Menu
       ...
       >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/accountingDocumentPosting/${this.props.accountingDocumentPosting.id}/dashboard`}><Icon type="dashboard" style={{marginRight:"20px"}}/><span>{appLocaleName(userContext,"Dashboard")}</span></Link>
             </Menu.Item>
...
<<<<<<< HEAD
      ...
      searchFormParameters: state._accountingDocumentPosting.accountingDocumentSearchFormParameters,
      loading: state._accountingDocumentPosting.loading,
      owner: { type: '_accountingDocumentPosting', id: state._accountingDocumentPosting.id, referenceName: 'posting', listName: 'accountingDocumentList', ref:state._accountingDocumentPosting, listDisplayName: '会计凭证列表'}, // this is for model namespace and
=======
      returnURL: `/accountingDocumentPosting/${state._accountingDocumentPosting.id}/list`,
      currentPage: state._accountingDocumentPosting.accountingDocumentCurrentPageNumber,
      searchFormParameters: state._accountingDocumentPosting.accountingDocumentSearchFormParameters,
      loading: state._accountingDocumentPosting.loading,
...
<<<<<<< HEAD
      owner: { type: '_accountingDocumentPosting', id: state._accountingDocumentPosting.id, listName: 'accountingDocumentList', ref:state._accountingDocumentPosting, listDisplayName: '会计凭证列表' }, // this is for model namespace and
=======
...
<<<<<<< HEAD
  	const {AccountingDocumentPostingPreference} = GlobalComponents
=======
...
<<<<<<< HEAD
     ...
     //const {AccountingDocumentPostingEditDetail} = GlobalComponents
     //const {AccountingDocumentPostingViewDetail} = GlobalComponents
...
=======
 ...
 <Header>
        ...
        <Col {...naviBarResponsiveStyle} >
            <Dropdown overlay= {this.getNavMenuItems(this.props.accountingDocumentPosting)}>
