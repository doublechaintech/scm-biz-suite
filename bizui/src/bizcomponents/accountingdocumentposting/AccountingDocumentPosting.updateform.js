...
import styles from './AccountingDocumentPosting.updateform.less'
...
class AccountingDocumentPostingUpdateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
        ...
        const accountingDocumentPostingId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, accountingDocumentPostingId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateAccountingDocumentPosting`,
          payload: {
            id: owner.id,
            type: 'accountingDocumentPosting',
            parameters,
            selectedRows,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextAccountingDocumentPostingUpdateRow`,
        payload: {
          id: owner.id,
          type: 'accountingDocumentPosting',
          selectedRows,
...
<<<<<<< HEAD
    ...
    return (
      <PageHeaderLayout
        title={"更新会计凭证过帐"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新会计凭证过帐"
...
=======
	...
	const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"Update")}会计凭证过帐: {(currentUpdateIndex+1)}/{selectedRows.length}</div>)
    }
...
}))(Form.create()(AccountingDocumentPostingUpdateForm))
