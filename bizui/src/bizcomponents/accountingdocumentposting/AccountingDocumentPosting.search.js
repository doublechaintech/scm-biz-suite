...
class AccountingDocumentPostingSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {AccountingDocumentPostingTable} = GlobalComponents;
    const {AccountingDocumentPostingSearchForm} = GlobalComponents;
    const {AccountingDocumentPostingModalTable} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={`${displayName}:${this.props.name}列表`}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <AccountingDocumentPostingSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,AccountingDocumentPostingModalTable,"accountingDocumentPostingIds")}
...
export default Form.create()(AccountingDocumentPostingSearch)
