...
import styles from './AccountingDocumentPosting.search.less'
...
class AccountingDocumentPostingSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      accountingDocumentPostingList: 1,
      'accountingDocumentPostingList.searchField': fieldName,
      'accountingDocumentPostingList.searchVerb': 'startsWith',
      'accountingDocumentPostingList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`accountingDocumentPostingList.searchField`] = fieldName
    value[`accountingDocumentPostingList.searchVerb`] =  searchVerb
    value[`accountingDocumentPostingList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
      params['accountingDocumentPostingList'] = 1
      params['accountingDocumentPostingList.orderBy.0'] = "id"
      params['accountingDocumentPostingList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        accountingDocumentPostingSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(AccountingDocumentPostingSearchForm)
