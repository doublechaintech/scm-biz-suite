...
export default {
  ...
  effects: {
    ...
    *addRetailStoreOrder({ payload }, { call, put }) {
      ...
      const location = { pathname: `/retailStoreOrderShipment/${id}/list/RetailStoreOrderList/Retail Store Order+${appLocaleName(userContext,'List')}`, state: newState }
      yield put(routerRedux.push(location))
    },
    *updateRetailStoreOrder({ payload }, { call, put }) {
      ...
      const location = { pathname: `/retailStoreOrderShipment/${id}/list/RetailStoreOrderList/Retail Store Order列表`, state: newPlayload }
      yield put(routerRedux.push(location))
    },
