...
const menuData = {menuName:"Retail Store Order Shipment", menuFor: "retailStoreOrderShipment",
  		subItems: [
...
const displayColumns = [
  { title: fieldLabels.id, debugtype: 'string', dataIndex: 'id', width: '20', render: (text, record)=>renderTextCell(text,record,'retailStoreOrderShipment') , sorter: true },
