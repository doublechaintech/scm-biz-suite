...
<<<<<<< HEAD
    ...
    return (
		  ...
		  <Menu
           ...
           >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/retailStoreOrderShipment/${this.props.retailStoreOrderShipment.id}/dashboard`}><Icon type="dashboard" /><span>仪表板</span></Link>
             </Menu.Item>
       ...
       <Menu.Item key="preference">
               <Link to={`/retailStoreOrderShipment/${this.props.retailStoreOrderShipment.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
    ...
    return (
	  <Menu
       ...
       >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/retailStoreOrderShipment/${this.props.retailStoreOrderShipment.id}/dashboard`}><Icon type="dashboard" style={{marginRight:"20px"}}/><span>{appLocaleName(userContext,"Dashboard")}</span></Link>
             </Menu.Item>
...
<<<<<<< HEAD
      ...
      searchFormParameters: state._retailStoreOrderShipment.retailStoreOrderSearchFormParameters,
      loading: state._retailStoreOrderShipment.loading,
      owner: { type: '_retailStoreOrderShipment', id: state._retailStoreOrderShipment.id, referenceName: 'shipment', listName: 'retailStoreOrderList', ref:state._retailStoreOrderShipment, listDisplayName: '生超的订单列表'}, // this is for model namespace and
=======
      returnURL: `/retailStoreOrderShipment/${state._retailStoreOrderShipment.id}/list`,
      currentPage: state._retailStoreOrderShipment.retailStoreOrderCurrentPageNumber,
      searchFormParameters: state._retailStoreOrderShipment.retailStoreOrderSearchFormParameters,
      loading: state._retailStoreOrderShipment.loading,
...
<<<<<<< HEAD
      owner: { type: '_retailStoreOrderShipment', id: state._retailStoreOrderShipment.id, listName: 'retailStoreOrderList', ref:state._retailStoreOrderShipment, listDisplayName: '生超的订单列表' }, // this is for model namespace and
=======
...
=======
  	const {RetailStoreOrderShipmentPermission} = GlobalComponents
  	const {RetailStoreOrderShipmentProfile} = GlobalComponents
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
...
=======
  	{path:"/retailStoreOrderShipment/:id/profile", component: RetailStoreOrderShipmentProfile},
  	{path:"/retailStoreOrderShipment/:id/permission", component: RetailStoreOrderShipmentPermission},
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
...
<<<<<<< HEAD
     ...
     //const {RetailStoreOrderShipmentEditDetail} = GlobalComponents
     //const {RetailStoreOrderShipmentViewDetail} = GlobalComponents
...
=======
 ...
 <Header>
        ...
        <Col {...naviBarResponsiveStyle} >
            <Dropdown overlay= {this.getNavMenuItems(this.props.retailStoreOrderShipment)}>
