...
=======
    ...
    const {searchLocalData}=GlobalComponents.RetailStoreOrderShipmentBase
...
=======
      {this.state.showSearch&&(
        ...
        <div style={{backgroundColor:'black'}}  onClick={()=>hideSearchResult()}  >{searchLocalData(this.props.retailStoreOrderShipment,this.state.searchKeyword)}</div>
