...
class RetailStoreOrderShipmentSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {RetailStoreOrderShipmentTable} = GlobalComponents;
    const {RetailStoreOrderShipmentSearchForm} = GlobalComponents;
    const {RetailStoreOrderShipmentModalTable} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <RetailStoreOrderShipmentSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,RetailStoreOrderShipmentModalTable,"retailStoreOrderShipmentIds")}
...
export default Form.create()(RetailStoreOrderShipmentSearch)
