...
class SupplyOrderApprovalSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {SupplyOrderApprovalTable} = GlobalComponents;
    const {SupplyOrderApprovalSearchForm} = GlobalComponents;
    const {SupplyOrderApprovalModalTable} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <SupplyOrderApprovalSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,SupplyOrderApprovalModalTable,"supplyOrderApprovalIds")}
...
export default Form.create()(SupplyOrderApprovalSearch)
