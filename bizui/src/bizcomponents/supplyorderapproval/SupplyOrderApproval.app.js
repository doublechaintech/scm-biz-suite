...
constructor(props) {
  ...
  handleOpenChange = (openKeys) => {
   ...
   render() {
    ...
    const {searchLocalData}=GlobalComponents.SupplyOrderApprovalBase
 ...
 <Header style={{ position: 'fixed', zIndex: 1, width: '100%' }}>
      ...
      {this.state.showSearch&&(
        ...
        <div style={{backgroundColor:'black'}}  onClick={()=>hideSearchResult()}  >{searchLocalData(this.props.supplyOrderApproval,this.state.searchKeyword)}</div>
