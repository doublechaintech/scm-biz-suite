...
const internalImageListOf = (supplyOrderApproval) =>{
<<<<<<< HEAD
...
const internalSettingListOf = (supplyOrderApproval) =>{
<<<<<<< HEAD
...
const handleTransferSearch =(targetComponent,filterKey,newRequest)=>{
  ...
  const pageNo = 1;
  const candidateReferenceService = SupplyOrderApprovalService[candidateServiceName] 
...
const executeTrans = (supplyOrderApproval,targetComponent) =>{
...
const buildTransferModal = (supplyOrderApproval,targetComponent) => {
...
<Modal title={transferModalTitle}
          ...
          onOk={()=>executeTrans(supplyOrderApproval,targetComponent)}
...
const internalRenderExtraHeader = (supplyOrderApproval) =>{
	return null
}
const internalRenderExtraFooter = (supplyOrderApproval) =>{
	return null
}
...
class SupplyOrderApprovalPreference extends Component {
...
}))(Form.create()(SupplyOrderApprovalPreference))
