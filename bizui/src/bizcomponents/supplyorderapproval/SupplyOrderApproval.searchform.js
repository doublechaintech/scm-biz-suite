...
import styles from './SupplyOrderApproval.search.less'
...
class SupplyOrderApprovalSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      supplyOrderApprovalList: 1,
      'supplyOrderApprovalList.searchField': fieldName,
      'supplyOrderApprovalList.searchVerb': 'startsWith',
      'supplyOrderApprovalList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`supplyOrderApprovalList.searchField`] = fieldName
    value[`supplyOrderApprovalList.searchVerb`] =  searchVerb
    value[`supplyOrderApprovalList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      params['supplyOrderApprovalList'] = 1
      params['supplyOrderApprovalList.orderBy.0'] = "id"
      params['supplyOrderApprovalList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        supplyOrderApprovalSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(SupplyOrderApprovalSearchForm)
