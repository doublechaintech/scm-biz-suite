...
import SectionCreateFormBody from './Section.createformbody'
...
class SectionCreateForm extends Component {
  state = {
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          ...
          payload: { id: owner.id, type: 'section', parameters, continueNext: true },
        })
      })
    }
