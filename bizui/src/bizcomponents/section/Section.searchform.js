...
import styles from './Section.search.less'
...
class SectionSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      sectionList: 1,
      'sectionList.searchField': fieldName,
      'sectionList.searchVerb': 'startsWith',
      'sectionList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      const {listName} = owner
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'contains', 'viewGroup'))
      ...
      dispatch({
        ...
        sectionSearchFormParameters: filterObjectKeys(fieldsValue),
    ...
    return (
      <Form onSubmit={this.handleSearch} layout="inline">
        <Row gutter={{ md: 8, lg: 24, xl: 48 }}>
          ...
          <Col md={8} sm={24}>
            <FormItem label={fieldLabels.viewGroup}>
 ...
 <Col md={8} sm={24}>
                  ...
                  <CandidateList 
                    ...
                    requestFunction={SectionService.queryCandidates} useForSearch />
...
export default Form.create()(SectionSearchForm)
