...
class SkillTypeCreateFormBody extends Component {
  state = {
  ...
  componentDidMount() {
    ...
    const formValue = SkillTypeBase.unpackObjectToFormValues(initValue)
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.description} {...formItemLayout}>
                  {getFieldDecorator('description', {
                    ...
                    <SmallTextInput minLength={1} maxLength={24} size="large"  placeholder={fieldLabels.description} />
                  )}
                </Form.Item>
              </Col>
              ...
              <Col lg={24} md={24} sm={24} style={{"display":"none"}}>
                <Form.Item label={fieldLabels.company} {...formItemLayout}>
                  ...
                  <CandidateList
                    ...
                    requestFunction={SkillTypeService.queryCandidates}  />
...
}))(Form.create()(SkillTypeCreateFormBody))
