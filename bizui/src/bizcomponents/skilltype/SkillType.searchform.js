...
import styles from './SkillType.search.less'
...
class SkillTypeSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      skillTypeList: 1,
      'skillTypeList.searchField': fieldName,
      'skillTypeList.searchVerb': 'startsWith',
      'skillTypeList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`skillTypeList.searchField`] = fieldName
    value[`skillTypeList.searchVerb`] =  searchVerb
    value[`skillTypeList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
      params['skillTypeList'] = 1
      params['skillTypeList.orderBy.0'] = "id"
      params['skillTypeList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        skillTypeSearchFormParameters: filterObjectKeys(fieldsValue),
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
                  ...
                  <SelectObject 
                    ...
                    targetType={"company"} 
<<<<<<< HEAD
                    requestFunction={SkillTypeService.requestCandidateCompany}/>
                  
=======
                    requestFunction={SkillTypeService.requestCandidateCompany} useForSearch />
...
export default Form.create()(SkillTypeSearchForm)
