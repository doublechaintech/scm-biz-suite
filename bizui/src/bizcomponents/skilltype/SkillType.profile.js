...
const internalSummaryOf = (item, targetComponents)=>{
	...
	return GlobalComponents.SkillTypeBase.renderItemOfList(item, targetComponents)

}



class SkillTypeProfile extends Component {
  ...
  render() {
    ...
    const  returnURL = `/skillType/${id}/dashboard`
