...
const internalSummaryOf = (item, targetComponents)=>{
	...
	return GlobalComponents.MemberRewardPointRedemptionBase.renderItemOfList(item, targetComponents)
...
class MemberRewardPointRedemptionProfile extends Component {
  ...
  render() {
    ...
    const  returnURL = `/memberRewardPointRedemption/${id}/dashboard`
