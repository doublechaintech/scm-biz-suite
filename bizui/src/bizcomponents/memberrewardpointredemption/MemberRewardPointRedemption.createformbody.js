...
class MemberRewardPointRedemptionCreateFormBody extends Component {
  state = {
  ...
  componentDidMount() {
    ...
    const formValue = MemberRewardPointRedemptionBase.unpackObjectToFormValues(initValue)
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.point} {...formItemLayout}>
                  {getFieldDecorator('point', {
                    ...
                    <SmallTextInput minLength={0} maxLength={20} size="large"  placeholder={fieldLabels.point} />
                  )}
                </Form.Item>
              </Col>
              ...
              <Col lg={24} md={24} sm={24} >
                <Form.Item label={fieldLabels.owner} {...formItemLayout}>
                  ...
                  <CandidateList
                    ...
                    requestFunction={MemberRewardPointRedemptionService.queryCandidates}  />
...
}))(Form.create()(MemberRewardPointRedemptionCreateFormBody))
