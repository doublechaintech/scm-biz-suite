...
const renderItemOfList=(memberRewardPointRedemption, targetComponent, columCount, listName)=>{
  ...
  const userContext = null
  return (
    <Card key={`${listName}-${memberRewardPointRedemption.id}`} style={{marginTop:"10px"}}>
