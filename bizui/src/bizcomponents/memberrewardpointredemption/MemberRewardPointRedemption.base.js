...
<<<<<<< HEAD
  ...
  { title: '点', debugtype: 'int', dataIndex: 'point', width: '6',render: (text, record)=>renderTextCell(text,record) },
...
const MemberRewardPointRedemptionBase={menuData,displayColumns,fieldLabels,displayColumns}
=======
