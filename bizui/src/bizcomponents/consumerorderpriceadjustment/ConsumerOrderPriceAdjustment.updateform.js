...
import styles from './ConsumerOrderPriceAdjustment.updateform.less'
...
class ConsumerOrderPriceAdjustmentUpdateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
        ...
        const consumerOrderPriceAdjustmentId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, consumerOrderPriceAdjustmentId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateConsumerOrderPriceAdjustment`,
          payload: {
            id: owner.id,
            type: 'consumerOrderPriceAdjustment',
            parameters,
            selectedRows,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextConsumerOrderPriceAdjustmentUpdateRow`,
        payload: {
          id: owner.id,
          type: 'consumerOrderPriceAdjustment',
          selectedRows,
...
<<<<<<< HEAD
    ...
    return (
      <PageHeaderLayout
        title={"更新消费品价格调整"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新消费品价格调整"
...
=======
	...
	const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"Update")}消费品价格调整: {(currentUpdateIndex+1)}/{selectedRows.length}</div>)
    }
              ...
              <Col lg={12} md={12} sm={24}>
                <Form.Item label={fieldLabels.provider} {...formItemLayout}>
                  {getFieldDecorator('provider', {
                    initialValue: selectedRow.provider,
...
}))(Form.create()(ConsumerOrderPriceAdjustmentUpdateForm))
