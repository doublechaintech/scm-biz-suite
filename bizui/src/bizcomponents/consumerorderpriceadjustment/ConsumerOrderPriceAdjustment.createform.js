...
class ConsumerOrderPriceAdjustmentCreateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, ...imagesValues }
        dispatch({
          type: `${owner.type}/addConsumerOrderPriceAdjustment`,
          payload: { id: owner.id, type: 'consumerOrderPriceAdjustment', parameters, continueNext: true },
        })
      })
    }
	...
	return (
      ...
      >
   		...
   		<ConsumerOrderPriceAdjustmentCreateFormBody	 {...this.props} handleImageChange={this.handleImageChange}/>
...
}))(Form.create()(ConsumerOrderPriceAdjustmentCreateForm))
