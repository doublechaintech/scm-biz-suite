...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{consumerOrderPriceAdjustmentList:selectedRows}} owner={owner}  
...
class ConsumerOrderPriceAdjustmentSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {ConsumerOrderPriceAdjustmentTable} = GlobalComponents;
    const {ConsumerOrderPriceAdjustmentSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <ConsumerOrderPriceAdjustmentSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,ConsumerOrderPriceAdjustmentModalTable,"consumerOrderPriceAdjustmentIds")}
...
export default Form.create()(ConsumerOrderPriceAdjustmentSearch)
