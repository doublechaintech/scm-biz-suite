...
import styles from './ConsumerOrderPriceAdjustment.search.less'
...
class ConsumerOrderPriceAdjustmentSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      consumerOrderPriceAdjustmentList: 1,
      'consumerOrderPriceAdjustmentList.searchField': fieldName,
      'consumerOrderPriceAdjustmentList.searchVerb': 'startsWith',
      'consumerOrderPriceAdjustmentList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`consumerOrderPriceAdjustmentList.searchField`] = fieldName
    value[`consumerOrderPriceAdjustmentList.searchVerb`] =  searchVerb
    value[`consumerOrderPriceAdjustmentList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'contains', 'provider'))
=======
      ...
      const {listName} = owner
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'contains', 'provider'))
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
...
<<<<<<< HEAD
      params['consumerOrderPriceAdjustmentList'] = 1
      params['consumerOrderPriceAdjustmentList.orderBy.0'] = "id"
      params['consumerOrderPriceAdjustmentList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        consumerOrderPriceAdjustmentSearchFormParameters: filterObjectKeys(fieldsValue),
...
=======
                    requestFunction={ConsumerOrderPriceAdjustmentService.requestCandidateBizOrder} useForSearch />
...
export default Form.create()(ConsumerOrderPriceAdjustmentSearchForm)
