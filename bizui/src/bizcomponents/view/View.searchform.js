...
import styles from './View.search.less'
...
class ViewSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      viewList: 1,
      'viewList.searchField': fieldName,
      'viewList.searchVerb': 'startsWith',
      'viewList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`viewList.searchField`] = fieldName
    value[`viewList.searchVerb`] =  searchVerb
    value[`viewList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'contains', 'assessment'))
=======
      ...
      const {listName} = owner
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'contains', 'assessment'))
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
...
<<<<<<< HEAD
      params['viewList'] = 1
      params['viewList.orderBy.0'] = "id"
      params['viewList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        viewSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(ViewSearchForm)
