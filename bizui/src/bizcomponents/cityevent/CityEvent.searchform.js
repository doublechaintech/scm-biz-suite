...
import styles from './CityEvent.search.less'
...
class CityEventSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      cityEventList: 1,
      'cityEventList.searchField': fieldName,
      'cityEventList.searchVerb': 'startsWith',
      'cityEventList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`cityEventList.searchField`] = fieldName
    value[`cityEventList.searchVerb`] =  searchVerb
    value[`cityEventList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
      params['cityEventList'] = 1
      params['cityEventList.orderBy.0'] = "id"
      params['cityEventList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        cityEventSearchFormParameters: filterObjectKeys(fieldsValue),
...
=======
                    requestFunction={CityEventService.requestCandidateCityServiceCenter} useForSearch />
...
export default Form.create()(CityEventSearchForm)
