...
class SupplyOrderPaymentGroupCreateFormBody extends Component {
  state = {
  ...
  componentDidMount() {
    ...
    const formValue = SupplyOrderPaymentGroupBase.unpackObjectToFormValues(initValue)
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.cardNumber} {...formItemLayout}>
                  {getFieldDecorator('cardNumber', {
                    ...
                    <SmallTextInput minLength={5} maxLength={68} size="large"  placeholder={fieldLabels.cardNumber} />
                  )}
                </Form.Item>
              </Col>
              ...
              <Col lg={24} md={24} sm={24} >
                <Form.Item label={fieldLabels.bizOrder} {...formItemLayout}>
                  ...
                  <CandidateList
                    ...
                    requestFunction={SupplyOrderPaymentGroupService.queryCandidates}  />
...
}))(Form.create()(SupplyOrderPaymentGroupCreateFormBody))
