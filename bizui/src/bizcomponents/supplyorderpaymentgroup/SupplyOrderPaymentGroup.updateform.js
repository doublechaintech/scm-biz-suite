...
import styles from './SupplyOrderPaymentGroup.updateform.less'
...
class SupplyOrderPaymentGroupUpdateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
        ...
        const supplyOrderPaymentGroupId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, supplyOrderPaymentGroupId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateSupplyOrderPaymentGroup`,
          payload: {
            id: owner.id,
            type: 'supplyOrderPaymentGroup',
            parameters,
            selectedRows,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextSupplyOrderPaymentGroupUpdateRow`,
        payload: {
          id: owner.id,
          type: 'supplyOrderPaymentGroup',
          selectedRows,
...
<<<<<<< HEAD
    ...
    return (
      <PageHeaderLayout
        title={"更新供应订单付款组"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新供应订单付款组"
...
=======
	...
	const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"Update")}供应订单付款组: {(currentUpdateIndex+1)}/{selectedRows.length}</div>)
    }
...
}))(Form.create()(SupplyOrderPaymentGroupUpdateForm))
