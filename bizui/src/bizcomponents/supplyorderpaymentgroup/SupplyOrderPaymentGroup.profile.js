...
const internalSummaryOf = (item, targetComponents)=>{
	...
	return GlobalComponents.SupplyOrderPaymentGroupBase.renderItemOfList(item, targetComponents)

}



class SupplyOrderPaymentGroupProfile extends Component {
...
}))(Form.create()(SupplyOrderPaymentGroupProfile))
