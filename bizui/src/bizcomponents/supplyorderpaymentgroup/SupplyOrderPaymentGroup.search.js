...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{supplyOrderPaymentGroupList:selectedRows}} owner={owner}  
...
class SupplyOrderPaymentGroupSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {SupplyOrderPaymentGroupTable} = GlobalComponents;
    const {SupplyOrderPaymentGroupSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <SupplyOrderPaymentGroupSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,SupplyOrderPaymentGroupModalTable,"supplyOrderPaymentGroupIds")}
...
export default Form.create()(SupplyOrderPaymentGroupSearch)
