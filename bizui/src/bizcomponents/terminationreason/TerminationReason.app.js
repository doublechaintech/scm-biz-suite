 ...
 getNavMenuItems = (targetObject, style, customTheme) => {
	  ...
	  <Menu
       ...
       >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/terminationReason/${this.props.terminationReason.id}/dashboard`}><Icon type="dashboard" style={{marginRight:"20px"}}/><span>{appLocaleName(userContext,"Dashboard")}</span></Link>
             </Menu.Item>
  ...
  getTerminationSearch = () => {
    ...
    return connect(state => ({
      ...
      returnURL: `/terminationReason/${state._terminationReason.id}/dashboard`,
  ...
  getTerminationCreateForm = () => {
    ...
    return connect(state => ({
      ...
      searchFormParameters: state._terminationReason.terminationSearchFormParameters,
      loading: state._terminationReason.loading,
      owner: { type: '_terminationReason', id: state._terminationReason.id, referenceName: 'reason', listName: 'terminationList', ref:state._terminationReason, listDisplayName: appLocaleName(userContext,"List")}, // this is for model namespace and
  ...
  getTerminationUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_terminationReason', id: state._terminationReason.id, listName: 'terminationList', ref:state._terminationReason, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
