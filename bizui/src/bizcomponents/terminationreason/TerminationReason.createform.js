...
import styles from './TerminationReason.createform.less'
...
=======
import TerminationReasonCreateFormBody from './TerminationReason.createformbody'
...
class TerminationReasonCreateForm extends Component {
  state = {
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          ...
          payload: { id: owner.id, type: 'terminationReason', parameters, continueNext: true },
        })
      })
    }
...
<<<<<<< HEAD
      dispatch({
        ...
        payload: { id: owner.id, type: 'terminationReason',listName:'雇佣终止的原因列表' },
=======
...
=======
    ...
    const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"CreateNew")}雇佣终止的原因</div>)
    }
	...
	return (
      ...
      >
   		...
   		<TerminationReasonCreateFormBody	 {...this.props} />
...
}))(Form.create()(TerminationReasonCreateForm))
