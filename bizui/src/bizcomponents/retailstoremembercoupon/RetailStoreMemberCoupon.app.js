...
<<<<<<< HEAD
    ...
    return (
		  ...
		  <Menu
           ...
           >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/retailStoreMemberCoupon/${this.props.retailStoreMemberCoupon.id}/dashboard`}><Icon type="dashboard" /><span>仪表板</span></Link>
             </Menu.Item>
       ...
       <Menu.Item key="preference">
               <Link to={`/retailStoreMemberCoupon/${this.props.retailStoreMemberCoupon.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
...
<<<<<<< HEAD
  	const {RetailStoreMemberCouponPreference} = GlobalComponents
=======
...
<<<<<<< HEAD
  	{path:"/retailStoreMemberCoupon/:id/preference", component: RetailStoreMemberCouponPreference},
=======
...
<<<<<<< HEAD
     ...
     //const {RetailStoreMemberCouponEditDetail} = GlobalComponents
     //const {RetailStoreMemberCouponViewDetail} = GlobalComponents
     ...
     <Layout>
       ...
       <Layout>
		 ...
		 {this.getNavMenuItems(this.props.retailStoreMemberCoupon)}
...
=======
 ...
 <Header>
        ...
        <Col {...naviBarResponsiveStyle} >
            <Dropdown overlay= {this.getNavMenuItems(this.props.retailStoreMemberCoupon)}>
