...
=======
import RetailStoreMemberCouponCreateFormBody from './RetailStoreMemberCoupon.createformbody'
...
class RetailStoreMemberCouponCreateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, ...imagesValues }
        dispatch({
          type: `${owner.type}/addRetailStoreMemberCoupon`,
          payload: { id: owner.id, type: 'retailStoreMemberCoupon', parameters, continueNext: true },
        })
      })
    }
...
<<<<<<< HEAD
      dispatch({
        ...
        payload: { id: owner.id, type: 'retailStoreMemberCoupon',listName:'生超会员优惠券列表' },
=======
     
      dispatch({
        type: `${owner.type}/goback`,
        payload: { id: owner.id, type: 'retailStoreMemberCoupon',listName:appLocaleName(userContext,"List") },
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      })
    }
...
=======
	...
	return (
      ...
      >
   		...
   		<RetailStoreMemberCouponCreateFormBody	 {...this.props} />
...
}))(Form.create()(RetailStoreMemberCouponCreateForm))
