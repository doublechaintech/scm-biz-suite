...
import styles from './RetailStoreMemberCoupon.updateform.less'
...
class RetailStoreMemberCouponUpdateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
        ...
        const retailStoreMemberCouponId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, retailStoreMemberCouponId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateRetailStoreMemberCoupon`,
          payload: {
            id: owner.id,
            type: 'retailStoreMemberCoupon',
            parameters,
            selectedRows,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextRetailStoreMemberCouponUpdateRow`,
        payload: {
          id: owner.id,
          type: 'retailStoreMemberCoupon',
          selectedRows,
...
<<<<<<< HEAD
    ...
    return (
      <PageHeaderLayout
        title={"更新生超会员优惠券"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新生超会员优惠券"
...
=======
	...
	const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"Update")}生超会员优惠券: {(currentUpdateIndex+1)}/{selectedRows.length}</div>)
    }
...
}))(Form.create()(RetailStoreMemberCouponUpdateForm))
