...
class GoodsPackagingSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      goodsPackagingList: 1,
      'goodsPackagingList.searchField': fieldName,
      'goodsPackagingList.searchVerb': 'startsWith',
      'goodsPackagingList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        goodsPackagingSearchFormParameters: filterObjectKeys(fieldsValue),
  ...
  renderSimpleForm() {
    ...
    return (
      <Form onSubmit={this.handleSearch} layout="inline">
       ...
       <Col md={8} sm={24}>
         <FormItem label={fieldLabels.packageName}>
...
export default Form.create()(GoodsPackagingSearchForm)
