...
class GoodsPackagingSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {GoodsPackagingTable} = GlobalComponents;
    const {GoodsPackagingSearchForm} = GlobalComponents;
    const {GoodsPackagingModalTable} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <GoodsPackagingSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,GoodsPackagingModalTable,"goodsPackagingIds")}
...
export default Form.create()(GoodsPackagingSearch)
