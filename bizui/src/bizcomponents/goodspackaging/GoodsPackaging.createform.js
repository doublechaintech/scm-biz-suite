...
=======
import GoodsPackagingCreateFormBody from './GoodsPackaging.createformbody'
...
const testValues = {
  ...
  rfid: 'RF99192',
<<<<<<< HEAD
  packageTime: '2018-12-24',
=======
  packageTime: '2016-10-06',
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
...
class GoodsPackagingCreateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, ...imagesValues }
        dispatch({
          type: `${owner.type}/addGoodsPackaging`,
          payload: { id: owner.id, type: 'goodsPackaging', parameters, continueNext: true },
        })
      })
    }
...
<<<<<<< HEAD
      dispatch({
        ...
        payload: { id: owner.id, type: 'goodsPackaging',listName:'货物包装列表' },
=======
     
      dispatch({
        type: `${owner.type}/goback`,
        payload: { id: owner.id, type: 'goodsPackaging',listName:appLocaleName(userContext,"List") },
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      })
    }
...
=======
	...
	return (
      ...
      >
   		...
   		<GoodsPackagingCreateFormBody	 {...this.props} />
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
...
}))(Form.create()(GoodsPackagingCreateForm))
