...
import styles from './GoodsPackaging.updateform.less'
...
class GoodsPackagingUpdateForm extends Component {
  state = {
  ...
  getSelectedRow() {
    ...
    const convertiedValues = selectedRows.map((item) => {
      return {
        ...item,
        packageTime: moment(item.packageTime),
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
        ...
        const goodsPackagingId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, goodsPackagingId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateGoodsPackaging`,
          payload: {
            id: owner.id,
            type: 'goodsPackaging',
            parameters,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextGoodsPackagingUpdateRow`,
        payload: {
          id: owner.id,
          type: 'goodsPackaging',
          selectedRows,
...
<<<<<<< HEAD
    ...
    return (
      <PageHeaderLayout
        title={"更新货物包装"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新货物包装"
...
=======
	...
	const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"Update")}货物包装: {(currentUpdateIndex+1)}/{selectedRows.length}</div>)
    }
              ...
              <Col lg={12} md={12} sm={24}>
                <Form.Item label={fieldLabels.packageName} {...formItemLayout}>
                  {getFieldDecorator('packageName', {
                    initialValue: selectedRow.packageName,
              ...
              <Col lg={12} md={12} sm={24}>
                <Form.Item label={fieldLabels.packageTime} {...formItemLayout}>
                  {getFieldDecorator('packageTime', {
                    initialValue: selectedRow.packageTime,
...
}))(Form.create()(GoodsPackagingUpdateForm))
