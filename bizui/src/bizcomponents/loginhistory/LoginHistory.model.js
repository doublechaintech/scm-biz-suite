...
export default {
  ...
  effects: {
    ...
    *analyze({ payload }, { call, put, select }){
      ...
      const data = yield call(LoginHistoryService.analyze, payload.id)
    ...
    *view({ payload }, { call, put, select }) { 
      ...
      const cachedData = yield select(state => state._loginHistory)
    ...
    *gotoCreateForm({ payload }, { put }) {
      ...
      yield put(routerRedux.push(`/loginHistory/${id}/list/${role}CreateForm`))
    },
    *gotoUpdateForm({ payload }, { put }) {
      const { id, role, selectedRows, currentUpdateIndex } = payload
      const state = { id, role, selectedRows, currentUpdateIndex }
      const location = { pathname: `/loginHistory/${id}/list/${role}UpdateForm`, state }
