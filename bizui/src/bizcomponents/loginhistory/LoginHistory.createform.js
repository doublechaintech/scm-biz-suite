...
import LoginHistoryCreateFormBody from './LoginHistory.createformbody'
  ...
  render() {
    ...
    const goback = () => {
      ...
      dispatch({
        ...
        payload: { id: owner.id, type: 'loginHistory',listName:appLocaleName(userContext,"List") },
      })
    }
...
<<<<<<< HEAD
      return (<div>{linkComp}{appLocaleName(userContext,"CreateNew")}登录历史</div>)
=======
...
=======
        content={`${appLocaleName(userContext,"CreateNew")}${window.trans('login_history')}`}
>>>>>>> ea67698ef1c4e94c89147baaf9f93aa768973fbe
        wrapperClassName={styles.advancedForm}
      >
   			
   		<LoginHistoryCreateFormBody	 {...this.props} />
