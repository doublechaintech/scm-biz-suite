...
class SupplyOrderShipmentSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {SupplyOrderShipmentTable} = GlobalComponents;
    const {SupplyOrderShipmentSearchForm} = GlobalComponents;
    const {SupplyOrderShipmentModalTable} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <SupplyOrderShipmentSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,SupplyOrderShipmentModalTable,"supplyOrderShipmentIds")}
...
export default Form.create()(SupplyOrderShipmentSearch)
