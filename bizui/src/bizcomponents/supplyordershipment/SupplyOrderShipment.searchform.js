...
import styles from './SupplyOrderShipment.search.less'
...
class SupplyOrderShipmentSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      supplyOrderShipmentList: 1,
      'supplyOrderShipmentList.searchField': fieldName,
      'supplyOrderShipmentList.searchVerb': 'startsWith',
      'supplyOrderShipmentList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`supplyOrderShipmentList.searchField`] = fieldName
    value[`supplyOrderShipmentList.searchVerb`] =  searchVerb
    value[`supplyOrderShipmentList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
      params['supplyOrderShipmentList'] = 1
      params['supplyOrderShipmentList.orderBy.0'] = "id"
      params['supplyOrderShipmentList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        supplyOrderShipmentSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(SupplyOrderShipmentSearchForm)
