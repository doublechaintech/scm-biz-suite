...
<<<<<<< HEAD
    ...
    return (
		  ...
		  <Menu
           ...
           >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/supplyOrderShipment/${this.props.supplyOrderShipment.id}/dashboard`}><Icon type="dashboard" /><span>仪表板</span></Link>
             </Menu.Item>
       ...
       <Menu.Item key="preference">
               <Link to={`/supplyOrderShipment/${this.props.supplyOrderShipment.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
...
<<<<<<< HEAD
      ...
      searchFormParameters: state._supplyOrderShipment.consumerOrderSearchFormParameters,
      loading: state._supplyOrderShipment.loading,
      owner: { type: '_supplyOrderShipment', id: state._supplyOrderShipment.id, referenceName: 'shipment', listName: 'consumerOrderList', ref:state._supplyOrderShipment, listDisplayName: '消费者订单列表'}, // this is for model namespace and
=======
...
<<<<<<< HEAD
      owner: { type: '_supplyOrderShipment', id: state._supplyOrderShipment.id, listName: 'consumerOrderList', ref:state._supplyOrderShipment, listDisplayName: '消费者订单列表' }, // this is for model namespace and
=======
...
<<<<<<< HEAD
      ...
      searchFormParameters: state._supplyOrderShipment.supplyOrderSearchFormParameters,
      loading: state._supplyOrderShipment.loading,
      owner: { type: '_supplyOrderShipment', id: state._supplyOrderShipment.id, referenceName: 'shipment', listName: 'supplyOrderList', ref:state._supplyOrderShipment, listDisplayName: '供应订单列表'}, // this is for model namespace and
=======
      returnURL: `/supplyOrderShipment/${state._supplyOrderShipment.id}/list`,
      currentPage: state._supplyOrderShipment.supplyOrderCurrentPageNumber,
      searchFormParameters: state._supplyOrderShipment.supplyOrderSearchFormParameters,
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
    ...
    return connect(state => ({
      ...
      currentUpdateIndex: state._supplyOrderShipment.currentUpdateIndex,
<<<<<<< HEAD
      owner: { type: '_supplyOrderShipment', id: state._supplyOrderShipment.id, listName: 'supplyOrderList', ref:state._supplyOrderShipment, listDisplayName: '供应订单列表' }, // this is for model namespace and
=======
...
<<<<<<< HEAD
  	const {SupplyOrderShipmentPreference} = GlobalComponents
=======
...
<<<<<<< HEAD
  	{path:"/supplyOrderShipment/:id/preference", component: SupplyOrderShipmentPreference},
=======
...
<<<<<<< HEAD
     ...
     //const {SupplyOrderShipmentEditDetail} = GlobalComponents
     //const {SupplyOrderShipmentViewDetail} = GlobalComponents
