...
<<<<<<< HEAD
    ...
    return (
		  ...
		  <Menu
           ...
           >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/truckDriver/${this.props.truckDriver.id}/dashboard`}><Icon type="dashboard" /><span>仪表板</span></Link>
             </Menu.Item>
       ...
       <Menu.Item key="preference">
               <Link to={`/truckDriver/${this.props.truckDriver.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
    ...
    return (
	  <Menu
       ...
       >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/truckDriver/${this.props.truckDriver.id}/dashboard`}><Icon type="dashboard" style={{marginRight:"20px"}}/><span>{appLocaleName(userContext,"Dashboard")}</span></Link>
             </Menu.Item>
...
<<<<<<< HEAD
      ...
      searchFormParameters: state._truckDriver.transportTaskSearchFormParameters,
      loading: state._truckDriver.loading,
      owner: { type: '_truckDriver', id: state._truckDriver.id, referenceName: 'driver', listName: 'transportTaskList', ref:state._truckDriver, listDisplayName: '运输任务列表'}, // this is for model namespace and
=======
...
<<<<<<< HEAD
      owner: { type: '_truckDriver', id: state._truckDriver.id, listName: 'transportTaskList', ref:state._truckDriver, listDisplayName: '运输任务列表' }, // this is for model namespace and
=======
...
<<<<<<< HEAD
  	const {TruckDriverPreference} = GlobalComponents
=======
...
<<<<<<< HEAD
  	{path:"/truckDriver/:id/preference", component: TruckDriverPreference},
=======
...
<<<<<<< HEAD
     ...
     //const {TruckDriverEditDetail} = GlobalComponents
     //const {TruckDriverViewDetail} = GlobalComponents
...
=======
 ...
 <Header>
        ...
        <Col {...naviBarResponsiveStyle} >
            <Dropdown overlay= {this.getNavMenuItems(this.props.truckDriver)}>
