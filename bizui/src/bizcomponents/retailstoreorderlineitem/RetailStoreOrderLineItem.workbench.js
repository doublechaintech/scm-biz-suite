...
import styles from './RetailStoreOrderLineItem.workbench.less'
...
const internalSummaryOf = (cardsData,targetComponent) =>{
	...
	const retailStoreOrderLineItem = cardsData.cardsSource
	const {RetailStoreOrderLineItemService} = GlobalComponents
	const userContext = null
	return (
	<div>
	<DescriptionList className={styles.headerList} size="small" col="4">
<Description term="ID" style={{wordBreak: 'break-all'}}>{retailStoreOrderLineItem.id}</Description> 
...
class RetailStoreOrderLineItemWorkbench extends Component {
...
}))(Form.create()(RetailStoreOrderLineItemWorkbench))
