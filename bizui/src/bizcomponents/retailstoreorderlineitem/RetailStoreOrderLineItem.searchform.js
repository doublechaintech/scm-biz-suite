...
class RetailStoreOrderLineItemSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      retailStoreOrderLineItemList: 1,
      'retailStoreOrderLineItemList.searchField': fieldName,
      'retailStoreOrderLineItemList.searchVerb': 'startsWith',
      'retailStoreOrderLineItemList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`retailStoreOrderLineItemList.searchField`] = fieldName
    value[`retailStoreOrderLineItemList.searchVerb`] =  searchVerb
    value[`retailStoreOrderLineItemList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
      params['retailStoreOrderLineItemList'] = 1
      params['retailStoreOrderLineItemList.orderBy.0'] = "id"
      params['retailStoreOrderLineItemList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        retailStoreOrderLineItemSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(RetailStoreOrderLineItemSearchForm)
