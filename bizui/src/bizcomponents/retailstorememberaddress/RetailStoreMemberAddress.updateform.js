...
import styles from './RetailStoreMemberAddress.updateform.less'
...
class RetailStoreMemberAddressUpdateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
        ...
        const retailStoreMemberAddressId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, retailStoreMemberAddressId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateRetailStoreMemberAddress`,
          payload: {
            id: owner.id,
            type: 'retailStoreMemberAddress',
            parameters,
            selectedRows,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextRetailStoreMemberAddressUpdateRow`,
        payload: {
          id: owner.id,
          type: 'retailStoreMemberAddress',
          selectedRows,
...
<<<<<<< HEAD
    ...
    return (
      <PageHeaderLayout
        title={"更新零售店会员地址"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新零售店会员地址"
...
=======
	...
	const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"Update")}零售店会员地址: {(currentUpdateIndex+1)}/{selectedRows.length}</div>)
    }
...
}))(Form.create()(RetailStoreMemberAddressUpdateForm))
