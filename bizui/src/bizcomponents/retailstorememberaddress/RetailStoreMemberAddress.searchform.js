...
componentDidMount() {
 ...
 <Col md={8} sm={24}>
                  ...
                  <CandidateList 
		                 ...
		                 ownerId={owner.id}
		                 scenarioCode={"search"}
		                 listType={"retail_store_member_address"} 
		                 targetType={"retail_store_member"} 
                 
                    requestFunction={RetailStoreMemberAddressService.queryCandidates} useForSearch />
          ...
          <Col md={8} sm={24}>
            <FormItem label={fieldLabels.mobilePhone}>
