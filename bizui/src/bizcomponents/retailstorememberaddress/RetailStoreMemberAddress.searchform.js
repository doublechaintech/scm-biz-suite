...
import styles from './RetailStoreMemberAddress.search.less'
...
class RetailStoreMemberAddressSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      retailStoreMemberAddressList: 1,
      'retailStoreMemberAddressList.searchField': fieldName,
      'retailStoreMemberAddressList.searchVerb': 'startsWith',
      'retailStoreMemberAddressList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`retailStoreMemberAddressList.searchField`] = fieldName
    value[`retailStoreMemberAddressList.searchVerb`] =  searchVerb
    value[`retailStoreMemberAddressList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'contains', 'mobilePhone'))
...
=======
      ...
      const {listName} = owner
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'contains', 'mobilePhone'))
...
<<<<<<< HEAD
      params['retailStoreMemberAddressList'] = 1
      params['retailStoreMemberAddressList.orderBy.0'] = "id"
      params['retailStoreMemberAddressList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        retailStoreMemberAddressSearchFormParameters: filterObjectKeys(fieldsValue),
...
=======
                    requestFunction={RetailStoreMemberAddressService.requestCandidateOwner} useForSearch />
...
export default Form.create()(RetailStoreMemberAddressSearchForm)
