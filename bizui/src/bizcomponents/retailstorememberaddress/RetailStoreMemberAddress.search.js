...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{retailStoreMemberAddressList:selectedRows}} owner={owner}  
...
class RetailStoreMemberAddressSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {RetailStoreMemberAddressTable} = GlobalComponents;
    const {RetailStoreMemberAddressSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <RetailStoreMemberAddressSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,RetailStoreMemberAddressModalTable,"retailStoreMemberAddressIds")}
...
export default Form.create()(RetailStoreMemberAddressSearch)
