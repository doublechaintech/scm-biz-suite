...
<<<<<<< HEAD
    ...
    return (
		  ...
		  <Menu
           ...
           >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/levelOneDepartment/${this.props.levelOneDepartment.id}/dashboard`}><Icon type="dashboard" /><span>仪表板</span></Link>
             </Menu.Item>
       ...
       <Menu.Item key="preference">
               <Link to={`/levelOneDepartment/${this.props.levelOneDepartment.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
    ...
    return (
	  <Menu
       ...
       >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/levelOneDepartment/${this.props.levelOneDepartment.id}/dashboard`}><Icon type="dashboard" style={{marginRight:"20px"}}/><span>{appLocaleName(userContext,"Dashboard")}</span></Link>
             </Menu.Item>
...
<<<<<<< HEAD
=======
      returnURL: `/levelOneDepartment/${state._levelOneDepartment.id}/dashboard`,
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
...
<<<<<<< HEAD
      listDisplayName: '二级部门列表' }, // this is for model namespace and
=======
...
<<<<<<< HEAD
      ...
      searchFormParameters: state._levelOneDepartment.levelTwoDepartmentSearchFormParameters,
      loading: state._levelOneDepartment.loading,
      owner: { type: '_levelOneDepartment', id: state._levelOneDepartment.id, referenceName: 'belongsTo', listName: 'levelTwoDepartmentList', ref:state._levelOneDepartment, listDisplayName: '二级部门列表'}, // this is for model namespace and
=======
...
<<<<<<< HEAD
      owner: { type: '_levelOneDepartment', id: state._levelOneDepartment.id, listName: 'levelTwoDepartmentList', ref:state._levelOneDepartment, listDisplayName: '二级部门列表' }, // this is for model namespace and
=======
...
<<<<<<< HEAD
  	const {LevelOneDepartmentPreference} = GlobalComponents
=======
...
<<<<<<< HEAD
  	{path:"/levelOneDepartment/:id/preference", component: LevelOneDepartmentPreference},
=======
...
<<<<<<< HEAD
     ...
     //const {LevelOneDepartmentEditDetail} = GlobalComponents
     //const {LevelOneDepartmentViewDetail} = GlobalComponents
...
=======
 ...
 <Header>
        ...
        <Col {...naviBarResponsiveStyle} >
            <Dropdown overlay= {this.getNavMenuItems(this.props.levelOneDepartment)}>
