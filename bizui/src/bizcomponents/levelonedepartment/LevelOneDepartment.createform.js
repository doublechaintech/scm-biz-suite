...
=======
import LevelOneDepartmentCreateFormBody from './LevelOneDepartment.createformbody'
...
class LevelOneDepartmentCreateForm extends Component {
  state = {
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          ...
          payload: { id: owner.id, type: 'levelOneDepartment', parameters, continueNext: true },
        })
      })
    }
...
<<<<<<< HEAD
      dispatch({
        ...
        payload: { id: owner.id, type: 'levelOneDepartment',listName:'一级部门列表' },
=======
...
=======
	...
	return (
      ...
      >
   		...
   		<LevelOneDepartmentCreateFormBody	 {...this.props} />
...
}))(Form.create()(LevelOneDepartmentCreateForm))
