...
class LevelOneDepartmentAssociateForm extends Component {
  state = {
 ...
 <Modal
	...
	<LevelTwoDepartmentModalTable data={data.levelTwoDepartmentList} owner={owner} />
...
}))(Form.create()(LevelOneDepartmentAssociateForm))
