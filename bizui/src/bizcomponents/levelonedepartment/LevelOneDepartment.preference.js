...
const internalImageListOf = (levelOneDepartment) =>{
<<<<<<< HEAD
...
const internalSettingListOf = (levelOneDepartment) =>{
<<<<<<< HEAD
...
const handleTransferSearch =(targetComponent,filterKey,newRequest)=>{
  ...
  const pageNo = 1;
  const candidateReferenceService = LevelOneDepartmentService[candidateServiceName] 
...
const executeTrans = (levelOneDepartment,targetComponent) =>{
...
const buildTransferModal = (levelOneDepartment,targetComponent) => {
...
<Modal title={transferModalTitle}
          ...
          onOk={()=>executeTrans(levelOneDepartment,targetComponent)}
...
const internalRenderExtraHeader = (levelOneDepartment) =>{
	return null
}
const internalRenderExtraFooter = (levelOneDepartment) =>{
	return null
}
...
class LevelOneDepartmentPreference extends Component {
...
}))(Form.create()(LevelOneDepartmentPreference))
