...
class AccountingDocumentAuditingSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {AccountingDocumentAuditingTable} = GlobalComponents;
    const {AccountingDocumentAuditingSearchForm} = GlobalComponents;
    const {AccountingDocumentAuditingModalTable} = GlobalComponents;
        ...
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <AccountingDocumentAuditingSearchForm {...this.props} />
            </div>
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
        ...
        {showDeletionDialog(this,AccountingDocumentAuditingModalTable,"accountingDocumentAuditingIds")}
...
export default Form.create()(AccountingDocumentAuditingSearch)
