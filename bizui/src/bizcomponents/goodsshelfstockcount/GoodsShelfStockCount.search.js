...
const showAssociateDialog = (targetComponent) => {
  ...
  const { GoodsShelfAssociateForm } = GlobalComponents
  ...
  <div>
	...
	visible={currentAssociateModal==='shelf'} 
	data={{goodsShelfStockCountList:selectedRows}} owner={owner}  
	onCancel={()=>toggleAssociateModalVisible(targetComponent,'shelf')} 
	onCreate={()=>toggleAssociateModalVisible(targetComponent,'shelf')}/> 
...
class GoodsShelfStockCountSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {GoodsShelfStockCountTable} = GlobalComponents;
    const {GoodsShelfStockCountSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        ...
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <GoodsShelfStockCountSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,GoodsShelfStockCountModalTable,"goodsShelfStockCountIds")}
...
export default Form.create()(GoodsShelfStockCountSearch)
