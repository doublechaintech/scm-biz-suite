...
class GoodsShelfStockCountCreateFormBody extends Component {
  ...
  componentDidMount() {
    ...
    const formValue = GoodsShelfStockCountBase.unpackObjectToFormValues(initValue)
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.summary} {...formItemLayout}>
                  {getFieldDecorator('summary', {
                    ...
                    <SmallTextInput minLength={5} maxLength={72} size="large"  placeholder={fieldLabels.summary} />
                  )}
                </Form.Item>
              </Col>
