...
class GoodsShelfStockCountCreateForm extends Component {
  ...
  render() {
	...
	return (
      <PageHeaderLayout
        title={`${appLocaleName(userContext,"CreateNew")}Goods Shelf Stock Count`}
        content={`${appLocaleName(userContext,"CreateNew")}Goods Shelf Stock Count`}
