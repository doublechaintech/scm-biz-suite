...
=======
import GoodsShelfStockCountCreateFormBody from './GoodsShelfStockCount.createformbody'
...
class GoodsShelfStockCountCreateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, ...imagesValues }
        dispatch({
          type: `${owner.type}/addGoodsShelfStockCount`,
          payload: { id: owner.id, type: 'goodsShelfStockCount', parameters, continueNext: true },
        })
      })
    }
...
<<<<<<< HEAD
      dispatch({
        ...
        payload: { id: owner.id, type: 'goodsShelfStockCount',listName:'货架库存盘点列表' },
=======
     
      dispatch({
        type: `${owner.type}/goback`,
        payload: { id: owner.id, type: 'goodsShelfStockCount',listName:appLocaleName(userContext,"List") },
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      })
    }
              ...
              <Col lg={12} md={12} sm={24}>
                <Form.Item label={fieldLabels.shelf} {...formItemLayout}>
                  {getFieldDecorator('shelfId', {
                    ...
                    rules: [{ required: true, message: '请输入架' }],
                  })(
...
}))(Form.create()(GoodsShelfStockCountCreateForm))
