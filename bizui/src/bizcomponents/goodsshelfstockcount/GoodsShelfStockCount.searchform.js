...
import styles from './GoodsShelfStockCount.search.less'
...
class GoodsShelfStockCountSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      goodsShelfStockCountList: 1,
      'goodsShelfStockCountList.searchField': fieldName,
      'goodsShelfStockCountList.searchVerb': 'startsWith',
      'goodsShelfStockCountList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`goodsShelfStockCountList.searchField`] = fieldName
    value[`goodsShelfStockCountList.searchVerb`] =  searchVerb
    value[`goodsShelfStockCountList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'contains', 'summary'))
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'eq', 'shelf'))
=======
      ...
      const {listName} = owner
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'contains', 'summary'))
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'eq', 'shelf'))
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
...
<<<<<<< HEAD
      params['goodsShelfStockCountList'] = 1
      params['goodsShelfStockCountList.orderBy.0'] = "id"
      params['goodsShelfStockCountList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        goodsShelfStockCountSearchFormParameters: filterObjectKeys(fieldsValue),
...
=======
                  {getFieldDecorator('shelf', {initialValue: tryinit('shelf')})(
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
...
=======
                    requestFunction={GoodsShelfStockCountService.requestCandidateShelf} useForSearch />
...
export default Form.create()(GoodsShelfStockCountSearchForm)
