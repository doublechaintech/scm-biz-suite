...
import styles from './GoodsShelfStockCount.workbench.less'
...
const internalSummaryOf = (cardsData,targetComponent) =>{
	...
	const goodsShelfStockCount = cardsData.cardsSource
	const {GoodsShelfStockCountService} = GlobalComponents
	const userContext = null
	return (
	<div>
	<DescriptionList className={styles.headerList} size="small" col="4">
<Description term="ID" style={{wordBreak: 'break-all'}}>{goodsShelfStockCount.id}</Description> 
...
class GoodsShelfStockCountWorkbench extends Component {
...
}))(Form.create()(GoodsShelfStockCountWorkbench))
