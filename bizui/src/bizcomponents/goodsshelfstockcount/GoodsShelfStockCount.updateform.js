...
import styles from './GoodsShelfStockCount.updateform.less'
...
class GoodsShelfStockCountUpdateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
        ...
        const goodsShelfStockCountId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, goodsShelfStockCountId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateGoodsShelfStockCount`,
          payload: {
            id: owner.id,
            type: 'goodsShelfStockCount',
            parameters,
            selectedRows,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextGoodsShelfStockCountUpdateRow`,
        payload: {
          id: owner.id,
          type: 'goodsShelfStockCount',
          selectedRows,
...
<<<<<<< HEAD
    ...
    return (
      <PageHeaderLayout
        title={"更新货架库存盘点"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新货架库存盘点"
...
=======
	...
	const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"Update")}货架库存盘点: {(currentUpdateIndex+1)}/{selectedRows.length}</div>)
    }
...
}))(Form.create()(GoodsShelfStockCountUpdateForm))
