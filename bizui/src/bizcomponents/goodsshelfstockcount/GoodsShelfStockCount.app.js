...
import styles from './GoodsShelfStockCount.app.less'
 ...
 getNavMenuItems = (targetObject, style, customTheme) => {
    ...
    return (
	  <Menu
       ...
       <Menu.Item key="workbench">
        <Link to={`/goodsShelfStockCount/${this.props.goodsShelfStockCount.id}/workbench`}><Icon type="solution" style={{marginRight:"20px"}}/><span>工作台</span></Link>
      </Menu.Item>
        ...
        {filteredMenuItemsGroup(targetObject,this).map((groupedMenuItem,index)=>{
          return(
    <SubMenu id={`submenu-vg${index}`}  key={`vg${index}`} title={<span><Icon type={viewGroupIconNameOf('goods_shelf_stock_count',`${groupedMenuItem.viewGroup}`)} style={{marginRight:"20px"}} /><span>{viewGroupDisplayNameOf('goods_shelf_stock_count',`${groupedMenuItem.viewGroup}`)}</span></span>} >
  ...
  getStockCountIssueTrackSearch = () => {
    ...
    return connect(state => ({
      rule: state.rule,
      name: window.mtrans('stock_count_issue_track','goods_shelf_stock_count.stock_count_issue_track_list',false),
      ...
      returnURL: `/goodsShelfStockCount/${state._goodsShelfStockCount.id}/workbench`,
      ...
      expandForm: state._goodsShelfStockCount.expandForm,
      loading: state._goodsShelfStockCount.loading,
      partialList: state._goodsShelfStockCount.partialList,
  ...
  getStockCountIssueTrackCreateForm = () => {
    ...
    return connect(state => ({
      ...
      searchFormParameters: state._goodsShelfStockCount.stockCountIssueTrackSearchFormParameters,
      loading: state._goodsShelfStockCount.loading,
      owner: { type: '_goodsShelfStockCount', id: state._goodsShelfStockCount.id || this.getOwnerId(), referenceName: 'stockCount', listName: 'stockCountIssueTrackList', ref:state._goodsShelfStockCount, listDisplayName: appLocaleName(userContext,"List")}, // this is for model namespace and
  ...
  getStockCountIssueTrackUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      role: "stockCountIssueTrack",
      currentUpdateIndex: state._goodsShelfStockCount.currentUpdateIndex || 0,
      owner: { type: '_goodsShelfStockCount', id: state._goodsShelfStockCount.id || this.getOwnerId(), listName: 'stockCountIssueTrackList', ref:state._goodsShelfStockCount, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
  ...
  getRequestTypeStepForm = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_goodsShelfStockCount', id: state._goodsShelfStockCount.id, listName: 'nolist', ref:state._goodsShelfStockCount, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
  ...
  buildRouters = () =>{
    const {GoodsShelfStockCountWorkbench} = GlobalComponents
    ...
    const routers=[
    {path:"/goodsShelfStockCount/:id/workbench", component: GoodsShelfStockCountWorkbench},
  	...
  	{path:"/goodsShelfStockCount/:id/list/stockCountIssueTrackList", component: this.getStockCountIssueTrackSearch()},
  	{path:"/goodsShelfStockCount/:id/list/stockCountIssueTrackCreateForm", component: this.getStockCountIssueTrackCreateForm()},
  	{path:"/goodsShelfStockCount/:id/list/stockCountIssueTrackUpdateForm", component: this.getStockCountIssueTrackUpdateForm()},
  ...
  handleOpenChange = (openKeys) => {
   ...
   render() {
    ...
    const {searchLocalData}=GlobalComponents.GoodsShelfStockCountBase
    ...
    const renderMenuSwitch=()=>{
     ...
     <Layout>
      ...
      {this.state.showSearch&&(
        ...
        <div style={{backgroundColor:'black'}}  onClick={()=>hideSearchResult()}  >{searchLocalData(this.props.goodsShelfStockCount,this.state.searchKeyword)}</div>
       ...
       <Sider
        ...
        >
         ...
         {this.getNavMenuItems(this.props.goodsShelfStockCount,"inline","dark")}
