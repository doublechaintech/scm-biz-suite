...
const internalImageListOf = (employeeInterview) =>{
...
const internalSettingListOf = (employeeInterview) =>{
	const userContext = null
	const optionList = [ 
	]
...
const handleTransferSearch =(targetComponent,filterKey,newRequest)=>{
  ...
  const pageNo = 1;
  const candidateReferenceService = EmployeeInterviewService[candidateServiceName] 
...
const executeTrans = (employeeInterview,targetComponent) =>{
...
const buildTransferModal = (employeeInterview,targetComponent) => {
...
<Modal title={transferModalTitle}
          ...
          onOk={()=>executeTrans(employeeInterview,targetComponent)}
...
const internalRenderExtraHeader = (employeeInterview) =>{
	return null
}
const internalRenderExtraFooter = (employeeInterview) =>{
	return null
}
...
<Description term="员工">{employeeInterview.employee==null?appLocaleName(userContext,"NotAssigned"):employeeInterview.employee.displayName}
 <Icon type="swap" onClick={()=>
  showTransferModel(targetComponent,"员工","employee","requestCandidateEmployee",
	      "transferToAnotherEmployee","anotherEmployeeId",employeeInterview.employee?employeeInterview.employee.id:"")} 
  style={{fontSize: 20,color:"red"}} />
</Description>
<Description term="面试类型">{employeeInterview.interviewType==null?appLocaleName(userContext,"NotAssigned"):employeeInterview.interviewType.displayName}
 <Icon type="swap" onClick={()=>
  showTransferModel(targetComponent,"面试类型","interviewType","requestCandidateInterviewType",
	      "transferToAnotherInterviewType","anotherInterviewTypeId",employeeInterview.interviewType?employeeInterview.interviewType.id:"")} 
  style={{fontSize: 20,color:"red"}} />
</Description>
...
class EmployeeInterviewPreference extends Component {
...
}))(Form.create()(EmployeeInterviewPreference))
