...
const internalSummaryOf = (item, targetComponents)=>{
	...
	return GlobalComponents.CandidateContainerBase.renderItemOfList(item, targetComponents)

}



class CandidateContainerProfile extends Component {
...
}))(Form.create()(CandidateContainerProfile))
