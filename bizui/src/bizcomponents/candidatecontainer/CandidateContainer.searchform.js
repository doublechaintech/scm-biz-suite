...
class CandidateContainerSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      candidateContainerList: 1,
      'candidateContainerList.searchField': fieldName,
      'candidateContainerList.searchVerb': 'startsWith',
      'candidateContainerList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        candidateContainerSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(CandidateContainerSearchForm)
