...
import styles from './CandidateContainer.search.less'
...
class CandidateContainerSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {CandidateContainerTable} = GlobalComponents;
    const {CandidateContainerSearchForm} = GlobalComponents;
    const {CandidateContainerModalTable} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        ...
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <CandidateContainerSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,CandidateContainerModalTable,"candidateContainerIds")}
...
export default Form.create()(CandidateContainerSearch)
