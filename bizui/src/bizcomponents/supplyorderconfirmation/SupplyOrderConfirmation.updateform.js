...
import styles from './SupplyOrderConfirmation.updateform.less'
...
class SupplyOrderConfirmationUpdateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
        ...
        const supplyOrderConfirmationId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, supplyOrderConfirmationId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateSupplyOrderConfirmation`,
          payload: {
            id: owner.id,
            type: 'supplyOrderConfirmation',
            parameters,
            selectedRows,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextSupplyOrderConfirmationUpdateRow`,
        payload: {
          id: owner.id,
          type: 'supplyOrderConfirmation',
          selectedRows,
...
<<<<<<< HEAD
    ...
    return (
      <PageHeaderLayout
        title={"更新供应订单确认"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新供应订单确认"
...
=======
	...
	const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"Update")}供应订单确认: {(currentUpdateIndex+1)}/{selectedRows.length}</div>)
    }
...
}))(Form.create()(SupplyOrderConfirmationUpdateForm))
