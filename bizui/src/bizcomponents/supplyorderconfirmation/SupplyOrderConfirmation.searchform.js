...
import styles from './SupplyOrderConfirmation.search.less'
...
class SupplyOrderConfirmationSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      supplyOrderConfirmationList: 1,
      'supplyOrderConfirmationList.searchField': fieldName,
      'supplyOrderConfirmationList.searchVerb': 'startsWith',
      'supplyOrderConfirmationList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`supplyOrderConfirmationList.searchField`] = fieldName
    value[`supplyOrderConfirmationList.searchVerb`] =  searchVerb
    value[`supplyOrderConfirmationList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      params['supplyOrderConfirmationList'] = 1
      params['supplyOrderConfirmationList.orderBy.0'] = "id"
      params['supplyOrderConfirmationList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        supplyOrderConfirmationSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(SupplyOrderConfirmationSearchForm)
