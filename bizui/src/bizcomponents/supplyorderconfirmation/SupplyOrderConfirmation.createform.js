...
=======
import SupplyOrderConfirmationCreateFormBody from './SupplyOrderConfirmation.createformbody'
...
const testValues = {
  who: '确认者',
<<<<<<< HEAD
  confirmTime: '2017-11-26',
=======
  confirmTime: '2019-03-31',
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
}
*/
...
class SupplyOrderConfirmationCreateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, ...imagesValues }
        dispatch({
          type: `${owner.type}/addSupplyOrderConfirmation`,
          payload: { id: owner.id, type: 'supplyOrderConfirmation', parameters, continueNext: true },
        })
      })
    }
...
<<<<<<< HEAD
      dispatch({
        ...
        payload: { id: owner.id, type: 'supplyOrderConfirmation',listName:'供应订单确认列表' },
=======
     
      dispatch({
        type: `${owner.type}/goback`,
        payload: { id: owner.id, type: 'supplyOrderConfirmation',listName:appLocaleName(userContext,"List") },
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      })
    }
...
=======
	...
	return (
      <PageHeaderLayout
        ...
        content={`${appLocaleName(userContext,"CreateNew")}供应订单确认`}
        wrapperClassName={styles.advancedForm}
      >
   			
   		<SupplyOrderConfirmationCreateFormBody	 {...this.props} />
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
...
}))(Form.create()(SupplyOrderConfirmationCreateForm))
