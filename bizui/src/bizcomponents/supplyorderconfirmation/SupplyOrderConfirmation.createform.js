...
class SupplyOrderConfirmationCreateForm extends Component {
  ...
  render() {
	...
	return (
      <PageHeaderLayout
        title={`${appLocaleName(userContext,"CreateNew")}Supply Order Confirmation`}
        content={`${appLocaleName(userContext,"CreateNew")}Supply Order Confirmation`}
