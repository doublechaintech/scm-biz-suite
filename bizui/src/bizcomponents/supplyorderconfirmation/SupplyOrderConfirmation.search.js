...
class SupplyOrderConfirmationSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {SupplyOrderConfirmationTable} = GlobalComponents;
    const {SupplyOrderConfirmationSearchForm} = GlobalComponents;
    const {SupplyOrderConfirmationModalTable} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <SupplyOrderConfirmationSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,SupplyOrderConfirmationModalTable,"supplyOrderConfirmationIds")}
...
export default Form.create()(SupplyOrderConfirmationSearch)
