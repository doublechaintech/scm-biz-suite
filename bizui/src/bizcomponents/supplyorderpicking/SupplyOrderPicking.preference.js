...
const internalImageListOf = (supplyOrderPicking) =>{
<<<<<<< HEAD
...
const internalSettingListOf = (supplyOrderPicking) =>{
<<<<<<< HEAD
...
const handleTransferSearch =(targetComponent,filterKey,newRequest)=>{
  ...
  const pageNo = 1;
  const candidateReferenceService = SupplyOrderPickingService[candidateServiceName] 
...
const executeTrans = (supplyOrderPicking,targetComponent) =>{
...
const buildTransferModal = (supplyOrderPicking,targetComponent) => {
...
<Modal title={transferModalTitle}
          ...
          onOk={()=>executeTrans(supplyOrderPicking,targetComponent)}
...
const internalRenderExtraHeader = (supplyOrderPicking) =>{
	return null
}
const internalRenderExtraFooter = (supplyOrderPicking) =>{
	return null
}
...
class SupplyOrderPickingPreference extends Component {
...
}))(Form.create()(SupplyOrderPickingPreference))
