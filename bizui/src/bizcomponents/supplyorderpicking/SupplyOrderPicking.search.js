...
class SupplyOrderPickingSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {SupplyOrderPickingTable} = GlobalComponents;
    const {SupplyOrderPickingSearchForm} = GlobalComponents;
    const {SupplyOrderPickingModalTable} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <SupplyOrderPickingSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,SupplyOrderPickingModalTable,"supplyOrderPickingIds")}
...
export default Form.create()(SupplyOrderPickingSearch)
