...
import styles from './SupplyOrderPicking.search.less'
...
class SupplyOrderPickingSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      supplyOrderPickingList: 1,
      'supplyOrderPickingList.searchField': fieldName,
      'supplyOrderPickingList.searchVerb': 'startsWith',
      'supplyOrderPickingList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`supplyOrderPickingList.searchField`] = fieldName
    value[`supplyOrderPickingList.searchVerb`] =  searchVerb
    value[`supplyOrderPickingList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      params['supplyOrderPickingList'] = 1
      params['supplyOrderPickingList.orderBy.0'] = "id"
      params['supplyOrderPickingList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        supplyOrderPickingSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(SupplyOrderPickingSearchForm)
