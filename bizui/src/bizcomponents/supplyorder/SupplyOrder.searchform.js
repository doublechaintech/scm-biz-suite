...
class SupplyOrderSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      supplyOrderList: 1,
      'supplyOrderList.searchField': fieldName,
      'supplyOrderList.searchVerb': 'startsWith',
      'supplyOrderList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        supplyOrderSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
               ...
               <CandidateList 
                 ...
                 requestFunction={SupplyOrderService.queryCandidates} useForSearch />
...
export default Form.create()(SupplyOrderSearchForm)
