...
import styles from './FormFieldMessage.search.less'
...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{formFieldMessageList:selectedRows}} owner={owner}  
...
class FormFieldMessageSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <FormFieldMessageSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,FormFieldMessageModalTable,"formFieldMessageIds")}
...
export default Form.create()(FormFieldMessageSearch)
