...
class FormFieldMessageSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      formFieldMessageList: 1,
      'formFieldMessageList.searchField': fieldName,
      'formFieldMessageList.searchVerb': 'startsWith',
      'formFieldMessageList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        formFieldMessageSearchFormParameters: filterObjectKeys(fieldsValue),
...
>>>>>>> ea67698ef1c4e94c89147baaf9f93aa768973fbe
                  ...
                  <SelectObject 
                    ...
                    targetType={"form"} 
                    requestFunction={FormFieldMessageService.requestCandidateForm} useForSearch />
...
export default Form.create()(FormFieldMessageSearchForm)
