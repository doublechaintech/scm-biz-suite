...
const internalSummaryOf = (item, targetComponents)=>{
	...
	return GlobalComponents.FormFieldMessageBase.renderItemOfList(item, targetComponents)

}



class FormFieldMessageProfile extends Component {
...
}))(Form.create()(FormFieldMessageProfile))
