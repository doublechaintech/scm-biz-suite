...
class FormFieldMessageCreateFormBody extends Component {
  state = {
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.form} {...formItemLayout}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"form"} 
                    requestFunction={FormFieldMessageService.requestCandidateForm}/>
...
}))(Form.create()(FormFieldMessageCreateFormBody))
