...
import styles from './RetailStoreOrderDelivery.updateform.less'
...
class RetailStoreOrderDeliveryUpdateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
        ...
        const retailStoreOrderDeliveryId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, retailStoreOrderDeliveryId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateRetailStoreOrderDelivery`,
          payload: {
            id: owner.id,
            type: 'retailStoreOrderDelivery',
            parameters,
            selectedRows,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextRetailStoreOrderDeliveryUpdateRow`,
        payload: {
          id: owner.id,
          type: 'retailStoreOrderDelivery',
          selectedRows,
...
<<<<<<< HEAD
    ...
    return (
      <PageHeaderLayout
        title={"更新生超订单交付"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新生超订单交付"
...
=======
	...
	const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"Update")}生超订单交付: {(currentUpdateIndex+1)}/{selectedRows.length}</div>)
    }
...
}))(Form.create()(RetailStoreOrderDeliveryUpdateForm))
