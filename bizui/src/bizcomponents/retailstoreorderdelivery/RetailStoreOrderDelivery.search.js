...
class RetailStoreOrderDeliverySearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {RetailStoreOrderDeliveryTable} = GlobalComponents;
    const {RetailStoreOrderDeliverySearchForm} = GlobalComponents;
    const {RetailStoreOrderDeliveryModalTable} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <RetailStoreOrderDeliverySearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,RetailStoreOrderDeliveryModalTable,"retailStoreOrderDeliveryIds")}
...
export default Form.create()(RetailStoreOrderDeliverySearch)
