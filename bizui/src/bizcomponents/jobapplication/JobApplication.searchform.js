...
import styles from './JobApplication.search.less'
...
class JobApplicationSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      jobApplicationList: 1,
      'jobApplicationList.searchField': fieldName,
      'jobApplicationList.searchVerb': 'startsWith',
      'jobApplicationList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`jobApplicationList.searchField`] = fieldName
    value[`jobApplicationList.searchVerb`] =  searchVerb
    value[`jobApplicationList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
      params['jobApplicationList'] = 1
      params['jobApplicationList.orderBy.0'] = "id"
      params['jobApplicationList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        jobApplicationSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(JobApplicationSearchForm)
