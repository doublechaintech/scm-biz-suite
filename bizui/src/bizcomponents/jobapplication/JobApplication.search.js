...
class JobApplicationSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {JobApplicationTable} = GlobalComponents;
    const {JobApplicationSearchForm} = GlobalComponents;
    const {JobApplicationModalTable} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <JobApplicationSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,JobApplicationModalTable,"jobApplicationIds")}
...
export default Form.create()(JobApplicationSearch)
