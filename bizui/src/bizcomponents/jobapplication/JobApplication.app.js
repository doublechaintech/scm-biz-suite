...
<<<<<<< HEAD
    ...
    return (
       ...
       <Menu.Item key="preference">
               <Link to={`/jobApplication/${this.props.jobApplication.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
    ...
    return (
	  <Menu
       ...
       >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/jobApplication/${this.props.jobApplication.id}/dashboard`}><Icon type="dashboard" style={{marginRight:"20px"}}/><span>{appLocaleName(userContext,"Dashboard")}</span></Link>
             </Menu.Item>
...
<<<<<<< HEAD
      ...
      searchFormParameters: state._jobApplication.employeeSearchFormParameters,
      loading: state._jobApplication.loading,
      owner: { type: '_jobApplication', id: state._jobApplication.id, referenceName: 'jobApplication', listName: 'employeeList', ref:state._jobApplication, listDisplayName: '员工列表'}, // this is for model namespace and
=======
      returnURL: `/jobApplication/${state._jobApplication.id}/list`,
      currentPage: state._jobApplication.employeeCurrentPageNumber,
      searchFormParameters: state._jobApplication.employeeSearchFormParameters,
      loading: state._jobApplication.loading,
...
<<<<<<< HEAD
  	const {JobApplicationPreference} = GlobalComponents
=======
...
<<<<<<< HEAD
  	{path:"/jobApplication/:id/preference", component: JobApplicationPreference},
=======
...
=======
 ...
 <Header>
        ...
        <Col {...naviBarResponsiveStyle} >
            <Dropdown overlay= {this.getNavMenuItems(this.props.jobApplication)}>
