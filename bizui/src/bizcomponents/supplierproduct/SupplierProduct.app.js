...
<<<<<<< HEAD
    ...
    return (
		  ...
		  <Menu
           ...
           >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/supplierProduct/${this.props.supplierProduct.id}/dashboard`}><Icon type="dashboard" /><span>仪表板</span></Link>
             </Menu.Item>
       ...
       <Menu.Item key="preference">
               <Link to={`/supplierProduct/${this.props.supplierProduct.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
    ...
    return (
	  <Menu
       ...
       >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/supplierProduct/${this.props.supplierProduct.id}/dashboard`}><Icon type="dashboard" style={{marginRight:"20px"}}/><span>{appLocaleName(userContext,"Dashboard")}</span></Link>
             </Menu.Item>
...
<<<<<<< HEAD
      listDisplayName: '产品供应时间列表' }, // this is for model namespace and
=======
...
<<<<<<< HEAD
      ...
      searchFormParameters: state._supplierProduct.productSupplyDurationSearchFormParameters,
      loading: state._supplierProduct.loading,
      owner: { type: '_supplierProduct', id: state._supplierProduct.id, referenceName: 'product', listName: 'productSupplyDurationList', ref:state._supplierProduct, listDisplayName: '产品供应时间列表'}, // this is for model namespace and
=======
...
<<<<<<< HEAD
      owner: { type: '_supplierProduct', id: state._supplierProduct.id, listName: 'productSupplyDurationList', ref:state._supplierProduct, listDisplayName: '产品供应时间列表' }, // this is for model namespace and
=======
...
<<<<<<< HEAD
     ...
     //const {SupplierProductEditDetail} = GlobalComponents
     //const {SupplierProductViewDetail} = GlobalComponents
...
=======
 ...
 <Header>
        ...
        <Col {...naviBarResponsiveStyle} >
            <Dropdown overlay= {this.getNavMenuItems(this.props.supplierProduct)}>
