...
import styles from './SupplierProduct.workbench.less'
...
const internalSummaryOf = (cardsData,targetComponent) =>{
	...
	const supplierProduct = cardsData.cardsSource
	const {SupplierProductService} = GlobalComponents
	const userContext = null
	return (
	<div>
	<DescriptionList className={styles.headerList} size="small" col="4">
<Description term="ID" style={{wordBreak: 'break-all'}}>{supplierProduct.id}</Description> 
...
class SupplierProductWorkbench extends Component {
...
}))(Form.create()(SupplierProductWorkbench))
