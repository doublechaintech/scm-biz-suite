...
const internalImageListOf = (supplierProduct) =>{
<<<<<<< HEAD
...
const internalSettingListOf = (supplierProduct) =>{
<<<<<<< HEAD
...
const handleTransferSearch =(targetComponent,filterKey,newRequest)=>{
  ...
  const pageNo = 1;
  const candidateReferenceService = SupplierProductService[candidateServiceName] 
...
const executeTrans = (supplierProduct,targetComponent) =>{
...
const buildTransferModal = (supplierProduct,targetComponent) => {
...
<Modal title={transferModalTitle}
          ...
          onOk={()=>executeTrans(supplierProduct,targetComponent)}
...
const internalRenderExtraHeader = (supplierProduct) =>{
	return null
}
const internalRenderExtraFooter = (supplierProduct) =>{
	return null
}
...
<<<<<<< HEAD
<Description term="供应商">{supplierProduct.supplier==null?"未分配":supplierProduct.supplier.displayName}
=======
<Description term="供应商">{supplierProduct.supplier==null?appLocaleName(userContext,"NotAssigned"):supplierProduct.supplier.displayName}
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
 <Icon type="swap" onClick={()=>
  showTransferModel(targetComponent,"供应商","goodsSupplier","requestCandidateSupplier",
	      "transferToAnotherSupplier","anotherSupplierId",supplierProduct.supplier?supplierProduct.supplier.id:"")} 
...
class SupplierProductPreference extends Component {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
  ...
  render() {
    ...
    const { id,displayName, productSupplyDurationCount } = this.props.supplierProduct
...
}))(Form.create()(SupplierProductPreference))
