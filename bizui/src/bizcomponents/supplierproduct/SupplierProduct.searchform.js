...
componentDidMount() {
  ...
  renderSimpleForm() {
    ...
    return (
      <Form onSubmit={this.handleSearch} layout="inline">
       ...
       <Col md={8} sm={24}>
         <FormItem label={fieldLabels.productName}>
    ...
    return (
      <Form onSubmit={this.handleSearch} layout="inline">
        <Row gutter={{ md: 8, lg: 24, xl: 48 }}>
          ...
          <Col md={8} sm={24}>
            <FormItem label={fieldLabels.productDescription}>
          ...
          <Col md={8} sm={24}>
            <FormItem label={fieldLabels.productUnit}>
 ...
 <Col md={8} sm={24}>
                    <Form.Item label={fieldLabels.supplier}>
                  ...
                  <CandidateList 
		                 ...
		                 ownerId={owner.id}
		                 scenarioCode={"search"}
		                 listType={"supplier_product"} 
		                 targetType={"goods_supplier"} 
                 
                    requestFunction={SupplierProductService.queryCandidates} useForSearch />
