...
import styles from './SupplierProduct.search.less'
...
class SupplierProductSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      supplierProductList: 1,
      'supplierProductList.searchField': fieldName,
      'supplierProductList.searchVerb': 'startsWith',
      'supplierProductList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`supplierProductList.searchField`] = fieldName
    value[`supplierProductList.searchVerb`] =  searchVerb
    value[`supplierProductList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'contains', 'productName'))
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'contains', 'productDescription'))
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'contains', 'productUnit'))
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'eq', 'supplier'))
=======
      const { owner } = this.props
      const {listName} = owner
     
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'contains', 'id'))
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'contains', 'productName'))
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'contains', 'productDescription'))
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'contains', 'productUnit'))
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'eq', 'supplier'))
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
...
<<<<<<< HEAD
      params['supplierProductList'] = 1
      params['supplierProductList.orderBy.0'] = "id"
      params['supplierProductList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        supplierProductSearchFormParameters: filterObjectKeys(fieldsValue),
...
=======
                  {getFieldDecorator('supplier', {initialValue: tryinit('supplier')})(
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
...
=======
                    requestFunction={SupplierProductService.requestCandidateSupplier} useForSearch />
...
export default Form.create()(SupplierProductSearchForm)
