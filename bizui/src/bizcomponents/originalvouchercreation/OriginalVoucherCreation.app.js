...
<<<<<<< HEAD
    ...
    return (
		  ...
		  <Menu
           ...
           >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/originalVoucherCreation/${this.props.originalVoucherCreation.id}/dashboard`}><Icon type="dashboard" /><span>仪表板</span></Link>
             </Menu.Item>
       ...
       <Menu.Item key="preference">
               <Link to={`/originalVoucherCreation/${this.props.originalVoucherCreation.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
    ...
    return (
	  <Menu
       ...
       >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/originalVoucherCreation/${this.props.originalVoucherCreation.id}/dashboard`}><Icon type="dashboard" style={{marginRight:"20px"}}/><span>{appLocaleName(userContext,"Dashboard")}</span></Link>
             </Menu.Item>
...
<<<<<<< HEAD
      ...
      searchFormParameters: state._originalVoucherCreation.originalVoucherSearchFormParameters,
      loading: state._originalVoucherCreation.loading,
      owner: { type: '_originalVoucherCreation', id: state._originalVoucherCreation.id, referenceName: 'creation', listName: 'originalVoucherList', ref:state._originalVoucherCreation, listDisplayName: '原始凭证列表'}, // this is for model namespace and
=======
      returnURL: `/originalVoucherCreation/${state._originalVoucherCreation.id}/list`,
      currentPage: state._originalVoucherCreation.originalVoucherCurrentPageNumber,
      searchFormParameters: state._originalVoucherCreation.originalVoucherSearchFormParameters,
      loading: state._originalVoucherCreation.loading,
...
<<<<<<< HEAD
      owner: { type: '_originalVoucherCreation', id: state._originalVoucherCreation.id, listName: 'originalVoucherList', ref:state._originalVoucherCreation, listDisplayName: '原始凭证列表' }, // this is for model namespace and
=======
...
<<<<<<< HEAD
  	const {OriginalVoucherCreationPreference} = GlobalComponents
=======
...
<<<<<<< HEAD
  	{path:"/originalVoucherCreation/:id/preference", component: OriginalVoucherCreationPreference},
=======
...
<<<<<<< HEAD
     ...
     //const {OriginalVoucherCreationEditDetail} = GlobalComponents
     //const {OriginalVoucherCreationViewDetail} = GlobalComponents
...
=======
 ...
 <Header>
        ...
        <Col {...naviBarResponsiveStyle} >
            <Dropdown overlay= {this.getNavMenuItems(this.props.originalVoucherCreation)}>
