  ...
  getNavMenuItems = (targetObject) => {
    ...
    return (
       ...
       <Menu.Item key="preference">
               <Link to={`/originalVoucherCreation/${this.props.originalVoucherCreation.id}/preference`}><Icon type="setting" /><span>{appLocaleName(userContext,"Preference")}</span></Link>
             </Menu.Item>
