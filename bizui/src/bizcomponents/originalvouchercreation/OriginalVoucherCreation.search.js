...
class OriginalVoucherCreationSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {OriginalVoucherCreationTable} = GlobalComponents;
    const {OriginalVoucherCreationSearchForm} = GlobalComponents;
    const {OriginalVoucherCreationModalTable} = GlobalComponents;
        ...
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <OriginalVoucherCreationSearchForm {...this.props} />
            </div>
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
        ...
        {showDeletionDialog(this,OriginalVoucherCreationModalTable,"originalVoucherCreationIds")}
...
export default Form.create()(OriginalVoucherCreationSearch)
