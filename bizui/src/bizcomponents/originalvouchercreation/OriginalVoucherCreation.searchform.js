...
import styles from './OriginalVoucherCreation.search.less'
...
class OriginalVoucherCreationSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      originalVoucherCreationList: 1,
      'originalVoucherCreationList.searchField': fieldName,
      'originalVoucherCreationList.searchVerb': 'startsWith',
      'originalVoucherCreationList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`originalVoucherCreationList.searchField`] = fieldName
    value[`originalVoucherCreationList.searchVerb`] =  searchVerb
    value[`originalVoucherCreationList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
      params['originalVoucherCreationList'] = 1
      params['originalVoucherCreationList.orderBy.0'] = "id"
      params['originalVoucherCreationList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        originalVoucherCreationSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(OriginalVoucherCreationSearchForm)
