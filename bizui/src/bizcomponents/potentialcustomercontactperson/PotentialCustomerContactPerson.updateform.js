...
import styles from './PotentialCustomerContactPerson.updateform.less'
...
class PotentialCustomerContactPersonUpdateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
        ...
        const potentialCustomerContactPersonId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, potentialCustomerContactPersonId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updatePotentialCustomerContactPerson`,
          payload: {
            id: owner.id,
            type: 'potentialCustomerContactPerson',
            parameters,
            selectedRows,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextPotentialCustomerContactPersonUpdateRow`,
        payload: {
          id: owner.id,
          type: 'potentialCustomerContactPerson',
          selectedRows,
...
<<<<<<< HEAD
    ...
    return (
      <PageHeaderLayout
        title={"更新潜在客户联络人"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新潜在客户联络人"
...
=======
	...
	const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"Update")}潜在客户联络人: {(currentUpdateIndex+1)}/{selectedRows.length}</div>)
    }
...
}))(Form.create()(PotentialCustomerContactPersonUpdateForm))
