...
import styles from './PotentialCustomerContactPerson.workbench.less'
...
const internalSummaryOf = (cardsData,targetComponent) =>{
	...
	const potentialCustomerContactPerson = cardsData.cardsSource
	const {PotentialCustomerContactPersonService} = GlobalComponents
	const userContext = null
	return (
	<div>
	<DescriptionList className={styles.headerList} size="small" col="4">
<Description term="ID" style={{wordBreak: 'break-all'}}>{potentialCustomerContactPerson.id}</Description> 
...
class PotentialCustomerContactPersonWorkbench extends Component {
...
}))(Form.create()(PotentialCustomerContactPersonWorkbench))
