...
const internalSummaryOf = (item, targetComponents)=>{
	...
	return GlobalComponents.PotentialCustomerContactPersonBase.renderItemOfList(item, targetComponents)
...
class PotentialCustomerContactPersonProfile extends Component {
  ...
  render() {
    ...
    const  returnURL = `/potentialCustomerContactPerson/${id}/dashboard`
