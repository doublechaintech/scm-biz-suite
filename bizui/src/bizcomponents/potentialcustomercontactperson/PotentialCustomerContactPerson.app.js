...
class PotentialCustomerContactPersonBizApp extends React.PureComponent {
  ...
  getNavMenuItems = (targetObject) => {
    ...
    return (
		  ...
		  <Menu
           ...
           >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/potentialCustomerContactPerson/${this.props.potentialCustomerContactPerson.id}/dashboard`}><Icon type="dashboard" /><span>仪表板</span></Link>
             </Menu.Item>
       ...
       <Menu.Item key="preference">
               <Link to={`/potentialCustomerContactPerson/${this.props.potentialCustomerContactPerson.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
  ...
  getPotentialCustomerContactCreateForm = () => {
    ...
    return connect(state => ({
      ...
      searchFormParameters: state._potentialCustomerContactPerson.potentialCustomerContactSearchFormParameters,
      loading: state._potentialCustomerContactPerson.loading,
      owner: { type: '_potentialCustomerContactPerson', id: state._potentialCustomerContactPerson.id, referenceName: 'contactTo', listName: 'potentialCustomerContactList', ref:state._potentialCustomerContactPerson, listDisplayName: '潜在客户联系列表'}, // this is for model namespace and
  ...
  getPotentialCustomerContactUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_potentialCustomerContactPerson', id: state._potentialCustomerContactPerson.id, listName: 'potentialCustomerContactList', ref:state._potentialCustomerContactPerson, listDisplayName: '潜在客户联系列表' }, // this is for model namespace and
  ...
  buildRouters = () =>{
  	...
  	const {PotentialCustomerContactPersonPreference} = GlobalComponents
  	
  	
  	const routers=[
  	{path:"/potentialCustomerContactPerson/:id/dashboard", component: PotentialCustomerContactPersonDashboard},
  	{path:"/potentialCustomerContactPerson/:id/preference", component: PotentialCustomerContactPersonPreference},
  ...
  handleOpenChange = (openKeys) => {
   ...
   render() {
     ...
     //const {PotentialCustomerContactPersonEditDetail} = GlobalComponents
     //const {PotentialCustomerContactPersonViewDetail} = GlobalComponents
     ...
     <Layout>
       ...
       <Layout>
		 ...
		 {this.getNavMenuItems(this.props.potentialCustomerContactPerson)}
