  ...
  getNavMenuItems = (targetObject) => {
    ...
    return (
       ...
       <Menu.Item key="preference">
               <Link to={`/potentialCustomerContactPerson/${this.props.potentialCustomerContactPerson.id}/preference`}><Icon type="setting" /><span>{appLocaleName(userContext,"Preference")}</span></Link>
             </Menu.Item>
