 ...
 getNavMenuItems = (targetObject, style, customTheme) => {
    ...
    return (
	  <Menu
       ...
       <Menu.Item key="workbench">
        <Link to={`/potentialCustomerContactPerson/${this.props.potentialCustomerContactPerson.id}/workbench`}><Icon type="solution" style={{marginRight:"20px"}}/><span>工作台</span></Link>
      </Menu.Item>
        ...
        {filteredMenuItemsGroup(targetObject,this).map((groupedMenuItem,index)=>{
          return(
    <SubMenu id={`submenu-vg${index}`}  key={`vg${index}`} title={<span><Icon type={viewGroupIconNameOf('potential_customer_contact_person',`${groupedMenuItem.viewGroup}`)} style={{marginRight:"20px"}} /><span>{viewGroupDisplayNameOf('potential_customer_contact_person',`${groupedMenuItem.viewGroup}`)}</span></span>} >
  ...
  getPotentialCustomerContactSearch = () => {
    ...
    return connect(state => ({
      rule: state.rule,
      name: window.mtrans('potential_customer_contact','potential_customer_contact_person.potential_customer_contact_list',false),
      ...
      returnURL: `/potentialCustomerContactPerson/${state._potentialCustomerContactPerson.id}/workbench`,
  ...
  getPotentialCustomerContactCreateForm = () => {
    ...
    return connect(state => ({
      ...
      searchFormParameters: state._potentialCustomerContactPerson.potentialCustomerContactSearchFormParameters,
      loading: state._potentialCustomerContactPerson.loading,
      owner: { type: '_potentialCustomerContactPerson', id: state._potentialCustomerContactPerson.id || this.getOwnerId(), referenceName: 'contactTo', listName: 'potentialCustomerContactList', ref:state._potentialCustomerContactPerson, listDisplayName: appLocaleName(userContext,"List")}, // this is for model namespace and
  ...
  getPotentialCustomerContactUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      role: "potentialCustomerContact",
      currentUpdateIndex: state._potentialCustomerContactPerson.currentUpdateIndex || 0,
      owner: { type: '_potentialCustomerContactPerson', id: state._potentialCustomerContactPerson.id || this.getOwnerId(), listName: 'potentialCustomerContactList', ref:state._potentialCustomerContactPerson, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
  ...
  getRequestTypeStepForm = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_potentialCustomerContactPerson', id: state._potentialCustomerContactPerson.id, listName: 'nolist', ref:state._potentialCustomerContactPerson, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
  ...
  buildRouters = () =>{
    const {PotentialCustomerContactPersonWorkbench} = GlobalComponents
    ...
    const routers=[
    {path:"/potentialCustomerContactPerson/:id/workbench", component: PotentialCustomerContactPersonWorkbench},
  ...
  handleOpenChange = (openKeys) => {
   ...
   render() {
    ...
    const {searchLocalData}=GlobalComponents.PotentialCustomerContactPersonBase
    ...
    const renderMenuSwitch=()=>{
     ...
     <Layout>
      ...
      {this.state.showSearch&&(
        ...
        <div style={{backgroundColor:'black'}}  onClick={()=>hideSearchResult()}  >{searchLocalData(this.props.potentialCustomerContactPerson,this.state.searchKeyword)}</div>
       ...
       <Sider
        ...
        >
         ...
         {this.getNavMenuItems(this.props.potentialCustomerContactPerson,"inline","dark")}
