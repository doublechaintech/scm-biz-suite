...
const internalImageListOf = (potentialCustomerContactPerson) =>{
<<<<<<< HEAD
...
const internalSettingListOf = (potentialCustomerContactPerson) =>{
<<<<<<< HEAD
...
const handleTransferSearch =(targetComponent,filterKey,newRequest)=>{
  ...
  const pageNo = 1;
  const candidateReferenceService = PotentialCustomerContactPersonService[candidateServiceName] 
...
const executeTrans = (potentialCustomerContactPerson,targetComponent) =>{
  ...
  validateFieldsAndScroll((error, values) => {
    ...
    const id=potentialCustomerContactPerson.id;
    const serviceNameToCall = transferServiceName;

    const payload = {parameters,id,serviceNameToCall}
    
    //targetComponent.setState({transferModalVisiable:false})
    dispatch({type:"_potentialCustomerContactPerson/doJob",payload: payload})
...
const buildTransferModal = (potentialCustomerContactPerson,targetComponent) => {
...
<Modal title={transferModalTitle}
          ...
          onOk={()=>executeTrans(potentialCustomerContactPerson,targetComponent)}
...
const internalRenderExtraHeader = (potentialCustomerContactPerson) =>{
	return null
}
const internalRenderExtraFooter = (potentialCustomerContactPerson) =>{
	return null
}
...
=======
<Description term="潜在的客户">{potentialCustomerContactPerson.potentialCustomer==null?appLocaleName(userContext,"NotAssigned"):potentialCustomerContactPerson.potentialCustomer.displayName}
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
 <Icon type="swap" onClick={()=>
  showTransferModel(targetComponent,"潜在的客户","potentialCustomer","requestCandidatePotentialCustomer",
	      "transferToAnotherPotentialCustomer","anotherPotentialCustomerId",potentialCustomerContactPerson.potentialCustomer?potentialCustomerContactPerson.potentialCustomer.id:"")} 
...
class PotentialCustomerContactPersonPreference extends Component {
...
}))(Form.create()(PotentialCustomerContactPersonPreference))
