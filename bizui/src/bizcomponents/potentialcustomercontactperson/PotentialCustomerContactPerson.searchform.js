...
import styles from './PotentialCustomerContactPerson.search.less'
...
class PotentialCustomerContactPersonSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      potentialCustomerContactPersonList: 1,
      'potentialCustomerContactPersonList.searchField': fieldName,
      'potentialCustomerContactPersonList.searchVerb': 'startsWith',
      'potentialCustomerContactPersonList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`potentialCustomerContactPersonList.searchField`] = fieldName
    value[`potentialCustomerContactPersonList.searchVerb`] =  searchVerb
    value[`potentialCustomerContactPersonList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
      params['potentialCustomerContactPersonList'] = 1
      params['potentialCustomerContactPersonList.orderBy.0'] = "id"
      params['potentialCustomerContactPersonList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        potentialCustomerContactPersonSearchFormParameters: filterObjectKeys(fieldsValue),
...
<<<<<<< HEAD
                    requestFunction={PotentialCustomerContactPersonService.requestCandidatePotentialCustomer}/>
                  
=======
                    requestFunction={PotentialCustomerContactPersonService.requestCandidatePotentialCustomer} useForSearch />
...
export default Form.create()(PotentialCustomerContactPersonSearchForm)
