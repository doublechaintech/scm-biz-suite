...
import styles from './RetailStoreFranchising.updateform.less'
...
class RetailStoreFranchisingUpdateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
        ...
        const retailStoreFranchisingId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, retailStoreFranchisingId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateRetailStoreFranchising`,
          payload: {
            id: owner.id,
            type: 'retailStoreFranchising',
            parameters,
            selectedRows,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextRetailStoreFranchisingUpdateRow`,
        payload: {
          id: owner.id,
          type: 'retailStoreFranchising',
          selectedRows,
...
<<<<<<< HEAD
    ...
    return (
      <PageHeaderLayout
        title={"更新生超的特许经营"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新生超的特许经营"
...
=======
	...
	const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"Update")}生超的特许经营: {(currentUpdateIndex+1)}/{selectedRows.length}</div>)
    }
...
}))(Form.create()(RetailStoreFranchisingUpdateForm))
