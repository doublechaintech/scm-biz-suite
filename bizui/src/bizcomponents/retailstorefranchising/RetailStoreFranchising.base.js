...
const renderItemOfList=(retailStoreFranchising, targetComponent, columCount, listName)=>{
  ...
  const userContext = null
  return (
    <Card key={`${listName}-${retailStoreFranchising.id}`} style={{marginTop:"10px"}}>
...
const RetailStoreFranchisingBase={menuData,settingMenuData,displayColumns,fieldLabels,renderItemOfList, stepOf, searchLocalData}
