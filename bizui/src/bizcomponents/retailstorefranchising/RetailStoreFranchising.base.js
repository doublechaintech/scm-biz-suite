...
const renderItemOfList=(retailStoreFranchising, targetComponent, columCount)=>{
  ...
  const userContext = null
  return (
    <Card key={`retailStoreFranchising-${retailStoreFranchising.id}`} style={{marginTop:"10px"}}>
