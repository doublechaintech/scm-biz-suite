...
import styles from './RetailStoreFranchising.search.less'
...
class RetailStoreFranchisingSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      retailStoreFranchisingList: 1,
      'retailStoreFranchisingList.searchField': fieldName,
      'retailStoreFranchisingList.searchVerb': 'startsWith',
      'retailStoreFranchisingList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`retailStoreFranchisingList.searchField`] = fieldName
    value[`retailStoreFranchisingList.searchVerb`] =  searchVerb
    value[`retailStoreFranchisingList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      params['retailStoreFranchisingList'] = 1
      params['retailStoreFranchisingList.orderBy.0'] = "id"
      params['retailStoreFranchisingList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        retailStoreFranchisingSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(RetailStoreFranchisingSearchForm)
