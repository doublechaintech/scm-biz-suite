...
const renderItemOfList=(responsibilityType, targetComponent, columCount, listName)=>{
  ...
  const userContext = null
  return (
    <Card key={`${listName}-${responsibilityType.id}`} style={{marginTop:"10px"}}>
...
const ResponsibilityTypeBase={menuData,settingMenuData,displayColumns,fieldLabels,renderItemOfList, stepOf, searchLocalData}
