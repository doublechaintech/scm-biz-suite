...
import styles from './ResponsibilityType.updateform.less'
...
class ResponsibilityTypeUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const responsibilityTypeId = values.id

        const parameters = { ...values, responsibilityTypeId, }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateResponsibilityType`,
          payload: {
            id: owner.id,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextResponsibilityTypeUpdateRow`,
        payload: {
          id: owner.id,
          type: 'responsibilityType',
          selectedRows,
	...
	const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"Update")}责任类型: {(currentUpdateIndex+1)}/{selectedRows.length}</div>)
    }
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.baseDescription} {...formItemLayout}>
                  {getFieldDecorator('baseDescription', {
                    ...
                    <SmallTextInput size="large"  placeholder={fieldLabels.baseDescription} />
...
}))(Form.create()(ResponsibilityTypeUpdateForm))
