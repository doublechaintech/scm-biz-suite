...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{responsibilityTypeList:selectedRows}} owner={owner}  
...
class ResponsibilityTypeSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {ResponsibilityTypeTable} = GlobalComponents;
    const {ResponsibilityTypeSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        ...
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <ResponsibilityTypeSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,ResponsibilityTypeModalTable,"responsibilityTypeIds")}
...
export default Form.create()(ResponsibilityTypeSearch)
