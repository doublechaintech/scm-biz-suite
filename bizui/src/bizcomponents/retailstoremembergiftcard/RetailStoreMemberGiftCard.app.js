 ...
 getNavMenuItems = (targetObject, style, customTheme) => {
    ...
    return (
	  <Menu
       ...
       <Menu.Item key="workbench">
        <Link to={`/retailStoreMemberGiftCard/${this.props.retailStoreMemberGiftCard.id}/workbench`}><Icon type="solution" style={{marginRight:"20px"}}/><span>工作台</span></Link>
      </Menu.Item>
        ...
        {filteredMenuItemsGroup(targetObject,this).map((groupedMenuItem,index)=>{
          return(
    <SubMenu id={`submenu-vg${index}`}  key={`vg${index}`} title={<span><Icon type={viewGroupIconNameOf('retail_store_member_gift_card',`${groupedMenuItem.viewGroup}`)} style={{marginRight:"20px"}} /><span>{viewGroupDisplayNameOf('retail_store_member_gift_card',`${groupedMenuItem.viewGroup}`)}</span></span>} >
  ...
  getRetailStoreMemberGiftCardConsumeRecordSearch = () => {
    ...
    return connect(state => ({
      rule: state.rule,
      name: window.mtrans('retail_store_member_gift_card_consume_record','retail_store_member_gift_card.retail_store_member_gift_card_consume_record_list',false),
      ...
      returnURL: `/retailStoreMemberGiftCard/${state._retailStoreMemberGiftCard.id}/workbench`,
  ...
  getRetailStoreMemberGiftCardConsumeRecordCreateForm = () => {
    ...
    return connect(state => ({
      ...
      searchFormParameters: state._retailStoreMemberGiftCard.retailStoreMemberGiftCardConsumeRecordSearchFormParameters,
      loading: state._retailStoreMemberGiftCard.loading,
      owner: { type: '_retailStoreMemberGiftCard', id: state._retailStoreMemberGiftCard.id || this.getOwnerId(), referenceName: 'owner', listName: 'retailStoreMemberGiftCardConsumeRecordList', ref:state._retailStoreMemberGiftCard, listDisplayName: appLocaleName(userContext,"List")}, // this is for model namespace and
  ...
  getRetailStoreMemberGiftCardConsumeRecordUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      role: "retailStoreMemberGiftCardConsumeRecord",
      currentUpdateIndex: state._retailStoreMemberGiftCard.currentUpdateIndex || 0,
      owner: { type: '_retailStoreMemberGiftCard', id: state._retailStoreMemberGiftCard.id || this.getOwnerId(), listName: 'retailStoreMemberGiftCardConsumeRecordList', ref:state._retailStoreMemberGiftCard, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
  ...
  getRequestTypeStepForm = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_retailStoreMemberGiftCard', id: state._retailStoreMemberGiftCard.id, listName: 'nolist', ref:state._retailStoreMemberGiftCard, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
  ...
  buildRouters = () =>{
    const {RetailStoreMemberGiftCardWorkbench} = GlobalComponents
    ...
    const routers=[
    {path:"/retailStoreMemberGiftCard/:id/workbench", component: RetailStoreMemberGiftCardWorkbench},
  ...
  handleOpenChange = (openKeys) => {
   ...
   render() {
    ...
    const {searchLocalData}=GlobalComponents.RetailStoreMemberGiftCardBase
    ...
    const renderMenuSwitch=()=>{
     ...
     <Layout>
      ...
      {this.state.showSearch&&(
        ...
        <div style={{backgroundColor:'black'}}  onClick={()=>hideSearchResult()}  >{searchLocalData(this.props.retailStoreMemberGiftCard,this.state.searchKeyword)}</div>
       ...
       <Sider
        ...
        >
         ...
         {this.getNavMenuItems(this.props.retailStoreMemberGiftCard,"inline","dark")}
