...
export default {
  ...
  effects: {
    ...
    *addRetailStoreMemberGiftCardConsumeRecord({ payload }, { call, put }) {
      ...
      const location = { pathname: `/retailStoreMemberGiftCard/${id}/list/RetailStoreMemberGiftCardConsumeRecordList/Retail Store Member Gift Card Consume Record+${appLocaleName(userContext,'List')}`, state: newState }
      yield put(routerRedux.push(location))
    },
    *updateRetailStoreMemberGiftCardConsumeRecord({ payload }, { call, put }) {
      ...
      const location = { pathname: `/retailStoreMemberGiftCard/${id}/list/RetailStoreMemberGiftCardConsumeRecordList/Retail Store Member Gift Card Consume Record列表`, state: newPlayload }
      yield put(routerRedux.push(location))
    },
