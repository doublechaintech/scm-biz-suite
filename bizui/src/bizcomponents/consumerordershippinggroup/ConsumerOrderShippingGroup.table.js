...
import styles from './ConsumerOrderShippingGroup.table.less'
...
class ConsumerOrderShippingGroupTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
    ...
    const operationColumn={
      ...
      render: (text, record) => (
        <span>
         ...
         { hasReadPermission(metaInfo)&&<Link to={`/consumerOrderShippingGroup/${record.id}/dashboard`}>{'查看'}</Link>}
...
export default ConsumerOrderShippingGroupTable
