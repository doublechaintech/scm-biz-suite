...
import styles from './ConsumerOrderShippingGroup.updateform.less'
...
class ConsumerOrderShippingGroupUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const consumerOrderShippingGroupId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, consumerOrderShippingGroupId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateConsumerOrderShippingGroup`,
          payload: {
            id: owner.id,
            type: 'consumerOrderShippingGroup',
            parameters,
            selectedRows,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextConsumerOrderShippingGroupUpdateRow`,
        payload: {
          id: owner.id,
          type: 'consumerOrderShippingGroup',
          selectedRows,
...
<<<<<<< HEAD
	...
	const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"Update")}消费订单送货分组: {(currentUpdateIndex+1)}/{selectedRows.length}</div>)
    }
...
}))(Form.create()(ConsumerOrderShippingGroupUpdateForm))
