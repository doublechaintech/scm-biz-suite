...
class SalaryGradeCreateFormBody extends Component {
  state = {
  ...
  componentDidMount() {
    ...
    const formValue = SalaryGradeBase.unpackObjectToFormValues(initValue)
              ...
              <Col lg={24} md={24} sm={24} style={{"display":"none"}}>
                <Form.Item label={fieldLabels.company} {...formItemLayout}>
                  ...
                  <CandidateList
                    ...
                    requestFunction={SalaryGradeService.queryCandidates}  />
...
}))(Form.create()(SalaryGradeCreateFormBody))
