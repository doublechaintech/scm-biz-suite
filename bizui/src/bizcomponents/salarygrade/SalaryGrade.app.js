 ...
 getNavMenuItems = (targetObject, style, customTheme) => {
    ...
    return (
	  <Menu
       ...
       <Menu.Item key="workbench">
        <Link to={`/salaryGrade/${this.props.salaryGrade.id}/workbench`}><Icon type="solution" style={{marginRight:"20px"}}/><span>工作台</span></Link>
      </Menu.Item>
        ...
        {filteredMenuItemsGroup(targetObject,this).map((groupedMenuItem,index)=>{
          return(
    <SubMenu id={`submenu-vg${index}`}  key={`vg${index}`} title={<span><Icon type={viewGroupIconNameOf('salary_grade',`${groupedMenuItem.viewGroup}`)} style={{marginRight:"20px"}} /><span>{viewGroupDisplayNameOf('salary_grade',`${groupedMenuItem.viewGroup}`)}</span></span>} >
  ...
  getEmployeeSearch = () => {
    ...
    return connect(state => ({
      rule: state.rule,
      name: window.mtrans('employee','salary_grade.employee_list',false),
      role: "employee",
      ...
      returnURL: `/salaryGrade/${state._salaryGrade.id}/workbench`,
      ...
      expandForm: state._salaryGrade.expandForm,
      loading: state._salaryGrade.loading,
      partialList: state._salaryGrade.partialList,
  ...
  getEmployeeCreateForm = () => {
    ...
    return connect(state => ({
      ...
      searchFormParameters: state._salaryGrade.employeeSearchFormParameters,
      loading: state._salaryGrade.loading,
      owner: { type: '_salaryGrade', id: state._salaryGrade.id || this.getOwnerId(), referenceName: 'currentSalaryGrade', listName: 'employeeList', ref:state._salaryGrade, listDisplayName: appLocaleName(userContext,"List")}, // this is for model namespace and
    }))(EmployeeCreateForm)
  }
  ...
  getEmployeeUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      role: "employee",
      currentUpdateIndex: state._salaryGrade.currentUpdateIndex || 0,
      owner: { type: '_salaryGrade', id: state._salaryGrade.id || this.getOwnerId(), listName: 'employeeList', ref:state._salaryGrade, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
    }))(EmployeeUpdateForm)
  }
  ...
  getEmployeeSalarySheetSearch = () => {
    ...
    return connect(state => ({
      rule: state.rule,
      name: window.mtrans('employee_salary_sheet','salary_grade.employee_salary_sheet_list',false),
  ...
  getEmployeeSalarySheetCreateForm = () => {
    ...
    return connect(state => ({
      ...
      searchFormParameters: state._salaryGrade.employeeSalarySheetSearchFormParameters,
      loading: state._salaryGrade.loading,
      owner: { type: '_salaryGrade', id: state._salaryGrade.id || this.getOwnerId(), referenceName: 'currentSalaryGrade', listName: 'employeeSalarySheetList', ref:state._salaryGrade, listDisplayName: appLocaleName(userContext,"List")}, // this is for model namespace and
  ...
  getEmployeeSalarySheetUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      role: "employeeSalarySheet",
      currentUpdateIndex: state._salaryGrade.currentUpdateIndex || 0,
      owner: { type: '_salaryGrade', id: state._salaryGrade.id || this.getOwnerId(), listName: 'employeeSalarySheetList', ref:state._salaryGrade, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
  ...
  getRequestTypeStepForm = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_salaryGrade', id: state._salaryGrade.id, listName: 'nolist', ref:state._salaryGrade, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
  ...
  buildRouters = () =>{
    const {SalaryGradeWorkbench} = GlobalComponents
    ...
    const routers=[
    {path:"/salaryGrade/:id/workbench", component: SalaryGradeWorkbench},
    {path:"/salaryGrade/:id/dashboard", component: SalaryGradeDashboard},
  	...
  	{path:"/salaryGrade/:id/list/employeeList", component: this.getEmployeeSearch()},
  	{path:"/salaryGrade/:id/list/employeeCreateForm", component: this.getEmployeeCreateForm()},
  	{path:"/salaryGrade/:id/list/employeeUpdateForm", component: this.getEmployeeUpdateForm()},
 
  	{path:"/salaryGrade/:id/list/employeeSalarySheetList", component: this.getEmployeeSalarySheetSearch()},
  	{path:"/salaryGrade/:id/list/employeeSalarySheetCreateForm", component: this.getEmployeeSalarySheetCreateForm()},
  	{path:"/salaryGrade/:id/list/employeeSalarySheetUpdateForm", component: this.getEmployeeSalarySheetUpdateForm()},
  ...
  handleOpenChange = (openKeys) => {
   ...
   render() {
    ...
    const {searchLocalData}=GlobalComponents.SalaryGradeBase
    ...
    const renderMenuSwitch=()=>{
     ...
     <Layout>
      ...
      {this.state.showSearch&&(
        ...
        <div style={{backgroundColor:'black'}}  onClick={()=>hideSearchResult()}  >{searchLocalData(this.props.salaryGrade,this.state.searchKeyword)}</div>
       ...
       <Sider
        ...
        >
         ...
         {this.getNavMenuItems(this.props.salaryGrade,"inline","dark")}
