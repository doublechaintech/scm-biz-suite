...
const internalImageListOf = (salaryGrade) =>{
...
const internalSettingListOf = (salaryGrade) =>{
	const userContext = null
	const optionList = [ 
	]
...
const handleTransferSearch =(targetComponent,filterKey,newRequest)=>{
  ...
  const pageNo = 1;
  const candidateReferenceService = SalaryGradeService[candidateServiceName] 
...
const executeTrans = (salaryGrade,targetComponent) =>{
...
const buildTransferModal = (salaryGrade,targetComponent) => {
...
<Modal title={transferModalTitle}
          ...
          onOk={()=>executeTrans(salaryGrade,targetComponent)}
...
const internalRenderExtraHeader = (salaryGrade) =>{
	return null
}
const internalRenderExtraFooter = (salaryGrade) =>{
	return null
}
...
class SalaryGradePreference extends Component {
...
}))(Form.create()(SalaryGradePreference))
