...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{salaryGradeList:selectedRows}} owner={owner}  
...
class SalaryGradeSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {SalaryGradeTable} = GlobalComponents;
    const {SalaryGradeSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <SalaryGradeSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,SalaryGradeModalTable,"salaryGradeIds")}
...
export default Form.create()(SalaryGradeSearch)
