...
import styles from './SalaryGrade.search.less'
...
class SalaryGradeSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      salaryGradeList: 1,
      'salaryGradeList.searchField': fieldName,
      'salaryGradeList.searchVerb': 'startsWith',
      'salaryGradeList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`salaryGradeList.searchField`] = fieldName
    value[`salaryGradeList.searchVerb`] =  searchVerb
    value[`salaryGradeList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
      params['salaryGradeList'] = 1
      params['salaryGradeList.orderBy.0'] = "id"
      params['salaryGradeList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        salaryGradeSearchFormParameters: filterObjectKeys(fieldsValue),
...
=======
                    requestFunction={SalaryGradeService.requestCandidateCompany} useForSearch />
...
export default Form.create()(SalaryGradeSearchForm)
