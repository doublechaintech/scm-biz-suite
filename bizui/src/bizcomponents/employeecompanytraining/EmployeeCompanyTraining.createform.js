...
=======
import EmployeeCompanyTrainingCreateFormBody from './EmployeeCompanyTraining.createformbody'
...
<<<<<<< HEAD
      dispatch({
        ...
        payload: { id: owner.id, type: 'employeeCompanyTraining',listName:'员工参与的公司培训列表' },
=======
     
      dispatch({
        type: `${owner.type}/goback`,
        payload: { id: owner.id, type: 'employeeCompanyTraining',listName:appLocaleName(userContext,"List") },
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      })
    }
...
=======
	...
	return (
      ...
      >
   		...
   		<EmployeeCompanyTrainingCreateFormBody	 {...this.props} />
