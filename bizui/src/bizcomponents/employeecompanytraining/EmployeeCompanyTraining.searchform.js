...
componentDidMount() {
  ...
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`employeeCompanyTrainingList.searchField`] = fieldName
    value[`employeeCompanyTrainingList.searchVerb`] =  searchVerb
    value[`employeeCompanyTrainingList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      const paramList = []
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'eq', 'training'))
      ...
      params['employeeCompanyTrainingList'] = 1
      params['employeeCompanyTrainingList.orderBy.0'] = "id"
      params['employeeCompanyTrainingList.descOrAsc.0'] = "desc"
