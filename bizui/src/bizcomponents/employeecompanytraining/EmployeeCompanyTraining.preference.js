...
const internalImageListOf = (employeeCompanyTraining) =>{
<<<<<<< HEAD
...
const internalSettingListOf = (employeeCompanyTraining) =>{
<<<<<<< HEAD
...
const handleTransferSearch =(targetComponent,filterKey,newRequest)=>{
  ...
  const pageNo = 1;
  const candidateReferenceService = EmployeeCompanyTrainingService[candidateServiceName] 
...
const executeTrans = (employeeCompanyTraining,targetComponent) =>{
  ...
  validateFieldsAndScroll((error, values) => {
    ...
    const id=employeeCompanyTraining.id;
    const serviceNameToCall = transferServiceName;

    const payload = {parameters,id,serviceNameToCall}
    
    //targetComponent.setState({transferModalVisiable:false})
    dispatch({type:"_employeeCompanyTraining/doJob",payload: payload})
...
const buildTransferModal = (employeeCompanyTraining,targetComponent) => {
...
<Modal title={transferModalTitle}
          ...
          onOk={()=>executeTrans(employeeCompanyTraining,targetComponent)}
...
const internalRenderExtraFooter = (employeeCompanyTraining) =>{
	return null
}
...
=======
	...
	<DescriptionList className={styles.headerList} size="small" col="4">
<Description term="序号">{employeeCompanyTraining.id}</Description> 
<Description term="员工">{employeeCompanyTraining.employee==null?appLocaleName(userContext,"NotAssigned"):employeeCompanyTraining.employee.displayName}
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
 <Icon type="swap" onClick={()=>
  showTransferModel(targetComponent,"员工","employee","requestCandidateEmployee",
	      "transferToAnotherEmployee","anotherEmployeeId",employeeCompanyTraining.employee?employeeCompanyTraining.employee.id:"")} 
  style={{fontSize: 20,color:"red"}} />
</Description>
<<<<<<< HEAD
<Description term="训练">{employeeCompanyTraining.training==null?"未分配":employeeCompanyTraining.training.displayName}
=======
<Description term="训练">{employeeCompanyTraining.training==null?appLocaleName(userContext,"NotAssigned"):employeeCompanyTraining.training.displayName}
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
 <Icon type="swap" onClick={()=>
  showTransferModel(targetComponent,"训练","companyTraining","requestCandidateTraining",
	      "transferToAnotherTraining","anotherTrainingId",employeeCompanyTraining.training?employeeCompanyTraining.training.id:"")} 
  style={{fontSize: 20,color:"red"}} />
</Description>
...
class EmployeeCompanyTrainingPreference extends Component {
...
}))(Form.create()(EmployeeCompanyTrainingPreference))
