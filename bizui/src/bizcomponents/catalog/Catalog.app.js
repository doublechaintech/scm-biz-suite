    ...
    return (
	  <Menu
       ...
       >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/catalog/${this.props.catalog.id}/dashboard`}><Icon type="dashboard" style={{marginRight:"20px"}}/><span>{appLocaleName(userContext,"Dashboard")}</span></Link>
             </Menu.Item>
...
<<<<<<< HEAD
      listDisplayName: '一级分类列表' }, // this is for model namespace and
=======
...
<<<<<<< HEAD
      ...
      searchFormParameters: state._catalog.levelOneCategorySearchFormParameters,
      loading: state._catalog.loading,
      owner: { type: '_catalog', id: state._catalog.id, referenceName: 'catalog', listName: 'levelOneCategoryList', ref:state._catalog, listDisplayName: '一级分类列表'}, // this is for model namespace and
=======
...
<<<<<<< HEAD
      owner: { type: '_catalog', id: state._catalog.id, listName: 'levelOneCategoryList', ref:state._catalog, listDisplayName: '一级分类列表' }, // this is for model namespace and
=======
...
=======
 ...
 <Header>
        ...
        <Col {...naviBarResponsiveStyle} >
            <Dropdown overlay= {this.getNavMenuItems(this.props.catalog)}>
