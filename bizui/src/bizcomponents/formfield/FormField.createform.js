...
import FormFieldCreateFormBody from './FormField.createformbody'
  ...
  render() {
    ...
    const goback = () => {
      ...
      dispatch({
        ...
        payload: { id: owner.id, type: 'formField',listName:appLocaleName(userContext,"List") },
      })
    }
...
<<<<<<< HEAD
        content={`${appLocaleName(userContext,"CreateNew")}表单字段`}
=======
        content={`${appLocaleName(userContext,"CreateNew")}${window.trans('form_field')}`}
>>>>>>> ea67698ef1c4e94c89147baaf9f93aa768973fbe
        wrapperClassName={styles.advancedForm}
      >
   			
   		<FormFieldCreateFormBody	 {...this.props} />
