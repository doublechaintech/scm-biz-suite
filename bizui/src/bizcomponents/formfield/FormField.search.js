...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{formFieldList:selectedRows}} owner={owner}  
...
class FormFieldSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {FormFieldTable} = GlobalComponents;
    const {FormFieldSearchForm} = GlobalComponents;
    const {FormFieldModalTable} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <FormFieldSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,FormFieldModalTable,"formFieldIds")}
...
export default Form.create()(FormFieldSearch)
