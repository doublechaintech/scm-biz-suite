 ...
 getNavMenuItems = (targetObject, style, customTheme) => {
    ...
    return (
	  <Menu
       ...
       <Menu.Item key="workbench">
        <Link to={`/potentialCustomer/${this.props.potentialCustomer.id}/workbench`}><Icon type="solution" style={{marginRight:"20px"}}/><span>工作台</span></Link>
      </Menu.Item>
        ...
        {filteredMenuItemsGroup(targetObject,this).map((groupedMenuItem,index)=>{
          return(
    <SubMenu id={`submenu-vg${index}`}  key={`vg${index}`} title={<span><Icon type={viewGroupIconNameOf('potential_customer',`${groupedMenuItem.viewGroup}`)} style={{marginRight:"20px"}} /><span>{viewGroupDisplayNameOf('potential_customer',`${groupedMenuItem.viewGroup}`)}</span></span>} >
  ...
  getPotentialCustomerContactPersonSearch = () => {
    ...
    return connect(state => ({
      rule: state.rule,
      name: window.mtrans('potential_customer_contact_person','potential_customer.potential_customer_contact_person_list',false),
      ...
      returnURL: `/potentialCustomer/${state._potentialCustomer.id}/workbench`,
  ...
  getPotentialCustomerContactPersonCreateForm = () => {
    ...
    return connect(state => ({
      ...
      searchFormParameters: state._potentialCustomer.potentialCustomerContactPersonSearchFormParameters,
      loading: state._potentialCustomer.loading,
      owner: { type: '_potentialCustomer', id: state._potentialCustomer.id || this.getOwnerId(), referenceName: 'potentialCustomer', listName: 'potentialCustomerContactPersonList', ref:state._potentialCustomer, listDisplayName: appLocaleName(userContext,"List")}, // this is for model namespace and
  ...
  getPotentialCustomerContactPersonUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      role: "potentialCustomerContactPerson",
      currentUpdateIndex: state._potentialCustomer.currentUpdateIndex || 0,
      owner: { type: '_potentialCustomer', id: state._potentialCustomer.id || this.getOwnerId(), listName: 'potentialCustomerContactPersonList', ref:state._potentialCustomer, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
  ...
  getPotentialCustomerContactSearch = () => {
    ...
    return connect(state => ({
      rule: state.rule,
      name: window.mtrans('potential_customer_contact','potential_customer.potential_customer_contact_list',false),
  ...
  getPotentialCustomerContactCreateForm = () => {
    ...
    return connect(state => ({
      ...
      searchFormParameters: state._potentialCustomer.potentialCustomerContactSearchFormParameters,
      loading: state._potentialCustomer.loading,
      owner: { type: '_potentialCustomer', id: state._potentialCustomer.id || this.getOwnerId(), referenceName: 'potentialCustomer', listName: 'potentialCustomerContactList', ref:state._potentialCustomer, listDisplayName: appLocaleName(userContext,"List")}, // this is for model namespace and
  ...
  getPotentialCustomerContactUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      role: "potentialCustomerContact",
      currentUpdateIndex: state._potentialCustomer.currentUpdateIndex || 0,
      owner: { type: '_potentialCustomer', id: state._potentialCustomer.id || this.getOwnerId(), listName: 'potentialCustomerContactList', ref:state._potentialCustomer, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
  ...
  getEventAttendanceSearch = () => {
    ...
    return connect(state => ({
      rule: state.rule,
      name: window.mtrans('event_attendance','potential_customer.event_attendance_list',false),
  ...
  getEventAttendanceCreateForm = () => {
    ...
    return connect(state => ({
      ...
      searchFormParameters: state._potentialCustomer.eventAttendanceSearchFormParameters,
      loading: state._potentialCustomer.loading,
      owner: { type: '_potentialCustomer', id: state._potentialCustomer.id || this.getOwnerId(), referenceName: 'potentialCustomer', listName: 'eventAttendanceList', ref:state._potentialCustomer, listDisplayName: appLocaleName(userContext,"List")}, // this is for model namespace and
  ...
  getEventAttendanceUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      role: "eventAttendance",
      currentUpdateIndex: state._potentialCustomer.currentUpdateIndex || 0,
      owner: { type: '_potentialCustomer', id: state._potentialCustomer.id || this.getOwnerId(), listName: 'eventAttendanceList', ref:state._potentialCustomer, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
  ...
  getRequestTypeStepForm = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_potentialCustomer', id: state._potentialCustomer.id, listName: 'nolist', ref:state._potentialCustomer, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
  ...
  buildRouters = () =>{
    const {PotentialCustomerWorkbench} = GlobalComponents
    ...
    const routers=[
    {path:"/potentialCustomer/:id/workbench", component: PotentialCustomerWorkbench},
      ...
      {this.state.showSearch&&(
       ...
       <Sider
        ...
        >
         ...
         {this.getNavMenuItems(this.props.potentialCustomer,"inline","dark")}
