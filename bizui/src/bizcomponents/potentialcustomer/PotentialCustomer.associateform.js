...
class PotentialCustomerAssociateForm extends Component {
  state = {
 ...
 <Modal
	...
	<PotentialCustomerContactPersonModalTable data={data.potentialCustomerContactPersonList} owner={owner} />
	<PotentialCustomerContactModalTable data={data.potentialCustomerContactList} owner={owner} />
	<EventAttendanceModalTable data={data.eventAttendanceList} owner={owner} />
...
}))(Form.create()(PotentialCustomerAssociateForm))
