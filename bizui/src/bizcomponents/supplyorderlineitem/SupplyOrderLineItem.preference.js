...
const internalImageListOf = (supplyOrderLineItem) =>{
<<<<<<< HEAD
...
const internalSettingListOf = (supplyOrderLineItem) =>{
<<<<<<< HEAD
...
const handleTransferSearch =(targetComponent,filterKey,newRequest)=>{
  ...
  const pageNo = 1;
  const candidateReferenceService = SupplyOrderLineItemService[candidateServiceName] 
...
const executeTrans = (supplyOrderLineItem,targetComponent) =>{
...
const buildTransferModal = (supplyOrderLineItem,targetComponent) => {
...
<Modal title={transferModalTitle}
          ...
          onOk={()=>executeTrans(supplyOrderLineItem,targetComponent)}
...
const internalRenderExtraHeader = (supplyOrderLineItem) =>{
	return null
}
const internalRenderExtraFooter = (supplyOrderLineItem) =>{
	return null
}
...
=======
	...
	<DescriptionList className={styles.headerList} size="small" col="4">
<Description term="序号">{supplyOrderLineItem.id}</Description> 
<Description term="订单">{supplyOrderLineItem.bizOrder==null?appLocaleName(userContext,"NotAssigned"):supplyOrderLineItem.bizOrder.displayName}
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
 <Icon type="swap" onClick={()=>
  showTransferModel(targetComponent,"订单","supplyOrder","requestCandidateBizOrder",
	      "transferToAnotherBizOrder","anotherBizOrderId",supplyOrderLineItem.bizOrder?supplyOrderLineItem.bizOrder.id:"")} 
...
class SupplyOrderLineItemPreference extends Component {
...
}))(Form.create()(SupplyOrderLineItemPreference))
