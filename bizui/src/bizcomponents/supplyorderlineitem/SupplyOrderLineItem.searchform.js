...
import styles from './SupplyOrderLineItem.search.less'
...
class SupplyOrderLineItemSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      supplyOrderLineItemList: 1,
      'supplyOrderLineItemList.searchField': fieldName,
      'supplyOrderLineItemList.searchVerb': 'startsWith',
      'supplyOrderLineItemList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`supplyOrderLineItemList.searchField`] = fieldName
    value[`supplyOrderLineItemList.searchVerb`] =  searchVerb
    value[`supplyOrderLineItemList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'contains', 'skuId'))
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'contains', 'skuName'))
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'contains', 'unitOfMeasurement'))
=======
      ...
      const {listName} = owner
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'contains', 'skuId'))
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'contains', 'skuName'))
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'contains', 'unitOfMeasurement'))
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
...
<<<<<<< HEAD
      params['supplyOrderLineItemList'] = 1
      params['supplyOrderLineItemList.orderBy.0'] = "id"
      params['supplyOrderLineItemList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        supplyOrderLineItemSearchFormParameters: filterObjectKeys(fieldsValue),
...
=======
                 requestFunction={SupplyOrderLineItemService.requestCandidateBizOrder} useForSearch />
...
export default Form.create()(SupplyOrderLineItemSearchForm)
