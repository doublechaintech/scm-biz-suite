...
=======
import SupplyOrderLineItemCreateFormBody from './SupplyOrderLineItem.createformbody'
...
class SupplyOrderLineItemCreateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, ...imagesValues }
        dispatch({
          type: `${owner.type}/addSupplyOrderLineItem`,
          payload: { id: owner.id, type: 'supplyOrderLineItem', parameters, continueNext: true },
        })
      })
    }
...
<<<<<<< HEAD
      dispatch({
        ...
        payload: { id: owner.id, type: 'supplyOrderLineItem',listName:'供应订单行项目列表' },
=======
     
      dispatch({
        type: `${owner.type}/goback`,
        payload: { id: owner.id, type: 'supplyOrderLineItem',listName:appLocaleName(userContext,"List") },
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      })
    }
...
}))(Form.create()(SupplyOrderLineItemCreateForm))
