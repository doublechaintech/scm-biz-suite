...
import styles from './AccountingDocumentType.search.less'
...
class AccountingDocumentTypeSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      accountingDocumentTypeList: 1,
      'accountingDocumentTypeList.searchField': fieldName,
      'accountingDocumentTypeList.searchVerb': 'startsWith',
      'accountingDocumentTypeList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`accountingDocumentTypeList.searchField`] = fieldName
    value[`accountingDocumentTypeList.searchVerb`] =  searchVerb
    value[`accountingDocumentTypeList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'eq', 'accountingPeriod'))
=======
...
<<<<<<< HEAD
      params['accountingDocumentTypeList'] = 1
      params['accountingDocumentTypeList.orderBy.0'] = "id"
      params['accountingDocumentTypeList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        accountingDocumentTypeSearchFormParameters: filterObjectKeys(fieldsValue),
...
=======
                    requestFunction={AccountingDocumentTypeService.requestCandidateAccountingPeriod} useForSearch />
...
export default Form.create()(AccountingDocumentTypeSearchForm)
