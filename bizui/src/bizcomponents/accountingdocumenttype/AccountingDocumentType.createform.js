...
=======
import AccountingDocumentTypeCreateFormBody from './AccountingDocumentType.createformbody'
...
class AccountingDocumentTypeCreateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, ...imagesValues }
        dispatch({
          type: `${owner.type}/addAccountingDocumentType`,
          payload: { id: owner.id, type: 'accountingDocumentType', parameters, continueNext: true },
        })
      })
    }
...
<<<<<<< HEAD
      dispatch({
        ...
        payload: { id: owner.id, type: 'accountingDocumentType',listName:'会计凭证类型列表' },
=======
     
      dispatch({
        type: `${owner.type}/goback`,
        payload: { id: owner.id, type: 'accountingDocumentType',listName:appLocaleName(userContext,"List") },
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      })
    }
...
=======
	...
	return (
      ...
      >
   		...
   		<AccountingDocumentTypeCreateFormBody	 {...this.props} />
...
}))(Form.create()(AccountingDocumentTypeCreateForm))
