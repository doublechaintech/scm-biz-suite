...
import styles from './AccountingDocumentType.workbench.less'
...
const internalSummaryOf = (cardsData,targetComponent) =>{
	...
	const accountingDocumentType = cardsData.cardsSource
	const {AccountingDocumentTypeService} = GlobalComponents
	const userContext = null
	return (
	<div>
	<DescriptionList className={styles.headerList} size="small" col="4">
<Description term="ID" style={{wordBreak: 'break-all'}}>{accountingDocumentType.id}</Description> 
...
class AccountingDocumentTypeWorkbench extends Component {
...
}))(Form.create()(AccountingDocumentTypeWorkbench))
