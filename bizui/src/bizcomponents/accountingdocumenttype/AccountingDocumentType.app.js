...
<<<<<<< HEAD
    ...
    return (
		  ...
		  <Menu
           ...
           >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/accountingDocumentType/${this.props.accountingDocumentType.id}/dashboard`}><Icon type="dashboard" /><span>仪表板</span></Link>
             </Menu.Item>
       ...
       <Menu.Item key="preference">
               <Link to={`/accountingDocumentType/${this.props.accountingDocumentType.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
...
<<<<<<< HEAD
      ...
      searchFormParameters: state._accountingDocumentType.accountingDocumentSearchFormParameters,
      loading: state._accountingDocumentType.loading,
      owner: { type: '_accountingDocumentType', id: state._accountingDocumentType.id, referenceName: 'documentType', listName: 'accountingDocumentList', ref:state._accountingDocumentType, listDisplayName: '会计凭证列表'}, // this is for model namespace and
=======
...
<<<<<<< HEAD
      owner: { type: '_accountingDocumentType', id: state._accountingDocumentType.id, listName: 'accountingDocumentList', ref:state._accountingDocumentType, listDisplayName: '会计凭证列表' }, // this is for model namespace and
=======
...
<<<<<<< HEAD
  	const {AccountingDocumentTypePreference} = GlobalComponents
=======
...
<<<<<<< HEAD
  	{path:"/accountingDocumentType/:id/preference", component: AccountingDocumentTypePreference},
=======
...
<<<<<<< HEAD
     ...
     //const {AccountingDocumentTypeEditDetail} = GlobalComponents
     //const {AccountingDocumentTypeViewDetail} = GlobalComponents
     ...
     <Layout>
       ...
       <Layout>
		 ...
		 {this.getNavMenuItems(this.props.accountingDocumentType)}
