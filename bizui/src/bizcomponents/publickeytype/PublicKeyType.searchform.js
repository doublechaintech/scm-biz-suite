...
import styles from './PublicKeyType.search.less'
...
class PublicKeyTypeSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      publicKeyTypeList: 1,
      'publicKeyTypeList.searchField': fieldName,
      'publicKeyTypeList.searchVerb': 'startsWith',
      'publicKeyTypeList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        publicKeyTypeSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                  ...
                  <CandidateList 
                    ...
                    requestFunction={PublicKeyTypeService.queryCandidates} useForSearch />
...
export default Form.create()(PublicKeyTypeSearchForm)
