 ...
 getNavMenuItems = (targetObject, style, customTheme) => {
	  ...
	  <Menu
       ...
       >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/payingOff/${this.props.payingOff.id}/dashboard`}><Icon type="dashboard" style={{marginRight:"20px"}}/><span>{appLocaleName(userContext,"Dashboard")}</span></Link>
             </Menu.Item>
  ...
  getEmployeeSalarySheetCreateForm = () => {
    ...
    return connect(state => ({
      ...
      searchFormParameters: state._payingOff.employeeSalarySheetSearchFormParameters,
      loading: state._payingOff.loading,
      owner: { type: '_payingOff', id: state._payingOff.id, referenceName: 'payingOff', listName: 'employeeSalarySheetList', ref:state._payingOff, listDisplayName: appLocaleName(userContext,"List")}, // this is for model namespace and
  ...
  getEmployeeSalarySheetUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_payingOff', id: state._payingOff.id, listName: 'employeeSalarySheetList', ref:state._payingOff, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
  ...
  buildRouters = () =>{
  	...
  	const routers=[
  	{path:"/payingOff/:id/dashboard", component: PayingOffDashboard},
