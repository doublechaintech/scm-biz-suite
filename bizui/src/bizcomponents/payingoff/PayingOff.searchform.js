...
componentDidMount() {
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      const {listName} = owner
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'eq', 'paidFor'))
 ...
 <Col md={8} sm={24}>
                  ...
                  {getFieldDecorator('paidFor', {initialValue: tryinit('paidFor')})(
                  ...
                  <CandidateList 
                    ...
                    requestFunction={PayingOffService.queryCandidates} useForSearch />
