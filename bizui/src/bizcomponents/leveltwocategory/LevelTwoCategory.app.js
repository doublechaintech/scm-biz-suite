 ...
 getNavMenuItems = (targetObject, style, customTheme) => {
	  ...
	  <Menu
       ...
       >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/levelTwoCategory/${this.props.levelTwoCategory.id}/dashboard`}><Icon type="dashboard" style={{marginRight:"20px"}}/><span>{appLocaleName(userContext,"Dashboard")}</span></Link>
             </Menu.Item>
  ...
  getLevelThreeCategorySearch = () => {
    ...
    return connect(state => ({
      ...
      returnURL: `/levelTwoCategory/${state._levelTwoCategory.id}/dashboard`,
