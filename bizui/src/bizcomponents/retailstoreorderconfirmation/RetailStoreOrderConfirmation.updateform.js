...
import styles from './RetailStoreOrderConfirmation.updateform.less'
...
class RetailStoreOrderConfirmationUpdateForm extends Component {
  state = {
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
        ...
        const retailStoreOrderConfirmationId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, retailStoreOrderConfirmationId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateRetailStoreOrderConfirmation`,
          payload: {
            id: owner.id,
            type: 'retailStoreOrderConfirmation',
            parameters,
            selectedRows,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextRetailStoreOrderConfirmationUpdateRow`,
        payload: {
          id: owner.id,
          type: 'retailStoreOrderConfirmation',
          selectedRows,
...
<<<<<<< HEAD
    ...
    return (
      <PageHeaderLayout
        title={"更新生超订单确认"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新生超订单确认"
...
=======
	...
	const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"Update")}生超订单确认: {(currentUpdateIndex+1)}/{selectedRows.length}</div>)
    }
...
}))(Form.create()(RetailStoreOrderConfirmationUpdateForm))
