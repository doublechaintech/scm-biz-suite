...
class RetailStoreOrderConfirmationSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {RetailStoreOrderConfirmationTable} = GlobalComponents;
    const {RetailStoreOrderConfirmationSearchForm} = GlobalComponents;
    const {RetailStoreOrderConfirmationModalTable} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={`${displayName}:${this.props.name}${appLocaleName(userContext,"List")}`}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <RetailStoreOrderConfirmationSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,RetailStoreOrderConfirmationModalTable,"retailStoreOrderConfirmationIds")}
...
export default Form.create()(RetailStoreOrderConfirmationSearch)
