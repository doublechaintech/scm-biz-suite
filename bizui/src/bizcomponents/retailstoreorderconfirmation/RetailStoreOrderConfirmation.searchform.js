...
import styles from './RetailStoreOrderConfirmation.search.less'
...
class RetailStoreOrderConfirmationSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      retailStoreOrderConfirmationList: 1,
      'retailStoreOrderConfirmationList.searchField': fieldName,
      'retailStoreOrderConfirmationList.searchVerb': 'startsWith',
      'retailStoreOrderConfirmationList.searchValue': fieldValue,
    }
  }
  */
<<<<<<< HEAD
...
<<<<<<< HEAD
    value[`retailStoreOrderConfirmationList.searchField`] = fieldName
    value[`retailStoreOrderConfirmationList.searchVerb`] =  searchVerb
    value[`retailStoreOrderConfirmationList.searchValue`] = fieldValue
=======
...
<<<<<<< HEAD
      params['retailStoreOrderConfirmationList'] = 1
      params['retailStoreOrderConfirmationList.orderBy.0'] = "id"
      params['retailStoreOrderConfirmationList.descOrAsc.0'] = "desc"
...
>>>>>>> 502e8b8dfc403300a992b5083e79c722e85d1854
      ...
      dispatch({
        ...
        retailStoreOrderConfirmationSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(RetailStoreOrderConfirmationSearchForm)
