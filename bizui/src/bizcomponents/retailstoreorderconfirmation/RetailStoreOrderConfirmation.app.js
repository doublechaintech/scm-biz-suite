...
<<<<<<< HEAD
    ...
    return (
		  ...
		  <Menu
           ...
           >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/retailStoreOrderConfirmation/${this.props.retailStoreOrderConfirmation.id}/dashboard`}><Icon type="dashboard" /><span>仪表板</span></Link>
             </Menu.Item>
       ...
       <Menu.Item key="preference">
               <Link to={`/retailStoreOrderConfirmation/${this.props.retailStoreOrderConfirmation.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
...
<<<<<<< HEAD
      ...
      searchFormParameters: state._retailStoreOrderConfirmation.retailStoreOrderSearchFormParameters,
      loading: state._retailStoreOrderConfirmation.loading,
      owner: { type: '_retailStoreOrderConfirmation', id: state._retailStoreOrderConfirmation.id, referenceName: 'confirmation', listName: 'retailStoreOrderList', ref:state._retailStoreOrderConfirmation, listDisplayName: '生超的订单列表'}, // this is for model namespace and
=======
...
<<<<<<< HEAD
      owner: { type: '_retailStoreOrderConfirmation', id: state._retailStoreOrderConfirmation.id, listName: 'retailStoreOrderList', ref:state._retailStoreOrderConfirmation, listDisplayName: '生超的订单列表' }, // this is for model namespace and
=======
...
<<<<<<< HEAD
  	const {RetailStoreOrderConfirmationPreference} = GlobalComponents
=======
...
<<<<<<< HEAD
  	{path:"/retailStoreOrderConfirmation/:id/preference", component: RetailStoreOrderConfirmationPreference},
=======
...
<<<<<<< HEAD
     ...
     //const {RetailStoreOrderConfirmationEditDetail} = GlobalComponents
     //const {RetailStoreOrderConfirmationViewDetail} = GlobalComponents
     ...
     <Layout>
       ...
       <Layout>
		 ...
		 {this.getNavMenuItems(this.props.retailStoreOrderConfirmation)}
