...
=======
    ...
    const {searchLocalData}=GlobalComponents.RetailStoreOrderConfirmationBase
...
=======
      {this.state.showSearch&&(
        ...
        <div style={{backgroundColor:'black'}}  onClick={()=>hideSearchResult()}  >{searchLocalData(this.props.retailStoreOrderConfirmation,this.state.searchKeyword)}</div>
