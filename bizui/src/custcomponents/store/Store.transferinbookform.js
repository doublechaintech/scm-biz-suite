...
class BookDeactiveForm extends Component {
  state = {
...
deactiveBookByEmployee = (parameters) => {
  //const { BookService } = GlobalComponents;

  const storeId='S000001';
 
  const future = BookStoreExService.putBookOffShelf('storeId',  parameters);
  //console.log(future);
  ...
  handleEnterOnScanISBN = (event) => {
    ...
    validateFieldsAndScroll((error, values) => {
        ...
        this.deactiveBookByEmployee(values)
