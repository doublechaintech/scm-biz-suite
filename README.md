...
selectedDate=$1
echo "working on day of $(selectedDate)"

cat stat.sql | sed 's/__end__/'"$(echo $SELECTED_DATE)"'/g'  > today.sql
...
四川省自贡市由春节至元宵节举办的的一项大型民俗文化活动，以灯火、焰火、装饰、光影为主要表现形式，内容以中国传统文化及四川当地习俗为主，也随会加入一些时尚、现代元素，展示丰富多采的民间生活。
