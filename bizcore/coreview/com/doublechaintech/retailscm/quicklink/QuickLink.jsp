<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.quicklink.QuickLink'%>
...
<sky:include page="com/doublechaintech/retailscm/quicklink/QuickLink$Summary.jsp" />
