<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.transporttask.TransportTask'%>
...
<c:set var="ownerBeanName" value="transportTask" scope="request"/>
<c:set var="ownerClassName" value="TransportTask" scope="request"/>
...
<div class="row">
	...
	<% TransportTask result = (TransportTask)request.getAttribute("result");  %>
			<li><a data-toggle="tab" href="#goodsList" class="disabled"> ${userContext.localeMap['goods']}</a></li>
			<li><a data-toggle="tab" href="#transportTaskTrackList" class="disabled"> ${userContext.localeMap['transport_task_track']}</a></li>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="transportTask" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/transporttask/TransportTask$Summary.jsp" />
...
<sky:include page="com/doublechaintech/retailscm/transportfleet/TransportFleet$Info.jsp" />
		...
		<div id="goodsList" class="tab-pane fade sublist" refer-name="transport_task">
			<sky:include page="com/doublechaintech/retailscm/goods/Goods$List.jsp"
					referName="transportTask"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["transportTaskTrackList"] or ignoreListAccessControl}'>
		<c:set var="transportTaskTrackList" value="${result.transportTaskTrackList}" scope="request"/>
		<c:set var="transportTaskTrackListName" value="transportTaskTrackList" scope="request"/>
		<div id="transportTaskTrackList" class="tab-pane fade sublist" refer-name="movement">
			<sky:include page="com/doublechaintech/retailscm/transporttasktrack/TransportTaskTrack$List.jsp"
					referName="movement"/>
		</div>
	</c:if>
