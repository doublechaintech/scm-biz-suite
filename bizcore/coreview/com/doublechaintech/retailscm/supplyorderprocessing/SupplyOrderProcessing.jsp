<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.supplyorderprocessing.SupplyOrderProcessing'%>
...
<c:set var="ownerBeanName" value="supplyOrderProcessing" scope="request"/>
<c:set var="ownerClassName" value="SupplyOrderProcessing" scope="request"/>
...
<div class="row">
	...
	<% SupplyOrderProcessing result = (SupplyOrderProcessing)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="supplyOrderProcessing" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/supplyorderprocessing/SupplyOrderProcessing$Summary.jsp" />
		...
		<div id="consumerOrderList" class="tab-pane fade sublist" refer-name="processing">
			<sky:include page="com/doublechaintech/retailscm/consumerorder/ConsumerOrder$List.jsp"
					referName="processing"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["supplyOrderList"] or ignoreListAccessControl}'>
		...
		<div id="supplyOrderList" class="tab-pane fade sublist" refer-name="processing">
