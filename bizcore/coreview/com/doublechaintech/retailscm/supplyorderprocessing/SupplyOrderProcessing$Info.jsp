...
<div class="col-xs-12 col-ms-6 col-md-4 section">
	...
	<b title="A SupplyOrderProcessing">${userContext.localeMap['supply_order_processing']} ${referName}</b><a href="#"><i class="fa fa-refresh" aria-hidden="true"></i></a>
	<hr/>
	<ul>
	
	
	<li><span>ID</span><a class="link-action-removed" href="./supplyOrderProcessingManager/view/${supplyOrderProcessing.id}/"> ${supplyOrderProcessing.id}</a></li>
