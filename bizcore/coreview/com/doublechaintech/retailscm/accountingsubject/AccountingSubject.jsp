<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.accountingsubject.AccountingSubject'%>
...
<c:set var="ownerBeanName" value="accountingSubject" scope="request"/>
<c:set var="ownerClassName" value="AccountingSubject" scope="request"/>
...
<div class="row">
	...
	<% AccountingSubject result = (AccountingSubject)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="accountingSubject" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/accountingsubject/AccountingSubject$Summary.jsp" />
	...
	<div class="row">
<c:set var="accountSet" value="${ result.accountSet}" scope="request" />
...
<sky:include page="com/doublechaintech/retailscm/accountset/AccountSet$Info.jsp" />
		...
		<div id="accountingDocumentLineList" class="tab-pane fade sublist" refer-name="accounting_subject">
			<sky:include page="com/doublechaintech/retailscm/accountingdocumentline/AccountingDocumentLine$List.jsp"
					referName="accountingSubject"/>
		</div>
	</c:if>
