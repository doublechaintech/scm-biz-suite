<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.accountingdocumentconfirmation.AccountingDocumentConfirmation'%>
...
<c:set var="ownerBeanName" value="accountingDocumentConfirmation" scope="request"/>
<c:set var="ownerClassName" value="AccountingDocumentConfirmation" scope="request"/>
...
<div class="row">
	...
	<% AccountingDocumentConfirmation result = (AccountingDocumentConfirmation)request.getAttribute("result");  %>
			<li><a data-toggle="tab" href="#accountingDocumentList" class="disabled"> ${userContext.localeMap['accounting_document']}</a></li>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="accountingDocumentConfirmation" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/accountingdocumentconfirmation/AccountingDocumentConfirmation$Summary.jsp" />
		...
		<c:if test='${not empty userContext.accessTokens["accountingDocumentList"] or ignoreListAccessControl}'>
		<c:set var="accountingDocumentList" value="${result.accountingDocumentList}" scope="request"/>
		<c:set var="accountingDocumentListName" value="accountingDocumentList" scope="request"/>
		<div id="accountingDocumentList" class="tab-pane fade sublist" refer-name="confirmation">
			<sky:include page="com/doublechaintech/retailscm/accountingdocument/AccountingDocument$List.jsp"
					referName="confirmation"/>
		</div>
	</c:if>
