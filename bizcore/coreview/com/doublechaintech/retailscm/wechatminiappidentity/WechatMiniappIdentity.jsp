<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.wechatminiappidentity.WechatMiniappIdentity'%>
...
<c:set var="ownerBeanName" value="wechatMiniappIdentity" scope="request"/>
<c:set var="ownerClassName" value="WechatMiniappIdentity" scope="request"/>
...
<div class="row">
	...
	<% WechatMiniappIdentity result = (WechatMiniappIdentity)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="wechatMiniappIdentity" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/wechatminiappidentity/WechatMiniappIdentity$Summary.jsp" />
