<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.product.Product'%>
...
<sky:include page="com/doublechaintech/retailscm/product/Product$Summary.jsp" />
	...
	<div class="row">
<c:set var="levelThreeCategory" value="${ result.parentCategory}" scope="request" />
<c:set var="referName" value="(parentCategory)" scope="request" />
<sky:include page="com/doublechaintech/retailscm/levelthreecategory/LevelThreeCategory$Info.jsp" />
		...
		<div id="skuList" class="tab-pane fade sublist" refer-name="product">
			<sky:include page="com/doublechaintech/retailscm/sku/Sku$List.jsp"
					referName="product"/>
		</div>
	</c:if>
