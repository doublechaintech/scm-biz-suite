<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.supplyorderpicking.SupplyOrderPicking'%>
...
<c:set var="ownerBeanName" value="supplyOrderPicking" scope="request"/>
<c:set var="ownerClassName" value="SupplyOrderPicking" scope="request"/>
...
<div class="row">
	...
	<% SupplyOrderPicking result = (SupplyOrderPicking)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="supplyOrderPicking" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/supplyorderpicking/SupplyOrderPicking$Summary.jsp" />
		...
		<div id="supplyOrderList" class="tab-pane fade sublist" refer-name="picking">
