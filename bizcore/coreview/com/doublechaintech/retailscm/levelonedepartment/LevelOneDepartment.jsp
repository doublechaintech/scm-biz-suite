<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.levelonedepartment.LevelOneDepartment'%>
...
<c:set var="ownerBeanName" value="levelOneDepartment" scope="request"/>
<c:set var="ownerClassName" value="LevelOneDepartment" scope="request"/>
...
<div class="row">
	...
	<% LevelOneDepartment result = (LevelOneDepartment)request.getAttribute("result");  %>
			<li><a data-toggle="tab" href="#levelTwoDepartmentList" class="disabled"> ${userContext.localeMap['level_two_department']}</a></li>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="levelOneDepartment" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/levelonedepartment/LevelOneDepartment$Summary.jsp" />
	...
	<div class="row">
<c:set var="retailStoreCountryCenter" value="${ result.belongsTo}" scope="request" />
...
<sky:include page="com/doublechaintech/retailscm/retailstorecountrycenter/RetailStoreCountryCenter$Info.jsp" />
		...
		<c:if test='${not empty userContext.accessTokens["levelTwoDepartmentList"] or ignoreListAccessControl}'>
		<c:set var="levelTwoDepartmentList" value="${result.levelTwoDepartmentList}" scope="request"/>
		<c:set var="levelTwoDepartmentListName" value="levelTwoDepartmentList" scope="request"/>
		<div id="levelTwoDepartmentList" class="tab-pane fade sublist" refer-name="belongs_to">
			<sky:include page="com/doublechaintech/retailscm/leveltwodepartment/LevelTwoDepartment$List.jsp"
					referName="belongsTo"/>
		</div>
	</c:if>
