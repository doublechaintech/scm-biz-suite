<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.loginhistory.LoginHistory'%>
...
<sky:include page="com/doublechaintech/retailscm/loginhistory/LoginHistory$Summary.jsp" />
