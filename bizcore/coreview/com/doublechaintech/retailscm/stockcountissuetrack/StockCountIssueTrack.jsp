<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.stockcountissuetrack.StockCountIssueTrack'%>
...
<c:set var="ownerBeanName" value="stockCountIssueTrack" scope="request"/>
<c:set var="ownerClassName" value="StockCountIssueTrack" scope="request"/>
...
<div class="row">
	...
	<% StockCountIssueTrack result = (StockCountIssueTrack)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="stockCountIssueTrack" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/stockcountissuetrack/StockCountIssueTrack$Summary.jsp" />
