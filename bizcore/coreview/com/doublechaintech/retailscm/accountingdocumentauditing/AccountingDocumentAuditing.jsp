<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.accountingdocumentauditing.AccountingDocumentAuditing'%>
...
<c:set var="ownerBeanName" value="accountingDocumentAuditing" scope="request"/>
<c:set var="ownerClassName" value="AccountingDocumentAuditing" scope="request"/>
...
<div class="row">
	...
	<% AccountingDocumentAuditing result = (AccountingDocumentAuditing)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="accountingDocumentAuditing" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/accountingdocumentauditing/AccountingDocumentAuditing$Summary.jsp" />
		...
		<div id="accountingDocumentList" class="tab-pane fade sublist" refer-name="auditing">
