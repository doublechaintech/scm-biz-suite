<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.transporttruck.TransportTruck'%>
...
<c:set var="ownerBeanName" value="transportTruck" scope="request"/>
<c:set var="ownerClassName" value="TransportTruck" scope="request"/>
...
<div class="row">
	...
	<% TransportTruck result = (TransportTruck)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="transportTruck" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/transporttruck/TransportTruck$Summary.jsp" />
	...
	<div class="row">
<c:set var="transportFleet" value="${ result.owner}" scope="request" />
...
<sky:include page="com/doublechaintech/retailscm/transportfleet/TransportFleet$Info.jsp" />
		...
		<div id="transportTaskList" class="tab-pane fade sublist" refer-name="truck">
