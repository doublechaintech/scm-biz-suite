...
<div class="col-xs-12 col-ms-6 col-md-4 section">
	...
	<b title="A ProfessionInterview">${userContext.localeMap['profession_interview']} ${referName}</b><a href="#"><i class="fa fa-refresh" aria-hidden="true"></i></a>
	<hr/>
	<ul>
	
	
	<li><span>ID</span><a class="link-action-removed" href="./professionInterviewManager/view/${professionInterview.id}/"> ${professionInterview.id}</a></li>
