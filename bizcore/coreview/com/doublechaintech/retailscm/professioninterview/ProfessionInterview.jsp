<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.professioninterview.ProfessionInterview'%>
...
<c:set var="ownerBeanName" value="professionInterview" scope="request"/>
<c:set var="ownerClassName" value="ProfessionInterview" scope="request"/>
...
<div class="row">
	...
	<% ProfessionInterview result = (ProfessionInterview)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="professionInterview" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/professioninterview/ProfessionInterview$Summary.jsp" />
		...
		<div id="employeeList" class="tab-pane fade sublist" refer-name="profession_interview">
			<sky:include page="com/doublechaintech/retailscm/employee/Employee$List.jsp"
					referName="professionInterview"/>
		</div>
	</c:if>
