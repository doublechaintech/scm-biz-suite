<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.secuser.SecUser'%>
...
<sky:include page="com/doublechaintech/retailscm/secuser/SecUser$Summary.jsp" />
...
<sky:include page="com/doublechaintech/retailscm/userdomain/UserDomain$Info.jsp" />
		...
		<div id="userAppList" class="tab-pane fade sublist" refer-name="sec_user">
			<sky:include page="com/doublechaintech/retailscm/userapp/UserApp$List.jsp"
					referName="secUser"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["loginHistoryList"] or ignoreListAccessControl}'>
		...
		<div id="loginHistoryList" class="tab-pane fade sublist" refer-name="sec_user">
			<sky:include page="com/doublechaintech/retailscm/loginhistory/LoginHistory$List.jsp"
					referName="secUser"/>
		</div>
	</c:if>
