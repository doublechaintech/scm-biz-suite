<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.employeecompanytraining.EmployeeCompanyTraining'%>
...
<c:set var="ownerBeanName" value="employeeCompanyTraining" scope="request"/>
<c:set var="ownerClassName" value="EmployeeCompanyTraining" scope="request"/>
...
<div class="row">
	...
	<% EmployeeCompanyTraining result = (EmployeeCompanyTraining)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="employeeCompanyTraining" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/employeecompanytraining/EmployeeCompanyTraining$Summary.jsp" />
