<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.originalvoucherauditing.OriginalVoucherAuditing'%>
...
<c:set var="ownerBeanName" value="originalVoucherAuditing" scope="request"/>
<c:set var="ownerClassName" value="OriginalVoucherAuditing" scope="request"/>
...
<div class="row">
	...
	<% OriginalVoucherAuditing result = (OriginalVoucherAuditing)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="originalVoucherAuditing" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/originalvoucherauditing/OriginalVoucherAuditing$Summary.jsp" />
		...
		<div id="originalVoucherList" class="tab-pane fade sublist" refer-name="auditing">
