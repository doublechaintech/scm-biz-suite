<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.potentialcustomercontact.PotentialCustomerContact'%>
...
<c:set var="ownerBeanName" value="potentialCustomerContact" scope="request"/>
<c:set var="ownerClassName" value="PotentialCustomerContact" scope="request"/>
...
<div class="row">
	...
	<% PotentialCustomerContact result = (PotentialCustomerContact)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="potentialCustomerContact" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/potentialcustomercontact/PotentialCustomerContact$Summary.jsp" />
