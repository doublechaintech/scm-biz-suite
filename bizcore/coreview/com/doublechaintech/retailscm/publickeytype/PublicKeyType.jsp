<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.publickeytype.PublicKeyType'%>
...
<c:set var="ownerBeanName" value="publicKeyType" scope="request"/>
<c:set var="ownerClassName" value="PublicKeyType" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="publicKeyType" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/publickeytype/PublicKeyType$Summary.jsp" />
