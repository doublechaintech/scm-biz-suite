...
<div class="col-xs-12 col-ms-6 col-md-4 section">
	...
	<li><span>ID</span><a class="link-action-removed" href="./accountingDocumentCreationManager/view/${accountingDocumentCreation.id}/"> ${accountingDocumentCreation.id}</a></li>
