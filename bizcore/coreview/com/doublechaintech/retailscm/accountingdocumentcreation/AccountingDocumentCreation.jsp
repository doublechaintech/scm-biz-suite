<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.accountingdocumentcreation.AccountingDocumentCreation'%>
...
<c:set var="ownerBeanName" value="accountingDocumentCreation" scope="request"/>
<c:set var="ownerClassName" value="AccountingDocumentCreation" scope="request"/>
...
<div class="row">
	...
	<% AccountingDocumentCreation result = (AccountingDocumentCreation)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="accountingDocumentCreation" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/accountingdocumentcreation/AccountingDocumentCreation$Summary.jsp" />
		...
		<div id="accountingDocumentList" class="tab-pane fade sublist" refer-name="creation">
