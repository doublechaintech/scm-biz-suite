...
<div class="col-xs-12 col-ms-6 col-md-4 section">
	...
	<b title="A AccountingDocumentLine">${userContext.localeMap['accounting_document_line']} ${referName}</b><a href="#"><i class="fa fa-refresh" aria-hidden="true"></i></a>
	<hr/>
	<ul>
	
	
	<li><span>ID</span><a class="link-action-removed" href="./accountingDocumentLineManager/view/${accountingDocumentLine.id}/"> ${accountingDocumentLine.id}</a></li>
