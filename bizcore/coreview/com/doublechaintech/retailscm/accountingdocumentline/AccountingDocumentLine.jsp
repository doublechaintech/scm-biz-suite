<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.accountingdocumentline.AccountingDocumentLine'%>
...
<c:set var="ownerBeanName" value="accountingDocumentLine" scope="request"/>
<c:set var="ownerClassName" value="AccountingDocumentLine" scope="request"/>
...
<div class="row">
	...
	<% AccountingDocumentLine result = (AccountingDocumentLine)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="accountingDocumentLine" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/accountingdocumentline/AccountingDocumentLine$Summary.jsp" />
