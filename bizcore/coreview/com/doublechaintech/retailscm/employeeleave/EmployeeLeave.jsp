<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.employeeleave.EmployeeLeave'%>
...
<c:set var="ownerBeanName" value="employeeLeave" scope="request"/>
<c:set var="ownerClassName" value="EmployeeLeave" scope="request"/>
...
<div class="row">
	...
	<% EmployeeLeave result = (EmployeeLeave)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="employeeLeave" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/employeeleave/EmployeeLeave$Summary.jsp" />
	...
	<div class="row">
<c:set var="employee" value="${ result.who}" scope="request" />
<c:set var="referName" value="(who)" scope="request" />
<sky:include page="com/doublechaintech/retailscm/employee/Employee$Info.jsp" />

<c:set var="leaveType" value="${ result.type}" scope="request" />
<c:set var="referName" value="(type)" scope="request" />
<sky:include page="com/doublechaintech/retailscm/leavetype/LeaveType$Info.jsp" />
