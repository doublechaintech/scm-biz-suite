<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.treenode.TreeNode'%>
...
<c:set var="ownerBeanName" value="treeNode" scope="request"/>
<c:set var="ownerClassName" value="TreeNode" scope="request"/>
...
<div class="row">
	...
	<% TreeNode result = (TreeNode)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="treeNode" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/treenode/TreeNode$Summary.jsp" />
