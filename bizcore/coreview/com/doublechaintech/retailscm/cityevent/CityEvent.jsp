<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.cityevent.CityEvent'%>
...
<c:set var="ownerBeanName" value="cityEvent" scope="request"/>
<c:set var="ownerClassName" value="CityEvent" scope="request"/>
...
<div class="row">
	...
	<% CityEvent result = (CityEvent)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="cityEvent" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/cityevent/CityEvent$Summary.jsp" />
...
<sky:include page="com/doublechaintech/retailscm/retailstorecityservicecenter/RetailStoreCityServiceCenter$Info.jsp" />
		...
		<div id="eventAttendanceList" class="tab-pane fade sublist" refer-name="city_event">
