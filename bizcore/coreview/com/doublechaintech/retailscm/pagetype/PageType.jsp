<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.pagetype.PageType'%>
...
<c:set var="ownerBeanName" value="pageType" scope="request"/>
<c:set var="ownerClassName" value="PageType" scope="request"/>
...
<div class="row">
	...
	<% PageType result = (PageType)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="pageType" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/pagetype/PageType$Summary.jsp" />
	...
	<div class="row">
<c:set var="mobileApp" value="${ result.mobileApp}" scope="request" />
<c:set var="referName" value="" scope="request" />
<sky:include page="com/doublechaintech/retailscm/mobileapp/MobileApp$Info.jsp" />
		...
		<div id="pageList" class="tab-pane fade sublist" refer-name="page_type">
