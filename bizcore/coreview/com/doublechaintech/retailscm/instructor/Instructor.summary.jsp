...
<section><h3>讲师(${result.id})</h3><table >
<tr><td class='th'>头衔</td><td >${result.title}</td><td class='th'>姓</td><td >${result.familyName}</td></tr><tr><td class='th'>名</td><td >${result.givenName}</td><td class='th'>手机</td><td >${result.cellPhone}</td></tr><tr><td class='th'>电子邮件</td><td >${result.email}</td><td class='th'>介绍</td><td >${result.introduction}</td></tr><tr><td class='th'>更新于</td><td ><fmt:formatDate pattern="yyyy-MM-dd HH:mm" value="${result.lastUpdateTime}" /></td><td class='th'></td><td ></td></tr></table>
</section>
