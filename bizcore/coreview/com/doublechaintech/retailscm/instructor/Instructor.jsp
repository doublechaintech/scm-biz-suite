<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.instructor.Instructor'%>
...
<c:set var="ownerBeanName" value="instructor" scope="request"/>
<c:set var="ownerClassName" value="Instructor" scope="request"/>
...
<div class="row">
	...
	<% Instructor result = (Instructor)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="instructor" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/instructor/Instructor$Summary.jsp" />
...
<sky:include page="com/doublechaintech/retailscm/retailstorecountrycenter/RetailStoreCountryCenter$Info.jsp" />
		...
		<div id="companyTrainingList" class="tab-pane fade sublist" refer-name="instructor">
			<sky:include page="com/doublechaintech/retailscm/companytraining/CompanyTraining$List.jsp"
					referName="instructor"/>
		</div>
	</c:if>
