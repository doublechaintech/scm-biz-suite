<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.transporttasktrack.TransportTaskTrack'%>
...
<c:set var="ownerBeanName" value="transportTaskTrack" scope="request"/>
<c:set var="ownerClassName" value="TransportTaskTrack" scope="request"/>
...
<div class="row">
	...
	<% TransportTaskTrack result = (TransportTaskTrack)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="transportTaskTrack" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/transporttasktrack/TransportTaskTrack$Summary.jsp" />
