<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.formfieldmessage.FormFieldMessage'%>
...
<sky:include page="com/doublechaintech/retailscm/formfieldmessage/FormFieldMessage$Summary.jsp" />
