...
<section><h3>卡车司机(${result.id})</h3><table >
<tr><td class='th'>名称</td><td >${result.name}</td><td class='th'>驾驶执照号码</td><td >${result.driverLicenseNumber}</td></tr><tr><td class='th'>联系电话</td><td >${result.contactNumber}</td><td class='th'>属于</td><td >${result.belongsTo.displayName}</td></tr></table>
</section>
