<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.truckdriver.TruckDriver'%>
...
<c:set var="ownerBeanName" value="truckDriver" scope="request"/>
<c:set var="ownerClassName" value="TruckDriver" scope="request"/>
...
<div class="row">
	...
	<% TruckDriver result = (TruckDriver)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="truckDriver" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/truckdriver/TruckDriver$Summary.jsp" />
...
<sky:include page="com/doublechaintech/retailscm/transportfleet/TransportFleet$Info.jsp" />
		...
		<div id="transportTaskList" class="tab-pane fade sublist" refer-name="driver">
