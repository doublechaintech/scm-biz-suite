<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.leveltwocategory.LevelTwoCategory'%>
...
<div class="row">
	...
	<% LevelTwoCategory result = (LevelTwoCategory)request.getAttribute("result");  %>
			<li><a data-toggle="tab" href="#levelThreeCategoryList" class="disabled"> ${userContext.localeMap['level_three_category']}</a></li>
...
<sky:include page="com/doublechaintech/retailscm/leveltwocategory/LevelTwoCategory$Summary.jsp" />
...
<sky:include page="com/doublechaintech/retailscm/levelonecategory/LevelOneCategory$Info.jsp" />
		...
		<c:if test='${not empty userContext.accessTokens["levelThreeCategoryList"] or ignoreListAccessControl}'>
		<c:set var="levelThreeCategoryList" value="${result.levelThreeCategoryList}" scope="request"/>
		<c:set var="levelThreeCategoryListName" value="levelThreeCategoryList" scope="request"/>
		<div id="levelThreeCategoryList" class="tab-pane fade sublist" refer-name="parent_category">
			<sky:include page="com/doublechaintech/retailscm/levelthreecategory/LevelThreeCategory$List.jsp"
