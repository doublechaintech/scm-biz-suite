<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.view.View'%>
...
<c:set var="ownerBeanName" value="view" scope="request"/>
<c:set var="ownerClassName" value="View" scope="request"/>
...
<div class="row">
	...
	<% View result = (View)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="view" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/view/View$Summary.jsp" />
