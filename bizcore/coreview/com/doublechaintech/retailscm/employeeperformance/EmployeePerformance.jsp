<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.employeeperformance.EmployeePerformance'%>
...
<c:set var="ownerBeanName" value="employeePerformance" scope="request"/>
<c:set var="ownerClassName" value="EmployeePerformance" scope="request"/>
...
<div class="row">
	...
	<% EmployeePerformance result = (EmployeePerformance)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="employeePerformance" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/employeeperformance/EmployeePerformance$Summary.jsp" />
