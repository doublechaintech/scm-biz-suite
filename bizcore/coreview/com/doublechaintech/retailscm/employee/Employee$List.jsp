...
</c:if><c:if test="${param.referName ne 'jobApplication'}">
	<td class="select_candidate_td"
			data-candidate-method="./employeeManager/requestCandidateJobApplication/${ownerBeanName}/${item.id}/"
			data-switch-method="./employeeManager/transferToAnotherJobApplication/${item.id}/"
			data-link-template="./jobApplicationManager/view/${'$'}{ID}/">
		<span class="display_span">
			<c:if test="${not empty  item.jobApplication}">
			<a href='./jobApplicationManager/view/${item.jobApplication.id}/'>${item.jobApplication.displayName}</a>
			</c:if>
			<c:if test="${empty  item.jobApplication}">
			<a href='#'></a>
			</c:if>
			<button class="btn btn-link candidate-action">...</button>
		</span>
...
<c:if test="${param.referName ne 'professionInterview'}">
	<td class="select_candidate_td"
			data-candidate-method="./employeeManager/requestCandidateProfessionInterview/${ownerBeanName}/${item.id}/"
			data-switch-method="./employeeManager/transferToAnotherProfessionInterview/${item.id}/"
			data-link-template="./professionInterviewManager/view/${'$'}{ID}/">
		<span class="display_span">
			<c:if test="${not empty  item.professionInterview}">
			<a href='./professionInterviewManager/view/${item.professionInterview.id}/'>${item.professionInterview.displayName}</a>
			</c:if>
			<c:if test="${empty  item.professionInterview}">
			<a href='#'></a>
			</c:if>
			<button class="btn btn-link candidate-action">...</button>
		</span>
...
<c:if test="${param.referName ne 'hrInterview'}">
	<td class="select_candidate_td"
			data-candidate-method="./employeeManager/requestCandidateHrInterview/${ownerBeanName}/${item.id}/"
			data-switch-method="./employeeManager/transferToAnotherHrInterview/${item.id}/"
			data-link-template="./hrInterviewManager/view/${'$'}{ID}/">
		<span class="display_span">
			<c:if test="${not empty  item.hrInterview}">
			<a href='./hrInterviewManager/view/${item.hrInterview.id}/'>${item.hrInterview.displayName}</a>
			</c:if>
			<c:if test="${empty  item.hrInterview}">
			<a href='#'></a>
			</c:if>
			<button class="btn btn-link candidate-action">...</button>
		</span>
...
<c:if test="${param.referName ne 'offerApproval'}">
	<td class="select_candidate_td"
			data-candidate-method="./employeeManager/requestCandidateOfferApproval/${ownerBeanName}/${item.id}/"
			data-switch-method="./employeeManager/transferToAnotherOfferApproval/${item.id}/"
			data-link-template="./offerApprovalManager/view/${'$'}{ID}/">
		<span class="display_span">
			<c:if test="${not empty  item.offerApproval}">
			<a href='./offerApprovalManager/view/${item.offerApproval.id}/'>${item.offerApproval.displayName}</a>
			</c:if>
			<c:if test="${empty  item.offerApproval}">
			<a href='#'></a>
			</c:if>
			<button class="btn btn-link candidate-action">...</button>
		</span>
...
<c:if test="${param.referName ne 'offerAcceptance'}">
	<td class="select_candidate_td"
			data-candidate-method="./employeeManager/requestCandidateOfferAcceptance/${ownerBeanName}/${item.id}/"
			data-switch-method="./employeeManager/transferToAnotherOfferAcceptance/${item.id}/"
			data-link-template="./offerAcceptanceManager/view/${'$'}{ID}/">
		<span class="display_span">
			<c:if test="${not empty  item.offerAcceptance}">
			<a href='./offerAcceptanceManager/view/${item.offerAcceptance.id}/'>${item.offerAcceptance.displayName}</a>
			</c:if>
			<c:if test="${empty  item.offerAcceptance}">
			<a href='#'></a>
			</c:if>
			<button class="btn btn-link candidate-action">...</button>
		</span>
...
<c:if test="${param.referName ne 'employeeBoarding'}">
	<td class="select_candidate_td"
			data-candidate-method="./employeeManager/requestCandidateEmployeeBoarding/${ownerBeanName}/${item.id}/"
			data-switch-method="./employeeManager/transferToAnotherEmployeeBoarding/${item.id}/"
			data-link-template="./employeeBoardingManager/view/${'$'}{ID}/">
		<span class="display_span">
			<c:if test="${not empty  item.employeeBoarding}">
			<a href='./employeeBoardingManager/view/${item.employeeBoarding.id}/'>${item.employeeBoarding.displayName}</a>
			</c:if>
			<c:if test="${empty  item.employeeBoarding}">
			<a href='#'></a>
			</c:if>
			<button class="btn btn-link candidate-action">...</button>
		</span>
...
<c:if test="${param.referName ne 'termination'}">
	<td class="select_candidate_td"
			data-candidate-method="./employeeManager/requestCandidateTermination/${ownerBeanName}/${item.id}/"
			data-switch-method="./employeeManager/transferToAnotherTermination/${item.id}/"
			data-link-template="./terminationManager/view/${'$'}{ID}/">
		<span class="display_span">
			<c:if test="${not empty  item.termination}">
			<a href='./terminationManager/view/${item.termination.id}/'>${item.termination.displayName}</a>
			</c:if>
			<c:if test="${empty  item.termination}">
			<a href='#'></a>
			</c:if>
			<button class="btn btn-link candidate-action">...</button>
		</span>
