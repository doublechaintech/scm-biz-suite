<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.memberwishlistproduct.MemberWishlistProduct'%>
...
<c:set var="ownerBeanName" value="memberWishlistProduct" scope="request"/>
<c:set var="ownerClassName" value="MemberWishlistProduct" scope="request"/>
...
<div class="row">
	...
	<% MemberWishlistProduct result = (MemberWishlistProduct)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="memberWishlistProduct" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/memberwishlistproduct/MemberWishlistProduct$Summary.jsp" />
	...
	<div class="row">
<c:set var="memberWishlist" value="${ result.owner}" scope="request" />
<c:set var="referName" value="(owner)" scope="request" />
<sky:include page="com/doublechaintech/retailscm/memberwishlist/MemberWishlist$Info.jsp" />
