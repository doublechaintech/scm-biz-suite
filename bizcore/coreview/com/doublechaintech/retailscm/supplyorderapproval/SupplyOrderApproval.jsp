<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.supplyorderapproval.SupplyOrderApproval'%>
...
<c:set var="ownerBeanName" value="supplyOrderApproval" scope="request"/>
<c:set var="ownerClassName" value="SupplyOrderApproval" scope="request"/>
...
<div class="row">
	...
	<% SupplyOrderApproval result = (SupplyOrderApproval)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="supplyOrderApproval" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/supplyorderapproval/SupplyOrderApproval$Summary.jsp" />
		...
		<div id="consumerOrderList" class="tab-pane fade sublist" refer-name="approval">
	...
	<c:if test='${not empty userContext.accessTokens["supplyOrderList"] or ignoreListAccessControl}'>
		...
		<div id="supplyOrderList" class="tab-pane fade sublist" refer-name="approval">
