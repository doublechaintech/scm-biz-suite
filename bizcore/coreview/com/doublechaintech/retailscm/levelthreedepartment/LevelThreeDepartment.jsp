<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.levelthreedepartment.LevelThreeDepartment'%>
...
<c:set var="ownerBeanName" value="levelThreeDepartment" scope="request"/>
<c:set var="ownerClassName" value="LevelThreeDepartment" scope="request"/>
...
<div class="row">
	...
	<% LevelThreeDepartment result = (LevelThreeDepartment)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="levelThreeDepartment" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/levelthreedepartment/LevelThreeDepartment$Summary.jsp" />
...
<sky:include page="com/doublechaintech/retailscm/leveltwodepartment/LevelTwoDepartment$Info.jsp" />
		...
		<div id="employeeList" class="tab-pane fade sublist" refer-name="department">
