<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.employeeeducation.EmployeeEducation'%>
...
<c:set var="ownerBeanName" value="employeeEducation" scope="request"/>
<c:set var="ownerClassName" value="EmployeeEducation" scope="request"/>
...
<div class="row">
	...
	<% EmployeeEducation result = (EmployeeEducation)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="employeeEducation" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/employeeeducation/EmployeeEducation$Summary.jsp" />
