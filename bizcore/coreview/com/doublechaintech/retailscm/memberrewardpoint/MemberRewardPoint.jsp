<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.memberrewardpoint.MemberRewardPoint'%>
...
<c:set var="ownerBeanName" value="memberRewardPoint" scope="request"/>
<c:set var="ownerClassName" value="MemberRewardPoint" scope="request"/>
...
<div class="row">
	...
	<% MemberRewardPoint result = (MemberRewardPoint)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="memberRewardPoint" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/memberrewardpoint/MemberRewardPoint$Summary.jsp" />
