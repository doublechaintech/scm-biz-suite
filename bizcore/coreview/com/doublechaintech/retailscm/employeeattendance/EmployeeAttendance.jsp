<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.employeeattendance.EmployeeAttendance'%>
...
<c:set var="ownerBeanName" value="employeeAttendance" scope="request"/>
<c:set var="ownerClassName" value="EmployeeAttendance" scope="request"/>
...
<div class="row">
	...
	<% EmployeeAttendance result = (EmployeeAttendance)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="employeeAttendance" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/employeeattendance/EmployeeAttendance$Summary.jsp" />
