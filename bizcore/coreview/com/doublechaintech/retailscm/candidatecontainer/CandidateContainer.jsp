<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.candidatecontainer.CandidateContainer'%>
...
<sky:include page="com/doublechaintech/retailscm/candidatecontainer/CandidateContainer$Summary.jsp" />
		...
		<div id="candidateElementList" class="tab-pane fade sublist" refer-name="container">
			<sky:include page="com/doublechaintech/retailscm/candidateelement/CandidateElement$List.jsp"
					referName="container"/>
		</div>
	</c:if>
