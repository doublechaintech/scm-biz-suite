<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.userdomain.UserDomain'%>
...
<sky:include page="com/doublechaintech/retailscm/userdomain/UserDomain$Summary.jsp" />
	...
	<c:if test='${not empty userContext.accessTokens["secUserList"] or ignoreListAccessControl}'>
		...
		<div id="secUserList" class="tab-pane fade sublist" refer-name="domain">
			<sky:include page="com/doublechaintech/retailscm/secuser/SecUser$List.jsp"
					referName="domain"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["publicKeyTypeList"] or ignoreListAccessControl}'>
		<c:set var="publicKeyTypeList" value="${result.publicKeyTypeList}" scope="request"/>
		<c:set var="publicKeyTypeListName" value="publicKeyTypeList" scope="request"/>
		<div id="publicKeyTypeList" class="tab-pane fade sublist" refer-name="domain">
			<sky:include page="com/doublechaintech/retailscm/publickeytype/PublicKeyType$List.jsp"
					referName="domain"/>
		</div>
	</c:if>
