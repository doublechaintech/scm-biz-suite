<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.userwhitelist.UserWhiteList'%>
...
<sky:include page="com/doublechaintech/retailscm/userwhitelist/UserWhiteList$Summary.jsp" />
