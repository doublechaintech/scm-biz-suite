<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.retailstoremembercoupon.RetailStoreMemberCoupon'%>
...
<c:set var="ownerBeanName" value="retailStoreMemberCoupon" scope="request"/>
<c:set var="ownerClassName" value="RetailStoreMemberCoupon" scope="request"/>
...
<div class="row">
	...
	<% RetailStoreMemberCoupon result = (RetailStoreMemberCoupon)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="retailStoreMemberCoupon" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/retailstoremembercoupon/RetailStoreMemberCoupon$Summary.jsp" />
