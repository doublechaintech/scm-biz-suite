<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.uiaction.UiAction'%>
...
<c:set var="ownerBeanName" value="uiAction" scope="request"/>
<c:set var="ownerClassName" value="UiAction" scope="request"/>
...
<div class="row">
	...
	<% UiAction result = (UiAction)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="uiAction" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/uiaction/UiAction$Summary.jsp" />
	...
	<div class="row">
<c:set var="page" value="${ result.page}" scope="request" />
<c:set var="referName" value="" scope="request" />
<sky:include page="com/doublechaintech/retailscm/page/Page$Info.jsp" />
