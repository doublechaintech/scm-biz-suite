<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.goodsmovement.GoodsMovement'%>
...
<c:set var="ownerBeanName" value="goodsMovement" scope="request"/>
<c:set var="ownerClassName" value="GoodsMovement" scope="request"/>
...
<div class="row">
	...
	<% GoodsMovement result = (GoodsMovement)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="goodsMovement" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/goodsmovement/GoodsMovement$Summary.jsp" />
