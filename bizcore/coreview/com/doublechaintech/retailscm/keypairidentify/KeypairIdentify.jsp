...
<c:set var="ownerBeanName" value="keypairIdentify" scope="request"/>
<c:set var="ownerClassName" value="KeypairIdentify" scope="request"/>
...
<div class="row">
	...
	<% KeypairIdentify result = (KeypairIdentify)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="keypairIdentify" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/keypairidentify/KeypairIdentify$Summary.jsp" />
