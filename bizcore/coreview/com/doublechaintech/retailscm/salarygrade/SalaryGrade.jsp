<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.salarygrade.SalaryGrade'%>
...
<c:set var="ownerBeanName" value="salaryGrade" scope="request"/>
<c:set var="ownerClassName" value="SalaryGrade" scope="request"/>
...
<div class="row">
	...
	<% SalaryGrade result = (SalaryGrade)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="salaryGrade" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/salarygrade/SalaryGrade$Summary.jsp" />
...
<sky:include page="com/doublechaintech/retailscm/retailstorecountrycenter/RetailStoreCountryCenter$Info.jsp" />
		...
		<div id="employeeList" class="tab-pane fade sublist" refer-name="current_salary_grade">
			<sky:include page="com/doublechaintech/retailscm/employee/Employee$List.jsp"
					referName="currentSalaryGrade"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["employeeSalarySheetList"] or ignoreListAccessControl}'>
		...
		<div id="employeeSalarySheetList" class="tab-pane fade sublist" refer-name="current_salary_grade">
