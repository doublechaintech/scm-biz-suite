<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.secuserblocking.SecUserBlocking'%>
...
<sky:include page="com/doublechaintech/retailscm/secuserblocking/SecUserBlocking$Summary.jsp" />
