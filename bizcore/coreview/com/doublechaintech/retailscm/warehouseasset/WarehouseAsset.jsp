<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.warehouseasset.WarehouseAsset'%>
...
<c:set var="ownerBeanName" value="warehouseAsset" scope="request"/>
<c:set var="ownerClassName" value="WarehouseAsset" scope="request"/>
...
<div class="row">
	...
	<% WarehouseAsset result = (WarehouseAsset)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="warehouseAsset" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/warehouseasset/WarehouseAsset$Summary.jsp" />
	...
	<div class="row">
<c:set var="warehouse" value="${ result.owner}" scope="request" />
