<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.consumerordershippinggroup.ConsumerOrderShippingGroup'%>
...
<c:set var="ownerBeanName" value="consumerOrderShippingGroup" scope="request"/>
<c:set var="ownerClassName" value="ConsumerOrderShippingGroup" scope="request"/>
...
<div class="row">
	...
	<% ConsumerOrderShippingGroup result = (ConsumerOrderShippingGroup)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="consumerOrderShippingGroup" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/consumerordershippinggroup/ConsumerOrderShippingGroup$Summary.jsp" />
