<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.retailstoreordershipment.RetailStoreOrderShipment'%>
...
<c:set var="ownerBeanName" value="retailStoreOrderShipment" scope="request"/>
<c:set var="ownerClassName" value="RetailStoreOrderShipment" scope="request"/>
...
<div class="row">
	...
	<% RetailStoreOrderShipment result = (RetailStoreOrderShipment)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="retailStoreOrderShipment" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/retailstoreordershipment/RetailStoreOrderShipment$Summary.jsp" />
		...
		<div id="retailStoreOrderList" class="tab-pane fade sublist" refer-name="shipment">
