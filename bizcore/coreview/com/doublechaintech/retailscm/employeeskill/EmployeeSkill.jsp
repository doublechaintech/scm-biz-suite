...
<c:set var="ownerBeanName" value="employeeSkill" scope="request"/>
<c:set var="ownerClassName" value="EmployeeSkill" scope="request"/>
...
<div class="row">
	...
	<% EmployeeSkill result = (EmployeeSkill)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="employeeSkill" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/employeeskill/EmployeeSkill$Summary.jsp" />
...
<c:set var="skillType" value="${ result.skillType}" scope="request" />
<c:set var="referName" value="" scope="request" />
<sky:include page="com/doublechaintech/retailscm/skilltype/SkillType$Info.jsp" />
