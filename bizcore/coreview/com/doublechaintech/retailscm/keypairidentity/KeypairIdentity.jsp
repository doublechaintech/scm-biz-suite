<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.keypairidentity.KeypairIdentity'%>
...
<c:set var="ownerBeanName" value="keypairIdentity" scope="request"/>
<c:set var="ownerClassName" value="KeypairIdentity" scope="request"/>
...
<div class="row">
	...
	<% KeypairIdentity result = (KeypairIdentity)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="keypairIdentity" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/keypairidentity/KeypairIdentity$Summary.jsp" />
	...
	<div class="row">
<c:set var="publicKeyType" value="${ result.keyType}" scope="request" />
<c:set var="referName" value="(keyType)" scope="request" />
<sky:include page="com/doublechaintech/retailscm/publickeytype/PublicKeyType$Info.jsp" />

<c:set var="secUser" value="${ result.secUser}" scope="request" />
<c:set var="referName" value="" scope="request" />
<sky:include page="com/doublechaintech/retailscm/secuser/SecUser$Info.jsp" />
