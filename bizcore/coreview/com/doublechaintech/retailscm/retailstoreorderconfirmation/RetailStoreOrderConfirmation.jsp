<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.retailstoreorderconfirmation.RetailStoreOrderConfirmation'%>
...
<c:set var="ownerBeanName" value="retailStoreOrderConfirmation" scope="request"/>
<c:set var="ownerClassName" value="RetailStoreOrderConfirmation" scope="request"/>
...
<div class="row">
	...
	<% RetailStoreOrderConfirmation result = (RetailStoreOrderConfirmation)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="retailStoreOrderConfirmation" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/retailstoreorderconfirmation/RetailStoreOrderConfirmation$Summary.jsp" />
		...
		<div id="retailStoreOrderList" class="tab-pane fade sublist" refer-name="confirmation">
