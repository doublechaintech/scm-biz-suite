<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.retailstoremembergiftcardconsumerecord.RetailStoreMemberGiftCardConsumeRecord'%>
...
<c:set var="ownerBeanName" value="retailStoreMemberGiftCardConsumeRecord" scope="request"/>
<c:set var="ownerClassName" value="RetailStoreMemberGiftCardConsumeRecord" scope="request"/>
...
<div class="row">
	...
	<% RetailStoreMemberGiftCardConsumeRecord result = (RetailStoreMemberGiftCardConsumeRecord)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="retailStoreMemberGiftCardConsumeRecord" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/retailstoremembergiftcardconsumerecord/RetailStoreMemberGiftCardConsumeRecord$Summary.jsp" />
