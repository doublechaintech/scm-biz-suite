<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.supplyordershipment.SupplyOrderShipment'%>
...
<c:set var="ownerBeanName" value="supplyOrderShipment" scope="request"/>
<c:set var="ownerClassName" value="SupplyOrderShipment" scope="request"/>
...
<div class="row">
	...
	<% SupplyOrderShipment result = (SupplyOrderShipment)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="supplyOrderShipment" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/supplyordershipment/SupplyOrderShipment$Summary.jsp" />
		...
		<div id="consumerOrderList" class="tab-pane fade sublist" refer-name="shipment">
	...
	<c:if test='${not empty userContext.accessTokens["supplyOrderList"] or ignoreListAccessControl}'>
		...
		<div id="supplyOrderList" class="tab-pane fade sublist" refer-name="shipment">
