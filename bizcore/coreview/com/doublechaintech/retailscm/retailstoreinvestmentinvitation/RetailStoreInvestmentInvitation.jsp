<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.retailstoreinvestmentinvitation.RetailStoreInvestmentInvitation'%>
...
<c:set var="ownerBeanName" value="retailStoreInvestmentInvitation" scope="request"/>
<c:set var="ownerClassName" value="RetailStoreInvestmentInvitation" scope="request"/>
...
<div class="row">
	...
	<% RetailStoreInvestmentInvitation result = (RetailStoreInvestmentInvitation)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="retailStoreInvestmentInvitation" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/retailstoreinvestmentinvitation/RetailStoreInvestmentInvitation$Summary.jsp" />
		...
		<div id="retailStoreList" class="tab-pane fade sublist" refer-name="investment_invitation">
			<sky:include page="com/doublechaintech/retailscm/retailstore/RetailStore$List.jsp"
					referName="investmentInvitation"/>
		</div>
	</c:if>
