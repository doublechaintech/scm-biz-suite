<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.goodspackaging.GoodsPackaging'%>
...
<c:set var="ownerBeanName" value="goodsPackaging" scope="request"/>
<c:set var="ownerClassName" value="GoodsPackaging" scope="request"/>
...
<div class="row">
	...
	<% GoodsPackaging result = (GoodsPackaging)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="goodsPackaging" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/goodspackaging/GoodsPackaging$Summary.jsp" />
		...
		<div id="goodsList" class="tab-pane fade sublist" refer-name="packaging">
