<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.consumerorderprocessing.ConsumerOrderProcessing'%>
...
<c:set var="ownerBeanName" value="consumerOrderProcessing" scope="request"/>
<c:set var="ownerClassName" value="ConsumerOrderProcessing" scope="request"/>
...
<div class="row">
	...
	<% ConsumerOrderProcessing result = (ConsumerOrderProcessing)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="consumerOrderProcessing" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/consumerorderprocessing/ConsumerOrderProcessing$Summary.jsp" />
