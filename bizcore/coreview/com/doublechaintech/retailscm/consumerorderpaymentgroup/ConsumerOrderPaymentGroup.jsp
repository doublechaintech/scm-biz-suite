<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.consumerorderpaymentgroup.ConsumerOrderPaymentGroup'%>
...
<c:set var="ownerBeanName" value="consumerOrderPaymentGroup" scope="request"/>
<c:set var="ownerClassName" value="ConsumerOrderPaymentGroup" scope="request"/>
...
<div class="row">
	...
	<% ConsumerOrderPaymentGroup result = (ConsumerOrderPaymentGroup)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="consumerOrderPaymentGroup" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/consumerorderpaymentgroup/ConsumerOrderPaymentGroup$Summary.jsp" />
