<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.levelthreecategory.LevelThreeCategory'%>
...
<c:set var="ownerBeanName" value="levelThreeCategory" scope="request"/>
<c:set var="ownerClassName" value="LevelThreeCategory" scope="request"/>
...
<div class="row">
	...
	<% LevelThreeCategory result = (LevelThreeCategory)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="levelThreeCategory" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/levelthreecategory/LevelThreeCategory$Summary.jsp" />
...
<sky:include page="com/doublechaintech/retailscm/leveltwocategory/LevelTwoCategory$Info.jsp" />
		...
		<div id="productList" class="tab-pane fade sublist" refer-name="parent_category">
			<sky:include page="com/doublechaintech/retailscm/product/Product$List.jsp"
