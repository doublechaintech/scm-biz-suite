<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.moyi.Moyi'%>
...
<c:set var="ownerBeanName" value="moyi" scope="request"/>
<c:set var="ownerClassName" value="Moyi" scope="request"/>
...
<div class="row">
	...
	<% Moyi result = (Moyi)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="moyi" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/moyi/Moyi$Summary.jsp" />
