<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.consumerorderpriceadjustment.ConsumerOrderPriceAdjustment'%>
...
<c:set var="ownerBeanName" value="consumerOrderPriceAdjustment" scope="request"/>
<c:set var="ownerClassName" value="ConsumerOrderPriceAdjustment" scope="request"/>
...
<div class="row">
	...
	<% ConsumerOrderPriceAdjustment result = (ConsumerOrderPriceAdjustment)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="consumerOrderPriceAdjustment" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/consumerorderpriceadjustment/ConsumerOrderPriceAdjustment$Summary.jsp" />
