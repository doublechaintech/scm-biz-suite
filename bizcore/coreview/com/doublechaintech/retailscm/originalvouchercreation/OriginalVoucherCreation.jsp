<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.originalvouchercreation.OriginalVoucherCreation'%>
...
<c:set var="ownerBeanName" value="originalVoucherCreation" scope="request"/>
<c:set var="ownerClassName" value="OriginalVoucherCreation" scope="request"/>
...
<div class="row">
	...
	<% OriginalVoucherCreation result = (OriginalVoucherCreation)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="originalVoucherCreation" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/originalvouchercreation/OriginalVoucherCreation$Summary.jsp" />
		...
		<div id="originalVoucherList" class="tab-pane fade sublist" refer-name="creation">
