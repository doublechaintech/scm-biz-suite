<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.retailstoreordershippinggroup.RetailStoreOrderShippingGroup'%>
...
<c:set var="ownerBeanName" value="retailStoreOrderShippingGroup" scope="request"/>
<c:set var="ownerClassName" value="RetailStoreOrderShippingGroup" scope="request"/>
...
<div class="row">
	...
	<% RetailStoreOrderShippingGroup result = (RetailStoreOrderShippingGroup)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="retailStoreOrderShippingGroup" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/retailstoreordershippinggroup/RetailStoreOrderShippingGroup$Summary.jsp" />
	...
	<div class="row">
<c:set var="retailStoreOrder" value="${ result.bizOrder}" scope="request" />
