...
<div class="col-xs-12 col-ms-6 col-md-4 section">
	...
	<b title="A SupplyOrderConfirmation">${userContext.localeMap['supply_order_confirmation']} ${referName}</b><a href="#"><i class="fa fa-refresh" aria-hidden="true"></i></a>
	<hr/>
	<ul>
	
	
	<li><span>ID</span><a class="link-action-removed" href="./supplyOrderConfirmationManager/view/${supplyOrderConfirmation.id}/"> ${supplyOrderConfirmation.id}</a></li>
