<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.supplyorderconfirmation.SupplyOrderConfirmation'%>
...
<c:set var="ownerBeanName" value="supplyOrderConfirmation" scope="request"/>
<c:set var="ownerClassName" value="SupplyOrderConfirmation" scope="request"/>
...
<div class="row">
	...
	<% SupplyOrderConfirmation result = (SupplyOrderConfirmation)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="supplyOrderConfirmation" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/supplyorderconfirmation/SupplyOrderConfirmation$Summary.jsp" />
		...
		<div id="consumerOrderList" class="tab-pane fade sublist" refer-name="confirmation">
	...
	<c:if test='${not empty userContext.accessTokens["supplyOrderList"] or ignoreListAccessControl}'>
		...
		<div id="supplyOrderList" class="tab-pane fade sublist" refer-name="confirmation">
