<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.terminationreason.TerminationReason'%>
...
<c:set var="ownerBeanName" value="terminationReason" scope="request"/>
<c:set var="ownerClassName" value="TerminationReason" scope="request"/>
...
<div class="row">
	...
	<% TerminationReason result = (TerminationReason)request.getAttribute("result");  %>
			<li><a data-toggle="tab" href="#terminationList" class="disabled"> ${userContext.localeMap['termination']}</a></li>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="terminationReason" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/terminationreason/TerminationReason$Summary.jsp" />
...
<sky:include page="com/doublechaintech/retailscm/retailstorecountrycenter/RetailStoreCountryCenter$Info.jsp" />
		...
		<c:if test='${not empty userContext.accessTokens["terminationList"] or ignoreListAccessControl}'>
		<c:set var="terminationList" value="${result.terminationList}" scope="request"/>
		<c:set var="terminationListName" value="terminationList" scope="request"/>
		<div id="terminationList" class="tab-pane fade sublist" refer-name="reason">
			<sky:include page="com/doublechaintech/retailscm/termination/Termination$List.jsp"
					referName="reason"/>
		</div>
	</c:if>
