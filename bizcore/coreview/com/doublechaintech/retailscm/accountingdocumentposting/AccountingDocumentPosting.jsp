<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.accountingdocumentposting.AccountingDocumentPosting'%>
...
<c:set var="ownerBeanName" value="accountingDocumentPosting" scope="request"/>
<c:set var="ownerClassName" value="AccountingDocumentPosting" scope="request"/>
...
<div class="row">
	...
	<% AccountingDocumentPosting result = (AccountingDocumentPosting)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="accountingDocumentPosting" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/accountingdocumentposting/AccountingDocumentPosting$Summary.jsp" />
		...
		<div id="accountingDocumentList" class="tab-pane fade sublist" refer-name="posting">
