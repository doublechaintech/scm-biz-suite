<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.terminationtype.TerminationType'%>
...
<c:set var="ownerBeanName" value="terminationType" scope="request"/>
<c:set var="ownerClassName" value="TerminationType" scope="request"/>
...
<div class="row">
	...
	<% TerminationType result = (TerminationType)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="terminationType" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/terminationtype/TerminationType$Summary.jsp" />
...
<sky:include page="com/doublechaintech/retailscm/retailstorecountrycenter/RetailStoreCountryCenter$Info.jsp" />
		...
		<div id="terminationList" class="tab-pane fade sublist" refer-name="type">
