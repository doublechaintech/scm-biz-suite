<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.accountingdocumenttype.AccountingDocumentType'%>
...
<c:set var="ownerBeanName" value="accountingDocumentType" scope="request"/>
<c:set var="ownerClassName" value="AccountingDocumentType" scope="request"/>
...
<div class="row">
	...
	<% AccountingDocumentType result = (AccountingDocumentType)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="accountingDocumentType" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/accountingdocumenttype/AccountingDocumentType$Summary.jsp" />
...
<sky:include page="com/doublechaintech/retailscm/accountset/AccountSet$Info.jsp" />
		...
		<div id="accountingDocumentList" class="tab-pane fade sublist" refer-name="document_type">
			<sky:include page="com/doublechaintech/retailscm/accountingdocument/AccountingDocument$List.jsp"
					referName="documentType"/>
		</div>
	</c:if>
