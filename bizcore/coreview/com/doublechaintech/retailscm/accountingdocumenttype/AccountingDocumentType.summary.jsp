...
<section><h3>会计凭证类型(${result.id})</h3><table >
<tr><td class='th'>名称</td><td >${result.name}</td><td class='th'>描述</td><td >${result.description}</td></tr><tr><td class='th'>会计期间</td><td >${result.accountingPeriod.displayName}</td><td class='th'></td><td ></td></tr></table>
</section>
