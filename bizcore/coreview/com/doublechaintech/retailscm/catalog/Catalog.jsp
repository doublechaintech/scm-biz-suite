<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.catalog.Catalog'%>
...
<sky:include page="com/doublechaintech/retailscm/catalog/Catalog$Summary.jsp" />
...
<sky:include page="com/doublechaintech/retailscm/retailstorecountrycenter/RetailStoreCountryCenter$Info.jsp" />
		...
		<div id="levelOneCategoryList" class="tab-pane fade sublist" refer-name="catalog">
			<sky:include page="com/doublechaintech/retailscm/levelonecategory/LevelOneCategory$List.jsp"
					referName="catalog"/>
		</div>
	</c:if>
