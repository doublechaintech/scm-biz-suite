<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.provincecenterdepartment.ProvinceCenterDepartment'%>
...
<c:set var="ownerBeanName" value="provinceCenterDepartment" scope="request"/>
<c:set var="ownerClassName" value="ProvinceCenterDepartment" scope="request"/>
...
<div class="row">
	...
	<% ProvinceCenterDepartment result = (ProvinceCenterDepartment)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="provinceCenterDepartment" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/provincecenterdepartment/ProvinceCenterDepartment$Summary.jsp" />
...
<sky:include page="com/doublechaintech/retailscm/retailstoreprovincecenter/RetailStoreProvinceCenter$Info.jsp" />
		...
		<div id="provinceCenterEmployeeList" class="tab-pane fade sublist" refer-name="department">
			<sky:include page="com/doublechaintech/retailscm/provincecenteremployee/ProvinceCenterEmployee$List.jsp"
					referName="department"/>
		</div>
	</c:if>
