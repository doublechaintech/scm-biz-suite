...
<c:if test="${ empty provinceCenterDepartmentList}" >
 ...
 <c:if test="${not empty provinceCenterDepartmentList}" >
    
    
<%

 	SmartList list=(SmartList)request.getAttribute("provinceCenterDepartmentList"); 
...
<c:set var="currentPageNumber" value="${page.pageNumber}"/>
	...
	<li class="page-item ${classType}">
		<a href='#${ownerBeanName}Manager/load${ownerClassName}/${result.id}/${provinceCenterDepartmentListName};${provinceCenterDepartmentListName}CurrentPage=${page.pageNumber};${provinceCenterDepartmentListName}RowsPerPage=${rowsPerPage}/' 
...
<th>${userContext.localeMap['@action']}</th>
		...
		<tbody>
			...
			<c:forEach var="item" items="${provinceCenterDepartmentList}">
				<tr currentVersion='${item.version}' id="provinceCenterDepartment-${item.id}" ><td><a class="link-action-removed" href="./provinceCenterDepartmentManager/view/${item.id}/"> ${item.id}</a></td>
...
</c:if><c:if test="${param.referName ne 'provinceCenter'}">
	<td class="select_candidate_td"
			data-candidate-method="./provinceCenterDepartmentManager/requestCandidateProvinceCenter/${ownerBeanName}/${item.id}/"
			data-switch-method="./provinceCenterDepartmentManager/transferToAnotherProvinceCenter/${item.id}/"
