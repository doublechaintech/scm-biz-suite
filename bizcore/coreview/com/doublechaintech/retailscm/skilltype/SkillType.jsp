<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.skilltype.SkillType'%>
...
<c:set var="ownerBeanName" value="skillType" scope="request"/>
<c:set var="ownerClassName" value="SkillType" scope="request"/>
...
<div class="row">
	...
	<% SkillType result = (SkillType)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="skillType" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/skilltype/SkillType$Summary.jsp" />
...
<sky:include page="com/doublechaintech/retailscm/retailstorecountrycenter/RetailStoreCountryCenter$Info.jsp" />
		...
		<div id="employeeSkillList" class="tab-pane fade sublist" refer-name="skill_type">
