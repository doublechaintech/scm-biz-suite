<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.retailstoreorderprocessing.RetailStoreOrderProcessing'%>
...
<c:set var="ownerBeanName" value="retailStoreOrderProcessing" scope="request"/>
<c:set var="ownerClassName" value="RetailStoreOrderProcessing" scope="request"/>
...
<div class="row">
	...
	<% RetailStoreOrderProcessing result = (RetailStoreOrderProcessing)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="retailStoreOrderProcessing" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/retailstoreorderprocessing/RetailStoreOrderProcessing$Summary.jsp" />
		...
		<div id="retailStoreOrderList" class="tab-pane fade sublist" refer-name="processing">
