<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.employeeboarding.EmployeeBoarding'%>
...
<c:set var="ownerBeanName" value="employeeBoarding" scope="request"/>
<c:set var="ownerClassName" value="EmployeeBoarding" scope="request"/>
...
<div class="row">
	...
	<% EmployeeBoarding result = (EmployeeBoarding)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="employeeBoarding" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/employeeboarding/EmployeeBoarding$Summary.jsp" />
		...
		<div id="employeeList" class="tab-pane fade sublist" refer-name="employee_boarding">
			<sky:include page="com/doublechaintech/retailscm/employee/Employee$List.jsp"
					referName="employeeBoarding"/>
		</div>
	</c:if>
