<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.formmessage.FormMessage'%>
...
<sky:include page="com/doublechaintech/retailscm/formmessage/FormMessage$Summary.jsp" />
