<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.supplierproduct.SupplierProduct'%>
...
<c:set var="ownerBeanName" value="supplierProduct" scope="request"/>
<c:set var="ownerClassName" value="SupplierProduct" scope="request"/>
...
<div class="row">
	...
	<% SupplierProduct result = (SupplierProduct)request.getAttribute("result");  %>
			<li><a data-toggle="tab" href="#productSupplyDurationList" class="disabled"> ${userContext.localeMap['product_supply_duration']}</a></li>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="supplierProduct" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/supplierproduct/SupplierProduct$Summary.jsp" />
	...
	<div class="row">
<c:set var="goodsSupplier" value="${ result.supplier}" scope="request" />
<c:set var="referName" value="(supplier)" scope="request" />
<sky:include page="com/doublechaintech/retailscm/goodssupplier/GoodsSupplier$Info.jsp" />
		...
		<c:if test='${not empty userContext.accessTokens["productSupplyDurationList"] or ignoreListAccessControl}'>
		<c:set var="productSupplyDurationList" value="${result.productSupplyDurationList}" scope="request"/>
		<c:set var="productSupplyDurationListName" value="productSupplyDurationList" scope="request"/>
		<div id="productSupplyDurationList" class="tab-pane fade sublist" refer-name="product">
			<sky:include page="com/doublechaintech/retailscm/productsupplyduration/ProductSupplyDuration$List.jsp"
					referName="product"/>
		</div>
	</c:if>
