<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.leveltwodepartment.LevelTwoDepartment'%>
...
<c:set var="ownerBeanName" value="levelTwoDepartment" scope="request"/>
<c:set var="ownerClassName" value="LevelTwoDepartment" scope="request"/>
...
<div class="row">
	...
	<% LevelTwoDepartment result = (LevelTwoDepartment)request.getAttribute("result");  %>
			<li><a data-toggle="tab" href="#levelThreeDepartmentList" class="disabled"> ${userContext.localeMap['level_three_department']}</a></li>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="levelTwoDepartment" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/leveltwodepartment/LevelTwoDepartment$Summary.jsp" />
	...
	<div class="row">
<c:set var="levelOneDepartment" value="${ result.belongsTo}" scope="request" />
<c:set var="referName" value="(belongsTo)" scope="request" />
<sky:include page="com/doublechaintech/retailscm/levelonedepartment/LevelOneDepartment$Info.jsp" />
		...
		<c:if test='${not empty userContext.accessTokens["levelThreeDepartmentList"] or ignoreListAccessControl}'>
		<c:set var="levelThreeDepartmentList" value="${result.levelThreeDepartmentList}" scope="request"/>
		<c:set var="levelThreeDepartmentListName" value="levelThreeDepartmentList" scope="request"/>
		<div id="levelThreeDepartmentList" class="tab-pane fade sublist" refer-name="belongs_to">
			<sky:include page="com/doublechaintech/retailscm/levelthreedepartment/LevelThreeDepartment$List.jsp"
					referName="belongsTo"/>
		</div>
	</c:if>
