<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.memberwishlist.MemberWishlist'%>
...
<c:set var="ownerBeanName" value="memberWishlist" scope="request"/>
<c:set var="ownerClassName" value="MemberWishlist" scope="request"/>
...
<div class="row">
	...
	<% MemberWishlist result = (MemberWishlist)request.getAttribute("result");  %>
			<li><a data-toggle="tab" href="#memberWishlistProductList" class="disabled"> ${userContext.localeMap['member_wishlist_product']}</a></li>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="memberWishlist" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/memberwishlist/MemberWishlist$Summary.jsp" />
	...
	<div class="row">
<c:set var="retailStoreMember" value="${ result.owner}" scope="request" />
...
<sky:include page="com/doublechaintech/retailscm/retailstoremember/RetailStoreMember$Info.jsp" />
		...
		<c:if test='${not empty userContext.accessTokens["memberWishlistProductList"] or ignoreListAccessControl}'>
		<c:set var="memberWishlistProductList" value="${result.memberWishlistProductList}" scope="request"/>
		<c:set var="memberWishlistProductListName" value="memberWishlistProductList" scope="request"/>
		<div id="memberWishlistProductList" class="tab-pane fade sublist" refer-name="owner">
			<sky:include page="com/doublechaintech/retailscm/memberwishlistproduct/MemberWishlistProduct$List.jsp"
					referName="owner"/>
		</div>
	</c:if>
