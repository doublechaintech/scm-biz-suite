<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.userallowlist.UserAllowList'%>
...
<c:set var="ownerBeanName" value="userAllowList" scope="request"/>
<c:set var="ownerClassName" value="UserAllowList" scope="request"/>
...
<div class="row">
	...
	<% UserAllowList result = (UserAllowList)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="userAllowList" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/userallowlist/UserAllowList$Summary.jsp" />
