<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.retailstoreorderpaymentgroup.RetailStoreOrderPaymentGroup'%>
...
<c:set var="ownerBeanName" value="retailStoreOrderPaymentGroup" scope="request"/>
<c:set var="ownerClassName" value="RetailStoreOrderPaymentGroup" scope="request"/>
...
<div class="row">
	...
	<% RetailStoreOrderPaymentGroup result = (RetailStoreOrderPaymentGroup)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="retailStoreOrderPaymentGroup" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/retailstoreorderpaymentgroup/RetailStoreOrderPaymentGroup$Summary.jsp" />
