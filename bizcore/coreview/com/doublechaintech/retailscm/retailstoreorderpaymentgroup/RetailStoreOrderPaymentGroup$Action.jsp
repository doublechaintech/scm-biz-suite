...
<div class="col-xs-12 col-ms-4 col-md-3 action-section" >
	<b title="A RetailStoreOrderPaymentGroup" style="color: green">${userContext.localeMap['retail_store_order_payment_group']}</b>
	<hr/>
	<ul>
	
	
	<li><span>${userContext.localeMap['retail_store_order_payment_group.id']}</span> ${retailStoreOrderPaymentGroup.id}</li>
