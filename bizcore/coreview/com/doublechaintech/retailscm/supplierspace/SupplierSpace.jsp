<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.supplierspace.SupplierSpace'%>
...
<c:set var="ownerBeanName" value="supplierSpace" scope="request"/>
<c:set var="ownerClassName" value="SupplierSpace" scope="request"/>
...
<div class="row">
	...
	<% SupplierSpace result = (SupplierSpace)request.getAttribute("result");  %>
			<li><a data-toggle="tab" href="#goodsShelfList" class="disabled"> ${userContext.localeMap['goods_shelf']}</a></li>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="supplierSpace" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/supplierspace/SupplierSpace$Summary.jsp" />
	...
	<div class="row">
<c:set var="warehouse" value="${ result.warehouse}" scope="request" />
<c:set var="referName" value="" scope="request" />
<sky:include page="com/doublechaintech/retailscm/warehouse/Warehouse$Info.jsp" />
		...
		<c:if test='${not empty userContext.accessTokens["goodsShelfList"] or ignoreListAccessControl}'>
		<c:set var="goodsShelfList" value="${result.goodsShelfList}" scope="request"/>
		<c:set var="goodsShelfListName" value="goodsShelfList" scope="request"/>
		<div id="goodsShelfList" class="tab-pane fade sublist" refer-name="supplier_space">
			<sky:include page="com/doublechaintech/retailscm/goodsshelf/GoodsShelf$List.jsp"
					referName="supplierSpace"/>
		</div>
	</c:if>
