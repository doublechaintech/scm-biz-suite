<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.memberrewardpointredemption.MemberRewardPointRedemption'%>
...
<c:set var="ownerBeanName" value="memberRewardPointRedemption" scope="request"/>
<c:set var="ownerClassName" value="MemberRewardPointRedemption" scope="request"/>
...
<div class="row">
	...
	<% MemberRewardPointRedemption result = (MemberRewardPointRedemption)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="memberRewardPointRedemption" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/memberrewardpointredemption/MemberRewardPointRedemption$Summary.jsp" />
