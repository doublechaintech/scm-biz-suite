<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.consumerorderapproval.ConsumerOrderApproval'%>
...
<c:set var="ownerBeanName" value="consumerOrderApproval" scope="request"/>
<c:set var="ownerClassName" value="ConsumerOrderApproval" scope="request"/>
...
<div class="row">
	...
	<% ConsumerOrderApproval result = (ConsumerOrderApproval)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="consumerOrderApproval" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/consumerorderapproval/ConsumerOrderApproval$Summary.jsp" />
