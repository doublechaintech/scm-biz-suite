<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.supplyorderpaymentgroup.SupplyOrderPaymentGroup'%>
...
<c:set var="ownerBeanName" value="supplyOrderPaymentGroup" scope="request"/>
<c:set var="ownerClassName" value="SupplyOrderPaymentGroup" scope="request"/>
...
<div class="row">
	...
	<% SupplyOrderPaymentGroup result = (SupplyOrderPaymentGroup)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="supplyOrderPaymentGroup" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/supplyorderpaymentgroup/SupplyOrderPaymentGroup$Summary.jsp" />
