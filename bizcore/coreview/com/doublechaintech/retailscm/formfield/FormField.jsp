<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.formfield.FormField'%>
...
<sky:include page="com/doublechaintech/retailscm/formfield/FormField$Summary.jsp" />
