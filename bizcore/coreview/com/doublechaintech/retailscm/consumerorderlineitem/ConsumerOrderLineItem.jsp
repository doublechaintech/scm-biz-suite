<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.consumerorderlineitem.ConsumerOrderLineItem'%>
...
<c:set var="ownerBeanName" value="consumerOrderLineItem" scope="request"/>
<c:set var="ownerClassName" value="ConsumerOrderLineItem" scope="request"/>
...
<div class="row">
	...
	<% ConsumerOrderLineItem result = (ConsumerOrderLineItem)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="consumerOrderLineItem" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/consumerorderlineitem/ConsumerOrderLineItem$Summary.jsp" />
