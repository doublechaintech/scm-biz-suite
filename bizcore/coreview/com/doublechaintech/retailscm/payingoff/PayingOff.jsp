<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.payingoff.PayingOff'%>
...
<c:set var="ownerBeanName" value="payingOff" scope="request"/>
<c:set var="ownerClassName" value="PayingOff" scope="request"/>
...
<div class="row">
	...
	<% PayingOff result = (PayingOff)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="payingOff" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/payingoff/PayingOff$Summary.jsp" />
	...
	<div class="row">
<c:set var="employee" value="${ result.paidFor}" scope="request" />
<c:set var="referName" value="(paidFor)" scope="request" />
<sky:include page="com/doublechaintech/retailscm/employee/Employee$Info.jsp" />
		...
		<div id="employeeSalarySheetList" class="tab-pane fade sublist" refer-name="paying_off">
