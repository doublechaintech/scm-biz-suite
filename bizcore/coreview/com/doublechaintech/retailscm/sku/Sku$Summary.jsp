...
<div class="col-xs-12 col-md-3 summary-section">
<span class="summary-label">${userContext.localeMap['sku.barcode']}</span>
<span >${result.barcode}</span>
</div>
<div class="col-xs-12 col-md-3 summary-section">
<span class="summary-label">${userContext.localeMap['sku.package_type']}</span>
<span >${result.packageType}</span>
</div>
<div class="col-xs-12 col-md-3 summary-section">
<span class="summary-label">${userContext.localeMap['sku.net_content']}</span>
<span >${result.netContent}</span>
</div>
<div class="col-xs-12 col-md-3 summary-section">
<span class="summary-label">${userContext.localeMap['sku.price']}</span>
<span ><fmt:formatNumber type="currency"  value="${result.price}" /></span>
</div>
<div class="col-xs-12 col-md-3 summary-section">
<span class="summary-label">${userContext.localeMap['sku.picture']}</span>
