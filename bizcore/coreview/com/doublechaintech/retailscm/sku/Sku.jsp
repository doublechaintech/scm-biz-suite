<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.sku.Sku'%>
...
<sky:include page="com/doublechaintech/retailscm/sku/Sku$Summary.jsp" />
...
<sky:include page="com/doublechaintech/retailscm/product/Product$Info.jsp" />
		...
		<div id="goodsList" class="tab-pane fade sublist" refer-name="sku">
