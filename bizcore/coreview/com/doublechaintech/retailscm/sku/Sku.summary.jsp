...
<section><h3>SKU(${result.id})</h3><table >
<tr><td class='th'>名称</td><td >${result.name}</td><td class='th'>大小</td><td >${result.size}</td></tr><tr><td class='th'>产品</td><td >${result.product.displayName}</td><td class='th'>条码</td><td >${result.barcode}</td></tr><tr><td class='th'>包装类型</td><td >${result.packageType}</td><td class='th'>净含量</td><td >${result.netContent}</td></tr><tr><td class='th'>价格</td><td >${result.price}</td><td class='th'>图片</td><td >${result.picture}</td></tr></table>
</section>
