...
<section><h3>双链小超的创作(${result.id})</h3><table >
<tr><td class='th'>评论</td><td >${result.comment}</td><td class='th'></td><td ></td></tr></table>
</section>
<section><c:if test="${not empty result.retailStoreList}">
