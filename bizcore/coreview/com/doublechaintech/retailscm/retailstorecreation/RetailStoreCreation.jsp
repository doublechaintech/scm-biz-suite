<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.retailstorecreation.RetailStoreCreation'%>
...
<c:set var="ownerBeanName" value="retailStoreCreation" scope="request"/>
<c:set var="ownerClassName" value="RetailStoreCreation" scope="request"/>
...
<div class="row">
	...
	<% RetailStoreCreation result = (RetailStoreCreation)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="retailStoreCreation" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/retailstorecreation/RetailStoreCreation$Summary.jsp" />
		...
		<div id="retailStoreList" class="tab-pane fade sublist" refer-name="creation">
