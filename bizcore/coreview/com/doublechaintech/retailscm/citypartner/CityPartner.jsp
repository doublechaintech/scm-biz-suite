<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.citypartner.CityPartner'%>
...
<c:set var="ownerBeanName" value="cityPartner" scope="request"/>
<c:set var="ownerClassName" value="CityPartner" scope="request"/>
...
<div class="row">
	...
	<% CityPartner result = (CityPartner)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="cityPartner" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/citypartner/CityPartner$Summary.jsp" />
...
<sky:include page="com/doublechaintech/retailscm/retailstorecityservicecenter/RetailStoreCityServiceCenter$Info.jsp" />
		...
		<div id="potentialCustomerList" class="tab-pane fade sublist" refer-name="city_partner">
			<sky:include page="com/doublechaintech/retailscm/potentialcustomer/PotentialCustomer$List.jsp"
					referName="cityPartner"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["potentialCustomerContactList"] or ignoreListAccessControl}'>
		...
		<div id="potentialCustomerContactList" class="tab-pane fade sublist" refer-name="city_partner">
