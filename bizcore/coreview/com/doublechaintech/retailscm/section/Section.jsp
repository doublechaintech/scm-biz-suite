<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.section.Section'%>
...
<c:set var="ownerBeanName" value="section" scope="request"/>
<c:set var="ownerClassName" value="Section" scope="request"/>
...
<div class="row">
	...
	<% Section result = (Section)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="section" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/section/Section$Summary.jsp" />
