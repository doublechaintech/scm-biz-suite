<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.offerapproval.OfferApproval'%>
...
<c:set var="ownerBeanName" value="offerApproval" scope="request"/>
<c:set var="ownerClassName" value="OfferApproval" scope="request"/>
...
<div class="row">
	...
	<% OfferApproval result = (OfferApproval)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="offerApproval" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/offerapproval/OfferApproval$Summary.jsp" />
		...
		<div id="employeeList" class="tab-pane fade sublist" refer-name="offer_approval">
			<sky:include page="com/doublechaintech/retailscm/employee/Employee$List.jsp"
					referName="offerApproval"/>
		</div>
	</c:if>
