<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.retailstoremembergiftcard.RetailStoreMemberGiftCard'%>
...
<c:set var="ownerBeanName" value="retailStoreMemberGiftCard" scope="request"/>
<c:set var="ownerClassName" value="RetailStoreMemberGiftCard" scope="request"/>
...
<div class="row">
	...
	<% RetailStoreMemberGiftCard result = (RetailStoreMemberGiftCard)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="retailStoreMemberGiftCard" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/retailstoremembergiftcard/RetailStoreMemberGiftCard$Summary.jsp" />
...
<sky:include page="com/doublechaintech/retailscm/retailstoremember/RetailStoreMember$Info.jsp" />
		...
		<div id="retailStoreMemberGiftCardConsumeRecordList" class="tab-pane fade sublist" refer-name="owner">
