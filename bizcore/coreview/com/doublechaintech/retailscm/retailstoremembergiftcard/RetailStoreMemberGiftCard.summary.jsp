...
<section><h3>零售店会员礼品卡(${result.id})</h3><table >
<tr><td class='th'>名称</td><td >${result.name}</td><td class='th'>业主</td><td >${result.owner.displayName}</td></tr><tr><td class='th'>数</td><td >${result.number}</td><td class='th'>保持</td><td >${result.remain}</td></tr></table>
</section>
<section><c:if test="${not empty result.retailStoreMemberGiftCardConsumeRecordList}">
