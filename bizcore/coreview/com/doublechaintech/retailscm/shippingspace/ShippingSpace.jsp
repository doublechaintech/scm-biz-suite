<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.shippingspace.ShippingSpace'%>
...
<c:set var="ownerBeanName" value="shippingSpace" scope="request"/>
<c:set var="ownerClassName" value="ShippingSpace" scope="request"/>
...
<div class="row">
	...
	<% ShippingSpace result = (ShippingSpace)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="shippingSpace" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/shippingspace/ShippingSpace$Summary.jsp" />
...
<sky:include page="com/doublechaintech/retailscm/warehouse/Warehouse$Info.jsp" />
		...
		<div id="goodsList" class="tab-pane fade sublist" refer-name="shipping_space">
			<sky:include page="com/doublechaintech/retailscm/goods/Goods$List.jsp"
					referName="shippingSpace"/>
		</div>
	</c:if>
