<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.formaction.FormAction'%>
...
<sky:include page="com/doublechaintech/retailscm/formaction/FormAction$Summary.jsp" />
