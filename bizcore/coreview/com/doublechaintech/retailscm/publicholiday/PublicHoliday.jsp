<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.publicholiday.PublicHoliday'%>
...
<c:set var="ownerBeanName" value="publicHoliday" scope="request"/>
<c:set var="ownerClassName" value="PublicHoliday" scope="request"/>
...
<div class="row">
	...
	<% PublicHoliday result = (PublicHoliday)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="publicHoliday" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/publicholiday/PublicHoliday$Summary.jsp" />
