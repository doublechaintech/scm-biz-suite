<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.retailstoreorderlineitem.RetailStoreOrderLineItem'%>
...
<c:set var="ownerBeanName" value="retailStoreOrderLineItem" scope="request"/>
<c:set var="ownerClassName" value="RetailStoreOrderLineItem" scope="request"/>
...
<div class="row">
	...
	<% RetailStoreOrderLineItem result = (RetailStoreOrderLineItem)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="retailStoreOrderLineItem" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/retailstoreorderlineitem/RetailStoreOrderLineItem$Summary.jsp" />
