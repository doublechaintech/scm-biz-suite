<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.leavetype.LeaveType'%>
...
<c:set var="ownerBeanName" value="leaveType" scope="request"/>
<c:set var="ownerClassName" value="LeaveType" scope="request"/>
...
<div class="row">
	...
	<% LeaveType result = (LeaveType)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="leaveType" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/leavetype/LeaveType$Summary.jsp" />
...
<sky:include page="com/doublechaintech/retailscm/retailstorecountrycenter/RetailStoreCountryCenter$Info.jsp" />
		...
		<div id="employeeLeaveList" class="tab-pane fade sublist" refer-name="type">
