<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.jobapplication.JobApplication'%>
...
<c:set var="ownerBeanName" value="jobApplication" scope="request"/>
<c:set var="ownerClassName" value="JobApplication" scope="request"/>
...
<div class="row">
	...
	<% JobApplication result = (JobApplication)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="jobApplication" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/jobapplication/JobApplication$Summary.jsp" />
		...
		<div id="employeeList" class="tab-pane fade sublist" refer-name="job_application">
			<sky:include page="com/doublechaintech/retailscm/employee/Employee$List.jsp"
					referName="jobApplication"/>
		</div>
	</c:if>
