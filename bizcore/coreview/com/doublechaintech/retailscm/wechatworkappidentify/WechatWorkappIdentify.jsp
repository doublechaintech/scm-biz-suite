<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.wechatworkappidentify.WechatWorkappIdentify'%>
...
<c:set var="ownerBeanName" value="wechatWorkappIdentify" scope="request"/>
<c:set var="ownerClassName" value="WechatWorkappIdentify" scope="request"/>
...
<div class="row">
	...
	<% WechatWorkappIdentify result = (WechatWorkappIdentify)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="wechatWorkappIdentify" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/wechatworkappidentify/WechatWorkappIdentify$Summary.jsp" />
