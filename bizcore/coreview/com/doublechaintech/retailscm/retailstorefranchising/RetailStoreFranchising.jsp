<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.retailstorefranchising.RetailStoreFranchising'%>
...
<c:set var="ownerBeanName" value="retailStoreFranchising" scope="request"/>
<c:set var="ownerClassName" value="RetailStoreFranchising" scope="request"/>
...
<div class="row">
	...
	<% RetailStoreFranchising result = (RetailStoreFranchising)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="retailStoreFranchising" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/retailstorefranchising/RetailStoreFranchising$Summary.jsp" />
		...
		<div id="retailStoreList" class="tab-pane fade sublist" refer-name="franchising">
			<sky:include page="com/doublechaintech/retailscm/retailstore/RetailStore$List.jsp"
					referName="franchising"/>
		</div>
	</c:if>
