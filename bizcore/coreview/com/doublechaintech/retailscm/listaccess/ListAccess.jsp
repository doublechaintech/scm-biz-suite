<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.listaccess.ListAccess'%>
...
<sky:include page="com/doublechaintech/retailscm/listaccess/ListAccess$Summary.jsp" />
