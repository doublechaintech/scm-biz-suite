...
<section><h3>货位(${result.id})</h3><table >
<tr><td class='th'>位置</td><td >${result.location}</td><td class='th'>纬度</td><td >${result.latitude}</td></tr><tr><td class='th'>经度</td><td >${result.longitude}</td><td class='th'>货架</td><td >${result.goodsShelf.displayName}</td></tr></table>
</section>
