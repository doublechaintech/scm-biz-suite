<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.goodsallocation.GoodsAllocation'%>
...
<c:set var="ownerBeanName" value="goodsAllocation" scope="request"/>
<c:set var="ownerClassName" value="GoodsAllocation" scope="request"/>
...
<div class="row">
	...
	<% GoodsAllocation result = (GoodsAllocation)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="goodsAllocation" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/goodsallocation/GoodsAllocation$Summary.jsp" />
	...
	<div class="row">
<c:set var="goodsShelf" value="${ result.goodsShelf}" scope="request" />
...
<sky:include page="com/doublechaintech/retailscm/goodsshelf/GoodsShelf$Info.jsp" />
		...
		<div id="goodsList" class="tab-pane fade sublist" refer-name="goods_allocation">
			<sky:include page="com/doublechaintech/retailscm/goods/Goods$List.jsp"
					referName="goodsAllocation"/>
		</div>
	</c:if>
