<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.supplyorderdelivery.SupplyOrderDelivery'%>
...
<c:set var="ownerBeanName" value="supplyOrderDelivery" scope="request"/>
<c:set var="ownerClassName" value="SupplyOrderDelivery" scope="request"/>
...
<div class="row">
	...
	<% SupplyOrderDelivery result = (SupplyOrderDelivery)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="supplyOrderDelivery" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/supplyorderdelivery/SupplyOrderDelivery$Summary.jsp" />
		...
		<div id="consumerOrderList" class="tab-pane fade sublist" refer-name="delivery">
	...
	<c:if test='${not empty userContext.accessTokens["supplyOrderList"] or ignoreListAccessControl}'>
		...
		<div id="supplyOrderList" class="tab-pane fade sublist" refer-name="delivery">
