<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.termination.Termination'%>
...
<c:set var="ownerBeanName" value="termination" scope="request"/>
<c:set var="ownerClassName" value="Termination" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="termination" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/termination/Termination$Summary.jsp" />
