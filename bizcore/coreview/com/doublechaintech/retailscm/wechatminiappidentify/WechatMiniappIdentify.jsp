<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.wechatminiappidentify.WechatMiniappIdentify'%>
...
<c:set var="ownerBeanName" value="wechatMiniappIdentify" scope="request"/>
<c:set var="ownerClassName" value="WechatMiniappIdentify" scope="request"/>
...
<div class="row">
	...
	<% WechatMiniappIdentify result = (WechatMiniappIdentify)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="wechatMiniappIdentify" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/wechatminiappidentify/WechatMiniappIdentify$Summary.jsp" />
