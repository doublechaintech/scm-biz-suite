<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.receivingspace.ReceivingSpace'%>
...
<c:set var="ownerBeanName" value="receivingSpace" scope="request"/>
<c:set var="ownerClassName" value="ReceivingSpace" scope="request"/>
...
<div class="row">
	...
	<% ReceivingSpace result = (ReceivingSpace)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="receivingSpace" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/receivingspace/ReceivingSpace$Summary.jsp" />
...
<sky:include page="com/doublechaintech/retailscm/warehouse/Warehouse$Info.jsp" />
		...
		<div id="goodsList" class="tab-pane fade sublist" refer-name="receiving_space">
			<sky:include page="com/doublechaintech/retailscm/goods/Goods$List.jsp"
					referName="receivingSpace"/>
		</div>
	</c:if>
