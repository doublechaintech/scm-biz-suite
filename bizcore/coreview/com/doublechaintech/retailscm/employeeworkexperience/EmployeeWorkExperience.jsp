<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.employeeworkexperience.EmployeeWorkExperience'%>
...
<c:set var="ownerBeanName" value="employeeWorkExperience" scope="request"/>
<c:set var="ownerClassName" value="EmployeeWorkExperience" scope="request"/>
...
<div class="row">
	...
	<% EmployeeWorkExperience result = (EmployeeWorkExperience)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="employeeWorkExperience" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/employeeworkexperience/EmployeeWorkExperience$Summary.jsp" />
