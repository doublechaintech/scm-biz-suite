<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.retailstoreopening.RetailStoreOpening'%>
...
<c:set var="ownerBeanName" value="retailStoreOpening" scope="request"/>
<c:set var="ownerClassName" value="RetailStoreOpening" scope="request"/>
...
<div class="row">
	...
	<% RetailStoreOpening result = (RetailStoreOpening)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="retailStoreOpening" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/retailstoreopening/RetailStoreOpening$Summary.jsp" />
		...
		<div id="retailStoreList" class="tab-pane fade sublist" refer-name="opening">
