...
<div class="col-xs-12 col-md-12 section">
	<b title="A RetailStoreProvinceCenter"> 
		${userContext.localeMap['retail_store_province_center']}${userContext.localeMap['@word_space']}${userContext.localeMap['@summary']}
		</b>
...
<span class="summary-label">${userContext.localeMap['retail_store_province_center.id']}</span>
<span >${result.id}</span>
</div>
<div class="col-xs-12 col-md-3 summary-section">
<span class="summary-label">${userContext.localeMap['retail_store_province_center.name']}</span>
