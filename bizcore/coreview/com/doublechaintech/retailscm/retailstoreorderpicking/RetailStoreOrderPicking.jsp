<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.retailstoreorderpicking.RetailStoreOrderPicking'%>
...
<c:set var="ownerBeanName" value="retailStoreOrderPicking" scope="request"/>
<c:set var="ownerClassName" value="RetailStoreOrderPicking" scope="request"/>
...
<div class="row">
	...
	<% RetailStoreOrderPicking result = (RetailStoreOrderPicking)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="retailStoreOrderPicking" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/retailstoreorderpicking/RetailStoreOrderPicking$Summary.jsp" />
		...
		<div id="retailStoreOrderList" class="tab-pane fade sublist" refer-name="picking">
