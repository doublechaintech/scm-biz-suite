<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.damagespace.DamageSpace'%>
...
<c:set var="ownerBeanName" value="damageSpace" scope="request"/>
<c:set var="ownerClassName" value="DamageSpace" scope="request"/>
...
<div class="row">
	...
	<% DamageSpace result = (DamageSpace)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="damageSpace" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/damagespace/DamageSpace$Summary.jsp" />
...
<sky:include page="com/doublechaintech/retailscm/warehouse/Warehouse$Info.jsp" />
		...
		<div id="goodsShelfList" class="tab-pane fade sublist" refer-name="damage_space">
			<sky:include page="com/doublechaintech/retailscm/goodsshelf/GoodsShelf$List.jsp"
					referName="damageSpace"/>
		</div>
	</c:if>
