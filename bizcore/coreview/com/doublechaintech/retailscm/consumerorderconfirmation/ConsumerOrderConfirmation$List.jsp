...
<c:if test="${ empty consumerOrderConfirmationList}" >
 ...
 <c:if test="${not empty consumerOrderConfirmationList}" >
    
    
<%

 	SmartList list=(SmartList)request.getAttribute("consumerOrderConfirmationList"); 
...
<c:set var="currentPageNumber" value="${page.pageNumber}"/>
	...
	<li class="page-item ${classType}">
		<a href='#${ownerBeanName}Manager/load${ownerClassName}/${result.id}/${consumerOrderConfirmationListName};${consumerOrderConfirmationListName}CurrentPage=${page.pageNumber};${consumerOrderConfirmationListName}RowsPerPage=${rowsPerPage}/' 
...
<th>${userContext.localeMap['@action']}</th>
		...
		<tbody>
			...
			<c:forEach var="item" items="${consumerOrderConfirmationList}">
				<tr currentVersion='${item.version}' id="consumerOrderConfirmation-${item.id}" ><td><a class="link-action-removed" href="./consumerOrderConfirmationManager/view/${item.id}/"> ${item.id}</a></td>
