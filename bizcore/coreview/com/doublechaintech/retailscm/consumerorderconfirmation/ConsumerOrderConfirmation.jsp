<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.consumerorderconfirmation.ConsumerOrderConfirmation'%>
...
<c:set var="ownerBeanName" value="consumerOrderConfirmation" scope="request"/>
<c:set var="ownerClassName" value="ConsumerOrderConfirmation" scope="request"/>
...
<div class="row">
	...
	<% ConsumerOrderConfirmation result = (ConsumerOrderConfirmation)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="consumerOrderConfirmation" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/consumerorderconfirmation/ConsumerOrderConfirmation$Summary.jsp" />
