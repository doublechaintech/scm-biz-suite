<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.occupationtype.OccupationType'%>
...
<c:set var="ownerBeanName" value="occupationType" scope="request"/>
<c:set var="ownerClassName" value="OccupationType" scope="request"/>
...
<div class="row">
	...
	<% OccupationType result = (OccupationType)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="occupationType" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/occupationtype/OccupationType$Summary.jsp" />
...
<sky:include page="com/doublechaintech/retailscm/retailstorecountrycenter/RetailStoreCountryCenter$Info.jsp" />
		...
		<div id="employeeList" class="tab-pane fade sublist" refer-name="occupation">
			<sky:include page="com/doublechaintech/retailscm/employee/Employee$List.jsp"
					referName="occupation"/>
		</div>
	</c:if>
