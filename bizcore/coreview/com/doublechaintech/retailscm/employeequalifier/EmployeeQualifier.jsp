<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.employeequalifier.EmployeeQualifier'%>
...
<c:set var="ownerBeanName" value="employeeQualifier" scope="request"/>
<c:set var="ownerClassName" value="EmployeeQualifier" scope="request"/>
...
<div class="row">
	...
	<% EmployeeQualifier result = (EmployeeQualifier)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="employeeQualifier" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/employeequalifier/EmployeeQualifier$Summary.jsp" />
