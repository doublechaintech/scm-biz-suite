<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.consumerordershipment.ConsumerOrderShipment'%>
...
<c:set var="ownerBeanName" value="consumerOrderShipment" scope="request"/>
<c:set var="ownerClassName" value="ConsumerOrderShipment" scope="request"/>
...
<div class="row">
	...
	<% ConsumerOrderShipment result = (ConsumerOrderShipment)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="consumerOrderShipment" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/consumerordershipment/ConsumerOrderShipment$Summary.jsp" />
