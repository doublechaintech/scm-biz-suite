<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.retailstorememberaddress.RetailStoreMemberAddress'%>
...
<c:set var="ownerBeanName" value="retailStoreMemberAddress" scope="request"/>
<c:set var="ownerClassName" value="RetailStoreMemberAddress" scope="request"/>
...
<div class="row">
	...
	<% RetailStoreMemberAddress result = (RetailStoreMemberAddress)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="retailStoreMemberAddress" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/retailstorememberaddress/RetailStoreMemberAddress$Summary.jsp" />
