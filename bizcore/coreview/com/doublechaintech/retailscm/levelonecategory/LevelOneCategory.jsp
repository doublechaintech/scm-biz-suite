<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.levelonecategory.LevelOneCategory'%>
...
<sky:include page="com/doublechaintech/retailscm/levelonecategory/LevelOneCategory$Summary.jsp" />
...
<sky:include page="com/doublechaintech/retailscm/catalog/Catalog$Info.jsp" />
		...
		<div id="levelTwoCategoryList" class="tab-pane fade sublist" refer-name="parent_category">
			<sky:include page="com/doublechaintech/retailscm/leveltwocategory/LevelTwoCategory$List.jsp"
