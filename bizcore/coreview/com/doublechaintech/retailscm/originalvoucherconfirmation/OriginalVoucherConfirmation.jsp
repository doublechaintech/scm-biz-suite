<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.originalvoucherconfirmation.OriginalVoucherConfirmation'%>
...
<c:set var="ownerBeanName" value="originalVoucherConfirmation" scope="request"/>
<c:set var="ownerClassName" value="OriginalVoucherConfirmation" scope="request"/>
...
<div class="row">
	...
	<% OriginalVoucherConfirmation result = (OriginalVoucherConfirmation)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="originalVoucherConfirmation" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/originalvoucherconfirmation/OriginalVoucherConfirmation$Summary.jsp" />
		...
		<div id="originalVoucherList" class="tab-pane fade sublist" refer-name="confirmation">
