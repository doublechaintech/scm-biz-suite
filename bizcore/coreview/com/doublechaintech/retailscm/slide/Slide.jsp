<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.slide.Slide'%>
...
<c:set var="ownerBeanName" value="slide" scope="request"/>
<c:set var="ownerClassName" value="Slide" scope="request"/>
...
<div class="row">
	...
	<% Slide result = (Slide)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="slide" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/slide/Slide$Summary.jsp" />
