<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.provincecenteremployee.ProvinceCenterEmployee'%>
...
<c:set var="ownerBeanName" value="provinceCenterEmployee" scope="request"/>
<c:set var="ownerClassName" value="ProvinceCenterEmployee" scope="request"/>
...
<div class="row">
	...
	<% ProvinceCenterEmployee result = (ProvinceCenterEmployee)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="provinceCenterEmployee" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/provincecenteremployee/ProvinceCenterEmployee$Summary.jsp" />
