<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.userapp.UserApp'%>
...
<sky:include page="com/doublechaintech/retailscm/userapp/UserApp$Summary.jsp" />
...
<sky:include page="com/doublechaintech/retailscm/secuser/SecUser$Info.jsp" />
		...
		<div id="listAccessList" class="tab-pane fade sublist" refer-name="app">
			<sky:include page="com/doublechaintech/retailscm/listaccess/ListAccess$List.jsp"
					referName="app"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["objectAccessList"] or ignoreListAccessControl}'>
		...
		<div id="objectAccessList" class="tab-pane fade sublist" refer-name="app">
			<sky:include page="com/doublechaintech/retailscm/objectaccess/ObjectAccess$List.jsp"
					referName="app"/>
		</div>
	</c:if>
