<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.retailstoreorderapproval.RetailStoreOrderApproval'%>
...
<c:set var="ownerBeanName" value="retailStoreOrderApproval" scope="request"/>
<c:set var="ownerClassName" value="RetailStoreOrderApproval" scope="request"/>
...
<div class="row">
	...
	<% RetailStoreOrderApproval result = (RetailStoreOrderApproval)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="retailStoreOrderApproval" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/retailstoreorderapproval/RetailStoreOrderApproval$Summary.jsp" />
		...
		<div id="retailStoreOrderList" class="tab-pane fade sublist" refer-name="approval">
