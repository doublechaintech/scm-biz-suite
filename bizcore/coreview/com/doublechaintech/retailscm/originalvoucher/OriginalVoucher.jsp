<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.originalvoucher.OriginalVoucher'%>
...
<c:set var="ownerBeanName" value="originalVoucher" scope="request"/>
<c:set var="ownerClassName" value="OriginalVoucher" scope="request"/>
...
<div class="row">
	...
	<% OriginalVoucher result = (OriginalVoucher)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="originalVoucher" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/originalvoucher/OriginalVoucher$Summary.jsp" />
...
<sky:include page="com/doublechaintech/retailscm/originalvouchercreation/OriginalVoucherCreation$Action.jsp" />

<c:set var="originalVoucherConfirmation" value="${ result.confirmation}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/originalvoucherconfirmation/OriginalVoucherConfirmation$Action.jsp" />

<c:set var="originalVoucherAuditing" value="${ result.auditing}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/originalvoucherauditing/OriginalVoucherAuditing$Action.jsp" />
