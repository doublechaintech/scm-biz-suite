...
<section><h3>潜在客户联络人(${result.id})</h3><table >
<tr><td class='th'>名称</td><td >${result.name}</td><td class='th'>手机</td><td >${result.mobile}</td></tr><tr><td class='th'>潜在的客户</td><td >${result.potentialCustomer.displayName}</td><td class='th'>描述</td><td >${result.description}</td></tr></table>
</section>
<section><c:if test="${not empty result.potentialCustomerContactList}">
