<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.potentialcustomercontactperson.PotentialCustomerContactPerson'%>
...
<c:set var="ownerBeanName" value="potentialCustomerContactPerson" scope="request"/>
<c:set var="ownerClassName" value="PotentialCustomerContactPerson" scope="request"/>
...
<div class="row">
	...
	<% PotentialCustomerContactPerson result = (PotentialCustomerContactPerson)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="potentialCustomerContactPerson" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/potentialcustomercontactperson/PotentialCustomerContactPerson$Summary.jsp" />
...
<sky:include page="com/doublechaintech/retailscm/potentialcustomer/PotentialCustomer$Info.jsp" />
		...
		<div id="potentialCustomerContactList" class="tab-pane fade sublist" refer-name="contact_to">
