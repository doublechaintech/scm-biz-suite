<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.reportline.ReportLine'%>
...
<c:set var="ownerBeanName" value="reportLine" scope="request"/>
<c:set var="ownerClassName" value="ReportLine" scope="request"/>
...
<div class="row">
	...
	<% ReportLine result = (ReportLine)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="reportLine" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/reportline/ReportLine$Summary.jsp" />
	...
	<div class="row">
<c:set var="report" value="${ result.owner}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/report/Report$Info.jsp" />
