<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.consumerorderdelivery.ConsumerOrderDelivery'%>
...
<c:set var="ownerBeanName" value="consumerOrderDelivery" scope="request"/>
<c:set var="ownerClassName" value="ConsumerOrderDelivery" scope="request"/>
...
<div class="row">
	...
	<% ConsumerOrderDelivery result = (ConsumerOrderDelivery)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="consumerOrderDelivery" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/consumerorderdelivery/ConsumerOrderDelivery$Summary.jsp" />
