<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.wechatworkappidentity.WechatWorkappIdentity'%>
...
<c:set var="ownerBeanName" value="wechatWorkappIdentity" scope="request"/>
<c:set var="ownerClassName" value="WechatWorkappIdentity" scope="request"/>
...
<div class="row">
	...
	<% WechatWorkappIdentity result = (WechatWorkappIdentity)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="wechatWorkappIdentity" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/wechatworkappidentity/WechatWorkappIdentity$Summary.jsp" />
