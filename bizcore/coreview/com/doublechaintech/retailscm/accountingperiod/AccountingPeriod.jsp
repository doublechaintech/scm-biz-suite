<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.accountingperiod.AccountingPeriod'%>
...
<c:set var="ownerBeanName" value="accountingPeriod" scope="request"/>
<c:set var="ownerClassName" value="AccountingPeriod" scope="request"/>
...
<div class="row">
	...
	<% AccountingPeriod result = (AccountingPeriod)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="accountingPeriod" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/accountingperiod/AccountingPeriod$Summary.jsp" />
...
<sky:include page="com/doublechaintech/retailscm/accountset/AccountSet$Info.jsp" />
		...
		<div id="accountingDocumentList" class="tab-pane fade sublist" refer-name="accounting_period">
