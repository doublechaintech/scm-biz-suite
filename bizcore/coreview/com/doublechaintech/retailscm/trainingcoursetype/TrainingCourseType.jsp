<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.trainingcoursetype.TrainingCourseType'%>
...
<c:set var="ownerBeanName" value="trainingCourseType" scope="request"/>
<c:set var="ownerClassName" value="TrainingCourseType" scope="request"/>
...
<div class="row">
	...
	<% TrainingCourseType result = (TrainingCourseType)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="trainingCourseType" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/trainingcoursetype/TrainingCourseType$Summary.jsp" />
...
<sky:include page="com/doublechaintech/retailscm/retailstorecountrycenter/RetailStoreCountryCenter$Info.jsp" />
		...
		<div id="companyTrainingList" class="tab-pane fade sublist" refer-name="training_course_type">
			<sky:include page="com/doublechaintech/retailscm/companytraining/CompanyTraining$List.jsp"
					referName="trainingCourseType"/>
		</div>
	</c:if>
