<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.smartpallet.SmartPallet'%>
...
<c:set var="ownerBeanName" value="smartPallet" scope="request"/>
<c:set var="ownerClassName" value="SmartPallet" scope="request"/>
...
<div class="row">
	...
	<% SmartPallet result = (SmartPallet)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="smartPallet" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/smartpallet/SmartPallet$Summary.jsp" />
...
<sky:include page="com/doublechaintech/retailscm/warehouse/Warehouse$Info.jsp" />
		...
		<div id="goodsList" class="tab-pane fade sublist" refer-name="smart_pallet">
			<sky:include page="com/doublechaintech/retailscm/goods/Goods$List.jsp"
					referName="smartPallet"/>
		</div>
	</c:if>
