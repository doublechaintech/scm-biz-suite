<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.storagespace.StorageSpace'%>
...
<c:set var="ownerBeanName" value="storageSpace" scope="request"/>
<c:set var="ownerClassName" value="StorageSpace" scope="request"/>
...
<div class="row">
	...
	<% StorageSpace result = (StorageSpace)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="storageSpace" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/storagespace/StorageSpace$Summary.jsp" />
...
<sky:include page="com/doublechaintech/retailscm/warehouse/Warehouse$Info.jsp" />
		...
		<div id="goodsShelfList" class="tab-pane fade sublist" refer-name="storage_space">
			<sky:include page="com/doublechaintech/retailscm/goodsshelf/GoodsShelf$List.jsp"
					referName="storageSpace"/>
		</div>
	</c:if>
