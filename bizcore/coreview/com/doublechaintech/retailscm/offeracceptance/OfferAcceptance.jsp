<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.offeracceptance.OfferAcceptance'%>
...
<c:set var="ownerBeanName" value="offerAcceptance" scope="request"/>
<c:set var="ownerClassName" value="OfferAcceptance" scope="request"/>
...
<div class="row">
	...
	<% OfferAcceptance result = (OfferAcceptance)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="offerAcceptance" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/offeracceptance/OfferAcceptance$Summary.jsp" />
		...
		<div id="employeeList" class="tab-pane fade sublist" refer-name="offer_acceptance">
			<sky:include page="com/doublechaintech/retailscm/employee/Employee$List.jsp"
					referName="offerAcceptance"/>
		</div>
	</c:if>
