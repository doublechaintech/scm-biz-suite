<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.interviewtype.InterviewType'%>
...
<c:set var="ownerBeanName" value="interviewType" scope="request"/>
<c:set var="ownerClassName" value="InterviewType" scope="request"/>
...
<div class="row">
	...
	<% InterviewType result = (InterviewType)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="interviewType" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/interviewtype/InterviewType$Summary.jsp" />
...
<sky:include page="com/doublechaintech/retailscm/retailstorecountrycenter/RetailStoreCountryCenter$Info.jsp" />
		...
		<div id="employeeInterviewList" class="tab-pane fade sublist" refer-name="interview_type">
			<sky:include page="com/doublechaintech/retailscm/employeeinterview/EmployeeInterview$List.jsp"
					referName="interviewType"/>
		</div>
	</c:if>
