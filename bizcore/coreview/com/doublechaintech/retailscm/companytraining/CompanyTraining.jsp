<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.companytraining.CompanyTraining'%>
...
<c:set var="ownerBeanName" value="companyTraining" scope="request"/>
<c:set var="ownerClassName" value="CompanyTraining" scope="request"/>
...
<div class="row">
	...
	<% CompanyTraining result = (CompanyTraining)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="companyTraining" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/companytraining/CompanyTraining$Summary.jsp" />
...
<sky:include page="com/doublechaintech/retailscm/trainingcoursetype/TrainingCourseType$Info.jsp" />
		...
		<div id="employeeCompanyTrainingList" class="tab-pane fade sublist" refer-name="training">
