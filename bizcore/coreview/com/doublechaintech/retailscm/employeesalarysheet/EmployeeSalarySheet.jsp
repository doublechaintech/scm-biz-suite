<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.employeesalarysheet.EmployeeSalarySheet'%>
...
<c:set var="ownerBeanName" value="employeeSalarySheet" scope="request"/>
<c:set var="ownerClassName" value="EmployeeSalarySheet" scope="request"/>
...
<div class="row">
	...
	<% EmployeeSalarySheet result = (EmployeeSalarySheet)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="employeeSalarySheet" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/employeesalarysheet/EmployeeSalarySheet$Summary.jsp" />
