...
<section><h3>评分(${result.id})</h3><table >
<tr><td class='th'>由谁打分</td><td >${result.scoredBy}</td><td class='th'>分数</td><td >${result.score}</td></tr><tr><td class='th'>评论</td><td >${result.comment}</td><td class='th'></td><td ></td></tr></table>
</section>
