<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.scoring.Scoring'%>
...
<c:set var="ownerBeanName" value="scoring" scope="request"/>
<c:set var="ownerClassName" value="Scoring" scope="request"/>
...
<div class="row">
	...
	<% Scoring result = (Scoring)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="scoring" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/scoring/Scoring$Summary.jsp" />
		...
		<div id="employeeCompanyTrainingList" class="tab-pane fade sublist" refer-name="scoring">
