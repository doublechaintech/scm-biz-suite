<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.productsupplyduration.ProductSupplyDuration'%>
...
<c:set var="ownerBeanName" value="productSupplyDuration" scope="request"/>
<c:set var="ownerClassName" value="ProductSupplyDuration" scope="request"/>
...
<div class="row">
	...
	<% ProductSupplyDuration result = (ProductSupplyDuration)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="productSupplyDuration" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/productsupplyduration/ProductSupplyDuration$Summary.jsp" />
	...
	<div class="row">
<c:set var="supplierProduct" value="${ result.product}" scope="request" />
<c:set var="referName" value="(product)" scope="request" />
<sky:include page="com/doublechaintech/retailscm/supplierproduct/SupplierProduct$Info.jsp" />
