<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.eventattendance.EventAttendance'%>
...
<c:set var="ownerBeanName" value="eventAttendance" scope="request"/>
<c:set var="ownerClassName" value="EventAttendance" scope="request"/>
...
<div class="row">
	...
	<% EventAttendance result = (EventAttendance)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="eventAttendance" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/eventattendance/EventAttendance$Summary.jsp" />
...
<c:set var="cityEvent" value="${ result.cityEvent}" scope="request" />
<c:set var="referName" value="" scope="request" />
<sky:include page="com/doublechaintech/retailscm/cityevent/CityEvent$Info.jsp" />
