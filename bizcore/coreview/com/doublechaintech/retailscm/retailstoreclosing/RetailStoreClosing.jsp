<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.retailstoreclosing.RetailStoreClosing'%>
...
<c:set var="ownerBeanName" value="retailStoreClosing" scope="request"/>
<c:set var="ownerClassName" value="RetailStoreClosing" scope="request"/>
...
<div class="row">
	...
	<% RetailStoreClosing result = (RetailStoreClosing)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="retailStoreClosing" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/retailstoreclosing/RetailStoreClosing$Summary.jsp" />
		...
		<div id="retailStoreList" class="tab-pane fade sublist" refer-name="closing">
