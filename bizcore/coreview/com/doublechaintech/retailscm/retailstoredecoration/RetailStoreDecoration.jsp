<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.retailstoredecoration.RetailStoreDecoration'%>
...
<c:set var="ownerBeanName" value="retailStoreDecoration" scope="request"/>
<c:set var="ownerClassName" value="RetailStoreDecoration" scope="request"/>
...
<div class="row">
	...
	<% RetailStoreDecoration result = (RetailStoreDecoration)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="retailStoreDecoration" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/retailstoredecoration/RetailStoreDecoration$Summary.jsp" />
		...
		<div id="retailStoreList" class="tab-pane fade sublist" refer-name="decoration">
			<sky:include page="com/doublechaintech/retailscm/retailstore/RetailStore$List.jsp"
					referName="decoration"/>
		</div>
	</c:if>
