<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.employeeaward.EmployeeAward'%>
...
<c:set var="ownerBeanName" value="employeeAward" scope="request"/>
<c:set var="ownerClassName" value="EmployeeAward" scope="request"/>
...
<div class="row">
	...
	<% EmployeeAward result = (EmployeeAward)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="employeeAward" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/employeeaward/EmployeeAward$Summary.jsp" />
