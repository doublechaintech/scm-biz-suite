<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.hrinterview.HrInterview'%>
...
<c:set var="ownerBeanName" value="hrInterview" scope="request"/>
<c:set var="ownerClassName" value="HrInterview" scope="request"/>
...
<div class="row">
	...
	<% HrInterview result = (HrInterview)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="hrInterview" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/hrinterview/HrInterview$Summary.jsp" />
		...
		<div id="employeeList" class="tab-pane fade sublist" refer-name="hr_interview">
			<sky:include page="com/doublechaintech/retailscm/employee/Employee$List.jsp"
					referName="hrInterview"/>
		</div>
	</c:if>
