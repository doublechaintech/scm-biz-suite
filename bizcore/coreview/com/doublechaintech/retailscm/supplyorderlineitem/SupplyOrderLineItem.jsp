<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.supplyorderlineitem.SupplyOrderLineItem'%>
...
<c:set var="ownerBeanName" value="supplyOrderLineItem" scope="request"/>
<c:set var="ownerClassName" value="SupplyOrderLineItem" scope="request"/>
...
<div class="row">
	...
	<% SupplyOrderLineItem result = (SupplyOrderLineItem)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="supplyOrderLineItem" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/supplyorderlineitem/SupplyOrderLineItem$Summary.jsp" />
