...
<c:if test="${ empty retailStoreOrderDeliveryList}" >
 ...
 <c:if test="${not empty retailStoreOrderDeliveryList}" >
    
    
<%

 	SmartList list=(SmartList)request.getAttribute("retailStoreOrderDeliveryList"); 
...
<c:set var="currentPageNumber" value="${page.pageNumber}"/>
	...
	<li class="page-item ${classType}">
		<a href='#${ownerBeanName}Manager/load${ownerClassName}/${result.id}/${retailStoreOrderDeliveryListName};${retailStoreOrderDeliveryListName}CurrentPage=${page.pageNumber};${retailStoreOrderDeliveryListName}RowsPerPage=${rowsPerPage}/' 
...
<th>${userContext.localeMap['@action']}</th>
		...
		<tbody>
			...
			<c:forEach var="item" items="${retailStoreOrderDeliveryList}">
				<tr currentVersion='${item.version}' id="retailStoreOrderDelivery-${item.id}" ><td><a class="link-action-removed" href="./retailStoreOrderDeliveryManager/view/${item.id}/"> ${item.id}</a></td>
