<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.retailstoreorderdelivery.RetailStoreOrderDelivery'%>
...
<c:set var="ownerBeanName" value="retailStoreOrderDelivery" scope="request"/>
<c:set var="ownerClassName" value="RetailStoreOrderDelivery" scope="request"/>
...
<div class="row">
	...
	<% RetailStoreOrderDelivery result = (RetailStoreOrderDelivery)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="retailStoreOrderDelivery" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/retailstoreorderdelivery/RetailStoreOrderDelivery$Summary.jsp" />
		...
		<div id="retailStoreOrderList" class="tab-pane fade sublist" refer-name="delivery">
