...
<div class="col-xs-12 col-ms-6 col-md-4 section">
	...
	<b title="A RetailStoreOrderDelivery">${userContext.localeMap['retail_store_order_delivery']} ${referName}</b><a href="#"><i class="fa fa-refresh" aria-hidden="true"></i></a>
	<hr/>
	<ul>
	
	
	<li><span>ID</span><a class="link-action-removed" href="./retailStoreOrderDeliveryManager/view/${retailStoreOrderDelivery.id}/"> ${retailStoreOrderDelivery.id}</a></li>
