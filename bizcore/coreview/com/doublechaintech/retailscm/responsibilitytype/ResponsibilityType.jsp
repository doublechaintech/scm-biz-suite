<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.responsibilitytype.ResponsibilityType'%>
...
<c:set var="ownerBeanName" value="responsibilityType" scope="request"/>
<c:set var="ownerClassName" value="ResponsibilityType" scope="request"/>
...
<div class="row">
	...
	<% ResponsibilityType result = (ResponsibilityType)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="responsibilityType" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/responsibilitytype/ResponsibilityType$Summary.jsp" />
...
<sky:include page="com/doublechaintech/retailscm/retailstorecountrycenter/RetailStoreCountryCenter$Info.jsp" />
		...
		<div id="employeeList" class="tab-pane fade sublist" refer-name="responsible_for">
			<sky:include page="com/doublechaintech/retailscm/employee/Employee$List.jsp"
					referName="responsibleFor"/>
		</div>
	</c:if>
