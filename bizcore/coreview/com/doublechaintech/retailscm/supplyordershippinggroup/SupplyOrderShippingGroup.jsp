<%@ page import='java.util.*,com.doublechaintech.retailscm.*,com.doublechaintech.retailscm.supplyordershippinggroup.SupplyOrderShippingGroup'%>
...
<c:set var="ownerBeanName" value="supplyOrderShippingGroup" scope="request"/>
<c:set var="ownerClassName" value="SupplyOrderShippingGroup" scope="request"/>
...
<div class="row">
	...
	<% SupplyOrderShippingGroup result = (SupplyOrderShippingGroup)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="supplyOrderShippingGroup" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/retailscm/supplyordershippinggroup/SupplyOrderShippingGroup$Summary.jsp" />
