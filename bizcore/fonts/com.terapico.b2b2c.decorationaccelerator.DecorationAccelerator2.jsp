...
$(function() {
	...
	if(!isMobile){
		...
		$("<div id='qr' class='tab-pane fade sublist'></div>").appendTo('#tab-content');
	...
	$("#navi-tabs").on("click", "a", function (e) {
			console.log("gets to here!"+ $(this).text());
     		e.preventDefault();
 			
     		
     		//console.log("gets to here!"+ $('#qr').text());
