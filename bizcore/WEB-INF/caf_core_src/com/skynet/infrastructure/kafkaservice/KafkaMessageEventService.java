...
public class KafkaMessageEventService implements EventService, InitializingBean {
    ...
    private List<Location> testLocations = new ArrayList<>();
 ...
 * '海门':[121.15,31.89],
    ...
    '大庆':[125.03,46.58]
 */
    private Location acquireTestingLocation() {
    ...
    public void afterPropertiesSet() throws Exception {
    	...
    	String[] locationStringArray = allLocation.split("\\|");
    	for (String locationString : locationStringArray) {
    		Location location = new Location();
    		String[] nameValue = locationString.split(":");
    		location.setLocationName(nameValue[0]);
    		String[] longitudeLatitudeArray = nameValue[1].split(",");
    		location.setLongitude(Double.parseDouble(longitudeLatitudeArray[0]));
    		location.setLatitude(Double.parseDouble(longitudeLatitudeArray[1]));
