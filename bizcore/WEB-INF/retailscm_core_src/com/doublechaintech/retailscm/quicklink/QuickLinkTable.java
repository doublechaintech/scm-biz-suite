...
public class QuickLinkTable{
	...
	public static final String []NORMAL_CLOUMNS = {COLUMN_NAME,COLUMN_ICON,COLUMN_IMAGE_PATH,COLUMN_LINK_TARGET,COLUMN_CREATE_TIME,COLUMN_APP};
	  ...
	  public static void ensureTable(RetailscmUserContext userContext, Map<String, Object> result) throws Exception {
        RetailscmBaseUtils.ensureTable(userContext, result, "quick_link_data", new String[][]{
                new String[]{"id","varchar(48)"," not null","ID","",""},
                new String[]{"name","varchar(200)","","名称","",""},
                new String[]{"icon","varchar(200)","","图标","",""},
                new String[]{"image_path","varchar(512) CHARACTER SET ascii COLLATE ascii_general_ci","","图片路径","",""},
