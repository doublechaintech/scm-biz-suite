...
public interface EmployeeSalarySheetManager extends BaseManager{
  ...
  List<EmployeeSalarySheet> searchEmployeeSalarySheetList(RetailscmUserContext ctx, EmployeeSalarySheetRequest pRequest);
  EmployeeSalarySheet searchEmployeeSalarySheet(RetailscmUserContext ctx, EmployeeSalarySheetRequest pRequest);
	...
	public default void onUpdated(RetailscmUserContext userContext, EmployeeSalarySheet updated, Object actor, String methodName) throws Exception {};
