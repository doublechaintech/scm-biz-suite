...
public class SectionManagerImpl extends CustomRetailscmCheckerManager
  ...
  protected Section saveSection(
      RetailscmUserContext userContext, Section section, String[] tokensExpr) throws Exception {
  ...
  protected Section saveSectionDetail(RetailscmUserContext userContext, Section section)
      throws Exception {
  ...
  public Section searchSection(
      RetailscmUserContext userContext, String sectionId, String textToSearch, String[] tokensExpr)
      throws Exception {
  ...
  protected Section present(
      RetailscmUserContext userContext, Section section, Map<String, Object> tokens)
      throws Exception {
  ...
  public Section loadSectionDetail(RetailscmUserContext userContext, String sectionId)
      throws Exception {
  ...
  protected Section loadSection(
      RetailscmUserContext userContext, String sectionId, Map<String, Object> tokens)
      throws Exception {
    checkerOf(userContext).checkIdOfSection(sectionId);
  ...
  protected <T extends BaseEntity> void addActions(
    ...
    // userContext, Section section, Map<String, Object> tokens){
  ...
  public Section internalSaveSection(
      RetailscmUserContext userContext, Section section, Map<String, Object> options)
      throws Exception {
  ...
  public Section forgetByAll(RetailscmUserContext userContext, String sectionId, int sectionVersion)
      throws Exception {
    return forgetByAllInternal(userContext, sectionId, sectionVersion);
  }

  protected Section forgetByAllInternal(
      RetailscmUserContext userContext, String sectionId, int sectionVersion) throws Exception {
  ...
  // -----------------------------------// list-of-view 处理 \\-----------------------------------
  protected void enhanceForListOfView(RetailscmUserContext userContext, SmartList<Section> list)
      throws Exception {
    if (list == null || list.isEmpty()) {
      return;
    }
