...
import com.doublechaintech.retailscm.*;import com.doublechaintech.retailscm.BaseViewPage;import com.doublechaintech.retailscm.RetailscmUserContextImpl;import com.doublechaintech.retailscm.iamservice.*;import com.doublechaintech.retailscm.secuser.SecUser;import com.doublechaintech.retailscm.services.IamService;import com.doublechaintech.retailscm.supplierproduct.CandidateSupplierProduct;import com.doublechaintech.retailscm.supplierproduct.SupplierProduct;import com.doublechaintech.retailscm.tree.*;import com.doublechaintech.retailscm.treenode.*;import com.doublechaintech.retailscm.userapp.UserApp;import com.doublechaintech.retailscm.utils.ModelAssurance;
...
public class ProductSupplyDurationManagerImpl extends CustomRetailscmCheckerManager implements ProductSupplyDurationManager, BusinessHandler{
	...
	public Object prepareContextForUserApp(BaseUserContext userContext,Object targetUserApp) throws Exception{
	 ...
	 public Object summaryView(RetailscmUserContext userContext, String productSupplyDurationId) throws Exception{
		ProductSupplyDuration productSupplyDuration = loadProductSupplyDuration( userContext, productSupplyDurationId, viewTokens());
	 ...
	 public Object analyze(RetailscmUserContext userContext, String productSupplyDurationId) throws Exception{
		ProductSupplyDuration productSupplyDuration = loadProductSupplyDuration( userContext, productSupplyDurationId, analyzeTokens());
		markVisited(userContext, productSupplyDuration);
  ...
  @Override
  public List<ProductSupplyDuration> searchProductSupplyDurationList(RetailscmUserContext ctx, ProductSupplyDurationRequest pRequest){
  ...
  @Override
  public ProductSupplyDuration searchProductSupplyDuration(RetailscmUserContext ctx, ProductSupplyDurationRequest pRequest){
    pRequest.limit(0, 1);
 ...
 //--------------------------------------------------------------
  ...
  public void sendAllItems(RetailscmUserContext ctx) throws Exception{
    productSupplyDurationDaoOf(ctx).loadAllAsStream().forEach(
