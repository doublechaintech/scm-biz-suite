...
public class PublicHolidayManagerImpl extends CustomRetailscmCheckerManager implements PublicHolidayManager, BusinessHandler{
	...
	public Object prepareContextForUserApp(BaseUserContext userContext,Object targetUserApp) throws Exception{
	 ...
	 public Object summaryView(RetailscmUserContext userContext, String publicHolidayId) throws Exception{
		PublicHoliday publicHoliday = loadPublicHoliday( userContext, publicHolidayId, viewTokens());
  ...
  @Override
  public List<PublicHoliday> searchPublicHolidayList(RetailscmUserContext ctx, PublicHolidayRequest pRequest){
  ...
  @Override
  public PublicHoliday searchPublicHoliday(RetailscmUserContext ctx, PublicHolidayRequest pRequest){
    pRequest.limit(0, 1);
 ...
 //--------------------------------------------------------------
  ...
  public void sendAllItems(RetailscmUserContext ctx) throws Exception{
    publicHolidayDaoOf(ctx).loadAllAsStream().forEach(
