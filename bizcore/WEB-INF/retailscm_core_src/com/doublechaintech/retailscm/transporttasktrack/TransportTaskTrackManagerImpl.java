...
import com.doublechaintech.retailscm.*;import com.doublechaintech.retailscm.BaseViewPage;import com.doublechaintech.retailscm.RetailscmUserContextImpl;import com.doublechaintech.retailscm.iamservice.*;import com.doublechaintech.retailscm.secuser.SecUser;import com.doublechaintech.retailscm.services.IamService;import com.doublechaintech.retailscm.transporttask.CandidateTransportTask;import com.doublechaintech.retailscm.transporttask.TransportTask;import com.doublechaintech.retailscm.tree.*;import com.doublechaintech.retailscm.treenode.*;import com.doublechaintech.retailscm.userapp.UserApp;import com.doublechaintech.retailscm.utils.ModelAssurance;
...
public class TransportTaskTrackManagerImpl extends CustomRetailscmCheckerManager implements TransportTaskTrackManager, BusinessHandler{
	...
	public Object prepareContextForUserApp(BaseUserContext userContext,Object targetUserApp) throws Exception{
	 ...
	 public Object summaryView(RetailscmUserContext userContext, String transportTaskTrackId) throws Exception{
		TransportTaskTrack transportTaskTrack = loadTransportTaskTrack( userContext, transportTaskTrackId, viewTokens());
	 ...
	 public Object analyze(RetailscmUserContext userContext, String transportTaskTrackId) throws Exception{
		TransportTaskTrack transportTaskTrack = loadTransportTaskTrack( userContext, transportTaskTrackId, analyzeTokens());
		markVisited(userContext, transportTaskTrack);
  ...
  @Override
  public List<TransportTaskTrack> searchTransportTaskTrackList(RetailscmUserContext ctx, TransportTaskTrackRequest pRequest){
  ...
  @Override
  public TransportTaskTrack searchTransportTaskTrack(RetailscmUserContext ctx, TransportTaskTrackRequest pRequest){
    pRequest.limit(0, 1);
 ...
 //--------------------------------------------------------------
  ...
  public void sendAllItems(RetailscmUserContext ctx) throws Exception{
    transportTaskTrackDaoOf(ctx).loadAllAsStream().forEach(
