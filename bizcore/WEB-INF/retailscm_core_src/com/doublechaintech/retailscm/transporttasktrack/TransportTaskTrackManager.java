...
public interface TransportTaskTrackManager extends BaseManager{
  ...
  List<TransportTaskTrack> searchTransportTaskTrackList(RetailscmUserContext ctx, TransportTaskTrackRequest pRequest);
  TransportTaskTrack searchTransportTaskTrack(RetailscmUserContext ctx, TransportTaskTrackRequest pRequest);
	...
	public default void onUpdated(RetailscmUserContext userContext, TransportTaskTrack updated, Object actor, String methodName) throws Exception {};
