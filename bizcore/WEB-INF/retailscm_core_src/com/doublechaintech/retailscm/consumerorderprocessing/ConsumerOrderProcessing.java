...
public class ConsumerOrderProcessing extends BaseEntity implements  java.io.Serializable{
	...
	public static final String INTERNAL_TYPE="ConsumerOrderProcessing";
	...
	public ConsumerOrderProcessing updateId(String id){
		this.mId = trimString(id);;
		this.changed = true;
		return this;
	}
	...
	public ConsumerOrderProcessing updateWho(String who){
		this.mWho = trimString(who);;
		this.changed = true;
		return this;
	}
	...
	public ConsumerOrderProcessing updateProcessTime(Date processTime){
		this.mProcessTime = processTime;;
		this.changed = true;
		return this;
	}
	...
	public ConsumerOrderProcessing updateVersion(int version){
		this.mVersion = version;;
		this.changed = true;
		return this;
	}
	...
	public String toString(){
		...
		stringBuilder.append("ConsumerOrderProcessing{");
