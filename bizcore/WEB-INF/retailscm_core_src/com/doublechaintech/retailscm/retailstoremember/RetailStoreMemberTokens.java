...
public class RetailStoreMemberTokens extends CommonTokens{
  ...
  private static void addToken(RetailStoreMemberTokens pTokens, String pTokenName, String[] pGroupNames, String[] fieldGroups) {
	...
	public RetailStoreMemberTokens withRetailStoreMemberCouponListIfViewGroupInclude(String [] viewGroups){
	...
	public RetailStoreMemberTokens sortRetailStoreMemberCouponListWith(String field, String descOrAsc){
		addSortMoreOptions(RETAIL_STORE_MEMBER_COUPON_LIST,retailStoreMemberCouponListSortCounter++, field, descOrAsc);
		return this;
	}
	...
	public RetailStoreMemberTokens currentPageNumberOfRetailStoreMemberCouponList(int currentPageNumber){
	...
	public RetailStoreMemberTokens sortMemberRewardPointListWith(String field, String descOrAsc){
		addSortMoreOptions(MEMBER_REWARD_POINT_LIST,memberRewardPointListSortCounter++, field, descOrAsc);
		return this;
	}
	...
	public RetailStoreMemberTokens withMemberRewardPointRedemptionListIfViewGroupInclude(String [] viewGroups){
	...
	public RetailStoreMemberTokens sortMemberRewardPointRedemptionListWith(String field, String descOrAsc){
		addSortMoreOptions(MEMBER_REWARD_POINT_REDEMPTION_LIST,memberRewardPointRedemptionListSortCounter++, field, descOrAsc);
		return this;
	}
	...
	public RetailStoreMemberTokens currentPageNumberOfMemberRewardPointRedemptionList(int currentPageNumber){
	...
	public RetailStoreMemberTokens withRetailStoreMemberAddressListIfViewGroupInclude(String [] viewGroups){
	...
	public RetailStoreMemberTokens sortRetailStoreMemberAddressListWith(String field, String descOrAsc){
		addSortMoreOptions(RETAIL_STORE_MEMBER_ADDRESS_LIST,retailStoreMemberAddressListSortCounter++, field, descOrAsc);
		return this;
	}
	...
	public RetailStoreMemberTokens currentPageNumberOfRetailStoreMemberAddressList(int currentPageNumber){
	...
	public RetailStoreMemberTokens withRetailStoreMemberGiftCardListIfViewGroupInclude(String [] viewGroups){
	...
	public RetailStoreMemberTokens sortRetailStoreMemberGiftCardListWith(String field, String descOrAsc){
		addSortMoreOptions(RETAIL_STORE_MEMBER_GIFT_CARD_LIST,retailStoreMemberGiftCardListSortCounter++, field, descOrAsc);
		return this;
	}
	...
	public RetailStoreMemberTokens currentPageNumberOfRetailStoreMemberGiftCardList(int currentPageNumber){
