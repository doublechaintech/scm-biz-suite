...
import com.doublechaintech.retailscm.*;import com.doublechaintech.retailscm.BaseViewPage;import com.doublechaintech.retailscm.RetailscmUserContextImpl;import com.doublechaintech.retailscm.iamservice.*;import com.doublechaintech.retailscm.provincecenterdepartment.CandidateProvinceCenterDepartment;import com.doublechaintech.retailscm.provincecenterdepartment.ProvinceCenterDepartment;import com.doublechaintech.retailscm.retailstoreprovincecenter.CandidateRetailStoreProvinceCenter;import com.doublechaintech.retailscm.retailstoreprovincecenter.RetailStoreProvinceCenter;import com.doublechaintech.retailscm.secuser.SecUser;import com.doublechaintech.retailscm.services.IamService;import com.doublechaintech.retailscm.tree.*;import com.doublechaintech.retailscm.treenode.*;import com.doublechaintech.retailscm.userapp.UserApp;import com.doublechaintech.retailscm.utils.ModelAssurance;
...
public class ProvinceCenterEmployeeManagerImpl extends CustomRetailscmCheckerManager implements ProvinceCenterEmployeeManager, BusinessHandler{
	...
	public Object prepareContextForUserApp(BaseUserContext userContext,Object targetUserApp) throws Exception{
	 ...
	 public Object summaryView(RetailscmUserContext userContext, String provinceCenterEmployeeId) throws Exception{
		ProvinceCenterEmployee provinceCenterEmployee = loadProvinceCenterEmployee( userContext, provinceCenterEmployeeId, viewTokens());
	 ...
	 public Object analyze(RetailscmUserContext userContext, String provinceCenterEmployeeId) throws Exception{
		ProvinceCenterEmployee provinceCenterEmployee = loadProvinceCenterEmployee( userContext, provinceCenterEmployeeId, analyzeTokens());
		markVisited(userContext, provinceCenterEmployee);
  ...
  @Override
  public List<ProvinceCenterEmployee> searchProvinceCenterEmployeeList(RetailscmUserContext ctx, ProvinceCenterEmployeeRequest pRequest){
  ...
  @Override
  public ProvinceCenterEmployee searchProvinceCenterEmployee(RetailscmUserContext ctx, ProvinceCenterEmployeeRequest pRequest){
    pRequest.limit(0, 1);
