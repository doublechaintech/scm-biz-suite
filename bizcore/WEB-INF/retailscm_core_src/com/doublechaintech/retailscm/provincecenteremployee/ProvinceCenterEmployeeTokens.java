...
public class ProvinceCenterEmployeeTokens extends CommonTokens{
  ...
  public static ProvinceCenterEmployeeTokens loadGroupTokens(String... groupNames){
    ...
    addToken(tokens, DEPARTMENT, groupNames, new String[]{"default"});addToken(tokens, PROVINCECENTER, groupNames, new String[]{"default"});

  
    return tokens;
  }

  private static void addToken(ProvinceCenterEmployeeTokens pTokens, String pTokenName, String[] pGroupNames, String[] fieldGroups) {
