...
public class TruckDriverTokens extends CommonTokens {
  ...
  private static void addToken(
      TruckDriverTokens pTokens, String pTokenName, String[] pGroupNames, String[] fieldGroups) {
  ...
  public static TruckDriverTokens filterWithTokenViewGroups(String[] viewGroups) {
    ...
    return start().withBelongsTo().withTransportTaskListIfViewGroupInclude(viewGroups);
  }

  public static TruckDriverTokens allTokens() {

    return start().withBelongsTo().withTransportTaskList();
  }
