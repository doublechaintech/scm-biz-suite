...
public class LevelThreeCategoryTable{
	...
	public static final String []NORMAL_CLOUMNS = {COLUMN_PARENT_CATEGORY,COLUMN_NAME};
	  ...
	  public static void ensureTable(RetailscmUserContext userContext, Map<String, Object> result) throws Exception {
        RetailscmBaseUtils.ensureTable(userContext, result, "level_three_category_data", new String[][]{
                new String[]{"id","varchar(48)"," not null","ID","",""},
                new String[]{"parent_category","varchar(48)","","父类","level_two_category_data","id"},
