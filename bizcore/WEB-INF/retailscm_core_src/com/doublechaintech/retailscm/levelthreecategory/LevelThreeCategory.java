...
public class LevelThreeCategory extends BaseEntity implements java.io.Serializable {
  ...
  public void transferAllRelationshipsTo(LevelThreeCategory target) {
    if (target == null) {
      return;
    }
    target.addProductList(this.getProductList());
  }
  ...
  static {
    ...
    memberMetaInfoList.add(
        MemberMetaInfo.defineBy(PARENT_CATEGORY_PROPERTY, "level_two_category", "父类")
    ...
    memberMetaInfoList.add(
        MemberMetaInfo.referBy(PRODUCT_LIST, "parentCategory", "产品列表")
  ...
  public Object propertyOf(String property) {
    ...
    if (PRODUCT_LIST.equals(property)) {
      List<BaseEntity> list =
          getProductList().stream().map(item -> item).collect(Collectors.toList());
      return list;
    }
  ...
  public LevelThreeCategory ignoreIdCriteria() {
  ...
  public void setParentCategory(LevelTwoCategory parentCategory) {
    LevelTwoCategory oldParentCategory = this.parentCategory;
    LevelTwoCategory newParentCategory = parentCategory;
  ...
  public LevelThreeCategory ignoreParentCategoryCriteria() {
    super.ignoreSearchProperty(PARENT_CATEGORY_PROPERTY);
    return this;
  }

  public LevelThreeCategory addParentCategoryCriteria(
  ...
  public LevelThreeCategory updateParentCategoryByReferenceId(String parentCategoryId) {
    updateParentCategory(LevelTwoCategory.refById(parentCategoryId));
    return this;
  }
  ...
  public LevelThreeCategory ignoreNameCriteria() {
  ...
  public LevelThreeCategory ignoreVersionCriteria() {
  ...
  public LevelThreeCategory addProduct(Product product) {
    product.updateParentCategory(this);
  ...
  public LevelThreeCategory addProductList(SmartList<Product> productList) {
    ...
    Map<String, Product> mapById = productList.mapWithId();
    getProductList().removeIf(item -> mapById.get(item.getId()) != null);
  ...
  public Product findTheProduct(Product product) {
    ...
    if (index < 0) {
      String message =
          "Product(" + product.getId() + ") with version='" + product.getVersion() + "' NOT found!";
      throw new IllegalStateException(message);
    }
  ...
  public List<KeyValuePair> keyValuePairOf() {
    ...
    if (!getProductList().isEmpty()) {
      ...
      appendKeyValuePair(
          result, "productCurrentPageNumber", getProductList().getCurrentPageNumber());
    }
  ...
  public BaseEntity mergeDataFrom(BaseEntity sourceEntity) {
    ...
    if (sourceEntity instanceof LevelThreeCategory) {

      LevelThreeCategory source = (LevelThreeCategory) sourceEntity;

      mergeId(source.getId());
      mergeParentCategory(source.getParentCategory());
      mergeName(source.getName());
      mergeVersion(source.getVersion());
      mergeProductList(source.getProductList());
    }
  ...
  public boolean checkIfEligibleForDelete(Object ctx) {
    ...
    LevelThreeCategory checkLevelThreeCategory =
        Q.levelThreeCategoryWithIdField()
            .filterById(id)
            .selectProductList(Q.productWithIdField().limit(0, 1))
            .execute(ctx);

    return checkLevelThreeCategory != null
        && !checkLevelThreeCategory.getAllRelatedLists().stream()
            .flatMap(subList -> subList.stream())
            .findFirst()
            .isPresent();
  }

  public LevelThreeCategory save(com.doublechaintech.retailscm.RetailscmUserContext ctx) {
    try {
  ...
  public String toString() {
    ...
    if (getParentCategory() != null) {
      stringBuilder.append(
          "\tparentCategory='LevelTwoCategory(" + getParentCategory().getId() + ")';");
    }
