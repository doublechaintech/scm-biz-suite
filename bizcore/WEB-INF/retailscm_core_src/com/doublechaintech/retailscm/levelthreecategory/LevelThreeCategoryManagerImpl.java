...
import com.doublechaintech.retailscm.*;import com.doublechaintech.retailscm.BaseViewPage;import com.doublechaintech.retailscm.RetailscmUserContextImpl;import com.doublechaintech.retailscm.iamservice.*;import com.doublechaintech.retailscm.levelthreecategory.LevelThreeCategory;import com.doublechaintech.retailscm.leveltwocategory.CandidateLevelTwoCategory;import com.doublechaintech.retailscm.leveltwocategory.LevelTwoCategory;import com.doublechaintech.retailscm.product.Product;import com.doublechaintech.retailscm.secuser.SecUser;import com.doublechaintech.retailscm.services.IamService;import com.doublechaintech.retailscm.tree.*;import com.doublechaintech.retailscm.treenode.*;import com.doublechaintech.retailscm.userapp.UserApp;import com.doublechaintech.retailscm.utils.ModelAssurance;
...
public class LevelThreeCategoryManagerImpl extends CustomRetailscmCheckerManager implements LevelThreeCategoryManager, BusinessHandler{
	...
	public Object prepareContextForUserApp(BaseUserContext userContext,Object targetUserApp) throws Exception{
	 ...
	 public Object summaryView(RetailscmUserContext userContext, String levelThreeCategoryId) throws Exception{
		LevelThreeCategory levelThreeCategory = loadLevelThreeCategory( userContext, levelThreeCategoryId, viewTokens());
	 ...
	 public Object analyze(RetailscmUserContext userContext, String levelThreeCategoryId) throws Exception{
		LevelThreeCategory levelThreeCategory = loadLevelThreeCategory( userContext, levelThreeCategoryId, analyzeTokens());
		markVisited(userContext, levelThreeCategory);
  ...
  @Override
  public List<LevelThreeCategory> searchLevelThreeCategoryList(RetailscmUserContext ctx, LevelThreeCategoryRequest pRequest){
  ...
  @Override
  public LevelThreeCategory searchLevelThreeCategory(RetailscmUserContext ctx, LevelThreeCategoryRequest pRequest){
    pRequest.limit(0, 1);
	...
	protected Map<String,Object> viewTokens(){
		...
		.sortProductListWith(Product.ID_PROPERTY,sortDesc())
		.done();
