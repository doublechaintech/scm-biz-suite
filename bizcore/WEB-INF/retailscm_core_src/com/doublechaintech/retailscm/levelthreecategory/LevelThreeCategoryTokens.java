...
public class LevelThreeCategoryTokens extends CommonTokens{
  ...
  private static void addToken(LevelThreeCategoryTokens pTokens, String pTokenName, String[] pGroupNames, String[] fieldGroups) {
	...
	public static LevelThreeCategoryTokens filterWithTokenViewGroups(String []viewGroups){
		...
		return start()
			.withParentCategory()
			.withProductListIfViewGroupInclude(viewGroups);
