...
public class PublicKeyTypeTokens extends CommonTokens {
  ...
  private static void addToken(
      PublicKeyTypeTokens pTokens, String pTokenName, String[] pGroupNames, String[] fieldGroups) {
  ...
  public static PublicKeyTypeTokens filterWithTokenViewGroups(String[] viewGroups) {
    ...
    return start().withDomain().withKeyPairIdentityListIfViewGroupInclude(viewGroups);
  }

  public static PublicKeyTypeTokens allTokens() {

    return start().withDomain().withKeyPairIdentityList();
  }
  ...
  public PublicKeyTypeTokens searchKeyPairIdentityListWith(
