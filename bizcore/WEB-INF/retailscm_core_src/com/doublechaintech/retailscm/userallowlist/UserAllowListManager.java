...
public interface UserAllowListManager extends BaseManager{
  ...
  List<UserAllowList> searchUserAllowListList(RetailscmUserContext ctx, UserAllowListRequest pRequest);
  UserAllowList searchUserAllowList(RetailscmUserContext ctx, UserAllowListRequest pRequest);
	...
	public default void onUpdated(RetailscmUserContext userContext, UserAllowList updated, Object actor, String methodName) throws Exception {};
