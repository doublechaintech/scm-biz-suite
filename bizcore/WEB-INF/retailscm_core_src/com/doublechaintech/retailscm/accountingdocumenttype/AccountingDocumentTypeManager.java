...
public interface AccountingDocumentTypeManager extends BaseManager{
  ...
  List<AccountingDocumentType> searchAccountingDocumentTypeList(RetailscmUserContext ctx, AccountingDocumentTypeRequest pRequest);
  AccountingDocumentType searchAccountingDocumentType(RetailscmUserContext ctx, AccountingDocumentTypeRequest pRequest);
	...
	public default void onUpdated(RetailscmUserContext userContext, AccountingDocumentType updated, Object actor, String methodName) throws Exception {};
