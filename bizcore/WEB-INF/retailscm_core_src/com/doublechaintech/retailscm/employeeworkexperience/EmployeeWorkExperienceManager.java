...
public interface EmployeeWorkExperienceManager extends BaseManager{
  ...
  List<EmployeeWorkExperience> searchEmployeeWorkExperienceList(RetailscmUserContext ctx, EmployeeWorkExperienceRequest pRequest);
  EmployeeWorkExperience searchEmployeeWorkExperience(RetailscmUserContext ctx, EmployeeWorkExperienceRequest pRequest);
	...
	public default void onUpdated(RetailscmUserContext userContext, EmployeeWorkExperience updated, Object actor, String methodName) throws Exception {};
