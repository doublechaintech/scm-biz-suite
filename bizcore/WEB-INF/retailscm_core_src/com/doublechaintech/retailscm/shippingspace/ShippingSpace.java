...
public class ShippingSpace extends BaseEntity implements java.io.Serializable {
  ...
  public void transferAllRelationshipsTo(ShippingSpace target) {
    if (target == null) {
      return;
    }
  ...
  static {
    ...
    memberMetaInfoList.add(
        MemberMetaInfo.referBy(GOODS_LIST, "shippingSpace", "商品列表").withType("goods", Goods.class));
  }
  ...
  public ShippingSpace ignoreIdCriteria() {
  ...
  public ShippingSpace ignoreLocationCriteria() {
  ...
  public ShippingSpace ignoreContactNumberCriteria() {
  ...
  public ShippingSpace ignoreTotalAreaCriteria() {
  ...
  public ShippingSpace ignoreWarehouseCriteria() {
  ...
  public ShippingSpace updateWarehouseByReferenceId(String warehouseId) {
  ...
  public ShippingSpace ignoreLatitudeCriteria() {
  ...
  public ShippingSpace ignoreLongitudeCriteria() {
  ...
  public ShippingSpace ignoreDescriptionCriteria() {
  ...
  public ShippingSpace ignoreLastUpdateTimeCriteria() {
  ...
  public ShippingSpace ignoreVersionCriteria() {
  ...
  public ShippingSpace addGoods(Goods goods) {
    goods.updateShippingSpace(this);
  ...
  public BaseEntity mergeDataFrom(BaseEntity sourceEntity) {
    ...
    if (sourceEntity instanceof ShippingSpace) {

      ShippingSpace source = (ShippingSpace) sourceEntity;
  ...
  public boolean checkIfEligibleForDelete(Object ctx) {
    ...
    ShippingSpace checkShippingSpace =
        Q.shippingSpaceWithIdField()
            .filterById(id)
            .selectGoodsList(Q.goodsWithIdField().limit(0, 1))
            .execute(ctx);

    return checkShippingSpace != null
        && !checkShippingSpace.getAllRelatedLists().stream()
            .flatMap(subList -> subList.stream())
            .findFirst()
            .isPresent();
  }

  public ShippingSpace save(com.doublechaintech.retailscm.RetailscmUserContext ctx) {
    try {
