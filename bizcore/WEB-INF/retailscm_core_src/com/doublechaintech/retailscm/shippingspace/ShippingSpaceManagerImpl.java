...
public class ShippingSpaceManagerImpl extends CustomRetailscmCheckerManager
    implements ShippingSpaceManager, BusinessHandler {
  ...
  public BlobObject exportExcelFromList(
    ...
    List<BaseEntity> entityListToNaming = shippingSpace.collectReferencesFromLists();
  ...
  protected ShippingSpace saveShippingSpace(
      RetailscmUserContext userContext, ShippingSpace shippingSpace, String[] tokensExpr)
      throws Exception {
  ...
  protected ShippingSpace saveShippingSpaceDetail(
  ...
  public ShippingSpace searchShippingSpace(
  ...
  protected ShippingSpace present(
      RetailscmUserContext userContext, ShippingSpace shippingSpace, Map<String, Object> tokens)
      throws Exception {

    addActions(userContext, shippingSpace, tokens);

    ShippingSpace shippingSpaceToPresent =
        shippingSpaceDaoOf(userContext).present(shippingSpace, tokens);

    List<BaseEntity> entityListToNaming = shippingSpaceToPresent.collectReferencesFromLists();
    shippingSpaceDaoOf(userContext).alias(entityListToNaming);
  ...
  public ShippingSpace loadShippingSpaceDetail(
      RetailscmUserContext userContext, String shippingSpaceId) throws Exception {
  ...
  public Object summaryView(RetailscmUserContext userContext, String shippingSpaceId)
      throws Exception {
    ShippingSpace shippingSpace = loadShippingSpace(userContext, shippingSpaceId, viewTokens());
  ...
  protected ShippingSpace loadShippingSpace(
      RetailscmUserContext userContext, String shippingSpaceId, Map<String, Object> tokens)
      throws Exception {
    checkerOf(userContext).checkIdOfShippingSpace(shippingSpaceId);
  ...
  protected <T extends BaseEntity> void addActions(
    ...
    // userContext, ShippingSpace shippingSpace, Map<String, Object> tokens){

  @Override
  public List<ShippingSpace> searchShippingSpaceList(
  ...
  public ShippingSpace clone(RetailscmUserContext userContext, String fromShippingSpaceId)
      throws Exception {
  ...
  public ShippingSpace internalSaveShippingSpace(
      RetailscmUserContext userContext, ShippingSpace shippingSpace, Map<String, Object> options)
      throws Exception {
    // checkParamsForUpdatingShippingSpace(userContext, shippingSpaceId, shippingSpaceVersion,
  ...
  public ShippingSpace updateShippingSpace(
    ...
    checkParamsForUpdatingShippingSpace(
        userContext, shippingSpaceId, shippingSpaceVersion, property, newValueExpr, tokensExpr);
  ...
  public ShippingSpace updateShippingSpaceProperty(
      RetailscmUserContext userContext,
      String shippingSpaceId,
      int shippingSpaceVersion,
      String property,
  ...
  public CandidateWarehouse requestCandidateWarehouse(
    ...
    SmartList<Warehouse> candidateList =
        warehouseDaoOf(userContext)
            .requestCandidateWarehouseForShippingSpace(
  ...
  public ShippingSpace forgetByAll(
      RetailscmUserContext userContext, String shippingSpaceId, int shippingSpaceVersion)
      throws Exception {
    return forgetByAllInternal(userContext, shippingSpaceId, shippingSpaceVersion);
  }

  protected ShippingSpace forgetByAllInternal(
      RetailscmUserContext userContext, String shippingSpaceId, int shippingSpaceVersion)
      throws Exception {
  ...
  public ShippingSpace addGoods(
    ...
    synchronized (shippingSpace) {
      ...
      shippingSpace =
          saveShippingSpace(userContext, shippingSpace, tokens().withGoodsList().done());
  ...
  public ShippingSpace updateGoodsProperties(
      RetailscmUserContext userContext,
      String shippingSpaceId,
      String id,
      String name,
    ...
    checkParamsForUpdatingGoodsProperties(
        userContext, shippingSpaceId, id, name, rfid, uom, maxPackage, expireTime, tokensExpr);
    ...
    ShippingSpace shippingSpace =
        saveShippingSpace(userContext, shippingSpaceToUpdate, tokens().withGoodsList().done());
    synchronized (shippingSpace) {
      return present(userContext, shippingSpace, mergedAllTokens(tokensExpr));
    }
  }
  ...
  public ShippingSpace removeGoodsList(
      RetailscmUserContext userContext,
      String shippingSpaceId,
      String goodsIds[],
      String[] tokensExpr)
  ...
  public ShippingSpace copyGoodsFrom(
      RetailscmUserContext userContext,
      String shippingSpaceId,
      String goodsId,
      int goodsVersion,
    ...
    synchronized (shippingSpace) {
      ...
      goodsManagerOf(userContext)
          .onNewInstanceCreated(
              userContext,
              (Goods) shippingSpace.getFlexiableObjects().get(BaseEntity.COPIED_CHILD));
      return present(userContext, shippingSpace, mergedAllTokens(tokensExpr));
    }
  }
  ...
  public ShippingSpace updateGoods(
    ...
    checkParamsForUpdatingGoods(
        userContext, shippingSpaceId, goodsId, goodsVersion, property, newValueExpr, tokensExpr);
  ...
  */
  ...
  public void sendAllItems(RetailscmUserContext ctx) throws Exception {
    shippingSpaceDaoOf(ctx).loadAllAsStream().forEach(event -> sendInitEvent(ctx, event));
  }
  ...
  protected void enhanceForListOfView(
      RetailscmUserContext userContext, SmartList<ShippingSpace> list) throws Exception {
    if (list == null || list.isEmpty()) {
      return;
    }
  ...
  public Object listPageByWarehouse(
    ...
    SmartList<ShippingSpace> list =
        shippingSpaceDaoOf(userContext)
            .findShippingSpaceByWarehouse(warehouseId, start, count, new HashMap<>());
   ...
   * @throws Exception
   */
  public Object wxappview(RetailscmUserContext userContext, String shippingSpaceId)
      throws Exception {
