...
public class ShippingSpaceGridViewGenerator extends BaseGridViewGenerator{
	...
	protected void throwExceptionIfListNotFount(String listName) {
		String message=String.format("List '%s' is not found for ShippingSpace", listName);
		throw new IllegalArgumentException(message);
	}

	protected String [] getHeaderKeys(String listName) {

		if(ShippingSpace.GOODS_LIST.equals(listName)){
