...
public class ShippingSpaceTable{
	...
	public static final String []NORMAL_CLOUMNS = {COLUMN_LOCATION,COLUMN_CONTACT_NUMBER,COLUMN_TOTAL_AREA,COLUMN_WAREHOUSE,COLUMN_LATITUDE,COLUMN_LONGITUDE,COLUMN_DESCRIPTION,COLUMN_LAST_UPDATE_TIME};
	  ...
	  public static void ensureTable(RetailscmUserContext userContext, Map<String, Object> result) throws Exception {
        RetailscmBaseUtils.ensureTable(userContext, result, "shipping_space_data", new String[][]{
                ...
                "alter table shipping_space_data add constraint fk4warehouse_of_shipping_space_data foreign key (warehouse) references warehouse_data(id) ON DELETE CASCADE ON UPDATE CASCADE;",
                ""
         });
  }
