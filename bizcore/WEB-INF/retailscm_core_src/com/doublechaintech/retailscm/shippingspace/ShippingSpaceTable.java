...
public class ShippingSpaceTable{
	...
	static final String TABLE_NAME="shipping_space_data";
	...
	static final String []ALL_CLOUMNS = {COLUMN_ID, 
		COLUMN_LOCATION, COLUMN_CONTACT_NUMBER, COLUMN_TOTAL_AREA, COLUMN_WAREHOUSE, COLUMN_LATITUDE, COLUMN_LONGITUDE, COLUMN_DESCRIPTION, COLUMN_LAST_UPDATE_TIME, 
		COLUMN_VERSION};
