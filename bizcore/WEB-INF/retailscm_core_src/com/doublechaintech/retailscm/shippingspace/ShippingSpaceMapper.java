...
public class ShippingSpaceMapper extends BaseRowMapper<ShippingSpace> {
  ...
  public static ShippingSpaceMapper mapperForClass(Class<?> clazz) {

    ShippingSpaceMapper mapperForOverride = new ShippingSpaceMapper();
  ...
  protected void setId(ShippingSpace shippingSpace, ResultSet rs, int rowNumber)
      throws SQLException {
    try {
  ...
  protected void setLocation(ShippingSpace shippingSpace, ResultSet rs, int rowNumber)
      throws SQLException {
    try {
      // there will be issue when the type is double/int/long
  ...
  protected void setContactNumber(ShippingSpace shippingSpace, ResultSet rs, int rowNumber)
      throws SQLException {
    try {
      // there will be issue when the type is double/int/long
  ...
  protected void setTotalArea(ShippingSpace shippingSpace, ResultSet rs, int rowNumber)
      throws SQLException {
    try {
      // there will be issue when the type is double/int/long
  ...
  protected void setWarehouse(ShippingSpace shippingSpace, ResultSet rs, int rowNumber)
      throws SQLException {
    String warehouseId;
    try {
  ...
  protected void setLatitude(ShippingSpace shippingSpace, ResultSet rs, int rowNumber)
      throws SQLException {
    try {
      // there will be issue when the type is double/int/long
  ...
  protected void setLongitude(ShippingSpace shippingSpace, ResultSet rs, int rowNumber)
      throws SQLException {
    try {
      // there will be issue when the type is double/int/long
  ...
  protected void setDescription(ShippingSpace shippingSpace, ResultSet rs, int rowNumber)
      throws SQLException {
    try {
      // there will be issue when the type is double/int/long
  ...
  protected void setLastUpdateTime(ShippingSpace shippingSpace, ResultSet rs, int rowNumber)
      throws SQLException {
    try {
      // there will be issue when the type is double/int/long
  ...
  protected void setVersion(ShippingSpace shippingSpace, ResultSet rs, int rowNumber)
      throws SQLException {
    try {
      // there will be issue when the type is double/int/long
