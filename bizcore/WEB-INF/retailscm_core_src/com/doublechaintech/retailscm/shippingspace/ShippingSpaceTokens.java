...
public class ShippingSpaceTokens extends CommonTokens {
  ...
  public static ShippingSpaceTokens loadGroupTokens(String... groupNames) {
    ShippingSpaceTokens tokens = start();
  ...
  private static void addToken(
      ShippingSpaceTokens pTokens, String pTokenName, String[] pGroupNames, String[] fieldGroups) {
  ...
  public static ShippingSpaceTokens filterWithTokenViewGroups(String[] viewGroups) {

    return start().withWarehouse().withGoodsListIfViewGroupInclude(viewGroups);
  }

  public static ShippingSpaceTokens allTokens() {
  ...
  public ShippingSpaceTokens withGoodsListIfViewGroupInclude(String[] viewGroups) {
