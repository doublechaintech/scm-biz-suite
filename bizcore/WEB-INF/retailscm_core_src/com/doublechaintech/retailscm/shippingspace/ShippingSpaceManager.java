...
public interface ShippingSpaceManager extends BaseManager{
  ...
  List<ShippingSpace> searchShippingSpaceList(RetailscmUserContext ctx, ShippingSpaceRequest pRequest);
  ShippingSpace searchShippingSpace(RetailscmUserContext ctx, ShippingSpaceRequest pRequest);
	...
	public default void onUpdated(RetailscmUserContext userContext, ShippingSpace updated, Object actor, String methodName) throws Exception {};
