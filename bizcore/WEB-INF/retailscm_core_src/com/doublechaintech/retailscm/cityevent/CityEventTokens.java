...
public class CityEventTokens extends CommonTokens {
  ...
  public static CityEventTokens loadGroupTokens(String... groupNames) {
    CityEventTokens tokens = start();
  ...
  private static void addToken(
      CityEventTokens pTokens, String pTokenName, String[] pGroupNames, String[] fieldGroups) {
  ...
  public static CityEventTokens filterWithTokenViewGroups(String[] viewGroups) {

    return start().withCityServiceCenter().withEventAttendanceListIfViewGroupInclude(viewGroups);
  }

  public static CityEventTokens allTokens() {

    return start().withCityServiceCenter().withEventAttendanceList();
  }

  public static CityEventTokens withoutListsTokens() {

    return start().withCityServiceCenter();
  }
  ...
  public CityEventTokens withEventAttendanceListIfViewGroupInclude(String[] viewGroups) {
