...
public class StorageSpace extends BaseEntity implements java.io.Serializable {
  ...
  public void transferAllRelationshipsTo(StorageSpace target) {
    if (target == null) {
      return;
    }
  ...
  static {
    ...
    memberMetaInfoList.add(
        MemberMetaInfo.referBy(GOODS_SHELF_LIST, "storageSpace", "货架列表")
  ...
  public StorageSpace updateId(String id) {
    String oldId = this.id;
    String newId = trimString(id);
  ...
  public StorageSpace ignoreIdCriteria() {
  ...
  public StorageSpace updateLocation(String location) {
    String oldLocation = this.location;
    String newLocation = trimString(location);
  ...
  public StorageSpace ignoreLocationCriteria() {
  ...
  public StorageSpace ignoreContactNumberCriteria() {
  ...
  public StorageSpace updateTotalArea(String totalArea) {
    String oldTotalArea = this.totalArea;
    String newTotalArea = trimString(totalArea);
  ...
  public StorageSpace ignoreTotalAreaCriteria() {
  ...
  public StorageSpace updateWarehouse(Warehouse warehouse) {
    Warehouse oldWarehouse = this.warehouse;
    Warehouse newWarehouse = warehouse;
  ...
  public StorageSpace ignoreWarehouseCriteria() {
  ...
  public StorageSpace updateWarehouseByReferenceId(String warehouseId) {
  ...
  public StorageSpace updateLatitude(BigDecimal latitude) {
    BigDecimal oldLatitude = this.latitude;
    BigDecimal newLatitude = latitude;
  ...
  public StorageSpace ignoreLatitudeCriteria() {
  ...
  public StorageSpace updateLongitude(BigDecimal longitude) {
    BigDecimal oldLongitude = this.longitude;
    BigDecimal newLongitude = longitude;
  ...
  public StorageSpace ignoreLongitudeCriteria() {
  ...
  public StorageSpace updateLastUpdateTime(DateTime lastUpdateTime) {
    DateTime oldLastUpdateTime = this.lastUpdateTime;
    DateTime newLastUpdateTime = lastUpdateTime;
  ...
  public StorageSpace ignoreLastUpdateTimeCriteria() {
  ...
  public StorageSpace updateVersion(int version) {
    int oldVersion = this.version;
    int newVersion = version;
  ...
  public StorageSpace ignoreVersionCriteria() {
  ...
  public StorageSpace addGoodsShelf(GoodsShelf goodsShelf) {
    goodsShelf.updateStorageSpace(this);
  ...
  public BaseEntity mergeDataFrom(BaseEntity sourceEntity) {
    ...
    if (sourceEntity instanceof StorageSpace) {

      StorageSpace source = (StorageSpace) sourceEntity;
  ...
  public boolean checkIfEligibleForDelete(Object ctx) {
    ...
    StorageSpace checkStorageSpace =
        Q.storageSpaceWithIdField()
            .filterById(id)
            .selectGoodsShelfList(Q.goodsShelfWithIdField().limit(0, 1))
            .execute(ctx);

    return checkStorageSpace != null
        && !checkStorageSpace.getAllRelatedLists().stream()
            .flatMap(subList -> subList.stream())
            .findFirst()
            .isPresent();
  }

  public StorageSpace save(com.doublechaintech.retailscm.RetailscmUserContext ctx) {
    try {
