...
public class StorageSpaceManagerImpl extends CustomRetailscmCheckerManager implements StorageSpaceManager, BusinessHandler{
	...
	public Object prepareContextForUserApp(BaseUserContext userContext,Object targetUserApp) throws Exception{
	 ...
	 public Object summaryView(RetailscmUserContext userContext, String storageSpaceId) throws Exception{
		StorageSpace storageSpace = loadStorageSpace( userContext, storageSpaceId, viewTokens());
  ...
  @Override
  public List<StorageSpace> searchStorageSpaceList(RetailscmUserContext ctx, StorageSpaceRequest pRequest){
