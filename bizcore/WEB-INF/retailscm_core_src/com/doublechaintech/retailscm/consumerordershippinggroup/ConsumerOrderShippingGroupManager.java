...
public interface ConsumerOrderShippingGroupManager extends BaseManager{
  ...
  List<ConsumerOrderShippingGroup> searchConsumerOrderShippingGroupList(RetailscmUserContext ctx, ConsumerOrderShippingGroupRequest pRequest);
  ConsumerOrderShippingGroup searchConsumerOrderShippingGroup(RetailscmUserContext ctx, ConsumerOrderShippingGroupRequest pRequest);
	...
	public default void onUpdated(RetailscmUserContext userContext, ConsumerOrderShippingGroup updated, Object actor, String methodName) throws Exception {};
