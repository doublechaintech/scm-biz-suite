...
public class ConsumerOrderShippingGroupManagerImpl extends CustomRetailscmCheckerManager
    implements ConsumerOrderShippingGroupManager, BusinessHandler {
  ...
  protected void throwExceptionWithMessage(String value)
      throws ConsumerOrderShippingGroupManagerException {
  ...
  protected ConsumerOrderShippingGroup saveConsumerOrderShippingGroupDetail(
      RetailscmUserContext userContext, ConsumerOrderShippingGroup consumerOrderShippingGroup)
      throws Exception {

    return saveConsumerOrderShippingGroup(userContext, consumerOrderShippingGroup, allTokens());
  }

  public ConsumerOrderShippingGroup loadConsumerOrderShippingGroup(
      RetailscmUserContext userContext, String consumerOrderShippingGroupId, String[] tokensExpr)
      throws Exception {

    checkerOf(userContext).checkIdOfConsumerOrderShippingGroup(consumerOrderShippingGroupId);

    checkerOf(userContext)
        .throwExceptionIfHasErrors(ConsumerOrderShippingGroupManagerException.class);

    Map<String, Object> tokens = parseTokens(tokensExpr);

    ConsumerOrderShippingGroup consumerOrderShippingGroup =
        loadConsumerOrderShippingGroup(userContext, consumerOrderShippingGroupId, tokens);
    // do some calc before sent to customer?
    return present(userContext, consumerOrderShippingGroup, tokens);
  }

  public ConsumerOrderShippingGroup searchConsumerOrderShippingGroup(
      RetailscmUserContext userContext,
  ...
  protected ConsumerOrderShippingGroup present(
      RetailscmUserContext userContext,
      ConsumerOrderShippingGroup consumerOrderShippingGroup,
      Map<String, Object> tokens)
      throws Exception {
    ...
    ConsumerOrderShippingGroup consumerOrderShippingGroupToPresent =
        consumerOrderShippingGroupDaoOf(userContext).present(consumerOrderShippingGroup, tokens);

    List<BaseEntity> entityListToNaming =
        consumerOrderShippingGroupToPresent.collectReferencesFromLists();
  ...
  public ConsumerOrderShippingGroup loadConsumerOrderShippingGroupDetail(
      RetailscmUserContext userContext, String consumerOrderShippingGroupId) throws Exception {
    ConsumerOrderShippingGroup consumerOrderShippingGroup =
        loadConsumerOrderShippingGroup(userContext, consumerOrderShippingGroupId, allTokens());
  ...
  public Object view(RetailscmUserContext userContext, String consumerOrderShippingGroupId)
      throws Exception {
    ConsumerOrderShippingGroup consumerOrderShippingGroup =
        loadConsumerOrderShippingGroup(userContext, consumerOrderShippingGroupId, viewTokens());
    markVisited(userContext, consumerOrderShippingGroup);
    return present(userContext, consumerOrderShippingGroup, viewTokens());
  }

  public Object summaryView(RetailscmUserContext userContext, String consumerOrderShippingGroupId)
      throws Exception {
    ConsumerOrderShippingGroup consumerOrderShippingGroup =
        loadConsumerOrderShippingGroup(userContext, consumerOrderShippingGroupId, viewTokens());
  ...
  public Object analyze(RetailscmUserContext userContext, String consumerOrderShippingGroupId)
      throws Exception {
    ConsumerOrderShippingGroup consumerOrderShippingGroup =
        loadConsumerOrderShippingGroup(userContext, consumerOrderShippingGroupId, analyzeTokens());
    markVisited(userContext, consumerOrderShippingGroup);
  ...
  protected ConsumerOrderShippingGroup loadConsumerOrderShippingGroup(
      RetailscmUserContext userContext,
      String consumerOrderShippingGroupId,
      Map<String, Object> tokens)
      throws Exception {
  ...
  protected <T extends BaseEntity> void addActions(
    ...
    // userContext, ConsumerOrderShippingGroup consumerOrderShippingGroup, Map<String, Object>
    // tokens){

  @Override
  public List<ConsumerOrderShippingGroup> searchConsumerOrderShippingGroupList(
      RetailscmUserContext ctx, ConsumerOrderShippingGroupRequest pRequest) {
  ...
  public ConsumerOrderShippingGroup createConsumerOrderShippingGroup(
    ...
    consumerOrderShippingGroup =
        saveConsumerOrderShippingGroup(userContext, consumerOrderShippingGroup, emptyOptions());
  ...
  public ConsumerOrderShippingGroup clone(
      RetailscmUserContext userContext, String fromConsumerOrderShippingGroupId) throws Exception {

    return consumerOrderShippingGroupDaoOf(userContext)
        .clone(fromConsumerOrderShippingGroupId, this.allTokens());
  }

  public ConsumerOrderShippingGroup internalSaveConsumerOrderShippingGroup(
      RetailscmUserContext userContext, ConsumerOrderShippingGroup consumerOrderShippingGroup)
      throws Exception {
    return internalSaveConsumerOrderShippingGroup(
        userContext, consumerOrderShippingGroup, allTokens());
  }
  ...
  public ConsumerOrderShippingGroup internalSaveConsumerOrderShippingGroup(
      ...
      throws Exception {
    // checkParamsForUpdatingConsumerOrderShippingGroup(userContext, consumerOrderShippingGroupId,
    // consumerOrderShippingGroupVersion, property, newValueExpr, tokensExpr);
    ...
    synchronized (consumerOrderShippingGroup) {
      ...
      consumerOrderShippingGroup =
          saveConsumerOrderShippingGroup(userContext, consumerOrderShippingGroup, options);
      return consumerOrderShippingGroup;
    }
  }

  public ConsumerOrderShippingGroup updateConsumerOrderShippingGroup(
      RetailscmUserContext userContext,
      String consumerOrderShippingGroupId,
      int consumerOrderShippingGroupVersion,
      String property,
    ...
    synchronized (consumerOrderShippingGroup) {
      ...
      consumerOrderShippingGroup =
          saveConsumerOrderShippingGroup(userContext, consumerOrderShippingGroup, tokens().done());
      return present(userContext, consumerOrderShippingGroup, mergedAllTokens(tokensExpr));
      // return saveConsumerOrderShippingGroup(userContext, consumerOrderShippingGroup,
      // tokens().done());
    }
  }

  public ConsumerOrderShippingGroup updateConsumerOrderShippingGroupProperty(
      RetailscmUserContext userContext,
      String consumerOrderShippingGroupId,
      int consumerOrderShippingGroupVersion,
      String property,
  ...
  public ConsumerOrderShippingGroup transferToAnotherBizOrder(
      RetailscmUserContext userContext,
      String consumerOrderShippingGroupId,
      String anotherBizOrderId)
      throws Exception {
    checkParamsForTransferingAnotherBizOrder(
        userContext, consumerOrderShippingGroupId, anotherBizOrderId);
  ...
  public CandidateConsumerOrder requestCandidateBizOrder(
    ...
    SmartList<ConsumerOrder> candidateList =
        consumerOrderDaoOf(userContext)
            .requestCandidateConsumerOrderForConsumerOrderShippingGroup(
  ...
  public ConsumerOrderShippingGroup forgetByAll(
      RetailscmUserContext userContext,
      String consumerOrderShippingGroupId,
      int consumerOrderShippingGroupVersion)
      throws Exception {
    return forgetByAllInternal(
        userContext, consumerOrderShippingGroupId, consumerOrderShippingGroupVersion);
  }

  protected ConsumerOrderShippingGroup forgetByAllInternal(
      RetailscmUserContext userContext,
      String consumerOrderShippingGroupId,
      int consumerOrderShippingGroupVersion)
      throws Exception {
    ...
    return consumerOrderShippingGroupDaoOf(userContext)
        .disconnectFromAll(consumerOrderShippingGroupId, consumerOrderShippingGroupVersion);
  }
  ...
  public void onNewInstanceCreated(
      RetailscmUserContext userContext, ConsumerOrderShippingGroup newCreated) throws Exception {
    ensureRelationInGraph(userContext, newCreated);
    sendCreationEvent(userContext, newCreated);
  }

  public void sendAllItems(RetailscmUserContext ctx) throws Exception {
    consumerOrderShippingGroupDaoOf(ctx)
        .loadAllAsStream()
  ...
  public void onAuthenticateNewUserLogged(
    ...
    // this.createConsumerOrderShippingGroup(userContext, ...
  ...
  protected void enhanceForListOfView(
      RetailscmUserContext userContext, SmartList<ConsumerOrderShippingGroup> list)
      throws Exception {
    if (list == null || list.isEmpty()) {
      return;
    }
  ...
  public Object listPageByBizOrder(
    ...
    SmartList<ConsumerOrderShippingGroup> list =
        consumerOrderShippingGroupDaoOf(userContext)
            .findConsumerOrderShippingGroupByBizOrder(bizOrderId, start, count, new HashMap<>());
   ...
   * @throws Exception
   */
  public Object wxappview(RetailscmUserContext userContext, String consumerOrderShippingGroupId)
      throws Exception {
    SerializeScope vscope = SerializeScope.EXCLUDE().nothing();
    ConsumerOrderShippingGroup merchantObj =
        (ConsumerOrderShippingGroup) this.view(userContext, consumerOrderShippingGroupId);
