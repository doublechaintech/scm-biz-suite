...
public class EmployeeAwardMapper extends BaseRowMapper<EmployeeAward> {
  ...
  public static EmployeeAwardMapper mapperForClass(Class<?> clazz) {

    EmployeeAwardMapper mapperForOverride = new EmployeeAwardMapper();
  ...
  protected void setId(EmployeeAward employeeAward, ResultSet rs, int rowNumber)
      throws SQLException {
    try {
  ...
  protected void setEmployee(EmployeeAward employeeAward, ResultSet rs, int rowNumber)
      throws SQLException {
    String employeeId;
    try {
  ...
  protected void setCompleteTime(EmployeeAward employeeAward, ResultSet rs, int rowNumber)
      throws SQLException {
    try {
      // there will be issue when the type is double/int/long
  ...
  protected void setType(EmployeeAward employeeAward, ResultSet rs, int rowNumber)
      throws SQLException {
    try {
      // there will be issue when the type is double/int/long
  ...
  protected void setRemark(EmployeeAward employeeAward, ResultSet rs, int rowNumber)
      throws SQLException {
    try {
      // there will be issue when the type is double/int/long
  ...
  protected void setVersion(EmployeeAward employeeAward, ResultSet rs, int rowNumber)
      throws SQLException {
    try {
      // there will be issue when the type is double/int/long
