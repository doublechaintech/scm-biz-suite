...
public class EmployeeAwardManagerImpl extends CustomRetailscmCheckerManager
    implements EmployeeAwardManager, BusinessHandler {
  ...
  protected EmployeeAward saveEmployeeAward(
      RetailscmUserContext userContext, EmployeeAward employeeAward, String[] tokensExpr)
      throws Exception {
  ...
  protected EmployeeAward saveEmployeeAwardDetail(
      RetailscmUserContext userContext, EmployeeAward employeeAward) throws Exception {

    return saveEmployeeAward(userContext, employeeAward, allTokens());
  }

  public EmployeeAward loadEmployeeAward(
      RetailscmUserContext userContext, String employeeAwardId, String[] tokensExpr)
      throws Exception {
  ...
  public EmployeeAward searchEmployeeAward(
  ...
  protected EmployeeAward present(
      RetailscmUserContext userContext, EmployeeAward employeeAward, Map<String, Object> tokens)
      throws Exception {

    addActions(userContext, employeeAward, tokens);

    EmployeeAward employeeAwardToPresent =
        employeeAwardDaoOf(userContext).present(employeeAward, tokens);

    List<BaseEntity> entityListToNaming = employeeAwardToPresent.collectReferencesFromLists();
  ...
  public EmployeeAward loadEmployeeAwardDetail(
      RetailscmUserContext userContext, String employeeAwardId) throws Exception {
  ...
  public Object summaryView(RetailscmUserContext userContext, String employeeAwardId)
      throws Exception {
    EmployeeAward employeeAward = loadEmployeeAward(userContext, employeeAwardId, viewTokens());
  ...
  protected EmployeeAward loadEmployeeAward(
      RetailscmUserContext userContext, String employeeAwardId, Map<String, Object> tokens)
      throws Exception {
    checkerOf(userContext).checkIdOfEmployeeAward(employeeAwardId);
  ...
  protected <T extends BaseEntity> void addActions(
    ...
    // userContext, EmployeeAward employeeAward, Map<String, Object> tokens){

  @Override
  public List<EmployeeAward> searchEmployeeAwardList(
      RetailscmUserContext ctx, EmployeeAwardRequest pRequest) {
  ...
  public EmployeeAward clone(RetailscmUserContext userContext, String fromEmployeeAwardId)
      throws Exception {

    return employeeAwardDaoOf(userContext).clone(fromEmployeeAwardId, this.allTokens());
  }

  public EmployeeAward internalSaveEmployeeAward(
      RetailscmUserContext userContext, EmployeeAward employeeAward) throws Exception {
    return internalSaveEmployeeAward(userContext, employeeAward, allTokens());
  }

  public EmployeeAward internalSaveEmployeeAward(
      RetailscmUserContext userContext, EmployeeAward employeeAward, Map<String, Object> options)
      throws Exception {
    // checkParamsForUpdatingEmployeeAward(userContext, employeeAwardId, employeeAwardVersion,
  ...
  public EmployeeAward updateEmployeeAward(
      RetailscmUserContext userContext,
      String employeeAwardId,
      int employeeAwardVersion,
      String property,
    ...
    checkParamsForUpdatingEmployeeAward(
        userContext, employeeAwardId, employeeAwardVersion, property, newValueExpr, tokensExpr);
  ...
  public EmployeeAward updateEmployeeAwardProperty(
      RetailscmUserContext userContext,
      String employeeAwardId,
      int employeeAwardVersion,
      String property,
  ...
  protected void checkParamsForTransferingAnotherEmployee(
      RetailscmUserContext userContext, String employeeAwardId, String anotherEmployeeId)
      throws Exception {
  ...
  public EmployeeAward transferToAnotherEmployee(
      RetailscmUserContext userContext, String employeeAwardId, String anotherEmployeeId)
      throws Exception {
  ...
  public CandidateEmployee requestCandidateEmployee(
    ...
    SmartList<Employee> candidateList =
        employeeDaoOf(userContext)
            .requestCandidateEmployeeForEmployeeAward(
  ...
  public EmployeeAward forgetByAll(
      RetailscmUserContext userContext, String employeeAwardId, int employeeAwardVersion)
      throws Exception {
    return forgetByAllInternal(userContext, employeeAwardId, employeeAwardVersion);
  }

  protected EmployeeAward forgetByAllInternal(
      RetailscmUserContext userContext, String employeeAwardId, int employeeAwardVersion)
      throws Exception {
  ...
  public void onNewInstanceCreated(RetailscmUserContext userContext, EmployeeAward newCreated)
      throws Exception {
  ...
  public void sendAllItems(RetailscmUserContext ctx) throws Exception {
    employeeAwardDaoOf(ctx).loadAllAsStream().forEach(event -> sendInitEvent(ctx, event));
  }
  ...
  protected void enhanceForListOfView(
      RetailscmUserContext userContext, SmartList<EmployeeAward> list) throws Exception {
    if (list == null || list.isEmpty()) {
      return;
    }
  ...
  public Object listPageByEmployee(
    ...
    SmartList<EmployeeAward> list =
        employeeAwardDaoOf(userContext)
            .findEmployeeAwardByEmployee(employeeId, start, count, new HashMap<>());
   ...
   * @throws Exception
   */
  public Object wxappview(RetailscmUserContext userContext, String employeeAwardId)
      throws Exception {
