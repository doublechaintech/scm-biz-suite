...
import com.doublechaintech.retailscm.*;import com.doublechaintech.retailscm.BaseViewPage;import com.doublechaintech.retailscm.RetailscmUserContextImpl;import com.doublechaintech.retailscm.companytraining.CandidateCompanyTraining;import com.doublechaintech.retailscm.companytraining.CompanyTraining;import com.doublechaintech.retailscm.employee.CandidateEmployee;import com.doublechaintech.retailscm.employee.Employee;import com.doublechaintech.retailscm.iamservice.*;import com.doublechaintech.retailscm.scoring.CandidateScoring;import com.doublechaintech.retailscm.scoring.Scoring;import com.doublechaintech.retailscm.secuser.SecUser;import com.doublechaintech.retailscm.services.IamService;import com.doublechaintech.retailscm.tree.*;import com.doublechaintech.retailscm.treenode.*;import com.doublechaintech.retailscm.userapp.UserApp;import com.doublechaintech.retailscm.utils.ModelAssurance;
...
public class EmployeeCompanyTrainingManagerImpl extends CustomRetailscmCheckerManager implements EmployeeCompanyTrainingManager, BusinessHandler{
	...
	public Object prepareContextForUserApp(BaseUserContext userContext,Object targetUserApp) throws Exception{
	 ...
	 public Object summaryView(RetailscmUserContext userContext, String employeeCompanyTrainingId) throws Exception{
		EmployeeCompanyTraining employeeCompanyTraining = loadEmployeeCompanyTraining( userContext, employeeCompanyTrainingId, viewTokens());
	 ...
	 public Object analyze(RetailscmUserContext userContext, String employeeCompanyTrainingId) throws Exception{
		EmployeeCompanyTraining employeeCompanyTraining = loadEmployeeCompanyTraining( userContext, employeeCompanyTrainingId, analyzeTokens());
		markVisited(userContext, employeeCompanyTraining);
  ...
  @Override
  public List<EmployeeCompanyTraining> searchEmployeeCompanyTrainingList(RetailscmUserContext ctx, EmployeeCompanyTrainingRequest pRequest){
  ...
  @Override
  public EmployeeCompanyTraining searchEmployeeCompanyTraining(RetailscmUserContext ctx, EmployeeCompanyTrainingRequest pRequest){
    pRequest.limit(0, 1);
 ...
 //--------------------------------------------------------------
  ...
  public void sendAllItems(RetailscmUserContext ctx) throws Exception{
    employeeCompanyTrainingDaoOf(ctx).loadAllAsStream().forEach(
  ...
  protected BusinessHandler getLoginProcessBizHandler(RetailscmUserContextImpl userContext) {
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(RetailscmUserContext userContext,SmartList<EmployeeCompanyTraining> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
		...
		List<CompanyTraining> trainingList = RetailscmBaseUtils.collectReferencedObjectWithType(userContext, list, CompanyTraining.class);
		userContext.getDAOGroup().enhanceList(trainingList, CompanyTraining.class);
		List<Scoring> scoringList = RetailscmBaseUtils.collectReferencedObjectWithType(userContext, list, Scoring.class);
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(RetailscmUserContext userContext, String employeeCompanyTrainingId) throws Exception{
