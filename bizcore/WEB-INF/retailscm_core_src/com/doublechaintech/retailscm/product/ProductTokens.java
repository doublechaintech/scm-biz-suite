...
public class ProductTokens extends CommonTokens {
  ...
  private static void addToken(
      ProductTokens pTokens, String pTokenName, String[] pGroupNames, String[] fieldGroups) {
  ...
  public static ProductTokens filterWithTokenViewGroups(String[] viewGroups) {
    ...
    return start().withParentCategory().withSkuListIfViewGroupInclude(viewGroups);
  }

  public static ProductTokens allTokens() {

    return start().withParentCategory().withSkuList();
  }
