...
public class MemberRewardPoint extends BaseEntity implements java.io.Serializable {
  ...
  public void transferAllRelationshipsTo(MemberRewardPoint target) {
    if (target == null) {
      return;
    }
  }
  ...
  public MemberRewardPoint ignoreIdCriteria() {
  ...
  public MemberRewardPoint ignoreNameCriteria() {
  ...
  public MemberRewardPoint ignorePointCriteria() {
  ...
  public MemberRewardPoint ignoreOwnerCriteria() {
  ...
  public MemberRewardPoint updateOwnerByReferenceId(String ownerId) {
  ...
  public MemberRewardPoint ignoreVersionCriteria() {
  ...
  public BaseEntity mergeDataFrom(BaseEntity sourceEntity) {
    ...
    if (sourceEntity instanceof MemberRewardPoint) {

      MemberRewardPoint source = (MemberRewardPoint) sourceEntity;
  ...
  public boolean checkIfEligibleForDelete(Object ctx) {
    ...
    MemberRewardPoint checkMemberRewardPoint =
        Q.memberRewardPointWithIdField().filterById(id).execute(ctx);

    return checkMemberRewardPoint != null
        && !checkMemberRewardPoint.getAllRelatedLists().stream()
            .flatMap(subList -> subList.stream())
            .findFirst()
            .isPresent();
  }

  public MemberRewardPoint save(com.doublechaintech.retailscm.RetailscmUserContext ctx) {
    try {
