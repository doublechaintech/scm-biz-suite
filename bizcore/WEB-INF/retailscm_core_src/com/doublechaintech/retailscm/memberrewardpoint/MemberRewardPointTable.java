...
public class MemberRewardPointTable {
  ...
  // protected
  public static final String TABLE_NAME = "member_reward_point_data";
  ...
  public static final String[] ALL_CLOUMNS = {
    COLUMN_ID, COLUMN_NAME, COLUMN_POINT, COLUMN_OWNER, COLUMN_VERSION
  };
  ...
  public static void ensureTable(RetailscmUserContext userContext, Map<String, Object> result)
    ...
    RetailscmBaseUtils.ensureTable(
        ...
        new String[] {
          ...
          "alter table member_reward_point_data add constraint fk4owner_of_member_reward_point_data foreign key (owner) references retail_store_member_data(id) ON DELETE CASCADE ON UPDATE CASCADE;",
          ""
        });
  }
}
