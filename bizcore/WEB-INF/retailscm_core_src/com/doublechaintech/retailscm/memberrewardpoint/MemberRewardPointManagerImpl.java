...
public class MemberRewardPointManagerImpl extends CustomRetailscmCheckerManager implements MemberRewardPointManager, BusinessHandler{
	...
	public Object prepareContextForUserApp(BaseUserContext userContext,Object targetUserApp) throws Exception{
	 ...
	 public Object summaryView(RetailscmUserContext userContext, String memberRewardPointId) throws Exception{
		MemberRewardPoint memberRewardPoint = loadMemberRewardPoint( userContext, memberRewardPointId, viewTokens());
	 ...
	 public Object analyze(RetailscmUserContext userContext, String memberRewardPointId) throws Exception{
		MemberRewardPoint memberRewardPoint = loadMemberRewardPoint( userContext, memberRewardPointId, analyzeTokens());
		markVisited(userContext, memberRewardPoint);
  ...
  @Override
  public List<MemberRewardPoint> searchMemberRewardPointList(RetailscmUserContext ctx, MemberRewardPointRequest pRequest){
  ...
  @Override
  public MemberRewardPoint searchMemberRewardPoint(RetailscmUserContext ctx, MemberRewardPointRequest pRequest){
    pRequest.limit(0, 1);
 ...
 //--------------------------------------------------------------
  ...
  public void sendAllItems(RetailscmUserContext ctx) throws Exception{
    memberRewardPointDaoOf(ctx).loadAllAsStream().forEach(
