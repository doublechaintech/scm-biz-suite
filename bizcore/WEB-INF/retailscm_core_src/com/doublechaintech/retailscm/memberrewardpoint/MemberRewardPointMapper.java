...
public class MemberRewardPointMapper extends BaseRowMapper<MemberRewardPoint> {
  ...
  public static MemberRewardPointMapper mapperForClass(Class<?> clazz) {

    MemberRewardPointMapper mapperForOverride = new MemberRewardPointMapper();
  ...
  protected void setId(MemberRewardPoint memberRewardPoint, ResultSet rs, int rowNumber)
      throws SQLException {
    try {
  ...
  protected void setName(MemberRewardPoint memberRewardPoint, ResultSet rs, int rowNumber)
      throws SQLException {
    try {
      // there will be issue when the type is double/int/long
  ...
  protected void setPoint(MemberRewardPoint memberRewardPoint, ResultSet rs, int rowNumber)
      throws SQLException {
    try {
      // there will be issue when the type is double/int/long
  ...
  protected void setOwner(MemberRewardPoint memberRewardPoint, ResultSet rs, int rowNumber)
      throws SQLException {
  ...
  protected void setVersion(MemberRewardPoint memberRewardPoint, ResultSet rs, int rowNumber)
      throws SQLException {
    try {
      // there will be issue when the type is double/int/long
