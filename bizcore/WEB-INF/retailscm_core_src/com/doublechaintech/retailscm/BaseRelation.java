...
public class BaseRelation {
  ...
  public String getRelation(String fromType, String fromId, String targetField, String targetId) {
    // the entry for external calls, ugly code with many path just works, using a map is fine but
    // lose the way to override the methods
    ...
    if (relation == null) {
      throw new IllegalArgumentException(
          "Not able to find any relation to the target type: " + targetField);
    }
    return relation;
  }
  ...
  protected void prepareRelationIndex() {
    ...
    String[] provinceCenterDepartmentRelatedObjectNames = {
      "province_center:RetailStoreProvinceCenter"
    };
    addRelationIndex("ProvinceCenterDepartment", provinceCenterDepartmentRelatedObjectNames);

    String[] provinceCenterEmployeeRelatedObjectNames = {
      "department:ProvinceCenterDepartment", "province_center:RetailStoreProvinceCenter"
    };
    addRelationIndex("ProvinceCenterEmployee", provinceCenterEmployeeRelatedObjectNames);

    String[] retailStoreCityServiceCenterRelatedObjectNames = {
      "belongs_to:RetailStoreProvinceCenter"
    };
    addRelationIndex(
        "RetailStoreCityServiceCenter", retailStoreCityServiceCenterRelatedObjectNames);
    ...
    String[] potentialCustomerRelatedObjectNames = {
      "city_service_center:RetailStoreCityServiceCenter", "city_partner:CityPartner"
    };
    addRelationIndex("PotentialCustomer", potentialCustomerRelatedObjectNames);

    String[] potentialCustomerContactPersonRelatedObjectNames = {
      "potential_customer:PotentialCustomer"
    };
    addRelationIndex(
        "PotentialCustomerContactPerson", potentialCustomerContactPersonRelatedObjectNames);

    String[] potentialCustomerContactRelatedObjectNames = {
      "potential_customer:PotentialCustomer",
      "city_partner:CityPartner",
      "contact_to:PotentialCustomerContactPerson"
    };
    ...
    String[] eventAttendanceRelatedObjectNames = {
      "potential_customer:PotentialCustomer", "city_event:CityEvent"
    };
    addRelationIndex("EventAttendance", eventAttendanceRelatedObjectNames);

    String[] retailStoreRelatedObjectNames = {
      "retail_store_country_center:RetailStoreCountryCenter",
      "city_service_center:RetailStoreCityServiceCenter",
      "creation:RetailStoreCreation",
      "investment_invitation:RetailStoreInvestmentInvitation",
      "franchising:RetailStoreFranchising",
      "decoration:RetailStoreDecoration",
      "opening:RetailStoreOpening",
      "closing:RetailStoreClosing"
    };
    ...
    addRelationIndex(
        "ConsumerOrderPriceAdjustment", consumerOrderPriceAdjustmentRelatedObjectNames);
    ...
    String[] retailStoreMemberGiftCardConsumeRecordRelatedObjectNames = {
      "owner:RetailStoreMemberGiftCard", "biz_order:ConsumerOrder"
    };
    addRelationIndex(
        "RetailStoreMemberGiftCardConsumeRecord",
        retailStoreMemberGiftCardConsumeRecordRelatedObjectNames);
    ...
    String[] supplyOrderRelatedObjectNames = {
      "buyer:RetailStoreCountryCenter", "seller:GoodsSupplier"
    };
    ...
    String[] retailStoreOrderRelatedObjectNames = {
      "buyer:RetailStore", "seller:RetailStoreCountryCenter"
    };
    ...
    addRelationIndex(
        "RetailStoreOrderShippingGroup", retailStoreOrderShippingGroupRelatedObjectNames);

    String[] retailStoreOrderPaymentGroupRelatedObjectNames = {"biz_order:RetailStoreOrder"};
    addRelationIndex(
        "RetailStoreOrderPaymentGroup", retailStoreOrderPaymentGroupRelatedObjectNames);
    ...
    String[] goodsShelfRelatedObjectNames = {
      "storage_space:StorageSpace", "supplier_space:SupplierSpace", "damage_space:DamageSpace"
    };
    ...
    String[] goodsRelatedObjectNames = {
      "sku:Sku",
      "receiving_space:ReceivingSpace",
      "goods_allocation:GoodsAllocation",
      "smart_pallet:SmartPallet",
      "shipping_space:ShippingSpace",
      "transport_task:TransportTask",
      "retail_store:RetailStore",
      "biz_order:SupplyOrder",
      "retail_store_order:RetailStoreOrder"
    };
    ...
    String[] transportTaskRelatedObjectNames = {
      "end:RetailStore", "driver:TruckDriver", "truck:TransportTruck", "belongs_to:TransportFleet"
    };
    ...
    String[] accountSetRelatedObjectNames = {
      "country_center:RetailStoreCountryCenter",
      "retail_store:RetailStore",
    ...
    String[] accountingDocumentRelatedObjectNames = {
      "accounting_period:AccountingPeriod", "document_type:AccountingDocumentType"
    };
    ...
    String[] accountingDocumentLineRelatedObjectNames = {
      "belongs_to:AccountingDocument", "accounting_subject:AccountingSubject"
    };
    ...
    String[] employeeRelatedObjectNames = {
      "company:RetailStoreCountryCenter",
      "department:LevelThreeDepartment",
      "occupation:OccupationType",
      "responsible_for:ResponsibilityType",
      "current_salary_grade:SalaryGrade"
    };
    ...
    String[] companyTrainingRelatedObjectNames = {
      "company:RetailStoreCountryCenter",
      "instructor:Instructor",
      "training_course_type:TrainingCourseType"
    };
    addRelationIndex("CompanyTraining", companyTrainingRelatedObjectNames);

    String[] employeeCompanyTrainingRelatedObjectNames = {
      "employee:Employee", "training:CompanyTraining", "scoring:Scoring"
    };
    ...
    String[] employeeInterviewRelatedObjectNames = {
      "employee:Employee", "interview_type:InterviewType"
    };
    ...
    String[] employeeSalarySheetRelatedObjectNames = {
      "employee:Employee", "current_salary_grade:SalaryGrade", "paying_off:PayingOff"
    };
  ...
  // default for reading trust chain, the default sequence are MXWR, the order is not affect the
  // result
