...
public class TerminationTypeTable{
	...
	public static final String []NORMAL_CLOUMNS = {COLUMN_CODE,COLUMN_COMPANY,COLUMN_BASE_DESCRIPTION,COLUMN_DETAIL_DESCRIPTION};
	  ...
	  public static void ensureTable(RetailscmUserContext userContext, Map<String, Object> result) throws Exception {
        RetailscmBaseUtils.ensureTable(userContext, result, "termination_type_data", new String[][]{
                ...
                new String[]{"detail_description","varchar(248)","","详细描述","",""},
                ...
                "alter table termination_type_data add constraint fk4company_of_termination_type_data foreign key (company) references retail_store_country_center_data(id) ON DELETE CASCADE ON UPDATE CASCADE;",
                ""
         });
  }
