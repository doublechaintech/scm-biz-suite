...
public class TerminationTypeTokens extends CommonTokens {
  ...
  public static TerminationTypeTokens loadGroupTokens(String... groupNames) {
    TerminationTypeTokens tokens = start();
  ...
  public static TerminationTypeTokens filterWithTokenViewGroups(String[] viewGroups) {

    return start().withCompany().withTerminationListIfViewGroupInclude(viewGroups);
  }

  public static TerminationTypeTokens allTokens() {

    return start().withCompany().withTerminationList();
  }
  ...
  public TerminationTypeTokens withTerminationListIfViewGroupInclude(String[] viewGroups) {
