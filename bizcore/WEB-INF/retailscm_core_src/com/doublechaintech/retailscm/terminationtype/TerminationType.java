...
public class TerminationType extends BaseEntity implements java.io.Serializable {
  ...
  public void transferAllRelationshipsTo(TerminationType target) {
    if (target == null) {
      return;
    }
    target.addTerminationList(this.getTerminationList());
  }
  ...
  static {
    ...
    memberMetaInfoList.add(
        MemberMetaInfo.referBy(TERMINATION_LIST, "type", "终止列表")
  ...
  public Object propertyOf(String property) {
    ...
    if (TERMINATION_LIST.equals(property)) {
      List<BaseEntity> list =
          getTerminationList().stream().map(item -> item).collect(Collectors.toList());
      return list;
    }
  ...
  public TerminationType ignoreIdCriteria() {
  ...
  public TerminationType ignoreCodeCriteria() {
  ...
  public TerminationType ignoreCompanyCriteria() {
  ...
  public TerminationType updateCompanyByReferenceId(String companyId) {
  ...
  public TerminationType ignoreBaseDescriptionCriteria() {
  ...
  public TerminationType ignoreDetailDescriptionCriteria() {
    super.ignoreSearchProperty(DETAIL_DESCRIPTION_PROPERTY);
    return this;
  }

  public TerminationType addDetailDescriptionCriteria(
      QueryOperator operator, Object... parameters) {
  ...
  public TerminationType ignoreVersionCriteria() {
  ...
  public TerminationType addTerminationList(SmartList<Termination> terminationList) {
    ...
    Map<String, Termination> mapById = terminationList.mapWithId();
    getTerminationList().removeIf(item -> mapById.get(item.getId()) != null);
  ...
  public Termination removeTermination(Termination terminationIndex) {
    ...
    if (index < 0) {
      String message =
          "Termination("
              + terminationIndex.getId()
              + ") with version='"
              + terminationIndex.getVersion()
              + "' NOT found!";
  ...
  public List<KeyValuePair> keyValuePairOf() {
    ...
    if (!getTerminationList().isEmpty()) {
      ...
      appendKeyValuePair(
          result, "terminationCurrentPageNumber", getTerminationList().getCurrentPageNumber());
    }
  ...
  public BaseEntity mergeDataFrom(BaseEntity sourceEntity) {
    ...
    if (sourceEntity instanceof TerminationType) {

      TerminationType source = (TerminationType) sourceEntity;
      ...
      mergeTerminationList(source.getTerminationList());
    }
  ...
  public boolean checkIfEligibleForDelete(Object ctx) {
    ...
    TerminationType checkTerminationType =
        Q.terminationTypeWithIdField()
            .filterById(id)
            .selectTerminationList(Q.terminationWithIdField().limit(0, 1))
            .execute(ctx);

    return checkTerminationType != null
        && !checkTerminationType.getAllRelatedLists().stream()
            .flatMap(subList -> subList.stream())
            .findFirst()
            .isPresent();
  }

  public TerminationType save(com.doublechaintech.retailscm.RetailscmUserContext ctx) {
    try {
