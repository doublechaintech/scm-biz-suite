...
public interface TerminationTypeManager extends BaseManager{
  ...
  List<TerminationType> searchTerminationTypeList(RetailscmUserContext ctx, TerminationTypeRequest pRequest);
  TerminationType searchTerminationType(RetailscmUserContext ctx, TerminationTypeRequest pRequest);
	...
	public default void onUpdated(RetailscmUserContext userContext, TerminationType updated, Object actor, String methodName) throws Exception {};
