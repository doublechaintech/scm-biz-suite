...
public class PotentialCustomerContactPersonTokens extends CommonTokens {
  ...
  private static void addToken(
      PotentialCustomerContactPersonTokens pTokens,
      String pTokenName,
      String[] pGroupNames,
      String[] fieldGroups) {
  ...
  public static PotentialCustomerContactPersonTokens filterWithTokenViewGroups(
      String[] viewGroups) {
  ...
  public static PotentialCustomerContactPersonTokens allTokens() {
    ...
    return start().withPotentialCustomer().withPotentialCustomerContactList();
  }

  public static PotentialCustomerContactPersonTokens withoutListsTokens() {

    return start().withPotentialCustomer();
  }
  ...
  public PotentialCustomerContactPersonTokens withPotentialCustomerContactListIfViewGroupInclude(
      String[] viewGroups) {
  ...
  public PotentialCustomerContactPersonTokens extractMoreFromPotentialCustomerContactList(
  ...
  public PotentialCustomerContactPersonTokens sortPotentialCustomerContactListWith(
  ...
  public PotentialCustomerContactPersonTokens searchPotentialCustomerContactListWith(
  ...
  public PotentialCustomerContactPersonTokens searchAllTextOfPotentialCustomerContactList(
  ...
  public PotentialCustomerContactPersonTokens rowsPerPageOfPotentialCustomerContactList(
      int rowsPerPage) {
    addSimpleOptions(POTENTIAL_CUSTOMER_CONTACT_LIST + "RowsPerPage", rowsPerPage);
    return this;
  }

  public PotentialCustomerContactPersonTokens currentPageNumberOfPotentialCustomerContactList(
      int currentPageNumber) {
    addSimpleOptions(POTENTIAL_CUSTOMER_CONTACT_LIST + "CurrentPage", currentPageNumber);
    return this;
  }

  public PotentialCustomerContactPersonTokens retainColumnsOfPotentialCustomerContactList(
      String[] columns) {
    addSimpleOptions(POTENTIAL_CUSTOMER_CONTACT_LIST + "RetainColumns", columns);
    return this;
  }

  public PotentialCustomerContactPersonTokens excludeColumnsOfPotentialCustomerContactList(
      String[] columns) {
