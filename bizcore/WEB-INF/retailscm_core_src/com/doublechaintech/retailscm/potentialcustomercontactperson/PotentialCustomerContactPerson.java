...
public class PotentialCustomerContactPerson extends BaseEntity implements java.io.Serializable {
  ...
  public void transferAllRelationshipsTo(PotentialCustomerContactPerson target) {
    if (target == null) {
      return;
    }
  ...
  static {
    ...
    memberMetaInfoList.add(
        MemberMetaInfo.referBy(POTENTIAL_CUSTOMER_CONTACT_LIST, "contactTo", "潜在客户联络名单")
  ...
  public PotentialCustomerContactPerson ignoreIdCriteria() {
    super.ignoreSearchProperty(ID_PROPERTY);
    return this;
  }

  public PotentialCustomerContactPerson addIdCriteria(
  ...
  public PotentialCustomerContactPerson ignoreNameCriteria() {
    super.ignoreSearchProperty(NAME_PROPERTY);
    return this;
  }

  public PotentialCustomerContactPerson addNameCriteria(
      QueryOperator operator, Object... parameters) {
  ...
  public PotentialCustomerContactPerson ignoreMobileCriteria() {
    super.ignoreSearchProperty(MOBILE_PROPERTY);
    return this;
  }

  public PotentialCustomerContactPerson addMobileCriteria(
      QueryOperator operator, Object... parameters) {
  ...
  public PotentialCustomerContactPerson updatePotentialCustomer(
  ...
  public PotentialCustomerContactPerson ignorePotentialCustomerCriteria() {
    super.ignoreSearchProperty(POTENTIAL_CUSTOMER_PROPERTY);
    return this;
  }

  public PotentialCustomerContactPerson addPotentialCustomerCriteria(
      QueryOperator operator, Object... parameters) {
  ...
  public PotentialCustomerContactPerson updatePotentialCustomerByReferenceId(
  ...
  public PotentialCustomerContactPerson ignoreDescriptionCriteria() {
    super.ignoreSearchProperty(DESCRIPTION_PROPERTY);
    return this;
  }

  public PotentialCustomerContactPerson addDescriptionCriteria(
      QueryOperator operator, Object... parameters) {
  ...
  public PotentialCustomerContactPerson ignoreVersionCriteria() {
    super.ignoreSearchProperty(VERSION_PROPERTY);
    return this;
  }

  public PotentialCustomerContactPerson addVersionCriteria(
      QueryOperator operator, Object... parameters) {
  ...
  public PotentialCustomerContactPerson addPotentialCustomerContact(
    ...
    potentialCustomerContact.updateContactTo(this);
    getPotentialCustomerContactList().add(potentialCustomerContact);
    return this;
  }

  public PotentialCustomerContactPerson addPotentialCustomerContactList(
      SmartList<PotentialCustomerContact> potentialCustomerContactList) {
    for (PotentialCustomerContact potentialCustomerContact : potentialCustomerContactList) {
      potentialCustomerContact.updateContactTo(this);
    }
  ...
  public BaseEntity mergeDataFrom(BaseEntity sourceEntity) {
    ...
    if (sourceEntity instanceof PotentialCustomerContactPerson) {

      PotentialCustomerContactPerson source = (PotentialCustomerContactPerson) sourceEntity;
  ...
  public Object[] toFlatArray() {
    return new Object[] {
      getId(), getName(), getMobile(), getPotentialCustomer(), getDescription(), getVersion()
    };
  }
  ...
  public boolean checkIfEligibleForDelete(Object ctx) {
    ...
    PotentialCustomerContactPerson checkPotentialCustomerContactPerson =
        Q.potentialCustomerContactPersonWithIdField()
            .filterById(id)
            .selectPotentialCustomerContactList(Q.potentialCustomerContactWithIdField().limit(0, 1))
            .execute(ctx);

    return checkPotentialCustomerContactPerson != null
        && !checkPotentialCustomerContactPerson.getAllRelatedLists().stream()
