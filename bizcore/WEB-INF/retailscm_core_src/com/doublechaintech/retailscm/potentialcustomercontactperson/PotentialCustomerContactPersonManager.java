...
public interface PotentialCustomerContactPersonManager extends BaseManager{
  ...
  List<PotentialCustomerContactPerson> searchPotentialCustomerContactPersonList(RetailscmUserContext ctx, PotentialCustomerContactPersonRequest pRequest);
  PotentialCustomerContactPerson searchPotentialCustomerContactPerson(RetailscmUserContext ctx, PotentialCustomerContactPersonRequest pRequest);
	...
	public default void onUpdated(RetailscmUserContext userContext, PotentialCustomerContactPerson updated, Object actor, String methodName) throws Exception {};
