...
public class RetailStoreMemberCoupon extends BaseEntity implements java.io.Serializable {
  ...
  public void transferAllRelationshipsTo(RetailStoreMemberCoupon target) {
    if (target == null) {
      return;
    }
  }
  ...
  public RetailStoreMemberCoupon ignoreIdCriteria() {
  ...
  public RetailStoreMemberCoupon ignoreNameCriteria() {
  ...
  public RetailStoreMemberCoupon ignoreOwnerCriteria() {
  ...
  public RetailStoreMemberCoupon updateOwnerByReferenceId(String ownerId) {
  ...
  public RetailStoreMemberCoupon ignoreNumberCriteria() {
  ...
  public RetailStoreMemberCoupon ignoreLastUpdateTimeCriteria() {
    super.ignoreSearchProperty(LAST_UPDATE_TIME_PROPERTY);
    return this;
  }

  public RetailStoreMemberCoupon addLastUpdateTimeCriteria(
  ...
  public RetailStoreMemberCoupon ignoreVersionCriteria() {
  ...
  public BaseEntity mergeDataFrom(BaseEntity sourceEntity) {
    ...
    if (sourceEntity instanceof RetailStoreMemberCoupon) {

      RetailStoreMemberCoupon source = (RetailStoreMemberCoupon) sourceEntity;
  ...
  public Object[] toFlatArray() {
    return new Object[] {
      getId(), getName(), getOwner(), getNumber(), getLastUpdateTime(), getVersion()
    };
  }
  ...
  public boolean checkIfEligibleForDelete(Object ctx) {
    ...
    RetailStoreMemberCoupon checkRetailStoreMemberCoupon =
        Q.retailStoreMemberCouponWithIdField().filterById(id).execute(ctx);

    return checkRetailStoreMemberCoupon != null
        && !checkRetailStoreMemberCoupon.getAllRelatedLists().stream()
            .flatMap(subList -> subList.stream())
            .findFirst()
            .isPresent();
  }

  public RetailStoreMemberCoupon save(com.doublechaintech.retailscm.RetailscmUserContext ctx) {
    try {
