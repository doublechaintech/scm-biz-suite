...
public interface RetailStoreMemberCouponManager extends BaseManager{
  ...
  List<RetailStoreMemberCoupon> searchRetailStoreMemberCouponList(RetailscmUserContext ctx, RetailStoreMemberCouponRequest pRequest);
  RetailStoreMemberCoupon searchRetailStoreMemberCoupon(RetailscmUserContext ctx, RetailStoreMemberCouponRequest pRequest);
	...
	public default void onUpdated(RetailscmUserContext userContext, RetailStoreMemberCoupon updated, Object actor, String methodName) throws Exception {};
