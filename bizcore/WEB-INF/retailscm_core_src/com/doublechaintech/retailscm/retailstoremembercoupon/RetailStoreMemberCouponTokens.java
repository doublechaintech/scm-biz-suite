...
public class RetailStoreMemberCouponTokens extends CommonTokens{
  ...
  public static RetailStoreMemberCouponTokens loadGroupTokens(String... groupNames){
    RetailStoreMemberCouponTokens tokens = start();
  ...
  private static void addToken(RetailStoreMemberCouponTokens pTokens, String pTokenName, String[] pGroupNames, String[] fieldGroups) {
	...
	public static RetailStoreMemberCouponTokens filterWithTokenViewGroups(String []viewGroups){
	...
	public static RetailStoreMemberCouponTokens allTokens(){
