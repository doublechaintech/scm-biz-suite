...
import com.doublechaintech.retailscm.*;import com.doublechaintech.retailscm.BaseViewPage;import com.doublechaintech.retailscm.RetailscmUserContextImpl;import com.doublechaintech.retailscm.goods.CandidateGoods;import com.doublechaintech.retailscm.goods.Goods;import com.doublechaintech.retailscm.iamservice.*;import com.doublechaintech.retailscm.secuser.SecUser;import com.doublechaintech.retailscm.services.IamService;import com.doublechaintech.retailscm.tree.*;import com.doublechaintech.retailscm.treenode.*;import com.doublechaintech.retailscm.userapp.UserApp;import com.doublechaintech.retailscm.utils.ModelAssurance;
...
public class GoodsMovementManagerImpl extends CustomRetailscmCheckerManager implements GoodsMovementManager, BusinessHandler{
	...
	public Object prepareContextForUserApp(BaseUserContext userContext,Object targetUserApp) throws Exception{
	 ...
	 public Object summaryView(RetailscmUserContext userContext, String goodsMovementId) throws Exception{
		GoodsMovement goodsMovement = loadGoodsMovement( userContext, goodsMovementId, viewTokens());
  ...
  @Override
  public List<GoodsMovement> searchGoodsMovementList(RetailscmUserContext ctx, GoodsMovementRequest pRequest){
  ...
  @Override
  public GoodsMovement searchGoodsMovement(RetailscmUserContext ctx, GoodsMovementRequest pRequest){
    pRequest.limit(0, 1);
 ...
 //--------------------------------------------------------------
  ...
  public void sendAllItems(RetailscmUserContext ctx) throws Exception{
    goodsMovementDaoOf(ctx).loadAllAsStream().forEach(
