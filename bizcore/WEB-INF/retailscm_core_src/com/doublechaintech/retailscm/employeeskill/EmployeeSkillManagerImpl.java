...
public class EmployeeSkillManagerImpl extends CustomRetailscmCheckerManager
    implements EmployeeSkillManager, BusinessHandler {
  ...
  protected EmployeeSkill saveEmployeeSkill(
      RetailscmUserContext userContext, EmployeeSkill employeeSkill, String[] tokensExpr)
      throws Exception {
  ...
  protected EmployeeSkill saveEmployeeSkillDetail(
      RetailscmUserContext userContext, EmployeeSkill employeeSkill) throws Exception {

    return saveEmployeeSkill(userContext, employeeSkill, allTokens());
  }

  public EmployeeSkill loadEmployeeSkill(
      RetailscmUserContext userContext, String employeeSkillId, String[] tokensExpr)
      throws Exception {
  ...
  public EmployeeSkill searchEmployeeSkill(
  ...
  protected EmployeeSkill present(
      RetailscmUserContext userContext, EmployeeSkill employeeSkill, Map<String, Object> tokens)
      throws Exception {

    addActions(userContext, employeeSkill, tokens);

    EmployeeSkill employeeSkillToPresent =
        employeeSkillDaoOf(userContext).present(employeeSkill, tokens);

    List<BaseEntity> entityListToNaming = employeeSkillToPresent.collectReferencesFromLists();
  ...
  public EmployeeSkill loadEmployeeSkillDetail(
      RetailscmUserContext userContext, String employeeSkillId) throws Exception {
  ...
  public Object summaryView(RetailscmUserContext userContext, String employeeSkillId)
      throws Exception {
    EmployeeSkill employeeSkill = loadEmployeeSkill(userContext, employeeSkillId, viewTokens());
  ...
  protected EmployeeSkill loadEmployeeSkill(
      RetailscmUserContext userContext, String employeeSkillId, Map<String, Object> tokens)
      throws Exception {
    checkerOf(userContext).checkIdOfEmployeeSkill(employeeSkillId);
  ...
  protected <T extends BaseEntity> void addActions(
    ...
    // userContext, EmployeeSkill employeeSkill, Map<String, Object> tokens){

  @Override
  public List<EmployeeSkill> searchEmployeeSkillList(
      RetailscmUserContext ctx, EmployeeSkillRequest pRequest) {
  ...
  public EmployeeSkill createEmployeeSkill(
      RetailscmUserContext userContext, String employeeId, String skillTypeId, String description)
      throws Exception {
  ...
  public EmployeeSkill clone(RetailscmUserContext userContext, String fromEmployeeSkillId)
      throws Exception {

    return employeeSkillDaoOf(userContext).clone(fromEmployeeSkillId, this.allTokens());
  }

  public EmployeeSkill internalSaveEmployeeSkill(
      RetailscmUserContext userContext, EmployeeSkill employeeSkill) throws Exception {
    return internalSaveEmployeeSkill(userContext, employeeSkill, allTokens());
  }

  public EmployeeSkill internalSaveEmployeeSkill(
      RetailscmUserContext userContext, EmployeeSkill employeeSkill, Map<String, Object> options)
      throws Exception {
    // checkParamsForUpdatingEmployeeSkill(userContext, employeeSkillId, employeeSkillVersion,
  ...
  public EmployeeSkill updateEmployeeSkill(
    ...
    checkParamsForUpdatingEmployeeSkill(
        userContext, employeeSkillId, employeeSkillVersion, property, newValueExpr, tokensExpr);
  ...
  public EmployeeSkill updateEmployeeSkillProperty(
      RetailscmUserContext userContext,
      String employeeSkillId,
      int employeeSkillVersion,
      String property,
  ...
  protected void checkParamsForTransferingAnotherEmployee(
      RetailscmUserContext userContext, String employeeSkillId, String anotherEmployeeId)
      throws Exception {
  ...
  public EmployeeSkill transferToAnotherEmployee(
      RetailscmUserContext userContext, String employeeSkillId, String anotherEmployeeId)
      throws Exception {
  ...
  public CandidateEmployee requestCandidateEmployee(
    ...
    SmartList<Employee> candidateList =
        employeeDaoOf(userContext)
            .requestCandidateEmployeeForEmployeeSkill(
  ...
  protected void checkParamsForTransferingAnotherSkillType(
      RetailscmUserContext userContext, String employeeSkillId, String anotherSkillTypeId)
      throws Exception {
  ...
  public EmployeeSkill transferToAnotherSkillType(
      RetailscmUserContext userContext, String employeeSkillId, String anotherSkillTypeId)
      throws Exception {
  ...
  public CandidateSkillType requestCandidateSkillType(
      RetailscmUserContext userContext, String ownerClass, String id, String filterKey, int pageNo)
      throws Exception {
    ...
    int pageSize = 20;
    // requestCandidateProductForSkuAsOwner
    SmartList<SkillType> candidateList =
        skillTypeDaoOf(userContext)
            .requestCandidateSkillTypeForEmployeeSkill(
                userContext, ownerClass, id, filterKey, pageNo, pageSize);
    result.setCandidates(candidateList);
    int totalCount = candidateList.getTotalCount();
    result.setTotalPage(Math.max(1, (totalCount + pageSize - 1) / pageSize));
  ...
  protected SkillType loadSkillType(
      RetailscmUserContext userContext, String newSkillTypeId, Map<String, Object> options)
      throws Exception {
  ...
  public EmployeeSkill forgetByAll(
      RetailscmUserContext userContext, String employeeSkillId, int employeeSkillVersion)
      throws Exception {
    return forgetByAllInternal(userContext, employeeSkillId, employeeSkillVersion);
  }

  protected EmployeeSkill forgetByAllInternal(
      RetailscmUserContext userContext, String employeeSkillId, int employeeSkillVersion)
      throws Exception {
  ...
  public void onNewInstanceCreated(RetailscmUserContext userContext, EmployeeSkill newCreated)
      throws Exception {
  ...
  public void sendAllItems(RetailscmUserContext ctx) throws Exception {
    employeeSkillDaoOf(ctx).loadAllAsStream().forEach(event -> sendInitEvent(ctx, event));
  }
  ...
  protected void enhanceForListOfView(
      RetailscmUserContext userContext, SmartList<EmployeeSkill> list) throws Exception {
    if (list == null || list.isEmpty()) {
      return;
    }
    ...
    List<SkillType> skillTypeList =
        RetailscmBaseUtils.collectReferencedObjectWithType(userContext, list, SkillType.class);
  ...
  public Object listPageByEmployee(
    ...
    SmartList<EmployeeSkill> list =
        employeeSkillDaoOf(userContext)
            .findEmployeeSkillByEmployee(employeeId, start, count, new HashMap<>());
  ...
  public Object listBySkillType(RetailscmUserContext userContext, String skillTypeId)
      throws Exception {
    return listPageBySkillType(userContext, skillTypeId, 0, 20);
  }

  @SuppressWarnings({"unchecked", "rawtypes"})
  public Object listPageBySkillType(
      RetailscmUserContext userContext, String skillTypeId, int start, int count) throws Exception {
    SmartList<EmployeeSkill> list =
        employeeSkillDaoOf(userContext)
            .findEmployeeSkillBySkillType(skillTypeId, start, count, new HashMap<>());
    enhanceForListOfView(userContext, list);
    RetailscmCommonListOfViewPage page = new RetailscmCommonListOfViewPage();
    page.setClassOfList(EmployeeSkill.class);
    ...
    page.setDisplayMode("auto");
    page.setLinkToUrl(
        TextUtil.encodeUrl(String.format("%s/listBySkillType/%s/", getBeanName(), skillTypeId)));
   ...
   * @throws Exception
   */
  public Object wxappview(RetailscmUserContext userContext, String employeeSkillId)
      throws Exception {
