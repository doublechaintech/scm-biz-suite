...
public class EmployeeSkillTokens extends CommonTokens{
  ...
  public static EmployeeSkillTokens loadGroupTokens(String... groupNames){
    ...
    addToken(tokens, EMPLOYEE, groupNames, new String[]{"default"});addToken(tokens, SKILLTYPE, groupNames, new String[]{"default"});

  
    return tokens;
  }

  private static void addToken(EmployeeSkillTokens pTokens, String pTokenName, String[] pGroupNames, String[] fieldGroups) {
