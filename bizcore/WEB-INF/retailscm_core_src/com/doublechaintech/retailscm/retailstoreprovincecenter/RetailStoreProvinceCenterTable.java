...
public class RetailStoreProvinceCenterTable {
  ...
  public static final String[] ALL_CLOUMNS = {
    COLUMN_ID, COLUMN_NAME, COLUMN_FOUNDED, COLUMN_COUNTRY, COLUMN_LAST_UPDATE_TIME, COLUMN_VERSION
  };
  ...
  public static void ensureTable(RetailscmUserContext userContext, Map<String, Object> result)
    ...
    RetailscmBaseUtils.ensureTable(
        userContext,
        result,
        "retail_store_province_center_data",
        new String[][] {
          new String[] {"id", "varchar(48)", " not null", "ID", "", ""},
          new String[] {"name", "varchar(44)", "", "名称", "", ""},
          new String[] {"founded", "date", "", "成立", "", ""},
          new String[] {
            "country", "varchar(48)", "", "国", "retail_store_country_center_data", "id"
          },
