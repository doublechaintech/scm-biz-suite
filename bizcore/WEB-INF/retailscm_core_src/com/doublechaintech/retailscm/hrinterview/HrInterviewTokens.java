...
public class HrInterviewTokens extends CommonTokens{
	...
	public  static  HrInterviewTokens of(Map<String,Object> options){
		//ensure not initialized outside the class
		HrInterviewTokens tokens = new HrInterviewTokens(options);
		return tokens;
		
	}
	protected HrInterviewTokens(Map<String,Object> options){
	...
	public HrInterviewTokens analyzeAllLists(){		
