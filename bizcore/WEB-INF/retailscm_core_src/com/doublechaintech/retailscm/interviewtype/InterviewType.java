...
public class InterviewType extends BaseEntity implements  java.io.Serializable{
  ...
  memberMetaInfoList.add(MemberMetaInfo.referBy(EMPLOYEE_INTERVIEW_LIST, "interviewType", "员工面试名单")
...
return getId();
	...
	public InterviewType updateId(String id){String oldId = this.id;String newId = trimString(id);if(!shouldReplaceBy(newId, oldId)){return this;}this.id = newId;addPropertyChange(ID_PROPERTY, oldId, newId);this.changed = true;setChecked(false);return this;}
...
return createCriteria(ID_PROPERTY, operator, parameters);
	...
	public InterviewType ignoreIdCriteria(){super.ignoreSearchProperty(ID_PROPERTY);
return this;
}
...
return getCode();
	...
	public InterviewType updateCode(String code){String oldCode = this.code;String newCode = trimString(code);if(!shouldReplaceBy(newCode, oldCode)){return this;}this.code = newCode;addPropertyChange(CODE_PROPERTY, oldCode, newCode);this.changed = true;setChecked(false);return this;}
...
return createCriteria(CODE_PROPERTY, operator, parameters);
	...
	public InterviewType ignoreCodeCriteria(){super.ignoreSearchProperty(CODE_PROPERTY);
return this;
}
...
return getCompany();
	...
	public InterviewType updateCompany(RetailStoreCountryCenter company){RetailStoreCountryCenter oldCompany = this.company;RetailStoreCountryCenter newCompany = company;if(!shouldReplaceBy(newCompany, oldCompany)){return this;}this.company = newCompany;addPropertyChange(COMPANY_PROPERTY, oldCompany, newCompany);this.changed = true;setChecked(false);return this;}
...
return createCriteria(COMPANY_PROPERTY, operator, parameters);
	...
	public InterviewType ignoreCompanyCriteria(){super.ignoreSearchProperty(COMPANY_PROPERTY);
return this;
}
...
return getDescription();
	...
	public InterviewType updateDescription(String description){String oldDescription = this.description;String newDescription = trimString(description);if(!shouldReplaceBy(newDescription, oldDescription)){return this;}this.description = newDescription;addPropertyChange(DESCRIPTION_PROPERTY, oldDescription, newDescription);this.changed = true;setChecked(false);return this;}
...
return createCriteria(DESCRIPTION_PROPERTY, operator, parameters);
	...
	public InterviewType ignoreDescriptionCriteria(){super.ignoreSearchProperty(DESCRIPTION_PROPERTY);
return this;
}
...
return createCriteria(DETAIL_DESCRIPTION_PROPERTY, operator, parameters);
	...
	public InterviewType ignoreDetailDescriptionCriteria(){super.ignoreSearchProperty(DETAIL_DESCRIPTION_PROPERTY);
return this;
}
...
return getVersion();
	...
	public InterviewType updateVersion(int version){int oldVersion = this.version;int newVersion = version;if(!shouldReplaceBy(newVersion, oldVersion)){return this;}this.version = newVersion;addPropertyChange(VERSION_PROPERTY, oldVersion, newVersion);this.changed = true;setChecked(false);return this;}
...
return createCriteria(VERSION_PROPERTY, operator, parameters);
	...
	public InterviewType ignoreVersionCriteria(){super.ignoreSearchProperty(VERSION_PROPERTY);
return this;
}
...
return this;
  ...
  public  SmartList<EmployeeInterview> employeeInterviewList(){
	...
	public  InterviewType addEmployeeInterviewList(SmartList<EmployeeInterview> employeeInterviewList){
		for( EmployeeInterview employeeInterview:employeeInterviewList){
			employeeInterview.setInterviewType(this);
		}
	...
	public static InterviewType createWith(RetailscmUserContext userContext, ThrowingFunction<InterviewType,InterviewType,Exception> postHandler, Object ... inputs) throws Exception {

    List<Object> params = inputs == null ? new ArrayList<>() : Arrays.asList(inputs);
    CustomRetailscmPropertyMapper mapper = CustomRetailscmPropertyMapper.of(userContext);
    CreationScene scene = mapper.findParamByClass(params, CreationScene.class);
    RetailscmBeanCreator<InterviewType> customCreator = mapper.findCustomCreator(InterviewType.class, scene);
    if (customCreator != null){
      return customCreator.create(userContext, scene, postHandler, params);
    }

    InterviewType result = new InterviewType();
    result.setCode(mapper.tryToGet(InterviewType.class, CODE_PROPERTY, String.class,
        0, false, result.getCode(), params));
    result.setCompany(mapper.tryToGet(InterviewType.class, COMPANY_PROPERTY, RetailStoreCountryCenter.class,
        0, true, result.getCompany(), params));
    result.setDescription(mapper.tryToGet(InterviewType.class, DESCRIPTION_PROPERTY, String.class,
        1, false, result.getDescription(), params));
    result.setDetailDescription(mapper.tryToGet(InterviewType.class, DETAIL_DESCRIPTION_PROPERTY, String.class,
    ...
    if (result != null){
      userContext.getChecker().checkAndFixInterviewType(result);
      userContext.getChecker().throwExceptionIfHasErrors(IllegalArgumentException.class);

      
      InterviewTypeTokens tokens = mapper.findParamByClass(params, InterviewTypeTokens.class);
      if (tokens == null) {
        tokens = InterviewTypeTokens.start();
      }
      result = userContext.getManagerGroup().getInterviewTypeManager().internalSaveInterviewType(userContext, result, tokens.done());
