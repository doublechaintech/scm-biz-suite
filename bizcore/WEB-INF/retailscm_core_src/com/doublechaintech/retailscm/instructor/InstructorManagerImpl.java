...
public class InstructorManagerImpl extends CustomRetailscmCheckerManager implements InstructorManager, BusinessHandler{
	...
	public Object prepareContextForUserApp(BaseUserContext userContext,Object targetUserApp) throws Exception{
	 ...
	 public Object summaryView(RetailscmUserContext userContext, String instructorId) throws Exception{
		Instructor instructor = loadInstructor( userContext, instructorId, viewTokens());
  ...
  @Override
  public List<Instructor> searchInstructorList(RetailscmUserContext ctx, InstructorRequest pRequest){
