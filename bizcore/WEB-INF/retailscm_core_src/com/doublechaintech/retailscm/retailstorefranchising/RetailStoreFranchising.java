...
public class RetailStoreFranchising extends BaseEntity implements java.io.Serializable {
  ...
  public void transferAllRelationshipsTo(RetailStoreFranchising target) {
    if (target == null) {
      return;
    }
  ...
  static {
    ...
    memberMetaInfoList.add(
        MemberMetaInfo.referBy(RETAIL_STORE_LIST, "franchising", "零售门店列表")
  ...
  public RetailStoreFranchising updateId(String id) {
    String oldId = this.id;
    String newId = trimString(id);
  ...
  public RetailStoreFranchising ignoreIdCriteria() {
  ...
  public RetailStoreFranchising updateComment(String comment) {
    String oldComment = this.comment;
    String newComment = trimString(comment);
  ...
  public RetailStoreFranchising ignoreCommentCriteria() {
  ...
  public RetailStoreFranchising updateVersion(int version) {
    int oldVersion = this.version;
    int newVersion = version;
  ...
  public RetailStoreFranchising ignoreVersionCriteria() {
  ...
  public RetailStoreFranchising addRetailStore(RetailStore retailStore) {
    retailStore.updateFranchising(this);
  ...
  public BaseEntity mergeDataFrom(BaseEntity sourceEntity) {
    ...
    if (sourceEntity instanceof RetailStoreFranchising) {

      RetailStoreFranchising source = (RetailStoreFranchising) sourceEntity;
  ...
  public boolean checkIfEligibleForDelete(Object ctx) {
    ...
    RetailStoreFranchising checkRetailStoreFranchising =
        Q.retailStoreFranchisingWithIdField()
            .filterById(id)
            .selectRetailStoreList(Q.retailStoreWithIdField().limit(0, 1))
            .execute(ctx);

    return checkRetailStoreFranchising != null
        && !checkRetailStoreFranchising.getAllRelatedLists().stream()
            .flatMap(subList -> subList.stream())
            .findFirst()
            .isPresent();
  }

  public RetailStoreFranchising save(com.doublechaintech.retailscm.RetailscmUserContext ctx) {
    try {
