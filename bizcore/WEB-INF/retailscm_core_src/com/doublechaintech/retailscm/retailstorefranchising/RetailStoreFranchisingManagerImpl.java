...
public class RetailStoreFranchisingManagerImpl extends CustomRetailscmCheckerManager implements RetailStoreFranchisingManager, BusinessHandler{
	...
	public Object prepareContextForUserApp(BaseUserContext userContext,Object targetUserApp) throws Exception{
	 ...
	 public Object summaryView(RetailscmUserContext userContext, String retailStoreFranchisingId) throws Exception{
		RetailStoreFranchising retailStoreFranchising = loadRetailStoreFranchising( userContext, retailStoreFranchisingId, viewTokens());
	 ...
	 public Object analyze(RetailscmUserContext userContext, String retailStoreFranchisingId) throws Exception{
		RetailStoreFranchising retailStoreFranchising = loadRetailStoreFranchising( userContext, retailStoreFranchisingId, analyzeTokens());
		markVisited(userContext, retailStoreFranchising);
  ...
  @Override
  public List<RetailStoreFranchising> searchRetailStoreFranchisingList(RetailscmUserContext ctx, RetailStoreFranchisingRequest pRequest){
  ...
  @Override
  public RetailStoreFranchising searchRetailStoreFranchising(RetailscmUserContext ctx, RetailStoreFranchisingRequest pRequest){
    pRequest.limit(0, 1);
...
//--------------------------------------------------------------
	...
	public  RetailStoreFranchising updateRetailStoreProperties(RetailscmUserContext userContext, String retailStoreFranchisingId, String id,String name,String telephone,String owner,Date founded,BigDecimal latitude,BigDecimal longitude,String description, String [] tokensExpr) throws Exception
	{
		...
		beforeUpdateRetailStoreProperties(userContext,item, retailStoreFranchisingId,id,name,telephone,owner,founded,latitude,longitude,description,tokensExpr);
	...
	protected  void beforeUpdateRetailStoreProperties(RetailscmUserContext userContext, RetailStore item, String retailStoreFranchisingId, String id,String name,String telephone,String owner,Date founded,BigDecimal latitude,BigDecimal longitude,String description, String [] tokensExpr)
						throws Exception {
	...
	public  RetailStoreFranchising copyRetailStoreFrom(RetailscmUserContext userContext, String retailStoreFranchisingId,
		...
		synchronized(retailStoreFranchising){
			...
			retailStoreManagerOf(userContext).onNewInstanceCreated(userContext, (RetailStore)retailStoreFranchising.getFlexiableObjects().get(BaseEntity.COPIED_CHILD));
			return present(userContext,retailStoreFranchising, mergedAllTokens(tokensExpr));
		}
	...
	public  RetailStoreFranchising updateRetailStore(RetailscmUserContext userContext, String retailStoreFranchisingId, String retailStoreId, int retailStoreVersion, String property, String newValueExpr,String [] tokensExpr)
		...
		synchronized(retailStoreFranchising){
			...
			beforeUpdateRetailStore(userContext, retailStore, retailStoreFranchisingId, retailStoreId, retailStoreVersion, property, newValueExpr,  tokensExpr);
	...
	protected void beforeUpdateRetailStore(RetailscmUserContext userContext, RetailStore existed, String retailStoreFranchisingId, String retailStoreId, int retailStoreVersion, String property, String newValueExpr,String [] tokensExpr)
  			throws Exception{
  }
	/*
  ...
  public void sendAllItems(RetailscmUserContext ctx) throws Exception{
    retailStoreFranchisingDaoOf(ctx).loadAllAsStream().forEach(
  ...
  protected BusinessHandler getLoginProcessBizHandler(RetailscmUserContextImpl userContext) {
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(RetailscmUserContext userContext,SmartList<RetailStoreFranchising> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(RetailscmUserContext userContext, String retailStoreFranchisingId) throws Exception{
