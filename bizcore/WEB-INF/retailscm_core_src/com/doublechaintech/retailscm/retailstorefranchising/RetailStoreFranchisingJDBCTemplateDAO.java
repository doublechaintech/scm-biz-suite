...
public class RetailStoreFranchisingJDBCTemplateDAO extends RetailscmBaseDAOImpl
    implements RetailStoreFranchisingDAO {
  ...
  */
  ...
  public RetailStoreFranchising save(
      RetailStoreFranchising retailStoreFranchising, Map<String, Object> options) {

    String methodName =
        "save(RetailStoreFranchising retailStoreFranchising,Map<String,Object> options)";
  ...
  public RetailStoreFranchising clone(String retailStoreFranchisingId, Map<String, Object> options)
      throws Exception {

    return clone(RetailStoreFranchisingTable.withId(retailStoreFranchisingId), options);
  }

  protected RetailStoreFranchising clone(AccessKey accessKey, Map<String, Object> options)
      throws Exception {
    ...
    RetailStoreFranchising newRetailStoreFranchising =
        loadInternalRetailStoreFranchising(accessKey, options);
  ...
  protected void throwIfHasException(String retailStoreFranchisingId, int version, int count)
      throws Exception {
    if (count == 1) {
  ...
  public RetailStoreFranchising disconnectFromAll(String retailStoreFranchisingId, int version)
      throws Exception {

    RetailStoreFranchising retailStoreFranchising =
        loadInternalRetailStoreFranchising(
            RetailStoreFranchisingTable.withId(retailStoreFranchisingId), emptyOptions());
  ...
  protected RetailStoreFranchising extractRetailStoreFranchising(
      AccessKey accessKey, Map<String, Object> loadOptions) throws Exception {
    try {
      RetailStoreFranchising retailStoreFranchising =
          loadSingleObject(accessKey, getRetailStoreFranchisingMapper());
      return retailStoreFranchising;
    } catch (EmptyResultDataAccessException e) {
      throw new RetailStoreFranchisingNotFoundException(
          "RetailStoreFranchising(" + accessKey + ") is not found!");
    }
  }

  protected RetailStoreFranchising loadInternalRetailStoreFranchising(
      AccessKey accessKey, Map<String, Object> loadOptions) throws Exception {

    RetailStoreFranchising retailStoreFranchising =
        extractRetailStoreFranchising(accessKey, loadOptions);
  ...
  protected RetailStoreFranchising extractRetailStoreList(
      RetailStoreFranchising retailStoreFranchising, Map<String, Object> options) {
    ...
    SmartList<RetailStore> retailStoreList =
        getRetailStoreDAO().findRetailStoreByFranchising(retailStoreFranchising.getId(), options);
  ...
  protected RetailStoreFranchising analyzeRetailStoreList(
      RetailStoreFranchising retailStoreFranchising, Map<String, Object> options) {
    ...
    if (retailStoreList != null) {
      getRetailStoreDAO()
          .analyzeRetailStoreByFranchising(
              retailStoreList, retailStoreFranchising.getId(), options);
    }
  ...
  public SmartList<RetailStoreFranchising> saveRetailStoreFranchisingList(
      SmartList<RetailStoreFranchising> retailStoreFranchisingList, Map<String, Object> options) {
    ...
    batchRetailStoreFranchisingRemove((List<RetailStoreFranchising>) lists[REMOVE_LIST_INDEX]);
    batchRetailStoreFranchisingRecover((List<RetailStoreFranchising>) lists[RECOVER_LIST_INDEX]);
    ...
    for (RetailStoreFranchising retailStoreFranchising : retailStoreFranchisingList) {
      ...
      if (retailStoreFranchising.isToRecover() || retailStoreFranchising.isToRemove()) {
        retailStoreFranchising.setVersion(-retailStoreFranchising.getVersion());
      }
    }
  ...
  public SmartList<RetailStoreFranchising> removeRetailStoreFranchisingList(
      SmartList<RetailStoreFranchising> retailStoreFranchisingList, Map<String, Object> options) {
  ...
  protected List<Object[]> prepareRetailStoreFranchisingBatchCreateArgs(
      List<RetailStoreFranchising> retailStoreFranchisingList) {
  ...
  protected List<Object[]> prepareRetailStoreFranchisingBatchUpdateArgs(
      List<RetailStoreFranchising> retailStoreFranchisingList) {
  ...
  protected List<Object[]> prepareRetailStoreFranchisingBatchRecoverArgs(
      List<RetailStoreFranchising> retailStoreFranchisingList) {

    List<Object[]> parametersList = new ArrayList<Object[]>();
    for (RetailStoreFranchising retailStoreFranchising : retailStoreFranchisingList) {
      if (!retailStoreFranchising.isToRecover()) {
        continue;
      }
      Object[] parameters = prepareRecoverParameters(retailStoreFranchising);
      parametersList.add(parameters);
    }
    return parametersList;
  }

  protected List<Object[]> prepareRetailStoreFranchisingBatchRemoveArgs(
      List<RetailStoreFranchising> retailStoreFranchisingList) {

    List<Object[]> parametersList = new ArrayList<Object[]>();
    for (RetailStoreFranchising retailStoreFranchising : retailStoreFranchisingList) {
      if (!retailStoreFranchising.isToRemove()) {
        continue;
      }
      Object[] parameters = prepareRetailStoreFranchisingRemoveParameters(retailStoreFranchising);
      parametersList.add(parameters);
    }
    return parametersList;
  }

  protected void batchRetailStoreFranchisingCreate(
      List<RetailStoreFranchising> retailStoreFranchisingList) {
  ...
  protected void batchRetailStoreFranchisingUpdate(
      List<RetailStoreFranchising> retailStoreFranchisingList) {
  ...
  protected void batchRetailStoreFranchisingRemove(
      List<RetailStoreFranchising> retailStoreFranchisingList) {
    String SQL = getRemoveSQL();
    List<Object[]> args = prepareRetailStoreFranchisingBatchRemoveArgs(retailStoreFranchisingList);
    int affectedNumbers[] = batchRemove(SQL, args);
    checkBatchReturn(affectedNumbers);
  }

  protected void batchRetailStoreFranchisingRecover(
      List<RetailStoreFranchising> retailStoreFranchisingList) {
    String SQL = getRecoverSQL();
    List<Object[]> args = prepareRetailStoreFranchisingBatchRecoverArgs(retailStoreFranchisingList);
  ...
  protected Object[] splitRetailStoreFranchisingList(
      List<RetailStoreFranchising> retailStoreFranchisingList) {

    List<RetailStoreFranchising> retailStoreFranchisingCreateList =
        new ArrayList<RetailStoreFranchising>();
    List<RetailStoreFranchising> retailStoreFranchisingUpdateList =
        new ArrayList<RetailStoreFranchising>();
    List<RetailStoreFranchising> retailStoreFranchisingRemoveList =
        new ArrayList<RetailStoreFranchising>();
    List<RetailStoreFranchising> retailStoreFranchisingRecoverList =
        new ArrayList<RetailStoreFranchising>();

    for (RetailStoreFranchising retailStoreFranchising : retailStoreFranchisingList) {
      if (retailStoreFranchising.isToRemove()) {
        retailStoreFranchisingRemoveList.add(retailStoreFranchising);
        continue;
      }
      if (retailStoreFranchising.isToRecover()) {
        retailStoreFranchisingRecoverList.add(retailStoreFranchising);
        continue;
      }
    ...
    return new Object[] {
      retailStoreFranchisingCreateList,
      retailStoreFranchisingUpdateList,
      retailStoreFranchisingRemoveList,
      retailStoreFranchisingRecoverList
    };
  }
  ...
  protected Object[] getSaveRetailStoreFranchisingParameters(
      RetailStoreFranchising retailStoreFranchising) {
    if (retailStoreFranchising.isToRemove()) {
      return prepareRetailStoreFranchisingRemoveParameters(retailStoreFranchising);
    }
    if (retailStoreFranchising.isToRecover()) {
      return prepareRecoverParameters(retailStoreFranchising);
    }
  ...
  protected Object[] prepareRetailStoreFranchisingRemoveParameters(
      RetailStoreFranchising retailStoreFranchising) {
    return super.prepareRemoveParameters(retailStoreFranchising);
  }

  protected Object[] prepareRetailStoreFranchisingUpdateParameters(
      RetailStoreFranchising retailStoreFranchising) {
  ...
  protected Object[] prepareRetailStoreFranchisingCreateParameters(
      RetailStoreFranchising retailStoreFranchising) {
  ...
  protected RetailStoreFranchising saveInternalRetailStoreFranchising(
      RetailStoreFranchising retailStoreFranchising, Map<String, Object> options) {
  ...
  public RetailStoreFranchising planToRemoveRetailStoreList(
      RetailStoreFranchising retailStoreFranchising,
  ...
  public RetailStoreFranchising planToRemoveRetailStoreListWithRetailStoreCountryCenter(
      RetailStoreFranchising retailStoreFranchising,
  ...
  public RetailStoreFranchising planToRemoveRetailStoreListWithCityServiceCenter(
      RetailStoreFranchising retailStoreFranchising,
  ...
  public int countRetailStoreListWithCityServiceCenter(
      String retailStoreFranchisingId, String cityServiceCenterId, Map<String, Object> options)
      throws Exception {
    // SmartList<ThreadLike> toRemoveThreadLikeList = threadLikeList.getToRemoveList();
    // the list will not be null here, empty, maybe
    // getThreadLikeDAO().removeThreadLikeList(toRemoveThreadLikeList,options);
  ...
  public RetailStoreFranchising planToRemoveRetailStoreListWithCreation(
      RetailStoreFranchising retailStoreFranchising, String creationId, Map<String, Object> options)
      throws Exception {
    // SmartList<ThreadLike> toRemoveThreadLikeList = threadLikeList.getToRemoveList();
    // the list will not be null here, empty, maybe
    // getThreadLikeDAO().removeThreadLikeList(toRemoveThreadLikeList,options);
  ...
  public int countRetailStoreListWithCreation(
      String retailStoreFranchisingId, String creationId, Map<String, Object> options)
      throws Exception {
    // SmartList<ThreadLike> toRemoveThreadLikeList = threadLikeList.getToRemoveList();
    // the list will not be null here, empty, maybe
    // getThreadLikeDAO().removeThreadLikeList(toRemoveThreadLikeList,options);
  ...
  public RetailStoreFranchising planToRemoveRetailStoreListWithInvestmentInvitation(
      RetailStoreFranchising retailStoreFranchising,
  ...
  public int countRetailStoreListWithInvestmentInvitation(
      String retailStoreFranchisingId, String investmentInvitationId, Map<String, Object> options)
      throws Exception {
    // SmartList<ThreadLike> toRemoveThreadLikeList = threadLikeList.getToRemoveList();
    // the list will not be null here, empty, maybe
    // getThreadLikeDAO().removeThreadLikeList(toRemoveThreadLikeList,options);
  ...
  public RetailStoreFranchising planToRemoveRetailStoreListWithDecoration(
      RetailStoreFranchising retailStoreFranchising,
      String decorationId,
      Map<String, Object> options)
      throws Exception {
  ...
  public int countRetailStoreListWithDecoration(
      String retailStoreFranchisingId, String decorationId, Map<String, Object> options)
      throws Exception {
    // SmartList<ThreadLike> toRemoveThreadLikeList = threadLikeList.getToRemoveList();
    // the list will not be null here, empty, maybe
    // getThreadLikeDAO().removeThreadLikeList(toRemoveThreadLikeList,options);
  ...
  public RetailStoreFranchising planToRemoveRetailStoreListWithOpening(
      RetailStoreFranchising retailStoreFranchising, String openingId, Map<String, Object> options)
      throws Exception {
    // SmartList<ThreadLike> toRemoveThreadLikeList = threadLikeList.getToRemoveList();
    // the list will not be null here, empty, maybe
    // getThreadLikeDAO().removeThreadLikeList(toRemoveThreadLikeList,options);
  ...
  public int countRetailStoreListWithOpening(
      String retailStoreFranchisingId, String openingId, Map<String, Object> options)
      throws Exception {
    // SmartList<ThreadLike> toRemoveThreadLikeList = threadLikeList.getToRemoveList();
    // the list will not be null here, empty, maybe
    // getThreadLikeDAO().removeThreadLikeList(toRemoveThreadLikeList,options);
  ...
  public RetailStoreFranchising planToRemoveRetailStoreListWithClosing(
      RetailStoreFranchising retailStoreFranchising, String closingId, Map<String, Object> options)
      throws Exception {
    // SmartList<ThreadLike> toRemoveThreadLikeList = threadLikeList.getToRemoveList();
    // the list will not be null here, empty, maybe
    // getThreadLikeDAO().removeThreadLikeList(toRemoveThreadLikeList,options);
  ...
  public int countRetailStoreListWithClosing(
      String retailStoreFranchisingId, String closingId, Map<String, Object> options)
      throws Exception {
    // SmartList<ThreadLike> toRemoveThreadLikeList = threadLikeList.getToRemoveList();
    // the list will not be null here, empty, maybe
    // getThreadLikeDAO().removeThreadLikeList(toRemoveThreadLikeList,options);
  ...
  protected RetailStoreFranchising saveRetailStoreList(
      RetailStoreFranchising retailStoreFranchising, Map<String, Object> options) {
  ...
  protected RetailStoreFranchising removeRetailStoreList(
      RetailStoreFranchising retailStoreFranchising, Map<String, Object> options) {
  ...
  public RetailStoreFranchising present(
      RetailStoreFranchising retailStoreFranchising, Map<String, Object> options) {
  ...
  public SmartList<RetailStoreFranchising> requestCandidateRetailStoreFranchisingForRetailStore(
    ...
    return findAllCandidateByFilter(
        RetailStoreFranchisingTable.COLUMN_COMMENT,
        null,
        filterKey,
        pageNo,
        pageSize,
        getRetailStoreFranchisingMapper());
  }
  ...
  public void collectAndEnhance(BaseEntity ownerEntity) {
    List<RetailStoreFranchising> retailStoreFranchisingList =
        ownerEntity.collectRefsWithType(RetailStoreFranchising.INTERNAL_TYPE);
    this.enhanceList(retailStoreFranchisingList);
  }

  @Override
  public SmartList<RetailStoreFranchising> findRetailStoreFranchisingWithKey(
  ...
  @Override
  public int countRetailStoreFranchisingWithKey(
      MultipleAccessKey key, Map<String, Object> options) {

    return countWith(key, options);
  }

  public Map<String, Integer> countRetailStoreFranchisingWithGroupKey(
  ...
  @Override
  public CandidateRetailStoreFranchising executeCandidatesQuery(
  ...
  @Override
  protected RetailStoreFranchisingMapper mapperForClazz(Class<?> clazz) {
    return RetailStoreFranchisingMapper.mapperForClass(clazz);
  }
}
