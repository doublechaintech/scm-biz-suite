...
public class RetailStoreFranchisingMapper extends BaseRowMapper<RetailStoreFranchising> {
  ...
  public static RetailStoreFranchisingMapper mapperForClass(Class<?> clazz) {

    RetailStoreFranchisingMapper mapperForOverride = new RetailStoreFranchisingMapper();
  ...
  protected void setId(RetailStoreFranchising retailStoreFranchising, ResultSet rs, int rowNumber)
      throws SQLException {
    try {
  ...
  protected void setComment(
      RetailStoreFranchising retailStoreFranchising, ResultSet rs, int rowNumber)
      throws SQLException {
    try {
      // there will be issue when the type is double/int/long
