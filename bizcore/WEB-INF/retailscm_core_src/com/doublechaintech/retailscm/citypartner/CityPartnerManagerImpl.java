...
public class CityPartnerManagerImpl extends CustomRetailscmCheckerManager
    implements CityPartnerManager, BusinessHandler {
  ...
  public BlobObject exportExcelFromList(
    ...
    List<BaseEntity> entityListToNaming = cityPartner.collectReferencesFromLists();
  ...
  protected CityPartner saveCityPartner(
      RetailscmUserContext userContext, CityPartner cityPartner, String[] tokensExpr)
      throws Exception {
  ...
  protected CityPartner saveCityPartnerDetail(
  ...
  public CityPartner loadCityPartner(
      RetailscmUserContext userContext, String cityPartnerId, String[] tokensExpr)
      throws Exception {
  ...
  public CityPartner searchCityPartner(
  ...
  protected CityPartner present(
      RetailscmUserContext userContext, CityPartner cityPartner, Map<String, Object> tokens)
      throws Exception {
    ...
    List<BaseEntity> entityListToNaming = cityPartnerToPresent.collectReferencesFromLists();
    cityPartnerDaoOf(userContext).alias(entityListToNaming);
  ...
  public CityPartner loadCityPartnerDetail(RetailscmUserContext userContext, String cityPartnerId)
      throws Exception {
  ...
  public Object summaryView(RetailscmUserContext userContext, String cityPartnerId)
      throws Exception {
    CityPartner cityPartner = loadCityPartner(userContext, cityPartnerId, viewTokens());
  ...
  protected CityPartner loadCityPartner(
      RetailscmUserContext userContext, String cityPartnerId, Map<String, Object> tokens)
      throws Exception {
    checkerOf(userContext).checkIdOfCityPartner(cityPartnerId);
  ...
  protected <T extends BaseEntity> void addActions(
    ...
    // userContext, CityPartner cityPartner, Map<String, Object> tokens){

  @Override
  public List<CityPartner> searchCityPartnerList(
      RetailscmUserContext ctx, CityPartnerRequest pRequest) {
  ...
  public CityPartner clone(RetailscmUserContext userContext, String fromCityPartnerId)
      throws Exception {
  ...
  public CityPartner internalSaveCityPartner(
      RetailscmUserContext userContext, CityPartner cityPartner, Map<String, Object> options)
      throws Exception {
    // checkParamsForUpdatingCityPartner(userContext, cityPartnerId, cityPartnerVersion, property,
  ...
  public CityPartner updateCityPartner(
    ...
    checkParamsForUpdatingCityPartner(
        userContext, cityPartnerId, cityPartnerVersion, property, newValueExpr, tokensExpr);

    CityPartner cityPartner = loadCityPartner(userContext, cityPartnerId, allTokens());
    if (cityPartner.getVersion() != cityPartnerVersion) {
      String message =
          "The target version("
              + cityPartner.getVersion()
  ...
  public CityPartner updateCityPartnerProperty(
      RetailscmUserContext userContext,
      String cityPartnerId,
      int cityPartnerVersion,
      String property,
  ...
  public CityPartner transferToAnotherCityServiceCenter(
    ...
    checkParamsForTransferingAnotherCityServiceCenter(
        userContext, cityPartnerId, anotherCityServiceCenterId);
  ...
  public CityPartner forgetByAll(
      RetailscmUserContext userContext, String cityPartnerId, int cityPartnerVersion)
      throws Exception {
    return forgetByAllInternal(userContext, cityPartnerId, cityPartnerVersion);
  }

  protected CityPartner forgetByAllInternal(
      RetailscmUserContext userContext, String cityPartnerId, int cityPartnerVersion)
      throws Exception {
  ...
  public CityPartner addPotentialCustomer(
    ...
    checkParamsForAddingPotentialCustomer(
        userContext, cityPartnerId, name, mobile, cityServiceCenterId, description, tokensExpr);

    PotentialCustomer potentialCustomer =
        createPotentialCustomer(userContext, name, mobile, cityServiceCenterId, description);
    ...
    synchronized (cityPartner) {
      ...
      cityPartner =
          saveCityPartner(userContext, cityPartner, tokens().withPotentialCustomerList().done());
  ...
  public CityPartner updatePotentialCustomerProperties(
      RetailscmUserContext userContext,
      String cityPartnerId,
      String id,
      String name,
    ...
    checkParamsForUpdatingPotentialCustomerProperties(
        userContext, cityPartnerId, id, name, mobile, description, tokensExpr);
    ...
    beforeUpdatePotentialCustomerProperties(
        userContext, item, cityPartnerId, id, name, mobile, description, tokensExpr);
    ...
    CityPartner cityPartner =
        saveCityPartner(
            userContext, cityPartnerToUpdate, tokens().withPotentialCustomerList().done());
    synchronized (cityPartner) {
      return present(userContext, cityPartner, mergedAllTokens(tokensExpr));
    }
  }
  ...
  public CityPartner removePotentialCustomerList(
      RetailscmUserContext userContext,
      String cityPartnerId,
      String potentialCustomerIds[],
      String[] tokensExpr)
    ...
    checkParamsForRemovingPotentialCustomerList(
        userContext, cityPartnerId, potentialCustomerIds, tokensExpr);
    ...
    synchronized (cityPartner) {
      ...
      cityPartnerDaoOf(userContext)
          .planToRemovePotentialCustomerList(cityPartner, potentialCustomerIds, allTokens());
      cityPartner =
          saveCityPartner(userContext, cityPartner, tokens().withPotentialCustomerList().done());
  ...
  public CityPartner removePotentialCustomer(
    ...
    checkParamsForRemovingPotentialCustomer(
        userContext, cityPartnerId, potentialCustomerId, potentialCustomerVersion, tokensExpr);
  ...
  public CityPartner copyPotentialCustomerFrom(
      RetailscmUserContext userContext,
      String cityPartnerId,
      String potentialCustomerId,
      int potentialCustomerVersion,
    ...
    synchronized (cityPartner) {
      ...
      potentialCustomerManagerOf(userContext)
          .onNewInstanceCreated(
              userContext,
              (PotentialCustomer) cityPartner.getFlexiableObjects().get(BaseEntity.COPIED_CHILD));
      return present(userContext, cityPartner, mergedAllTokens(tokensExpr));
    }
  }
  ...
  public CityPartner updatePotentialCustomer(
    ...
    synchronized (cityPartner) {
      ...
      PotentialCustomer potentialCustomer =
          cityPartner.findThePotentialCustomer(potentialCustomerIdVersionKey);
  ...
  */
  ...
  public CityPartner addPotentialCustomerContact(
    ...
    synchronized (cityPartner) {
      ...
      cityPartner =
          saveCityPartner(
              userContext, cityPartner, tokens().withPotentialCustomerContactList().done());
  ...
  public CityPartner updatePotentialCustomerContactProperties(
      RetailscmUserContext userContext,
      String cityPartnerId,
      String id,
      String name,
    ...
    checkParamsForUpdatingPotentialCustomerContactProperties(
        userContext, cityPartnerId, id, name, contactDate, contactMethod, description, tokensExpr);
    ...
    if (cityPartnerToUpdate.getPotentialCustomerContactList().isEmpty()) {
      throw new CityPartnerManagerException(
    ...
    // checkParamsForAddingPotentialCustomerContact(userContext,cityPartnerId,name, code,
    // used,tokensExpr);
    CityPartner cityPartner =
        saveCityPartner(
            userContext, cityPartnerToUpdate, tokens().withPotentialCustomerContactList().done());
    synchronized (cityPartner) {
      return present(userContext, cityPartner, mergedAllTokens(tokensExpr));
    }
  }
  ...
  public CityPartner removePotentialCustomerContactList(
      RetailscmUserContext userContext,
      String cityPartnerId,
      String potentialCustomerContactIds[],
      String[] tokensExpr)
    ...
    checkParamsForRemovingPotentialCustomerContactList(
        userContext, cityPartnerId, potentialCustomerContactIds, tokensExpr);
    ...
    synchronized (cityPartner) {
      ...
      cityPartnerDaoOf(userContext)
          .planToRemovePotentialCustomerContactList(
              cityPartner, potentialCustomerContactIds, allTokens());
      cityPartner =
          saveCityPartner(
              userContext, cityPartner, tokens().withPotentialCustomerContactList().done());
  ...
  public CityPartner copyPotentialCustomerContactFrom(
      RetailscmUserContext userContext,
      String cityPartnerId,
      String potentialCustomerContactId,
      int potentialCustomerContactVersion,
      ...
      potentialCustomerContactManagerOf(userContext)
          .onNewInstanceCreated(
              ...
              (PotentialCustomerContact)
                  cityPartner.getFlexiableObjects().get(BaseEntity.COPIED_CHILD));
      return present(userContext, cityPartner, mergedAllTokens(tokensExpr));
    }
  }
  ...
  public CityPartner updatePotentialCustomerContact(
    ...
    synchronized (cityPartner) {
      ...
      PotentialCustomerContact potentialCustomerContact =
          cityPartner.findThePotentialCustomerContact(potentialCustomerContactIdVersionKey);
  ...
  */
  ...
  public void sendAllItems(RetailscmUserContext ctx) throws Exception {
    cityPartnerDaoOf(ctx).loadAllAsStream().forEach(event -> sendInitEvent(ctx, event));
  }
  ...
  // -----------------------------------// list-of-view 处理 \\-----------------------------------
  protected void enhanceForListOfView(RetailscmUserContext userContext, SmartList<CityPartner> list)
      throws Exception {
    if (list == null || list.isEmpty()) {
      return;
    }
  ...
  public Object listPageByCityServiceCenter(
      ...
      throws Exception {
    SmartList<CityPartner> list =
        cityPartnerDaoOf(userContext)
            .findCityPartnerByCityServiceCenter(cityServiceCenterId, start, count, new HashMap<>());
