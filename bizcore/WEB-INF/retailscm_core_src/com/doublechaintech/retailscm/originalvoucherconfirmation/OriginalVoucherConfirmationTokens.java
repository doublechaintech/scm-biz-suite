...
public class OriginalVoucherConfirmationTokens extends CommonTokens{
	...
	public  static  OriginalVoucherConfirmationTokens of(Map<String,Object> options){
		//ensure not initialized outside the class
		OriginalVoucherConfirmationTokens tokens = new OriginalVoucherConfirmationTokens(options);
		return tokens;
		
	}
	protected OriginalVoucherConfirmationTokens(Map<String,Object> options){
	...
	public OriginalVoucherConfirmationTokens analyzeAllLists(){		
