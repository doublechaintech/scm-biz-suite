...
public class AccountingDocumentAuditing extends BaseEntity implements  java.io.Serializable{
	...
	public static final String INTERNAL_TYPE="AccountingDocumentAuditing";
	...
	public AccountingDocumentAuditing updateId(String id){
		this.mId = trimString(id);;
		this.changed = true;
		return this;
	}
	...
	public AccountingDocumentAuditing updateWho(String who){
		this.mWho = trimString(who);;
		this.changed = true;
		return this;
	}
	...
	public AccountingDocumentAuditing updateComments(String comments){
		this.mComments = trimString(comments);;
		this.changed = true;
		return this;
	}
	...
	public AccountingDocumentAuditing updateMakeDate(Date makeDate){
		this.mMakeDate = makeDate;;
		this.changed = true;
		return this;
	}
	...
	public AccountingDocumentAuditing updateVersion(int version){
		this.mVersion = version;;
		this.changed = true;
		return this;
	}
	...
	public  AccountingDocument removeAccountingDocument(AccountingDocument accountingDocumentIndex){
        ...
        // accountingDocument.clearAuditing(); //disconnect with Auditing
        accountingDocument.clearFromAll(); //disconnect with Auditing
	...
	public  void breakWithAccountingDocument(AccountingDocument accountingDocument){
		...
		accountingDocument.setAuditing(null);
	...
	public String toString(){
		...
		stringBuilder.append("AccountingDocumentAuditing{");
