...
public class AccountingDocumentAuditingTokens extends CommonTokens{
	...
	public  static  AccountingDocumentAuditingTokens of(Map<String,Object> options){
		//ensure not initialized outside the class
		AccountingDocumentAuditingTokens tokens = new AccountingDocumentAuditingTokens(options);
		return tokens;
		
	}
	protected AccountingDocumentAuditingTokens(Map<String,Object> options){
	...
	public AccountingDocumentAuditingTokens analyzeAllLists(){		
