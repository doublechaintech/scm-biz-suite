...
public class ConsumerOrderPriceAdjustment extends BaseEntity implements java.io.Serializable {
  ...
  public void transferAllRelationshipsTo(ConsumerOrderPriceAdjustment target) {
    if (target == null) {
      return;
    }
  }
  ...
  static {
    ...
    memberMetaInfoList.add(
        MemberMetaInfo.defineBy(PROVIDER_PROPERTY, "provider", "供应商")
  ...
  public ConsumerOrderPriceAdjustment ignoreIdCriteria() {
  ...
  public ConsumerOrderPriceAdjustment ignoreNameCriteria() {
    super.ignoreSearchProperty(NAME_PROPERTY);
    return this;
  }

  public ConsumerOrderPriceAdjustment addNameCriteria(
  ...
  public ConsumerOrderPriceAdjustment ignoreBizOrderCriteria() {
    super.ignoreSearchProperty(BIZ_ORDER_PROPERTY);
    return this;
  }

  public ConsumerOrderPriceAdjustment addBizOrderCriteria(
      QueryOperator operator, Object... parameters) {
  ...
  public ConsumerOrderPriceAdjustment updateBizOrderByReferenceId(String bizOrderId) {
  ...
  public ConsumerOrderPriceAdjustment ignoreAmountCriteria() {
    super.ignoreSearchProperty(AMOUNT_PROPERTY);
    return this;
  }

  public ConsumerOrderPriceAdjustment addAmountCriteria(
      QueryOperator operator, Object... parameters) {
  ...
  public void setProvider(String provider) {
    ...
    String newProvider = trimString(provider);
  ...
  public ConsumerOrderPriceAdjustment updateProvider(String provider) {
    String oldProvider = this.provider;
    String newProvider = trimString(provider);
    if (!shouldReplaceBy(newProvider, oldProvider)) {
      return this;
    }
    this.provider = newProvider;
    if (cn.hutool.core.util.ObjectUtil.equals(newProvider, oldProvider)) {
      return this;
    }
    addPropertyChange(PROVIDER_PROPERTY, oldProvider, newProvider);
    this.changed = true;
    setChecked(false);
    return this;
  }
  ...
  public ConsumerOrderPriceAdjustment ignoreProviderCriteria() {
    super.ignoreSearchProperty(PROVIDER_PROPERTY);
    return this;
  }

  public ConsumerOrderPriceAdjustment addProviderCriteria(
      QueryOperator operator, Object... parameters) {
  ...
  public ConsumerOrderPriceAdjustment ignoreVersionCriteria() {
    super.ignoreSearchProperty(VERSION_PROPERTY);
    return this;
  }

  public ConsumerOrderPriceAdjustment addVersionCriteria(
      QueryOperator operator, Object... parameters) {
  ...
  public BaseEntity mergeDataFrom(BaseEntity sourceEntity) {
    ...
    if (sourceEntity instanceof ConsumerOrderPriceAdjustment) {

      ConsumerOrderPriceAdjustment source = (ConsumerOrderPriceAdjustment) sourceEntity;

      mergeId(source.getId());
      mergeName(source.getName());
      mergeBizOrder(source.getBizOrder());
      mergeAmount(source.getAmount());
      mergeProvider(source.getProvider());
  ...
  public Object[] toFlatArray() {
    return new Object[] {
      getId(), getName(), getBizOrder(), getAmount(), getProvider(), getVersion()
    };
  }
  ...
  public boolean checkIfEligibleForDelete(Object ctx) {
    ...
    ConsumerOrderPriceAdjustment checkConsumerOrderPriceAdjustment =
        Q.consumerOrderPriceAdjustmentWithIdField().filterById(id).execute(ctx);

    return checkConsumerOrderPriceAdjustment != null
        && !checkConsumerOrderPriceAdjustment.getAllRelatedLists().stream()
            .flatMap(subList -> subList.stream())
            .findFirst()
            .isPresent();
  }

  public ConsumerOrderPriceAdjustment save(com.doublechaintech.retailscm.RetailscmUserContext ctx) {
    try {
