...
public class ConsumerOrderPriceAdjustmentManagerImpl extends CustomRetailscmCheckerManager
    implements ConsumerOrderPriceAdjustmentManager, BusinessHandler {
  ...
  protected void throwExceptionWithMessage(String value)
      throws ConsumerOrderPriceAdjustmentManagerException {
  ...
  protected ConsumerOrderPriceAdjustment saveConsumerOrderPriceAdjustmentDetail(
  ...
  public ConsumerOrderPriceAdjustment loadConsumerOrderPriceAdjustment(
    ...
    checkerOf(userContext)
        .throwExceptionIfHasErrors(ConsumerOrderPriceAdjustmentManagerException.class);

    Map<String, Object> tokens = parseTokens(tokensExpr);

    ConsumerOrderPriceAdjustment consumerOrderPriceAdjustment =
        loadConsumerOrderPriceAdjustment(userContext, consumerOrderPriceAdjustmentId, tokens);
    // do some calc before sent to customer?
    return present(userContext, consumerOrderPriceAdjustment, tokens);
  }

  public ConsumerOrderPriceAdjustment searchConsumerOrderPriceAdjustment(
      RetailscmUserContext userContext,
  ...
  protected ConsumerOrderPriceAdjustment present(
      RetailscmUserContext userContext,
      ConsumerOrderPriceAdjustment consumerOrderPriceAdjustment,
      Map<String, Object> tokens)
      throws Exception {
    ...
    ConsumerOrderPriceAdjustment consumerOrderPriceAdjustmentToPresent =
        consumerOrderPriceAdjustmentDaoOf(userContext)
            .present(consumerOrderPriceAdjustment, tokens);

    List<BaseEntity> entityListToNaming =
        consumerOrderPriceAdjustmentToPresent.collectReferencesFromLists();
  ...
  public ConsumerOrderPriceAdjustment loadConsumerOrderPriceAdjustmentDetail(
      RetailscmUserContext userContext, String consumerOrderPriceAdjustmentId) throws Exception {
    ConsumerOrderPriceAdjustment consumerOrderPriceAdjustment =
        loadConsumerOrderPriceAdjustment(userContext, consumerOrderPriceAdjustmentId, allTokens());
  ...
  public Object view(RetailscmUserContext userContext, String consumerOrderPriceAdjustmentId)
      throws Exception {
    ConsumerOrderPriceAdjustment consumerOrderPriceAdjustment =
        loadConsumerOrderPriceAdjustment(userContext, consumerOrderPriceAdjustmentId, viewTokens());
    markVisited(userContext, consumerOrderPriceAdjustment);
    return present(userContext, consumerOrderPriceAdjustment, viewTokens());
  }

  public Object summaryView(RetailscmUserContext userContext, String consumerOrderPriceAdjustmentId)
      throws Exception {
    ConsumerOrderPriceAdjustment consumerOrderPriceAdjustment =
        loadConsumerOrderPriceAdjustment(userContext, consumerOrderPriceAdjustmentId, viewTokens());
  ...
  public Object analyze(RetailscmUserContext userContext, String consumerOrderPriceAdjustmentId)
      throws Exception {
    ConsumerOrderPriceAdjustment consumerOrderPriceAdjustment =
        loadConsumerOrderPriceAdjustment(
            userContext, consumerOrderPriceAdjustmentId, analyzeTokens());
    markVisited(userContext, consumerOrderPriceAdjustment);
  ...
  protected ConsumerOrderPriceAdjustment saveConsumerOrderPriceAdjustment(
    ...
    return consumerOrderPriceAdjustmentDaoOf(userContext)
        .save(consumerOrderPriceAdjustment, tokens);
  }

  protected ConsumerOrderPriceAdjustment loadConsumerOrderPriceAdjustment(
      RetailscmUserContext userContext,
      String consumerOrderPriceAdjustmentId,
      Map<String, Object> tokens)
      throws Exception {
    ...
    return consumerOrderPriceAdjustmentDaoOf(userContext)
        .load(consumerOrderPriceAdjustmentId, tokens);
  }
  ...
  protected <T extends BaseEntity> void addActions(
    ...
    // userContext, ConsumerOrderPriceAdjustment consumerOrderPriceAdjustment, Map<String, Object>
    // tokens){

  @Override
  public List<ConsumerOrderPriceAdjustment> searchConsumerOrderPriceAdjustmentList(
  ...
  public ConsumerOrderPriceAdjustment createConsumerOrderPriceAdjustment(
    ...
    ConsumerOrderPriceAdjustment consumerOrderPriceAdjustment =
        createNewConsumerOrderPriceAdjustment();
    ...
    consumerOrderPriceAdjustment =
        saveConsumerOrderPriceAdjustment(userContext, consumerOrderPriceAdjustment, emptyOptions());
  ...
  public ConsumerOrderPriceAdjustment clone(
      RetailscmUserContext userContext, String fromConsumerOrderPriceAdjustmentId)
      throws Exception {

    return consumerOrderPriceAdjustmentDaoOf(userContext)
        .clone(fromConsumerOrderPriceAdjustmentId, this.allTokens());
  }

  public ConsumerOrderPriceAdjustment internalSaveConsumerOrderPriceAdjustment(
      RetailscmUserContext userContext, ConsumerOrderPriceAdjustment consumerOrderPriceAdjustment)
      throws Exception {
    return internalSaveConsumerOrderPriceAdjustment(
        userContext, consumerOrderPriceAdjustment, allTokens());
  }
  ...
  public ConsumerOrderPriceAdjustment internalSaveConsumerOrderPriceAdjustment(
      ...
      throws Exception {
    // checkParamsForUpdatingConsumerOrderPriceAdjustment(userContext,
    // consumerOrderPriceAdjustmentId, consumerOrderPriceAdjustmentVersion, property, newValueExpr,
    // tokensExpr);
    ...
    synchronized (consumerOrderPriceAdjustment) {
      ...
      consumerOrderPriceAdjustment =
          saveConsumerOrderPriceAdjustment(userContext, consumerOrderPriceAdjustment, options);
      return consumerOrderPriceAdjustment;
    }
  }
  ...
  public ConsumerOrderPriceAdjustment updateConsumerOrderPriceAdjustment(
    ...
    synchronized (consumerOrderPriceAdjustment) {
      ...
      consumerOrderPriceAdjustment =
          saveConsumerOrderPriceAdjustment(
              userContext, consumerOrderPriceAdjustment, tokens().done());
      return present(userContext, consumerOrderPriceAdjustment, mergedAllTokens(tokensExpr));
      // return saveConsumerOrderPriceAdjustment(userContext, consumerOrderPriceAdjustment,
      // tokens().done());
    }
  }

  public ConsumerOrderPriceAdjustment updateConsumerOrderPriceAdjustmentProperty(
      RetailscmUserContext userContext,
      String consumerOrderPriceAdjustmentId,
      int consumerOrderPriceAdjustmentVersion,
      String property,
  ...
  public ConsumerOrderPriceAdjustment transferToAnotherBizOrder(
    ...
    checkParamsForTransferingAnotherBizOrder(
        userContext, consumerOrderPriceAdjustmentId, anotherBizOrderId);
    ...
    synchronized (consumerOrderPriceAdjustment) {
      ...
      consumerOrderPriceAdjustment =
          saveConsumerOrderPriceAdjustment(
              userContext, consumerOrderPriceAdjustment, emptyOptions());
  ...
  public CandidateConsumerOrder requestCandidateBizOrder(
    ...
    SmartList<ConsumerOrder> candidateList =
        consumerOrderDaoOf(userContext)
            .requestCandidateConsumerOrderForConsumerOrderPriceAdjustment(
  ...
  public ConsumerOrderPriceAdjustment forgetByAll(
      RetailscmUserContext userContext,
      String consumerOrderPriceAdjustmentId,
      int consumerOrderPriceAdjustmentVersion)
      throws Exception {
    return forgetByAllInternal(
        userContext, consumerOrderPriceAdjustmentId, consumerOrderPriceAdjustmentVersion);
  }

  protected ConsumerOrderPriceAdjustment forgetByAllInternal(
      RetailscmUserContext userContext,
      String consumerOrderPriceAdjustmentId,
      int consumerOrderPriceAdjustmentVersion)
      throws Exception {
    ...
    return consumerOrderPriceAdjustmentDaoOf(userContext)
        .disconnectFromAll(consumerOrderPriceAdjustmentId, consumerOrderPriceAdjustmentVersion);
  }
  ...
  public void sendAllItems(RetailscmUserContext ctx) throws Exception {
    consumerOrderPriceAdjustmentDaoOf(ctx)
        .loadAllAsStream()
  ...
  public void onAuthenticateNewUserLogged(
    ...
    // this.createConsumerOrderPriceAdjustment(userContext, ...
  ...
  protected void enhanceForListOfView(
      RetailscmUserContext userContext, SmartList<ConsumerOrderPriceAdjustment> list)
      throws Exception {
    if (list == null || list.isEmpty()) {
      return;
    }
  ...
  public Object listPageByBizOrder(
    ...
    SmartList<ConsumerOrderPriceAdjustment> list =
        consumerOrderPriceAdjustmentDaoOf(userContext)
            .findConsumerOrderPriceAdjustmentByBizOrder(bizOrderId, start, count, new HashMap<>());
   ...
   * @throws Exception
   */
  public Object wxappview(RetailscmUserContext userContext, String consumerOrderPriceAdjustmentId)
      throws Exception {
    SerializeScope vscope = SerializeScope.EXCLUDE().nothing();
    ConsumerOrderPriceAdjustment merchantObj =
        (ConsumerOrderPriceAdjustment) this.view(userContext, consumerOrderPriceAdjustmentId);
