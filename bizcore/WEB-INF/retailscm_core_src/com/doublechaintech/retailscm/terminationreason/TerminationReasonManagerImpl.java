...
public class TerminationReasonManagerImpl extends CustomRetailscmCheckerManager
    implements TerminationReasonManager, BusinessHandler {
  ...
  public BlobObject exportExcelFromList(
    ...
    Map<String, Object> tokens =
        TerminationReasonTokens.start().withTokenFromListName(listName).done();
    TerminationReason terminationReason =
        (TerminationReason) this.loadTerminationReason(userContext, id, tokens);
    // to enrich reference object to let it show display name
    List<BaseEntity> entityListToNaming = terminationReason.collectReferencesFromLists();
  ...
  protected TerminationReason saveTerminationReason(
      RetailscmUserContext userContext, TerminationReason terminationReason, String[] tokensExpr)
      throws Exception {
  ...
  protected TerminationReason saveTerminationReasonDetail(
      RetailscmUserContext userContext, TerminationReason terminationReason) throws Exception {

    return saveTerminationReason(userContext, terminationReason, allTokens());
  }

  public TerminationReason loadTerminationReason(
      RetailscmUserContext userContext, String terminationReasonId, String[] tokensExpr)
      throws Exception {
    ...
    TerminationReason terminationReason =
        loadTerminationReason(userContext, terminationReasonId, tokens);
    // do some calc before sent to customer?
    return present(userContext, terminationReason, tokens);
  }

  public TerminationReason searchTerminationReason(
  ...
  protected TerminationReason present(
      RetailscmUserContext userContext,
      TerminationReason terminationReason,
      Map<String, Object> tokens)
      throws Exception {
    ...
    TerminationReason terminationReasonToPresent =
        terminationReasonDaoOf(userContext).present(terminationReason, tokens);

    List<BaseEntity> entityListToNaming = terminationReasonToPresent.collectReferencesFromLists();
    terminationReasonDaoOf(userContext).alias(entityListToNaming);
  ...
  public TerminationReason loadTerminationReasonDetail(
      RetailscmUserContext userContext, String terminationReasonId) throws Exception {
    TerminationReason terminationReason =
        loadTerminationReason(userContext, terminationReasonId, allTokens());
  ...
  public Object view(RetailscmUserContext userContext, String terminationReasonId)
      throws Exception {
    TerminationReason terminationReason =
        loadTerminationReason(userContext, terminationReasonId, viewTokens());
    markVisited(userContext, terminationReason);
    return present(userContext, terminationReason, viewTokens());
  }

  public Object summaryView(RetailscmUserContext userContext, String terminationReasonId)
      throws Exception {
    TerminationReason terminationReason =
        loadTerminationReason(userContext, terminationReasonId, viewTokens());
  ...
  public Object analyze(RetailscmUserContext userContext, String terminationReasonId)
      throws Exception {
    TerminationReason terminationReason =
        loadTerminationReason(userContext, terminationReasonId, analyzeTokens());
    markVisited(userContext, terminationReason);
  ...
  protected TerminationReason loadTerminationReason(
      RetailscmUserContext userContext, String terminationReasonId, Map<String, Object> tokens)
      throws Exception {
    checkerOf(userContext).checkIdOfTerminationReason(terminationReasonId);
  ...
  protected <T extends BaseEntity> void addActions(
    ...
    // userContext, TerminationReason terminationReason, Map<String, Object> tokens){

  @Override
  public List<TerminationReason> searchTerminationReasonList(
      RetailscmUserContext ctx, TerminationReasonRequest pRequest) {
  ...
  public TerminationReason createTerminationReason(
      RetailscmUserContext userContext, String code, String companyId, String description)
      throws Exception {
  ...
  public TerminationReason clone(RetailscmUserContext userContext, String fromTerminationReasonId)
      throws Exception {

    return terminationReasonDaoOf(userContext).clone(fromTerminationReasonId, this.allTokens());
  }

  public TerminationReason internalSaveTerminationReason(
      RetailscmUserContext userContext, TerminationReason terminationReason) throws Exception {
  ...
  public TerminationReason internalSaveTerminationReason(
      ...
      throws Exception {
    // checkParamsForUpdatingTerminationReason(userContext, terminationReasonId,
    // terminationReasonVersion, property, newValueExpr, tokensExpr);
  ...
  public TerminationReason updateTerminationReason(
      RetailscmUserContext userContext,
      String terminationReasonId,
      int terminationReasonVersion,
      String property,
  ...
  public TerminationReason updateTerminationReasonProperty(
      RetailscmUserContext userContext,
      String terminationReasonId,
      int terminationReasonVersion,
      String property,
  ...
  protected void checkParamsForTransferingAnotherCompany(
      RetailscmUserContext userContext, String terminationReasonId, String anotherCompanyId)
      throws Exception {
  ...
  public TerminationReason transferToAnotherCompany(
      RetailscmUserContext userContext, String terminationReasonId, String anotherCompanyId)
      throws Exception {
  ...
  public TerminationReason forgetByAll(
      RetailscmUserContext userContext, String terminationReasonId, int terminationReasonVersion)
      throws Exception {
    return forgetByAllInternal(userContext, terminationReasonId, terminationReasonVersion);
  }

  protected TerminationReason forgetByAllInternal(
      RetailscmUserContext userContext, String terminationReasonId, int terminationReasonVersion)
      throws Exception {

    return terminationReasonDaoOf(userContext)
        .disconnectFromAll(terminationReasonId, terminationReasonVersion);
  }
  ...
  public TerminationReason addTermination(
      RetailscmUserContext userContext,
      String terminationReasonId,
      String typeId,
      String comment,
    ...
    TerminationReason terminationReason =
        loadTerminationReason(userContext, terminationReasonId, emptyOptions());
    synchronized (terminationReason) {
      // Will be good when the terminationReason loaded from this JVM process cache.
      // Also good when there is a RAM based DAO implementation
      ...
      terminationReason =
          saveTerminationReason(
              userContext, terminationReason, tokens().withTerminationList().done());
  ...
  public TerminationReason updateTerminationProperties(
      RetailscmUserContext userContext,
      String terminationReasonId,
      String id,
      String comment,
    ...
    checkParamsForUpdatingTerminationProperties(
        userContext, terminationReasonId, id, comment, tokensExpr);
    ...
    TerminationReason terminationReasonToUpdate =
        loadTerminationReason(userContext, terminationReasonId, options);
    ...
    beforeUpdateTerminationProperties(
        userContext, item, terminationReasonId, id, comment, tokensExpr);
    item.updateComment(comment);

    // checkParamsForAddingTermination(userContext,terminationReasonId,name, code, used,tokensExpr);
    TerminationReason terminationReason =
        saveTerminationReason(
            userContext, terminationReasonToUpdate, tokens().withTerminationList().done());
    synchronized (terminationReason) {
      return present(userContext, terminationReason, mergedAllTokens(tokensExpr));
    }
  }
  ...
  protected Termination createTermination(
      RetailscmUserContext userContext, String typeId, String comment) throws Exception {
  ...
  public TerminationReason removeTerminationList(
      RetailscmUserContext userContext,
      String terminationReasonId,
      String terminationIds[],
      String[] tokensExpr)
    ...
    checkParamsForRemovingTerminationList(
        userContext, terminationReasonId, terminationIds, tokensExpr);
    ...
    synchronized (terminationReason) {
      // Will be good when the terminationReason loaded from this JVM process cache.
      // Also good when there is a RAM based DAO implementation
      terminationReasonDaoOf(userContext)
          .planToRemoveTerminationList(terminationReason, terminationIds, allTokens());
      terminationReason =
          saveTerminationReason(
              userContext, terminationReason, tokens().withTerminationList().done());
  ...
  public TerminationReason removeTermination(
      RetailscmUserContext userContext,
      String terminationReasonId,
      String terminationId,
      int terminationVersion,
    ...
    checkParamsForRemovingTermination(
        userContext, terminationReasonId, terminationId, terminationVersion, tokensExpr);
  ...
  public TerminationReason copyTerminationFrom(
      RetailscmUserContext userContext,
      String terminationReasonId,
      String terminationId,
      int terminationVersion,
    ...
    synchronized (terminationReason) {
      ...
      terminationManagerOf(userContext)
          .onNewInstanceCreated(
              userContext,
              (Termination) terminationReason.getFlexiableObjects().get(BaseEntity.COPIED_CHILD));
      return present(userContext, terminationReason, mergedAllTokens(tokensExpr));
    }
  }
  ...
  public TerminationReason updateTermination(
      RetailscmUserContext userContext,
      String terminationReasonId,
      String terminationId,
      int terminationVersion,
    ...
    TerminationReason terminationReason =
        loadTerminationReason(userContext, terminationReasonId, loadTokens);
  ...
  */
  ...
  public void onNewInstanceCreated(RetailscmUserContext userContext, TerminationReason newCreated)
      throws Exception {
  ...
  public void sendAllItems(RetailscmUserContext ctx) throws Exception {
    terminationReasonDaoOf(ctx).loadAllAsStream().forEach(event -> sendInitEvent(ctx, event));
  }
  ...
  protected void enhanceForListOfView(
      RetailscmUserContext userContext, SmartList<TerminationReason> list) throws Exception {
    if (list == null || list.isEmpty()) {
      return;
    }
  ...
  public Object listPageByCompany(
    ...
    SmartList<TerminationReason> list =
        terminationReasonDaoOf(userContext)
            .findTerminationReasonByCompany(companyId, start, count, new HashMap<>());
   ...
   * @throws Exception
   */
  public Object wxappview(RetailscmUserContext userContext, String terminationReasonId)
      throws Exception {
