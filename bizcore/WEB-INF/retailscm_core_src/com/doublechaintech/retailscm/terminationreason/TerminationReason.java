...
public class TerminationReason extends BaseEntity implements java.io.Serializable {
  ...
  public void transferAllRelationshipsTo(TerminationReason target) {
    if (target == null) {
      return;
    }
  ...
  static {
    ...
    memberMetaInfoList.add(
        MemberMetaInfo.referBy(TERMINATION_LIST, "reason", "终止列表")
  ...
  public TerminationReason ignoreIdCriteria() {
  ...
  public TerminationReason ignoreCodeCriteria() {
  ...
  public TerminationReason ignoreCompanyCriteria() {
  ...
  public TerminationReason updateCompanyByReferenceId(String companyId) {
  ...
  public TerminationReason ignoreDescriptionCriteria() {
  ...
  public TerminationReason ignoreVersionCriteria() {
  ...
  public BaseEntity mergeDataFrom(BaseEntity sourceEntity) {
    ...
    if (sourceEntity instanceof TerminationReason) {

      TerminationReason source = (TerminationReason) sourceEntity;
  ...
  public boolean checkIfEligibleForDelete(Object ctx) {
    ...
    TerminationReason checkTerminationReason =
        Q.terminationReasonWithIdField()
            .filterById(id)
            .selectTerminationList(Q.terminationWithIdField().limit(0, 1))
            .execute(ctx);

    return checkTerminationReason != null
        && !checkTerminationReason.getAllRelatedLists().stream()
            .flatMap(subList -> subList.stream())
            .findFirst()
            .isPresent();
  }

  public TerminationReason save(com.doublechaintech.retailscm.RetailscmUserContext ctx) {
    try {
