...
public class EmployeeEducationManagerImpl extends CustomRetailscmCheckerManager
    implements EmployeeEducationManager, BusinessHandler {
  ...
  protected EmployeeEducation saveEmployeeEducation(
      RetailscmUserContext userContext, EmployeeEducation employeeEducation, String[] tokensExpr)
      throws Exception {
  ...
  protected EmployeeEducation saveEmployeeEducationDetail(
      RetailscmUserContext userContext, EmployeeEducation employeeEducation) throws Exception {

    return saveEmployeeEducation(userContext, employeeEducation, allTokens());
  }

  public EmployeeEducation loadEmployeeEducation(
      RetailscmUserContext userContext, String employeeEducationId, String[] tokensExpr)
      throws Exception {
    ...
    EmployeeEducation employeeEducation =
        loadEmployeeEducation(userContext, employeeEducationId, tokens);
    // do some calc before sent to customer?
    return present(userContext, employeeEducation, tokens);
  }

  public EmployeeEducation searchEmployeeEducation(
  ...
  protected EmployeeEducation present(
      RetailscmUserContext userContext,
      EmployeeEducation employeeEducation,
      Map<String, Object> tokens)
      throws Exception {
    ...
    EmployeeEducation employeeEducationToPresent =
        employeeEducationDaoOf(userContext).present(employeeEducation, tokens);

    List<BaseEntity> entityListToNaming = employeeEducationToPresent.collectReferencesFromLists();
  ...
  public EmployeeEducation loadEmployeeEducationDetail(
      RetailscmUserContext userContext, String employeeEducationId) throws Exception {
    EmployeeEducation employeeEducation =
        loadEmployeeEducation(userContext, employeeEducationId, allTokens());
  ...
  public Object view(RetailscmUserContext userContext, String employeeEducationId)
      throws Exception {
    EmployeeEducation employeeEducation =
        loadEmployeeEducation(userContext, employeeEducationId, viewTokens());
    markVisited(userContext, employeeEducation);
    return present(userContext, employeeEducation, viewTokens());
  }

  public Object summaryView(RetailscmUserContext userContext, String employeeEducationId)
      throws Exception {
    EmployeeEducation employeeEducation =
        loadEmployeeEducation(userContext, employeeEducationId, viewTokens());
  ...
  public Object analyze(RetailscmUserContext userContext, String employeeEducationId)
      throws Exception {
    EmployeeEducation employeeEducation =
        loadEmployeeEducation(userContext, employeeEducationId, analyzeTokens());
    markVisited(userContext, employeeEducation);
  ...
  protected EmployeeEducation loadEmployeeEducation(
      RetailscmUserContext userContext, String employeeEducationId, Map<String, Object> tokens)
      throws Exception {
    checkerOf(userContext).checkIdOfEmployeeEducation(employeeEducationId);
  ...
  protected <T extends BaseEntity> void addActions(
    ...
    // userContext, EmployeeEducation employeeEducation, Map<String, Object> tokens){

  @Override
  public List<EmployeeEducation> searchEmployeeEducationList(
      RetailscmUserContext ctx, EmployeeEducationRequest pRequest) {
  ...
  public EmployeeEducation createEmployeeEducation(
      RetailscmUserContext userContext,
      String employeeId,
      Date completeTime,
      String type,
  ...
  public EmployeeEducation clone(RetailscmUserContext userContext, String fromEmployeeEducationId)
      throws Exception {

    return employeeEducationDaoOf(userContext).clone(fromEmployeeEducationId, this.allTokens());
  }

  public EmployeeEducation internalSaveEmployeeEducation(
      RetailscmUserContext userContext, EmployeeEducation employeeEducation) throws Exception {
  ...
  public EmployeeEducation internalSaveEmployeeEducation(
      ...
      throws Exception {
    // checkParamsForUpdatingEmployeeEducation(userContext, employeeEducationId,
    // employeeEducationVersion, property, newValueExpr, tokensExpr);
  ...
  public EmployeeEducation updateEmployeeEducationProperty(
      RetailscmUserContext userContext,
      String employeeEducationId,
      int employeeEducationVersion,
      String property,
  ...
  protected void checkParamsForTransferingAnotherEmployee(
      RetailscmUserContext userContext, String employeeEducationId, String anotherEmployeeId)
      throws Exception {
  ...
  public EmployeeEducation transferToAnotherEmployee(
      RetailscmUserContext userContext, String employeeEducationId, String anotherEmployeeId)
      throws Exception {
  ...
  public CandidateEmployee requestCandidateEmployee(
    ...
    SmartList<Employee> candidateList =
        employeeDaoOf(userContext)
            .requestCandidateEmployeeForEmployeeEducation(
  ...
  public EmployeeEducation forgetByAll(
      RetailscmUserContext userContext, String employeeEducationId, int employeeEducationVersion)
      throws Exception {
    return forgetByAllInternal(userContext, employeeEducationId, employeeEducationVersion);
  }

  protected EmployeeEducation forgetByAllInternal(
      RetailscmUserContext userContext, String employeeEducationId, int employeeEducationVersion)
      throws Exception {

    return employeeEducationDaoOf(userContext)
        .disconnectFromAll(employeeEducationId, employeeEducationVersion);
  }
  ...
  public void onNewInstanceCreated(RetailscmUserContext userContext, EmployeeEducation newCreated)
      throws Exception {
  ...
  public void sendAllItems(RetailscmUserContext ctx) throws Exception {
    employeeEducationDaoOf(ctx).loadAllAsStream().forEach(event -> sendInitEvent(ctx, event));
  }
  ...
  protected void enhanceForListOfView(
      RetailscmUserContext userContext, SmartList<EmployeeEducation> list) throws Exception {
    if (list == null || list.isEmpty()) {
      return;
    }
  ...
  public Object listPageByEmployee(
    ...
    SmartList<EmployeeEducation> list =
        employeeEducationDaoOf(userContext)
            .findEmployeeEducationByEmployee(employeeId, start, count, new HashMap<>());
   ...
   * @throws Exception
   */
  public Object wxappview(RetailscmUserContext userContext, String employeeEducationId)
      throws Exception {
