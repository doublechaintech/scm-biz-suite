...
public class EmployeeEducation extends BaseEntity implements java.io.Serializable {
  ...
  public void transferAllRelationshipsTo(EmployeeEducation target) {
    if (target == null) {
      return;
    }
  }
  ...
  public EmployeeEducation ignoreIdCriteria() {
  ...
  public EmployeeEducation ignoreEmployeeCriteria() {
  ...
  public EmployeeEducation updateEmployeeByReferenceId(String employeeId) {
  ...
  public EmployeeEducation ignoreCompleteTimeCriteria() {
  ...
  public EmployeeEducation ignoreTypeCriteria() {
  ...
  public EmployeeEducation ignoreRemarkCriteria() {
  ...
  public EmployeeEducation ignoreVersionCriteria() {
  ...
  public BaseEntity mergeDataFrom(BaseEntity sourceEntity) {
    ...
    if (sourceEntity instanceof EmployeeEducation) {

      EmployeeEducation source = (EmployeeEducation) sourceEntity;
  ...
  public boolean checkIfEligibleForDelete(Object ctx) {
    ...
    EmployeeEducation checkEmployeeEducation =
        Q.employeeEducationWithIdField().filterById(id).execute(ctx);

    return checkEmployeeEducation != null
        && !checkEmployeeEducation.getAllRelatedLists().stream()
            .flatMap(subList -> subList.stream())
            .findFirst()
            .isPresent();
  }

  public EmployeeEducation save(com.doublechaintech.retailscm.RetailscmUserContext ctx) {
    try {
