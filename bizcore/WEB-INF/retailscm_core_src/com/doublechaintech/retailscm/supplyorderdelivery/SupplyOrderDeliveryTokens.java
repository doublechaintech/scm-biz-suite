...
public class SupplyOrderDeliveryTokens extends CommonTokens{
	...
	public  static  SupplyOrderDeliveryTokens of(Map<String,Object> options){
		//ensure not initialized outside the class
		SupplyOrderDeliveryTokens tokens = new SupplyOrderDeliveryTokens(options);
		return tokens;
		
	}
	protected SupplyOrderDeliveryTokens(Map<String,Object> options){
	...
	public SupplyOrderDeliveryTokens analyzeAllLists(){		
	...
	public SupplyOrderDeliveryTokens analyzeConsumerOrderList(){		
	...
	public SupplyOrderDeliveryTokens analyzeSupplyOrderList(){		
