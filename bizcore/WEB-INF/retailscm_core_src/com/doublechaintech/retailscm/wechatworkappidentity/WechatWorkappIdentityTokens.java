...
public class WechatWorkappIdentityTokens extends CommonTokens{
  ...
  public static WechatWorkappIdentityTokens loadGroupTokens(String... groupNames){
    WechatWorkappIdentityTokens tokens = start();
  ...
  private static void addToken(WechatWorkappIdentityTokens pTokens, String pTokenName, String[] pGroupNames, String[] fieldGroups) {
	...
	public static WechatWorkappIdentityTokens filterWithTokenViewGroups(String []viewGroups){
	...
	public static WechatWorkappIdentityTokens allTokens(){
