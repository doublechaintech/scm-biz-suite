...
public class WechatWorkappIdentityManagerImpl extends CustomRetailscmCheckerManager
  ...
  protected WechatWorkappIdentity saveWechatWorkappIdentityDetail(
      RetailscmUserContext userContext, WechatWorkappIdentity wechatWorkappIdentity)
      throws Exception {
  ...
  public WechatWorkappIdentity loadWechatWorkappIdentity(
      RetailscmUserContext userContext, String wechatWorkappIdentityId, String[] tokensExpr)
      throws Exception {
  ...
  public WechatWorkappIdentity loadWechatWorkappIdentityDetail(
      RetailscmUserContext userContext, String wechatWorkappIdentityId) throws Exception {
    WechatWorkappIdentity wechatWorkappIdentity =
  ...
  public Object view(RetailscmUserContext userContext, String wechatWorkappIdentityId)
      throws Exception {
    WechatWorkappIdentity wechatWorkappIdentity =
  ...
  public Object summaryView(RetailscmUserContext userContext, String wechatWorkappIdentityId)
      throws Exception {
    WechatWorkappIdentity wechatWorkappIdentity =
        loadWechatWorkappIdentity(userContext, wechatWorkappIdentityId, viewTokens());
  ...
  public Object analyze(RetailscmUserContext userContext, String wechatWorkappIdentityId)
      throws Exception {
    WechatWorkappIdentity wechatWorkappIdentity =
  ...
  protected WechatWorkappIdentity loadWechatWorkappIdentity(
      RetailscmUserContext userContext, String wechatWorkappIdentityId, Map<String, Object> tokens)
      throws Exception {
    checkerOf(userContext).checkIdOfWechatWorkappIdentity(wechatWorkappIdentityId);
  ...
  protected <T extends BaseEntity> void addActions(
    ...
    // userContext, WechatWorkappIdentity wechatWorkappIdentity, Map<String, Object> tokens){

  @Override
  public List<WechatWorkappIdentity> searchWechatWorkappIdentityList(
      RetailscmUserContext ctx, WechatWorkappIdentityRequest pRequest) {
  ...
  public WechatWorkappIdentity clone(
      RetailscmUserContext userContext, String fromWechatWorkappIdentityId) throws Exception {
  ...
  protected void checkParamsForTransferingAnotherSecUser(
      RetailscmUserContext userContext, String wechatWorkappIdentityId, String anotherSecUserId)
      throws Exception {
  ...
  protected void checkParamsForTransferingAnotherSecUserWithLogin(
      RetailscmUserContext userContext, String wechatWorkappIdentityId, String anotherLogin)
      throws Exception {
  ...
  protected void checkParamsForTransferingAnotherSecUserWithEmail(
      RetailscmUserContext userContext, String wechatWorkappIdentityId, String anotherEmail)
      throws Exception {
  ...
  protected void checkParamsForTransferingAnotherSecUserWithMobile(
      RetailscmUserContext userContext, String wechatWorkappIdentityId, String anotherMobile)
      throws Exception {
  ...
  public void onNewInstanceCreated(
      RetailscmUserContext userContext, WechatWorkappIdentity newCreated) throws Exception {
  ...
  protected void enhanceForListOfView(
      RetailscmUserContext userContext, SmartList<WechatWorkappIdentity> list) throws Exception {
    if (list == null || list.isEmpty()) {
      return;
    }
   ...
   * @throws Exception
   */
  public Object wxappview(RetailscmUserContext userContext, String wechatWorkappIdentityId)
      throws Exception {
