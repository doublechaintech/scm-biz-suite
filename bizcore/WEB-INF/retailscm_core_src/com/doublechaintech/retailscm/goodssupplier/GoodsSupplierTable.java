...
public class GoodsSupplierTable{
	...
	static final String TABLE_NAME="goods_supplier_data";
	...
	static final String []ALL_CLOUMNS = {COLUMN_ID, 
		COLUMN_NAME, COLUMN_SUPPLY_PRODUCT, COLUMN_BELONG_TO, COLUMN_CONTACT_NUMBER, COLUMN_DESCRIPTION, COLUMN_LAST_UPDATE_TIME, 
		COLUMN_VERSION};
