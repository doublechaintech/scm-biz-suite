...
public class RetailscmExceptionJsonSerializer extends  JsonSerializer<RetailscmException> {
	...
	@Override
	public void serialize(RetailscmException exception, JsonGenerator jgen,
	...
	protected void writeExceptionMessage(String message, RetailscmException exception,
	...
	protected void writeStartObject(RetailscmException exception, JsonGenerator jgen,SerializerProvider provider)throws IOException,JsonProcessingException{
		jgen.writeStartObject();
		writeClassField(CLASS,exception,jgen,provider);
	}
	
	private static final String MESSAGE_LIST = "messageList";
	protected void writeEndObject(RetailscmException exception, JsonGenerator jgen,SerializerProvider provider)throws IOException,JsonProcessingException{
		
		writeMessageList(MESSAGE_LIST,exception,jgen,provider);
		jgen.writeEndObject();
	}
	protected void writeClassField(String fieldName,RetailscmException exception,
	...
	protected void writeMessageList(String fieldName,RetailscmException exception,
			JsonGenerator jgen, SerializerProvider provider)
			throws IOException, JsonProcessingException {
		if(exception == null){
			return; //do nothing when base entity is null
