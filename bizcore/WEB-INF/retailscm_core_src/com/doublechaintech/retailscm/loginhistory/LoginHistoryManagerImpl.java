...
public class LoginHistoryManagerImpl extends CustomRetailscmCheckerManager
    implements LoginHistoryManager, BusinessHandler {
  ...
  protected LoginHistory saveLoginHistory(
      RetailscmUserContext userContext, LoginHistory loginHistory, String[] tokensExpr)
      throws Exception {
  ...
  protected LoginHistory saveLoginHistoryDetail(
      RetailscmUserContext userContext, LoginHistory loginHistory) throws Exception {

    return saveLoginHistory(userContext, loginHistory, allTokens());
  }

  public LoginHistory loadLoginHistory(
      RetailscmUserContext userContext, String loginHistoryId, String[] tokensExpr)
      throws Exception {
  ...
  public LoginHistory searchLoginHistory(
  ...
  protected LoginHistory present(
      RetailscmUserContext userContext, LoginHistory loginHistory, Map<String, Object> tokens)
      throws Exception {

    addActions(userContext, loginHistory, tokens);

    LoginHistory loginHistoryToPresent =
        loginHistoryDaoOf(userContext).present(loginHistory, tokens);
  ...
  public LoginHistory loadLoginHistoryDetail(
      RetailscmUserContext userContext, String loginHistoryId) throws Exception {
  ...
  public Object summaryView(RetailscmUserContext userContext, String loginHistoryId)
      throws Exception {
    LoginHistory loginHistory = loadLoginHistory(userContext, loginHistoryId, viewTokens());
  ...
  protected LoginHistory loadLoginHistory(
      RetailscmUserContext userContext, String loginHistoryId, Map<String, Object> tokens)
      throws Exception {
    checkerOf(userContext).checkIdOfLoginHistory(loginHistoryId);
  ...
  protected <T extends BaseEntity> void addActions(
    ...
    // userContext, LoginHistory loginHistory, Map<String, Object> tokens){

  @Override
  public List<LoginHistory> searchLoginHistoryList(
      RetailscmUserContext ctx, LoginHistoryRequest pRequest) {
  ...
  public LoginHistory createLoginHistory(
      RetailscmUserContext userContext, String fromIp, String description, String secUserId)
      throws Exception {
  ...
  public LoginHistory clone(RetailscmUserContext userContext, String fromLoginHistoryId)
      throws Exception {

    return loginHistoryDaoOf(userContext).clone(fromLoginHistoryId, this.allTokens());
  }

  public LoginHistory internalSaveLoginHistory(
      RetailscmUserContext userContext, LoginHistory loginHistory) throws Exception {
    return internalSaveLoginHistory(userContext, loginHistory, allTokens());
  }

  public LoginHistory internalSaveLoginHistory(
      RetailscmUserContext userContext, LoginHistory loginHistory, Map<String, Object> options)
      throws Exception {
    // checkParamsForUpdatingLoginHistory(userContext, loginHistoryId, loginHistoryVersion,
  ...
  public LoginHistory updateLoginHistory(
      RetailscmUserContext userContext,
      String loginHistoryId,
      int loginHistoryVersion,
      String property,
    ...
    checkParamsForUpdatingLoginHistory(
        userContext, loginHistoryId, loginHistoryVersion, property, newValueExpr, tokensExpr);
  ...
  public LoginHistory updateLoginHistoryProperty(
      RetailscmUserContext userContext,
      String loginHistoryId,
      int loginHistoryVersion,
      String property,
  ...
  protected void checkParamsForTransferingAnotherSecUser(
      RetailscmUserContext userContext, String loginHistoryId, String anotherSecUserId)
      throws Exception {
  ...
  public LoginHistory transferToAnotherSecUser(
      RetailscmUserContext userContext, String loginHistoryId, String anotherSecUserId)
      throws Exception {
  ...
  protected void checkParamsForTransferingAnotherSecUserWithLogin(
      RetailscmUserContext userContext, String loginHistoryId, String anotherLogin)
      throws Exception {
  ...
  public LoginHistory transferToAnotherSecUserWithLogin(
      RetailscmUserContext userContext, String loginHistoryId, String anotherLogin)
      throws Exception {
  ...
  protected void checkParamsForTransferingAnotherSecUserWithEmail(
      RetailscmUserContext userContext, String loginHistoryId, String anotherEmail)
      throws Exception {
  ...
  public LoginHistory transferToAnotherSecUserWithEmail(
      RetailscmUserContext userContext, String loginHistoryId, String anotherEmail)
      throws Exception {
  ...
  protected void checkParamsForTransferingAnotherSecUserWithMobile(
      RetailscmUserContext userContext, String loginHistoryId, String anotherMobile)
      throws Exception {
  ...
  public LoginHistory transferToAnotherSecUserWithMobile(
      RetailscmUserContext userContext, String loginHistoryId, String anotherMobile)
      throws Exception {
  ...
  public CandidateSecUser requestCandidateSecUser(
    ...
    SmartList<SecUser> candidateList =
        secUserDaoOf(userContext)
            .requestCandidateSecUserForLoginHistory(
  ...
  public LoginHistory forgetByAll(
      RetailscmUserContext userContext, String loginHistoryId, int loginHistoryVersion)
      throws Exception {
    return forgetByAllInternal(userContext, loginHistoryId, loginHistoryVersion);
  }

  protected LoginHistory forgetByAllInternal(
      RetailscmUserContext userContext, String loginHistoryId, int loginHistoryVersion)
      throws Exception {
  ...
  public void onNewInstanceCreated(RetailscmUserContext userContext, LoginHistory newCreated)
      throws Exception {
  ...
  public void sendAllItems(RetailscmUserContext ctx) throws Exception {
    loginHistoryDaoOf(ctx).loadAllAsStream().forEach(event -> sendInitEvent(ctx, event));
  }
  ...
  protected void enhanceForListOfView(
      RetailscmUserContext userContext, SmartList<LoginHistory> list) throws Exception {
    if (list == null || list.isEmpty()) {
      return;
    }
  ...
  public Object listPageBySecUser(
    ...
    SmartList<LoginHistory> list =
        loginHistoryDaoOf(userContext)
            .findLoginHistoryBySecUser(secUserId, start, count, new HashMap<>());
   ...
   * @throws Exception
   */
  public Object wxappview(RetailscmUserContext userContext, String loginHistoryId)
      throws Exception {
