...
public class AccountingSubjectTokens extends CommonTokens{
  ...
  private static void addToken(AccountingSubjectTokens pTokens, String pTokenName, String[] pGroupNames, String[] fieldGroups) {
	...
	public AccountingSubjectTokens withAccountingDocumentLineListIfViewGroupInclude(String [] viewGroups){
