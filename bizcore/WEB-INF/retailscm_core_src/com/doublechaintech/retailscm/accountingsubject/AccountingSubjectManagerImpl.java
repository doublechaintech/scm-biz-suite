...
public class AccountingSubjectManagerImpl extends CustomRetailscmCheckerManager implements AccountingSubjectManager, BusinessHandler{
	...
	public Object prepareContextForUserApp(BaseUserContext userContext,Object targetUserApp) throws Exception{
	 ...
	 public Object summaryView(RetailscmUserContext userContext, String accountingSubjectId) throws Exception{
		AccountingSubject accountingSubject = loadAccountingSubject( userContext, accountingSubjectId, viewTokens());
	 ...
	 public Object analyze(RetailscmUserContext userContext, String accountingSubjectId) throws Exception{
		AccountingSubject accountingSubject = loadAccountingSubject( userContext, accountingSubjectId, analyzeTokens());
		markVisited(userContext, accountingSubject);
  ...
  @Override
  public List<AccountingSubject> searchAccountingSubjectList(RetailscmUserContext ctx, AccountingSubjectRequest pRequest){
  ...
  @Override
  public AccountingSubject searchAccountingSubject(RetailscmUserContext ctx, AccountingSubjectRequest pRequest){
    pRequest.limit(0, 1);
