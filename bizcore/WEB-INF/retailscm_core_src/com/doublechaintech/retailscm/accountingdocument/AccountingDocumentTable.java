...
public class AccountingDocumentTable{
	...
	public static final String []NORMAL_CLOUMNS = {COLUMN_NAME,COLUMN_ACCOUNTING_DOCUMENT_DATE,COLUMN_ACCOUNTING_PERIOD,COLUMN_DOCUMENT_TYPE};
	  ...
	  public static void ensureTable(RetailscmUserContext userContext, Map<String, Object> result) throws Exception {
        RetailscmBaseUtils.ensureTable(userContext, result, "accounting_document_data", new String[][]{
                new String[]{"id","varchar(48)"," not null","ID","",""},
                new String[]{"name","varchar(16)","","名称","",""},
                new String[]{"accounting_document_date","date","","会计凭证日期","",""},
                new String[]{"accounting_period","varchar(48)","","会计期间","accounting_period_data","id"},
                new String[]{"document_type","varchar(48)","","文档类型","accounting_document_type_data","id"},
