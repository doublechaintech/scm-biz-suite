...
public class RetailStoreCountryCenterTable{
	...
	static final String TABLE_NAME="retail_store_country_center_data";
	...
	static final String []ALL_CLOUMNS = {COLUMN_ID, 
		COLUMN_NAME, COLUMN_SERVICE_NUMBER, COLUMN_FOUNDED, COLUMN_WEB_SITE, COLUMN_ADDRESS, COLUMN_OPERATED_BY, COLUMN_LEGAL_REPRESENTATIVE, COLUMN_DESCRIPTION, 
		COLUMN_VERSION};
