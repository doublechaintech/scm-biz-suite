...
public class RetailStoreCountryCenter extends BaseEntity implements  java.io.Serializable{
  ...
  static{
    ...
    memberMetaInfoList.add(MemberMetaInfo.defineBy(SERVICE_NUMBER_PROPERTY, "service_number", "服务号码")
        .withType("string", String.class));
    memberMetaInfoList.add(MemberMetaInfo.defineBy(FOUNDED_PROPERTY, "founded", "成立")
        .withType("date_past", "Date"));
    memberMetaInfoList.add(MemberMetaInfo.defineBy(WEB_SITE_PROPERTY, "web_site", "网站")
        .withType("string_url", String.class));
    memberMetaInfoList.add(MemberMetaInfo.defineBy(ADDRESS_PROPERTY, "address", "地址")
        .withType("string", String.class));
    memberMetaInfoList.add(MemberMetaInfo.defineBy(OPERATED_BY_PROPERTY, "operated_by", "由")
        .withType("string", String.class));
    memberMetaInfoList.add(MemberMetaInfo.defineBy(LEGAL_REPRESENTATIVE_PROPERTY, "legal_representative", "法定代表人")
        .withType("string", String.class));
  ...
  memberMetaInfoList.add(MemberMetaInfo.referBy(CATALOG_LIST, "owner", "目录列表")
        .withType("catalog", Catalog.class));

  memberMetaInfoList.add(MemberMetaInfo.referBy(RETAIL_STORE_PROVINCE_CENTER_LIST, "country", "零售门店省中心名单")
        .withType("retail_store_province_center", RetailStoreProvinceCenter.class));

  memberMetaInfoList.add(MemberMetaInfo.referBy(RETAIL_STORE_LIST, "retailStoreCountryCenter", "零售门店列表")
        .withType("retail_store", RetailStore.class));

  memberMetaInfoList.add(MemberMetaInfo.referBy(RETAIL_STORE_MEMBER_LIST, "owner", "零售店会员名单")
        .withType("retail_store_member", RetailStoreMember.class));

  memberMetaInfoList.add(MemberMetaInfo.referBy(GOODS_SUPPLIER_LIST, "belongTo", "货物供应商列表")
        .withType("goods_supplier", GoodsSupplier.class));

  memberMetaInfoList.add(MemberMetaInfo.referBy(SUPPLY_ORDER_LIST, "buyer", "供应订单列表")
        .withType("supply_order", SupplyOrder.class));

  memberMetaInfoList.add(MemberMetaInfo.referBy(RETAIL_STORE_ORDER_LIST, "seller", "零售店订购单")
        .withType("retail_store_order", RetailStoreOrder.class));

  memberMetaInfoList.add(MemberMetaInfo.referBy(WAREHOUSE_LIST, "owner", "仓库列表")
        .withType("warehouse", Warehouse.class));

  memberMetaInfoList.add(MemberMetaInfo.referBy(TRANSPORT_FLEET_LIST, "owner", "运输舰队列表")
        .withType("transport_fleet", TransportFleet.class));

  memberMetaInfoList.add(MemberMetaInfo.referBy(ACCOUNT_SET_LIST, "countryCenter", "帐户设置列表")
        .withType("account_set", AccountSet.class));

  memberMetaInfoList.add(MemberMetaInfo.referBy(LEVEL_ONE_DEPARTMENT_LIST, "belongsTo", "一级部门名单")
        .withType("level_one_department", LevelOneDepartment.class));

  memberMetaInfoList.add(MemberMetaInfo.referBy(SKILL_TYPE_LIST, "company", "技能类型列表")
        .withType("skill_type", SkillType.class));

  memberMetaInfoList.add(MemberMetaInfo.referBy(RESPONSIBILITY_TYPE_LIST, "company", "责任类型列表")
        .withType("responsibility_type", ResponsibilityType.class));

  memberMetaInfoList.add(MemberMetaInfo.referBy(TERMINATION_REASON_LIST, "company", "终止原因列表")
        .withType("termination_reason", TerminationReason.class));

  memberMetaInfoList.add(MemberMetaInfo.referBy(TERMINATION_TYPE_LIST, "company", "终止类型列表")
        .withType("termination_type", TerminationType.class));

  memberMetaInfoList.add(MemberMetaInfo.referBy(OCCUPATION_TYPE_LIST, "company", "职业类型列表")
        .withType("occupation_type", OccupationType.class));

  memberMetaInfoList.add(MemberMetaInfo.referBy(LEAVE_TYPE_LIST, "company", "离开类型列表")
        .withType("leave_type", LeaveType.class));

  memberMetaInfoList.add(MemberMetaInfo.referBy(SALARY_GRADE_LIST, "company", "工资等级表")
        .withType("salary_grade", SalaryGrade.class));

  memberMetaInfoList.add(MemberMetaInfo.referBy(INTERVIEW_TYPE_LIST, "company", "面试类型列表")
        .withType("interview_type", InterviewType.class));

  memberMetaInfoList.add(MemberMetaInfo.referBy(TRAINING_COURSE_TYPE_LIST, "company", "培训课程类别表")
        .withType("training_course_type", TrainingCourseType.class));

  memberMetaInfoList.add(MemberMetaInfo.referBy(PUBLIC_HOLIDAY_LIST, "company", "公共假期列表")
        .withType("public_holiday", PublicHoliday.class));

  memberMetaInfoList.add(MemberMetaInfo.referBy(EMPLOYEE_LIST, "company", "员工列表")
        .withType("employee", Employee.class));

  memberMetaInfoList.add(MemberMetaInfo.referBy(INSTRUCTOR_LIST, "company", "导师名单")
        .withType("instructor", Instructor.class));

  memberMetaInfoList.add(MemberMetaInfo.referBy(COMPANY_TRAINING_LIST, "company", "公司培训名单")
  ...
  public String[] getPropertyNames(){
    return new String[]{ID_PROPERTY ,NAME_PROPERTY ,SERVICE_NUMBER_PROPERTY ,FOUNDED_PROPERTY ,WEB_SITE_PROPERTY ,ADDRESS_PROPERTY ,OPERATED_BY_PROPERTY ,LEGAL_REPRESENTATIVE_PROPERTY ,DESCRIPTION_PROPERTY ,VERSION_PROPERTY};
  }
...
return getId();
	...
	public RetailStoreCountryCenter updateId(String id){String oldId = this.id;String newId = trimString(id);if(!shouldReplaceBy(newId, oldId)){return this;}this.id = newId;addPropertyChange(ID_PROPERTY, oldId, newId);this.changed = true;setChecked(false);return this;}
...
return createCriteria(ID_PROPERTY, operator, parameters);
	...
	public RetailStoreCountryCenter ignoreIdCriteria(){super.ignoreSearchProperty(ID_PROPERTY);
return this;
}
...
return getName();
	...
	public RetailStoreCountryCenter updateName(String name){String oldName = this.name;String newName = trimString(name);if(!shouldReplaceBy(newName, oldName)){return this;}this.name = newName;addPropertyChange(NAME_PROPERTY, oldName, newName);this.changed = true;setChecked(false);return this;}
...
return createCriteria(NAME_PROPERTY, operator, parameters);
	...
	public RetailStoreCountryCenter ignoreNameCriteria(){super.ignoreSearchProperty(NAME_PROPERTY);
return this;
}
...
return this;
	...
	public void setServiceNumber(String serviceNumber){String oldServiceNumber = this.serviceNumber;String newServiceNumber = trimString(serviceNumber);this.serviceNumber = newServiceNumber;}
...
return getServiceNumber();
	...
	public RetailStoreCountryCenter updateServiceNumber(String serviceNumber){String oldServiceNumber = this.serviceNumber;String newServiceNumber = trimString(serviceNumber);if(!shouldReplaceBy(newServiceNumber, oldServiceNumber)){return this;}this.serviceNumber = newServiceNumber;addPropertyChange(SERVICE_NUMBER_PROPERTY, oldServiceNumber, newServiceNumber);this.changed = true;setChecked(false);return this;}
...
return createCriteria(SERVICE_NUMBER_PROPERTY, operator, parameters);
	...
	public RetailStoreCountryCenter ignoreServiceNumberCriteria(){super.ignoreSearchProperty(SERVICE_NUMBER_PROPERTY);
return this;
}
	public RetailStoreCountryCenter addServiceNumberCriteria(QueryOperator operator, Object... parameters){
...
return getFounded();
	...
	public RetailStoreCountryCenter updateFounded(Date founded){Date oldFounded = this.founded;Date newFounded = founded;if(!shouldReplaceBy(newFounded, oldFounded)){return this;}this.founded = newFounded;addPropertyChange(FOUNDED_PROPERTY, oldFounded, newFounded);this.changed = true;setChecked(false);return this;}
...
return createCriteria(FOUNDED_PROPERTY, operator, parameters);
	...
	public RetailStoreCountryCenter ignoreFoundedCriteria(){super.ignoreSearchProperty(FOUNDED_PROPERTY);
return this;
}
...
return this;
	...
	public void setWebSite(String webSite){String oldWebSite = this.webSite;String newWebSite = trimString(encodeUrl(webSite));;this.webSite = newWebSite;}
...
return getWebSite();
	...
	public RetailStoreCountryCenter updateWebSite(String webSite){String oldWebSite = this.webSite;String newWebSite = trimString(encodeUrl(webSite));;if(!shouldReplaceBy(newWebSite, oldWebSite)){return this;}this.webSite = newWebSite;addPropertyChange(WEB_SITE_PROPERTY, oldWebSite, newWebSite);this.changed = true;setChecked(false);return this;}
...
return createCriteria(WEB_SITE_PROPERTY, operator, parameters);
	...
	public RetailStoreCountryCenter ignoreWebSiteCriteria(){super.ignoreSearchProperty(WEB_SITE_PROPERTY);
return this;
}
...
return createCriteria(ADDRESS_PROPERTY, operator, parameters);
	...
	public RetailStoreCountryCenter ignoreAddressCriteria(){super.ignoreSearchProperty(ADDRESS_PROPERTY);
return this;
}
...
return this;
	...
	public void setOperatedBy(String operatedBy){String oldOperatedBy = this.operatedBy;String newOperatedBy = trimString(operatedBy);this.operatedBy = newOperatedBy;}
...
return getOperatedBy();
	...
	public RetailStoreCountryCenter updateOperatedBy(String operatedBy){String oldOperatedBy = this.operatedBy;String newOperatedBy = trimString(operatedBy);if(!shouldReplaceBy(newOperatedBy, oldOperatedBy)){return this;}this.operatedBy = newOperatedBy;addPropertyChange(OPERATED_BY_PROPERTY, oldOperatedBy, newOperatedBy);this.changed = true;setChecked(false);return this;}
...
return createCriteria(OPERATED_BY_PROPERTY, operator, parameters);
	...
	public RetailStoreCountryCenter ignoreOperatedByCriteria(){super.ignoreSearchProperty(OPERATED_BY_PROPERTY);
return this;
}
	public RetailStoreCountryCenter addOperatedByCriteria(QueryOperator operator, Object... parameters){
...
return this;
	...
	public void setLegalRepresentative(String legalRepresentative){String oldLegalRepresentative = this.legalRepresentative;String newLegalRepresentative = trimString(legalRepresentative);this.legalRepresentative = newLegalRepresentative;}
...
return getLegalRepresentative();
	...
	public RetailStoreCountryCenter updateLegalRepresentative(String legalRepresentative){String oldLegalRepresentative = this.legalRepresentative;String newLegalRepresentative = trimString(legalRepresentative);if(!shouldReplaceBy(newLegalRepresentative, oldLegalRepresentative)){return this;}this.legalRepresentative = newLegalRepresentative;addPropertyChange(LEGAL_REPRESENTATIVE_PROPERTY, oldLegalRepresentative, newLegalRepresentative);this.changed = true;setChecked(false);return this;}
	public RetailStoreCountryCenter orderByLegalRepresentative(boolean asc){
doAddOrderBy(LEGAL_REPRESENTATIVE_PROPERTY, asc);
return this;
}
	public SearchCriteria createLegalRepresentativeCriteria(QueryOperator operator, Object... parameters){
return createCriteria(LEGAL_REPRESENTATIVE_PROPERTY, operator, parameters);
}
	public RetailStoreCountryCenter ignoreLegalRepresentativeCriteria(){super.ignoreSearchProperty(LEGAL_REPRESENTATIVE_PROPERTY);
return this;
}
	public RetailStoreCountryCenter addLegalRepresentativeCriteria(QueryOperator operator, Object... parameters){
...
return getDescription();
	...
	public RetailStoreCountryCenter updateDescription(String description){String oldDescription = this.description;String newDescription = trimString(description);if(!shouldReplaceBy(newDescription, oldDescription)){return this;}this.description = newDescription;addPropertyChange(DESCRIPTION_PROPERTY, oldDescription, newDescription);this.changed = true;setChecked(false);return this;}
...
return createCriteria(DESCRIPTION_PROPERTY, operator, parameters);
	...
	public RetailStoreCountryCenter ignoreDescriptionCriteria(){super.ignoreSearchProperty(DESCRIPTION_PROPERTY);
return this;
}
	public RetailStoreCountryCenter addDescriptionCriteria(QueryOperator operator, Object... parameters){
...
return getVersion();
	...
	public RetailStoreCountryCenter updateVersion(int version){int oldVersion = this.version;int newVersion = version;if(!shouldReplaceBy(newVersion, oldVersion)){return this;}this.version = newVersion;addPropertyChange(VERSION_PROPERTY, oldVersion, newVersion);this.changed = true;setChecked(false);return this;}
...
return createCriteria(VERSION_PROPERTY, operator, parameters);
	...
	public RetailStoreCountryCenter ignoreVersionCriteria(){super.ignoreSearchProperty(VERSION_PROPERTY);
return this;
}
...
return this;
  ...
  public  SmartList<RetailStoreProvinceCenter> retailStoreProvinceCenterList(){
	...
	public  RetailStoreCountryCenter addRetailStoreProvinceCenter(RetailStoreProvinceCenter retailStoreProvinceCenter){
		retailStoreProvinceCenter.setCountry(this);
		getRetailStoreProvinceCenterList().add(retailStoreProvinceCenter);
		return this;
	}
	public  RetailStoreCountryCenter addRetailStoreProvinceCenterList(SmartList<RetailStoreProvinceCenter> retailStoreProvinceCenterList){
		for( RetailStoreProvinceCenter retailStoreProvinceCenter:retailStoreProvinceCenterList){
			retailStoreProvinceCenter.setCountry(this);
		}
  ...
  public  SmartList<RetailStoreMember> retailStoreMemberList(){
	...
	public  RetailStoreCountryCenter addRetailStoreMemberList(SmartList<RetailStoreMember> retailStoreMemberList){
		for( RetailStoreMember retailStoreMember:retailStoreMemberList){
			retailStoreMember.setOwner(this);
		}
  ...
  public  SmartList<RetailStoreOrder> retailStoreOrderList(){
	...
	public  RetailStoreCountryCenter addRetailStoreOrderList(SmartList<RetailStoreOrder> retailStoreOrderList){
		for( RetailStoreOrder retailStoreOrder:retailStoreOrderList){
			retailStoreOrder.setSeller(this);
		}
  ...
  public  SmartList<TransportFleet> transportFleetList(){
	...
	public  RetailStoreCountryCenter addTransportFleetList(SmartList<TransportFleet> transportFleetList){
		for( TransportFleet transportFleet:transportFleetList){
			transportFleet.setOwner(this);
		}
  ...
  public  SmartList<LevelOneDepartment> levelOneDepartmentList(){
	...
	public  RetailStoreCountryCenter addLevelOneDepartmentList(SmartList<LevelOneDepartment> levelOneDepartmentList){
		for( LevelOneDepartment levelOneDepartment:levelOneDepartmentList){
			levelOneDepartment.setBelongsTo(this);
		}
  ...
  public  SmartList<ResponsibilityType> responsibilityTypeList(){
	...
	public  RetailStoreCountryCenter addResponsibilityTypeList(SmartList<ResponsibilityType> responsibilityTypeList){
		for( ResponsibilityType responsibilityType:responsibilityTypeList){
			responsibilityType.setCompany(this);
		}
  ...
  public  SmartList<TerminationReason> terminationReasonList(){
	...
	public  RetailStoreCountryCenter addTerminationReasonList(SmartList<TerminationReason> terminationReasonList){
		for( TerminationReason terminationReason:terminationReasonList){
			terminationReason.setCompany(this);
		}
  ...
  public  SmartList<TerminationType> terminationTypeList(){
	...
	public  RetailStoreCountryCenter addTerminationTypeList(SmartList<TerminationType> terminationTypeList){
		for( TerminationType terminationType:terminationTypeList){
			terminationType.setCompany(this);
		}
  ...
  public  SmartList<OccupationType> occupationTypeList(){
	...
	public  RetailStoreCountryCenter addOccupationTypeList(SmartList<OccupationType> occupationTypeList){
		for( OccupationType occupationType:occupationTypeList){
			occupationType.setCompany(this);
		}
  ...
  public  SmartList<TrainingCourseType> trainingCourseTypeList(){
	...
	public  RetailStoreCountryCenter addTrainingCourseTypeList(SmartList<TrainingCourseType> trainingCourseTypeList){
		for( TrainingCourseType trainingCourseType:trainingCourseTypeList){
			trainingCourseType.setCompany(this);
		}
  ...
  public  SmartList<CompanyTraining> companyTrainingList(){
	...
	public  RetailStoreCountryCenter addCompanyTrainingList(SmartList<CompanyTraining> companyTrainingList){
		for( CompanyTraining companyTraining:companyTrainingList){
			companyTraining.setCompany(this);
		}
	...
	public static RetailStoreCountryCenter createWith(RetailscmUserContext userContext, ThrowingFunction<RetailStoreCountryCenter,RetailStoreCountryCenter,Exception> postHandler, Object ... inputs) throws Exception {

    List<Object> params = inputs == null ? new ArrayList<>() : Arrays.asList(inputs);
    CustomRetailscmPropertyMapper mapper = CustomRetailscmPropertyMapper.of(userContext);
    CreationScene scene = mapper.findParamByClass(params, CreationScene.class);
    RetailscmBeanCreator<RetailStoreCountryCenter> customCreator = mapper.findCustomCreator(RetailStoreCountryCenter.class, scene);
    if (customCreator != null){
      return customCreator.create(userContext, scene, postHandler, params);
    }

    RetailStoreCountryCenter result = new RetailStoreCountryCenter();
    result.setName(mapper.tryToGet(RetailStoreCountryCenter.class, NAME_PROPERTY, String.class,
        0, false, result.getName(), params));
    result.setServiceNumber(mapper.tryToGet(RetailStoreCountryCenter.class, SERVICE_NUMBER_PROPERTY, String.class,
        1, false, result.getServiceNumber(), params));
    result.setFounded(mapper.tryToGet(RetailStoreCountryCenter.class, FOUNDED_PROPERTY, Date.class,
        0, true, result.getFounded(), params));
    result.setWebSite(mapper.tryToGet(RetailStoreCountryCenter.class, WEB_SITE_PROPERTY, String.class,
        2, false, result.getWebSite(), params));
    result.setAddress(mapper.tryToGet(RetailStoreCountryCenter.class, ADDRESS_PROPERTY, String.class,
        3, false, result.getAddress(), params));
    result.setOperatedBy(mapper.tryToGet(RetailStoreCountryCenter.class, OPERATED_BY_PROPERTY, String.class,
        4, false, result.getOperatedBy(), params));
    result.setLegalRepresentative(mapper.tryToGet(RetailStoreCountryCenter.class, LEGAL_REPRESENTATIVE_PROPERTY, String.class,
        5, false, result.getLegalRepresentative(), params));
    result.setDescription(mapper.tryToGet(RetailStoreCountryCenter.class, DESCRIPTION_PROPERTY, String.class,
        6, false, result.getDescription(), params));

    if (postHandler != null) {
      result = postHandler.apply(result);
    }
    if (result != null){
      userContext.getChecker().checkAndFixRetailStoreCountryCenter(result);
      userContext.getChecker().throwExceptionIfHasErrors(IllegalArgumentException.class);

      
      RetailStoreCountryCenterTokens tokens = mapper.findParamByClass(params, RetailStoreCountryCenterTokens.class);
      if (tokens == null) {
        tokens = RetailStoreCountryCenterTokens.start();
      }
      result = userContext.getManagerGroup().getRetailStoreCountryCenterManager().internalSaveRetailStoreCountryCenter(userContext, result, tokens.done());
