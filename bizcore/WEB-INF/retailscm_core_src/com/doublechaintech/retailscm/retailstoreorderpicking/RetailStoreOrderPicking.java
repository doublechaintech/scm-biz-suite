...
public class RetailStoreOrderPicking extends BaseEntity implements  java.io.Serializable{
	...
	public static final String INTERNAL_TYPE="RetailStoreOrderPicking";
	...
	public RetailStoreOrderPicking updateId(String id){
		this.mId = trimString(id);;
		this.changed = true;
		return this;
	}
	...
	public RetailStoreOrderPicking updateWho(String who){
		this.mWho = trimString(who);;
		this.changed = true;
		return this;
	}
	...
	public RetailStoreOrderPicking updateProcessTime(Date processTime){
		this.mProcessTime = processTime;;
		this.changed = true;
		return this;
	}
	...
	public RetailStoreOrderPicking updateVersion(int version){
		this.mVersion = version;;
		this.changed = true;
		return this;
	}
	...
	public  RetailStoreOrder removeRetailStoreOrder(RetailStoreOrder retailStoreOrderIndex){
        ...
        // retailStoreOrder.clearPicking(); //disconnect with Picking
        retailStoreOrder.clearFromAll(); //disconnect with Picking
	...
	public  void breakWithRetailStoreOrder(RetailStoreOrder retailStoreOrder){
		...
		retailStoreOrder.setPicking(null);
	...
	public BaseEntity copyTo(BaseEntity baseDest){
		...
		if(baseDest instanceof RetailStoreOrderPicking){
		
		
			RetailStoreOrderPicking dest =(RetailStoreOrderPicking)baseDest;
	...
	public String toString(){
		...
		stringBuilder.append("RetailStoreOrderPicking{");
