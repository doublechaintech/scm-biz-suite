...
public class TransportTruckTokens extends CommonTokens {
  ...
  private static void addToken(
      TransportTruckTokens pTokens, String pTokenName, String[] pGroupNames, String[] fieldGroups) {
  ...
  public static TransportTruckTokens filterWithTokenViewGroups(String[] viewGroups) {
    ...
    return start().withOwner().withTransportTaskListIfViewGroupInclude(viewGroups);
  }

  public static TransportTruckTokens allTokens() {

    return start().withOwner().withTransportTaskList();
  }
