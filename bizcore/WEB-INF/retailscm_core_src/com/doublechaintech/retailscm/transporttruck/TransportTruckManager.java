...
public interface TransportTruckManager extends BaseManager{
  ...
  List<TransportTruck> searchTransportTruckList(RetailscmUserContext ctx, TransportTruckRequest pRequest);
  TransportTruck searchTransportTruck(RetailscmUserContext ctx, TransportTruckRequest pRequest);
	...
	public default void onUpdated(RetailscmUserContext userContext, TransportTruck updated, Object actor, String methodName) throws Exception {};
