...
public interface GoodsShelfStockCountManager extends BaseManager{
  ...
  List<GoodsShelfStockCount> searchGoodsShelfStockCountList(RetailscmUserContext ctx, GoodsShelfStockCountRequest pRequest);
  GoodsShelfStockCount searchGoodsShelfStockCount(RetailscmUserContext ctx, GoodsShelfStockCountRequest pRequest);
	...
	public default void onUpdated(RetailscmUserContext userContext, GoodsShelfStockCount updated, Object actor, String methodName) throws Exception {};
