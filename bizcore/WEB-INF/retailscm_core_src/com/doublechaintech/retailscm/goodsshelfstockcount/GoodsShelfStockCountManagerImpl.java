...
import com.doublechaintech.retailscm.*;import com.doublechaintech.retailscm.BaseViewPage;import com.doublechaintech.retailscm.RetailscmUserContextImpl;import com.doublechaintech.retailscm.goodsshelf.CandidateGoodsShelf;import com.doublechaintech.retailscm.goodsshelf.GoodsShelf;import com.doublechaintech.retailscm.goodsshelfstockcount.GoodsShelfStockCount;import com.doublechaintech.retailscm.iamservice.*;import com.doublechaintech.retailscm.secuser.SecUser;import com.doublechaintech.retailscm.services.IamService;import com.doublechaintech.retailscm.stockcountissuetrack.StockCountIssueTrack;import com.doublechaintech.retailscm.tree.*;import com.doublechaintech.retailscm.treenode.*;import com.doublechaintech.retailscm.userapp.UserApp;import com.doublechaintech.retailscm.utils.ModelAssurance;
...
public class GoodsShelfStockCountManagerImpl extends CustomRetailscmCheckerManager implements GoodsShelfStockCountManager, BusinessHandler{
	...
	public Object prepareContextForUserApp(BaseUserContext userContext,Object targetUserApp) throws Exception{
	 ...
	 public Object summaryView(RetailscmUserContext userContext, String goodsShelfStockCountId) throws Exception{
		GoodsShelfStockCount goodsShelfStockCount = loadGoodsShelfStockCount( userContext, goodsShelfStockCountId, viewTokens());
	 ...
	 public Object analyze(RetailscmUserContext userContext, String goodsShelfStockCountId) throws Exception{
		GoodsShelfStockCount goodsShelfStockCount = loadGoodsShelfStockCount( userContext, goodsShelfStockCountId, analyzeTokens());
		markVisited(userContext, goodsShelfStockCount);
  ...
  @Override
  public List<GoodsShelfStockCount> searchGoodsShelfStockCountList(RetailscmUserContext ctx, GoodsShelfStockCountRequest pRequest){
  ...
  @Override
  public GoodsShelfStockCount searchGoodsShelfStockCount(RetailscmUserContext ctx, GoodsShelfStockCountRequest pRequest){
    pRequest.limit(0, 1);
 ...
 //--------------------------------------------------------------
	...
	public  GoodsShelfStockCount addStockCountIssueTrack(RetailscmUserContext userContext, String goodsShelfStockCountId, String title, Date countTime, String summary, String [] tokensExpr) throws Exception
	{
		...
		synchronized(goodsShelfStockCount){
			...
			stockCountIssueTrackManagerOf(userContext).onNewInstanceCreated(userContext, stockCountIssueTrack);
			return present(userContext,goodsShelfStockCount, mergedAllTokens(tokensExpr));
		}
	}
	...
	public  GoodsShelfStockCount updateStockCountIssueTrackProperties(RetailscmUserContext userContext, String goodsShelfStockCountId, String id,String title,Date countTime,String summary, String [] tokensExpr) throws Exception
	{
		...
		Map<String, Object> options = tokens()
				...
				.searchStockCountIssueTrackListWith(StockCountIssueTrack.ID_PROPERTY, tokens().is(), id).done();
		...
		beforeUpdateStockCountIssueTrackProperties(userContext,item, goodsShelfStockCountId,id,title,countTime,summary,tokensExpr);
	...
	protected  void beforeUpdateStockCountIssueTrackProperties(RetailscmUserContext userContext, StockCountIssueTrack item, String goodsShelfStockCountId, String id,String title,Date countTime,String summary, String [] tokensExpr)
						throws Exception {
	...
	public  GoodsShelfStockCount copyStockCountIssueTrackFrom(RetailscmUserContext userContext, String goodsShelfStockCountId,
		...
		synchronized(goodsShelfStockCount){
			...
			stockCountIssueTrackManagerOf(userContext).onNewInstanceCreated(userContext, (StockCountIssueTrack)goodsShelfStockCount.getFlexiableObjects().get(BaseEntity.COPIED_CHILD));
			return present(userContext,goodsShelfStockCount, mergedAllTokens(tokensExpr));
		}
	...
	public  GoodsShelfStockCount updateStockCountIssueTrack(RetailscmUserContext userContext, String goodsShelfStockCountId, String stockCountIssueTrackId, int stockCountIssueTrackVersion, String property, String newValueExpr,String [] tokensExpr)
		...
		Map<String,Object> loadTokens = this.tokens().withStockCountIssueTrackList().searchStockCountIssueTrackListWith(StockCountIssueTrack.ID_PROPERTY, tokens().equals(), stockCountIssueTrackId).done();
		...
		synchronized(goodsShelfStockCount){
			...
			StockCountIssueTrack stockCountIssueTrackIdVersionKey = createIndexedStockCountIssueTrack(stockCountIssueTrackId, stockCountIssueTrackVersion);

			StockCountIssueTrack stockCountIssueTrack = goodsShelfStockCount.findTheStockCountIssueTrack(stockCountIssueTrackIdVersionKey);
			if(stockCountIssueTrack == null){
				throw new GoodsShelfStockCountManagerException(stockCountIssueTrackId+" is NOT FOUND" );
			}

			beforeUpdateStockCountIssueTrack(userContext, stockCountIssueTrack, goodsShelfStockCountId, stockCountIssueTrackId, stockCountIssueTrackVersion, property, newValueExpr,  tokensExpr);
			stockCountIssueTrack.changeProperty(property, newValueExpr);
			
			goodsShelfStockCount = saveGoodsShelfStockCount(userContext, goodsShelfStockCount, tokens().withStockCountIssueTrackList().done());
			stockCountIssueTrackManagerOf(userContext).onUpdated(userContext, stockCountIssueTrack, this, "updateStockCountIssueTrack");
			return present(userContext,goodsShelfStockCount, mergedAllTokens(tokensExpr));
		}
	...
	protected void beforeUpdateStockCountIssueTrack(RetailscmUserContext userContext, StockCountIssueTrack existed, String goodsShelfStockCountId, String stockCountIssueTrackId, int stockCountIssueTrackVersion, String property, String newValueExpr,String [] tokensExpr)
  			throws Exception{
  }
	/*
  ...
  public void sendAllItems(RetailscmUserContext ctx) throws Exception{
    goodsShelfStockCountDaoOf(ctx).loadAllAsStream().forEach(
