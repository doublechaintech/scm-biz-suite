...
@JsonSerialize(using = AccountingDocumentCreationSerializer.class)
public class AccountingDocumentCreation extends BaseEntity implements  java.io.Serializable{
	...
	public static final String INTERNAL_TYPE="AccountingDocumentCreation";
	...
	public 	AccountingDocumentCreation(String who, String comments, Date makeDate)
	{
		setWho(who);
	...
	public AccountingDocumentCreation updateId(String id){
		this.mId = trimString(id);;
		this.changed = true;
		return this;
	}
	...
	public AccountingDocumentCreation updateWho(String who){
		this.mWho = trimString(who);;
		this.changed = true;
		return this;
	}
	...
	public AccountingDocumentCreation updateComments(String comments){
		this.mComments = trimString(comments);;
		this.changed = true;
		return this;
	}
	...
	public AccountingDocumentCreation updateMakeDate(Date makeDate){
		this.mMakeDate = makeDate;;
		this.changed = true;
		return this;
	}
	...
	public AccountingDocumentCreation updateVersion(int version){
		this.mVersion = version;;
		this.changed = true;
		return this;
	}
	...
	public  void setAccountingDocumentList(SmartList<AccountingDocument> accountingDocumentList){
		for( AccountingDocument accountingDocument:accountingDocumentList){
			accountingDocument.setCreation(this);
		}
	...
	public  AccountingDocument removeAccountingDocument(AccountingDocument accountingDocumentIndex){
        ...
        // accountingDocument.clearCreation(); //disconnect with Creation
        accountingDocument.clearFromAll(); //disconnect with Creation
	...
	public  void breakWithAccountingDocument(AccountingDocument accountingDocument){
		...
		accountingDocument.setCreation(null);
	...
	public String toString(){
		...
		stringBuilder.append("AccountingDocumentCreation{");
