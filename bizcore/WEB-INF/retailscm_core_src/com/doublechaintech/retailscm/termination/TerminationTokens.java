...
public class TerminationTokens extends CommonTokens{
  ...
  public static TerminationTokens loadGroupTokens(String... groupNames){
    TerminationTokens tokens = start();
    if (groupNames == null || groupNames.length == 0){
      return allTokens();
    }
    addToken(tokens, REASON, groupNames, new String[]{"default"});addToken(tokens, TYPE, groupNames, new String[]{"default"});

  
    return tokens;
  }

  private static void addToken(TerminationTokens pTokens, String pTokenName, String[] pGroupNames, String[] fieldGroups) {
	...
	public static TerminationTokens filterWithTokenViewGroups(String []viewGroups){
	...
	public static TerminationTokens allTokens(){
	...
	public TerminationReasonTokens withReasonTokens(){
		//addSimpleOptions(REASON);
	...
	public TerminationTypeTokens withTypeTokens(){
		//addSimpleOptions(TYPE);
