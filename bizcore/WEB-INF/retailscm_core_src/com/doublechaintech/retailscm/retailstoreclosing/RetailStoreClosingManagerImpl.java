...
public class RetailStoreClosingManagerImpl extends CustomRetailscmCheckerManager
    implements RetailStoreClosingManager, BusinessHandler {
  ...
  public BlobObject exportExcelFromList(
    ...
    Map<String, Object> tokens =
        RetailStoreClosingTokens.start().withTokenFromListName(listName).done();
    RetailStoreClosing retailStoreClosing =
        (RetailStoreClosing) this.loadRetailStoreClosing(userContext, id, tokens);
    // to enrich reference object to let it show display name
    List<BaseEntity> entityListToNaming = retailStoreClosing.collectReferencesFromLists();
  ...
  protected RetailStoreClosing saveRetailStoreClosing(
      RetailscmUserContext userContext, RetailStoreClosing retailStoreClosing, String[] tokensExpr)
      throws Exception {
  ...
  protected RetailStoreClosing saveRetailStoreClosingDetail(
  ...
  public RetailStoreClosing loadRetailStoreClosing(
    ...
    RetailStoreClosing retailStoreClosing =
        loadRetailStoreClosing(userContext, retailStoreClosingId, tokens);
    // do some calc before sent to customer?
    return present(userContext, retailStoreClosing, tokens);
  }

  public RetailStoreClosing searchRetailStoreClosing(
  ...
  protected RetailStoreClosing present(
      RetailscmUserContext userContext,
      RetailStoreClosing retailStoreClosing,
      Map<String, Object> tokens)
      throws Exception {
    ...
    RetailStoreClosing retailStoreClosingToPresent =
        retailStoreClosingDaoOf(userContext).present(retailStoreClosing, tokens);

    List<BaseEntity> entityListToNaming = retailStoreClosingToPresent.collectReferencesFromLists();
    retailStoreClosingDaoOf(userContext).alias(entityListToNaming);
  ...
  public RetailStoreClosing loadRetailStoreClosingDetail(
      RetailscmUserContext userContext, String retailStoreClosingId) throws Exception {
    RetailStoreClosing retailStoreClosing =
        loadRetailStoreClosing(userContext, retailStoreClosingId, allTokens());
  ...
  public Object view(RetailscmUserContext userContext, String retailStoreClosingId)
      throws Exception {
    RetailStoreClosing retailStoreClosing =
        loadRetailStoreClosing(userContext, retailStoreClosingId, viewTokens());
    markVisited(userContext, retailStoreClosing);
    return present(userContext, retailStoreClosing, viewTokens());
  }

  public Object summaryView(RetailscmUserContext userContext, String retailStoreClosingId)
      throws Exception {
    RetailStoreClosing retailStoreClosing =
        loadRetailStoreClosing(userContext, retailStoreClosingId, viewTokens());
  ...
  public Object analyze(RetailscmUserContext userContext, String retailStoreClosingId)
      throws Exception {
    RetailStoreClosing retailStoreClosing =
        loadRetailStoreClosing(userContext, retailStoreClosingId, analyzeTokens());
    markVisited(userContext, retailStoreClosing);
  ...
  protected RetailStoreClosing loadRetailStoreClosing(
      RetailscmUserContext userContext, String retailStoreClosingId, Map<String, Object> tokens)
      throws Exception {
    checkerOf(userContext).checkIdOfRetailStoreClosing(retailStoreClosingId);
  ...
  protected <T extends BaseEntity> void addActions(
    ...
    // userContext, RetailStoreClosing retailStoreClosing, Map<String, Object> tokens){

  @Override
  public List<RetailStoreClosing> searchRetailStoreClosingList(
  ...
  protected void checkParamsForUpdatingRetailStoreClosing(
      RetailscmUserContext userContext,
      String retailStoreClosingId,
  ...
  public RetailStoreClosing clone(RetailscmUserContext userContext, String fromRetailStoreClosingId)
      throws Exception {
  ...
  public RetailStoreClosing internalSaveRetailStoreClosing(
      ...
      throws Exception {
    // checkParamsForUpdatingRetailStoreClosing(userContext, retailStoreClosingId,
    // retailStoreClosingVersion, property, newValueExpr, tokensExpr);
  ...
  public RetailStoreClosing updateRetailStoreClosing(
      ...
      String[] tokensExpr)
      throws Exception {
    checkParamsForUpdatingRetailStoreClosing(
        userContext,
        retailStoreClosingId,
        retailStoreClosingVersion,
        property,
        newValueExpr,
        tokensExpr);
  ...
  public RetailStoreClosing updateRetailStoreClosingProperty(
      RetailscmUserContext userContext,
      String retailStoreClosingId,
      int retailStoreClosingVersion,
      String property,
  ...
  public RetailStoreClosing forgetByAll(
      RetailscmUserContext userContext, String retailStoreClosingId, int retailStoreClosingVersion)
      throws Exception {
    return forgetByAllInternal(userContext, retailStoreClosingId, retailStoreClosingVersion);
  }

  protected RetailStoreClosing forgetByAllInternal(
      RetailscmUserContext userContext, String retailStoreClosingId, int retailStoreClosingVersion)
      throws Exception {

    return retailStoreClosingDaoOf(userContext)
        .disconnectFromAll(retailStoreClosingId, retailStoreClosingVersion);
  }
  ...
  public RetailStoreClosing addRetailStore(
    ...
    RetailStoreClosing retailStoreClosing =
        loadRetailStoreClosing(userContext, retailStoreClosingId, emptyOptions());
    synchronized (retailStoreClosing) {
      // Will be good when the retailStoreClosing loaded from this JVM process cache.
      // Also good when there is a RAM based DAO implementation
      retailStoreClosing.addRetailStore(retailStore);
      retailStoreClosing =
          saveRetailStoreClosing(
              userContext, retailStoreClosing, tokens().withRetailStoreList().done());
  ...
  public RetailStoreClosing updateRetailStoreProperties(
      RetailscmUserContext userContext,
      String retailStoreClosingId,
      String id,
      String name,
    ...
    RetailStoreClosing retailStoreClosingToUpdate =
        loadRetailStoreClosing(userContext, retailStoreClosingId, options);

    if (retailStoreClosingToUpdate.getRetailStoreList().isEmpty()) {
      throw new RetailStoreClosingManagerException(
    ...
    // checkParamsForAddingRetailStore(userContext,retailStoreClosingId,name, code,
    // used,tokensExpr);
    RetailStoreClosing retailStoreClosing =
        saveRetailStoreClosing(
            userContext, retailStoreClosingToUpdate, tokens().withRetailStoreList().done());
    synchronized (retailStoreClosing) {
      return present(userContext, retailStoreClosing, mergedAllTokens(tokensExpr));
    }
  }
  ...
  public RetailStoreClosing removeRetailStoreList(
      RetailscmUserContext userContext,
      String retailStoreClosingId,
      String retailStoreIds[],
      String[] tokensExpr)
    ...
    checkParamsForRemovingRetailStoreList(
        userContext, retailStoreClosingId, retailStoreIds, tokensExpr);
    ...
    synchronized (retailStoreClosing) {
      ...
      retailStoreClosingDaoOf(userContext)
          .planToRemoveRetailStoreList(retailStoreClosing, retailStoreIds, allTokens());
      retailStoreClosing =
          saveRetailStoreClosing(
              userContext, retailStoreClosing, tokens().withRetailStoreList().done());
  ...
  public RetailStoreClosing removeRetailStore(
    ...
    checkParamsForRemovingRetailStore(
        userContext, retailStoreClosingId, retailStoreId, retailStoreVersion, tokensExpr);
  ...
  public RetailStoreClosing copyRetailStoreFrom(
      RetailscmUserContext userContext,
      String retailStoreClosingId,
      String retailStoreId,
      int retailStoreVersion,
    ...
    synchronized (retailStoreClosing) {
      ...
      retailStoreManagerOf(userContext)
          .onNewInstanceCreated(
              userContext,
              (RetailStore) retailStoreClosing.getFlexiableObjects().get(BaseEntity.COPIED_CHILD));
      return present(userContext, retailStoreClosing, mergedAllTokens(tokensExpr));
    }
  }
  ...
  public RetailStoreClosing updateRetailStore(
    ...
    RetailStoreClosing retailStoreClosing =
        loadRetailStoreClosing(userContext, retailStoreClosingId, loadTokens);
  ...
  */
  ...
  public void sendAllItems(RetailscmUserContext ctx) throws Exception {
    retailStoreClosingDaoOf(ctx).loadAllAsStream().forEach(event -> sendInitEvent(ctx, event));
  }
  ...
  protected void enhanceForListOfView(
      RetailscmUserContext userContext, SmartList<RetailStoreClosing> list) throws Exception {
    if (list == null || list.isEmpty()) {
      return;
    }
  }
   ...
   * @throws Exception
   */
  public Object wxappview(RetailscmUserContext userContext, String retailStoreClosingId)
      throws Exception {
    SerializeScope vscope = SerializeScope.EXCLUDE().nothing();
    RetailStoreClosing merchantObj =
        (RetailStoreClosing) this.view(userContext, retailStoreClosingId);
