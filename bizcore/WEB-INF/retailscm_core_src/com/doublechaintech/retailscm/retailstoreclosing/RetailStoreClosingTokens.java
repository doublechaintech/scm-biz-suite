...
public class RetailStoreClosingTokens extends CommonTokens{
  ...
  public static RetailStoreClosingTokens loadGroupTokens(String... groupNames){
    RetailStoreClosingTokens tokens = start();
  ...
  private static void addToken(RetailStoreClosingTokens pTokens, String pTokenName, String[] pGroupNames, String[] fieldGroups) {
	...
	public static RetailStoreClosingTokens filterWithTokenViewGroups(String []viewGroups){
	...
	public static RetailStoreClosingTokens allTokens(){
	...
	public RetailStoreClosingTokens withRetailStoreListIfViewGroupInclude(String [] viewGroups){
