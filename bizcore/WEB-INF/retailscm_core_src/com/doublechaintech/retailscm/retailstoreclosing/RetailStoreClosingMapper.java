...
public class RetailStoreClosingMapper extends BaseRowMapper<RetailStoreClosing> {
  ...
  public static RetailStoreClosingMapper mapperForClass(Class<?> clazz) {

    RetailStoreClosingMapper mapperForOverride = new RetailStoreClosingMapper();
  ...
  protected void setId(RetailStoreClosing retailStoreClosing, ResultSet rs, int rowNumber)
      throws SQLException {
    try {
  ...
  protected void setComment(RetailStoreClosing retailStoreClosing, ResultSet rs, int rowNumber)
      throws SQLException {
    try {
      // there will be issue when the type is double/int/long
  ...
  protected void setVersion(RetailStoreClosing retailStoreClosing, ResultSet rs, int rowNumber)
      throws SQLException {
    try {
      // there will be issue when the type is double/int/long
