...
public class SmartPallet extends BaseEntity implements java.io.Serializable {
  ...
  public void transferAllRelationshipsTo(SmartPallet target) {
    if (target == null) {
      return;
    }
  ...
  static {
    ...
    memberMetaInfoList.add(
        MemberMetaInfo.referBy(GOODS_LIST, "smartPallet", "商品列表").withType("goods", Goods.class));
  }
  ...
  public SmartPallet updateId(String id) {
    String oldId = this.id;
    String newId = trimString(id);
  ...
  public SmartPallet ignoreIdCriteria() {
  ...
  public SmartPallet updateLocation(String location) {
    String oldLocation = this.location;
    String newLocation = trimString(location);
  ...
  public SmartPallet ignoreLocationCriteria() {
  ...
  public SmartPallet updateContactNumber(String contactNumber) {
    String oldContactNumber = this.contactNumber;
    String newContactNumber = trimString(contactNumber);
  ...
  public SmartPallet ignoreContactNumberCriteria() {
  ...
  public SmartPallet updateTotalArea(String totalArea) {
    String oldTotalArea = this.totalArea;
    String newTotalArea = trimString(totalArea);
  ...
  public SmartPallet ignoreTotalAreaCriteria() {
  ...
  public SmartPallet updateLatitude(BigDecimal latitude) {
    BigDecimal oldLatitude = this.latitude;
    BigDecimal newLatitude = latitude;
  ...
  public SmartPallet ignoreLatitudeCriteria() {
  ...
  public SmartPallet updateLongitude(BigDecimal longitude) {
    BigDecimal oldLongitude = this.longitude;
    BigDecimal newLongitude = longitude;
  ...
  public SmartPallet ignoreLongitudeCriteria() {
  ...
  public SmartPallet updateWarehouse(Warehouse warehouse) {
    Warehouse oldWarehouse = this.warehouse;
    Warehouse newWarehouse = warehouse;
  ...
  public SmartPallet ignoreWarehouseCriteria() {
  ...
  public SmartPallet updateWarehouseByReferenceId(String warehouseId) {
  ...
  public SmartPallet updateLastUpdateTime(DateTime lastUpdateTime) {
    DateTime oldLastUpdateTime = this.lastUpdateTime;
    DateTime newLastUpdateTime = lastUpdateTime;
  ...
  public SmartPallet ignoreLastUpdateTimeCriteria() {
  ...
  public SmartPallet updateVersion(int version) {
    int oldVersion = this.version;
    int newVersion = version;
  ...
  public SmartPallet ignoreVersionCriteria() {
  ...
  public BaseEntity mergeDataFrom(BaseEntity sourceEntity) {
    ...
    if (sourceEntity instanceof SmartPallet) {

      SmartPallet source = (SmartPallet) sourceEntity;
  ...
  public boolean checkIfEligibleForDelete(Object ctx) {
    ...
    SmartPallet checkSmartPallet =
        Q.smartPalletWithIdField()
            .filterById(id)
            .selectGoodsList(Q.goodsWithIdField().limit(0, 1))
            .execute(ctx);

    return checkSmartPallet != null
        && !checkSmartPallet.getAllRelatedLists().stream()
            .flatMap(subList -> subList.stream())
            .findFirst()
            .isPresent();
  }

  public SmartPallet save(com.doublechaintech.retailscm.RetailscmUserContext ctx) {
    try {
