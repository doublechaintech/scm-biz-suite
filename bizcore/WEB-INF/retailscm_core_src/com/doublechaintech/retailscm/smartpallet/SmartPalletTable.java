...
public class SmartPalletTable{
	...
	static final String TABLE_NAME="smart_pallet_data";
	...
	static final String []ALL_CLOUMNS = {COLUMN_ID, 
		COLUMN_LOCATION, COLUMN_CONTACT_NUMBER, COLUMN_TOTAL_AREA, COLUMN_LATITUDE, COLUMN_LONGITUDE, COLUMN_WAREHOUSE, 
		COLUMN_VERSION};
