...
public class SmartPalletManagerImpl extends CustomRetailscmCheckerManager
    implements SmartPalletManager, BusinessHandler {
  ...
  public BlobObject exportExcelFromList(
    ...
    List<BaseEntity> entityListToNaming = smartPallet.collectReferencesFromLists();
  ...
  protected SmartPallet saveSmartPallet(
      RetailscmUserContext userContext, SmartPallet smartPallet, String[] tokensExpr)
      throws Exception {
  ...
  protected SmartPallet saveSmartPalletDetail(
      RetailscmUserContext userContext, SmartPallet smartPallet) throws Exception {

    return saveSmartPallet(userContext, smartPallet, allTokens());
  }

  public SmartPallet loadSmartPallet(
      RetailscmUserContext userContext, String smartPalletId, String[] tokensExpr)
      throws Exception {
  ...
  public SmartPallet searchSmartPallet(
  ...
  protected SmartPallet present(
      RetailscmUserContext userContext, SmartPallet smartPallet, Map<String, Object> tokens)
      throws Exception {
    ...
    List<BaseEntity> entityListToNaming = smartPalletToPresent.collectReferencesFromLists();
    smartPalletDaoOf(userContext).alias(entityListToNaming);
  ...
  public SmartPallet loadSmartPalletDetail(RetailscmUserContext userContext, String smartPalletId)
      throws Exception {
  ...
  public Object summaryView(RetailscmUserContext userContext, String smartPalletId)
      throws Exception {
    SmartPallet smartPallet = loadSmartPallet(userContext, smartPalletId, viewTokens());
  ...
  protected SmartPallet loadSmartPallet(
      RetailscmUserContext userContext, String smartPalletId, Map<String, Object> tokens)
      throws Exception {
    checkerOf(userContext).checkIdOfSmartPallet(smartPalletId);
  ...
  protected <T extends BaseEntity> void addActions(
    ...
    // userContext, SmartPallet smartPallet, Map<String, Object> tokens){

  @Override
  public List<SmartPallet> searchSmartPalletList(
      RetailscmUserContext ctx, SmartPalletRequest pRequest) {
  ...
  public SmartPallet createSmartPallet(
      RetailscmUserContext userContext,
      String location,
  ...
  public SmartPallet clone(RetailscmUserContext userContext, String fromSmartPalletId)
      throws Exception {

    return smartPalletDaoOf(userContext).clone(fromSmartPalletId, this.allTokens());
  }

  public SmartPallet internalSaveSmartPallet(
      RetailscmUserContext userContext, SmartPallet smartPallet) throws Exception {
    return internalSaveSmartPallet(userContext, smartPallet, allTokens());
  }

  public SmartPallet internalSaveSmartPallet(
      RetailscmUserContext userContext, SmartPallet smartPallet, Map<String, Object> options)
      throws Exception {
    // checkParamsForUpdatingSmartPallet(userContext, smartPalletId, smartPalletVersion, property,
  ...
  public SmartPallet updateSmartPallet(
      RetailscmUserContext userContext,
      String smartPalletId,
      int smartPalletVersion,
      String property,
    ...
    checkParamsForUpdatingSmartPallet(
        userContext, smartPalletId, smartPalletVersion, property, newValueExpr, tokensExpr);
  ...
  public SmartPallet updateSmartPalletProperty(
      RetailscmUserContext userContext,
      String smartPalletId,
      int smartPalletVersion,
      String property,
  ...
  protected void checkParamsForTransferingAnotherWarehouse(
      RetailscmUserContext userContext, String smartPalletId, String anotherWarehouseId)
      throws Exception {
  ...
  public SmartPallet transferToAnotherWarehouse(
      RetailscmUserContext userContext, String smartPalletId, String anotherWarehouseId)
      throws Exception {
  ...
  public CandidateWarehouse requestCandidateWarehouse(
    ...
    SmartList<Warehouse> candidateList =
        warehouseDaoOf(userContext)
            .requestCandidateWarehouseForSmartPallet(
  ...
  public SmartPallet forgetByAll(
      RetailscmUserContext userContext, String smartPalletId, int smartPalletVersion)
      throws Exception {
    return forgetByAllInternal(userContext, smartPalletId, smartPalletVersion);
  }

  protected SmartPallet forgetByAllInternal(
      RetailscmUserContext userContext, String smartPalletId, int smartPalletVersion)
      throws Exception {
  ...
  public SmartPallet updateGoodsProperties(
      RetailscmUserContext userContext,
      String smartPalletId,
      String id,
      String name,
    ...
    checkParamsForUpdatingGoodsProperties(
        userContext, smartPalletId, id, name, rfid, uom, maxPackage, expireTime, tokensExpr);
    ...
    beforeUpdateGoodsProperties(
        userContext, item, smartPalletId, id, name, rfid, uom, maxPackage, expireTime, tokensExpr);
    ...
    SmartPallet smartPallet =
        saveSmartPallet(userContext, smartPalletToUpdate, tokens().withGoodsList().done());
    synchronized (smartPallet) {
      return present(userContext, smartPallet, mergedAllTokens(tokensExpr));
    }
  }
  ...
  public SmartPallet removeGoodsList(
      RetailscmUserContext userContext,
      String smartPalletId,
      String goodsIds[],
      String[] tokensExpr)
  ...
  public SmartPallet removeGoods(
      RetailscmUserContext userContext,
      String smartPalletId,
      String goodsId,
      int goodsVersion,
  ...
  public SmartPallet copyGoodsFrom(
      RetailscmUserContext userContext,
      String smartPalletId,
      String goodsId,
      int goodsVersion,
    ...
    synchronized (smartPallet) {
      ...
      goodsManagerOf(userContext)
          .onNewInstanceCreated(
              userContext, (Goods) smartPallet.getFlexiableObjects().get(BaseEntity.COPIED_CHILD));
      return present(userContext, smartPallet, mergedAllTokens(tokensExpr));
    }
  }
  ...
  public SmartPallet updateGoods(
      RetailscmUserContext userContext,
      String smartPalletId,
      String goodsId,
      int goodsVersion,
    ...
    checkParamsForUpdatingGoods(
        userContext, smartPalletId, goodsId, goodsVersion, property, newValueExpr, tokensExpr);
  ...
  */
  ...
  public void onNewInstanceCreated(RetailscmUserContext userContext, SmartPallet newCreated)
      throws Exception {
  ...
  public void sendAllItems(RetailscmUserContext ctx) throws Exception {
    smartPalletDaoOf(ctx).loadAllAsStream().forEach(event -> sendInitEvent(ctx, event));
  }
  ...
  // -----------------------------------// list-of-view 处理 \\-----------------------------------
  protected void enhanceForListOfView(RetailscmUserContext userContext, SmartList<SmartPallet> list)
      throws Exception {
    if (list == null || list.isEmpty()) {
      return;
    }
  ...
  public Object listPageByWarehouse(
    ...
    SmartList<SmartPallet> list =
        smartPalletDaoOf(userContext)
            .findSmartPalletByWarehouse(warehouseId, start, count, new HashMap<>());
