...
public interface SalaryGradeManager extends BaseManager{
  ...
  SalaryGrade searchSalaryGrade(RetailscmUserContext ctx, SalaryGradeRequest pRequest);
	...
	public default void onUpdated(RetailscmUserContext userContext, SalaryGrade updated, Object actor, String methodName) throws Exception {};
	...
	*/
	...
	//public  EmployeeSalarySheetManager getEmployeeSalarySheetManager(RetailscmUserContext userContext, String salaryGradeId, String employeeId, BigDecimal baseSalary, BigDecimal bonus, BigDecimal reward, BigDecimal personalTax, BigDecimal socialSecurity, BigDecimal housingFound, BigDecimal jobInsurance, String payingOffId ,String [] tokensExpr)  throws Exception;
