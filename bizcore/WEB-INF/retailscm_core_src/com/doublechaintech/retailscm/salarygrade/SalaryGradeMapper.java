...
public class SalaryGradeMapper extends BaseRowMapper<SalaryGrade> {
  ...
  public static SalaryGradeMapper mapperForClass(Class<?> clazz) {

    SalaryGradeMapper mapperForOverride = new SalaryGradeMapper();
  ...
  protected void setCompany(SalaryGrade salaryGrade, ResultSet rs, int rowNumber)
      throws SQLException {
  ...
  protected void setDetailDescription(SalaryGrade salaryGrade, ResultSet rs, int rowNumber)
      throws SQLException {
    try {
      // there will be issue when the type is double/int/long
  ...
  protected void setVersion(SalaryGrade salaryGrade, ResultSet rs, int rowNumber)
      throws SQLException {
    try {
      // there will be issue when the type is double/int/long
