...
public class SalaryGradeTokens extends CommonTokens {
  ...
  private static void addToken(
      SalaryGradeTokens pTokens, String pTokenName, String[] pGroupNames, String[] fieldGroups) {
  ...
  public static SalaryGradeTokens allTokens() {
    ...
    return start().withCompany().withEmployeeList().withEmployeeSalarySheetList();
  }
  ...
  public SalaryGradeTokens searchEmployeeSalarySheetListWith(
