...
public class ScoringTokens extends CommonTokens {
  ...
  public static ScoringTokens loadGroupTokens(String... groupNames) {
    ScoringTokens tokens = start();
  ...
  private static void addToken(
      ScoringTokens pTokens, String pTokenName, String[] pGroupNames, String[] fieldGroups) {
  ...
  public static ScoringTokens filterWithTokenViewGroups(String[] viewGroups) {

    return start().withEmployeeCompanyTrainingListIfViewGroupInclude(viewGroups);
  }

  public static ScoringTokens allTokens() {

    return start().withEmployeeCompanyTrainingList();
  }
  ...
  public ScoringTokens withEmployeeCompanyTrainingListIfViewGroupInclude(String[] viewGroups) {
  ...
  public ScoringTokens searchEmployeeCompanyTrainingListWith(
