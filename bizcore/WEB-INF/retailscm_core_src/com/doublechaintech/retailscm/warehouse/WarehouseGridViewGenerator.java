...
public class WarehouseGridViewGenerator extends BaseGridViewGenerator{
	...
	protected String [] getHeaderKeys(String listName) {
		...
		if(Warehouse.STORAGE_SPACE_LIST.equals(listName)){
			return new String[]{"id","location","contact_number","total_area","warehouse","latitude","longitude","last_update_time","version"};
		}
		if(Warehouse.SMART_PALLET_LIST.equals(listName)){
			return new String[]{"id","location","contact_number","total_area","latitude","longitude","warehouse","last_update_time","version"};
		}
		if(Warehouse.SUPPLIER_SPACE_LIST.equals(listName)){
			return new String[]{"id","location","contact_number","total_area","warehouse","latitude","longitude","last_update_time","version"};
		}
		if(Warehouse.RECEIVING_SPACE_LIST.equals(listName)){
			return new String[]{"id","location","contact_number","description","total_area","warehouse","latitude","longitude","last_update_time","version"};
		}
		if(Warehouse.SHIPPING_SPACE_LIST.equals(listName)){
			return new String[]{"id","location","contact_number","total_area","warehouse","latitude","longitude","description","last_update_time","version"};
		}
