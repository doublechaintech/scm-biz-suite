...
public class WarehouseTable{
	...
	static final String TABLE_NAME="warehouse_data";
	...
	static final String []ALL_CLOUMNS = {COLUMN_ID, 
		COLUMN_LOCATION, COLUMN_CONTACT_NUMBER, COLUMN_TOTAL_AREA, COLUMN_OWNER, COLUMN_LATITUDE, COLUMN_LONGITUDE, COLUMN_LAST_UPDATE_TIME, 
		COLUMN_VERSION};
