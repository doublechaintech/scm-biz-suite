...
public class OccupationTypeTokens extends CommonTokens {
  ...
  private static void addToken(
      OccupationTypeTokens pTokens, String pTokenName, String[] pGroupNames, String[] fieldGroups) {
  ...
  public static OccupationTypeTokens filterWithTokenViewGroups(String[] viewGroups) {
    ...
    return start().withCompany().withEmployeeListIfViewGroupInclude(viewGroups);
  }

  public static OccupationTypeTokens allTokens() {

    return start().withCompany().withEmployeeList();
  }
