...
public class OccupationTypeTable{
	...
	public static final String TABLE_NAME="occupation_type_data";
	...
	public static final String []NORMAL_CLOUMNS = {COLUMN_CODE,COLUMN_COMPANY,COLUMN_DESCRIPTION,COLUMN_DETAIL_DESCRIPTION};
	  ...
	  public static void ensureTable(RetailscmUserContext userContext, Map<String, Object> result) throws Exception {
        RetailscmBaseUtils.ensureTable(userContext, result, "occupation_type_data", new String[][]{
                ...
                "alter table occupation_type_data add constraint fk4company_of_occupation_type_data foreign key (company) references retail_store_country_center_data(id) ON DELETE CASCADE ON UPDATE CASCADE;",
                ""
         });
  }
