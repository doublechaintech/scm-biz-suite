...
public class RetailStoreMemberGiftCardConsumeRecordTokens extends CommonTokens{
  ...
  public static RetailStoreMemberGiftCardConsumeRecordTokens loadGroupTokens(String... groupNames){
    ...
    addToken(tokens, OWNER, groupNames, new String[]{"default"});addToken(tokens, BIZORDER, groupNames, new String[]{"default"});

  
    return tokens;
  }

  private static void addToken(RetailStoreMemberGiftCardConsumeRecordTokens pTokens, String pTokenName, String[] pGroupNames, String[] fieldGroups) {
	...
	public static RetailStoreMemberGiftCardConsumeRecordTokens filterWithTokenViewGroups(String []viewGroups){
