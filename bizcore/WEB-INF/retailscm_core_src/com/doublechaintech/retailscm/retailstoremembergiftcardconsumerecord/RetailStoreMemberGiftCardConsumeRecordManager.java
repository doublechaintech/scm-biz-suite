...
public interface RetailStoreMemberGiftCardConsumeRecordManager extends BaseManager{
  ...
  List<RetailStoreMemberGiftCardConsumeRecord> searchRetailStoreMemberGiftCardConsumeRecordList(RetailscmUserContext ctx, RetailStoreMemberGiftCardConsumeRecordRequest pRequest);
  RetailStoreMemberGiftCardConsumeRecord searchRetailStoreMemberGiftCardConsumeRecord(RetailscmUserContext ctx, RetailStoreMemberGiftCardConsumeRecordRequest pRequest);
	...
	public default void onUpdated(RetailscmUserContext userContext, RetailStoreMemberGiftCardConsumeRecord updated, Object actor, String methodName) throws Exception {};
