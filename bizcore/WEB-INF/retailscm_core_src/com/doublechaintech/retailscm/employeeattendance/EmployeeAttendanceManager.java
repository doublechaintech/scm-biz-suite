...
public interface EmployeeAttendanceManager extends BaseManager{
  ...
  List<EmployeeAttendance> searchEmployeeAttendanceList(RetailscmUserContext ctx, EmployeeAttendanceRequest pRequest);
  EmployeeAttendance searchEmployeeAttendance(RetailscmUserContext ctx, EmployeeAttendanceRequest pRequest);
	...
	public default void onUpdated(RetailscmUserContext userContext, EmployeeAttendance updated, Object actor, String methodName) throws Exception {};
