...
public class DamageSpace extends BaseEntity implements java.io.Serializable {
  ...
  public void transferAllRelationshipsTo(DamageSpace target) {
    if (target == null) {
      return;
    }
  ...
  static {
    ...
    memberMetaInfoList.add(
        MemberMetaInfo.referBy(GOODS_SHELF_LIST, "damageSpace", "货架列表")
  ...
  public DamageSpace ignoreIdCriteria() {
  ...
  public DamageSpace ignoreLocationCriteria() {
  ...
  public DamageSpace ignoreContactNumberCriteria() {
  ...
  public DamageSpace ignoreTotalAreaCriteria() {
  ...
  public DamageSpace ignoreLatitudeCriteria() {
  ...
  public DamageSpace ignoreLongitudeCriteria() {
  ...
  public DamageSpace ignoreWarehouseCriteria() {
  ...
  public DamageSpace updateWarehouseByReferenceId(String warehouseId) {
  ...
  public DamageSpace ignoreLastUpdateTimeCriteria() {
  ...
  public DamageSpace ignoreVersionCriteria() {
  ...
  public DamageSpace addGoodsShelf(GoodsShelf goodsShelf) {
    goodsShelf.updateDamageSpace(this);
  ...
  public BaseEntity mergeDataFrom(BaseEntity sourceEntity) {
    ...
    if (sourceEntity instanceof DamageSpace) {

      DamageSpace source = (DamageSpace) sourceEntity;
  ...
  public boolean checkIfEligibleForDelete(Object ctx) {
    ...
    DamageSpace checkDamageSpace =
        Q.damageSpaceWithIdField()
            .filterById(id)
            .selectGoodsShelfList(Q.goodsShelfWithIdField().limit(0, 1))
            .execute(ctx);

    return checkDamageSpace != null
        && !checkDamageSpace.getAllRelatedLists().stream()
            .flatMap(subList -> subList.stream())
            .findFirst()
            .isPresent();
  }

  public DamageSpace save(com.doublechaintech.retailscm.RetailscmUserContext ctx) {
    try {
