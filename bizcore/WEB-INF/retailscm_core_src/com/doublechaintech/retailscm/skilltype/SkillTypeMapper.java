...
public class SkillTypeMapper extends BaseRowMapper<SkillType> {
  ...
  public static SkillTypeMapper mapperForClass(Class<?> clazz) {

    SkillTypeMapper mapperForOverride = new SkillTypeMapper();
  ...
  protected void setDescription(SkillType skillType, ResultSet rs, int rowNumber)
      throws SQLException {
    try {
      // there will be issue when the type is double/int/long
