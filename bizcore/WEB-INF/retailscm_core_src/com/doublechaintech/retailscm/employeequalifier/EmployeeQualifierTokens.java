...
public class EmployeeQualifierTokens extends CommonTokens{
  ...
  public static EmployeeQualifierTokens loadGroupTokens(String... groupNames){
    EmployeeQualifierTokens tokens = start();
  ...
  private static void addToken(EmployeeQualifierTokens pTokens, String pTokenName, String[] pGroupNames, String[] fieldGroups) {
	...
	public static EmployeeQualifierTokens filterWithTokenViewGroups(String []viewGroups){
	...
	public static EmployeeQualifierTokens allTokens(){
