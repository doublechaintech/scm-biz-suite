...
public class EmployeeQualifierManagerImpl extends CustomRetailscmCheckerManager implements EmployeeQualifierManager, BusinessHandler{
	...
	public Object prepareContextForUserApp(BaseUserContext userContext,Object targetUserApp) throws Exception{
	 ...
	 public Object summaryView(RetailscmUserContext userContext, String employeeQualifierId) throws Exception{
		EmployeeQualifier employeeQualifier = loadEmployeeQualifier( userContext, employeeQualifierId, viewTokens());
	 ...
	 public Object analyze(RetailscmUserContext userContext, String employeeQualifierId) throws Exception{
		EmployeeQualifier employeeQualifier = loadEmployeeQualifier( userContext, employeeQualifierId, analyzeTokens());
		markVisited(userContext, employeeQualifier);
  ...
  @Override
  public List<EmployeeQualifier> searchEmployeeQualifierList(RetailscmUserContext ctx, EmployeeQualifierRequest pRequest){
  ...
  @Override
  public EmployeeQualifier searchEmployeeQualifier(RetailscmUserContext ctx, EmployeeQualifierRequest pRequest){
    pRequest.limit(0, 1);
 ...
 //--------------------------------------------------------------
  ...
  public void sendAllItems(RetailscmUserContext ctx) throws Exception{
    employeeQualifierDaoOf(ctx).loadAllAsStream().forEach(
