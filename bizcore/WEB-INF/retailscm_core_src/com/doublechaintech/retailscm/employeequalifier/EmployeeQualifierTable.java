...
public class EmployeeQualifierTable{
	...
	public static final String []ALL_CLOUMNS = {COLUMN_ID,COLUMN_EMPLOYEE,COLUMN_QUALIFIED_TIME,COLUMN_TYPE,COLUMN_LEVEL,COLUMN_REMARK,COLUMN_VERSION};
	public static final String []NORMAL_CLOUMNS = {COLUMN_EMPLOYEE,COLUMN_QUALIFIED_TIME,COLUMN_TYPE,COLUMN_LEVEL,COLUMN_REMARK};

	  public static void ensureTable(RetailscmUserContext userContext, Map<String, Object> result) throws Exception {
        RetailscmBaseUtils.ensureTable(userContext, result, "employee_qualifier_data", new String[][]{
