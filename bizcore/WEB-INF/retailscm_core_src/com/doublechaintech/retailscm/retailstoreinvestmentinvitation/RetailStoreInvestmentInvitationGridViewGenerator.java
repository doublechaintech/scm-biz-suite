...
public class RetailStoreInvestmentInvitationGridViewGenerator extends BaseGridViewGenerator{
	...
	protected void throwExceptionIfListNotFount(String listName) {
		String message=String.format("List '%s' is not found for RetailStoreInvestmentInvitation", listName);
		throw new IllegalArgumentException(message);
	}
	
	protected String [] getHeaderKeys(String listName) {
		
		if(RetailStoreInvestmentInvitation.RETAIL_STORE_LIST.equals(listName)){
