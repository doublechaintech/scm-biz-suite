...
public class RetailStoreInvestmentInvitationTokens extends CommonTokens {
  ...
  public static RetailStoreInvestmentInvitationTokens of(Map<String, Object> options) {
    // ensure not initialized outside the class
    RetailStoreInvestmentInvitationTokens tokens =
        new RetailStoreInvestmentInvitationTokens(options);
    return tokens;
  }
  ...
  private static void addToken(
      RetailStoreInvestmentInvitationTokens pTokens,
      String pTokenName,
      String[] pGroupNames,
      String[] fieldGroups) {
  ...
  public static RetailStoreInvestmentInvitationTokens filterWithTokenViewGroups(
      String[] viewGroups) {
  ...
  public RetailStoreInvestmentInvitationTokens withRetailStoreListIfViewGroupInclude(
      String[] viewGroups) {
  ...
  public RetailStoreInvestmentInvitationTokens extractMoreFromRetailStoreList(
  ...
  public RetailStoreInvestmentInvitationTokens sortRetailStoreListWith(
  ...
  public RetailStoreInvestmentInvitationTokens searchRetailStoreListWith(
  ...
  public RetailStoreInvestmentInvitationTokens searchAllTextOfRetailStoreList(
  ...
  public RetailStoreInvestmentInvitationTokens currentPageNumberOfRetailStoreList(
