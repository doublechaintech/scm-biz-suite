...
public class RetailStoreInvestmentInvitationManagerImpl extends CustomRetailscmCheckerManager implements RetailStoreInvestmentInvitationManager, BusinessHandler{
	...
	public Object prepareContextForUserApp(BaseUserContext userContext,Object targetUserApp) throws Exception{
	 ...
	 public Object summaryView(RetailscmUserContext userContext, String retailStoreInvestmentInvitationId) throws Exception{
		RetailStoreInvestmentInvitation retailStoreInvestmentInvitation = loadRetailStoreInvestmentInvitation( userContext, retailStoreInvestmentInvitationId, viewTokens());
	 ...
	 public Object analyze(RetailscmUserContext userContext, String retailStoreInvestmentInvitationId) throws Exception{
		RetailStoreInvestmentInvitation retailStoreInvestmentInvitation = loadRetailStoreInvestmentInvitation( userContext, retailStoreInvestmentInvitationId, analyzeTokens());
		markVisited(userContext, retailStoreInvestmentInvitation);
  ...
  @Override
  public List<RetailStoreInvestmentInvitation> searchRetailStoreInvestmentInvitationList(RetailscmUserContext ctx, RetailStoreInvestmentInvitationRequest pRequest){
  ...
  @Override
  public RetailStoreInvestmentInvitation searchRetailStoreInvestmentInvitation(RetailscmUserContext ctx, RetailStoreInvestmentInvitationRequest pRequest){
    pRequest.limit(0, 1);
    List<RetailStoreInvestmentInvitation> list = searchRetailStoreInvestmentInvitationList(ctx, pRequest);
...
//--------------------------------------------------------------
	...
	public  RetailStoreInvestmentInvitation updateRetailStoreProperties(RetailscmUserContext userContext, String retailStoreInvestmentInvitationId, String id,String name,String telephone,String owner,Date founded,BigDecimal latitude,BigDecimal longitude,String description, String [] tokensExpr) throws Exception
	{
		...
		beforeUpdateRetailStoreProperties(userContext,item, retailStoreInvestmentInvitationId,id,name,telephone,owner,founded,latitude,longitude,description,tokensExpr);
	...
	protected  void beforeUpdateRetailStoreProperties(RetailscmUserContext userContext, RetailStore item, String retailStoreInvestmentInvitationId, String id,String name,String telephone,String owner,Date founded,BigDecimal latitude,BigDecimal longitude,String description, String [] tokensExpr)
						throws Exception {
	...
	public  RetailStoreInvestmentInvitation copyRetailStoreFrom(RetailscmUserContext userContext, String retailStoreInvestmentInvitationId,
		...
		synchronized(retailStoreInvestmentInvitation){
			...
			retailStoreManagerOf(userContext).onNewInstanceCreated(userContext, (RetailStore)retailStoreInvestmentInvitation.getFlexiableObjects().get(BaseEntity.COPIED_CHILD));
			return present(userContext,retailStoreInvestmentInvitation, mergedAllTokens(tokensExpr));
		}
	...
	public  RetailStoreInvestmentInvitation updateRetailStore(RetailscmUserContext userContext, String retailStoreInvestmentInvitationId, String retailStoreId, int retailStoreVersion, String property, String newValueExpr,String [] tokensExpr)
		...
		synchronized(retailStoreInvestmentInvitation){
			...
			RetailStore retailStore = retailStoreInvestmentInvitation.findTheRetailStore(retailStoreIdVersionKey);
			if(retailStore == null){
				throw new RetailStoreInvestmentInvitationManagerException(retailStoreId+" is NOT FOUND" );
			}

			beforeUpdateRetailStore(userContext, retailStore, retailStoreInvestmentInvitationId, retailStoreId, retailStoreVersion, property, newValueExpr,  tokensExpr);
	...
	protected void beforeUpdateRetailStore(RetailscmUserContext userContext, RetailStore existed, String retailStoreInvestmentInvitationId, String retailStoreId, int retailStoreVersion, String property, String newValueExpr,String [] tokensExpr)
  			throws Exception{
  }
	/*
  ...
  public void sendAllItems(RetailscmUserContext ctx) throws Exception{
    retailStoreInvestmentInvitationDaoOf(ctx).loadAllAsStream().forEach(
