...
public class RetailStoreInvestmentInvitation extends BaseEntity implements java.io.Serializable {
  ...
  public void transferAllRelationshipsTo(RetailStoreInvestmentInvitation target) {
    if (target == null) {
      return;
    }
  ...
  static {
    ...
    memberMetaInfoList.add(
        MemberMetaInfo.referBy(RETAIL_STORE_LIST, "investmentInvitation", "零售门店列表")
  ...
  public RetailStoreInvestmentInvitation updateId(String id) {
    String oldId = this.id;
    String newId = trimString(id);
  ...
  public RetailStoreInvestmentInvitation ignoreIdCriteria() {
    super.ignoreSearchProperty(ID_PROPERTY);
    return this;
  }

  public RetailStoreInvestmentInvitation addIdCriteria(
  ...
  public RetailStoreInvestmentInvitation updateComment(String comment) {
    String oldComment = this.comment;
    String newComment = trimString(comment);
  ...
  public RetailStoreInvestmentInvitation ignoreCommentCriteria() {
    super.ignoreSearchProperty(COMMENT_PROPERTY);
    return this;
  }

  public RetailStoreInvestmentInvitation addCommentCriteria(
      QueryOperator operator, Object... parameters) {
  ...
  public RetailStoreInvestmentInvitation updateVersion(int version) {
    int oldVersion = this.version;
    int newVersion = version;
  ...
  public RetailStoreInvestmentInvitation ignoreVersionCriteria() {
    super.ignoreSearchProperty(VERSION_PROPERTY);
    return this;
  }

  public RetailStoreInvestmentInvitation addVersionCriteria(
      QueryOperator operator, Object... parameters) {
  ...
  public RetailStoreInvestmentInvitation addRetailStore(RetailStore retailStore) {
    retailStore.updateInvestmentInvitation(this);
    getRetailStoreList().add(retailStore);
    return this;
  }

  public RetailStoreInvestmentInvitation addRetailStoreList(
  ...
  public BaseEntity mergeDataFrom(BaseEntity sourceEntity) {
    ...
    if (sourceEntity instanceof RetailStoreInvestmentInvitation) {

      RetailStoreInvestmentInvitation source = (RetailStoreInvestmentInvitation) sourceEntity;
  ...
  public boolean checkIfEligibleForDelete(Object ctx) {
    ...
    RetailStoreInvestmentInvitation checkRetailStoreInvestmentInvitation =
        Q.retailStoreInvestmentInvitationWithIdField()
            .filterById(id)
            .selectRetailStoreList(Q.retailStoreWithIdField().limit(0, 1))
            .execute(ctx);

    return checkRetailStoreInvestmentInvitation != null
        && !checkRetailStoreInvestmentInvitation.getAllRelatedLists().stream()
