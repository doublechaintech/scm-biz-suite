...
public interface ConsumerOrderPaymentGroupManager extends BaseManager{
  ...
  List<ConsumerOrderPaymentGroup> searchConsumerOrderPaymentGroupList(RetailscmUserContext ctx, ConsumerOrderPaymentGroupRequest pRequest);
  ConsumerOrderPaymentGroup searchConsumerOrderPaymentGroup(RetailscmUserContext ctx, ConsumerOrderPaymentGroupRequest pRequest);
	...
	public default void onUpdated(RetailscmUserContext userContext, ConsumerOrderPaymentGroup updated, Object actor, String methodName) throws Exception {};
