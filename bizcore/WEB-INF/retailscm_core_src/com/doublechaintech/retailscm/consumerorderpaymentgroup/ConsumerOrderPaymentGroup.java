...
return getId();
	...
	public ConsumerOrderPaymentGroup updateId(String id){String oldId = this.id;String newId = trimString(id);if(!shouldReplaceBy(newId, oldId)){return this;}this.id = newId;addPropertyChange(ID_PROPERTY, oldId, newId);this.changed = true;setChecked(false);return this;}
...
return createCriteria(ID_PROPERTY, operator, parameters);
	...
	public ConsumerOrderPaymentGroup ignoreIdCriteria(){super.ignoreSearchProperty(ID_PROPERTY);
return this;
}
...
return getName();
	...
	public ConsumerOrderPaymentGroup updateName(String name){String oldName = this.name;String newName = trimString(name);if(!shouldReplaceBy(newName, oldName)){return this;}this.name = newName;addPropertyChange(NAME_PROPERTY, oldName, newName);this.changed = true;setChecked(false);return this;}
...
return createCriteria(NAME_PROPERTY, operator, parameters);
	...
	public ConsumerOrderPaymentGroup ignoreNameCriteria(){super.ignoreSearchProperty(NAME_PROPERTY);
return this;
}
...
return createCriteria(BIZ_ORDER_PROPERTY, operator, parameters);
	...
	public ConsumerOrderPaymentGroup ignoreBizOrderCriteria(){super.ignoreSearchProperty(BIZ_ORDER_PROPERTY);
return this;
}
	public ConsumerOrderPaymentGroup addBizOrderCriteria(QueryOperator operator, Object... parameters){
...
return createCriteria(CARD_NUMBER_PROPERTY, operator, parameters);
	...
	public ConsumerOrderPaymentGroup ignoreCardNumberCriteria(){super.ignoreSearchProperty(CARD_NUMBER_PROPERTY);
return this;
}
	public ConsumerOrderPaymentGroup addCardNumberCriteria(QueryOperator operator, Object... parameters){
...
return getVersion();
	...
	public ConsumerOrderPaymentGroup updateVersion(int version){int oldVersion = this.version;int newVersion = version;if(!shouldReplaceBy(newVersion, oldVersion)){return this;}this.version = newVersion;addPropertyChange(VERSION_PROPERTY, oldVersion, newVersion);this.changed = true;setChecked(false);return this;}
...
return createCriteria(VERSION_PROPERTY, operator, parameters);
	...
	public ConsumerOrderPaymentGroup ignoreVersionCriteria(){super.ignoreSearchProperty(VERSION_PROPERTY);
return this;
}
	public ConsumerOrderPaymentGroup addVersionCriteria(QueryOperator operator, Object... parameters){
...
return this;
	...
	public static ConsumerOrderPaymentGroup createWith(RetailscmUserContext userContext, ThrowingFunction<ConsumerOrderPaymentGroup,ConsumerOrderPaymentGroup,Exception> postHandler, Object ... inputs) throws Exception {

    List<Object> params = inputs == null ? new ArrayList<>() : Arrays.asList(inputs);
    CustomRetailscmPropertyMapper mapper = CustomRetailscmPropertyMapper.of(userContext);
    CreationScene scene = mapper.findParamByClass(params, CreationScene.class);
    RetailscmBeanCreator<ConsumerOrderPaymentGroup> customCreator = mapper.findCustomCreator(ConsumerOrderPaymentGroup.class, scene);
    if (customCreator != null){
      return customCreator.create(userContext, scene, postHandler, params);
    }

    ConsumerOrderPaymentGroup result = new ConsumerOrderPaymentGroup();
    result.setName(mapper.tryToGet(ConsumerOrderPaymentGroup.class, NAME_PROPERTY, String.class,
        0, false, result.getName(), params));
    result.setBizOrder(mapper.tryToGet(ConsumerOrderPaymentGroup.class, BIZ_ORDER_PROPERTY, ConsumerOrder.class,
        0, true, result.getBizOrder(), params));
    result.setCardNumber(mapper.tryToGet(ConsumerOrderPaymentGroup.class, CARD_NUMBER_PROPERTY, String.class,
    ...
    if (result != null){
      userContext.getChecker().checkAndFixConsumerOrderPaymentGroup(result);
      userContext.getChecker().throwExceptionIfHasErrors(IllegalArgumentException.class);

      
      ConsumerOrderPaymentGroupTokens tokens = mapper.findParamByClass(params, ConsumerOrderPaymentGroupTokens.class);
      if (tokens == null) {
        tokens = ConsumerOrderPaymentGroupTokens.start();
      }
      result = userContext.getManagerGroup().getConsumerOrderPaymentGroupManager().internalSaveConsumerOrderPaymentGroup(userContext, result, tokens.done());
