...
public class ConsumerOrderConfirmation extends BaseEntity implements  java.io.Serializable{
	...
	public static final String INTERNAL_TYPE="ConsumerOrderConfirmation";
	...
	public ConsumerOrderConfirmation updateId(String id){
		this.mId = trimString(id);;
		this.changed = true;
		return this;
	}
	...
	public ConsumerOrderConfirmation updateWho(String who){
		this.mWho = trimString(who);;
		this.changed = true;
		return this;
	}
	...
	public ConsumerOrderConfirmation updateConfirmTime(Date confirmTime){
		this.mConfirmTime = confirmTime;;
		this.changed = true;
		return this;
	}
	...
	public ConsumerOrderConfirmation updateVersion(int version){
		this.mVersion = version;;
		this.changed = true;
		return this;
	}
	...
	public String toString(){
		...
		stringBuilder.append("ConsumerOrderConfirmation{");
