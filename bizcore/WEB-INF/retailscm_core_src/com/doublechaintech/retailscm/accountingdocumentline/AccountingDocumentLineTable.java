...
public class AccountingDocumentLineTable{
	...
	public static final String []ALL_CLOUMNS = {COLUMN_ID,COLUMN_NAME,COLUMN_CODE,COLUMN_DIRECT,COLUMN_AMOUNT,COLUMN_BELONGS_TO,COLUMN_ACCOUNTING_SUBJECT,COLUMN_VERSION};
	public static final String []NORMAL_CLOUMNS = {COLUMN_NAME,COLUMN_CODE,COLUMN_DIRECT,COLUMN_AMOUNT,COLUMN_BELONGS_TO,COLUMN_ACCOUNTING_SUBJECT};

	  public static void ensureTable(RetailscmUserContext userContext, Map<String, Object> result) throws Exception {
        RetailscmBaseUtils.ensureTable(userContext, result, "accounting_document_line_data", new String[][]{
                ...
                new String[]{"accounting_subject","varchar(48)","","会计科目","accounting_subject_data","id"},
