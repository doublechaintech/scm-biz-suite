...
public class AccountingDocumentLineTokens extends CommonTokens{
  ...
  public static AccountingDocumentLineTokens loadGroupTokens(String... groupNames){
    ...
    addToken(tokens, BELONGSTO, groupNames, new String[]{"default"});addToken(tokens, ACCOUNTINGSUBJECT, groupNames, new String[]{"default"});

  
    return tokens;
  }

  private static void addToken(AccountingDocumentLineTokens pTokens, String pTokenName, String[] pGroupNames, String[] fieldGroups) {
