...
public class CatalogTokens extends CommonTokens {
  ...
  private static void addToken(
      CatalogTokens pTokens, String pTokenName, String[] pGroupNames, String[] fieldGroups) {
  ...
  public static CatalogTokens filterWithTokenViewGroups(String[] viewGroups) {
    ...
    return start().withOwner().withLevelOneCategoryListIfViewGroupInclude(viewGroups);
  }

  public static CatalogTokens allTokens() {

    return start().withOwner().withLevelOneCategoryList();
  }
  ...
  public CatalogTokens sortLevelOneCategoryListWith(String field, String descOrAsc) {
    addSortMoreOptions(
        LEVEL_ONE_CATEGORY_LIST, levelOneCategoryListSortCounter++, field, descOrAsc);
    return this;
  }
  ...
  public CatalogTokens searchLevelOneCategoryListWith(String field, String verb, String value) {
    ...
    addSearchMoreOptions(
        LEVEL_ONE_CATEGORY_LIST, levelOneCategoryListSearchCounter++, field, verb, value);
    return this;
  }
