...
public class WechatMiniappIdentityMapper extends BaseRowMapper<WechatMiniappIdentity> {
  ...
  public static WechatMiniappIdentityMapper mapperForClass(Class<?> clazz) {

    WechatMiniappIdentityMapper mapperForOverride = new WechatMiniappIdentityMapper();
  ...
  protected void setId(WechatMiniappIdentity wechatMiniappIdentity, ResultSet rs, int rowNumber)
      throws SQLException {
    try {
  ...
  protected void setOpenId(WechatMiniappIdentity wechatMiniappIdentity, ResultSet rs, int rowNumber)
      throws SQLException {
    try {
      // there will be issue when the type is double/int/long
  ...
  protected void setAppId(WechatMiniappIdentity wechatMiniappIdentity, ResultSet rs, int rowNumber)
      throws SQLException {
    try {
      // there will be issue when the type is double/int/long
  ...
  protected void setUnionId(
      WechatMiniappIdentity wechatMiniappIdentity, ResultSet rs, int rowNumber)
      throws SQLException {
    try {
      // there will be issue when the type is double/int/long
  ...
  protected void setSecUser(
    ...
    if (secUser != null) {
      // if the root object 'wechatMiniappIdentity' already have the property, just set the id for
      // it;
