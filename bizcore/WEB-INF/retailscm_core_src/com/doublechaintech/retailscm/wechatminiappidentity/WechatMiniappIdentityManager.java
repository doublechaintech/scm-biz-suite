...
public interface WechatMiniappIdentityManager extends BaseManager{
  ...
  List<WechatMiniappIdentity> searchWechatMiniappIdentityList(RetailscmUserContext ctx, WechatMiniappIdentityRequest pRequest);
  WechatMiniappIdentity searchWechatMiniappIdentity(RetailscmUserContext ctx, WechatMiniappIdentityRequest pRequest);
	...
	public default void onUpdated(RetailscmUserContext userContext, WechatMiniappIdentity updated, Object actor, String methodName) throws Exception {};
