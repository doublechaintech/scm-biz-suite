...
public class SlideManagerImpl extends CustomRetailscmCheckerManager
    implements SlideManager, BusinessHandler {
  ...
  protected Slide saveSlide(RetailscmUserContext userContext, Slide slide, String[] tokensExpr)
      throws Exception {
  ...
  public Slide searchSlide(
      RetailscmUserContext userContext, String slideId, String textToSearch, String[] tokensExpr)
      throws Exception {
  ...
  protected Slide present(RetailscmUserContext userContext, Slide slide, Map<String, Object> tokens)
      throws Exception {
  ...
  protected Slide saveSlide(
      RetailscmUserContext userContext, Slide slide, Map<String, Object> tokens) throws Exception {

    return slideDaoOf(userContext).save(slide, tokens);
  }

  protected Slide loadSlide(
      RetailscmUserContext userContext, String slideId, Map<String, Object> tokens)
      throws Exception {
    checkerOf(userContext).checkIdOfSlide(slideId);
  ...
  protected <T extends BaseEntity> void addActions(
      RetailscmUserContext userContext, Slide slide, Map<String, Object> tokens) {
    ...
    // userContext, Slide slide, Map<String, Object> tokens){
  ...
  public Slide internalSaveSlide(
      RetailscmUserContext userContext, Slide slide, Map<String, Object> options) throws Exception {
    // checkParamsForUpdatingSlide(userContext, slideId, slideVersion, property, newValueExpr,
    // tokensExpr);
  ...
  public Slide updateSlide(
    ...
    checkParamsForUpdatingSlide(
        userContext, slideId, slideVersion, property, newValueExpr, tokensExpr);
  ...
  public Slide updateSlideProperty(
      RetailscmUserContext userContext,
      String slideId,
      int slideVersion,
      String property,
  ...
  public CandidatePage requestCandidatePage(
    ...
    SmartList<Page> candidateList =
        pageDaoOf(userContext)
            .requestCandidatePageForSlide(userContext, ownerClass, id, filterKey, pageNo, pageSize);
  ...
  public Slide forgetByAll(RetailscmUserContext userContext, String slideId, int slideVersion)
      throws Exception {
    return forgetByAllInternal(userContext, slideId, slideVersion);
  }

  protected Slide forgetByAllInternal(
      RetailscmUserContext userContext, String slideId, int slideVersion) throws Exception {
  ...
  public void sendAllItems(RetailscmUserContext ctx) throws Exception {
    slideDaoOf(ctx).loadAllAsStream().forEach(event -> sendInitEvent(ctx, event));
  }
  ...
  // -----------------------------------// list-of-view 处理 \\-----------------------------------
  protected void enhanceForListOfView(RetailscmUserContext userContext, SmartList<Slide> list)
      throws Exception {
    if (list == null || list.isEmpty()) {
      return;
    }
  ...
  public Object listPageByPage(
    ...
    SmartList<Slide> list =
        slideDaoOf(userContext).findSlideByPage(pageId, start, count, new HashMap<>());
