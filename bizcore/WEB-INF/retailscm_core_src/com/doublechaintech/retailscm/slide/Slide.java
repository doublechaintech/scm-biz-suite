...
public class Slide extends BaseEntity implements java.io.Serializable {
  ...
  public void transferAllRelationshipsTo(Slide target) {
    if (target == null) {
      return;
    }
  }
  ...
  static {
    ...
    memberMetaInfoList.add(
        MemberMetaInfo.defineBy(VIDEO_URL_PROPERTY, "video_url", "视频网址")
            .withType("string_image", String.class));
    memberMetaInfoList.add(
  ...
  public Slide ignoreNameCriteria() {
  ...
  public Slide ignoreDisplayOrderCriteria() {
  ...
  public Slide ignoreImageUrlCriteria() {
  ...
  public void setVideoUrl(String videoUrl) {
    ...
    String newVideoUrl = trimString(encodeUrl(videoUrl));
    ;
  ...
  public Slide updateVideoUrl(String videoUrl) {
    ...
    String newVideoUrl = trimString(encodeUrl(videoUrl));
    ;
    if (!shouldReplaceBy(newVideoUrl, oldVideoUrl)) {
      return this;
    }
    this.videoUrl = newVideoUrl;
    if (cn.hutool.core.util.ObjectUtil.equals(newVideoUrl, oldVideoUrl)) {
      return this;
    }
    addPropertyChange(VIDEO_URL_PROPERTY, oldVideoUrl, newVideoUrl);
    this.changed = true;
    setChecked(false);
    return this;
  }
  ...
  public Slide ignoreVideoUrlCriteria() {
    super.ignoreSearchProperty(VIDEO_URL_PROPERTY);
    return this;
  }
  ...
  public Slide ignoreLinkToUrlCriteria() {
  ...
  public Slide ignorePageCriteria() {
  ...
  public Slide updatePageByReferenceId(String pageId) {
  ...
  public Slide ignoreVersionCriteria() {
  ...
  public boolean checkIfEligibleForDelete(Object ctx) {
    ...
    Slide checkSlide = Q.slideWithIdField().filterById(id).execute(ctx);

    return checkSlide != null
        && !checkSlide.getAllRelatedLists().stream()
            .flatMap(subList -> subList.stream())
            .findFirst()
            .isPresent();
  }

  public Slide save(com.doublechaintech.retailscm.RetailscmUserContext ctx) {
    try {
