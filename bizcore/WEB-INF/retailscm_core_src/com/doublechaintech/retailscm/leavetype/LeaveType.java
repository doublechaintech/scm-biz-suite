...
public class LeaveType extends BaseEntity implements  java.io.Serializable{
  ...
  memberMetaInfoList.add(MemberMetaInfo.referBy(EMPLOYEE_LEAVE_LIST, "type", "员工离开列表")
...
return getId();
	...
	public LeaveType updateId(String id){String oldId = this.id;String newId = trimString(id);if(!shouldReplaceBy(newId, oldId)){return this;}this.id = newId;addPropertyChange(ID_PROPERTY, oldId, newId);this.changed = true;setChecked(false);return this;}
...
return createCriteria(ID_PROPERTY, operator, parameters);
	...
	public LeaveType ignoreIdCriteria(){super.ignoreSearchProperty(ID_PROPERTY);
return this;
}
...
return getCode();
	...
	public LeaveType updateCode(String code){String oldCode = this.code;String newCode = trimString(code);if(!shouldReplaceBy(newCode, oldCode)){return this;}this.code = newCode;addPropertyChange(CODE_PROPERTY, oldCode, newCode);this.changed = true;setChecked(false);return this;}
...
return createCriteria(CODE_PROPERTY, operator, parameters);
	...
	public LeaveType ignoreCodeCriteria(){super.ignoreSearchProperty(CODE_PROPERTY);
return this;
}
...
return getCompany();
	...
	public LeaveType updateCompany(RetailStoreCountryCenter company){RetailStoreCountryCenter oldCompany = this.company;RetailStoreCountryCenter newCompany = company;if(!shouldReplaceBy(newCompany, oldCompany)){return this;}this.company = newCompany;addPropertyChange(COMPANY_PROPERTY, oldCompany, newCompany);this.changed = true;setChecked(false);return this;}
...
return createCriteria(COMPANY_PROPERTY, operator, parameters);
	...
	public LeaveType ignoreCompanyCriteria(){super.ignoreSearchProperty(COMPANY_PROPERTY);
return this;
}
...
return getDescription();
	...
	public LeaveType updateDescription(String description){String oldDescription = this.description;String newDescription = trimString(description);if(!shouldReplaceBy(newDescription, oldDescription)){return this;}this.description = newDescription;addPropertyChange(DESCRIPTION_PROPERTY, oldDescription, newDescription);this.changed = true;setChecked(false);return this;}
...
return createCriteria(DESCRIPTION_PROPERTY, operator, parameters);
	...
	public LeaveType ignoreDescriptionCriteria(){super.ignoreSearchProperty(DESCRIPTION_PROPERTY);
return this;
}
...
return createCriteria(DETAIL_DESCRIPTION_PROPERTY, operator, parameters);
	...
	public LeaveType ignoreDetailDescriptionCriteria(){super.ignoreSearchProperty(DETAIL_DESCRIPTION_PROPERTY);
return this;
}
...
return getVersion();
	...
	public LeaveType updateVersion(int version){int oldVersion = this.version;int newVersion = version;if(!shouldReplaceBy(newVersion, oldVersion)){return this;}this.version = newVersion;addPropertyChange(VERSION_PROPERTY, oldVersion, newVersion);this.changed = true;setChecked(false);return this;}
...
return createCriteria(VERSION_PROPERTY, operator, parameters);
	...
	public LeaveType ignoreVersionCriteria(){super.ignoreSearchProperty(VERSION_PROPERTY);
return this;
}
...
return this;
  ...
  public  SmartList<EmployeeLeave> employeeLeaveList(){
	...
	public static LeaveType createWith(RetailscmUserContext userContext, ThrowingFunction<LeaveType,LeaveType,Exception> postHandler, Object ... inputs) throws Exception {

    List<Object> params = inputs == null ? new ArrayList<>() : Arrays.asList(inputs);
    CustomRetailscmPropertyMapper mapper = CustomRetailscmPropertyMapper.of(userContext);
    CreationScene scene = mapper.findParamByClass(params, CreationScene.class);
    RetailscmBeanCreator<LeaveType> customCreator = mapper.findCustomCreator(LeaveType.class, scene);
    if (customCreator != null){
      return customCreator.create(userContext, scene, postHandler, params);
    }

    LeaveType result = new LeaveType();
    result.setCode(mapper.tryToGet(LeaveType.class, CODE_PROPERTY, String.class,
        0, false, result.getCode(), params));
    result.setCompany(mapper.tryToGet(LeaveType.class, COMPANY_PROPERTY, RetailStoreCountryCenter.class,
        0, true, result.getCompany(), params));
    result.setDescription(mapper.tryToGet(LeaveType.class, DESCRIPTION_PROPERTY, String.class,
        1, false, result.getDescription(), params));
    result.setDetailDescription(mapper.tryToGet(LeaveType.class, DETAIL_DESCRIPTION_PROPERTY, String.class,
    ...
    if (result != null){
      userContext.getChecker().checkAndFixLeaveType(result);
      userContext.getChecker().throwExceptionIfHasErrors(IllegalArgumentException.class);

      
      LeaveTypeTokens tokens = mapper.findParamByClass(params, LeaveTypeTokens.class);
      if (tokens == null) {
        tokens = LeaveTypeTokens.start();
      }
      result = userContext.getManagerGroup().getLeaveTypeManager().internalSaveLeaveType(userContext, result, tokens.done());
