...
public class ConsumerOrderLineItemManagerImpl extends CustomRetailscmCheckerManager
    implements ConsumerOrderLineItemManager, BusinessHandler {
  ...
  protected void throwExceptionWithMessage(String value)
      throws ConsumerOrderLineItemManagerException {
  ...
  protected ConsumerOrderLineItem saveConsumerOrderLineItemDetail(
      RetailscmUserContext userContext, ConsumerOrderLineItem consumerOrderLineItem)
      throws Exception {

    return saveConsumerOrderLineItem(userContext, consumerOrderLineItem, allTokens());
  }

  public ConsumerOrderLineItem loadConsumerOrderLineItem(
      RetailscmUserContext userContext, String consumerOrderLineItemId, String[] tokensExpr)
      throws Exception {
    ...
    ConsumerOrderLineItem consumerOrderLineItem =
        loadConsumerOrderLineItem(userContext, consumerOrderLineItemId, tokens);
    // do some calc before sent to customer?
    return present(userContext, consumerOrderLineItem, tokens);
  }

  public ConsumerOrderLineItem searchConsumerOrderLineItem(
      RetailscmUserContext userContext,
  ...
  protected ConsumerOrderLineItem present(
      RetailscmUserContext userContext,
      ConsumerOrderLineItem consumerOrderLineItem,
      Map<String, Object> tokens)
      throws Exception {
    ...
    ConsumerOrderLineItem consumerOrderLineItemToPresent =
        consumerOrderLineItemDaoOf(userContext).present(consumerOrderLineItem, tokens);

    List<BaseEntity> entityListToNaming =
        consumerOrderLineItemToPresent.collectReferencesFromLists();
  ...
  public ConsumerOrderLineItem loadConsumerOrderLineItemDetail(
      RetailscmUserContext userContext, String consumerOrderLineItemId) throws Exception {
    ConsumerOrderLineItem consumerOrderLineItem =
        loadConsumerOrderLineItem(userContext, consumerOrderLineItemId, allTokens());
  ...
  public Object view(RetailscmUserContext userContext, String consumerOrderLineItemId)
      throws Exception {
    ConsumerOrderLineItem consumerOrderLineItem =
        loadConsumerOrderLineItem(userContext, consumerOrderLineItemId, viewTokens());
    markVisited(userContext, consumerOrderLineItem);
    return present(userContext, consumerOrderLineItem, viewTokens());
  }

  public Object summaryView(RetailscmUserContext userContext, String consumerOrderLineItemId)
      throws Exception {
    ConsumerOrderLineItem consumerOrderLineItem =
        loadConsumerOrderLineItem(userContext, consumerOrderLineItemId, viewTokens());
  ...
  public Object analyze(RetailscmUserContext userContext, String consumerOrderLineItemId)
      throws Exception {
    ConsumerOrderLineItem consumerOrderLineItem =
        loadConsumerOrderLineItem(userContext, consumerOrderLineItemId, analyzeTokens());
    markVisited(userContext, consumerOrderLineItem);
  ...
  protected ConsumerOrderLineItem loadConsumerOrderLineItem(
      RetailscmUserContext userContext, String consumerOrderLineItemId, Map<String, Object> tokens)
      throws Exception {
    checkerOf(userContext).checkIdOfConsumerOrderLineItem(consumerOrderLineItemId);
  ...
  protected <T extends BaseEntity> void addActions(
    ...
    // userContext, ConsumerOrderLineItem consumerOrderLineItem, Map<String, Object> tokens){

  @Override
  public List<ConsumerOrderLineItem> searchConsumerOrderLineItemList(
      RetailscmUserContext ctx, ConsumerOrderLineItemRequest pRequest) {
  ...
  public ConsumerOrderLineItem createConsumerOrderLineItem(
      RetailscmUserContext userContext,
      String bizOrderId,
      String skuId,
      String skuName,
    ...
    consumerOrderLineItem =
        saveConsumerOrderLineItem(userContext, consumerOrderLineItem, emptyOptions());
  ...
  public ConsumerOrderLineItem clone(
      RetailscmUserContext userContext, String fromConsumerOrderLineItemId) throws Exception {

    return consumerOrderLineItemDaoOf(userContext)
        .clone(fromConsumerOrderLineItemId, this.allTokens());
  }

  public ConsumerOrderLineItem internalSaveConsumerOrderLineItem(
      RetailscmUserContext userContext, ConsumerOrderLineItem consumerOrderLineItem)
      throws Exception {
  ...
  public ConsumerOrderLineItem internalSaveConsumerOrderLineItem(
      ...
      throws Exception {
    // checkParamsForUpdatingConsumerOrderLineItem(userContext, consumerOrderLineItemId,
    // consumerOrderLineItemVersion, property, newValueExpr, tokensExpr);
    ...
    synchronized (consumerOrderLineItem) {
      ...
      consumerOrderLineItem =
          saveConsumerOrderLineItem(userContext, consumerOrderLineItem, options);
      return consumerOrderLineItem;
    }
  }

  public ConsumerOrderLineItem updateConsumerOrderLineItem(
      RetailscmUserContext userContext,
      String consumerOrderLineItemId,
      int consumerOrderLineItemVersion,
      String property,
    ...
    synchronized (consumerOrderLineItem) {
      ...
      consumerOrderLineItem =
          saveConsumerOrderLineItem(userContext, consumerOrderLineItem, tokens().done());
  ...
  public ConsumerOrderLineItem updateConsumerOrderLineItemProperty(
      RetailscmUserContext userContext,
      String consumerOrderLineItemId,
      int consumerOrderLineItemVersion,
      String property,
  ...
  protected void checkParamsForTransferingAnotherBizOrder(
      RetailscmUserContext userContext, String consumerOrderLineItemId, String anotherBizOrderId)
      throws Exception {
  ...
  public ConsumerOrderLineItem transferToAnotherBizOrder(
      RetailscmUserContext userContext, String consumerOrderLineItemId, String anotherBizOrderId)
      throws Exception {
    checkParamsForTransferingAnotherBizOrder(
        userContext, consumerOrderLineItemId, anotherBizOrderId);
  ...
  public CandidateConsumerOrder requestCandidateBizOrder(
    ...
    SmartList<ConsumerOrder> candidateList =
        consumerOrderDaoOf(userContext)
            .requestCandidateConsumerOrderForConsumerOrderLineItem(
  ...
  public ConsumerOrderLineItem forgetByAll(
      RetailscmUserContext userContext,
      String consumerOrderLineItemId,
      int consumerOrderLineItemVersion)
      throws Exception {
  ...
  protected ConsumerOrderLineItem forgetByAllInternal(
      RetailscmUserContext userContext,
      String consumerOrderLineItemId,
      int consumerOrderLineItemVersion)
      throws Exception {
    ...
    return consumerOrderLineItemDaoOf(userContext)
        .disconnectFromAll(consumerOrderLineItemId, consumerOrderLineItemVersion);
  }
  ...
  public void onNewInstanceCreated(
      RetailscmUserContext userContext, ConsumerOrderLineItem newCreated) throws Exception {
    ensureRelationInGraph(userContext, newCreated);
    sendCreationEvent(userContext, newCreated);
  }

  public void sendAllItems(RetailscmUserContext ctx) throws Exception {
    consumerOrderLineItemDaoOf(ctx).loadAllAsStream().forEach(event -> sendInitEvent(ctx, event));
  }
  ...
  public void onAuthenticateNewUserLogged(
    ...
    // this.createConsumerOrderLineItem(userContext, ...
  ...
  protected void enhanceForListOfView(
      RetailscmUserContext userContext, SmartList<ConsumerOrderLineItem> list) throws Exception {
    if (list == null || list.isEmpty()) {
      return;
    }
  ...
  public Object listPageByBizOrder(
    ...
    SmartList<ConsumerOrderLineItem> list =
        consumerOrderLineItemDaoOf(userContext)
            .findConsumerOrderLineItemByBizOrder(bizOrderId, start, count, new HashMap<>());
   ...
   * @throws Exception
   */
  public Object wxappview(RetailscmUserContext userContext, String consumerOrderLineItemId)
      throws Exception {
    SerializeScope vscope = SerializeScope.EXCLUDE().nothing();
    ConsumerOrderLineItem merchantObj =
        (ConsumerOrderLineItem) this.view(userContext, consumerOrderLineItemId);
