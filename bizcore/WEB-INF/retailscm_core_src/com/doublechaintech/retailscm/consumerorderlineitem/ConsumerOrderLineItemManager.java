...
public interface ConsumerOrderLineItemManager extends BaseManager{
  ...
  List<ConsumerOrderLineItem> searchConsumerOrderLineItemList(RetailscmUserContext ctx, ConsumerOrderLineItemRequest pRequest);
  ConsumerOrderLineItem searchConsumerOrderLineItem(RetailscmUserContext ctx, ConsumerOrderLineItemRequest pRequest);
	...
	public default void onUpdated(RetailscmUserContext userContext, ConsumerOrderLineItem updated, Object actor, String methodName) throws Exception {};
