...
public class ConsumerOrderLineItemTable{
	...
	static final String TABLE_NAME="consumer_order_line_item_data";
	...
	static final String []ALL_CLOUMNS = {COLUMN_ID, 
		COLUMN_BIZ_ORDER, COLUMN_SKU_ID, COLUMN_SKU_NAME, COLUMN_PRICE, COLUMN_QUANTITY, COLUMN_AMOUNT, COLUMN_LAST_UPDATE_TIME, 
		COLUMN_VERSION};
