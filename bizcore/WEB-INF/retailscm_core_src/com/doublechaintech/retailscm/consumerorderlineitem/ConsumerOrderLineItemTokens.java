...
public class ConsumerOrderLineItemTokens extends CommonTokens{
  ...
  public static ConsumerOrderLineItemTokens loadGroupTokens(String... groupNames){
    ConsumerOrderLineItemTokens tokens = start();
  ...
  private static void addToken(ConsumerOrderLineItemTokens pTokens, String pTokenName, String[] pGroupNames, String[] fieldGroups) {
	...
	public static ConsumerOrderLineItemTokens filterWithTokenViewGroups(String []viewGroups){
	...
	public static ConsumerOrderLineItemTokens allTokens(){
