...
public class RetailStoreCreationTokens extends CommonTokens{
  ...
  public static RetailStoreCreationTokens loadGroupTokens(String... groupNames){
    RetailStoreCreationTokens tokens = start();
  ...
  private static void addToken(RetailStoreCreationTokens pTokens, String pTokenName, String[] pGroupNames, String[] fieldGroups) {
	...
	public static RetailStoreCreationTokens filterWithTokenViewGroups(String []viewGroups){
	...
	public static RetailStoreCreationTokens allTokens(){
	...
	public RetailStoreCreationTokens withRetailStoreListIfViewGroupInclude(String [] viewGroups){
