...
public class RetailStoreCreationJDBCTemplateDAO extends RetailscmBaseDAOImpl
    implements RetailStoreCreationDAO {
  ...
  */
  ...
  public RetailStoreCreation save(
      RetailStoreCreation retailStoreCreation, Map<String, Object> options) {
  ...
  public RetailStoreCreation clone(String retailStoreCreationId, Map<String, Object> options)
      throws Exception {

    return clone(RetailStoreCreationTable.withId(retailStoreCreationId), options);
  }

  protected RetailStoreCreation clone(AccessKey accessKey, Map<String, Object> options)
      throws Exception {
    ...
    RetailStoreCreation newRetailStoreCreation =
        loadInternalRetailStoreCreation(accessKey, options);
  ...
  protected void throwIfHasException(String retailStoreCreationId, int version, int count)
      throws Exception {
    if (count == 1) {
  ...
  public RetailStoreCreation disconnectFromAll(String retailStoreCreationId, int version)
      throws Exception {

    RetailStoreCreation retailStoreCreation =
        loadInternalRetailStoreCreation(
            RetailStoreCreationTable.withId(retailStoreCreationId), emptyOptions());
  ...
  protected RetailStoreCreation extractRetailStoreCreation(
      AccessKey accessKey, Map<String, Object> loadOptions) throws Exception {
    try {
      RetailStoreCreation retailStoreCreation =
          loadSingleObject(accessKey, getRetailStoreCreationMapper());
      return retailStoreCreation;
    } catch (EmptyResultDataAccessException e) {
      throw new RetailStoreCreationNotFoundException(
          "RetailStoreCreation(" + accessKey + ") is not found!");
    }
  }

  protected RetailStoreCreation loadInternalRetailStoreCreation(
      AccessKey accessKey, Map<String, Object> loadOptions) throws Exception {
  ...
  protected RetailStoreCreation extractRetailStoreList(
      RetailStoreCreation retailStoreCreation, Map<String, Object> options) {
    ...
    SmartList<RetailStore> retailStoreList =
        getRetailStoreDAO().findRetailStoreByCreation(retailStoreCreation.getId(), options);
  ...
  protected RetailStoreCreation analyzeRetailStoreList(
      RetailStoreCreation retailStoreCreation, Map<String, Object> options) {
    ...
    if (retailStoreList != null) {
      getRetailStoreDAO()
          .analyzeRetailStoreByCreation(retailStoreList, retailStoreCreation.getId(), options);
    }
  ...
  public SmartList<RetailStoreCreation> saveRetailStoreCreationList(
      SmartList<RetailStoreCreation> retailStoreCreationList, Map<String, Object> options) {
    ...
    batchRetailStoreCreationRemove((List<RetailStoreCreation>) lists[REMOVE_LIST_INDEX]);
    batchRetailStoreCreationRecover((List<RetailStoreCreation>) lists[RECOVER_LIST_INDEX]);
    ...
    for (RetailStoreCreation retailStoreCreation : retailStoreCreationList) {
      ...
      if (retailStoreCreation.isToRecover() || retailStoreCreation.isToRemove()) {
        retailStoreCreation.setVersion(-retailStoreCreation.getVersion());
      }
    }
  ...
  public SmartList<RetailStoreCreation> removeRetailStoreCreationList(
      SmartList<RetailStoreCreation> retailStoreCreationList, Map<String, Object> options) {
  ...
  protected List<Object[]> prepareRetailStoreCreationBatchCreateArgs(
      List<RetailStoreCreation> retailStoreCreationList) {
  ...
  protected List<Object[]> prepareRetailStoreCreationBatchUpdateArgs(
      List<RetailStoreCreation> retailStoreCreationList) {
  ...
  protected List<Object[]> prepareRetailStoreCreationBatchRecoverArgs(
      List<RetailStoreCreation> retailStoreCreationList) {

    List<Object[]> parametersList = new ArrayList<Object[]>();
    for (RetailStoreCreation retailStoreCreation : retailStoreCreationList) {
      if (!retailStoreCreation.isToRecover()) {
        continue;
      }
      Object[] parameters = prepareRecoverParameters(retailStoreCreation);
      parametersList.add(parameters);
    }
    return parametersList;
  }

  protected List<Object[]> prepareRetailStoreCreationBatchRemoveArgs(
      List<RetailStoreCreation> retailStoreCreationList) {

    List<Object[]> parametersList = new ArrayList<Object[]>();
    for (RetailStoreCreation retailStoreCreation : retailStoreCreationList) {
      if (!retailStoreCreation.isToRemove()) {
        continue;
      }
      Object[] parameters = prepareRetailStoreCreationRemoveParameters(retailStoreCreation);
      parametersList.add(parameters);
    }
    return parametersList;
  }
  ...
  protected void batchRetailStoreCreationRemove(List<RetailStoreCreation> retailStoreCreationList) {
    String SQL = getRemoveSQL();
    List<Object[]> args = prepareRetailStoreCreationBatchRemoveArgs(retailStoreCreationList);
    int affectedNumbers[] = batchRemove(SQL, args);
    checkBatchReturn(affectedNumbers);
  }

  protected void batchRetailStoreCreationRecover(
      List<RetailStoreCreation> retailStoreCreationList) {
    String SQL = getRecoverSQL();
    List<Object[]> args = prepareRetailStoreCreationBatchRecoverArgs(retailStoreCreationList);
  ...
  protected Object[] splitRetailStoreCreationList(
      List<RetailStoreCreation> retailStoreCreationList) {
    ...
    List<RetailStoreCreation> retailStoreCreationRemoveList = new ArrayList<RetailStoreCreation>();
    List<RetailStoreCreation> retailStoreCreationRecoverList = new ArrayList<RetailStoreCreation>();

    for (RetailStoreCreation retailStoreCreation : retailStoreCreationList) {
      if (retailStoreCreation.isToRemove()) {
        retailStoreCreationRemoveList.add(retailStoreCreation);
        continue;
      }
      if (retailStoreCreation.isToRecover()) {
        retailStoreCreationRecoverList.add(retailStoreCreation);
        continue;
      }
    ...
    return new Object[] {
      retailStoreCreationCreateList,
      retailStoreCreationUpdateList,
      retailStoreCreationRemoveList,
      retailStoreCreationRecoverList
    };
  }
  ...
  protected Object[] getSaveRetailStoreCreationParameters(RetailStoreCreation retailStoreCreation) {
    if (retailStoreCreation.isToRemove()) {
      return prepareRetailStoreCreationRemoveParameters(retailStoreCreation);
    }
    if (retailStoreCreation.isToRecover()) {
      return prepareRecoverParameters(retailStoreCreation);
    }
  ...
  protected Object[] prepareRetailStoreCreationRemoveParameters(
      RetailStoreCreation retailStoreCreation) {
    return super.prepareRemoveParameters(retailStoreCreation);
  }

  protected Object[] prepareRetailStoreCreationUpdateParameters(
      RetailStoreCreation retailStoreCreation) {
  ...
  protected Object[] prepareRetailStoreCreationCreateParameters(
      RetailStoreCreation retailStoreCreation) {
  ...
  protected RetailStoreCreation saveInternalRetailStoreCreation(
      RetailStoreCreation retailStoreCreation, Map<String, Object> options) {
  ...
  public RetailStoreCreation planToRemoveRetailStoreList(
      RetailStoreCreation retailStoreCreation, String retailStoreIds[], Map<String, Object> options)
      throws Exception {
  ...
  public RetailStoreCreation planToRemoveRetailStoreListWithRetailStoreCountryCenter(
      RetailStoreCreation retailStoreCreation,
  ...
  public int countRetailStoreListWithRetailStoreCountryCenter(
      String retailStoreCreationId, String retailStoreCountryCenterId, Map<String, Object> options)
      throws Exception {
    // SmartList<ThreadLike> toRemoveThreadLikeList = threadLikeList.getToRemoveList();
    // the list will not be null here, empty, maybe
    // getThreadLikeDAO().removeThreadLikeList(toRemoveThreadLikeList,options);
  ...
  public RetailStoreCreation planToRemoveRetailStoreListWithCityServiceCenter(
      RetailStoreCreation retailStoreCreation,
  ...
  public int countRetailStoreListWithCityServiceCenter(
      String retailStoreCreationId, String cityServiceCenterId, Map<String, Object> options)
      throws Exception {
    // SmartList<ThreadLike> toRemoveThreadLikeList = threadLikeList.getToRemoveList();
    // the list will not be null here, empty, maybe
    // getThreadLikeDAO().removeThreadLikeList(toRemoveThreadLikeList,options);
  ...
  public RetailStoreCreation planToRemoveRetailStoreListWithInvestmentInvitation(
      RetailStoreCreation retailStoreCreation,
  ...
  public int countRetailStoreListWithInvestmentInvitation(
      String retailStoreCreationId, String investmentInvitationId, Map<String, Object> options)
      throws Exception {
    // SmartList<ThreadLike> toRemoveThreadLikeList = threadLikeList.getToRemoveList();
    // the list will not be null here, empty, maybe
    // getThreadLikeDAO().removeThreadLikeList(toRemoveThreadLikeList,options);
  ...
  public RetailStoreCreation planToRemoveRetailStoreListWithFranchising(
      RetailStoreCreation retailStoreCreation, String franchisingId, Map<String, Object> options)
      throws Exception {
    // SmartList<ThreadLike> toRemoveThreadLikeList = threadLikeList.getToRemoveList();
    // the list will not be null here, empty, maybe
    // getThreadLikeDAO().removeThreadLikeList(toRemoveThreadLikeList,options);
  ...
  public int countRetailStoreListWithFranchising(
      String retailStoreCreationId, String franchisingId, Map<String, Object> options)
      throws Exception {
    // SmartList<ThreadLike> toRemoveThreadLikeList = threadLikeList.getToRemoveList();
    // the list will not be null here, empty, maybe
    // getThreadLikeDAO().removeThreadLikeList(toRemoveThreadLikeList,options);
  ...
  public RetailStoreCreation planToRemoveRetailStoreListWithDecoration(
      RetailStoreCreation retailStoreCreation, String decorationId, Map<String, Object> options)
      throws Exception {
    // SmartList<ThreadLike> toRemoveThreadLikeList = threadLikeList.getToRemoveList();
    // the list will not be null here, empty, maybe
    // getThreadLikeDAO().removeThreadLikeList(toRemoveThreadLikeList,options);
  ...
  public int countRetailStoreListWithDecoration(
      String retailStoreCreationId, String decorationId, Map<String, Object> options)
      throws Exception {
    // SmartList<ThreadLike> toRemoveThreadLikeList = threadLikeList.getToRemoveList();
    // the list will not be null here, empty, maybe
    // getThreadLikeDAO().removeThreadLikeList(toRemoveThreadLikeList,options);
  ...
  public RetailStoreCreation planToRemoveRetailStoreListWithOpening(
      RetailStoreCreation retailStoreCreation, String openingId, Map<String, Object> options)
      throws Exception {
    // SmartList<ThreadLike> toRemoveThreadLikeList = threadLikeList.getToRemoveList();
    // the list will not be null here, empty, maybe
    // getThreadLikeDAO().removeThreadLikeList(toRemoveThreadLikeList,options);
  ...
  public int countRetailStoreListWithOpening(
      String retailStoreCreationId, String openingId, Map<String, Object> options)
      throws Exception {
    // SmartList<ThreadLike> toRemoveThreadLikeList = threadLikeList.getToRemoveList();
    // the list will not be null here, empty, maybe
    // getThreadLikeDAO().removeThreadLikeList(toRemoveThreadLikeList,options);
  ...
  public RetailStoreCreation planToRemoveRetailStoreListWithClosing(
      RetailStoreCreation retailStoreCreation, String closingId, Map<String, Object> options)
      throws Exception {
    // SmartList<ThreadLike> toRemoveThreadLikeList = threadLikeList.getToRemoveList();
    // the list will not be null here, empty, maybe
    // getThreadLikeDAO().removeThreadLikeList(toRemoveThreadLikeList,options);
  ...
  public int countRetailStoreListWithClosing(
      String retailStoreCreationId, String closingId, Map<String, Object> options)
      throws Exception {
    // SmartList<ThreadLike> toRemoveThreadLikeList = threadLikeList.getToRemoveList();
    // the list will not be null here, empty, maybe
    // getThreadLikeDAO().removeThreadLikeList(toRemoveThreadLikeList,options);
  ...
  protected RetailStoreCreation saveRetailStoreList(
      RetailStoreCreation retailStoreCreation, Map<String, Object> options) {
  ...
  protected RetailStoreCreation removeRetailStoreList(
      RetailStoreCreation retailStoreCreation, Map<String, Object> options) {
  ...
  public RetailStoreCreation present(
      RetailStoreCreation retailStoreCreation, Map<String, Object> options) {
  ...
  public SmartList<RetailStoreCreation> requestCandidateRetailStoreCreationForRetailStore(
    ...
    return findAllCandidateByFilter(
        RetailStoreCreationTable.COLUMN_COMMENT,
        null,
        filterKey,
        pageNo,
        pageSize,
        getRetailStoreCreationMapper());
  }
  ...
  public void collectAndEnhance(BaseEntity ownerEntity) {
    List<RetailStoreCreation> retailStoreCreationList =
        ownerEntity.collectRefsWithType(RetailStoreCreation.INTERNAL_TYPE);
    this.enhanceList(retailStoreCreationList);
  }

  @Override
  public SmartList<RetailStoreCreation> findRetailStoreCreationWithKey(
  ...
  public Map<String, Integer> countRetailStoreCreationWithGroupKey(
  ...
  @Override
  public CandidateRetailStoreCreation executeCandidatesQuery(
  ...
  @Override
  protected RetailStoreCreationMapper mapperForClazz(Class<?> clazz) {
    return RetailStoreCreationMapper.mapperForClass(clazz);
  }
}
