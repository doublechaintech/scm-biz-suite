...
public class RetailStoreCreationJDBCTemplateDAO extends RetailscmNamingServiceDAO implements RetailStoreCreationDAO{
	...
	*/
    ...
    public SmartList<RetailStoreCreation> requestCandidateRetailStoreCreationForRetailStore(RetailscmUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
		...
		return findAllCandidateByFilter(RetailStoreCreationTable.COLUMN_COMMENT, filterKey, pageNo, pageSize, getRetailStoreCreationMapper());
    }
