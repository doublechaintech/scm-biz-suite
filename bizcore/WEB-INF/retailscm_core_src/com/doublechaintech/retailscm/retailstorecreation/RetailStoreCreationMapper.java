...
public class RetailStoreCreationMapper extends BaseRowMapper<RetailStoreCreation> {
  ...
  public static RetailStoreCreationMapper mapperForClass(Class<?> clazz) {

    RetailStoreCreationMapper mapperForOverride = new RetailStoreCreationMapper();
  ...
  protected void setId(RetailStoreCreation retailStoreCreation, ResultSet rs, int rowNumber)
      throws SQLException {
    try {
  ...
  protected void setComment(RetailStoreCreation retailStoreCreation, ResultSet rs, int rowNumber)
      throws SQLException {
    try {
      // there will be issue when the type is double/int/long
  ...
  protected void setVersion(RetailStoreCreation retailStoreCreation, ResultSet rs, int rowNumber)
      throws SQLException {
    try {
      // there will be issue when the type is double/int/long
