...
public interface RetailStoreCreationManager extends BaseManager {
  ...
  List<RetailStoreCreation> searchRetailStoreCreationList(
      RetailscmUserContext ctx, RetailStoreCreationRequest pRequest);

  RetailStoreCreation searchRetailStoreCreation(
      RetailscmUserContext ctx, RetailStoreCreationRequest pRequest);
  ...
  // retailStoreCreationId, String name, String telephone, String owner, String
  // retailStoreCountryCenterId, String cityServiceCenterId, String investmentInvitationId, String
