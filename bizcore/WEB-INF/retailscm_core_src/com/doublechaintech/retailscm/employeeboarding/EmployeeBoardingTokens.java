...
public class EmployeeBoardingTokens extends CommonTokens{
	...
	public  static  EmployeeBoardingTokens of(Map<String,Object> options){
		//ensure not initialized outside the class
		EmployeeBoardingTokens tokens = new EmployeeBoardingTokens(options);
		return tokens;
		
	}
	protected EmployeeBoardingTokens(Map<String,Object> options){
	...
	public EmployeeBoardingTokens analyzeAllLists(){		
	...
	public EmployeeBoardingTokens analyzeEmployeeList(){		
