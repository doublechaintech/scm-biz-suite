...
public class LevelOneCategoryTable{
	...
	public static final String []NORMAL_CLOUMNS = {COLUMN_CATALOG,COLUMN_NAME};
	  ...
	  public static void ensureTable(RetailscmUserContext userContext, Map<String, Object> result) throws Exception {
        RetailscmBaseUtils.ensureTable(userContext, result, "level_one_category_data", new String[][]{
                new String[]{"id","varchar(48)"," not null","ID","",""},
                new String[]{"catalog","varchar(48)","","目录","catalog_data","id"},
                ...
                "alter table level_one_category_data add constraint fk4catalog_of_level_one_category_data foreign key (catalog) references catalog_data(id) ON DELETE CASCADE ON UPDATE CASCADE;",
                ""
         });
  }
