...
public class EmployeeLeaveTokens extends CommonTokens{
  ...
  public static EmployeeLeaveTokens loadGroupTokens(String... groupNames){
    ...
    addToken(tokens, WHO, groupNames, new String[]{"default"});addToken(tokens, TYPE, groupNames, new String[]{"default"});

  
    return tokens;
  }

  private static void addToken(EmployeeLeaveTokens pTokens, String pTokenName, String[] pGroupNames, String[] fieldGroups) {
