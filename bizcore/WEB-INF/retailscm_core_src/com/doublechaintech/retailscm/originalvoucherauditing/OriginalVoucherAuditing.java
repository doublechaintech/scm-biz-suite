...
@JsonSerialize(using = OriginalVoucherAuditingSerializer.class)
public class OriginalVoucherAuditing extends BaseEntity implements  java.io.Serializable{
	...
	public static final String INTERNAL_TYPE="OriginalVoucherAuditing";
	...
	public 	OriginalVoucherAuditing(String who, String comments, Date makeDate)
	{
		setWho(who);
	...
	public OriginalVoucherAuditing updateId(String id){
		this.mId = trimString(id);;
		this.changed = true;
		return this;
	}
	...
	public OriginalVoucherAuditing updateWho(String who){
		this.mWho = trimString(who);;
		this.changed = true;
		return this;
	}
	...
	public OriginalVoucherAuditing updateComments(String comments){
		this.mComments = trimString(comments);;
		this.changed = true;
		return this;
	}
	...
	public OriginalVoucherAuditing updateMakeDate(Date makeDate){
		this.mMakeDate = makeDate;;
		this.changed = true;
		return this;
	}
	...
	public OriginalVoucherAuditing updateVersion(int version){
		this.mVersion = version;;
		this.changed = true;
		return this;
	}
	...
	public  void setOriginalVoucherList(SmartList<OriginalVoucher> originalVoucherList){
		for( OriginalVoucher originalVoucher:originalVoucherList){
			originalVoucher.setAuditing(this);
		}
	...
	public  OriginalVoucher removeOriginalVoucher(OriginalVoucher originalVoucherIndex){
        ...
        // originalVoucher.clearAuditing(); //disconnect with Auditing
        originalVoucher.clearFromAll(); //disconnect with Auditing
	...
	public  void breakWithOriginalVoucher(OriginalVoucher originalVoucher){
		...
		originalVoucher.setAuditing(null);
	...
	public BaseEntity copyTo(BaseEntity baseDest){
		...
		if(baseDest instanceof OriginalVoucherAuditing){
		
		
			OriginalVoucherAuditing dest =(OriginalVoucherAuditing)baseDest;
	...
	public String toString(){
		...
		stringBuilder.append("OriginalVoucherAuditing{");
