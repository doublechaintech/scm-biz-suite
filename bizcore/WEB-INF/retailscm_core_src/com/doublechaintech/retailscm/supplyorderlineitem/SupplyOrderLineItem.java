...
public class SupplyOrderLineItem extends BaseEntity implements java.io.Serializable {
  ...
  public void transferAllRelationshipsTo(SupplyOrderLineItem target) {
    if (target == null) {
      return;
    }
  }
  ...
  public SupplyOrderLineItem updateId(String id) {
    String oldId = this.id;
    String newId = trimString(id);
  ...
  public SupplyOrderLineItem ignoreIdCriteria() {
  ...
  public SupplyOrderLineItem updateBizOrder(SupplyOrder bizOrder) {
    SupplyOrder oldBizOrder = this.bizOrder;
    SupplyOrder newBizOrder = bizOrder;
  ...
  public SupplyOrderLineItem ignoreBizOrderCriteria() {
  ...
  public SupplyOrderLineItem updateBizOrderByReferenceId(String bizOrderId) {
  ...
  public SupplyOrderLineItem updateSkuId(String skuId) {
    String oldSkuId = this.skuId;
    String newSkuId = trimString(skuId);
  ...
  public SupplyOrderLineItem ignoreSkuIdCriteria() {
  ...
  public SupplyOrderLineItem updateSkuName(String skuName) {
    String oldSkuName = this.skuName;
    String newSkuName = trimString(skuName);
  ...
  public SupplyOrderLineItem ignoreSkuNameCriteria() {
  ...
  public SupplyOrderLineItem updateAmount(BigDecimal amount) {
    BigDecimal oldAmount = this.amount;
    BigDecimal newAmount = amount;
  ...
  public SupplyOrderLineItem ignoreAmountCriteria() {
  ...
  public SupplyOrderLineItem updateQuantity(int quantity) {
    int oldQuantity = this.quantity;
    int newQuantity = quantity;
  ...
  public SupplyOrderLineItem ignoreQuantityCriteria() {
  ...
  public SupplyOrderLineItem updateUnitOfMeasurement(String unitOfMeasurement) {
    String oldUnitOfMeasurement = this.unitOfMeasurement;
    String newUnitOfMeasurement = trimString(unitOfMeasurement);
  ...
  public SupplyOrderLineItem ignoreUnitOfMeasurementCriteria() {
    super.ignoreSearchProperty(UNIT_OF_MEASUREMENT_PROPERTY);
    return this;
  }

  public SupplyOrderLineItem addUnitOfMeasurementCriteria(
      QueryOperator operator, Object... parameters) {
  ...
  public SupplyOrderLineItem updateVersion(int version) {
    int oldVersion = this.version;
    int newVersion = version;
  ...
  public SupplyOrderLineItem ignoreVersionCriteria() {
  ...
  public BaseEntity mergeDataFrom(BaseEntity sourceEntity) {
    ...
    if (sourceEntity instanceof SupplyOrderLineItem) {

      SupplyOrderLineItem source = (SupplyOrderLineItem) sourceEntity;
  ...
  public boolean checkIfEligibleForDelete(Object ctx) {
    ...
    SupplyOrderLineItem checkSupplyOrderLineItem =
        Q.supplyOrderLineItemWithIdField().filterById(id).execute(ctx);

    return checkSupplyOrderLineItem != null
        && !checkSupplyOrderLineItem.getAllRelatedLists().stream()
            .flatMap(subList -> subList.stream())
            .findFirst()
            .isPresent();
  }

  public SupplyOrderLineItem save(com.doublechaintech.retailscm.RetailscmUserContext ctx) {
    try {
