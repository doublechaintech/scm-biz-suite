...
public interface SupplyOrderLineItemManager extends BaseManager{
  ...
  List<SupplyOrderLineItem> searchSupplyOrderLineItemList(RetailscmUserContext ctx, SupplyOrderLineItemRequest pRequest);
  SupplyOrderLineItem searchSupplyOrderLineItem(RetailscmUserContext ctx, SupplyOrderLineItemRequest pRequest);
	...
	public default void onUpdated(RetailscmUserContext userContext, SupplyOrderLineItem updated, Object actor, String methodName) throws Exception {};
