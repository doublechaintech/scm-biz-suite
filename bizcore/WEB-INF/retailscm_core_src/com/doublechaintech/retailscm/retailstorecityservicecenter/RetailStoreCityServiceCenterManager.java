...
public interface RetailStoreCityServiceCenterManager extends BaseManager{
  ...
  List<RetailStoreCityServiceCenter> searchRetailStoreCityServiceCenterList(RetailscmUserContext ctx, RetailStoreCityServiceCenterRequest pRequest);
  RetailStoreCityServiceCenter searchRetailStoreCityServiceCenter(RetailscmUserContext ctx, RetailStoreCityServiceCenterRequest pRequest);
	...
	public default void onUpdated(RetailscmUserContext userContext, RetailStoreCityServiceCenter updated, Object actor, String methodName) throws Exception {};
