...
public class RetailStoreCityServiceCenterTable{
	...
	public static final String []NORMAL_CLOUMNS = {COLUMN_NAME,COLUMN_FOUNDED,COLUMN_BELONGS_TO,COLUMN_LAST_UPDATE_TIME};
	  ...
	  public static void ensureTable(RetailscmUserContext userContext, Map<String, Object> result) throws Exception {
        RetailscmBaseUtils.ensureTable(userContext, result, "retail_store_city_service_center_data", new String[][]{
                new String[]{"id","varchar(48)"," not null","ID","",""},
                new String[]{"name","varchar(36)","","名称","",""},
                new String[]{"founded","date","","成立","",""},
                new String[]{"belongs_to","varchar(48)","","属于","retail_store_province_center_data","id"},
                new String[]{"last_update_time","datetime","","更新于","",""},
                new String[]{"version","int","","版本","",""}
            }, "双链小超城市服务中心", new String[]{
