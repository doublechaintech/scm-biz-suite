...
public class GoodsAllocationManagerImpl extends CustomRetailscmCheckerManager
    implements GoodsAllocationManager, BusinessHandler {
  ...
  public BlobObject exportExcelFromList(
    ...
    Map<String, Object> tokens =
        GoodsAllocationTokens.start().withTokenFromListName(listName).done();
    GoodsAllocation goodsAllocation =
        (GoodsAllocation) this.loadGoodsAllocation(userContext, id, tokens);
    // to enrich reference object to let it show display name
    List<BaseEntity> entityListToNaming = goodsAllocation.collectReferencesFromLists();
  ...
  protected GoodsAllocation saveGoodsAllocation(
      RetailscmUserContext userContext, GoodsAllocation goodsAllocation, String[] tokensExpr)
      throws Exception {
  ...
  protected GoodsAllocation saveGoodsAllocationDetail(
      RetailscmUserContext userContext, GoodsAllocation goodsAllocation) throws Exception {

    return saveGoodsAllocation(userContext, goodsAllocation, allTokens());
  }

  public GoodsAllocation loadGoodsAllocation(
      RetailscmUserContext userContext, String goodsAllocationId, String[] tokensExpr)
      throws Exception {
  ...
  public GoodsAllocation searchGoodsAllocation(
  ...
  protected GoodsAllocation present(
      RetailscmUserContext userContext, GoodsAllocation goodsAllocation, Map<String, Object> tokens)
      throws Exception {

    addActions(userContext, goodsAllocation, tokens);

    GoodsAllocation goodsAllocationToPresent =
        goodsAllocationDaoOf(userContext).present(goodsAllocation, tokens);

    List<BaseEntity> entityListToNaming = goodsAllocationToPresent.collectReferencesFromLists();
    goodsAllocationDaoOf(userContext).alias(entityListToNaming);
  ...
  public GoodsAllocation loadGoodsAllocationDetail(
      RetailscmUserContext userContext, String goodsAllocationId) throws Exception {
    GoodsAllocation goodsAllocation =
        loadGoodsAllocation(userContext, goodsAllocationId, allTokens());
  ...
  public Object view(RetailscmUserContext userContext, String goodsAllocationId) throws Exception {
    GoodsAllocation goodsAllocation =
        loadGoodsAllocation(userContext, goodsAllocationId, viewTokens());
    markVisited(userContext, goodsAllocation);
    return present(userContext, goodsAllocation, viewTokens());
  }

  public Object summaryView(RetailscmUserContext userContext, String goodsAllocationId)
      throws Exception {
    GoodsAllocation goodsAllocation =
        loadGoodsAllocation(userContext, goodsAllocationId, viewTokens());
  ...
  public Object analyze(RetailscmUserContext userContext, String goodsAllocationId)
      throws Exception {
    GoodsAllocation goodsAllocation =
        loadGoodsAllocation(userContext, goodsAllocationId, analyzeTokens());
    markVisited(userContext, goodsAllocation);
  ...
  protected GoodsAllocation loadGoodsAllocation(
      RetailscmUserContext userContext, String goodsAllocationId, Map<String, Object> tokens)
      throws Exception {
    checkerOf(userContext).checkIdOfGoodsAllocation(goodsAllocationId);
  ...
  protected <T extends BaseEntity> void addActions(
    ...
    // userContext, GoodsAllocation goodsAllocation, Map<String, Object> tokens){

  @Override
  public List<GoodsAllocation> searchGoodsAllocationList(
      RetailscmUserContext ctx, GoodsAllocationRequest pRequest) {
  ...
  public GoodsAllocation createGoodsAllocation(
      RetailscmUserContext userContext,
      String location,
      BigDecimal latitude,
  ...
  public GoodsAllocation clone(RetailscmUserContext userContext, String fromGoodsAllocationId)
      throws Exception {

    return goodsAllocationDaoOf(userContext).clone(fromGoodsAllocationId, this.allTokens());
  }

  public GoodsAllocation internalSaveGoodsAllocation(
      RetailscmUserContext userContext, GoodsAllocation goodsAllocation) throws Exception {
  ...
  public GoodsAllocation internalSaveGoodsAllocation(
      ...
      throws Exception {
    // checkParamsForUpdatingGoodsAllocation(userContext, goodsAllocationId, goodsAllocationVersion,
  ...
  public GoodsAllocation updateGoodsAllocation(
      RetailscmUserContext userContext,
      String goodsAllocationId,
      int goodsAllocationVersion,
      String property,
    ...
    checkParamsForUpdatingGoodsAllocation(
        userContext, goodsAllocationId, goodsAllocationVersion, property, newValueExpr, tokensExpr);
  ...
  public GoodsAllocation updateGoodsAllocationProperty(
      RetailscmUserContext userContext,
      String goodsAllocationId,
      int goodsAllocationVersion,
      String property,
  ...
  protected void checkParamsForTransferingAnotherGoodsShelf(
      RetailscmUserContext userContext, String goodsAllocationId, String anotherGoodsShelfId)
      throws Exception {
  ...
  public GoodsAllocation transferToAnotherGoodsShelf(
      RetailscmUserContext userContext, String goodsAllocationId, String anotherGoodsShelfId)
      throws Exception {
  ...
  public CandidateGoodsShelf requestCandidateGoodsShelf(
    ...
    SmartList<GoodsShelf> candidateList =
        goodsShelfDaoOf(userContext)
            .requestCandidateGoodsShelfForGoodsAllocation(
  ...
  protected GoodsShelf loadGoodsShelf(
      RetailscmUserContext userContext, String newGoodsShelfId, Map<String, Object> options)
      throws Exception {
  ...
  public GoodsAllocation forgetByAll(
      RetailscmUserContext userContext, String goodsAllocationId, int goodsAllocationVersion)
      throws Exception {
    return forgetByAllInternal(userContext, goodsAllocationId, goodsAllocationVersion);
  }

  protected GoodsAllocation forgetByAllInternal(
      RetailscmUserContext userContext, String goodsAllocationId, int goodsAllocationVersion)
      throws Exception {

    return goodsAllocationDaoOf(userContext)
        .disconnectFromAll(goodsAllocationId, goodsAllocationVersion);
  }
  ...
  public GoodsAllocation addGoods(
      RetailscmUserContext userContext,
      String goodsAllocationId,
      String name,
      String rfid,
    ...
    synchronized (goodsAllocation) {
      ...
      goodsAllocation =
          saveGoodsAllocation(userContext, goodsAllocation, tokens().withGoodsList().done());
  ...
  public GoodsAllocation updateGoodsProperties(
      RetailscmUserContext userContext,
      String goodsAllocationId,
      String id,
      String name,
    ...
    checkParamsForUpdatingGoodsProperties(
        userContext, goodsAllocationId, id, name, rfid, uom, maxPackage, expireTime, tokensExpr);
    ...
    GoodsAllocation goodsAllocationToUpdate =
        loadGoodsAllocation(userContext, goodsAllocationId, options);
    ...
    GoodsAllocation goodsAllocation =
        saveGoodsAllocation(userContext, goodsAllocationToUpdate, tokens().withGoodsList().done());
    synchronized (goodsAllocation) {
      return present(userContext, goodsAllocation, mergedAllTokens(tokensExpr));
    }
  }
  ...
  public GoodsAllocation removeGoodsList(
      RetailscmUserContext userContext,
      String goodsAllocationId,
      String goodsIds[],
      String[] tokensExpr)
    ...
    synchronized (goodsAllocation) {
      ...
      goodsAllocationDaoOf(userContext)
          .planToRemoveGoodsList(goodsAllocation, goodsIds, allTokens());
      goodsAllocation =
          saveGoodsAllocation(userContext, goodsAllocation, tokens().withGoodsList().done());
  ...
  public GoodsAllocation removeGoods(
      RetailscmUserContext userContext,
      String goodsAllocationId,
      String goodsId,
      int goodsVersion,
  ...
  public GoodsAllocation copyGoodsFrom(
      RetailscmUserContext userContext,
      String goodsAllocationId,
      String goodsId,
      int goodsVersion,
    ...
    synchronized (goodsAllocation) {
      ...
      goodsManagerOf(userContext)
          .onNewInstanceCreated(
              userContext,
              (Goods) goodsAllocation.getFlexiableObjects().get(BaseEntity.COPIED_CHILD));
      return present(userContext, goodsAllocation, mergedAllTokens(tokensExpr));
    }
  }
  ...
  public GoodsAllocation updateGoods(
      RetailscmUserContext userContext,
      String goodsAllocationId,
      String goodsId,
      int goodsVersion,
    ...
    checkParamsForUpdatingGoods(
        userContext, goodsAllocationId, goodsId, goodsVersion, property, newValueExpr, tokensExpr);
    ...
    GoodsAllocation goodsAllocation =
        loadGoodsAllocation(userContext, goodsAllocationId, loadTokens);
  ...
  */
  ...
  public void onNewInstanceCreated(RetailscmUserContext userContext, GoodsAllocation newCreated)
      throws Exception {
  ...
  public void sendAllItems(RetailscmUserContext ctx) throws Exception {
    goodsAllocationDaoOf(ctx).loadAllAsStream().forEach(event -> sendInitEvent(ctx, event));
  }
  ...
  protected void enhanceForListOfView(
      RetailscmUserContext userContext, SmartList<GoodsAllocation> list) throws Exception {
    if (list == null || list.isEmpty()) {
      return;
    }
    List<GoodsShelf> goodsShelfList =
  ...
  public Object listByGoodsShelf(RetailscmUserContext userContext, String goodsShelfId)
      throws Exception {
    return listPageByGoodsShelf(userContext, goodsShelfId, 0, 20);
  }

  @SuppressWarnings({"unchecked", "rawtypes"})
  public Object listPageByGoodsShelf(
      RetailscmUserContext userContext, String goodsShelfId, int start, int count)
      throws Exception {
    SmartList<GoodsAllocation> list =
        goodsAllocationDaoOf(userContext)
            .findGoodsAllocationByGoodsShelf(goodsShelfId, start, count, new HashMap<>());
    ...
    page.setLinkToUrl(
        TextUtil.encodeUrl(String.format("%s/listByGoodsShelf/%s/", getBeanName(), goodsShelfId)));
   ...
   * @throws Exception
   */
  public Object wxappview(RetailscmUserContext userContext, String goodsAllocationId)
      throws Exception {
