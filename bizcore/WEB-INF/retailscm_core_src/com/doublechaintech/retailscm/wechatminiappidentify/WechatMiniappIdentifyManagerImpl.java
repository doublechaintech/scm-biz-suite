...
public class WechatMiniappIdentifyManagerImpl extends CustomRetailscmCheckerManager implements WechatMiniappIdentifyManager, BusinessHandler{
	...
	@Override
	public WechatMiniappIdentifyDAO daoOf(RetailscmUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws WechatMiniappIdentifyManagerException{
 	...
 	protected WechatMiniappIdentify saveWechatMiniappIdentify(RetailscmUserContext userContext, WechatMiniappIdentify wechatMiniappIdentify, String [] tokensExpr) throws Exception{	
 	...
 	protected WechatMiniappIdentify saveWechatMiniappIdentifyDetail(RetailscmUserContext userContext, WechatMiniappIdentify wechatMiniappIdentify) throws Exception{	
 	...
 	public WechatMiniappIdentify loadWechatMiniappIdentify(RetailscmUserContext userContext, String wechatMiniappIdentifyId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public WechatMiniappIdentify searchWechatMiniappIdentify(RetailscmUserContext userContext, String wechatMiniappIdentifyId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected WechatMiniappIdentify present(RetailscmUserContext userContext, WechatMiniappIdentify wechatMiniappIdentify, Map<String, Object> tokens) throws Exception {
 	...
 	public WechatMiniappIdentify loadWechatMiniappIdentifyDetail(RetailscmUserContext userContext, String wechatMiniappIdentifyId) throws Exception{	
 	...
 	public Object view(RetailscmUserContext userContext, String wechatMiniappIdentifyId) throws Exception{	
 		WechatMiniappIdentify wechatMiniappIdentify = loadWechatMiniappIdentify( userContext, wechatMiniappIdentifyId, viewTokens());
 		return present(userContext,wechatMiniappIdentify, allTokens());
		
 	}
 	protected WechatMiniappIdentify saveWechatMiniappIdentify(RetailscmUserContext userContext, WechatMiniappIdentify wechatMiniappIdentify, Map<String,Object>tokens) throws Exception{	
 		return wechatMiniappIdentifyDaoOf(userContext).save(wechatMiniappIdentify, tokens);
 	}
 	protected WechatMiniappIdentify loadWechatMiniappIdentify(RetailscmUserContext userContext, String wechatMiniappIdentifyId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfWechatMiniappIdentify(wechatMiniappIdentifyId);
		checkerOf(userContext).throwExceptionIfHasErrors( WechatMiniappIdentifyManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(RetailscmUserContext userContext, WechatMiniappIdentify wechatMiniappIdentify, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(RetailscmUserContext userContext, WechatMiniappIdentify wechatMiniappIdentify, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingWechatMiniappIdentify(RetailscmUserContext userContext,String wechatMiniappIdentifyId, int wechatMiniappIdentifyVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public WechatMiniappIdentify clone(RetailscmUserContext userContext, String fromWechatMiniappIdentifyId) throws Exception{
	...
	public WechatMiniappIdentify internalSaveWechatMiniappIdentify(RetailscmUserContext userContext, WechatMiniappIdentify wechatMiniappIdentify, Map<String,Object> options) throws Exception
	{
	...
	public WechatMiniappIdentify updateWechatMiniappIdentifyProperty(RetailscmUserContext userContext,String wechatMiniappIdentifyId, int wechatMiniappIdentifyVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingWechatMiniappIdentify(userContext, wechatMiniappIdentifyId, wechatMiniappIdentifyVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherSecUser(RetailscmUserContext userContext, String wechatMiniappIdentifyId, String anotherSecUserId) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithLogin(RetailscmUserContext userContext, String wechatMiniappIdentifyId, String anotherLogin) throws Exception
 	{
 	...
 	public WechatMiniappIdentify transferToAnotherSecUserWithLogin(RetailscmUserContext userContext, String wechatMiniappIdentifyId, String anotherLogin) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithEmail(RetailscmUserContext userContext, String wechatMiniappIdentifyId, String anotherEmail) throws Exception
 	{
 	...
 	public WechatMiniappIdentify transferToAnotherSecUserWithEmail(RetailscmUserContext userContext, String wechatMiniappIdentifyId, String anotherEmail) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithMobile(RetailscmUserContext userContext, String wechatMiniappIdentifyId, String anotherMobile) throws Exception
 	{
 	...
 	public WechatMiniappIdentify transferToAnotherSecUserWithMobile(RetailscmUserContext userContext, String wechatMiniappIdentifyId, String anotherMobile) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(RetailscmUserContext userContext, String wechatMiniappIdentifyId, int wechatMiniappIdentifyVersion) throws Exception {
	...
	public WechatMiniappIdentify forgetByAll(RetailscmUserContext userContext, String wechatMiniappIdentifyId, int wechatMiniappIdentifyVersion) throws Exception {
		return forgetByAllInternal(userContext, wechatMiniappIdentifyId, wechatMiniappIdentifyVersion);
	}
	protected WechatMiniappIdentify forgetByAllInternal(RetailscmUserContext userContext,
			String wechatMiniappIdentifyId, int wechatMiniappIdentifyVersion) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(RetailscmUserContext userContext,SmartList<WechatMiniappIdentify> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(RetailscmUserContext userContext, String wechatMiniappIdentifyId) throws Exception{
	  SerializeScope vscope = RetailscmViewScope.getInstance().getWechatMiniappIdentifyDetailScope().clone();
