...
public interface MobileAppManager extends BaseManager {
  ...
  public MobileApp internalSaveMobileApp(
      RetailscmUserContext userContext, MobileApp mobileApp, Map<String, Object> option)
      throws Exception;
  ...
  public default void onUpdated(
      RetailscmUserContext userContext, MobileApp updated, Object actor, String methodName)
      throws Exception {};

  /*======================================================DATA MAINTENANCE===========================================================*/

  // public  PageManager getPageManager(RetailscmUserContext userContext, String mobileAppId, String
  ...
  */
  ...
  // public  PageTypeManager getPageTypeManager(RetailscmUserContext userContext, String
  // mobileAppId, String name, String code, boolean footerTab ,String [] tokensExpr)  throws
  // Exception;
