...
public class LevelTwoDepartmentTable{
	...
	public static final String TABLE_NAME="level_two_department_data";
	...
	public static final String []NORMAL_CLOUMNS = {COLUMN_BELONGS_TO,COLUMN_NAME,COLUMN_DESCRIPTION,COLUMN_FOUNDED};
	  ...
	  public static void ensureTable(RetailscmUserContext userContext, Map<String, Object> result) throws Exception {
        RetailscmBaseUtils.ensureTable(userContext, result, "level_two_department_data", new String[][]{
                new String[]{"id","varchar(48)"," not null","ID","",""},
                new String[]{"belongs_to","varchar(48)","","属于","level_one_department_data","id"},
                ...
                "alter table level_two_department_data add constraint fk4belongs_to_of_level_two_department_data foreign key (belongs_to) references level_one_department_data(id) ON DELETE CASCADE ON UPDATE CASCADE;",
                ""
         });
  }
