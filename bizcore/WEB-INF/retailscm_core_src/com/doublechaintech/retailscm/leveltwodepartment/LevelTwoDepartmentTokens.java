...
public class LevelTwoDepartmentTokens extends CommonTokens{
  ...
  private static void addToken(LevelTwoDepartmentTokens pTokens, String pTokenName, String[] pGroupNames, String[] fieldGroups) {
	...
	public static LevelTwoDepartmentTokens filterWithTokenViewGroups(String []viewGroups){
		...
		return start()
			.withBelongsTo()
			.withLevelThreeDepartmentListIfViewGroupInclude(viewGroups);
	...
	public LevelTwoDepartmentTokens withLevelThreeDepartmentListIfViewGroupInclude(String [] viewGroups){
	...
	public LevelTwoDepartmentTokens sortLevelThreeDepartmentListWith(String field, String descOrAsc){
		addSortMoreOptions(LEVEL_THREE_DEPARTMENT_LIST,levelThreeDepartmentListSortCounter++, field, descOrAsc);
		return this;
	}
	private int levelThreeDepartmentListSearchCounter = 0;
	public LevelTwoDepartmentTokens searchLevelThreeDepartmentListWith(String field, String verb, String value){

		withLevelThreeDepartmentList();
		addSearchMoreOptions(LEVEL_THREE_DEPARTMENT_LIST,levelThreeDepartmentListSearchCounter++, field, verb, value);
		return this;
	}



	public LevelTwoDepartmentTokens searchAllTextOfLevelThreeDepartmentList(String verb, String value){
	...
	public LevelTwoDepartmentTokens currentPageNumberOfLevelThreeDepartmentList(int currentPageNumber){
