...
public class LevelOneDepartmentTokens extends CommonTokens{
  ...
  private static void addToken(LevelOneDepartmentTokens pTokens, String pTokenName, String[] pGroupNames, String[] fieldGroups) {
	...
	public static LevelOneDepartmentTokens filterWithTokenViewGroups(String []viewGroups){
		...
		return start()
			.withBelongsTo()
			.withLevelTwoDepartmentListIfViewGroupInclude(viewGroups);
	...
	public LevelOneDepartmentTokens withLevelTwoDepartmentListIfViewGroupInclude(String [] viewGroups){
