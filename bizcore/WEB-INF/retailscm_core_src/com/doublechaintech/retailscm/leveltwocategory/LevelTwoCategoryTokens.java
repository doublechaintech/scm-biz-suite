...
public class LevelTwoCategoryTokens extends CommonTokens {
  ...
  private static void addToken(
      LevelTwoCategoryTokens pTokens,
      String pTokenName,
      String[] pGroupNames,
      String[] fieldGroups) {
  ...
  public static LevelTwoCategoryTokens filterWithTokenViewGroups(String[] viewGroups) {
    ...
    return start().withParentCategory().withLevelThreeCategoryListIfViewGroupInclude(viewGroups);
  }

  public static LevelTwoCategoryTokens allTokens() {

    return start().withParentCategory().withLevelThreeCategoryList();
  }
  ...
  public LevelTwoCategoryTokens extractMoreFromLevelThreeCategoryList(
  ...
  public LevelTwoCategoryTokens sortLevelThreeCategoryListWith(String field, String descOrAsc) {
    addSortMoreOptions(
        LEVEL_THREE_CATEGORY_LIST, levelThreeCategoryListSortCounter++, field, descOrAsc);
    return this;
  }

  private int levelThreeCategoryListSearchCounter = 0;

  public LevelTwoCategoryTokens searchLevelThreeCategoryListWith(
      String field, String verb, String value) {

    withLevelThreeCategoryList();
    addSearchMoreOptions(
        LEVEL_THREE_CATEGORY_LIST, levelThreeCategoryListSearchCounter++, field, verb, value);
    return this;
  }
