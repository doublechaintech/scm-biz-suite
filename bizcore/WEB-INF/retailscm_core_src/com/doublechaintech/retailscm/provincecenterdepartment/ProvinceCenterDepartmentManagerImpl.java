...
import com.doublechaintech.retailscm.*;import com.doublechaintech.retailscm.BaseViewPage;import com.doublechaintech.retailscm.RetailscmUserContextImpl;import com.doublechaintech.retailscm.iamservice.*;import com.doublechaintech.retailscm.provincecenterdepartment.ProvinceCenterDepartment;import com.doublechaintech.retailscm.provincecenteremployee.ProvinceCenterEmployee;import com.doublechaintech.retailscm.retailstoreprovincecenter.CandidateRetailStoreProvinceCenter;import com.doublechaintech.retailscm.retailstoreprovincecenter.RetailStoreProvinceCenter;import com.doublechaintech.retailscm.secuser.SecUser;import com.doublechaintech.retailscm.services.IamService;import com.doublechaintech.retailscm.tree.*;import com.doublechaintech.retailscm.treenode.*;import com.doublechaintech.retailscm.userapp.UserApp;import com.doublechaintech.retailscm.utils.ModelAssurance;
...
public class ProvinceCenterDepartmentManagerImpl extends CustomRetailscmCheckerManager implements ProvinceCenterDepartmentManager, BusinessHandler{
	...
	public Object prepareContextForUserApp(BaseUserContext userContext,Object targetUserApp) throws Exception{
	 ...
	 public Object summaryView(RetailscmUserContext userContext, String provinceCenterDepartmentId) throws Exception{
		ProvinceCenterDepartment provinceCenterDepartment = loadProvinceCenterDepartment( userContext, provinceCenterDepartmentId, viewTokens());
	 ...
	 public Object analyze(RetailscmUserContext userContext, String provinceCenterDepartmentId) throws Exception{
		ProvinceCenterDepartment provinceCenterDepartment = loadProvinceCenterDepartment( userContext, provinceCenterDepartmentId, analyzeTokens());
		markVisited(userContext, provinceCenterDepartment);
  ...
  @Override
  public List<ProvinceCenterDepartment> searchProvinceCenterDepartmentList(RetailscmUserContext ctx, ProvinceCenterDepartmentRequest pRequest){
  ...
  @Override
  public ProvinceCenterDepartment searchProvinceCenterDepartment(RetailscmUserContext ctx, ProvinceCenterDepartmentRequest pRequest){
    pRequest.limit(0, 1);
 ...
 //--------------------------------------------------------------
	...
	public  ProvinceCenterDepartment updateProvinceCenterEmployeeProperties(RetailscmUserContext userContext, String provinceCenterDepartmentId, String id,String name,String mobile,String email,Date founded, String [] tokensExpr) throws Exception
	{
		...
		beforeUpdateProvinceCenterEmployeeProperties(userContext,item, provinceCenterDepartmentId,id,name,mobile,email,founded,tokensExpr);
	...
	protected  void beforeUpdateProvinceCenterEmployeeProperties(RetailscmUserContext userContext, ProvinceCenterEmployee item, String provinceCenterDepartmentId, String id,String name,String mobile,String email,Date founded, String [] tokensExpr)
						throws Exception {
	...
	public  ProvinceCenterDepartment copyProvinceCenterEmployeeFrom(RetailscmUserContext userContext, String provinceCenterDepartmentId,
		...
		synchronized(provinceCenterDepartment){
			...
			provinceCenterEmployeeManagerOf(userContext).onNewInstanceCreated(userContext, (ProvinceCenterEmployee)provinceCenterDepartment.getFlexiableObjects().get(BaseEntity.COPIED_CHILD));
			return present(userContext,provinceCenterDepartment, mergedAllTokens(tokensExpr));
		}
	...
	public  ProvinceCenterDepartment updateProvinceCenterEmployee(RetailscmUserContext userContext, String provinceCenterDepartmentId, String provinceCenterEmployeeId, int provinceCenterEmployeeVersion, String property, String newValueExpr,String [] tokensExpr)
		...
		synchronized(provinceCenterDepartment){
			...
			ProvinceCenterEmployee provinceCenterEmployee = provinceCenterDepartment.findTheProvinceCenterEmployee(provinceCenterEmployeeIdVersionKey);
			if(provinceCenterEmployee == null){
				throw new ProvinceCenterDepartmentManagerException(provinceCenterEmployeeId+" is NOT FOUND" );
			}

			beforeUpdateProvinceCenterEmployee(userContext, provinceCenterEmployee, provinceCenterDepartmentId, provinceCenterEmployeeId, provinceCenterEmployeeVersion, property, newValueExpr,  tokensExpr);
			provinceCenterEmployee.changeProperty(property, newValueExpr);
			
			provinceCenterDepartment = saveProvinceCenterDepartment(userContext, provinceCenterDepartment, tokens().withProvinceCenterEmployeeList().done());
			provinceCenterEmployeeManagerOf(userContext).onUpdated(userContext, provinceCenterEmployee, this, "updateProvinceCenterEmployee");
			return present(userContext,provinceCenterDepartment, mergedAllTokens(tokensExpr));
		}
	...
	protected void beforeUpdateProvinceCenterEmployee(RetailscmUserContext userContext, ProvinceCenterEmployee existed, String provinceCenterDepartmentId, String provinceCenterEmployeeId, int provinceCenterEmployeeVersion, String property, String newValueExpr,String [] tokensExpr)
  			throws Exception{
  }
	/*
  ...
  public void sendAllItems(RetailscmUserContext ctx) throws Exception{
    provinceCenterDepartmentDaoOf(ctx).loadAllAsStream().forEach(
