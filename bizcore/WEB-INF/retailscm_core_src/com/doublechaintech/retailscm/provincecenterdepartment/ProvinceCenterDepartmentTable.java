...
public class ProvinceCenterDepartmentTable {
  ...
  public static final String[] ALL_CLOUMNS = {
    COLUMN_ID, COLUMN_NAME, COLUMN_FOUNDED, COLUMN_PROVINCE_CENTER, COLUMN_MANAGER, COLUMN_VERSION
  };
  ...
  public static void ensureTable(RetailscmUserContext userContext, Map<String, Object> result)
    ...
    RetailscmBaseUtils.ensureTable(
        userContext,
        result,
        "province_center_department_data",
        new String[][] {
          new String[] {"id", "varchar(48)", " not null", "ID", "", ""},
          new String[] {"name", "varchar(20)", "", "名称", "", ""},
          new String[] {"founded", "date", "", "成立", "", ""},
          new String[] {
            "province_center", "varchar(48)", "", "省中心", "retail_store_province_center_data", "id"
          },
