...
public class ProvinceCenterDepartmentTokens extends CommonTokens {
  ...
  private static void addToken(
      ProvinceCenterDepartmentTokens pTokens,
      String pTokenName,
      String[] pGroupNames,
      String[] fieldGroups) {
  ...
  public static ProvinceCenterDepartmentTokens allTokens() {
    ...
    return start().withProvinceCenter().withProvinceCenterEmployeeList();
  }

  public static ProvinceCenterDepartmentTokens withoutListsTokens() {

    return start().withProvinceCenter();
  }
  ...
  public ProvinceCenterDepartmentTokens withProvinceCenterEmployeeListIfViewGroupInclude(
      String[] viewGroups) {
  ...
  public ProvinceCenterDepartmentTokens extractMoreFromProvinceCenterEmployeeList(
  ...
  public ProvinceCenterDepartmentTokens sortProvinceCenterEmployeeListWith(
  ...
  public ProvinceCenterDepartmentTokens searchProvinceCenterEmployeeListWith(
  ...
  public ProvinceCenterDepartmentTokens searchAllTextOfProvinceCenterEmployeeList(
  ...
  public ProvinceCenterDepartmentTokens currentPageNumberOfProvinceCenterEmployeeList(
      int currentPageNumber) {
    addSimpleOptions(PROVINCE_CENTER_EMPLOYEE_LIST + "CurrentPage", currentPageNumber);
    return this;
  }

  public ProvinceCenterDepartmentTokens retainColumnsOfProvinceCenterEmployeeList(
      String[] columns) {
    addSimpleOptions(PROVINCE_CENTER_EMPLOYEE_LIST + "RetainColumns", columns);
    return this;
  }

  public ProvinceCenterDepartmentTokens excludeColumnsOfProvinceCenterEmployeeList(
      String[] columns) {
