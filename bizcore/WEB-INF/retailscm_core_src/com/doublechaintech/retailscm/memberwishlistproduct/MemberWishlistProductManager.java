...
public interface MemberWishlistProductManager extends BaseManager{
  ...
  List<MemberWishlistProduct> searchMemberWishlistProductList(RetailscmUserContext ctx, MemberWishlistProductRequest pRequest);
  MemberWishlistProduct searchMemberWishlistProduct(RetailscmUserContext ctx, MemberWishlistProductRequest pRequest);
	...
	public default void onUpdated(RetailscmUserContext userContext, MemberWishlistProduct updated, Object actor, String methodName) throws Exception {};
