...
public class MemberWishlistProductManagerImpl extends CustomRetailscmCheckerManager
    implements MemberWishlistProductManager, BusinessHandler {
  ...
  protected void throwExceptionWithMessage(String value)
      throws MemberWishlistProductManagerException {
  ...
  protected MemberWishlistProduct saveMemberWishlistProductDetail(
  ...
  public MemberWishlistProduct loadMemberWishlistProduct(
    ...
    MemberWishlistProduct memberWishlistProduct =
        loadMemberWishlistProduct(userContext, memberWishlistProductId, tokens);
    // do some calc before sent to customer?
    return present(userContext, memberWishlistProduct, tokens);
  }

  public MemberWishlistProduct searchMemberWishlistProduct(
      RetailscmUserContext userContext,
  ...
  protected MemberWishlistProduct present(
      RetailscmUserContext userContext,
      MemberWishlistProduct memberWishlistProduct,
      Map<String, Object> tokens)
      throws Exception {
    ...
    MemberWishlistProduct memberWishlistProductToPresent =
        memberWishlistProductDaoOf(userContext).present(memberWishlistProduct, tokens);

    List<BaseEntity> entityListToNaming =
        memberWishlistProductToPresent.collectReferencesFromLists();
  ...
  public MemberWishlistProduct loadMemberWishlistProductDetail(
      RetailscmUserContext userContext, String memberWishlistProductId) throws Exception {
    MemberWishlistProduct memberWishlistProduct =
        loadMemberWishlistProduct(userContext, memberWishlistProductId, allTokens());
  ...
  public Object view(RetailscmUserContext userContext, String memberWishlistProductId)
      throws Exception {
    MemberWishlistProduct memberWishlistProduct =
        loadMemberWishlistProduct(userContext, memberWishlistProductId, viewTokens());
    markVisited(userContext, memberWishlistProduct);
    return present(userContext, memberWishlistProduct, viewTokens());
  }

  public Object summaryView(RetailscmUserContext userContext, String memberWishlistProductId)
      throws Exception {
    MemberWishlistProduct memberWishlistProduct =
        loadMemberWishlistProduct(userContext, memberWishlistProductId, viewTokens());
  ...
  public Object analyze(RetailscmUserContext userContext, String memberWishlistProductId)
      throws Exception {
    MemberWishlistProduct memberWishlistProduct =
        loadMemberWishlistProduct(userContext, memberWishlistProductId, analyzeTokens());
    markVisited(userContext, memberWishlistProduct);
  ...
  protected MemberWishlistProduct loadMemberWishlistProduct(
      RetailscmUserContext userContext, String memberWishlistProductId, Map<String, Object> tokens)
      throws Exception {
    checkerOf(userContext).checkIdOfMemberWishlistProduct(memberWishlistProductId);
  ...
  protected <T extends BaseEntity> void addActions(
    ...
    // userContext, MemberWishlistProduct memberWishlistProduct, Map<String, Object> tokens){

  @Override
  public List<MemberWishlistProduct> searchMemberWishlistProductList(
  ...
  public MemberWishlistProduct createMemberWishlistProduct(
    ...
    memberWishlistProduct =
        saveMemberWishlistProduct(userContext, memberWishlistProduct, emptyOptions());
  ...
  public MemberWishlistProduct clone(
      RetailscmUserContext userContext, String fromMemberWishlistProductId) throws Exception {

    return memberWishlistProductDaoOf(userContext)
        .clone(fromMemberWishlistProductId, this.allTokens());
  }
  ...
  public MemberWishlistProduct internalSaveMemberWishlistProduct(
      ...
      throws Exception {
    // checkParamsForUpdatingMemberWishlistProduct(userContext, memberWishlistProductId,
    // memberWishlistProductVersion, property, newValueExpr, tokensExpr);
    ...
    synchronized (memberWishlistProduct) {
      ...
      memberWishlistProduct =
          saveMemberWishlistProduct(userContext, memberWishlistProduct, options);
      return memberWishlistProduct;
    }
  }
  ...
  public MemberWishlistProduct updateMemberWishlistProduct(
    ...
    if (memberWishlistProduct.getVersion() != memberWishlistProductVersion) {
      String message =
          "The target version("
              + memberWishlistProduct.getVersion()
    ...
    synchronized (memberWishlistProduct) {
      ...
      memberWishlistProduct =
          saveMemberWishlistProduct(userContext, memberWishlistProduct, tokens().done());
  ...
  public MemberWishlistProduct updateMemberWishlistProductProperty(
      RetailscmUserContext userContext,
      String memberWishlistProductId,
      int memberWishlistProductVersion,
      String property,
  ...
  public CandidateMemberWishlist requestCandidateOwner(
    ...
    SmartList<MemberWishlist> candidateList =
        memberWishlistDaoOf(userContext)
            .requestCandidateMemberWishlistForMemberWishlistProduct(
  ...
  public MemberWishlistProduct forgetByAll(
      RetailscmUserContext userContext,
      String memberWishlistProductId,
      int memberWishlistProductVersion)
      throws Exception {
  ...
  protected MemberWishlistProduct forgetByAllInternal(
      RetailscmUserContext userContext,
      String memberWishlistProductId,
      int memberWishlistProductVersion)
      throws Exception {
    ...
    return memberWishlistProductDaoOf(userContext)
        .disconnectFromAll(memberWishlistProductId, memberWishlistProductVersion);
  }
  ...
  public void sendAllItems(RetailscmUserContext ctx) throws Exception {
    memberWishlistProductDaoOf(ctx).loadAllAsStream().forEach(event -> sendInitEvent(ctx, event));
  }
  ...
  public void onAuthenticateNewUserLogged(
    ...
    // this.createMemberWishlistProduct(userContext, ...
  ...
  protected void enhanceForListOfView(
      RetailscmUserContext userContext, SmartList<MemberWishlistProduct> list) throws Exception {
    if (list == null || list.isEmpty()) {
      return;
    }
    List<MemberWishlist> ownerList =
        RetailscmBaseUtils.collectReferencedObjectWithType(userContext, list, MemberWishlist.class);
  ...
  public Object listPageByOwner(
    ...
    SmartList<MemberWishlistProduct> list =
        memberWishlistProductDaoOf(userContext)
            .findMemberWishlistProductByOwner(ownerId, start, count, new HashMap<>());
   ...
   * @throws Exception
   */
  public Object wxappview(RetailscmUserContext userContext, String memberWishlistProductId)
      throws Exception {
    SerializeScope vscope = SerializeScope.EXCLUDE().nothing();
    MemberWishlistProduct merchantObj =
        (MemberWishlistProduct) this.view(userContext, memberWishlistProductId);
