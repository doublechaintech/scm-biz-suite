...
public class ConsumerOrderTokens extends CommonTokens{
  ...
  public static ConsumerOrderTokens loadGroupTokens(String... groupNames){
    ...
    addToken(tokens, CONSUMER, groupNames, new String[]{"default"});addToken(tokens, STORE, groupNames, new String[]{"default"});
  ...
  private static void addToken(ConsumerOrderTokens pTokens, String pTokenName, String[] pGroupNames, String[] fieldGroups) {
	...
	public ConsumerOrderTokens withConsumerOrderShippingGroupListIfViewGroupInclude(String [] viewGroups){
	...
	public ConsumerOrderTokens withConsumerOrderPaymentGroupListIfViewGroupInclude(String [] viewGroups){
	...
	public ConsumerOrderTokens withConsumerOrderPriceAdjustmentListIfViewGroupInclude(String [] viewGroups){
	...
	public ConsumerOrderTokens withRetailStoreMemberGiftCardConsumeRecordListIfViewGroupInclude(String [] viewGroups){
