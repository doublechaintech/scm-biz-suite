...
public class SupplierSpaceManagerImpl extends CustomRetailscmCheckerManager
    implements SupplierSpaceManager, BusinessHandler {
  ...
  public BlobObject exportExcelFromList(
    ...
    List<BaseEntity> entityListToNaming = supplierSpace.collectReferencesFromLists();
  ...
  protected SupplierSpace saveSupplierSpace(
      RetailscmUserContext userContext, SupplierSpace supplierSpace, String[] tokensExpr)
      throws Exception {
  ...
  protected SupplierSpace saveSupplierSpaceDetail(
      RetailscmUserContext userContext, SupplierSpace supplierSpace) throws Exception {

    return saveSupplierSpace(userContext, supplierSpace, allTokens());
  }

  public SupplierSpace loadSupplierSpace(
      RetailscmUserContext userContext, String supplierSpaceId, String[] tokensExpr)
      throws Exception {
  ...
  public SupplierSpace searchSupplierSpace(
  ...
  protected SupplierSpace present(
      RetailscmUserContext userContext, SupplierSpace supplierSpace, Map<String, Object> tokens)
      throws Exception {

    addActions(userContext, supplierSpace, tokens);

    SupplierSpace supplierSpaceToPresent =
        supplierSpaceDaoOf(userContext).present(supplierSpace, tokens);

    List<BaseEntity> entityListToNaming = supplierSpaceToPresent.collectReferencesFromLists();
    supplierSpaceDaoOf(userContext).alias(entityListToNaming);
  ...
  public SupplierSpace loadSupplierSpaceDetail(
      RetailscmUserContext userContext, String supplierSpaceId) throws Exception {
  ...
  public Object summaryView(RetailscmUserContext userContext, String supplierSpaceId)
      throws Exception {
    SupplierSpace supplierSpace = loadSupplierSpace(userContext, supplierSpaceId, viewTokens());
  ...
  protected SupplierSpace loadSupplierSpace(
      RetailscmUserContext userContext, String supplierSpaceId, Map<String, Object> tokens)
      throws Exception {
    checkerOf(userContext).checkIdOfSupplierSpace(supplierSpaceId);
  ...
  protected <T extends BaseEntity> void addActions(
    ...
    // userContext, SupplierSpace supplierSpace, Map<String, Object> tokens){

  @Override
  public List<SupplierSpace> searchSupplierSpaceList(
      RetailscmUserContext ctx, SupplierSpaceRequest pRequest) {
  ...
  public SupplierSpace createSupplierSpace(
      RetailscmUserContext userContext,
      String location,
  ...
  public SupplierSpace clone(RetailscmUserContext userContext, String fromSupplierSpaceId)
      throws Exception {

    return supplierSpaceDaoOf(userContext).clone(fromSupplierSpaceId, this.allTokens());
  }

  public SupplierSpace internalSaveSupplierSpace(
      RetailscmUserContext userContext, SupplierSpace supplierSpace) throws Exception {
    return internalSaveSupplierSpace(userContext, supplierSpace, allTokens());
  }

  public SupplierSpace internalSaveSupplierSpace(
      RetailscmUserContext userContext, SupplierSpace supplierSpace, Map<String, Object> options)
      throws Exception {
    // checkParamsForUpdatingSupplierSpace(userContext, supplierSpaceId, supplierSpaceVersion,
  ...
  public SupplierSpace updateSupplierSpace(
      RetailscmUserContext userContext,
      String supplierSpaceId,
      int supplierSpaceVersion,
      String property,
    ...
    checkParamsForUpdatingSupplierSpace(
        userContext, supplierSpaceId, supplierSpaceVersion, property, newValueExpr, tokensExpr);
  ...
  public SupplierSpace updateSupplierSpaceProperty(
      RetailscmUserContext userContext,
      String supplierSpaceId,
      int supplierSpaceVersion,
      String property,
  ...
  protected void checkParamsForTransferingAnotherWarehouse(
      RetailscmUserContext userContext, String supplierSpaceId, String anotherWarehouseId)
      throws Exception {
  ...
  public SupplierSpace transferToAnotherWarehouse(
      RetailscmUserContext userContext, String supplierSpaceId, String anotherWarehouseId)
      throws Exception {
  ...
  public CandidateWarehouse requestCandidateWarehouse(
    ...
    SmartList<Warehouse> candidateList =
        warehouseDaoOf(userContext)
            .requestCandidateWarehouseForSupplierSpace(
  ...
  public SupplierSpace forgetByAll(
      RetailscmUserContext userContext, String supplierSpaceId, int supplierSpaceVersion)
      throws Exception {
    return forgetByAllInternal(userContext, supplierSpaceId, supplierSpaceVersion);
  }

  protected SupplierSpace forgetByAllInternal(
      RetailscmUserContext userContext, String supplierSpaceId, int supplierSpaceVersion)
      throws Exception {
  ...
  public SupplierSpace addGoodsShelf(
      RetailscmUserContext userContext,
      String supplierSpaceId,
      String location,
      String storageSpaceId,
    ...
    checkParamsForAddingGoodsShelf(
        userContext, supplierSpaceId, location, storageSpaceId, damageSpaceId, tokensExpr);
    ...
    synchronized (supplierSpace) {
      ...
      supplierSpace =
          saveSupplierSpace(userContext, supplierSpace, tokens().withGoodsShelfList().done());
  ...
  public SupplierSpace updateGoodsShelfProperties(
      RetailscmUserContext userContext,
      String supplierSpaceId,
      String id,
      String location,
    ...
    checkParamsForUpdatingGoodsShelfProperties(
        userContext, supplierSpaceId, id, location, tokensExpr);
    ...
    SupplierSpace supplierSpace =
        saveSupplierSpace(userContext, supplierSpaceToUpdate, tokens().withGoodsShelfList().done());
    synchronized (supplierSpace) {
      return present(userContext, supplierSpace, mergedAllTokens(tokensExpr));
    }
  }
  ...
  public SupplierSpace removeGoodsShelfList(
      RetailscmUserContext userContext,
      String supplierSpaceId,
      String goodsShelfIds[],
      String[] tokensExpr)
    ...
    synchronized (supplierSpace) {
      ...
      supplierSpaceDaoOf(userContext)
          .planToRemoveGoodsShelfList(supplierSpace, goodsShelfIds, allTokens());
      supplierSpace =
          saveSupplierSpace(userContext, supplierSpace, tokens().withGoodsShelfList().done());
  ...
  public SupplierSpace removeGoodsShelf(
      RetailscmUserContext userContext,
      String supplierSpaceId,
      String goodsShelfId,
      int goodsShelfVersion,
    ...
    checkParamsForRemovingGoodsShelf(
        userContext, supplierSpaceId, goodsShelfId, goodsShelfVersion, tokensExpr);
  ...
  public SupplierSpace copyGoodsShelfFrom(
      RetailscmUserContext userContext,
      String supplierSpaceId,
      String goodsShelfId,
      int goodsShelfVersion,
    ...
    synchronized (supplierSpace) {
      ...
      goodsShelfManagerOf(userContext)
          .onNewInstanceCreated(
              userContext,
              (GoodsShelf) supplierSpace.getFlexiableObjects().get(BaseEntity.COPIED_CHILD));
      return present(userContext, supplierSpace, mergedAllTokens(tokensExpr));
    }
  }
  ...
  public SupplierSpace updateGoodsShelf(
      RetailscmUserContext userContext,
      String supplierSpaceId,
      String goodsShelfId,
      int goodsShelfVersion,
  ...
  */
  ...
  public void onNewInstanceCreated(RetailscmUserContext userContext, SupplierSpace newCreated)
      throws Exception {
  ...
  public void sendAllItems(RetailscmUserContext ctx) throws Exception {
    supplierSpaceDaoOf(ctx).loadAllAsStream().forEach(event -> sendInitEvent(ctx, event));
  }
  ...
  protected void enhanceForListOfView(
      RetailscmUserContext userContext, SmartList<SupplierSpace> list) throws Exception {
    if (list == null || list.isEmpty()) {
      return;
    }
  ...
  public Object listPageByWarehouse(
    ...
    SmartList<SupplierSpace> list =
        supplierSpaceDaoOf(userContext)
            .findSupplierSpaceByWarehouse(warehouseId, start, count, new HashMap<>());
   ...
   * @throws Exception
   */
  public Object wxappview(RetailscmUserContext userContext, String supplierSpaceId)
      throws Exception {
