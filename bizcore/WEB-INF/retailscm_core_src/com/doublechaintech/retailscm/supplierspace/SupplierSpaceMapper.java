...
public class SupplierSpaceMapper extends BaseRowMapper<SupplierSpace> {
  ...
  public static SupplierSpaceMapper mapperForClass(Class<?> clazz) {

    SupplierSpaceMapper mapperForOverride = new SupplierSpaceMapper();
  ...
  protected void setId(SupplierSpace supplierSpace, ResultSet rs, int rowNumber)
      throws SQLException {
    try {
  ...
  protected void setLocation(SupplierSpace supplierSpace, ResultSet rs, int rowNumber)
      throws SQLException {
    try {
      // there will be issue when the type is double/int/long
  ...
  protected void setContactNumber(SupplierSpace supplierSpace, ResultSet rs, int rowNumber)
      throws SQLException {
    try {
      // there will be issue when the type is double/int/long
  ...
  protected void setTotalArea(SupplierSpace supplierSpace, ResultSet rs, int rowNumber)
      throws SQLException {
    try {
      // there will be issue when the type is double/int/long
  ...
  protected void setWarehouse(SupplierSpace supplierSpace, ResultSet rs, int rowNumber)
      throws SQLException {
    String warehouseId;
    try {
  ...
  protected void setLatitude(SupplierSpace supplierSpace, ResultSet rs, int rowNumber)
      throws SQLException {
    try {
      // there will be issue when the type is double/int/long
  ...
  protected void setLongitude(SupplierSpace supplierSpace, ResultSet rs, int rowNumber)
      throws SQLException {
    try {
      // there will be issue when the type is double/int/long
  ...
  protected void setLastUpdateTime(SupplierSpace supplierSpace, ResultSet rs, int rowNumber)
      throws SQLException {
    try {
      // there will be issue when the type is double/int/long
  ...
  protected void setVersion(SupplierSpace supplierSpace, ResultSet rs, int rowNumber)
      throws SQLException {
    try {
      // there will be issue when the type is double/int/long
