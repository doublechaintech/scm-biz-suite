...
public class SupplierSpace extends BaseEntity implements  java.io.Serializable{
  ...
  memberMetaInfoList.add(MemberMetaInfo.referBy(GOODS_SHELF_LIST, "supplierSpace", "货架列表")
...
return getId();
	...
	public SupplierSpace updateId(String id){String oldId = this.id;String newId = trimString(id);if(!shouldReplaceBy(newId, oldId)){return this;}this.id = newId;addPropertyChange(ID_PROPERTY, oldId, newId);this.changed = true;setChecked(false);return this;}
...
return createCriteria(ID_PROPERTY, operator, parameters);
	...
	public SupplierSpace ignoreIdCriteria(){super.ignoreSearchProperty(ID_PROPERTY);
return this;
}
...
return getLocation();
	...
	public SupplierSpace updateLocation(String location){String oldLocation = this.location;String newLocation = trimString(location);if(!shouldReplaceBy(newLocation, oldLocation)){return this;}this.location = newLocation;addPropertyChange(LOCATION_PROPERTY, oldLocation, newLocation);this.changed = true;setChecked(false);return this;}
...
return createCriteria(LOCATION_PROPERTY, operator, parameters);
	...
	public SupplierSpace ignoreLocationCriteria(){super.ignoreSearchProperty(LOCATION_PROPERTY);
return this;
}
...
return createCriteria(CONTACT_NUMBER_PROPERTY, operator, parameters);
	...
	public SupplierSpace ignoreContactNumberCriteria(){super.ignoreSearchProperty(CONTACT_NUMBER_PROPERTY);
return this;
}
...
return createCriteria(TOTAL_AREA_PROPERTY, operator, parameters);
	...
	public SupplierSpace ignoreTotalAreaCriteria(){super.ignoreSearchProperty(TOTAL_AREA_PROPERTY);
return this;
}
...
return createCriteria(WAREHOUSE_PROPERTY, operator, parameters);
	...
	public SupplierSpace ignoreWarehouseCriteria(){super.ignoreSearchProperty(WAREHOUSE_PROPERTY);
return this;
}
...
return getLatitude();
	...
	public SupplierSpace updateLatitude(BigDecimal latitude){BigDecimal oldLatitude = this.latitude;BigDecimal newLatitude = latitude;if(!shouldReplaceBy(newLatitude, oldLatitude)){return this;}this.latitude = newLatitude;addPropertyChange(LATITUDE_PROPERTY, oldLatitude, newLatitude);this.changed = true;setChecked(false);return this;}
...
return createCriteria(LATITUDE_PROPERTY, operator, parameters);
	...
	public SupplierSpace ignoreLatitudeCriteria(){super.ignoreSearchProperty(LATITUDE_PROPERTY);
return this;
}
...
return getLongitude();
	...
	public SupplierSpace updateLongitude(BigDecimal longitude){BigDecimal oldLongitude = this.longitude;BigDecimal newLongitude = longitude;if(!shouldReplaceBy(newLongitude, oldLongitude)){return this;}this.longitude = newLongitude;addPropertyChange(LONGITUDE_PROPERTY, oldLongitude, newLongitude);this.changed = true;setChecked(false);return this;}
...
return createCriteria(LONGITUDE_PROPERTY, operator, parameters);
	...
	public SupplierSpace ignoreLongitudeCriteria(){super.ignoreSearchProperty(LONGITUDE_PROPERTY);
return this;
}
...
return createCriteria(LAST_UPDATE_TIME_PROPERTY, operator, parameters);
	...
	public SupplierSpace ignoreLastUpdateTimeCriteria(){super.ignoreSearchProperty(LAST_UPDATE_TIME_PROPERTY);
return this;
}
...
return getVersion();
	...
	public SupplierSpace updateVersion(int version){int oldVersion = this.version;int newVersion = version;if(!shouldReplaceBy(newVersion, oldVersion)){return this;}this.version = newVersion;addPropertyChange(VERSION_PROPERTY, oldVersion, newVersion);this.changed = true;setChecked(false);return this;}
...
return createCriteria(VERSION_PROPERTY, operator, parameters);
	...
	public SupplierSpace ignoreVersionCriteria(){super.ignoreSearchProperty(VERSION_PROPERTY);
return this;
}
...
return this;
  ...
  public  SmartList<GoodsShelf> goodsShelfList(){
	...
	public static SupplierSpace createWith(RetailscmUserContext userContext, ThrowingFunction<SupplierSpace,SupplierSpace,Exception> postHandler, Object ... inputs) throws Exception {

    List<Object> params = inputs == null ? new ArrayList<>() : Arrays.asList(inputs);
    CustomRetailscmPropertyMapper mapper = CustomRetailscmPropertyMapper.of(userContext);
    CreationScene scene = mapper.findParamByClass(params, CreationScene.class);
    RetailscmBeanCreator<SupplierSpace> customCreator = mapper.findCustomCreator(SupplierSpace.class, scene);
    if (customCreator != null){
      return customCreator.create(userContext, scene, postHandler, params);
    }

    SupplierSpace result = new SupplierSpace();
    result.setLocation(mapper.tryToGet(SupplierSpace.class, LOCATION_PROPERTY, String.class,
        0, false, result.getLocation(), params));
    result.setContactNumber(mapper.tryToGet(SupplierSpace.class, CONTACT_NUMBER_PROPERTY, String.class,
        1, false, result.getContactNumber(), params));
    result.setTotalArea(mapper.tryToGet(SupplierSpace.class, TOTAL_AREA_PROPERTY, String.class,
        2, false, result.getTotalArea(), params));
    result.setWarehouse(mapper.tryToGet(SupplierSpace.class, WAREHOUSE_PROPERTY, Warehouse.class,
        0, true, result.getWarehouse(), params));
    result.setLatitude(mapper.tryToGet(SupplierSpace.class, LATITUDE_PROPERTY, BigDecimal.class,
        0, false, result.getLatitude(), params));
    result.setLongitude(mapper.tryToGet(SupplierSpace.class, LONGITUDE_PROPERTY, BigDecimal.class,
    ...
    if (result != null){
      userContext.getChecker().checkAndFixSupplierSpace(result);
      userContext.getChecker().throwExceptionIfHasErrors(IllegalArgumentException.class);

      
      SupplierSpaceTokens tokens = mapper.findParamByClass(params, SupplierSpaceTokens.class);
      if (tokens == null) {
        tokens = SupplierSpaceTokens.start();
      }
      result = userContext.getManagerGroup().getSupplierSpaceManager().internalSaveSupplierSpace(userContext, result, tokens.done());
