...
public class SupplyOrderPaymentGroupTable {
  ...
  public static final String[] ALL_CLOUMNS = {
    COLUMN_ID, COLUMN_NAME, COLUMN_BIZ_ORDER, COLUMN_CARD_NUMBER, COLUMN_VERSION
  };
  ...
  public static void ensureTable(RetailscmUserContext userContext, Map<String, Object> result)
    ...
    RetailscmBaseUtils.ensureTable(
        userContext,
        result,
        "supply_order_payment_group_data",
        new String[][] {
        ...
        new String[] {
          ...
          "alter table supply_order_payment_group_data add constraint fk4biz_order_of_supply_order_payment_group_data foreign key (biz_order) references supply_order_data(id) ON DELETE CASCADE ON UPDATE CASCADE;",
          ""
        });
  }
}
