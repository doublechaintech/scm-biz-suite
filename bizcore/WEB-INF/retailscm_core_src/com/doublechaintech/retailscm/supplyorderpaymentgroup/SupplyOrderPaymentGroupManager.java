...
public interface SupplyOrderPaymentGroupManager extends BaseManager{
  ...
  List<SupplyOrderPaymentGroup> searchSupplyOrderPaymentGroupList(RetailscmUserContext ctx, SupplyOrderPaymentGroupRequest pRequest);
  SupplyOrderPaymentGroup searchSupplyOrderPaymentGroup(RetailscmUserContext ctx, SupplyOrderPaymentGroupRequest pRequest);
	...
	public default void onUpdated(RetailscmUserContext userContext, SupplyOrderPaymentGroup updated, Object actor, String methodName) throws Exception {};
