...
public class SupplyOrderPaymentGroupManagerImpl extends CustomRetailscmCheckerManager
    implements SupplyOrderPaymentGroupManager, BusinessHandler {
  ...
  protected void throwExceptionWithMessage(String value)
      throws SupplyOrderPaymentGroupManagerException {
  ...
  protected SupplyOrderPaymentGroup saveSupplyOrderPaymentGroupDetail(
  ...
  public SupplyOrderPaymentGroup loadSupplyOrderPaymentGroup(
    ...
    SupplyOrderPaymentGroup supplyOrderPaymentGroup =
        loadSupplyOrderPaymentGroup(userContext, supplyOrderPaymentGroupId, tokens);
    // do some calc before sent to customer?
    return present(userContext, supplyOrderPaymentGroup, tokens);
  }

  public SupplyOrderPaymentGroup searchSupplyOrderPaymentGroup(
      RetailscmUserContext userContext,
  ...
  protected SupplyOrderPaymentGroup present(
      RetailscmUserContext userContext,
      SupplyOrderPaymentGroup supplyOrderPaymentGroup,
      Map<String, Object> tokens)
      throws Exception {
    ...
    SupplyOrderPaymentGroup supplyOrderPaymentGroupToPresent =
        supplyOrderPaymentGroupDaoOf(userContext).present(supplyOrderPaymentGroup, tokens);

    List<BaseEntity> entityListToNaming =
        supplyOrderPaymentGroupToPresent.collectReferencesFromLists();
  ...
  public SupplyOrderPaymentGroup loadSupplyOrderPaymentGroupDetail(
      RetailscmUserContext userContext, String supplyOrderPaymentGroupId) throws Exception {
    SupplyOrderPaymentGroup supplyOrderPaymentGroup =
        loadSupplyOrderPaymentGroup(userContext, supplyOrderPaymentGroupId, allTokens());
  ...
  public Object view(RetailscmUserContext userContext, String supplyOrderPaymentGroupId)
      throws Exception {
    SupplyOrderPaymentGroup supplyOrderPaymentGroup =
        loadSupplyOrderPaymentGroup(userContext, supplyOrderPaymentGroupId, viewTokens());
    markVisited(userContext, supplyOrderPaymentGroup);
    return present(userContext, supplyOrderPaymentGroup, viewTokens());
  }

  public Object summaryView(RetailscmUserContext userContext, String supplyOrderPaymentGroupId)
      throws Exception {
    SupplyOrderPaymentGroup supplyOrderPaymentGroup =
        loadSupplyOrderPaymentGroup(userContext, supplyOrderPaymentGroupId, viewTokens());
  ...
  public Object analyze(RetailscmUserContext userContext, String supplyOrderPaymentGroupId)
      throws Exception {
    SupplyOrderPaymentGroup supplyOrderPaymentGroup =
        loadSupplyOrderPaymentGroup(userContext, supplyOrderPaymentGroupId, analyzeTokens());
    markVisited(userContext, supplyOrderPaymentGroup);
  ...
  protected SupplyOrderPaymentGroup loadSupplyOrderPaymentGroup(
      RetailscmUserContext userContext,
      String supplyOrderPaymentGroupId,
      Map<String, Object> tokens)
      throws Exception {
  ...
  protected <T extends BaseEntity> void addActions(
    ...
    // userContext, SupplyOrderPaymentGroup supplyOrderPaymentGroup, Map<String, Object> tokens){

  @Override
  public List<SupplyOrderPaymentGroup> searchSupplyOrderPaymentGroupList(
  ...
  public SupplyOrderPaymentGroup createSupplyOrderPaymentGroup(
    ...
    supplyOrderPaymentGroup =
        saveSupplyOrderPaymentGroup(userContext, supplyOrderPaymentGroup, emptyOptions());
  ...
  public SupplyOrderPaymentGroup clone(
      RetailscmUserContext userContext, String fromSupplyOrderPaymentGroupId) throws Exception {

    return supplyOrderPaymentGroupDaoOf(userContext)
        .clone(fromSupplyOrderPaymentGroupId, this.allTokens());
  }
  ...
  public SupplyOrderPaymentGroup internalSaveSupplyOrderPaymentGroup(
      ...
      throws Exception {
    // checkParamsForUpdatingSupplyOrderPaymentGroup(userContext, supplyOrderPaymentGroupId,
    // supplyOrderPaymentGroupVersion, property, newValueExpr, tokensExpr);
    ...
    synchronized (supplyOrderPaymentGroup) {
      ...
      supplyOrderPaymentGroup =
          saveSupplyOrderPaymentGroup(userContext, supplyOrderPaymentGroup, options);
      return supplyOrderPaymentGroup;
    }
  }
  ...
  public SupplyOrderPaymentGroup updateSupplyOrderPaymentGroup(
    ...
    synchronized (supplyOrderPaymentGroup) {
      ...
      supplyOrderPaymentGroup =
          saveSupplyOrderPaymentGroup(userContext, supplyOrderPaymentGroup, tokens().done());
  ...
  public SupplyOrderPaymentGroup updateSupplyOrderPaymentGroupProperty(
      RetailscmUserContext userContext,
      String supplyOrderPaymentGroupId,
      int supplyOrderPaymentGroupVersion,
      String property,
  ...
  public SupplyOrderPaymentGroup transferToAnotherBizOrder(
    ...
    checkParamsForTransferingAnotherBizOrder(
        userContext, supplyOrderPaymentGroupId, anotherBizOrderId);
  ...
  public CandidateSupplyOrder requestCandidateBizOrder(
    ...
    SmartList<SupplyOrder> candidateList =
        supplyOrderDaoOf(userContext)
            .requestCandidateSupplyOrderForSupplyOrderPaymentGroup(
  ...
  public SupplyOrderPaymentGroup forgetByAll(
      RetailscmUserContext userContext,
      String supplyOrderPaymentGroupId,
      int supplyOrderPaymentGroupVersion)
      throws Exception {
    return forgetByAllInternal(
        userContext, supplyOrderPaymentGroupId, supplyOrderPaymentGroupVersion);
  }

  protected SupplyOrderPaymentGroup forgetByAllInternal(
      RetailscmUserContext userContext,
      String supplyOrderPaymentGroupId,
      int supplyOrderPaymentGroupVersion)
      throws Exception {
    ...
    return supplyOrderPaymentGroupDaoOf(userContext)
        .disconnectFromAll(supplyOrderPaymentGroupId, supplyOrderPaymentGroupVersion);
  }
  ...
  public void sendAllItems(RetailscmUserContext ctx) throws Exception {
    supplyOrderPaymentGroupDaoOf(ctx).loadAllAsStream().forEach(event -> sendInitEvent(ctx, event));
  }
  ...
  public void onAuthenticateNewUserLogged(
    ...
    // this.createSupplyOrderPaymentGroup(userContext, ...
  ...
  protected void enhanceForListOfView(
      RetailscmUserContext userContext, SmartList<SupplyOrderPaymentGroup> list) throws Exception {
    if (list == null || list.isEmpty()) {
      return;
    }
  ...
  public Object listPageByBizOrder(
    ...
    SmartList<SupplyOrderPaymentGroup> list =
        supplyOrderPaymentGroupDaoOf(userContext)
            .findSupplyOrderPaymentGroupByBizOrder(bizOrderId, start, count, new HashMap<>());
   ...
   * @throws Exception
   */
  public Object wxappview(RetailscmUserContext userContext, String supplyOrderPaymentGroupId)
      throws Exception {
    SerializeScope vscope = SerializeScope.EXCLUDE().nothing();
    SupplyOrderPaymentGroup merchantObj =
        (SupplyOrderPaymentGroup) this.view(userContext, supplyOrderPaymentGroupId);
