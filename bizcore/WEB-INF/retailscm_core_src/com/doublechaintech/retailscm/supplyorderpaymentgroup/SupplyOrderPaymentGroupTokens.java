...
public class SupplyOrderPaymentGroupTokens extends CommonTokens{
  ...
  public static SupplyOrderPaymentGroupTokens loadGroupTokens(String... groupNames){
    SupplyOrderPaymentGroupTokens tokens = start();
  ...
  private static void addToken(SupplyOrderPaymentGroupTokens pTokens, String pTokenName, String[] pGroupNames, String[] fieldGroups) {
	...
	public static SupplyOrderPaymentGroupTokens filterWithTokenViewGroups(String []viewGroups){
	...
	public static SupplyOrderPaymentGroupTokens allTokens(){
