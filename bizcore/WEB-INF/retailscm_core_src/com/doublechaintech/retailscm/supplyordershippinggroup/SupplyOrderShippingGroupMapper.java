...
public class SupplyOrderShippingGroupMapper extends BaseRowMapper<SupplyOrderShippingGroup> {
  ...
  public static SupplyOrderShippingGroupMapper mapperForClass(Class<?> clazz) {

    SupplyOrderShippingGroupMapper mapperForOverride = new SupplyOrderShippingGroupMapper();
    mapperForOverride.setClazz(clazz);
    return mapperForOverride;
  }

  protected SupplyOrderShippingGroup internalMapRow(ResultSet rs, int rowNumber)
      throws SQLException {
  ...
  protected void setId(
      SupplyOrderShippingGroup supplyOrderShippingGroup, ResultSet rs, int rowNumber)
      throws SQLException {
    try {
  ...
  protected void setBizOrder(
    ...
    if (supplyOrder != null) {
      // if the root object 'supplyOrderShippingGroup' already have the property, just set the id
      // for it;
