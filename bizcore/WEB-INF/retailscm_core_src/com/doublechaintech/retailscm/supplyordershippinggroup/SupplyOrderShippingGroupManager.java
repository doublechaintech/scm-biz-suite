...
public interface SupplyOrderShippingGroupManager extends BaseManager{
  ...
  List<SupplyOrderShippingGroup> searchSupplyOrderShippingGroupList(RetailscmUserContext ctx, SupplyOrderShippingGroupRequest pRequest);
  SupplyOrderShippingGroup searchSupplyOrderShippingGroup(RetailscmUserContext ctx, SupplyOrderShippingGroupRequest pRequest);
	...
	public default void onUpdated(RetailscmUserContext userContext, SupplyOrderShippingGroup updated, Object actor, String methodName) throws Exception {};
