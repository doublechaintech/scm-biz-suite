...
public class SupplyOrderShippingGroup extends BaseEntity implements java.io.Serializable {
  ...
  public void transferAllRelationshipsTo(SupplyOrderShippingGroup target) {
    if (target == null) {
      return;
    }
  }
  ...
  public SupplyOrderShippingGroup ignoreIdCriteria() {
  ...
  public SupplyOrderShippingGroup ignoreNameCriteria() {
  ...
  public SupplyOrderShippingGroup ignoreBizOrderCriteria() {
    super.ignoreSearchProperty(BIZ_ORDER_PROPERTY);
    return this;
  }

  public SupplyOrderShippingGroup addBizOrderCriteria(
  ...
  public SupplyOrderShippingGroup updateBizOrderByReferenceId(String bizOrderId) {
  ...
  public SupplyOrderShippingGroup ignoreAmountCriteria() {
  ...
  public SupplyOrderShippingGroup ignoreVersionCriteria() {
  ...
  public BaseEntity mergeDataFrom(BaseEntity sourceEntity) {
    ...
    if (sourceEntity instanceof SupplyOrderShippingGroup) {

      SupplyOrderShippingGroup source = (SupplyOrderShippingGroup) sourceEntity;
  ...
  public boolean checkIfEligibleForDelete(Object ctx) {
    ...
    SupplyOrderShippingGroup checkSupplyOrderShippingGroup =
        Q.supplyOrderShippingGroupWithIdField().filterById(id).execute(ctx);

    return checkSupplyOrderShippingGroup != null
        && !checkSupplyOrderShippingGroup.getAllRelatedLists().stream()
            .flatMap(subList -> subList.stream())
            .findFirst()
            .isPresent();
  }

  public SupplyOrderShippingGroup save(com.doublechaintech.retailscm.RetailscmUserContext ctx) {
    try {
