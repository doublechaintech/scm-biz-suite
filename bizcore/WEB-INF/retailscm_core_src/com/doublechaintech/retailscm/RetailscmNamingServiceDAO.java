...
public class RetailscmNamingServiceDAO extends CommonJDBCTemplateDAO {
  ...
  static {
    ...
    namingTableMap.put(
        "RetailStoreCountryCenter", new String[] {"retail_store_country_center_data", "name"});
    ...
    namingTableMap.put(
        "RetailStoreProvinceCenter", new String[] {"retail_store_province_center_data", "name"});
    namingTableMap.put(
        "ProvinceCenterDepartment", new String[] {"province_center_department_data", "name"});
    namingTableMap.put(
        "ProvinceCenterEmployee", new String[] {"province_center_employee_data", "name"});
    namingTableMap.put(
        "RetailStoreCityServiceCenter",
        new String[] {"retail_store_city_service_center_data", "name"});
    ...
    namingTableMap.put(
        ...
        new String[] {"potential_customer_contact_person_data", "name"});
    namingTableMap.put(
        "PotentialCustomerContact", new String[] {"potential_customer_contact_data", "name"});
    ...
    namingTableMap.put(
        "RetailStoreCreation", new String[] {"retail_store_creation_data", "comment"});
    namingTableMap.put(
        "RetailStoreInvestmentInvitation",
        new String[] {"retail_store_investment_invitation_data", "comment"});
    namingTableMap.put(
        "RetailStoreFranchising", new String[] {"retail_store_franchising_data", "comment"});
    namingTableMap.put(
        "RetailStoreDecoration", new String[] {"retail_store_decoration_data", "comment"});
    ...
    namingTableMap.put(
        "ConsumerOrderLineItem", new String[] {"consumer_order_line_item_data", "sku_id"});
    namingTableMap.put(
        "ConsumerOrderShippingGroup", new String[] {"consumer_order_shipping_group_data", "name"});
    namingTableMap.put(
        "ConsumerOrderPaymentGroup", new String[] {"consumer_order_payment_group_data", "name"});
    namingTableMap.put(
        "ConsumerOrderPriceAdjustment",
        new String[] {"consumer_order_price_adjustment_data", "name"});
    namingTableMap.put(
        "RetailStoreMemberCoupon", new String[] {"retail_store_member_coupon_data", "name"});
    ...
    namingTableMap.put(
        ...
        new String[] {"member_reward_point_redemption_data", "name"});
    namingTableMap.put(
        "MemberWishlistProduct", new String[] {"member_wishlist_product_data", "name"});
    namingTableMap.put(
        "RetailStoreMemberAddress", new String[] {"retail_store_member_address_data", "name"});
    namingTableMap.put(
        "RetailStoreMemberGiftCard", new String[] {"retail_store_member_gift_card_data", "name"});
    namingTableMap.put(
        "RetailStoreMemberGiftCardConsumeRecord",
        new String[] {"retail_store_member_gift_card_consume_record_data", "number"});
    ...
    namingTableMap.put(
        "ProductSupplyDuration", new String[] {"product_supply_duration_data", "duration"});
    namingTableMap.put("SupplyOrder", new String[] {"supply_order_data", "title"});
    namingTableMap.put(
        "SupplyOrderLineItem", new String[] {"supply_order_line_item_data", "sku_id"});
    namingTableMap.put(
        "SupplyOrderShippingGroup", new String[] {"supply_order_shipping_group_data", "name"});
    namingTableMap.put(
        "SupplyOrderPaymentGroup", new String[] {"supply_order_payment_group_data", "name"});
    namingTableMap.put("RetailStoreOrder", new String[] {"retail_store_order_data", "title"});
    namingTableMap.put(
        "RetailStoreOrderLineItem", new String[] {"retail_store_order_line_item_data", "sku_id"});
    namingTableMap.put(
        "RetailStoreOrderShippingGroup",
        new String[] {"retail_store_order_shipping_group_data", "name"});
    namingTableMap.put(
        "RetailStoreOrderPaymentGroup",
        new String[] {"retail_store_order_payment_group_data", "name"});
    ...
    namingTableMap.put(
        "GoodsShelfStockCount", new String[] {"goods_shelf_stock_count_data", "title"});
    namingTableMap.put(
        "StockCountIssueTrack", new String[] {"stock_count_issue_track_data", "title"});
    ...
    namingTableMap.put(
        "AccountingSubject", new String[] {"accounting_subject_data", "accounting_subject_code"});
    namingTableMap.put("AccountingPeriod", new String[] {"accounting_period_data", "name"});
    namingTableMap.put(
        "AccountingDocumentType", new String[] {"accounting_document_type_data", "name"});
    ...
    namingTableMap.put(
        "AccountingDocumentLine", new String[] {"accounting_document_line_data", "name"});
    ...
    namingTableMap.put(
        "LevelThreeDepartment", new String[] {"level_three_department_data", "name"});
    ...
    namingTableMap.put(
        "EmployeeCompanyTraining", new String[] {"employee_company_training_data", "id"});
    namingTableMap.put("EmployeeSkill", new String[] {"employee_skill_data", "description"});
    namingTableMap.put(
        "EmployeePerformance", new String[] {"employee_performance_data", "performance_comment"});
    namingTableMap.put(
        "EmployeeWorkExperience", new String[] {"employee_work_experience_data", "company"});
    ...
    namingTableMap.put(
        "WechatWorkappIdentity", new String[] {"wechat_workapp_identity_data", "corp_id"});
    namingTableMap.put(
        "WechatMiniappIdentity", new String[] {"wechat_miniapp_identity_data", "open_id"});
  ...
  protected Map<String, String> getResultMap(String unionedSQL, Object[] parameters) {
            ...
            new ResultSetExtractor<Map<String, String>>() {
              ...
              public Map<String, String> extractData(ResultSet resultSet)
                ...
                while (resultSet.next()) {
                  String key =
                      trimString(resultSet.getString(1)) + ":" + trimString(resultSet.getString(2));
                  // Fixed the issue for Informix and Gbase 8t/s data base, it appends values for
                  // the class column
  ...
  Map<String, List<String>> sqlMapOf(List<BaseEntity> sortedEntityList) {
    ...
    for (BaseEntity baseEntity : sortedEntityList) {
      ...
      if (sql != null) sqlMap.put(sql, idList);
  ...
  protected String sqlOf(String currentClassName) {
    ...
    if (sqlInfo == null) {
      // throw new IllegalArgumentException("sqlOf(String currentClassName): Not able to find sql
      // info for class: "+currentClassName);
      return null;
    }
    if (sqlInfo.length < 2) {
      throw new IllegalArgumentException(
          "sqlOf(String currentClassName): sqlInfo.length should equals 2 for class: "
              + currentClassName);
    }
  ...
  public SmartList<BaseEntity> requestCandidateValuesForSearch(
    ...
    if (filterKey != null && !filterKey.trim().isEmpty()) {
      ...
      if (sqlInfo == null) {
        throw new IllegalArgumentException(
            "sqlOf(String currentClassName): Not able to find sql info for filter class: "
                + targetClassName);
      }
      if (sqlInfo.length < 2) {
        throw new IllegalArgumentException(
            "sqlOf(String currentClassName): sqlInfo.length should equals 2 for filter class: "
                + targetClassName);
      }
      String displayExpr = sqlInfo[1];
      joinClause =
          String.format(
              " left join %s_data T2 on T1.%s=T2.id ",
              mapToInternalColumn(targetClassName), mapToInternalColumn(resultMemberName));
      filterClause = String.format(" and T2.%s like ? ", displayExpr);
      params.add("%" + filterKey.trim() + "%");
    }
    String sql =
        String.format(
            "select distinct T1.%s from %s_data T1%swhere T1.%s = ?%sorder by cast(%s as CHAR CHARACTER SET GBK) asc",
            mapToInternalColumn(resultMemberName),
            mapToInternalColumn(resutlClassName),
            joinClause,
