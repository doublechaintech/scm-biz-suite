...
public class StockCountIssueTrackTable{
	...
	public static final String []NORMAL_CLOUMNS = {COLUMN_TITLE,COLUMN_COUNT_TIME,COLUMN_SUMMARY,COLUMN_STOCK_COUNT};
	  ...
	  public static void ensureTable(RetailscmUserContext userContext, Map<String, Object> result) throws Exception {
        RetailscmBaseUtils.ensureTable(userContext, result, "stock_count_issue_track_data", new String[][]{
                new String[]{"id","varchar(48)"," not null","ID","",""},
                new String[]{"title","varchar(16)","","头衔","",""},
                new String[]{"count_time","date","","计数时间","",""},
                new String[]{"summary","varchar(40)","","概览","",""},
                new String[]{"stock_count","varchar(48)","","盘点","goods_shelf_stock_count_data","id"},
