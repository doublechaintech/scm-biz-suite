...
public class KeyPairIdentityManagerImpl extends CustomRetailscmCheckerManager
  ...
  protected KeyPairIdentity saveKeyPairIdentity(
      RetailscmUserContext userContext, KeyPairIdentity keyPairIdentity, String[] tokensExpr)
      throws Exception {
  ...
  protected KeyPairIdentity present(
      RetailscmUserContext userContext, KeyPairIdentity keyPairIdentity, Map<String, Object> tokens)
      throws Exception {
  ...
  public KeyPairIdentity loadKeyPairIdentityDetail(
      RetailscmUserContext userContext, String keyPairIdentityId) throws Exception {
  ...
  public Object summaryView(RetailscmUserContext userContext, String keyPairIdentityId)
      throws Exception {
    KeyPairIdentity keyPairIdentity =
        loadKeyPairIdentity(userContext, keyPairIdentityId, viewTokens());
  ...
  public Object analyze(RetailscmUserContext userContext, String keyPairIdentityId)
      throws Exception {
    KeyPairIdentity keyPairIdentity =
  ...
  protected KeyPairIdentity loadKeyPairIdentity(
      RetailscmUserContext userContext, String keyPairIdentityId, Map<String, Object> tokens)
      throws Exception {
    checkerOf(userContext).checkIdOfKeyPairIdentity(keyPairIdentityId);
  ...
  protected <T extends BaseEntity> void addActions(
    ...
    // userContext, KeyPairIdentity keyPairIdentity, Map<String, Object> tokens){
  ...
  public KeyPairIdentity clone(RetailscmUserContext userContext, String fromKeyPairIdentityId)
      throws Exception {
  ...
  protected void checkParamsForTransferingAnotherSecUserWithLogin(
      RetailscmUserContext userContext, String keyPairIdentityId, String anotherLogin)
      throws Exception {
  ...
  protected void checkParamsForTransferingAnotherSecUserWithEmail(
      RetailscmUserContext userContext, String keyPairIdentityId, String anotherEmail)
      throws Exception {
  ...
  protected void checkParamsForTransferingAnotherSecUserWithMobile(
      RetailscmUserContext userContext, String keyPairIdentityId, String anotherMobile)
      throws Exception {
  ...
  protected PublicKeyType loadPublicKeyType(
      RetailscmUserContext userContext, String newKeyTypeId, Map<String, Object> options)
      throws Exception {
  ...
  public KeyPairIdentity forgetByAll(
      RetailscmUserContext userContext, String keyPairIdentityId, int keyPairIdentityVersion)
      throws Exception {
  ...
  protected void enhanceForListOfView(
      RetailscmUserContext userContext, SmartList<KeyPairIdentity> list) throws Exception {
    if (list == null || list.isEmpty()) {
      return;
    }
    List<PublicKeyType> keyTypeList =
        RetailscmBaseUtils.collectReferencedObjectWithType(userContext, list, PublicKeyType.class);
   ...
   * @throws Exception
   */
  public Object wxappview(RetailscmUserContext userContext, String keyPairIdentityId)
      throws Exception {
