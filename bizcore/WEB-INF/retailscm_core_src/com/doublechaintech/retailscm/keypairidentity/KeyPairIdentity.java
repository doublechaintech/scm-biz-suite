...
public class KeyPairIdentity extends BaseEntity implements java.io.Serializable {
  ...
  public void transferAllRelationshipsTo(KeyPairIdentity target) {
    if (target == null) {
      return;
    }
  }
  ...
  static {
    ...
    memberMetaInfoList.add(
        MemberMetaInfo.defineBy(PUBLIC_KEY_PROPERTY, "public_key", "公钥")
            .withType("text", String.class));
    memberMetaInfoList.add(
        MemberMetaInfo.defineBy(KEY_TYPE_PROPERTY, "public_key_type", "密钥类型")
  ...
  public KeyPairIdentity updateId(String id) {
    String oldId = this.id;
    String newId = trimString(id);
  ...
  public KeyPairIdentity ignoreIdCriteria() {
  ...
  public KeyPairIdentity updatePublicKey(String publicKey) {
    String oldPublicKey = this.publicKey;
    String newPublicKey = publicKey;
    if (!shouldReplaceBy(newPublicKey, oldPublicKey)) {
      return this;
    }
    this.publicKey = newPublicKey;
    if (cn.hutool.core.util.ObjectUtil.equals(newPublicKey, oldPublicKey)) {
      return this;
    }
    addPropertyChange(PUBLIC_KEY_PROPERTY, oldPublicKey, newPublicKey);
    this.changed = true;
    setChecked(false);
    return this;
  }
  ...
  public KeyPairIdentity ignorePublicKeyCriteria() {
    super.ignoreSearchProperty(PUBLIC_KEY_PROPERTY);
    return this;
  }
  ...
  public void setKeyType(PublicKeyType keyType) {
    PublicKeyType oldKeyType = this.keyType;
    PublicKeyType newKeyType = keyType;
  ...
  public KeyPairIdentity updateKeyType(PublicKeyType keyType) {
    PublicKeyType oldKeyType = this.keyType;
    PublicKeyType newKeyType = keyType;
    if (!shouldReplaceBy(newKeyType, oldKeyType)) {
      return this;
    }
    this.keyType = newKeyType;
    if (cn.hutool.core.util.ObjectUtil.equals(newKeyType, oldKeyType)) {
      return this;
    }
    addPropertyChange(KEY_TYPE_PROPERTY, oldKeyType, newKeyType);
    this.changed = true;
    setChecked(false);
    return this;
  }
  ...
  public KeyPairIdentity ignoreKeyTypeCriteria() {
    super.ignoreSearchProperty(KEY_TYPE_PROPERTY);
    return this;
  }
  ...
  public KeyPairIdentity updateKeyTypeByReferenceId(String keyTypeId) {
    updateKeyType(PublicKeyType.refById(keyTypeId));
    return this;
  }
  ...
  public KeyPairIdentity updateSecUser(SecUser secUser) {
    SecUser oldSecUser = this.secUser;
    SecUser newSecUser = secUser;
  ...
  public KeyPairIdentity ignoreSecUserCriteria() {
  ...
  public KeyPairIdentity updateSecUserByReferenceId(String secUserId) {
  ...
  public KeyPairIdentity updateCreateTime(DateTime createTime) {
    DateTime oldCreateTime = this.createTime;
    DateTime newCreateTime = createTime;
  ...
  public KeyPairIdentity ignoreCreateTimeCriteria() {
  ...
  public KeyPairIdentity updateVersion(int version) {
    int oldVersion = this.version;
    int newVersion = version;
  ...
  public KeyPairIdentity ignoreVersionCriteria() {
  ...
  public BaseEntity mergeDataFrom(BaseEntity sourceEntity) {
    ...
    if (sourceEntity instanceof KeyPairIdentity) {

      KeyPairIdentity source = (KeyPairIdentity) sourceEntity;

      mergeId(source.getId());
      mergePublicKey(source.getPublicKey());
      mergeKeyType(source.getKeyType());
  ...
  public Object[] toFlatArray() {
    return new Object[] {
      getId(), getPublicKey(), getKeyType(), getSecUser(), getCreateTime(), getVersion()
    };
  }
  ...
  public boolean checkIfEligibleForDelete(Object ctx) {
    ...
    KeyPairIdentity checkKeyPairIdentity =
        Q.keyPairIdentityWithIdField().filterById(id).execute(ctx);

    return checkKeyPairIdentity != null
        && !checkKeyPairIdentity.getAllRelatedLists().stream()
            .flatMap(subList -> subList.stream())
            .findFirst()
            .isPresent();
  }

  public KeyPairIdentity save(com.doublechaintech.retailscm.RetailscmUserContext ctx) {
    try {
