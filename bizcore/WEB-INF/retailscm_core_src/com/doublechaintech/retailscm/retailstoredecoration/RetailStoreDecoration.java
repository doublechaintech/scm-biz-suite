...
public class RetailStoreDecoration extends BaseEntity implements java.io.Serializable {
  ...
  public void transferAllRelationshipsTo(RetailStoreDecoration target) {
    if (target == null) {
      return;
    }
  ...
  static {
    ...
    memberMetaInfoList.add(
        MemberMetaInfo.referBy(RETAIL_STORE_LIST, "decoration", "零售门店列表")
  ...
  public RetailStoreDecoration ignoreIdCriteria() {
  ...
  public RetailStoreDecoration ignoreCommentCriteria() {
  ...
  public RetailStoreDecoration ignoreVersionCriteria() {
  ...
  public RetailStoreDecoration addRetailStore(RetailStore retailStore) {
    retailStore.updateDecoration(this);
  ...
  public BaseEntity mergeDataFrom(BaseEntity sourceEntity) {
    ...
    if (sourceEntity instanceof RetailStoreDecoration) {

      RetailStoreDecoration source = (RetailStoreDecoration) sourceEntity;
  ...
  public boolean checkIfEligibleForDelete(Object ctx) {
    ...
    RetailStoreDecoration checkRetailStoreDecoration =
        Q.retailStoreDecorationWithIdField()
            .filterById(id)
            .selectRetailStoreList(Q.retailStoreWithIdField().limit(0, 1))
            .execute(ctx);

    return checkRetailStoreDecoration != null
        && !checkRetailStoreDecoration.getAllRelatedLists().stream()
            .flatMap(subList -> subList.stream())
            .findFirst()
            .isPresent();
  }

  public RetailStoreDecoration save(com.doublechaintech.retailscm.RetailscmUserContext ctx) {
    try {
