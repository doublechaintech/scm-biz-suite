...
public class RetailStoreDecorationTokens extends CommonTokens{
  ...
  public static RetailStoreDecorationTokens loadGroupTokens(String... groupNames){
    RetailStoreDecorationTokens tokens = start();
  ...
  private static void addToken(RetailStoreDecorationTokens pTokens, String pTokenName, String[] pGroupNames, String[] fieldGroups) {
	...
	public static RetailStoreDecorationTokens filterWithTokenViewGroups(String []viewGroups){
	...
	public static RetailStoreDecorationTokens allTokens(){
	...
	public RetailStoreDecorationTokens withRetailStoreListIfViewGroupInclude(String [] viewGroups){
