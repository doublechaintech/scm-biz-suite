...
public class RetailStoreDecorationMapper extends BaseRowMapper<RetailStoreDecoration> {
  ...
  public static RetailStoreDecorationMapper mapperForClass(Class<?> clazz) {

    RetailStoreDecorationMapper mapperForOverride = new RetailStoreDecorationMapper();
  ...
  protected void setId(RetailStoreDecoration retailStoreDecoration, ResultSet rs, int rowNumber)
      throws SQLException {
    try {
  ...
  protected void setComment(
      RetailStoreDecoration retailStoreDecoration, ResultSet rs, int rowNumber)
      throws SQLException {
    try {
      // there will be issue when the type is double/int/long
