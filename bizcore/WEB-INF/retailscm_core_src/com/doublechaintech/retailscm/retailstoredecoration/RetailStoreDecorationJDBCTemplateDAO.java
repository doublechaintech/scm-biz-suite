...
public class RetailStoreDecorationJDBCTemplateDAO extends RetailscmNamingServiceDAO implements RetailStoreDecorationDAO{
	...
	*/
    ...
    public SmartList<RetailStoreDecoration> requestCandidateRetailStoreDecorationForRetailStore(RetailscmUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
		...
		return findAllCandidateByFilter(RetailStoreDecorationTable.COLUMN_COMMENT, filterKey, pageNo, pageSize, getRetailStoreDecorationMapper());
    }
