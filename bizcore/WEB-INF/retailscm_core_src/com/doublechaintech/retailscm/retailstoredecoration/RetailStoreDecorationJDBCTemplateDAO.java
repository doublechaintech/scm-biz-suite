...
public class RetailStoreDecorationJDBCTemplateDAO extends RetailscmBaseDAOImpl
    implements RetailStoreDecorationDAO {
  ...
  */
  ...
  public Stream<RetailStoreDecoration> loadAllAsStream() {
    return this.loadAllAsStream(getRetailStoreDecorationMapper());
  }
  ...
  public RetailStoreDecoration save(
    ...
    String methodName =
        "save(RetailStoreDecoration retailStoreDecoration,Map<String,Object> options)";
  ...
  public RetailStoreDecoration clone(String retailStoreDecorationId, Map<String, Object> options)
      throws Exception {

    return clone(RetailStoreDecorationTable.withId(retailStoreDecorationId), options);
  }

  protected RetailStoreDecoration clone(AccessKey accessKey, Map<String, Object> options)
      throws Exception {
    ...
    RetailStoreDecoration newRetailStoreDecoration =
        loadInternalRetailStoreDecoration(accessKey, options);
  ...
  protected void throwIfHasException(String retailStoreDecorationId, int version, int count)
      throws Exception {
    if (count == 1) {
  ...
  public RetailStoreDecoration disconnectFromAll(String retailStoreDecorationId, int version)
    ...
    RetailStoreDecoration retailStoreDecoration =
        loadInternalRetailStoreDecoration(
            RetailStoreDecorationTable.withId(retailStoreDecorationId), emptyOptions());
  ...
  protected RetailStoreDecoration extractRetailStoreDecoration(
      AccessKey accessKey, Map<String, Object> loadOptions) throws Exception {
    try {
      RetailStoreDecoration retailStoreDecoration =
          loadSingleObject(accessKey, getRetailStoreDecorationMapper());
      return retailStoreDecoration;
    } catch (EmptyResultDataAccessException e) {
      throw new RetailStoreDecorationNotFoundException(
          "RetailStoreDecoration(" + accessKey + ") is not found!");
    }
  }

  protected RetailStoreDecoration loadInternalRetailStoreDecoration(
      AccessKey accessKey, Map<String, Object> loadOptions) throws Exception {

    RetailStoreDecoration retailStoreDecoration =
        extractRetailStoreDecoration(accessKey, loadOptions);
  ...
  protected RetailStoreDecoration extractRetailStoreList(
      RetailStoreDecoration retailStoreDecoration, Map<String, Object> options) {
    ...
    SmartList<RetailStore> retailStoreList =
        getRetailStoreDAO().findRetailStoreByDecoration(retailStoreDecoration.getId(), options);
  ...
  protected RetailStoreDecoration analyzeRetailStoreList(
      RetailStoreDecoration retailStoreDecoration, Map<String, Object> options) {
    ...
    if (retailStoreList != null) {
      getRetailStoreDAO()
          .analyzeRetailStoreByDecoration(retailStoreList, retailStoreDecoration.getId(), options);
    }
  ...
  protected RetailStoreDecoration saveRetailStoreDecoration(
    ...
    Beans.dbUtil().cacheCleanUp(retailStoreDecoration);
    ...
    retailStoreDecoration.afterSave();
    return retailStoreDecoration;
  }
  ...
  public SmartList<RetailStoreDecoration> saveRetailStoreDecorationList(
    ...
    batchRetailStoreDecorationRemove((List<RetailStoreDecoration>) lists[REMOVE_LIST_INDEX]);
    batchRetailStoreDecorationRecover((List<RetailStoreDecoration>) lists[RECOVER_LIST_INDEX]);
    ...
    for (RetailStoreDecoration retailStoreDecoration : retailStoreDecorationList) {
      ...
      if (retailStoreDecoration.isToRecover() || retailStoreDecoration.isToRemove()) {
        retailStoreDecoration.setVersion(-retailStoreDecoration.getVersion());
      }
    }
  ...
  protected List<Object[]> prepareRetailStoreDecorationBatchCreateArgs(
      List<RetailStoreDecoration> retailStoreDecorationList) {
  ...
  protected List<Object[]> prepareRetailStoreDecorationBatchUpdateArgs(
      List<RetailStoreDecoration> retailStoreDecorationList) {
  ...
  protected List<Object[]> prepareRetailStoreDecorationBatchRecoverArgs(
      List<RetailStoreDecoration> retailStoreDecorationList) {

    List<Object[]> parametersList = new ArrayList<Object[]>();
    for (RetailStoreDecoration retailStoreDecoration : retailStoreDecorationList) {
      if (!retailStoreDecoration.isToRecover()) {
        continue;
      }
      Object[] parameters = prepareRecoverParameters(retailStoreDecoration);
      parametersList.add(parameters);
    }
    return parametersList;
  }

  protected List<Object[]> prepareRetailStoreDecorationBatchRemoveArgs(
      List<RetailStoreDecoration> retailStoreDecorationList) {

    List<Object[]> parametersList = new ArrayList<Object[]>();
    for (RetailStoreDecoration retailStoreDecoration : retailStoreDecorationList) {
      if (!retailStoreDecoration.isToRemove()) {
        continue;
      }
      Object[] parameters = prepareRetailStoreDecorationRemoveParameters(retailStoreDecoration);
      parametersList.add(parameters);
    }
    return parametersList;
  }

  protected void batchRetailStoreDecorationCreate(
      List<RetailStoreDecoration> retailStoreDecorationList) {
  ...
  protected void batchRetailStoreDecorationUpdate(
      List<RetailStoreDecoration> retailStoreDecorationList) {
  ...
  protected void batchRetailStoreDecorationRemove(
      List<RetailStoreDecoration> retailStoreDecorationList) {
    String SQL = getRemoveSQL();
    List<Object[]> args = prepareRetailStoreDecorationBatchRemoveArgs(retailStoreDecorationList);
    int affectedNumbers[] = batchRemove(SQL, args);
    checkBatchReturn(affectedNumbers);
  }

  protected void batchRetailStoreDecorationRecover(
      List<RetailStoreDecoration> retailStoreDecorationList) {
    String SQL = getRecoverSQL();
    List<Object[]> args = prepareRetailStoreDecorationBatchRecoverArgs(retailStoreDecorationList);
  ...
  protected Object[] splitRetailStoreDecorationList(
      List<RetailStoreDecoration> retailStoreDecorationList) {

    List<RetailStoreDecoration> retailStoreDecorationCreateList =
        new ArrayList<RetailStoreDecoration>();
    List<RetailStoreDecoration> retailStoreDecorationUpdateList =
        new ArrayList<RetailStoreDecoration>();
    List<RetailStoreDecoration> retailStoreDecorationRemoveList =
        new ArrayList<RetailStoreDecoration>();
    List<RetailStoreDecoration> retailStoreDecorationRecoverList =
        new ArrayList<RetailStoreDecoration>();

    for (RetailStoreDecoration retailStoreDecoration : retailStoreDecorationList) {
      if (retailStoreDecoration.isToRemove()) {
        retailStoreDecorationRemoveList.add(retailStoreDecoration);
        continue;
      }
      if (retailStoreDecoration.isToRecover()) {
        retailStoreDecorationRecoverList.add(retailStoreDecoration);
        continue;
      }
    ...
    return new Object[] {
      retailStoreDecorationCreateList,
      retailStoreDecorationUpdateList,
      retailStoreDecorationRemoveList,
      retailStoreDecorationRecoverList
    };
  }
  ...
  protected Object[] getSaveRetailStoreDecorationParameters(
      RetailStoreDecoration retailStoreDecoration) {
    if (retailStoreDecoration.isToRemove()) {
      return prepareRetailStoreDecorationRemoveParameters(retailStoreDecoration);
    }
    if (retailStoreDecoration.isToRecover()) {
      return prepareRecoverParameters(retailStoreDecoration);
    }
  ...
  protected Object[] prepareRetailStoreDecorationRemoveParameters(
      RetailStoreDecoration retailStoreDecoration) {
    return super.prepareRemoveParameters(retailStoreDecoration);
  }

  protected Object[] prepareRetailStoreDecorationUpdateParameters(
      RetailStoreDecoration retailStoreDecoration) {
  ...
  protected Object[] prepareRetailStoreDecorationCreateParameters(
      RetailStoreDecoration retailStoreDecoration) {
  ...
  protected RetailStoreDecoration saveInternalRetailStoreDecoration(
      RetailStoreDecoration retailStoreDecoration, Map<String, Object> options) {
  ...
  protected RetailStoreDecoration saveRetailStoreList(
      RetailStoreDecoration retailStoreDecoration, Map<String, Object> options) {
  ...
  protected RetailStoreDecoration removeRetailStoreList(
      RetailStoreDecoration retailStoreDecoration, Map<String, Object> options) {
  ...
  public SmartList<RetailStoreDecoration> requestCandidateRetailStoreDecorationForRetailStore(
    ...
    return findAllCandidateByFilter(
        RetailStoreDecorationTable.COLUMN_COMMENT,
        null,
        filterKey,
        pageNo,
        pageSize,
        getRetailStoreDecorationMapper());
  }
  ...
  public void collectAndEnhance(BaseEntity ownerEntity) {
    List<RetailStoreDecoration> retailStoreDecorationList =
        ownerEntity.collectRefsWithType(RetailStoreDecoration.INTERNAL_TYPE);
  ...
  public Stream<RetailStoreDecoration> queryStream(String sql, Object... parameters) {
    return this.queryForStream(sql, parameters, this.getRetailStoreDecorationMapper());
  }
  ...
  @Override
  public List<RetailStoreDecoration> search(RetailStoreDecorationRequest pRequest) {
    return searchInternal(pRequest);
  }

  @Override
  protected RetailStoreDecorationMapper mapper() {
    return getRetailStoreDecorationMapper();
  }

  @Override
  protected RetailStoreDecorationMapper mapperForClazz(Class<?> clazz) {
    return RetailStoreDecorationMapper.mapperForClass(clazz);
  }
}
