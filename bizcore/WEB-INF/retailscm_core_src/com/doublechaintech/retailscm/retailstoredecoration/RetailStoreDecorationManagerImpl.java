...
public class RetailStoreDecorationManagerImpl extends CustomRetailscmCheckerManager implements RetailStoreDecorationManager, BusinessHandler{
	...
	public Object prepareContextForUserApp(BaseUserContext userContext,Object targetUserApp) throws Exception{
	 ...
	 public Object summaryView(RetailscmUserContext userContext, String retailStoreDecorationId) throws Exception{
		RetailStoreDecoration retailStoreDecoration = loadRetailStoreDecoration( userContext, retailStoreDecorationId, viewTokens());
	 ...
	 public Object analyze(RetailscmUserContext userContext, String retailStoreDecorationId) throws Exception{
		RetailStoreDecoration retailStoreDecoration = loadRetailStoreDecoration( userContext, retailStoreDecorationId, analyzeTokens());
		markVisited(userContext, retailStoreDecoration);
  ...
  @Override
  public List<RetailStoreDecoration> searchRetailStoreDecorationList(RetailscmUserContext ctx, RetailStoreDecorationRequest pRequest){
  ...
  @Override
  public RetailStoreDecoration searchRetailStoreDecoration(RetailscmUserContext ctx, RetailStoreDecorationRequest pRequest){
    pRequest.limit(0, 1);
