...
public class RetailStoreMemberAddressManagerImpl extends CustomRetailscmCheckerManager implements RetailStoreMemberAddressManager, BusinessHandler{
	...
	public Object prepareContextForUserApp(BaseUserContext userContext,Object targetUserApp) throws Exception{
	 ...
	 public Object summaryView(RetailscmUserContext userContext, String retailStoreMemberAddressId) throws Exception{
		RetailStoreMemberAddress retailStoreMemberAddress = loadRetailStoreMemberAddress( userContext, retailStoreMemberAddressId, viewTokens());
	 ...
	 public Object analyze(RetailscmUserContext userContext, String retailStoreMemberAddressId) throws Exception{
		RetailStoreMemberAddress retailStoreMemberAddress = loadRetailStoreMemberAddress( userContext, retailStoreMemberAddressId, analyzeTokens());
		markVisited(userContext, retailStoreMemberAddress);
  ...
  @Override
  public List<RetailStoreMemberAddress> searchRetailStoreMemberAddressList(RetailscmUserContext ctx, RetailStoreMemberAddressRequest pRequest){
  ...
  @Override
  public RetailStoreMemberAddress searchRetailStoreMemberAddress(RetailscmUserContext ctx, RetailStoreMemberAddressRequest pRequest){
    pRequest.limit(0, 1);
