...
public interface RetailStoreMemberAddressManager extends BaseManager{
  ...
  List<RetailStoreMemberAddress> searchRetailStoreMemberAddressList(RetailscmUserContext ctx, RetailStoreMemberAddressRequest pRequest);
  RetailStoreMemberAddress searchRetailStoreMemberAddress(RetailscmUserContext ctx, RetailStoreMemberAddressRequest pRequest);
	...
	public default void onUpdated(RetailscmUserContext userContext, RetailStoreMemberAddress updated, Object actor, String methodName) throws Exception {};
