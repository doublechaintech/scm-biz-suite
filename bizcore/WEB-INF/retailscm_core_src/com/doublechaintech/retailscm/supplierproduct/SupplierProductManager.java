...
public interface SupplierProductManager extends BaseManager{
  ...
  List<SupplierProduct> searchSupplierProductList(RetailscmUserContext ctx, SupplierProductRequest pRequest);
  SupplierProduct searchSupplierProduct(RetailscmUserContext ctx, SupplierProductRequest pRequest);
	...
	public default void onUpdated(RetailscmUserContext userContext, SupplierProduct updated, Object actor, String methodName) throws Exception {};
