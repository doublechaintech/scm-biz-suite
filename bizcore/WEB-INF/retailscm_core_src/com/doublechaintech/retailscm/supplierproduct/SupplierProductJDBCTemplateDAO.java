...
public class SupplierProductJDBCTemplateDAO extends RetailscmBaseDAOImpl
    implements SupplierProductDAO {
  ...
  public ProductSupplyDurationDAO getProductSupplyDurationDAO() {
    if (this.productSupplyDurationDAO == null) {
      throw new IllegalStateException(
          "The productSupplyDurationDAO is not configured yet, please config it some where.");
    }
  ...
  */
  ...
  public SupplierProduct clone(String supplierProductId, Map<String, Object> options)
      throws Exception {

    return clone(SupplierProductTable.withId(supplierProductId), options);
  }

  protected SupplierProduct clone(AccessKey accessKey, Map<String, Object> options)
      throws Exception {
  ...
  protected void throwIfHasException(String supplierProductId, int version, int count)
      throws Exception {
    if (count == 1) {
  ...
  public SupplierProduct disconnectFromAll(String supplierProductId, int version) throws Exception {
    ...
    SupplierProduct supplierProduct =
        loadInternalSupplierProduct(SupplierProductTable.withId(supplierProductId), emptyOptions());
  ...
  protected SupplierProduct extractSupplierProduct(
    ...
    try {
      ...
      throw new SupplierProductNotFoundException(
          "SupplierProduct(" + accessKey + ") is not found!");
    }
  }

  protected SupplierProduct loadInternalSupplierProduct(
      AccessKey accessKey, Map<String, Object> loadOptions) throws Exception {
  ...
  protected SupplierProduct extractSupplier(
      SupplierProduct supplierProduct, Map<String, Object> options) throws Exception {
  ...
  protected void enhanceProductSupplyDurationList(
  ...
  protected SupplierProduct extractProductSupplyDurationList(
      SupplierProduct supplierProduct, Map<String, Object> options) {
    ...
    SmartList<ProductSupplyDuration> productSupplyDurationList =
        getProductSupplyDurationDAO()
            .findProductSupplyDurationByProduct(supplierProduct.getId(), options);
  ...
  protected SupplierProduct analyzeProductSupplyDurationList(
      SupplierProduct supplierProduct, Map<String, Object> options) {
    ...
    SmartList<ProductSupplyDuration> productSupplyDurationList =
        supplierProduct.getProductSupplyDurationList();
    if (productSupplyDurationList != null) {
      getProductSupplyDurationDAO()
          .analyzeProductSupplyDurationByProduct(
              productSupplyDurationList, supplierProduct.getId(), options);
    }

    return supplierProduct;
  }

  public SmartList<SupplierProduct> findSupplierProductBySupplier(
      String goodsSupplierId, Map<String, Object> options) {

    SmartList<SupplierProduct> resultList =
        queryWith(
            SupplierProductTable.COLUMN_SUPPLIER,
            goodsSupplierId,
            options,
            getSupplierProductMapper());
  ...
  public void analyzeSupplierProductBySupplier(
      SmartList<SupplierProduct> resultList, String goodsSupplierId, Map<String, Object> options) {
    if (resultList == null) {
  ...
  @Override
  public Map<String, Integer> countSupplierProductBySupplierIds(
  ...
  public SmartList<SupplierProduct> saveSupplierProductList(
    ...
    batchSupplierProductRemove((List<SupplierProduct>) lists[REMOVE_LIST_INDEX]);
    batchSupplierProductRecover((List<SupplierProduct>) lists[RECOVER_LIST_INDEX]);
    ...
    for (SupplierProduct supplierProduct : supplierProductList) {
      ...
      if (supplierProduct.isToRecover() || supplierProduct.isToRemove()) {
        supplierProduct.setVersion(-supplierProduct.getVersion());
      }
    }
  ...
  public SmartList<SupplierProduct> removeSupplierProductList(
      SmartList<SupplierProduct> supplierProductList, Map<String, Object> options) {
  ...
  protected List<Object[]> prepareSupplierProductBatchCreateArgs(
  ...
  protected List<Object[]> prepareSupplierProductBatchUpdateArgs(
      List<SupplierProduct> supplierProductList) {
  ...
  protected List<Object[]> prepareSupplierProductBatchRecoverArgs(
      List<SupplierProduct> supplierProductList) {

    List<Object[]> parametersList = new ArrayList<Object[]>();
    for (SupplierProduct supplierProduct : supplierProductList) {
      if (!supplierProduct.isToRecover()) {
        continue;
      }
      Object[] parameters = prepareRecoverParameters(supplierProduct);
      parametersList.add(parameters);
    }
    return parametersList;
  }

  protected List<Object[]> prepareSupplierProductBatchRemoveArgs(
      List<SupplierProduct> supplierProductList) {

    List<Object[]> parametersList = new ArrayList<Object[]>();
    for (SupplierProduct supplierProduct : supplierProductList) {
      if (!supplierProduct.isToRemove()) {
        continue;
      }
      Object[] parameters = prepareSupplierProductRemoveParameters(supplierProduct);
      parametersList.add(parameters);
    }
    return parametersList;
  }
  ...
  protected void batchSupplierProductRemove(List<SupplierProduct> supplierProductList) {
    String SQL = getRemoveSQL();
    List<Object[]> args = prepareSupplierProductBatchRemoveArgs(supplierProductList);
    int affectedNumbers[] = batchRemove(SQL, args);
    checkBatchReturn(affectedNumbers);
  }

  protected void batchSupplierProductRecover(List<SupplierProduct> supplierProductList) {
    String SQL = getRecoverSQL();
    List<Object[]> args = prepareSupplierProductBatchRecoverArgs(supplierProductList);
  ...
  protected Object[] splitSupplierProductList(List<SupplierProduct> supplierProductList) {
    ...
    List<SupplierProduct> supplierProductRemoveList = new ArrayList<SupplierProduct>();
    List<SupplierProduct> supplierProductRecoverList = new ArrayList<SupplierProduct>();

    for (SupplierProduct supplierProduct : supplierProductList) {
      if (supplierProduct.isToRemove()) {
        supplierProductRemoveList.add(supplierProduct);
        continue;
      }
      if (supplierProduct.isToRecover()) {
        supplierProductRecoverList.add(supplierProduct);
        continue;
      }
    ...
    return new Object[] {
      supplierProductCreateList,
      supplierProductUpdateList,
      supplierProductRemoveList,
      supplierProductRecoverList
    };
  }
  ...
  protected Object[] getSaveSupplierProductParameters(SupplierProduct supplierProduct) {
    if (supplierProduct.isToRemove()) {
      return prepareSupplierProductRemoveParameters(supplierProduct);
    }
    if (supplierProduct.isToRecover()) {
      return prepareRecoverParameters(supplierProduct);
    }
  ...
  protected Object[] prepareSupplierProductRemoveParameters(SupplierProduct supplierProduct) {
    return super.prepareRemoveParameters(supplierProduct);
  }
  ...
  protected SupplierProduct saveInternalSupplierProduct(
      SupplierProduct supplierProduct, Map<String, Object> options) {
  ...
  protected SupplierProduct saveSupplier(
      SupplierProduct supplierProduct, Map<String, Object> options) {
  ...
  public SupplierProduct planToRemoveProductSupplyDurationList(
      SupplierProduct supplierProduct,
    ...
    SmartList<ProductSupplyDuration> externalProductSupplyDurationList =
        getProductSupplyDurationDAO().findProductSupplyDurationWithKey(key, options);
  ...
  protected SupplierProduct saveProductSupplyDurationList(
      SupplierProduct supplierProduct, Map<String, Object> options) {
    ...
    SmartList<ProductSupplyDuration> mergedUpdateProductSupplyDurationList =
        new SmartList<ProductSupplyDuration>();
    ...
    getProductSupplyDurationDAO()
        .saveProductSupplyDurationList(mergedUpdateProductSupplyDurationList, options);
  ...
  protected SupplierProduct removeProductSupplyDurationList(
      SupplierProduct supplierProduct, Map<String, Object> options) {
    ...
    SmartList<ProductSupplyDuration> toRemoveProductSupplyDurationList =
        productSupplyDurationList.getToRemoveList();
    ...
    getProductSupplyDurationDAO()
        .removeProductSupplyDurationList(toRemoveProductSupplyDurationList, options);
  ...
  protected SupplierProduct presentProductSupplyDurationList(
    ...
    SmartList<ProductSupplyDuration> productSupplyDurationList =
        supplierProduct.getProductSupplyDurationList();
    SmartList<ProductSupplyDuration> newList =
        presentSubList(
  ...
  public SmartList<SupplierProduct> requestCandidateSupplierProductForProductSupplyDuration(
    ...
    return findAllCandidateByFilter(
        SupplierProductTable.COLUMN_PRODUCT_NAME,
        SupplierProductTable.COLUMN_SUPPLIER,
        filterKey,
        pageNo,
        pageSize,
  ...
  public void collectAndEnhance(BaseEntity ownerEntity) {
    List<SupplierProduct> supplierProductList =
        ownerEntity.collectRefsWithType(SupplierProduct.INTERNAL_TYPE);
    this.enhanceList(supplierProductList);
  }

  @Override
  public SmartList<SupplierProduct> findSupplierProductWithKey(
  ...
  public Map<String, Integer> countSupplierProductWithGroupKey(
  ...
  @Override
  public CandidateSupplierProduct executeCandidatesQuery(
  ...
  @Override
  protected SupplierProductMapper mapperForClazz(Class<?> clazz) {
    return SupplierProductMapper.mapperForClass(clazz);
  }
}
