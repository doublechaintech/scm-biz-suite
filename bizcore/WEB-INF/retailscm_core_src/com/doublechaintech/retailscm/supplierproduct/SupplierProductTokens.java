...
public class SupplierProductTokens extends CommonTokens{
  ...
  private static void addToken(SupplierProductTokens pTokens, String pTokenName, String[] pGroupNames, String[] fieldGroups) {
	...
	public static SupplierProductTokens filterWithTokenViewGroups(String []viewGroups){
		...
		return start()
			.withSupplier()
			.withProductSupplyDurationListIfViewGroupInclude(viewGroups);
	...
	public SupplierProductTokens withProductSupplyDurationListIfViewGroupInclude(String [] viewGroups){
