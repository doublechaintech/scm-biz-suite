...
import com.doublechaintech.retailscm.*;import com.doublechaintech.retailscm.BaseViewPage;import com.doublechaintech.retailscm.RetailscmUserContextImpl;import com.doublechaintech.retailscm.goodssupplier.CandidateGoodsSupplier;import com.doublechaintech.retailscm.goodssupplier.GoodsSupplier;import com.doublechaintech.retailscm.iamservice.*;import com.doublechaintech.retailscm.productsupplyduration.ProductSupplyDuration;import com.doublechaintech.retailscm.secuser.SecUser;import com.doublechaintech.retailscm.services.IamService;import com.doublechaintech.retailscm.supplierproduct.SupplierProduct;import com.doublechaintech.retailscm.tree.*;import com.doublechaintech.retailscm.treenode.*;import com.doublechaintech.retailscm.userapp.UserApp;import com.doublechaintech.retailscm.utils.ModelAssurance;
...
public class SupplierProductManagerImpl extends CustomRetailscmCheckerManager implements SupplierProductManager, BusinessHandler{
	...
	public Object prepareContextForUserApp(BaseUserContext userContext,Object targetUserApp) throws Exception{
	 ...
	 public Object summaryView(RetailscmUserContext userContext, String supplierProductId) throws Exception{
		SupplierProduct supplierProduct = loadSupplierProduct( userContext, supplierProductId, viewTokens());
	 ...
	 public Object analyze(RetailscmUserContext userContext, String supplierProductId) throws Exception{
		SupplierProduct supplierProduct = loadSupplierProduct( userContext, supplierProductId, analyzeTokens());
		markVisited(userContext, supplierProduct);
  ...
  @Override
  public List<SupplierProduct> searchSupplierProductList(RetailscmUserContext ctx, SupplierProductRequest pRequest){
  ...
  @Override
  public SupplierProduct searchSupplierProduct(RetailscmUserContext ctx, SupplierProductRequest pRequest){
    pRequest.limit(0, 1);
 ...
 //--------------------------------------------------------------
	...
	public  SupplierProduct updateProductSupplyDuration(RetailscmUserContext userContext, String supplierProductId, String productSupplyDurationId, int productSupplyDurationVersion, String property, String newValueExpr,String [] tokensExpr)
		...
		synchronized(supplierProduct){
			...
			supplierProduct = saveSupplierProduct(userContext, supplierProduct, tokens().withProductSupplyDurationList().done());
			productSupplyDurationManagerOf(userContext).onUpdated(userContext, productSupplyDuration, this, "updateProductSupplyDuration");
			return present(userContext,supplierProduct, mergedAllTokens(tokensExpr));
		}
