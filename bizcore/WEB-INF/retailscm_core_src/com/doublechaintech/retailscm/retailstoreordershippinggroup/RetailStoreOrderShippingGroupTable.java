...
public class RetailStoreOrderShippingGroupTable {
  ...
  // protected
  public static final String TABLE_NAME = "retail_store_order_shipping_group_data";
  ...
  public static final String[] ALL_CLOUMNS = {
    COLUMN_ID, COLUMN_NAME, COLUMN_BIZ_ORDER, COLUMN_AMOUNT, COLUMN_VERSION
  };
  ...
  public static void ensureTable(RetailscmUserContext userContext, Map<String, Object> result)
    ...
    RetailscmBaseUtils.ensureTable(
        userContext,
        result,
        "retail_store_order_shipping_group_data",
        new String[][] {
        ...
        new String[] {
          ...
          "alter table retail_store_order_shipping_group_data add constraint fk4biz_order_of_retail_store_order_shipping_group_data foreign key (biz_order) references retail_store_order_data(id) ON DELETE CASCADE ON UPDATE CASCADE;",
          ""
        });
  }
}
