...
public class RetailStoreOrderShippingGroupMapper
    extends BaseRowMapper<RetailStoreOrderShippingGroup> {

  public static RetailStoreOrderShippingGroupMapper mapperForClass(Class<?> clazz) {

    RetailStoreOrderShippingGroupMapper mapperForOverride =
        new RetailStoreOrderShippingGroupMapper();
    mapperForOverride.setClazz(clazz);
    return mapperForOverride;
  }

  protected RetailStoreOrderShippingGroup internalMapRow(ResultSet rs, int rowNumber)
      throws SQLException {
    RetailStoreOrderShippingGroup retailStoreOrderShippingGroup =
        getRetailStoreOrderShippingGroup();
  ...
  protected void setId(
      RetailStoreOrderShippingGroup retailStoreOrderShippingGroup, ResultSet rs, int rowNumber)
      throws SQLException {
    try {
  ...
  protected void setBizOrder(
    ...
    if (retailStoreOrder != null) {
      // if the root object 'retailStoreOrderShippingGroup' already have the property, just set the
      // id for it;
