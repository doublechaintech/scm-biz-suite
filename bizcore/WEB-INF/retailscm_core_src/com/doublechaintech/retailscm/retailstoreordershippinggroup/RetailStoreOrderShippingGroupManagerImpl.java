...
public class RetailStoreOrderShippingGroupManagerImpl extends CustomRetailscmCheckerManager
    implements RetailStoreOrderShippingGroupManager, BusinessHandler {
  ...
  protected void throwExceptionWithMessage(String value)
      throws RetailStoreOrderShippingGroupManagerException {
  ...
  protected RetailStoreOrderShippingGroup saveRetailStoreOrderShippingGroupDetail(
      RetailscmUserContext userContext, RetailStoreOrderShippingGroup retailStoreOrderShippingGroup)
      throws Exception {

    return saveRetailStoreOrderShippingGroup(
        userContext, retailStoreOrderShippingGroup, allTokens());
  }

  public RetailStoreOrderShippingGroup loadRetailStoreOrderShippingGroup(
      RetailscmUserContext userContext, String retailStoreOrderShippingGroupId, String[] tokensExpr)
      throws Exception {

    checkerOf(userContext).checkIdOfRetailStoreOrderShippingGroup(retailStoreOrderShippingGroupId);

    checkerOf(userContext)
        .throwExceptionIfHasErrors(RetailStoreOrderShippingGroupManagerException.class);

    Map<String, Object> tokens = parseTokens(tokensExpr);

    RetailStoreOrderShippingGroup retailStoreOrderShippingGroup =
        loadRetailStoreOrderShippingGroup(userContext, retailStoreOrderShippingGroupId, tokens);
    // do some calc before sent to customer?
    return present(userContext, retailStoreOrderShippingGroup, tokens);
  }

  public RetailStoreOrderShippingGroup searchRetailStoreOrderShippingGroup(
      RetailscmUserContext userContext,
  ...
  protected RetailStoreOrderShippingGroup present(
      RetailscmUserContext userContext,
      RetailStoreOrderShippingGroup retailStoreOrderShippingGroup,
      Map<String, Object> tokens)
      throws Exception {
    ...
    RetailStoreOrderShippingGroup retailStoreOrderShippingGroupToPresent =
        retailStoreOrderShippingGroupDaoOf(userContext)
            .present(retailStoreOrderShippingGroup, tokens);

    List<BaseEntity> entityListToNaming =
        retailStoreOrderShippingGroupToPresent.collectReferencesFromLists();
  ...
  public RetailStoreOrderShippingGroup loadRetailStoreOrderShippingGroupDetail(
      RetailscmUserContext userContext, String retailStoreOrderShippingGroupId) throws Exception {
    RetailStoreOrderShippingGroup retailStoreOrderShippingGroup =
        loadRetailStoreOrderShippingGroup(
            userContext, retailStoreOrderShippingGroupId, allTokens());
  ...
  public Object view(RetailscmUserContext userContext, String retailStoreOrderShippingGroupId)
      throws Exception {
    RetailStoreOrderShippingGroup retailStoreOrderShippingGroup =
        loadRetailStoreOrderShippingGroup(
            userContext, retailStoreOrderShippingGroupId, viewTokens());
  ...
  public Object analyze(RetailscmUserContext userContext, String retailStoreOrderShippingGroupId)
      throws Exception {
    RetailStoreOrderShippingGroup retailStoreOrderShippingGroup =
        loadRetailStoreOrderShippingGroup(
            userContext, retailStoreOrderShippingGroupId, analyzeTokens());
    markVisited(userContext, retailStoreOrderShippingGroup);
  ...
  protected RetailStoreOrderShippingGroup saveRetailStoreOrderShippingGroup(
    ...
    return retailStoreOrderShippingGroupDaoOf(userContext)
        .save(retailStoreOrderShippingGroup, tokens);
  }

  protected RetailStoreOrderShippingGroup loadRetailStoreOrderShippingGroup(
      RetailscmUserContext userContext,
      String retailStoreOrderShippingGroupId,
      Map<String, Object> tokens)
      throws Exception {
    ...
    return retailStoreOrderShippingGroupDaoOf(userContext)
        .load(retailStoreOrderShippingGroupId, tokens);
  }
  ...
  protected <T extends BaseEntity> void addActions(
    ...
    // userContext, RetailStoreOrderShippingGroup retailStoreOrderShippingGroup, Map<String, Object>
    // tokens){

  @Override
  public List<RetailStoreOrderShippingGroup> searchRetailStoreOrderShippingGroupList(
      RetailscmUserContext ctx, RetailStoreOrderShippingGroupRequest pRequest) {
  ...
  public RetailStoreOrderShippingGroup searchRetailStoreOrderShippingGroup(
    ...
    List<RetailStoreOrderShippingGroup> list =
        searchRetailStoreOrderShippingGroupList(ctx, pRequest);
  ...
  public RetailStoreOrderShippingGroup createRetailStoreOrderShippingGroup(
    ...
    RetailStoreOrderShippingGroup retailStoreOrderShippingGroup =
        createNewRetailStoreOrderShippingGroup();
    ...
    retailStoreOrderShippingGroup =
        saveRetailStoreOrderShippingGroup(
            userContext, retailStoreOrderShippingGroup, emptyOptions());
  ...
  public RetailStoreOrderShippingGroup clone(
      RetailscmUserContext userContext, String fromRetailStoreOrderShippingGroupId)
      throws Exception {

    return retailStoreOrderShippingGroupDaoOf(userContext)
        .clone(fromRetailStoreOrderShippingGroupId, this.allTokens());
  }

  public RetailStoreOrderShippingGroup internalSaveRetailStoreOrderShippingGroup(
      RetailscmUserContext userContext, RetailStoreOrderShippingGroup retailStoreOrderShippingGroup)
      throws Exception {
    return internalSaveRetailStoreOrderShippingGroup(
        userContext, retailStoreOrderShippingGroup, allTokens());
  }
  ...
  public RetailStoreOrderShippingGroup internalSaveRetailStoreOrderShippingGroup(
      ...
      throws Exception {
    // checkParamsForUpdatingRetailStoreOrderShippingGroup(userContext,
    // retailStoreOrderShippingGroupId, retailStoreOrderShippingGroupVersion, property,
    ...
    synchronized (retailStoreOrderShippingGroup) {
      ...
      retailStoreOrderShippingGroup =
          saveRetailStoreOrderShippingGroup(userContext, retailStoreOrderShippingGroup, options);
      return retailStoreOrderShippingGroup;
    }
  }

  public RetailStoreOrderShippingGroup updateRetailStoreOrderShippingGroup(
      RetailscmUserContext userContext,
      String retailStoreOrderShippingGroupId,
      int retailStoreOrderShippingGroupVersion,
      String property,
    ...
    synchronized (retailStoreOrderShippingGroup) {
      ...
      retailStoreOrderShippingGroup =
          saveRetailStoreOrderShippingGroup(
              userContext, retailStoreOrderShippingGroup, tokens().done());
      return present(userContext, retailStoreOrderShippingGroup, mergedAllTokens(tokensExpr));
      // return saveRetailStoreOrderShippingGroup(userContext, retailStoreOrderShippingGroup,
      // tokens().done());
    }
  }

  public RetailStoreOrderShippingGroup updateRetailStoreOrderShippingGroupProperty(
      RetailscmUserContext userContext,
      String retailStoreOrderShippingGroupId,
      int retailStoreOrderShippingGroupVersion,
      String property,
  ...
  public RetailStoreOrderShippingGroup transferToAnotherBizOrder(
      RetailscmUserContext userContext,
      String retailStoreOrderShippingGroupId,
      String anotherBizOrderId)
      throws Exception {
    checkParamsForTransferingAnotherBizOrder(
        userContext, retailStoreOrderShippingGroupId, anotherBizOrderId);
  ...
  public RetailStoreOrderShippingGroup forgetByAll(
      RetailscmUserContext userContext,
      String retailStoreOrderShippingGroupId,
      int retailStoreOrderShippingGroupVersion)
      throws Exception {
    return forgetByAllInternal(
        userContext, retailStoreOrderShippingGroupId, retailStoreOrderShippingGroupVersion);
  }

  protected RetailStoreOrderShippingGroup forgetByAllInternal(
      RetailscmUserContext userContext,
      String retailStoreOrderShippingGroupId,
      int retailStoreOrderShippingGroupVersion)
      throws Exception {
    ...
    return retailStoreOrderShippingGroupDaoOf(userContext)
        .disconnectFromAll(retailStoreOrderShippingGroupId, retailStoreOrderShippingGroupVersion);
  }
  ...
  public void onNewInstanceCreated(
      RetailscmUserContext userContext, RetailStoreOrderShippingGroup newCreated) throws Exception {
    ensureRelationInGraph(userContext, newCreated);
    sendCreationEvent(userContext, newCreated);
  }

  public void sendAllItems(RetailscmUserContext ctx) throws Exception {
    retailStoreOrderShippingGroupDaoOf(ctx)
        .loadAllAsStream()
  ...
  public void onAuthenticateNewUserLogged(
    ...
    // this.createRetailStoreOrderShippingGroup(userContext, ...
  ...
  protected void enhanceForListOfView(
      RetailscmUserContext userContext, SmartList<RetailStoreOrderShippingGroup> list)
      throws Exception {
    if (list == null || list.isEmpty()) {
      return;
    }
  ...
  public Object listPageByBizOrder(
    ...
    SmartList<RetailStoreOrderShippingGroup> list =
        retailStoreOrderShippingGroupDaoOf(userContext)
            .findRetailStoreOrderShippingGroupByBizOrder(bizOrderId, start, count, new HashMap<>());
   ...
   * @throws Exception
   */
  public Object wxappview(RetailscmUserContext userContext, String retailStoreOrderShippingGroupId)
      throws Exception {
    SerializeScope vscope = SerializeScope.EXCLUDE().nothing();
    RetailStoreOrderShippingGroup merchantObj =
        (RetailStoreOrderShippingGroup) this.view(userContext, retailStoreOrderShippingGroupId);
