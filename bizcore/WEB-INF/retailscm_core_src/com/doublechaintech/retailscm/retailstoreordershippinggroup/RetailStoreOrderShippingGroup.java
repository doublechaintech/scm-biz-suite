...
public class RetailStoreOrderShippingGroup extends BaseEntity implements java.io.Serializable {
  ...
  public void transferAllRelationshipsTo(RetailStoreOrderShippingGroup target) {
    if (target == null) {
      return;
    }
  }
  ...
  public RetailStoreOrderShippingGroup updateId(String id) {
    String oldId = this.id;
    String newId = trimString(id);
  ...
  public RetailStoreOrderShippingGroup ignoreIdCriteria() {
  ...
  public RetailStoreOrderShippingGroup updateName(String name) {
    String oldName = this.name;
    String newName = trimString(name);
  ...
  public RetailStoreOrderShippingGroup ignoreNameCriteria() {
    super.ignoreSearchProperty(NAME_PROPERTY);
    return this;
  }

  public RetailStoreOrderShippingGroup addNameCriteria(
  ...
  public RetailStoreOrderShippingGroup updateBizOrder(RetailStoreOrder bizOrder) {
    RetailStoreOrder oldBizOrder = this.bizOrder;
    RetailStoreOrder newBizOrder = bizOrder;
  ...
  public RetailStoreOrderShippingGroup ignoreBizOrderCriteria() {
    super.ignoreSearchProperty(BIZ_ORDER_PROPERTY);
    return this;
  }

  public RetailStoreOrderShippingGroup addBizOrderCriteria(
      QueryOperator operator, Object... parameters) {
  ...
  public RetailStoreOrderShippingGroup updateBizOrderByReferenceId(String bizOrderId) {
  ...
  public RetailStoreOrderShippingGroup updateAmount(BigDecimal amount) {
    BigDecimal oldAmount = this.amount;
    BigDecimal newAmount = amount;
  ...
  public RetailStoreOrderShippingGroup ignoreAmountCriteria() {
    super.ignoreSearchProperty(AMOUNT_PROPERTY);
    return this;
  }

  public RetailStoreOrderShippingGroup addAmountCriteria(
      QueryOperator operator, Object... parameters) {
  ...
  public RetailStoreOrderShippingGroup updateVersion(int version) {
    int oldVersion = this.version;
    int newVersion = version;
  ...
  public RetailStoreOrderShippingGroup ignoreVersionCriteria() {
    super.ignoreSearchProperty(VERSION_PROPERTY);
    return this;
  }

  public RetailStoreOrderShippingGroup addVersionCriteria(
      QueryOperator operator, Object... parameters) {
  ...
  public BaseEntity mergeDataFrom(BaseEntity sourceEntity) {
    ...
    if (sourceEntity instanceof RetailStoreOrderShippingGroup) {

      RetailStoreOrderShippingGroup source = (RetailStoreOrderShippingGroup) sourceEntity;
  ...
  public boolean checkIfEligibleForDelete(Object ctx) {
    ...
    RetailStoreOrderShippingGroup checkRetailStoreOrderShippingGroup =
        Q.retailStoreOrderShippingGroupWithIdField().filterById(id).execute(ctx);

    return checkRetailStoreOrderShippingGroup != null
        && !checkRetailStoreOrderShippingGroup.getAllRelatedLists().stream()
