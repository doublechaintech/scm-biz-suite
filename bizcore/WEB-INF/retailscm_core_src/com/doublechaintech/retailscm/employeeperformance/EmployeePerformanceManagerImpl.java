...
public class EmployeePerformanceManagerImpl extends CustomRetailscmCheckerManager
    implements EmployeePerformanceManager, BusinessHandler {
  ...
  protected void throwExceptionWithMessage(String value)
      throws EmployeePerformanceManagerException {
  ...
  protected EmployeePerformance saveEmployeePerformance(
  ...
  protected EmployeePerformance saveEmployeePerformanceDetail(
      RetailscmUserContext userContext, EmployeePerformance employeePerformance) throws Exception {

    return saveEmployeePerformance(userContext, employeePerformance, allTokens());
  }

  public EmployeePerformance loadEmployeePerformance(
      RetailscmUserContext userContext, String employeePerformanceId, String[] tokensExpr)
      throws Exception {
    ...
    EmployeePerformance employeePerformance =
        loadEmployeePerformance(userContext, employeePerformanceId, tokens);
    // do some calc before sent to customer?
    return present(userContext, employeePerformance, tokens);
  }

  public EmployeePerformance searchEmployeePerformance(
      RetailscmUserContext userContext,
  ...
  protected EmployeePerformance present(
      RetailscmUserContext userContext,
      EmployeePerformance employeePerformance,
      Map<String, Object> tokens)
      throws Exception {
    ...
    EmployeePerformance employeePerformanceToPresent =
        employeePerformanceDaoOf(userContext).present(employeePerformance, tokens);

    List<BaseEntity> entityListToNaming = employeePerformanceToPresent.collectReferencesFromLists();
  ...
  public EmployeePerformance loadEmployeePerformanceDetail(
      RetailscmUserContext userContext, String employeePerformanceId) throws Exception {
    EmployeePerformance employeePerformance =
        loadEmployeePerformance(userContext, employeePerformanceId, allTokens());
  ...
  public Object view(RetailscmUserContext userContext, String employeePerformanceId)
      throws Exception {
    EmployeePerformance employeePerformance =
        loadEmployeePerformance(userContext, employeePerformanceId, viewTokens());
    markVisited(userContext, employeePerformance);
    return present(userContext, employeePerformance, viewTokens());
  }

  public Object summaryView(RetailscmUserContext userContext, String employeePerformanceId)
      throws Exception {
    EmployeePerformance employeePerformance =
        loadEmployeePerformance(userContext, employeePerformanceId, viewTokens());
  ...
  public Object analyze(RetailscmUserContext userContext, String employeePerformanceId)
      throws Exception {
    EmployeePerformance employeePerformance =
        loadEmployeePerformance(userContext, employeePerformanceId, analyzeTokens());
    markVisited(userContext, employeePerformance);
  ...
  protected EmployeePerformance loadEmployeePerformance(
      RetailscmUserContext userContext, String employeePerformanceId, Map<String, Object> tokens)
      throws Exception {
    checkerOf(userContext).checkIdOfEmployeePerformance(employeePerformanceId);
  ...
  protected <T extends BaseEntity> void addActions(
    ...
    // userContext, EmployeePerformance employeePerformance, Map<String, Object> tokens){

  @Override
  public List<EmployeePerformance> searchEmployeePerformanceList(
      RetailscmUserContext ctx, EmployeePerformanceRequest pRequest) {
  ...
  public EmployeePerformance createEmployeePerformance(
      RetailscmUserContext userContext, String employeeId, String performanceComment)
      throws Exception {
  ...
  public EmployeePerformance clone(
      RetailscmUserContext userContext, String fromEmployeePerformanceId) throws Exception {

    return employeePerformanceDaoOf(userContext).clone(fromEmployeePerformanceId, this.allTokens());
  }

  public EmployeePerformance internalSaveEmployeePerformance(
      RetailscmUserContext userContext, EmployeePerformance employeePerformance) throws Exception {
  ...
  public EmployeePerformance internalSaveEmployeePerformance(
      ...
      throws Exception {
    // checkParamsForUpdatingEmployeePerformance(userContext, employeePerformanceId,
    // employeePerformanceVersion, property, newValueExpr, tokensExpr);
  ...
  public EmployeePerformance updateEmployeePerformance(
      RetailscmUserContext userContext,
      String employeePerformanceId,
      int employeePerformanceVersion,
      String property,
    ...
    synchronized (employeePerformance) {
      ...
      employeePerformance =
          saveEmployeePerformance(userContext, employeePerformance, tokens().done());
  ...
  public EmployeePerformance updateEmployeePerformanceProperty(
      RetailscmUserContext userContext,
      String employeePerformanceId,
      int employeePerformanceVersion,
      String property,
  ...
  protected void checkParamsForTransferingAnotherEmployee(
      RetailscmUserContext userContext, String employeePerformanceId, String anotherEmployeeId)
      throws Exception {
  ...
  public EmployeePerformance transferToAnotherEmployee(
      RetailscmUserContext userContext, String employeePerformanceId, String anotherEmployeeId)
      throws Exception {
    ...
    synchronized (employeePerformance) {
      ...
      employeePerformance =
          saveEmployeePerformance(userContext, employeePerformance, emptyOptions());
  ...
  public CandidateEmployee requestCandidateEmployee(
    ...
    SmartList<Employee> candidateList =
        employeeDaoOf(userContext)
            .requestCandidateEmployeeForEmployeePerformance(
  ...
  public EmployeePerformance forgetByAll(
      RetailscmUserContext userContext,
      String employeePerformanceId,
      int employeePerformanceVersion)
      throws Exception {
  ...
  protected EmployeePerformance forgetByAllInternal(
      RetailscmUserContext userContext,
      String employeePerformanceId,
      int employeePerformanceVersion)
      throws Exception {
    ...
    return employeePerformanceDaoOf(userContext)
        .disconnectFromAll(employeePerformanceId, employeePerformanceVersion);
  }
  ...
  public void onNewInstanceCreated(RetailscmUserContext userContext, EmployeePerformance newCreated)
      throws Exception {
  ...
  public void sendAllItems(RetailscmUserContext ctx) throws Exception {
    employeePerformanceDaoOf(ctx).loadAllAsStream().forEach(event -> sendInitEvent(ctx, event));
  }
  ...
  protected void enhanceForListOfView(
      RetailscmUserContext userContext, SmartList<EmployeePerformance> list) throws Exception {
    if (list == null || list.isEmpty()) {
      return;
    }
  ...
  public Object listPageByEmployee(
    ...
    SmartList<EmployeePerformance> list =
        employeePerformanceDaoOf(userContext)
            .findEmployeePerformanceByEmployee(employeeId, start, count, new HashMap<>());
   ...
   * @throws Exception
   */
  public Object wxappview(RetailscmUserContext userContext, String employeePerformanceId)
      throws Exception {
    SerializeScope vscope = SerializeScope.EXCLUDE().nothing();
    EmployeePerformance merchantObj =
        (EmployeePerformance) this.view(userContext, employeePerformanceId);
