...
public class ReceivingSpaceTokens extends CommonTokens {
  ...
  public static ReceivingSpaceTokens loadGroupTokens(String... groupNames) {
    ReceivingSpaceTokens tokens = start();
  ...
  private static void addToken(
      ReceivingSpaceTokens pTokens, String pTokenName, String[] pGroupNames, String[] fieldGroups) {
  ...
  public static ReceivingSpaceTokens filterWithTokenViewGroups(String[] viewGroups) {

    return start().withWarehouse().withGoodsListIfViewGroupInclude(viewGroups);
  }

  public static ReceivingSpaceTokens allTokens() {

    return start().withWarehouse().withGoodsList();
  }
  ...
  public ReceivingSpaceTokens withGoodsListIfViewGroupInclude(String[] viewGroups) {
