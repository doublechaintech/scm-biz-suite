...
public class ReceivingSpaceJDBCTemplateDAO extends RetailscmBaseDAOImpl
    implements ReceivingSpaceDAO {
  ...
  */
  ...
  public ReceivingSpace clone(String receivingSpaceId, Map<String, Object> options)
      throws Exception {

    return clone(ReceivingSpaceTable.withId(receivingSpaceId), options);
  }

  protected ReceivingSpace clone(AccessKey accessKey, Map<String, Object> options)
      throws Exception {
  ...
  protected void throwIfHasException(String receivingSpaceId, int version, int count)
      throws Exception {
    if (count == 1) {
  ...
  public ReceivingSpace disconnectFromAll(String receivingSpaceId, int version) throws Exception {
    ...
    ReceivingSpace receivingSpace =
        loadInternalReceivingSpace(ReceivingSpaceTable.withId(receivingSpaceId), emptyOptions());
  ...
  protected ReceivingSpace extractReceivingSpace(
  ...
  protected ReceivingSpace loadInternalReceivingSpace(
      AccessKey accessKey, Map<String, Object> loadOptions) throws Exception {
  ...
  protected ReceivingSpace extractWarehouse(
      ReceivingSpace receivingSpace, Map<String, Object> options) throws Exception {
  ...
  protected ReceivingSpace extractGoodsList(
      ReceivingSpace receivingSpace, Map<String, Object> options) {
    ...
    SmartList<Goods> goodsList =
        getGoodsDAO().findGoodsByReceivingSpace(receivingSpace.getId(), options);
    if (goodsList != null) {
  ...
  protected ReceivingSpace analyzeGoodsList(
      ReceivingSpace receivingSpace, Map<String, Object> options) {
  ...
  public SmartList<ReceivingSpace> findReceivingSpaceByWarehouse(
      String warehouseId, Map<String, Object> options) {

    SmartList<ReceivingSpace> resultList =
        queryWith(
            ReceivingSpaceTable.COLUMN_WAREHOUSE, warehouseId, options, getReceivingSpaceMapper());
  ...
  public SmartList<ReceivingSpace> findReceivingSpaceByWarehouse(
    ...
    SmartList<ReceivingSpace> resultList =
        queryWithRange(
            ReceivingSpaceTable.COLUMN_WAREHOUSE,
            warehouseId,
            options,
            getReceivingSpaceMapper(),
            start,
            count);
    // analyzeReceivingSpaceByWarehouse(resultList, warehouseId, options);
    return resultList;
  ...
  public void analyzeReceivingSpaceByWarehouse(
      SmartList<ReceivingSpace> resultList, String warehouseId, Map<String, Object> options) {
    if (resultList == null) {
    ...
    lastUpdateTimeStatsItem.setInternalName(
        formatKeyForDateLine(ReceivingSpace.LAST_UPDATE_TIME_PROPERTY));
    lastUpdateTimeStatsItem.setResult(
        statsWithGroup(
            DateKey.class,
            wrapWithDate(ReceivingSpace.LAST_UPDATE_TIME_PROPERTY),
            filterKey,
            emptyOptions));
  ...
  @Override
  public Map<String, Integer> countReceivingSpaceByWarehouseIds(
  ...
  public SmartList<ReceivingSpace> saveReceivingSpaceList(
    ...
    batchReceivingSpaceRemove((List<ReceivingSpace>) lists[REMOVE_LIST_INDEX]);
    batchReceivingSpaceRecover((List<ReceivingSpace>) lists[RECOVER_LIST_INDEX]);
    ...
    for (ReceivingSpace receivingSpace : receivingSpaceList) {
      ...
      if (receivingSpace.isToRecover() || receivingSpace.isToRemove()) {
        receivingSpace.setVersion(-receivingSpace.getVersion());
      }
    }
  ...
  public SmartList<ReceivingSpace> removeReceivingSpaceList(
      SmartList<ReceivingSpace> receivingSpaceList, Map<String, Object> options) {
  ...
  protected List<Object[]> prepareReceivingSpaceBatchCreateArgs(
  ...
  protected List<Object[]> prepareReceivingSpaceBatchUpdateArgs(
      List<ReceivingSpace> receivingSpaceList) {
  ...
  protected List<Object[]> prepareReceivingSpaceBatchRecoverArgs(
      List<ReceivingSpace> receivingSpaceList) {

    List<Object[]> parametersList = new ArrayList<Object[]>();
    for (ReceivingSpace receivingSpace : receivingSpaceList) {
      if (!receivingSpace.isToRecover()) {
        continue;
      }
      Object[] parameters = prepareRecoverParameters(receivingSpace);
      parametersList.add(parameters);
    }
    return parametersList;
  }

  protected List<Object[]> prepareReceivingSpaceBatchRemoveArgs(
      List<ReceivingSpace> receivingSpaceList) {

    List<Object[]> parametersList = new ArrayList<Object[]>();
    for (ReceivingSpace receivingSpace : receivingSpaceList) {
      if (!receivingSpace.isToRemove()) {
        continue;
      }
      Object[] parameters = prepareReceivingSpaceRemoveParameters(receivingSpace);
      parametersList.add(parameters);
    }
    return parametersList;
  }
  ...
  protected void batchReceivingSpaceRemove(List<ReceivingSpace> receivingSpaceList) {
    String SQL = getRemoveSQL();
    List<Object[]> args = prepareReceivingSpaceBatchRemoveArgs(receivingSpaceList);
    int affectedNumbers[] = batchRemove(SQL, args);
    checkBatchReturn(affectedNumbers);
  }

  protected void batchReceivingSpaceRecover(List<ReceivingSpace> receivingSpaceList) {
    String SQL = getRecoverSQL();
    List<Object[]> args = prepareReceivingSpaceBatchRecoverArgs(receivingSpaceList);
  ...
  protected Object[] splitReceivingSpaceList(List<ReceivingSpace> receivingSpaceList) {
    ...
    List<ReceivingSpace> receivingSpaceRemoveList = new ArrayList<ReceivingSpace>();
    List<ReceivingSpace> receivingSpaceRecoverList = new ArrayList<ReceivingSpace>();

    for (ReceivingSpace receivingSpace : receivingSpaceList) {
      if (receivingSpace.isToRemove()) {
        receivingSpaceRemoveList.add(receivingSpace);
        continue;
      }
      if (receivingSpace.isToRecover()) {
        receivingSpaceRecoverList.add(receivingSpace);
        continue;
      }
    ...
    return new Object[] {
      receivingSpaceCreateList,
      receivingSpaceUpdateList,
      receivingSpaceRemoveList,
      receivingSpaceRecoverList
    };
  }
  ...
  protected Object[] getSaveReceivingSpaceParameters(ReceivingSpace receivingSpace) {
    if (receivingSpace.isToRemove()) {
      return prepareReceivingSpaceRemoveParameters(receivingSpace);
    }
    if (receivingSpace.isToRecover()) {
      return prepareRecoverParameters(receivingSpace);
    }
  ...
  protected Object[] prepareReceivingSpaceRemoveParameters(ReceivingSpace receivingSpace) {
    return super.prepareRemoveParameters(receivingSpace);
  }
  ...
  protected ReceivingSpace saveInternalReceivingSpace(
      ReceivingSpace receivingSpace, Map<String, Object> options) {
  ...
  protected ReceivingSpace saveWarehouse(
      ReceivingSpace receivingSpace, Map<String, Object> options) {
  ...
  public ReceivingSpace planToRemoveGoodsList(
      ReceivingSpace receivingSpace, String goodsIds[], Map<String, Object> options)
      throws Exception {
  ...
  public ReceivingSpace planToRemoveGoodsListWithSku(
      ReceivingSpace receivingSpace, String skuId, Map<String, Object> options) throws Exception {
  ...
  public int countGoodsListWithSku(
      String receivingSpaceId, String skuId, Map<String, Object> options) throws Exception {
    // SmartList<ThreadLike> toRemoveThreadLikeList = threadLikeList.getToRemoveList();
    // the list will not be null here, empty, maybe
    // getThreadLikeDAO().removeThreadLikeList(toRemoveThreadLikeList,options);
  ...
  public ReceivingSpace planToRemoveGoodsListWithGoodsAllocation(
      ReceivingSpace receivingSpace, String goodsAllocationId, Map<String, Object> options)
      throws Exception {
    // SmartList<ThreadLike> toRemoveThreadLikeList = threadLikeList.getToRemoveList();
    // the list will not be null here, empty, maybe
    // getThreadLikeDAO().removeThreadLikeList(toRemoveThreadLikeList,options);
  ...
  public int countGoodsListWithGoodsAllocation(
      String receivingSpaceId, String goodsAllocationId, Map<String, Object> options)
      throws Exception {
    // SmartList<ThreadLike> toRemoveThreadLikeList = threadLikeList.getToRemoveList();
    // the list will not be null here, empty, maybe
    // getThreadLikeDAO().removeThreadLikeList(toRemoveThreadLikeList,options);
  ...
  public ReceivingSpace planToRemoveGoodsListWithSmartPallet(
      ReceivingSpace receivingSpace, String smartPalletId, Map<String, Object> options)
      throws Exception {
    // SmartList<ThreadLike> toRemoveThreadLikeList = threadLikeList.getToRemoveList();
    // the list will not be null here, empty, maybe
    // getThreadLikeDAO().removeThreadLikeList(toRemoveThreadLikeList,options);
  ...
  public int countGoodsListWithSmartPallet(
      String receivingSpaceId, String smartPalletId, Map<String, Object> options) throws Exception {
    // SmartList<ThreadLike> toRemoveThreadLikeList = threadLikeList.getToRemoveList();
    // the list will not be null here, empty, maybe
    // getThreadLikeDAO().removeThreadLikeList(toRemoveThreadLikeList,options);
  ...
  public ReceivingSpace planToRemoveGoodsListWithShippingSpace(
      ReceivingSpace receivingSpace, String shippingSpaceId, Map<String, Object> options)
      throws Exception {
    // SmartList<ThreadLike> toRemoveThreadLikeList = threadLikeList.getToRemoveList();
    // the list will not be null here, empty, maybe
    // getThreadLikeDAO().removeThreadLikeList(toRemoveThreadLikeList,options);
  ...
  public int countGoodsListWithShippingSpace(
      String receivingSpaceId, String shippingSpaceId, Map<String, Object> options)
      throws Exception {
    // SmartList<ThreadLike> toRemoveThreadLikeList = threadLikeList.getToRemoveList();
    // the list will not be null here, empty, maybe
    // getThreadLikeDAO().removeThreadLikeList(toRemoveThreadLikeList,options);
  ...
  public ReceivingSpace planToRemoveGoodsListWithTransportTask(
      ReceivingSpace receivingSpace, String transportTaskId, Map<String, Object> options)
      throws Exception {
    // SmartList<ThreadLike> toRemoveThreadLikeList = threadLikeList.getToRemoveList();
    // the list will not be null here, empty, maybe
    // getThreadLikeDAO().removeThreadLikeList(toRemoveThreadLikeList,options);
  ...
  public int countGoodsListWithTransportTask(
      String receivingSpaceId, String transportTaskId, Map<String, Object> options)
      throws Exception {
    // SmartList<ThreadLike> toRemoveThreadLikeList = threadLikeList.getToRemoveList();
    // the list will not be null here, empty, maybe
    // getThreadLikeDAO().removeThreadLikeList(toRemoveThreadLikeList,options);
  ...
  public ReceivingSpace planToRemoveGoodsListWithRetailStore(
      ReceivingSpace receivingSpace, String retailStoreId, Map<String, Object> options)
      throws Exception {
    // SmartList<ThreadLike> toRemoveThreadLikeList = threadLikeList.getToRemoveList();
    // the list will not be null here, empty, maybe
    // getThreadLikeDAO().removeThreadLikeList(toRemoveThreadLikeList,options);
  ...
  public int countGoodsListWithRetailStore(
      String receivingSpaceId, String retailStoreId, Map<String, Object> options) throws Exception {
    // SmartList<ThreadLike> toRemoveThreadLikeList = threadLikeList.getToRemoveList();
    // the list will not be null here, empty, maybe
    // getThreadLikeDAO().removeThreadLikeList(toRemoveThreadLikeList,options);
  ...
  public ReceivingSpace planToRemoveGoodsListWithBizOrder(
      ReceivingSpace receivingSpace, String bizOrderId, Map<String, Object> options)
      throws Exception {
    // SmartList<ThreadLike> toRemoveThreadLikeList = threadLikeList.getToRemoveList();
    // the list will not be null here, empty, maybe
    // getThreadLikeDAO().removeThreadLikeList(toRemoveThreadLikeList,options);
  ...
  public int countGoodsListWithBizOrder(
      String receivingSpaceId, String bizOrderId, Map<String, Object> options) throws Exception {
    // SmartList<ThreadLike> toRemoveThreadLikeList = threadLikeList.getToRemoveList();
    // the list will not be null here, empty, maybe
    // getThreadLikeDAO().removeThreadLikeList(toRemoveThreadLikeList,options);
  ...
  public ReceivingSpace planToRemoveGoodsListWithRetailStoreOrder(
      ReceivingSpace receivingSpace, String retailStoreOrderId, Map<String, Object> options)
      throws Exception {
    // SmartList<ThreadLike> toRemoveThreadLikeList = threadLikeList.getToRemoveList();
    // the list will not be null here, empty, maybe
    // getThreadLikeDAO().removeThreadLikeList(toRemoveThreadLikeList,options);
  ...
  public int countGoodsListWithRetailStoreOrder(
      String receivingSpaceId, String retailStoreOrderId, Map<String, Object> options)
      throws Exception {
    // SmartList<ThreadLike> toRemoveThreadLikeList = threadLikeList.getToRemoveList();
    // the list will not be null here, empty, maybe
    // getThreadLikeDAO().removeThreadLikeList(toRemoveThreadLikeList,options);
  ...
  protected ReceivingSpace saveGoodsList(
      ReceivingSpace receivingSpace, Map<String, Object> options) {
  ...
  protected ReceivingSpace removeGoodsList(
      ReceivingSpace receivingSpace, Map<String, Object> options) {
  ...
  public SmartList<ReceivingSpace> requestCandidateReceivingSpaceForGoods(
    ...
    return findAllCandidateByFilter(
        ReceivingSpaceTable.COLUMN_LOCATION,
        ReceivingSpaceTable.COLUMN_WAREHOUSE,
        filterKey,
        pageNo,
        pageSize,
  ...
  public void collectAndEnhance(BaseEntity ownerEntity) {
    List<ReceivingSpace> receivingSpaceList =
        ownerEntity.collectRefsWithType(ReceivingSpace.INTERNAL_TYPE);
    this.enhanceList(receivingSpaceList);
  }

  @Override
  public SmartList<ReceivingSpace> findReceivingSpaceWithKey(
  ...
  public Map<String, Integer> countReceivingSpaceWithGroupKey(
  ...
  @Override
  public CandidateReceivingSpace executeCandidatesQuery(
  ...
  @Override
  protected ReceivingSpaceMapper mapperForClazz(Class<?> clazz) {
    return ReceivingSpaceMapper.mapperForClass(clazz);
  }
}
