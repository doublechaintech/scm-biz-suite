...
public class ReceivingSpaceManagerImpl extends CustomRetailscmCheckerManager implements ReceivingSpaceManager, BusinessHandler{
 ...
 //--------------------------------------------------------------
	...
	public  ReceivingSpace updateGoodsProperties(RetailscmUserContext userContext, String receivingSpaceId, String id,String name,String rfid,String uom,int maxPackage,Date expireTime, String [] tokensExpr) throws Exception
	{
		...
		beforeUpdateGoodsProperties(userContext,item, receivingSpaceId,id,name,rfid,uom,maxPackage,expireTime,tokensExpr);
	...
	protected  void beforeUpdateGoodsProperties(RetailscmUserContext userContext, Goods item, String receivingSpaceId, String id,String name,String rfid,String uom,int maxPackage,Date expireTime, String [] tokensExpr)
						throws Exception {
	...
	public  ReceivingSpace copyGoodsFrom(RetailscmUserContext userContext, String receivingSpaceId,
		...
		synchronized(receivingSpace){
			...
			goodsManagerOf(userContext).onNewInstanceCreated(userContext, (Goods)receivingSpace.getFlexiableObjects().get(BaseEntity.COPIED_CHILD));
			return present(userContext,receivingSpace, mergedAllTokens(tokensExpr));
		}
	...
	public  ReceivingSpace updateGoods(RetailscmUserContext userContext, String receivingSpaceId, String goodsId, int goodsVersion, String property, String newValueExpr,String [] tokensExpr)
		...
		synchronized(receivingSpace){
			...
			beforeUpdateGoods(userContext, goods, receivingSpaceId, goodsId, goodsVersion, property, newValueExpr,  tokensExpr);
	...
	protected void beforeUpdateGoods(RetailscmUserContext userContext, Goods existed, String receivingSpaceId, String goodsId, int goodsVersion, String property, String newValueExpr,String [] tokensExpr)
  			throws Exception{
  }
	/*
  ...
  public void sendAllItems(RetailscmUserContext ctx) throws Exception{
    receivingSpaceDaoOf(ctx).loadAllAsStream().forEach(
