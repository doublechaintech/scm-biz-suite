...
public class RetailStoreOpeningJDBCTemplateDAO extends RetailscmBaseDAOImpl implements RetailStoreOpeningDAO{
  ...
  public Stream<RetailStoreOpening> loadAllAsStream() {
    ...
    public SmartList<RetailStoreOpening> requestCandidateRetailStoreOpeningForRetailStore(RetailscmUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
		...
		return findAllCandidateByFilter(RetailStoreOpeningTable.COLUMN_COMMENT, null, filterKey, pageNo, pageSize, getRetailStoreOpeningMapper());
    }
