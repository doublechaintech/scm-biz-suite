...
public class RetailStoreOpening extends BaseEntity implements  java.io.Serializable{
  ...
  memberMetaInfoList.add(MemberMetaInfo.referBy(RETAIL_STORE_LIST, "opening", "零售门店列表")
  ...
  public Map<String, String> getReferProperties(){
    Map<String, String> refers = new HashMap<>();
    	    ...
    	    refers.put(RETAIL_STORE_LIST, "opening");
  ...
  public RetailStoreOpening want(Class<? extends BaseEntity>... classes) {
      doWant(classes);
      return this;
    }

  public RetailStoreOpening wants(Class<? extends BaseEntity>... classes) {
    doWants(classes);
    return this;
  }
	...
	public 	static RetailStoreOpening withId(String id){
		...
		retailStoreOpening.setChecked(true);
  ...
  public RetailStoreOpening limit(int count){
    doAddLimit(0, count);
    return this;
  }

  public RetailStoreOpening limit(int start, int count){
    doAddLimit(start, count);
    return this;
  }

  public static RetailStoreOpening searchExample(){
    RetailStoreOpening retailStoreOpening = new RetailStoreOpening();
    		retailStoreOpening.setVersion(UNSET_INT);
...
return getId();
	...
	public RetailStoreOpening updateId(String id){String oldId = this.id;String newId = trimString(id);if(!shouldReplaceBy(newId, oldId)){return this;}this.id = newId;addPropertyChange(ID_PROPERTY, oldId, newId);this.changed = true;setChecked(false);return this;}
	public RetailStoreOpening orderById(boolean asc){
...
return createCriteria(ID_PROPERTY, operator, parameters);
	...
	public RetailStoreOpening ignoreIdCriteria(){super.ignoreSearchProperty(ID_PROPERTY);
return this;
}
	public RetailStoreOpening addIdCriteria(QueryOperator operator, Object... parameters){
...
return getComment();
	...
	public RetailStoreOpening updateComment(String comment){String oldComment = this.comment;String newComment = trimString(comment);if(!shouldReplaceBy(newComment, oldComment)){return this;}this.comment = newComment;addPropertyChange(COMMENT_PROPERTY, oldComment, newComment);this.changed = true;setChecked(false);return this;}
	public RetailStoreOpening orderByComment(boolean asc){
...
return createCriteria(COMMENT_PROPERTY, operator, parameters);
	...
	public RetailStoreOpening ignoreCommentCriteria(){super.ignoreSearchProperty(COMMENT_PROPERTY);
return this;
}
	public RetailStoreOpening addCommentCriteria(QueryOperator operator, Object... parameters){
...
return getVersion();
	...
	public RetailStoreOpening updateVersion(int version){int oldVersion = this.version;int newVersion = version;if(!shouldReplaceBy(newVersion, oldVersion)){return this;}this.version = newVersion;addPropertyChange(VERSION_PROPERTY, oldVersion, newVersion);this.changed = true;setChecked(false);return this;}
	public RetailStoreOpening orderByVersion(boolean asc){
...
return createCriteria(VERSION_PROPERTY, operator, parameters);
	...
	public RetailStoreOpening ignoreVersionCriteria(){super.ignoreSearchProperty(VERSION_PROPERTY);
return this;
}
	public RetailStoreOpening addVersionCriteria(QueryOperator operator, Object... parameters){
...
return this;
  ...
  public  SmartList<RetailStore> retailStoreList(){
	...
	public  RetailStoreOpening addRetailStore(RetailStore retailStore){
		retailStore.setOpening(this);
		getRetailStoreList().add(retailStore);
		return this;
	}
	public  RetailStoreOpening addRetailStoreList(SmartList<RetailStore> retailStoreList){
		for( RetailStore retailStore:retailStoreList){
			retailStore.setOpening(this);
		}
	...
	public static RetailStoreOpening createWith(RetailscmUserContext userContext, ThrowingFunction<RetailStoreOpening,RetailStoreOpening,Exception> postHandler, Object ... inputs) throws Exception {

    List<Object> params = inputs == null ? new ArrayList<>() : Arrays.asList(inputs);
    CustomRetailscmPropertyMapper mapper = CustomRetailscmPropertyMapper.of(userContext);
    CreationScene scene = mapper.findParamByClass(params, CreationScene.class);
    RetailscmBeanCreator<RetailStoreOpening> customCreator = mapper.findCustomCreator(RetailStoreOpening.class, scene);
    if (customCreator != null){
      return customCreator.create(userContext, scene, postHandler, params);
    }

    RetailStoreOpening result = new RetailStoreOpening();
    result.setComment(mapper.tryToGet(RetailStoreOpening.class, COMMENT_PROPERTY, String.class,
    ...
    if (result != null){
      userContext.getChecker().checkAndFixRetailStoreOpening(result);
      userContext.getChecker().throwExceptionIfHasErrors(IllegalArgumentException.class);

      
      RetailStoreOpeningTokens tokens = mapper.findParamByClass(params, RetailStoreOpeningTokens.class);
      if (tokens == null) {
        tokens = RetailStoreOpeningTokens.start();
      }
      result = userContext.getManagerGroup().getRetailStoreOpeningManager().internalSaveRetailStoreOpening(userContext, result, tokens.done());
