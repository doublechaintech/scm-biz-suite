...
public interface EventAttendanceManager extends BaseManager{
  ...
  List<EventAttendance> searchEventAttendanceList(RetailscmUserContext ctx, EventAttendanceRequest pRequest);
  EventAttendance searchEventAttendance(RetailscmUserContext ctx, EventAttendanceRequest pRequest);
	...
	public default void onUpdated(RetailscmUserContext userContext, EventAttendance updated, Object actor, String methodName) throws Exception {};
