...
public class EventAttendanceTokens extends CommonTokens{
  ...
  public static EventAttendanceTokens loadGroupTokens(String... groupNames){
    ...
    addToken(tokens, POTENTIALCUSTOMER, groupNames, new String[]{"default"});addToken(tokens, CITYEVENT, groupNames, new String[]{"default"});

  
    return tokens;
  }

  private static void addToken(EventAttendanceTokens pTokens, String pTokenName, String[] pGroupNames, String[] fieldGroups) {
