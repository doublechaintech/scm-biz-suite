...
public class MemberWishlistTokens extends CommonTokens{
  ...
  private static void addToken(MemberWishlistTokens pTokens, String pTokenName, String[] pGroupNames, String[] fieldGroups) {
	...
	public static MemberWishlistTokens filterWithTokenViewGroups(String []viewGroups){
		...
		return start()
			.withOwner()
			.withMemberWishlistProductListIfViewGroupInclude(viewGroups);
