...
public class MemberWishlistTokens extends CommonTokens {
  ...
  public static MemberWishlistTokens loadGroupTokens(String... groupNames) {
    MemberWishlistTokens tokens = start();
    if (groupNames == null || groupNames.length == 0) {
      return allTokens();
    }
    addToken(tokens, OWNER, groupNames, new String[] {"default"});

    addToken(tokens, MEMBER_WISHLIST_PRODUCT_LIST, groupNames, new String[] {"default"});

    return tokens;
  }

  private static void addToken(
      MemberWishlistTokens pTokens, String pTokenName, String[] pGroupNames, String[] fieldGroups) {
  ...
  public static MemberWishlistTokens filterWithTokenViewGroups(String[] viewGroups) {

    return start().withOwner().withMemberWishlistProductListIfViewGroupInclude(viewGroups);
  }

  public static MemberWishlistTokens allTokens() {

    return start().withOwner().withMemberWishlistProductList();
  }
  ...
  public MemberWishlistTokens withMemberWishlistProductListIfViewGroupInclude(String[] viewGroups) {
  ...
  public MemberWishlistProductTokens withMemberWishlistProductListTokens() {
    // addSimpleOptions(MEMBER_WISHLIST_PRODUCT_LIST);
  ...
  public MemberWishlistTokens extractMoreFromMemberWishlistProductList(
  ...
  public MemberWishlistTokens sortMemberWishlistProductListWith(String field, String descOrAsc) {
    addSortMoreOptions(
        MEMBER_WISHLIST_PRODUCT_LIST, memberWishlistProductListSortCounter++, field, descOrAsc);
    return this;
  }

  private int memberWishlistProductListSearchCounter = 0;

  public MemberWishlistTokens searchMemberWishlistProductListWith(
      String field, String verb, String value) {

    withMemberWishlistProductList();
    addSearchMoreOptions(
        MEMBER_WISHLIST_PRODUCT_LIST, memberWishlistProductListSearchCounter++, field, verb, value);
    return this;
  }
