...
public class LevelThreeDepartmentTokens extends CommonTokens {
  ...
  public static LevelThreeDepartmentTokens loadGroupTokens(String... groupNames) {
    LevelThreeDepartmentTokens tokens = start();
  ...
  private static void addToken(
      LevelThreeDepartmentTokens pTokens,
      String pTokenName,
      String[] pGroupNames,
      String[] fieldGroups) {
  ...
  public static LevelThreeDepartmentTokens filterWithTokenViewGroups(String[] viewGroups) {

    return start().withBelongsTo().withEmployeeListIfViewGroupInclude(viewGroups);
  }

  public static LevelThreeDepartmentTokens allTokens() {

    return start().withBelongsTo().withEmployeeList();
  }
  ...
  public LevelTwoDepartmentTokens withBelongsToTokens() {
    // addSimpleOptions(BELONGSTO);
  ...
  public LevelThreeDepartmentTokens withEmployeeListIfViewGroupInclude(String[] viewGroups) {
  ...
  public LevelThreeDepartmentTokens searchEmployeeListWith(
