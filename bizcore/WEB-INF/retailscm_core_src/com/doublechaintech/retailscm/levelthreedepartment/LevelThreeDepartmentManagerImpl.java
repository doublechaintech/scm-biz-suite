...
public class LevelThreeDepartmentManagerImpl extends CustomRetailscmCheckerManager
    implements LevelThreeDepartmentManager, BusinessHandler {
  ...
  public BlobObject exportExcelFromList(
    ...
    Map<String, Object> tokens =
        LevelThreeDepartmentTokens.start().withTokenFromListName(listName).done();
    LevelThreeDepartment levelThreeDepartment =
        (LevelThreeDepartment) this.loadLevelThreeDepartment(userContext, id, tokens);
    // to enrich reference object to let it show display name
    List<BaseEntity> entityListToNaming = levelThreeDepartment.collectReferencesFromLists();
  ...
  protected void throwExceptionWithMessage(String value)
      throws LevelThreeDepartmentManagerException {
  ...
  protected LevelThreeDepartment saveLevelThreeDepartmentDetail(
      RetailscmUserContext userContext, LevelThreeDepartment levelThreeDepartment)
      throws Exception {

    return saveLevelThreeDepartment(userContext, levelThreeDepartment, allTokens());
  }

  public LevelThreeDepartment loadLevelThreeDepartment(
      RetailscmUserContext userContext, String levelThreeDepartmentId, String[] tokensExpr)
      throws Exception {
    ...
    LevelThreeDepartment levelThreeDepartment =
        loadLevelThreeDepartment(userContext, levelThreeDepartmentId, tokens);
    // do some calc before sent to customer?
    return present(userContext, levelThreeDepartment, tokens);
  }

  public LevelThreeDepartment searchLevelThreeDepartment(
      RetailscmUserContext userContext,
  ...
  protected LevelThreeDepartment present(
      RetailscmUserContext userContext,
      LevelThreeDepartment levelThreeDepartment,
      Map<String, Object> tokens)
      throws Exception {
    ...
    LevelThreeDepartment levelThreeDepartmentToPresent =
        levelThreeDepartmentDaoOf(userContext).present(levelThreeDepartment, tokens);

    List<BaseEntity> entityListToNaming =
        levelThreeDepartmentToPresent.collectReferencesFromLists();
    levelThreeDepartmentDaoOf(userContext).alias(entityListToNaming);
  ...
  public LevelThreeDepartment loadLevelThreeDepartmentDetail(
      RetailscmUserContext userContext, String levelThreeDepartmentId) throws Exception {
    LevelThreeDepartment levelThreeDepartment =
        loadLevelThreeDepartment(userContext, levelThreeDepartmentId, allTokens());
  ...
  public Object view(RetailscmUserContext userContext, String levelThreeDepartmentId)
      throws Exception {
    LevelThreeDepartment levelThreeDepartment =
        loadLevelThreeDepartment(userContext, levelThreeDepartmentId, viewTokens());
    markVisited(userContext, levelThreeDepartment);
    return present(userContext, levelThreeDepartment, viewTokens());
  }

  public Object summaryView(RetailscmUserContext userContext, String levelThreeDepartmentId)
      throws Exception {
    LevelThreeDepartment levelThreeDepartment =
        loadLevelThreeDepartment(userContext, levelThreeDepartmentId, viewTokens());
  ...
  public Object analyze(RetailscmUserContext userContext, String levelThreeDepartmentId)
      throws Exception {
    LevelThreeDepartment levelThreeDepartment =
        loadLevelThreeDepartment(userContext, levelThreeDepartmentId, analyzeTokens());
    markVisited(userContext, levelThreeDepartment);
  ...
  protected LevelThreeDepartment loadLevelThreeDepartment(
      RetailscmUserContext userContext, String levelThreeDepartmentId, Map<String, Object> tokens)
      throws Exception {
    checkerOf(userContext).checkIdOfLevelThreeDepartment(levelThreeDepartmentId);
  ...
  protected <T extends BaseEntity> void addActions(
    ...
    // userContext, LevelThreeDepartment levelThreeDepartment, Map<String, Object> tokens){

  @Override
  public List<LevelThreeDepartment> searchLevelThreeDepartmentList(
      RetailscmUserContext ctx, LevelThreeDepartmentRequest pRequest) {
  ...
  public LevelThreeDepartment createLevelThreeDepartment(
      RetailscmUserContext userContext,
      String belongsToId,
      String name,
      String description,
    ...
    levelThreeDepartment =
        saveLevelThreeDepartment(userContext, levelThreeDepartment, emptyOptions());
  ...
  public LevelThreeDepartment clone(
      RetailscmUserContext userContext, String fromLevelThreeDepartmentId) throws Exception {

    return levelThreeDepartmentDaoOf(userContext)
        .clone(fromLevelThreeDepartmentId, this.allTokens());
  }

  public LevelThreeDepartment internalSaveLevelThreeDepartment(
      RetailscmUserContext userContext, LevelThreeDepartment levelThreeDepartment)
      throws Exception {
  ...
  public LevelThreeDepartment internalSaveLevelThreeDepartment(
      ...
      throws Exception {
    // checkParamsForUpdatingLevelThreeDepartment(userContext, levelThreeDepartmentId,
    // levelThreeDepartmentVersion, property, newValueExpr, tokensExpr);
  ...
  public LevelThreeDepartment updateLevelThreeDepartment(
      RetailscmUserContext userContext,
      String levelThreeDepartmentId,
      int levelThreeDepartmentVersion,
      String property,
    ...
    synchronized (levelThreeDepartment) {
      ...
      levelThreeDepartment =
          saveLevelThreeDepartment(userContext, levelThreeDepartment, tokens().done());
  ...
  public LevelThreeDepartment updateLevelThreeDepartmentProperty(
      RetailscmUserContext userContext,
      String levelThreeDepartmentId,
      int levelThreeDepartmentVersion,
      String property,
  ...
  protected Map<String, Object> viewTokens() {
    return tokens().allTokens().sortEmployeeListWith(Employee.ID_PROPERTY, sortDesc()).done();
  }
  ...
  protected void checkParamsForTransferingAnotherBelongsTo(
      RetailscmUserContext userContext, String levelThreeDepartmentId, String anotherBelongsToId)
      throws Exception {

    checkerOf(userContext).checkIdOfLevelThreeDepartment(levelThreeDepartmentId);
    checkerOf(userContext)
        .checkIdOfLevelTwoDepartment(anotherBelongsToId); // check for optional reference

    checkerOf(userContext).throwExceptionIfHasErrors(LevelThreeDepartmentManagerException.class);
  }

  public LevelThreeDepartment transferToAnotherBelongsTo(
      RetailscmUserContext userContext, String levelThreeDepartmentId, String anotherBelongsToId)
      throws Exception {
    checkParamsForTransferingAnotherBelongsTo(
        userContext, levelThreeDepartmentId, anotherBelongsToId);
    ...
    synchronized (levelThreeDepartment) {
      // will be good when the levelThreeDepartment loaded from this JVM process cache.
      // also good when there is a ram based DAO implementation
      LevelTwoDepartment belongsTo =
          loadLevelTwoDepartment(userContext, anotherBelongsToId, emptyOptions());
  ...
  public CandidateLevelTwoDepartment requestCandidateBelongsTo(
    ...
    SmartList<LevelTwoDepartment> candidateList =
        levelTwoDepartmentDaoOf(userContext)
            .requestCandidateLevelTwoDepartmentForLevelThreeDepartment(
  ...
  public LevelThreeDepartment forgetByAll(
      RetailscmUserContext userContext,
      String levelThreeDepartmentId,
      int levelThreeDepartmentVersion)
      throws Exception {
  ...
  protected LevelThreeDepartment forgetByAllInternal(
      RetailscmUserContext userContext,
      String levelThreeDepartmentId,
      int levelThreeDepartmentVersion)
      throws Exception {
    ...
    return levelThreeDepartmentDaoOf(userContext)
        .disconnectFromAll(levelThreeDepartmentId, levelThreeDepartmentVersion);
  }
  ...
  public LevelThreeDepartment addEmployee(
    ...
    LevelThreeDepartment levelThreeDepartment =
        loadLevelThreeDepartment(userContext, levelThreeDepartmentId, emptyOptions());
    synchronized (levelThreeDepartment) {
      // Will be good when the levelThreeDepartment loaded from this JVM process cache.
      // Also good when there is a RAM based DAO implementation
      levelThreeDepartment.addEmployee(employee);
      levelThreeDepartment =
          saveLevelThreeDepartment(
              userContext, levelThreeDepartment, tokens().withEmployeeList().done());
  ...
  public LevelThreeDepartment updateEmployeeProperties(
      RetailscmUserContext userContext,
      String levelThreeDepartmentId,
      String id,
      String title,
    ...
    LevelThreeDepartment levelThreeDepartmentToUpdate =
        loadLevelThreeDepartment(userContext, levelThreeDepartmentId, options);
    ...
    LevelThreeDepartment levelThreeDepartment =
        saveLevelThreeDepartment(
            userContext, levelThreeDepartmentToUpdate, tokens().withEmployeeList().done());
    synchronized (levelThreeDepartment) {
      return present(userContext, levelThreeDepartment, mergedAllTokens(tokensExpr));
    }
  }
  ...
  public LevelThreeDepartment removeEmployeeList(
      RetailscmUserContext userContext,
      String levelThreeDepartmentId,
      String employeeIds[],
      String[] tokensExpr)
    ...
    checkParamsForRemovingEmployeeList(
        userContext, levelThreeDepartmentId, employeeIds, tokensExpr);
    ...
    synchronized (levelThreeDepartment) {
      ...
      levelThreeDepartmentDaoOf(userContext)
          .planToRemoveEmployeeList(levelThreeDepartment, employeeIds, allTokens());
      levelThreeDepartment =
          saveLevelThreeDepartment(
              userContext, levelThreeDepartment, tokens().withEmployeeList().done());
  ...
  public LevelThreeDepartment removeEmployee(
      RetailscmUserContext userContext,
      String levelThreeDepartmentId,
      String employeeId,
      int employeeVersion,
    ...
    checkParamsForRemovingEmployee(
        userContext, levelThreeDepartmentId, employeeId, employeeVersion, tokensExpr);
  ...
  public LevelThreeDepartment copyEmployeeFrom(
      RetailscmUserContext userContext,
      String levelThreeDepartmentId,
      String employeeId,
      int employeeVersion,
    ...
    synchronized (levelThreeDepartment) {
      ...
      employeeManagerOf(userContext)
          .onNewInstanceCreated(
              userContext,
              (Employee) levelThreeDepartment.getFlexiableObjects().get(BaseEntity.COPIED_CHILD));
      return present(userContext, levelThreeDepartment, mergedAllTokens(tokensExpr));
    }
  }
  ...
  public LevelThreeDepartment updateEmployee(
      RetailscmUserContext userContext,
      String levelThreeDepartmentId,
      String employeeId,
      int employeeVersion,
    ...
    LevelThreeDepartment levelThreeDepartment =
        loadLevelThreeDepartment(userContext, levelThreeDepartmentId, loadTokens);
  ...
  */
  ...
  public void onNewInstanceCreated(
      RetailscmUserContext userContext, LevelThreeDepartment newCreated) throws Exception {
    ensureRelationInGraph(userContext, newCreated);
    sendCreationEvent(userContext, newCreated);
  }

  public void sendAllItems(RetailscmUserContext ctx) throws Exception {
    levelThreeDepartmentDaoOf(ctx).loadAllAsStream().forEach(event -> sendInitEvent(ctx, event));
  }
  ...
  protected void enhanceForListOfView(
      RetailscmUserContext userContext, SmartList<LevelThreeDepartment> list) throws Exception {
    if (list == null || list.isEmpty()) {
      return;
    }
    List<LevelTwoDepartment> belongsToList =
        RetailscmBaseUtils.collectReferencedObjectWithType(
            userContext, list, LevelTwoDepartment.class);
  ...
  public Object listPageByBelongsTo(
    ...
    SmartList<LevelThreeDepartment> list =
        levelThreeDepartmentDaoOf(userContext)
            .findLevelThreeDepartmentByBelongsTo(belongsToId, start, count, new HashMap<>());
   ...
   * @throws Exception
   */
  public Object wxappview(RetailscmUserContext userContext, String levelThreeDepartmentId)
      throws Exception {
    SerializeScope vscope = SerializeScope.EXCLUDE().nothing();
    LevelThreeDepartment merchantObj =
        (LevelThreeDepartment) this.view(userContext, levelThreeDepartmentId);
