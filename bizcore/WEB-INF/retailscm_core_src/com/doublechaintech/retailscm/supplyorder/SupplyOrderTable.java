...
public class SupplyOrderTable{
	...
	public static final String []ALL_CLOUMNS = {COLUMN_ID,COLUMN_BUYER,COLUMN_SELLER,COLUMN_TITLE,COLUMN_CONTRACT,COLUMN_TOTAL_AMOUNT,COLUMN_LAST_UPDATE_TIME,COLUMN_VERSION};
	public static final String []NORMAL_CLOUMNS = {COLUMN_BUYER,COLUMN_SELLER,COLUMN_TITLE,COLUMN_CONTRACT,COLUMN_TOTAL_AMOUNT,COLUMN_LAST_UPDATE_TIME};
	  ...
	  public static void ensureTable(RetailscmUserContext userContext, Map<String, Object> result) throws Exception {
        RetailscmBaseUtils.ensureTable(userContext, result, "supply_order_data", new String[][]{
                ...
                new String[]{"title","varchar(40)","","标题","",""},
