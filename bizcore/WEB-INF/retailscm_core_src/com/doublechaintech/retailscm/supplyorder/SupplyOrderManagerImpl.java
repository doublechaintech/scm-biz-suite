...
public class SupplyOrderManagerImpl extends CustomRetailscmCheckerManager
    implements SupplyOrderManager, BusinessHandler {
  ...
  public BlobObject exportExcelFromList(
    ...
    List<BaseEntity> entityListToNaming = supplyOrder.collectReferencesFromLists();
  ...
  protected SupplyOrder saveSupplyOrder(
      RetailscmUserContext userContext, SupplyOrder supplyOrder, String[] tokensExpr)
      throws Exception {
  ...
  protected SupplyOrder saveSupplyOrderDetail(
      RetailscmUserContext userContext, SupplyOrder supplyOrder) throws Exception {

    return saveSupplyOrder(userContext, supplyOrder, allTokens());
  }

  public SupplyOrder loadSupplyOrder(
      RetailscmUserContext userContext, String supplyOrderId, String[] tokensExpr)
      throws Exception {
  ...
  public SupplyOrder searchSupplyOrder(
  ...
  protected SupplyOrder present(
      RetailscmUserContext userContext, SupplyOrder supplyOrder, Map<String, Object> tokens)
      throws Exception {
    ...
    List<BaseEntity> entityListToNaming = supplyOrderToPresent.collectReferencesFromLists();
    supplyOrderDaoOf(userContext).alias(entityListToNaming);
  ...
  public SupplyOrder loadSupplyOrderDetail(RetailscmUserContext userContext, String supplyOrderId)
      throws Exception {
  ...
  public Object summaryView(RetailscmUserContext userContext, String supplyOrderId)
      throws Exception {
    SupplyOrder supplyOrder = loadSupplyOrder(userContext, supplyOrderId, viewTokens());
  ...
  protected SupplyOrder loadSupplyOrder(
      RetailscmUserContext userContext, String supplyOrderId, Map<String, Object> tokens)
      throws Exception {
    checkerOf(userContext).checkIdOfSupplyOrder(supplyOrderId);
  ...
  protected <T extends BaseEntity> void addActions(
    ...
    // userContext, SupplyOrder supplyOrder, Map<String, Object> tokens){

  @Override
  public List<SupplyOrder> searchSupplyOrderList(
      RetailscmUserContext ctx, SupplyOrderRequest pRequest) {
  ...
  public SupplyOrder createSupplyOrder(
    ...
    RetailStoreCountryCenter buyer =
        loadRetailStoreCountryCenter(userContext, buyerId, emptyOptions());
  ...
  public SupplyOrder clone(RetailscmUserContext userContext, String fromSupplyOrderId)
      throws Exception {

    return supplyOrderDaoOf(userContext).clone(fromSupplyOrderId, this.allTokens());
  }

  public SupplyOrder internalSaveSupplyOrder(
      RetailscmUserContext userContext, SupplyOrder supplyOrder) throws Exception {
    return internalSaveSupplyOrder(userContext, supplyOrder, allTokens());
  }

  public SupplyOrder internalSaveSupplyOrder(
      RetailscmUserContext userContext, SupplyOrder supplyOrder, Map<String, Object> options)
      throws Exception {
    // checkParamsForUpdatingSupplyOrder(userContext, supplyOrderId, supplyOrderVersion, property,
  ...
  public SupplyOrder updateSupplyOrder(
    ...
    checkParamsForUpdatingSupplyOrder(
        userContext, supplyOrderId, supplyOrderVersion, property, newValueExpr, tokensExpr);
  ...
  public SupplyOrder updateSupplyOrderProperty(
      RetailscmUserContext userContext,
      String supplyOrderId,
      int supplyOrderVersion,
      String property,
  ...
  protected void checkParamsForTransferingAnotherBuyer(
      RetailscmUserContext userContext, String supplyOrderId, String anotherBuyerId)
      throws Exception {

    checkerOf(userContext).checkIdOfSupplyOrder(supplyOrderId);
    checkerOf(userContext)
        .checkIdOfRetailStoreCountryCenter(anotherBuyerId); // check for optional reference

    checkerOf(userContext).throwExceptionIfHasErrors(SupplyOrderManagerException.class);
  }

  public SupplyOrder transferToAnotherBuyer(
      RetailscmUserContext userContext, String supplyOrderId, String anotherBuyerId)
      throws Exception {
    ...
    synchronized (supplyOrder) {
      ...
      // also good when there is a ram based DAO implementation
      RetailStoreCountryCenter buyer =
          loadRetailStoreCountryCenter(userContext, anotherBuyerId, emptyOptions());
  ...
  public CandidateRetailStoreCountryCenter requestCandidateBuyer(
    ...
    SmartList<RetailStoreCountryCenter> candidateList =
        retailStoreCountryCenterDaoOf(userContext)
            .requestCandidateRetailStoreCountryCenterForSupplyOrder(
  ...
  protected void checkParamsForTransferingAnotherSeller(
      RetailscmUserContext userContext, String supplyOrderId, String anotherSellerId)
      throws Exception {
  ...
  public SupplyOrder transferToAnotherSeller(
      RetailscmUserContext userContext, String supplyOrderId, String anotherSellerId)
      throws Exception {
  ...
  public CandidateGoodsSupplier requestCandidateSeller(
      RetailscmUserContext userContext, String ownerClass, String id, String filterKey, int pageNo)
      throws Exception {
    ...
    SmartList<GoodsSupplier> candidateList =
        goodsSupplierDaoOf(userContext)
            .requestCandidateGoodsSupplierForSupplyOrder(
                userContext, ownerClass, id, filterKey, pageNo, pageSize);
    result.setCandidates(candidateList);
    int totalCount = candidateList.getTotalCount();
    result.setTotalPage(Math.max(1, (totalCount + pageSize - 1) / pageSize));
  ...
  public SupplyOrder forgetByAll(
      RetailscmUserContext userContext, String supplyOrderId, int supplyOrderVersion)
      throws Exception {
    return forgetByAllInternal(userContext, supplyOrderId, supplyOrderVersion);
  }

  protected SupplyOrder forgetByAllInternal(
      RetailscmUserContext userContext, String supplyOrderId, int supplyOrderVersion)
      throws Exception {
  ...
  protected void checkParamsForAddingSupplyOrderLineItem(
      RetailscmUserContext userContext,
      String supplyOrderId,
      String skuId,
      String skuName,
  ...
  public SupplyOrder addSupplyOrderLineItem(
      RetailscmUserContext userContext,
      String supplyOrderId,
      String skuId,
      String skuName,
      ...
      String[] tokensExpr)
      throws Exception {
    checkParamsForAddingSupplyOrderLineItem(
        userContext,
        supplyOrderId,
        skuId,
        skuName,
    ...
    SupplyOrderLineItem supplyOrderLineItem =
        createSupplyOrderLineItem(userContext, skuId, skuName, amount, quantity, unitOfMeasurement);
    ...
    synchronized (supplyOrder) {
      ...
      supplyOrder =
          saveSupplyOrder(userContext, supplyOrder, tokens().withSupplyOrderLineItemList().done());

      supplyOrderLineItemManagerOf(userContext)
          .onNewInstanceCreated(userContext, supplyOrderLineItem);
      return present(userContext, supplyOrder, mergedAllTokens(tokensExpr));
    }
  }

  protected void checkParamsForUpdatingSupplyOrderLineItemProperties(
      RetailscmUserContext userContext,
      String supplyOrderId,
      String id,
      String skuId,
  ...
  public SupplyOrder updateSupplyOrderLineItemProperties(
      RetailscmUserContext userContext,
      String supplyOrderId,
      String id,
      String skuId,
      ...
      String[] tokensExpr)
      throws Exception {
    checkParamsForUpdatingSupplyOrderLineItemProperties(
        userContext,
        supplyOrderId,
        id,
        skuId,
    ...
    Map<String, Object> options =
        tokens()
            ...
            .searchSupplyOrderLineItemListWith(SupplyOrderLineItem.ID_PROPERTY, tokens().is(), id)
            .done();
    ...
    if (supplyOrderToUpdate.getSupplyOrderLineItemList().isEmpty()) {
      throw new SupplyOrderManagerException(
          "SupplyOrderLineItem is NOT FOUND with id: '" + id + "'");
    }

    SupplyOrderLineItem item = supplyOrderToUpdate.getSupplyOrderLineItemList().first();
    beforeUpdateSupplyOrderLineItemProperties(
        userContext,
        item,
        supplyOrderId,
        id,
    ...
    // checkParamsForAddingSupplyOrderLineItem(userContext,supplyOrderId,name, code,
    // used,tokensExpr);
    SupplyOrder supplyOrder =
        saveSupplyOrder(
            userContext, supplyOrderToUpdate, tokens().withSupplyOrderLineItemList().done());
    synchronized (supplyOrder) {
      return present(userContext, supplyOrder, mergedAllTokens(tokensExpr));
    }
  }

  protected void beforeUpdateSupplyOrderLineItemProperties(
      RetailscmUserContext userContext,
      SupplyOrderLineItem item,
      String supplyOrderId,
      String id,
      String skuId,
      String skuName,
  ...
  protected SupplyOrderLineItem createSupplyOrderLineItem(
      RetailscmUserContext userContext,
      String skuId,
      String skuName,
      BigDecimal amount,
  ...
  protected void checkParamsForRemovingSupplyOrderLineItemList(
      RetailscmUserContext userContext,
      String supplyOrderId,
      String supplyOrderLineItemIds[],
      String[] tokensExpr)
      throws Exception {
  ...
  public SupplyOrder removeSupplyOrderLineItemList(
      RetailscmUserContext userContext,
      String supplyOrderId,
      String supplyOrderLineItemIds[],
      String[] tokensExpr)
    ...
    checkParamsForRemovingSupplyOrderLineItemList(
        userContext, supplyOrderId, supplyOrderLineItemIds, tokensExpr);
    ...
    synchronized (supplyOrder) {
      ...
      supplyOrderDaoOf(userContext)
          .planToRemoveSupplyOrderLineItemList(supplyOrder, supplyOrderLineItemIds, allTokens());
      supplyOrder =
          saveSupplyOrder(userContext, supplyOrder, tokens().withSupplyOrderLineItemList().done());
  ...
  protected void checkParamsForRemovingSupplyOrderLineItem(
      RetailscmUserContext userContext,
      String supplyOrderId,
  ...
  public SupplyOrder removeSupplyOrderLineItem(
      RetailscmUserContext userContext,
      String supplyOrderId,
      String supplyOrderLineItemId,
      int supplyOrderLineItemVersion,
    ...
    checkParamsForRemovingSupplyOrderLineItem(
        userContext, supplyOrderId, supplyOrderLineItemId, supplyOrderLineItemVersion, tokensExpr);

    SupplyOrderLineItem supplyOrderLineItem =
        createIndexedSupplyOrderLineItem(supplyOrderLineItemId, supplyOrderLineItemVersion);
    SupplyOrder supplyOrder = loadSupplyOrder(userContext, supplyOrderId, allTokens());
    synchronized (supplyOrder) {
      // Will be good when the supplyOrder loaded from this JVM process cache.
      // Also good when there is a RAM based DAO implementation
  ...
  protected void checkParamsForCopyingSupplyOrderLineItem(
      RetailscmUserContext userContext,
      String supplyOrderId,
      String supplyOrderLineItemId,
      int supplyOrderLineItemVersion,
  ...
  public SupplyOrder copySupplyOrderLineItemFrom(
      RetailscmUserContext userContext,
      String supplyOrderId,
      String supplyOrderLineItemId,
      int supplyOrderLineItemVersion,
    ...
    checkParamsForCopyingSupplyOrderLineItem(
        userContext, supplyOrderId, supplyOrderLineItemId, supplyOrderLineItemVersion, tokensExpr);
    ...
    synchronized (supplyOrder) {
      ...
      supplyOrderLineItemManagerOf(userContext)
          .onNewInstanceCreated(
              userContext,
              (SupplyOrderLineItem) supplyOrder.getFlexiableObjects().get(BaseEntity.COPIED_CHILD));
      return present(userContext, supplyOrder, mergedAllTokens(tokensExpr));
    }
  }
  ...
  public SupplyOrder updateSupplyOrderLineItem(
      RetailscmUserContext userContext,
      String supplyOrderId,
      String supplyOrderLineItemId,
      int supplyOrderLineItemVersion,
    ...
    Map<String, Object> loadTokens =
        this.tokens()
            ...
            .searchSupplyOrderLineItemListWith(
                SupplyOrderLineItem.ID_PROPERTY, tokens().equals(), supplyOrderLineItemId)
            .done();
    ...
    synchronized (supplyOrder) {
      ...
      SupplyOrderLineItem supplyOrderLineItemIdVersionKey =
          createIndexedSupplyOrderLineItem(supplyOrderLineItemId, supplyOrderLineItemVersion);

      SupplyOrderLineItem supplyOrderLineItem =
          supplyOrder.findTheSupplyOrderLineItem(supplyOrderLineItemIdVersionKey);
      if (supplyOrderLineItem == null) {
        throw new SupplyOrderManagerException(supplyOrderLineItemId + " is NOT FOUND");
      }

      beforeUpdateSupplyOrderLineItem(
          userContext,
          supplyOrderLineItem,
          supplyOrderId,
          supplyOrderLineItemId,
      ...
      supplyOrder =
          saveSupplyOrder(userContext, supplyOrder, tokens().withSupplyOrderLineItemList().done());
      supplyOrderLineItemManagerOf(userContext)
          .onUpdated(userContext, supplyOrderLineItem, this, "updateSupplyOrderLineItem");
      return present(userContext, supplyOrder, mergedAllTokens(tokensExpr));
    }
  }

  /** if you has something need to do before update data from DB, override this */
  protected void beforeUpdateSupplyOrderLineItem(
      RetailscmUserContext userContext,
      SupplyOrderLineItem existed,
      String supplyOrderId,
      String supplyOrderLineItemId,
      int supplyOrderLineItemVersion,
      String property,
  ...
  */
  ...
  protected void checkParamsForAddingSupplyOrderShippingGroup(
      RetailscmUserContext userContext,
      String supplyOrderId,
      String name,
      BigDecimal amount,
  ...
  public SupplyOrder addSupplyOrderShippingGroup(
      ...
      String[] tokensExpr)
      throws Exception {
    checkParamsForAddingSupplyOrderShippingGroup(
        userContext, supplyOrderId, name, amount, tokensExpr);

    SupplyOrderShippingGroup supplyOrderShippingGroup =
        createSupplyOrderShippingGroup(userContext, name, amount);
    ...
    synchronized (supplyOrder) {
      ...
      supplyOrder =
          saveSupplyOrder(
              userContext, supplyOrder, tokens().withSupplyOrderShippingGroupList().done());

      supplyOrderShippingGroupManagerOf(userContext)
          .onNewInstanceCreated(userContext, supplyOrderShippingGroup);
      return present(userContext, supplyOrder, mergedAllTokens(tokensExpr));
    }
  }

  protected void checkParamsForUpdatingSupplyOrderShippingGroupProperties(
      RetailscmUserContext userContext,
      String supplyOrderId,
      String id,
      String name,
  ...
  public SupplyOrder updateSupplyOrderShippingGroupProperties(
      RetailscmUserContext userContext,
      String supplyOrderId,
      String id,
      String name,
      ...
      String[] tokensExpr)
      throws Exception {
    checkParamsForUpdatingSupplyOrderShippingGroupProperties(
        userContext, supplyOrderId, id, name, amount, tokensExpr);

    Map<String, Object> options =
        tokens()
            .allTokens()
            // .withSupplyOrderShippingGroupListList()
            .searchSupplyOrderShippingGroupListWith(
                SupplyOrderShippingGroup.ID_PROPERTY, tokens().is(), id)
            .done();
    ...
    if (supplyOrderToUpdate.getSupplyOrderShippingGroupList().isEmpty()) {
      throw new SupplyOrderManagerException(
          "SupplyOrderShippingGroup is NOT FOUND with id: '" + id + "'");
    }

    SupplyOrderShippingGroup item = supplyOrderToUpdate.getSupplyOrderShippingGroupList().first();
    beforeUpdateSupplyOrderShippingGroupProperties(
        userContext, item, supplyOrderId, id, name, amount, tokensExpr);
    item.updateName(name);
    item.updateAmount(amount);

    // checkParamsForAddingSupplyOrderShippingGroup(userContext,supplyOrderId,name, code,
    // used,tokensExpr);
    SupplyOrder supplyOrder =
        saveSupplyOrder(
            userContext, supplyOrderToUpdate, tokens().withSupplyOrderShippingGroupList().done());
    synchronized (supplyOrder) {
      return present(userContext, supplyOrder, mergedAllTokens(tokensExpr));
    }
  }

  protected void beforeUpdateSupplyOrderShippingGroupProperties(
      RetailscmUserContext userContext,
      SupplyOrderShippingGroup item,
      String supplyOrderId,
      String id,
      String name,
      BigDecimal amount,
  ...
  protected SupplyOrderShippingGroup createSupplyOrderShippingGroup(
  ...
  protected void checkParamsForRemovingSupplyOrderShippingGroupList(
      RetailscmUserContext userContext,
      String supplyOrderId,
      String supplyOrderShippingGroupIds[],
      String[] tokensExpr)
      throws Exception {
  ...
  public SupplyOrder removeSupplyOrderShippingGroupList(
      RetailscmUserContext userContext,
      String supplyOrderId,
      String supplyOrderShippingGroupIds[],
      String[] tokensExpr)
    ...
    checkParamsForRemovingSupplyOrderShippingGroupList(
        userContext, supplyOrderId, supplyOrderShippingGroupIds, tokensExpr);
    ...
    synchronized (supplyOrder) {
      ...
      // Also good when there is a RAM based DAO implementation
      supplyOrderDaoOf(userContext)
          .planToRemoveSupplyOrderShippingGroupList(
              supplyOrder, supplyOrderShippingGroupIds, allTokens());
      supplyOrder =
          saveSupplyOrder(
              userContext, supplyOrder, tokens().withSupplyOrderShippingGroupList().done());
  ...
  protected void checkParamsForRemovingSupplyOrderShippingGroup(
      RetailscmUserContext userContext,
      String supplyOrderId,
  ...
  public SupplyOrder removeSupplyOrderShippingGroup(
      RetailscmUserContext userContext,
      String supplyOrderId,
      String supplyOrderShippingGroupId,
      int supplyOrderShippingGroupVersion,
    ...
    checkParamsForRemovingSupplyOrderShippingGroup(
        userContext,
        supplyOrderId,
        supplyOrderShippingGroupId,
        supplyOrderShippingGroupVersion,
        tokensExpr);

    SupplyOrderShippingGroup supplyOrderShippingGroup =
        createIndexedSupplyOrderShippingGroup(
            supplyOrderShippingGroupId, supplyOrderShippingGroupVersion);
    SupplyOrder supplyOrder = loadSupplyOrder(userContext, supplyOrderId, allTokens());
    synchronized (supplyOrder) {
      // Will be good when the supplyOrder loaded from this JVM process cache.
      // Also good when there is a RAM based DAO implementation
  ...
  protected void checkParamsForCopyingSupplyOrderShippingGroup(
      RetailscmUserContext userContext,
      String supplyOrderId,
      String supplyOrderShippingGroupId,
      int supplyOrderShippingGroupVersion,
  ...
  public SupplyOrder copySupplyOrderShippingGroupFrom(
      RetailscmUserContext userContext,
      String supplyOrderId,
      String supplyOrderShippingGroupId,
      int supplyOrderShippingGroupVersion,
    ...
    checkParamsForCopyingSupplyOrderShippingGroup(
        userContext,
        supplyOrderId,
        supplyOrderShippingGroupId,
        supplyOrderShippingGroupVersion,
      ...
      supplyOrderShippingGroupManagerOf(userContext)
          .onNewInstanceCreated(
              ...
              (SupplyOrderShippingGroup)
                  supplyOrder.getFlexiableObjects().get(BaseEntity.COPIED_CHILD));
      return present(userContext, supplyOrder, mergedAllTokens(tokensExpr));
    }
  }

  protected void checkParamsForUpdatingSupplyOrderShippingGroup(
      RetailscmUserContext userContext,
      String supplyOrderId,
      String supplyOrderShippingGroupId,
      int supplyOrderShippingGroupVersion,
  ...
  public SupplyOrder updateSupplyOrderShippingGroup(
      RetailscmUserContext userContext,
      String supplyOrderId,
      String supplyOrderShippingGroupId,
      int supplyOrderShippingGroupVersion,
    ...
    checkParamsForUpdatingSupplyOrderShippingGroup(
        userContext,
        supplyOrderId,
        supplyOrderShippingGroupId,
        supplyOrderShippingGroupVersion,
    ...
    Map<String, Object> loadTokens =
        this.tokens()
            ...
            .searchSupplyOrderShippingGroupListWith(
                SupplyOrderShippingGroup.ID_PROPERTY, tokens().equals(), supplyOrderShippingGroupId)
            .done();
    ...
    synchronized (supplyOrder) {
      ...
      // supplyOrder.removeSupplyOrderShippingGroup( supplyOrderShippingGroup );
      // make changes to AcceleraterAccount.
      SupplyOrderShippingGroup supplyOrderShippingGroupIdVersionKey =
          createIndexedSupplyOrderShippingGroup(
              supplyOrderShippingGroupId, supplyOrderShippingGroupVersion);

      SupplyOrderShippingGroup supplyOrderShippingGroup =
          supplyOrder.findTheSupplyOrderShippingGroup(supplyOrderShippingGroupIdVersionKey);
      if (supplyOrderShippingGroup == null) {
        throw new SupplyOrderManagerException(supplyOrderShippingGroupId + " is NOT FOUND");
      }

      beforeUpdateSupplyOrderShippingGroup(
          userContext,
          supplyOrderShippingGroup,
          supplyOrderId,
          supplyOrderShippingGroupId,
      ...
      supplyOrder =
          saveSupplyOrder(
              userContext, supplyOrder, tokens().withSupplyOrderShippingGroupList().done());
      supplyOrderShippingGroupManagerOf(userContext)
          .onUpdated(userContext, supplyOrderShippingGroup, this, "updateSupplyOrderShippingGroup");
      return present(userContext, supplyOrder, mergedAllTokens(tokensExpr));
    }
  }

  /** if you has something need to do before update data from DB, override this */
  protected void beforeUpdateSupplyOrderShippingGroup(
      RetailscmUserContext userContext,
      SupplyOrderShippingGroup existed,
      String supplyOrderId,
      String supplyOrderShippingGroupId,
      int supplyOrderShippingGroupVersion,
      String property,
  ...
  */
  ...
  protected void checkParamsForAddingSupplyOrderPaymentGroup(
      RetailscmUserContext userContext,
      String supplyOrderId,
      String name,
      String cardNumber,
  ...
  public SupplyOrder addSupplyOrderPaymentGroup(
      RetailscmUserContext userContext,
      String supplyOrderId,
      String name,
      String cardNumber,
      String[] tokensExpr)
      throws Exception {
    checkParamsForAddingSupplyOrderPaymentGroup(
        userContext, supplyOrderId, name, cardNumber, tokensExpr);

    SupplyOrderPaymentGroup supplyOrderPaymentGroup =
        createSupplyOrderPaymentGroup(userContext, name, cardNumber);
    ...
    synchronized (supplyOrder) {
      ...
      supplyOrder =
          saveSupplyOrder(
              userContext, supplyOrder, tokens().withSupplyOrderPaymentGroupList().done());

      supplyOrderPaymentGroupManagerOf(userContext)
          .onNewInstanceCreated(userContext, supplyOrderPaymentGroup);
      return present(userContext, supplyOrder, mergedAllTokens(tokensExpr));
    }
  }

  protected void checkParamsForUpdatingSupplyOrderPaymentGroupProperties(
      RetailscmUserContext userContext,
      String supplyOrderId,
      String id,
      String name,
  ...
  public SupplyOrder updateSupplyOrderPaymentGroupProperties(
      RetailscmUserContext userContext,
      String supplyOrderId,
      String id,
      String name,
      ...
      String[] tokensExpr)
      throws Exception {
    checkParamsForUpdatingSupplyOrderPaymentGroupProperties(
        userContext, supplyOrderId, id, name, cardNumber, tokensExpr);

    Map<String, Object> options =
        tokens()
            .allTokens()
            // .withSupplyOrderPaymentGroupListList()
            .searchSupplyOrderPaymentGroupListWith(
                SupplyOrderPaymentGroup.ID_PROPERTY, tokens().is(), id)
            .done();
    ...
    if (supplyOrderToUpdate.getSupplyOrderPaymentGroupList().isEmpty()) {
      throw new SupplyOrderManagerException(
          "SupplyOrderPaymentGroup is NOT FOUND with id: '" + id + "'");
    }

    SupplyOrderPaymentGroup item = supplyOrderToUpdate.getSupplyOrderPaymentGroupList().first();
    beforeUpdateSupplyOrderPaymentGroupProperties(
        userContext, item, supplyOrderId, id, name, cardNumber, tokensExpr);
    item.updateName(name);
    item.updateCardNumber(cardNumber);

    // checkParamsForAddingSupplyOrderPaymentGroup(userContext,supplyOrderId,name, code,
    // used,tokensExpr);
    SupplyOrder supplyOrder =
        saveSupplyOrder(
            userContext, supplyOrderToUpdate, tokens().withSupplyOrderPaymentGroupList().done());
    synchronized (supplyOrder) {
      return present(userContext, supplyOrder, mergedAllTokens(tokensExpr));
    }
  }

  protected void beforeUpdateSupplyOrderPaymentGroupProperties(
      RetailscmUserContext userContext,
      SupplyOrderPaymentGroup item,
      String supplyOrderId,
      String id,
      String name,
      String cardNumber,
  ...
  protected SupplyOrderPaymentGroup createSupplyOrderPaymentGroup(
  ...
  protected void checkParamsForRemovingSupplyOrderPaymentGroupList(
      RetailscmUserContext userContext,
      String supplyOrderId,
      String supplyOrderPaymentGroupIds[],
      String[] tokensExpr)
      throws Exception {
  ...
  public SupplyOrder removeSupplyOrderPaymentGroupList(
      RetailscmUserContext userContext,
      String supplyOrderId,
      String supplyOrderPaymentGroupIds[],
      String[] tokensExpr)
    ...
    checkParamsForRemovingSupplyOrderPaymentGroupList(
        userContext, supplyOrderId, supplyOrderPaymentGroupIds, tokensExpr);
    ...
    synchronized (supplyOrder) {
      ...
      // Also good when there is a RAM based DAO implementation
      supplyOrderDaoOf(userContext)
          .planToRemoveSupplyOrderPaymentGroupList(
              supplyOrder, supplyOrderPaymentGroupIds, allTokens());
      supplyOrder =
          saveSupplyOrder(
              userContext, supplyOrder, tokens().withSupplyOrderPaymentGroupList().done());
  ...
  protected void checkParamsForRemovingSupplyOrderPaymentGroup(
      RetailscmUserContext userContext,
      String supplyOrderId,
  ...
  public SupplyOrder removeSupplyOrderPaymentGroup(
      RetailscmUserContext userContext,
      String supplyOrderId,
      String supplyOrderPaymentGroupId,
      int supplyOrderPaymentGroupVersion,
    ...
    checkParamsForRemovingSupplyOrderPaymentGroup(
        userContext,
        supplyOrderId,
        supplyOrderPaymentGroupId,
        supplyOrderPaymentGroupVersion,
        tokensExpr);

    SupplyOrderPaymentGroup supplyOrderPaymentGroup =
        createIndexedSupplyOrderPaymentGroup(
            supplyOrderPaymentGroupId, supplyOrderPaymentGroupVersion);
    SupplyOrder supplyOrder = loadSupplyOrder(userContext, supplyOrderId, allTokens());
    synchronized (supplyOrder) {
      // Will be good when the supplyOrder loaded from this JVM process cache.
      // Also good when there is a RAM based DAO implementation
  ...
  protected void checkParamsForCopyingSupplyOrderPaymentGroup(
      RetailscmUserContext userContext,
      String supplyOrderId,
      String supplyOrderPaymentGroupId,
      int supplyOrderPaymentGroupVersion,
  ...
  public SupplyOrder copySupplyOrderPaymentGroupFrom(
      RetailscmUserContext userContext,
      String supplyOrderId,
      String supplyOrderPaymentGroupId,
      int supplyOrderPaymentGroupVersion,
    ...
    checkParamsForCopyingSupplyOrderPaymentGroup(
        userContext,
        supplyOrderId,
        supplyOrderPaymentGroupId,
        supplyOrderPaymentGroupVersion,
  ...
  protected void checkParamsForUpdatingSupplyOrderPaymentGroup(
      RetailscmUserContext userContext,
      String supplyOrderId,
      String supplyOrderPaymentGroupId,
      int supplyOrderPaymentGroupVersion,
  ...
  public SupplyOrder updateSupplyOrderPaymentGroup(
      RetailscmUserContext userContext,
      String supplyOrderId,
      String supplyOrderPaymentGroupId,
      int supplyOrderPaymentGroupVersion,
    ...
    checkParamsForUpdatingSupplyOrderPaymentGroup(
        userContext,
        supplyOrderId,
        supplyOrderPaymentGroupId,
        supplyOrderPaymentGroupVersion,
    ...
    Map<String, Object> loadTokens =
        this.tokens()
            ...
            .searchSupplyOrderPaymentGroupListWith(
                SupplyOrderPaymentGroup.ID_PROPERTY, tokens().equals(), supplyOrderPaymentGroupId)
            .done();
    ...
    synchronized (supplyOrder) {
      ...
      // supplyOrder.removeSupplyOrderPaymentGroup( supplyOrderPaymentGroup );
      // make changes to AcceleraterAccount.
      SupplyOrderPaymentGroup supplyOrderPaymentGroupIdVersionKey =
          createIndexedSupplyOrderPaymentGroup(
              supplyOrderPaymentGroupId, supplyOrderPaymentGroupVersion);

      SupplyOrderPaymentGroup supplyOrderPaymentGroup =
          supplyOrder.findTheSupplyOrderPaymentGroup(supplyOrderPaymentGroupIdVersionKey);
      if (supplyOrderPaymentGroup == null) {
        throw new SupplyOrderManagerException(supplyOrderPaymentGroupId + " is NOT FOUND");
      }

      beforeUpdateSupplyOrderPaymentGroup(
          userContext,
          supplyOrderPaymentGroup,
          supplyOrderId,
          supplyOrderPaymentGroupId,
      ...
      supplyOrder =
          saveSupplyOrder(
              userContext, supplyOrder, tokens().withSupplyOrderPaymentGroupList().done());
      supplyOrderPaymentGroupManagerOf(userContext)
          .onUpdated(userContext, supplyOrderPaymentGroup, this, "updateSupplyOrderPaymentGroup");
      return present(userContext, supplyOrder, mergedAllTokens(tokensExpr));
    }
  }

  /** if you has something need to do before update data from DB, override this */
  protected void beforeUpdateSupplyOrderPaymentGroup(
      RetailscmUserContext userContext,
      SupplyOrderPaymentGroup existed,
      String supplyOrderId,
      String supplyOrderPaymentGroupId,
      int supplyOrderPaymentGroupVersion,
      String property,
  ...
  */
  ...
  public SupplyOrder updateGoodsProperties(
      RetailscmUserContext userContext,
      String supplyOrderId,
      String id,
      String name,
    ...
    checkParamsForUpdatingGoodsProperties(
        userContext, supplyOrderId, id, name, rfid, uom, maxPackage, expireTime, tokensExpr);
    ...
    beforeUpdateGoodsProperties(
        userContext, item, supplyOrderId, id, name, rfid, uom, maxPackage, expireTime, tokensExpr);
    item.updateName(name);
    ...
    SupplyOrder supplyOrder =
        saveSupplyOrder(userContext, supplyOrderToUpdate, tokens().withGoodsList().done());
    synchronized (supplyOrder) {
      return present(userContext, supplyOrder, mergedAllTokens(tokensExpr));
    }
  }
  ...
  public SupplyOrder removeGoodsList(
      RetailscmUserContext userContext,
      String supplyOrderId,
      String goodsIds[],
      String[] tokensExpr)
  ...
  public SupplyOrder removeGoods(
      RetailscmUserContext userContext,
      String supplyOrderId,
      String goodsId,
      int goodsVersion,
  ...
  public SupplyOrder copyGoodsFrom(
      RetailscmUserContext userContext,
      String supplyOrderId,
      String goodsId,
      int goodsVersion,
    ...
    synchronized (supplyOrder) {
      ...
      goodsManagerOf(userContext)
          .onNewInstanceCreated(
              userContext, (Goods) supplyOrder.getFlexiableObjects().get(BaseEntity.COPIED_CHILD));
      return present(userContext, supplyOrder, mergedAllTokens(tokensExpr));
    }
  }
  ...
  public SupplyOrder updateGoods(
      RetailscmUserContext userContext,
      String supplyOrderId,
      String goodsId,
      int goodsVersion,
    ...
    checkParamsForUpdatingGoods(
        userContext, supplyOrderId, goodsId, goodsVersion, property, newValueExpr, tokensExpr);
  ...
  */
  ...
  public void onNewInstanceCreated(RetailscmUserContext userContext, SupplyOrder newCreated)
      throws Exception {
  ...
  public void sendAllItems(RetailscmUserContext ctx) throws Exception {
    supplyOrderDaoOf(ctx).loadAllAsStream().forEach(event -> sendInitEvent(ctx, event));
  }
  ...
  // -----------------------------------// list-of-view 处理 \\-----------------------------------
  protected void enhanceForListOfView(RetailscmUserContext userContext, SmartList<SupplyOrder> list)
      throws Exception {
    if (list == null || list.isEmpty()) {
      return;
    }
    List<RetailStoreCountryCenter> buyerList =
  ...
  public Object listPageByBuyer(
    ...
    SmartList<SupplyOrder> list =
        supplyOrderDaoOf(userContext)
            .findSupplyOrderByBuyer(buyerId, start, count, new HashMap<>());
  ...
  public Object listPageBySeller(
    ...
    SmartList<SupplyOrder> list =
        supplyOrderDaoOf(userContext)
            .findSupplyOrderBySeller(sellerId, start, count, new HashMap<>());
    enhanceForListOfView(userContext, list);
    RetailscmCommonListOfViewPage page = new RetailscmCommonListOfViewPage();
    page.setClassOfList(SupplyOrder.class);
  ...
  public Object wxappview(RetailscmUserContext userContext, String supplyOrderId) throws Exception {
    ...
    Map supplyOrderLineItemListSection =
    ...
    result.put(
        "supplyOrderLineItemListSection",
        ListofUtils.toShortList(merchantObj.getSupplyOrderLineItemList(), "supplyOrderLineItem"));

    // 处理Section：supplyOrderShippingGroupListSection
    Map supplyOrderShippingGroupListSection =
        ListofUtils.buildSection(
    ...
    result.put(
        ...
        ListofUtils.toShortList(
            merchantObj.getSupplyOrderShippingGroupList(), "supplyOrderShippingGroup"));

    // 处理Section：supplyOrderPaymentGroupListSection
    Map supplyOrderPaymentGroupListSection =
        ListofUtils.buildSection(
    ...
    result.put(
        "supplyOrderPaymentGroupListSection",
        ListofUtils.toShortList(
            merchantObj.getSupplyOrderPaymentGroupList(), "supplyOrderPaymentGroup"));
