...
public interface MemberRewardPointRedemptionManager extends BaseManager{
  ...
  List<MemberRewardPointRedemption> searchMemberRewardPointRedemptionList(RetailscmUserContext ctx, MemberRewardPointRedemptionRequest pRequest);
  MemberRewardPointRedemption searchMemberRewardPointRedemption(RetailscmUserContext ctx, MemberRewardPointRedemptionRequest pRequest);
	...
	public default void onUpdated(RetailscmUserContext userContext, MemberRewardPointRedemption updated, Object actor, String methodName) throws Exception {};
