...
public class MemberRewardPointRedemptionManagerImpl extends CustomRetailscmCheckerManager
    implements MemberRewardPointRedemptionManager, BusinessHandler {
  ...
  protected void throwExceptionWithMessage(String value)
      throws MemberRewardPointRedemptionManagerException {
  ...
  protected MemberRewardPointRedemption saveMemberRewardPointRedemptionDetail(
  ...
  public MemberRewardPointRedemption loadMemberRewardPointRedemption(
    ...
    checkerOf(userContext)
        .throwExceptionIfHasErrors(MemberRewardPointRedemptionManagerException.class);

    Map<String, Object> tokens = parseTokens(tokensExpr);

    MemberRewardPointRedemption memberRewardPointRedemption =
        loadMemberRewardPointRedemption(userContext, memberRewardPointRedemptionId, tokens);
    // do some calc before sent to customer?
    return present(userContext, memberRewardPointRedemption, tokens);
  }

  public MemberRewardPointRedemption searchMemberRewardPointRedemption(
      RetailscmUserContext userContext,
  ...
  protected MemberRewardPointRedemption present(
      RetailscmUserContext userContext,
      MemberRewardPointRedemption memberRewardPointRedemption,
      Map<String, Object> tokens)
      throws Exception {
    ...
    MemberRewardPointRedemption memberRewardPointRedemptionToPresent =
        memberRewardPointRedemptionDaoOf(userContext).present(memberRewardPointRedemption, tokens);

    List<BaseEntity> entityListToNaming =
        memberRewardPointRedemptionToPresent.collectReferencesFromLists();
  ...
  public MemberRewardPointRedemption loadMemberRewardPointRedemptionDetail(
      RetailscmUserContext userContext, String memberRewardPointRedemptionId) throws Exception {
    MemberRewardPointRedemption memberRewardPointRedemption =
        loadMemberRewardPointRedemption(userContext, memberRewardPointRedemptionId, allTokens());
  ...
  public Object view(RetailscmUserContext userContext, String memberRewardPointRedemptionId)
      throws Exception {
    MemberRewardPointRedemption memberRewardPointRedemption =
        loadMemberRewardPointRedemption(userContext, memberRewardPointRedemptionId, viewTokens());
    markVisited(userContext, memberRewardPointRedemption);
    return present(userContext, memberRewardPointRedemption, viewTokens());
  }

  public Object summaryView(RetailscmUserContext userContext, String memberRewardPointRedemptionId)
      throws Exception {
    MemberRewardPointRedemption memberRewardPointRedemption =
        loadMemberRewardPointRedemption(userContext, memberRewardPointRedemptionId, viewTokens());
  ...
  public Object analyze(RetailscmUserContext userContext, String memberRewardPointRedemptionId)
      throws Exception {
    MemberRewardPointRedemption memberRewardPointRedemption =
        loadMemberRewardPointRedemption(
            userContext, memberRewardPointRedemptionId, analyzeTokens());
    markVisited(userContext, memberRewardPointRedemption);
  ...
  protected MemberRewardPointRedemption loadMemberRewardPointRedemption(
      RetailscmUserContext userContext,
      String memberRewardPointRedemptionId,
      Map<String, Object> tokens)
      throws Exception {
    ...
    return memberRewardPointRedemptionDaoOf(userContext)
        .load(memberRewardPointRedemptionId, tokens);
  }
  ...
  protected <T extends BaseEntity> void addActions(
    ...
    // userContext, MemberRewardPointRedemption memberRewardPointRedemption, Map<String, Object>
    // tokens){

  @Override
  public List<MemberRewardPointRedemption> searchMemberRewardPointRedemptionList(
  ...
  public MemberRewardPointRedemption createMemberRewardPointRedemption(
    ...
    MemberRewardPointRedemption memberRewardPointRedemption =
        createNewMemberRewardPointRedemption();
    ...
    memberRewardPointRedemption =
        saveMemberRewardPointRedemption(userContext, memberRewardPointRedemption, emptyOptions());
  ...
  public MemberRewardPointRedemption clone(
      RetailscmUserContext userContext, String fromMemberRewardPointRedemptionId) throws Exception {

    return memberRewardPointRedemptionDaoOf(userContext)
        .clone(fromMemberRewardPointRedemptionId, this.allTokens());
  }

  public MemberRewardPointRedemption internalSaveMemberRewardPointRedemption(
      RetailscmUserContext userContext, MemberRewardPointRedemption memberRewardPointRedemption)
      throws Exception {
    return internalSaveMemberRewardPointRedemption(
        userContext, memberRewardPointRedemption, allTokens());
  }
  ...
  public MemberRewardPointRedemption internalSaveMemberRewardPointRedemption(
      ...
      throws Exception {
    // checkParamsForUpdatingMemberRewardPointRedemption(userContext, memberRewardPointRedemptionId,
    // memberRewardPointRedemptionVersion, property, newValueExpr, tokensExpr);
    ...
    synchronized (memberRewardPointRedemption) {
      ...
      memberRewardPointRedemption =
          saveMemberRewardPointRedemption(userContext, memberRewardPointRedemption, options);
      return memberRewardPointRedemption;
    }
  }
  ...
  public MemberRewardPointRedemption updateMemberRewardPointRedemption(
    ...
    synchronized (memberRewardPointRedemption) {
      ...
      memberRewardPointRedemption =
          saveMemberRewardPointRedemption(
              userContext, memberRewardPointRedemption, tokens().done());
      return present(userContext, memberRewardPointRedemption, mergedAllTokens(tokensExpr));
      // return saveMemberRewardPointRedemption(userContext, memberRewardPointRedemption,
      // tokens().done());
    }
  }

  public MemberRewardPointRedemption updateMemberRewardPointRedemptionProperty(
      RetailscmUserContext userContext,
      String memberRewardPointRedemptionId,
      int memberRewardPointRedemptionVersion,
      String property,
  ...
  public MemberRewardPointRedemption transferToAnotherOwner(
    ...
    checkParamsForTransferingAnotherOwner(
        userContext, memberRewardPointRedemptionId, anotherOwnerId);
  ...
  public MemberRewardPointRedemption forgetByAll(
      RetailscmUserContext userContext,
      String memberRewardPointRedemptionId,
      int memberRewardPointRedemptionVersion)
      throws Exception {
    return forgetByAllInternal(
        userContext, memberRewardPointRedemptionId, memberRewardPointRedemptionVersion);
  }

  protected MemberRewardPointRedemption forgetByAllInternal(
      RetailscmUserContext userContext,
      String memberRewardPointRedemptionId,
      int memberRewardPointRedemptionVersion)
      throws Exception {
    ...
    return memberRewardPointRedemptionDaoOf(userContext)
        .disconnectFromAll(memberRewardPointRedemptionId, memberRewardPointRedemptionVersion);
  }
  ...
  public void sendAllItems(RetailscmUserContext ctx) throws Exception {
    memberRewardPointRedemptionDaoOf(ctx)
        .loadAllAsStream()
  ...
  public void onAuthenticateNewUserLogged(
    ...
    // this.createMemberRewardPointRedemption(userContext, ...
  ...
  protected void enhanceForListOfView(
      RetailscmUserContext userContext, SmartList<MemberRewardPointRedemption> list)
      throws Exception {
    if (list == null || list.isEmpty()) {
      return;
    }
  ...
  public Object listPageByOwner(
    ...
    SmartList<MemberRewardPointRedemption> list =
        memberRewardPointRedemptionDaoOf(userContext)
            .findMemberRewardPointRedemptionByOwner(ownerId, start, count, new HashMap<>());
   ...
   * @throws Exception
   */
  public Object wxappview(RetailscmUserContext userContext, String memberRewardPointRedemptionId)
      throws Exception {
    SerializeScope vscope = SerializeScope.EXCLUDE().nothing();
    MemberRewardPointRedemption merchantObj =
        (MemberRewardPointRedemption) this.view(userContext, memberRewardPointRedemptionId);
