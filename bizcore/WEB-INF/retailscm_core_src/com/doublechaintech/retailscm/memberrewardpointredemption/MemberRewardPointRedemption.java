...
return getId();
	...
	public MemberRewardPointRedemption updateId(String id){String oldId = this.id;String newId = trimString(id);if(!shouldReplaceBy(newId, oldId)){return this;}this.id = newId;addPropertyChange(ID_PROPERTY, oldId, newId);this.changed = true;setChecked(false);return this;}
...
return createCriteria(ID_PROPERTY, operator, parameters);
	...
	public MemberRewardPointRedemption ignoreIdCriteria(){super.ignoreSearchProperty(ID_PROPERTY);
return this;
}
...
return getName();
	...
	public MemberRewardPointRedemption updateName(String name){String oldName = this.name;String newName = trimString(name);if(!shouldReplaceBy(newName, oldName)){return this;}this.name = newName;addPropertyChange(NAME_PROPERTY, oldName, newName);this.changed = true;setChecked(false);return this;}
...
return createCriteria(NAME_PROPERTY, operator, parameters);
	...
	public MemberRewardPointRedemption ignoreNameCriteria(){super.ignoreSearchProperty(NAME_PROPERTY);
return this;
}
...
return getPoint();
	...
	public MemberRewardPointRedemption updatePoint(int point){int oldPoint = this.point;int newPoint = point;if(!shouldReplaceBy(newPoint, oldPoint)){return this;}this.point = newPoint;addPropertyChange(POINT_PROPERTY, oldPoint, newPoint);this.changed = true;setChecked(false);return this;}
...
return createCriteria(POINT_PROPERTY, operator, parameters);
	...
	public MemberRewardPointRedemption ignorePointCriteria(){super.ignoreSearchProperty(POINT_PROPERTY);
return this;
}
	public MemberRewardPointRedemption addPointCriteria(QueryOperator operator, Object... parameters){
...
return createCriteria(OWNER_PROPERTY, operator, parameters);
	...
	public MemberRewardPointRedemption ignoreOwnerCriteria(){super.ignoreSearchProperty(OWNER_PROPERTY);
return this;
}
	public MemberRewardPointRedemption addOwnerCriteria(QueryOperator operator, Object... parameters){
...
return getVersion();
	...
	public MemberRewardPointRedemption updateVersion(int version){int oldVersion = this.version;int newVersion = version;if(!shouldReplaceBy(newVersion, oldVersion)){return this;}this.version = newVersion;addPropertyChange(VERSION_PROPERTY, oldVersion, newVersion);this.changed = true;setChecked(false);return this;}
...
return createCriteria(VERSION_PROPERTY, operator, parameters);
	...
	public MemberRewardPointRedemption ignoreVersionCriteria(){super.ignoreSearchProperty(VERSION_PROPERTY);
return this;
}
	public MemberRewardPointRedemption addVersionCriteria(QueryOperator operator, Object... parameters){
...
return this;
	...
	public static MemberRewardPointRedemption createWith(RetailscmUserContext userContext, ThrowingFunction<MemberRewardPointRedemption,MemberRewardPointRedemption,Exception> postHandler, Object ... inputs) throws Exception {

    List<Object> params = inputs == null ? new ArrayList<>() : Arrays.asList(inputs);
    CustomRetailscmPropertyMapper mapper = CustomRetailscmPropertyMapper.of(userContext);
    CreationScene scene = mapper.findParamByClass(params, CreationScene.class);
    RetailscmBeanCreator<MemberRewardPointRedemption> customCreator = mapper.findCustomCreator(MemberRewardPointRedemption.class, scene);
    if (customCreator != null){
      return customCreator.create(userContext, scene, postHandler, params);
    }

    MemberRewardPointRedemption result = new MemberRewardPointRedemption();
    result.setName(mapper.tryToGet(MemberRewardPointRedemption.class, NAME_PROPERTY, String.class,
        0, true, result.getName(), params));
    result.setPoint(mapper.tryToGet(MemberRewardPointRedemption.class, POINT_PROPERTY, int.class,
        0, true, result.getPoint(), params));
    result.setOwner(mapper.tryToGet(MemberRewardPointRedemption.class, OWNER_PROPERTY, RetailStoreMember.class,
    ...
    if (result != null){
      userContext.getChecker().checkAndFixMemberRewardPointRedemption(result);
      userContext.getChecker().throwExceptionIfHasErrors(IllegalArgumentException.class);

      
      MemberRewardPointRedemptionTokens tokens = mapper.findParamByClass(params, MemberRewardPointRedemptionTokens.class);
      if (tokens == null) {
        tokens = MemberRewardPointRedemptionTokens.start();
      }
      result = userContext.getManagerGroup().getMemberRewardPointRedemptionManager().internalSaveMemberRewardPointRedemption(userContext, result, tokens.done());
