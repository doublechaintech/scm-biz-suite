...
public class WarehouseAssetTokens extends CommonTokens{
  ...
  public static WarehouseAssetTokens loadGroupTokens(String... groupNames){
    WarehouseAssetTokens tokens = start();
  ...
  private static void addToken(WarehouseAssetTokens pTokens, String pTokenName, String[] pGroupNames, String[] fieldGroups) {
	...
	public static WarehouseAssetTokens filterWithTokenViewGroups(String []viewGroups){
	...
	public static WarehouseAssetTokens allTokens(){
	...
	public WarehouseTokens withOwnerTokens(){
		//addSimpleOptions(OWNER);
