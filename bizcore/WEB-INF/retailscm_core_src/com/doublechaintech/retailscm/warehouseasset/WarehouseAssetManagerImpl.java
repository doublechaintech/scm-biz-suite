...
import com.doublechaintech.retailscm.*;import com.doublechaintech.retailscm.BaseViewPage;import com.doublechaintech.retailscm.RetailscmUserContextImpl;import com.doublechaintech.retailscm.iamservice.*;import com.doublechaintech.retailscm.secuser.SecUser;import com.doublechaintech.retailscm.services.IamService;import com.doublechaintech.retailscm.tree.*;import com.doublechaintech.retailscm.treenode.*;import com.doublechaintech.retailscm.userapp.UserApp;import com.doublechaintech.retailscm.utils.ModelAssurance;import com.doublechaintech.retailscm.warehouse.CandidateWarehouse;import com.doublechaintech.retailscm.warehouse.Warehouse;
...
public class WarehouseAssetManagerImpl extends CustomRetailscmCheckerManager implements WarehouseAssetManager, BusinessHandler{
	...
	public Object prepareContextForUserApp(BaseUserContext userContext,Object targetUserApp) throws Exception{
	 ...
	 public Object summaryView(RetailscmUserContext userContext, String warehouseAssetId) throws Exception{
		WarehouseAsset warehouseAsset = loadWarehouseAsset( userContext, warehouseAssetId, viewTokens());
	 ...
	 public Object analyze(RetailscmUserContext userContext, String warehouseAssetId) throws Exception{
		WarehouseAsset warehouseAsset = loadWarehouseAsset( userContext, warehouseAssetId, analyzeTokens());
		markVisited(userContext, warehouseAsset);
  ...
  @Override
  public List<WarehouseAsset> searchWarehouseAssetList(RetailscmUserContext ctx, WarehouseAssetRequest pRequest){
  ...
  @Override
  public WarehouseAsset searchWarehouseAsset(RetailscmUserContext ctx, WarehouseAssetRequest pRequest){
    pRequest.limit(0, 1);
