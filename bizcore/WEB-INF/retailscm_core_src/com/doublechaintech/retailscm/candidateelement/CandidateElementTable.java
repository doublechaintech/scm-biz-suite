...
public class CandidateElementTable {
  ...
  public static final String[] ALL_CLOUMNS = {
    COLUMN_ID, COLUMN_NAME, COLUMN_TYPE, COLUMN_IMAGE, COLUMN_CONTAINER, COLUMN_VERSION
  };
  ...
  public static void ensureTable(RetailscmUserContext userContext, Map<String, Object> result)
    ...
    RetailscmBaseUtils.ensureTable(
        userContext,
        result,
        "candidate_element_data",
        new String[][] {
          new String[] {"id", "varchar(48)", " not null", "ID", "", ""},
          new String[] {"name", "varchar(200)", "", "名称", "", ""},
          new String[] {"type", "varchar(200)", "", "类型", "", ""},
          new String[] {
            "image", "varchar(512) CHARACTER SET ascii COLLATE ascii_general_ci", "", "图片", "", ""
          },
