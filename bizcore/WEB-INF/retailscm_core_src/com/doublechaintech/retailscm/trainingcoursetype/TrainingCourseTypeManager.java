...
public interface TrainingCourseTypeManager extends BaseManager{
  ...
  List<TrainingCourseType> searchTrainingCourseTypeList(RetailscmUserContext ctx, TrainingCourseTypeRequest pRequest);
  TrainingCourseType searchTrainingCourseType(RetailscmUserContext ctx, TrainingCourseTypeRequest pRequest);
	...
	public default void onUpdated(RetailscmUserContext userContext, TrainingCourseType updated, Object actor, String methodName) throws Exception {};
