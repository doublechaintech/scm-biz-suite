...
public class AccountSetTable{
	...
	static final String TABLE_NAME="account_set_data";
	...
	static final String []ALL_CLOUMNS = {COLUMN_ID, 
		COLUMN_NAME, COLUMN_YEAR_SET, COLUMN_EFFECTIVE_DATE, COLUMN_ACCOUNTING_SYSTEM, COLUMN_DOMESTIC_CURRENCY_CODE, COLUMN_DOMESTIC_CURRENCY_NAME, COLUMN_OPENING_BANK, COLUMN_ACCOUNT_NUMBER, COLUMN_COUNTRY_CENTER, COLUMN_RETAIL_STORE, COLUMN_GOODS_SUPPLIER, COLUMN_LAST_UPDATE_TIME, 
		COLUMN_VERSION};
