...
public interface EmployeeInterviewManager extends BaseManager{
  ...
  List<EmployeeInterview> searchEmployeeInterviewList(RetailscmUserContext ctx, EmployeeInterviewRequest pRequest);
  EmployeeInterview searchEmployeeInterview(RetailscmUserContext ctx, EmployeeInterviewRequest pRequest);
	...
	public default void onUpdated(RetailscmUserContext userContext, EmployeeInterview updated, Object actor, String methodName) throws Exception {};
