...
public class EmployeeInterviewManagerImpl extends CustomRetailscmCheckerManager
    implements EmployeeInterviewManager, BusinessHandler {
  ...
  protected EmployeeInterview saveEmployeeInterview(
      RetailscmUserContext userContext, EmployeeInterview employeeInterview, String[] tokensExpr)
      throws Exception {
  ...
  protected EmployeeInterview saveEmployeeInterviewDetail(
  ...
  public EmployeeInterview loadEmployeeInterview(
    ...
    EmployeeInterview employeeInterview =
        loadEmployeeInterview(userContext, employeeInterviewId, tokens);
    // do some calc before sent to customer?
    return present(userContext, employeeInterview, tokens);
  }

  public EmployeeInterview searchEmployeeInterview(
  ...
  protected EmployeeInterview present(
      RetailscmUserContext userContext,
      EmployeeInterview employeeInterview,
      Map<String, Object> tokens)
      throws Exception {
    ...
    EmployeeInterview employeeInterviewToPresent =
        employeeInterviewDaoOf(userContext).present(employeeInterview, tokens);

    List<BaseEntity> entityListToNaming = employeeInterviewToPresent.collectReferencesFromLists();
  ...
  public EmployeeInterview loadEmployeeInterviewDetail(
      RetailscmUserContext userContext, String employeeInterviewId) throws Exception {
    EmployeeInterview employeeInterview =
        loadEmployeeInterview(userContext, employeeInterviewId, allTokens());
  ...
  public Object view(RetailscmUserContext userContext, String employeeInterviewId)
      throws Exception {
    EmployeeInterview employeeInterview =
        loadEmployeeInterview(userContext, employeeInterviewId, viewTokens());
    markVisited(userContext, employeeInterview);
    return present(userContext, employeeInterview, viewTokens());
  }

  public Object summaryView(RetailscmUserContext userContext, String employeeInterviewId)
      throws Exception {
    EmployeeInterview employeeInterview =
        loadEmployeeInterview(userContext, employeeInterviewId, viewTokens());
  ...
  public Object analyze(RetailscmUserContext userContext, String employeeInterviewId)
      throws Exception {
    EmployeeInterview employeeInterview =
        loadEmployeeInterview(userContext, employeeInterviewId, analyzeTokens());
    markVisited(userContext, employeeInterview);
  ...
  protected EmployeeInterview loadEmployeeInterview(
      RetailscmUserContext userContext, String employeeInterviewId, Map<String, Object> tokens)
      throws Exception {
    checkerOf(userContext).checkIdOfEmployeeInterview(employeeInterviewId);
  ...
  protected <T extends BaseEntity> void addActions(
    ...
    // userContext, EmployeeInterview employeeInterview, Map<String, Object> tokens){

  @Override
  public List<EmployeeInterview> searchEmployeeInterviewList(
  ...
  public EmployeeInterview clone(RetailscmUserContext userContext, String fromEmployeeInterviewId)
      throws Exception {
  ...
  public EmployeeInterview internalSaveEmployeeInterview(
      ...
      throws Exception {
    // checkParamsForUpdatingEmployeeInterview(userContext, employeeInterviewId,
    // employeeInterviewVersion, property, newValueExpr, tokensExpr);
  ...
  public EmployeeInterview updateEmployeeInterviewProperty(
      RetailscmUserContext userContext,
      String employeeInterviewId,
      int employeeInterviewVersion,
      String property,
  ...
  public CandidateEmployee requestCandidateEmployee(
    ...
    SmartList<Employee> candidateList =
        employeeDaoOf(userContext)
            .requestCandidateEmployeeForEmployeeInterview(
  ...
  protected void checkParamsForTransferingAnotherInterviewType(
      RetailscmUserContext userContext, String employeeInterviewId, String anotherInterviewTypeId)
      throws Exception {

    checkerOf(userContext).checkIdOfEmployeeInterview(employeeInterviewId);
    checkerOf(userContext)
        .checkIdOfInterviewType(anotherInterviewTypeId); // check for optional reference
  ...
  public EmployeeInterview transferToAnotherInterviewType(
      RetailscmUserContext userContext, String employeeInterviewId, String anotherInterviewTypeId)
      throws Exception {
    checkParamsForTransferingAnotherInterviewType(
        userContext, employeeInterviewId, anotherInterviewTypeId);
    ...
    synchronized (employeeInterview) {
      ...
      InterviewType interviewType =
          loadInterviewType(userContext, anotherInterviewTypeId, emptyOptions());
  ...
  public CandidateInterviewType requestCandidateInterviewType(
      RetailscmUserContext userContext, String ownerClass, String id, String filterKey, int pageNo)
      throws Exception {
    ...
    int pageSize = 20;
    // requestCandidateProductForSkuAsOwner
    SmartList<InterviewType> candidateList =
        interviewTypeDaoOf(userContext)
            .requestCandidateInterviewTypeForEmployeeInterview(
                userContext, ownerClass, id, filterKey, pageNo, pageSize);
    result.setCandidates(candidateList);
    int totalCount = candidateList.getTotalCount();
    result.setTotalPage(Math.max(1, (totalCount + pageSize - 1) / pageSize));
  ...
  protected InterviewType loadInterviewType(
      RetailscmUserContext userContext, String newInterviewTypeId, Map<String, Object> options)
      throws Exception {
  ...
  public EmployeeInterview forgetByAll(
      RetailscmUserContext userContext, String employeeInterviewId, int employeeInterviewVersion)
      throws Exception {
    return forgetByAllInternal(userContext, employeeInterviewId, employeeInterviewVersion);
  }

  protected EmployeeInterview forgetByAllInternal(
      RetailscmUserContext userContext, String employeeInterviewId, int employeeInterviewVersion)
      throws Exception {

    return employeeInterviewDaoOf(userContext)
        .disconnectFromAll(employeeInterviewId, employeeInterviewVersion);
  }
  ...
  public void sendAllItems(RetailscmUserContext ctx) throws Exception {
    employeeInterviewDaoOf(ctx).loadAllAsStream().forEach(event -> sendInitEvent(ctx, event));
  }
  ...
  protected void enhanceForListOfView(
      RetailscmUserContext userContext, SmartList<EmployeeInterview> list) throws Exception {
    if (list == null || list.isEmpty()) {
      return;
    }
    ...
    List<InterviewType> interviewTypeList =
        RetailscmBaseUtils.collectReferencedObjectWithType(userContext, list, InterviewType.class);
  ...
  public Object listPageByEmployee(
    ...
    SmartList<EmployeeInterview> list =
        employeeInterviewDaoOf(userContext)
            .findEmployeeInterviewByEmployee(employeeId, start, count, new HashMap<>());
  ...
  public Object listPageByInterviewType(
    ...
    SmartList<EmployeeInterview> list =
        employeeInterviewDaoOf(userContext)
            .findEmployeeInterviewByInterviewType(interviewTypeId, start, count, new HashMap<>());
    enhanceForListOfView(userContext, list);
    RetailscmCommonListOfViewPage page = new RetailscmCommonListOfViewPage();
    page.setClassOfList(EmployeeInterview.class);
    ...
    page.setLinkToUrl(
        TextUtil.encodeUrl(
            String.format("%s/listByInterviewType/%s/", getBeanName(), interviewTypeId)));
   ...
   * @throws Exception
   */
  public Object wxappview(RetailscmUserContext userContext, String employeeInterviewId)
      throws Exception {
