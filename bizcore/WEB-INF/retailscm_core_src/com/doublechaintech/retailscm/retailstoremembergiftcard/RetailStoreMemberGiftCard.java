...
public class RetailStoreMemberGiftCard extends BaseEntity implements java.io.Serializable {
  ...
  public void transferAllRelationshipsTo(RetailStoreMemberGiftCard target) {
    if (target == null) {
      return;
    }
  ...
  static {
    ...
    memberMetaInfoList.add(
        MemberMetaInfo.defineBy(NUMBER_PROPERTY, "number", "数").withType("string", String.class));
    memberMetaInfoList.add(
        MemberMetaInfo.defineBy(REMAIN_PROPERTY, "remain", "保持").withType("money", "BigDecimal"));
    memberMetaInfoList.add(
        MemberMetaInfo.defineBy(VERSION_PROPERTY, "version", "版本").withType("version", "int"));

    memberMetaInfoList.add(
        MemberMetaInfo.referBy(
                RETAIL_STORE_MEMBER_GIFT_CARD_CONSUME_RECORD_LIST, "owner", "零售会员礼品卡消费记录列表")
            .withType(
  ...
  public RetailStoreMemberGiftCard ignoreIdCriteria() {
  ...
  public RetailStoreMemberGiftCard ignoreNameCriteria() {
  ...
  public RetailStoreMemberGiftCard ignoreOwnerCriteria() {
  ...
  public RetailStoreMemberGiftCard updateOwnerByReferenceId(String ownerId) {
  ...
  public void setNumber(String number) {
    ...
    String newNumber = trimString(number);
  ...
  public RetailStoreMemberGiftCard updateNumber(String number) {
    String oldNumber = this.number;
    String newNumber = trimString(number);
    if (!shouldReplaceBy(newNumber, oldNumber)) {
      return this;
    }
    this.number = newNumber;
    if (cn.hutool.core.util.ObjectUtil.equals(newNumber, oldNumber)) {
      return this;
    }
    addPropertyChange(NUMBER_PROPERTY, oldNumber, newNumber);
    this.changed = true;
    setChecked(false);
    return this;
  }
  ...
  public RetailStoreMemberGiftCard ignoreNumberCriteria() {
    super.ignoreSearchProperty(NUMBER_PROPERTY);
    return this;
  }
  ...
  public void setRemain(BigDecimal remain) {
    BigDecimal oldRemain = this.remain;
    BigDecimal newRemain = remain;
  ...
  public RetailStoreMemberGiftCard updateRemain(BigDecimal remain) {
    BigDecimal oldRemain = this.remain;
    BigDecimal newRemain = remain;
    if (!shouldReplaceBy(newRemain, oldRemain)) {
      return this;
    }
    this.remain = newRemain;
    if (cn.hutool.core.util.ObjectUtil.equals(newRemain, oldRemain)) {
      return this;
    }
    addPropertyChange(REMAIN_PROPERTY, oldRemain, newRemain);
    this.changed = true;
    setChecked(false);
    return this;
  }
  ...
  public RetailStoreMemberGiftCard ignoreRemainCriteria() {
    super.ignoreSearchProperty(REMAIN_PROPERTY);
    return this;
  }
  ...
  public RetailStoreMemberGiftCard ignoreVersionCriteria() {
    super.ignoreSearchProperty(VERSION_PROPERTY);
    return this;
  }

  public RetailStoreMemberGiftCard addVersionCriteria(
  ...
  public RetailStoreMemberGiftCard addRetailStoreMemberGiftCardConsumeRecord(
    ...
    retailStoreMemberGiftCardConsumeRecord.updateOwner(this);
    getRetailStoreMemberGiftCardConsumeRecordList().add(retailStoreMemberGiftCardConsumeRecord);
    return this;
  }

  public RetailStoreMemberGiftCard addRetailStoreMemberGiftCardConsumeRecordList(
      SmartList<RetailStoreMemberGiftCardConsumeRecord>
          retailStoreMemberGiftCardConsumeRecordList) {
    for (RetailStoreMemberGiftCardConsumeRecord retailStoreMemberGiftCardConsumeRecord :
        retailStoreMemberGiftCardConsumeRecordList) {
  ...
  public BaseEntity mergeDataFrom(BaseEntity sourceEntity) {
    ...
    if (sourceEntity instanceof RetailStoreMemberGiftCard) {

      RetailStoreMemberGiftCard source = (RetailStoreMemberGiftCard) sourceEntity;

      mergeId(source.getId());
      mergeName(source.getName());
      mergeOwner(source.getOwner());
      mergeNumber(source.getNumber());
      mergeRemain(source.getRemain());
  ...
  public boolean checkIfEligibleForDelete(Object ctx) {
    ...
    RetailStoreMemberGiftCard checkRetailStoreMemberGiftCard =
        Q.retailStoreMemberGiftCardWithIdField()
            .filterById(id)
            .selectRetailStoreMemberGiftCardConsumeRecordList(
                Q.retailStoreMemberGiftCardConsumeRecordWithIdField().limit(0, 1))
            .execute(ctx);

    return checkRetailStoreMemberGiftCard != null
        && !checkRetailStoreMemberGiftCard.getAllRelatedLists().stream()
            .flatMap(subList -> subList.stream())
            .findFirst()
            .isPresent();
  }

  public RetailStoreMemberGiftCard save(com.doublechaintech.retailscm.RetailscmUserContext ctx) {
    try {
