...
public class RetailStoreMemberGiftCardGridViewGenerator extends BaseGridViewGenerator{
	...
	protected void throwExceptionIfListNotFount(String listName) {
		String message=String.format("List '%s' is not found for RetailStoreMemberGiftCard", listName);
		throw new IllegalArgumentException(message);
	}

	protected String [] getHeaderKeys(String listName) {

		if(RetailStoreMemberGiftCard.RETAIL_STORE_MEMBER_GIFT_CARD_CONSUME_RECORD_LIST.equals(listName)){
