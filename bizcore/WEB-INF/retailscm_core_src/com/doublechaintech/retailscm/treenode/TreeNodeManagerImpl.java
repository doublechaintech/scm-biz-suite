...
public class TreeNodeManagerImpl extends CustomRetailscmCheckerManager implements TreeNodeManager, BusinessHandler{
	...
	protected void throwExceptionWithMessage(String value) throws TreeNodeManagerException{
 	...
 	protected TreeNode saveTreeNode(RetailscmUserContext userContext, TreeNode treeNode, String [] tokensExpr) throws Exception{	
 	...
 	protected TreeNode saveTreeNodeDetail(RetailscmUserContext userContext, TreeNode treeNode) throws Exception{	
 	...
 	public TreeNode loadTreeNode(RetailscmUserContext userContext, String treeNodeId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public TreeNode searchTreeNode(RetailscmUserContext userContext, String treeNodeId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected TreeNode present(RetailscmUserContext userContext, TreeNode treeNode, Map<String, Object> tokens) throws Exception {
 	...
 	public TreeNode loadTreeNodeDetail(RetailscmUserContext userContext, String treeNodeId) throws Exception{	
 	...
 	protected TreeNode saveTreeNode(RetailscmUserContext userContext, TreeNode treeNode, Map<String,Object>tokens) throws Exception{	
 		return treeNodeDaoOf(userContext).save(treeNode, tokens);
 	}
 	protected TreeNode loadTreeNode(RetailscmUserContext userContext, String treeNodeId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfTreeNode(treeNodeId);
		checkerOf(userContext).throwExceptionIfHasErrors( TreeNodeManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(RetailscmUserContext userContext, TreeNode treeNode, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(RetailscmUserContext userContext, TreeNode treeNode, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingTreeNode(RetailscmUserContext userContext,String treeNodeId, int treeNodeVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public TreeNode internalSaveTreeNode(RetailscmUserContext userContext, TreeNode treeNode, Map<String,Object> options) throws Exception
	{
	...
	public TreeNode updateTreeNodeProperty(RetailscmUserContext userContext,String treeNodeId, int treeNodeVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingTreeNode(userContext, treeNodeId, treeNodeVersion, property, newValueExpr, tokensExpr);
...
//--------------------------------------------------------------
	...
	public void delete(RetailscmUserContext userContext, String treeNodeId, int treeNodeVersion) throws Exception {
	...
	public TreeNode forgetByAll(RetailscmUserContext userContext, String treeNodeId, int treeNodeVersion) throws Exception {
		return forgetByAllInternal(userContext, treeNodeId, treeNodeVersion);
	}
	protected TreeNode forgetByAllInternal(RetailscmUserContext userContext,
			String treeNodeId, int treeNodeVersion) throws Exception{
  ...
  public void sendAllItems(RetailscmUserContext ctx) throws Exception{
    treeNodeDaoOf(ctx).loadAllAsStream().forEach(
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(RetailscmUserContext userContext,SmartList<TreeNode> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 */
 	public Object wxappview(RetailscmUserContext userContext, String treeNodeId) throws Exception{
	  SerializeScope vscope = RetailscmViewScope.getInstance().getTreeNodeDetailScope().clone();
