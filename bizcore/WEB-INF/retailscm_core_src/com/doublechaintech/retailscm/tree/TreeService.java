...
public interface TreeService {
  ...
  default Node loadAncestors(RetailscmUserContext ctx, String nodeId, Class nodeClass)
      throws Exception {
  ...
  Node addChild(RetailscmUserContext ctx, Node tree, String childId, String childType)
      throws Exception;

  default Node addChild(RetailscmUserContext ctx, Node tree, String childId, Class childType)
      throws Exception {
