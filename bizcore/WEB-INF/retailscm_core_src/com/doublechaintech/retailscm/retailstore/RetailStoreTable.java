...
public class RetailStoreTable{
	...
	static final String TABLE_NAME="retail_store_data";
	...
	static final String []ALL_CLOUMNS = {COLUMN_ID, 
		COLUMN_NAME, COLUMN_TELEPHONE, COLUMN_OWNER, COLUMN_RETAIL_STORE_COUNTRY_CENTER, COLUMN_CITY_SERVICE_CENTER, COLUMN_CREATION, COLUMN_INVESTMENT_INVITATION, COLUMN_FRANCHISING, COLUMN_DECORATION, COLUMN_OPENING, COLUMN_CLOSING, COLUMN_FOUNDED, COLUMN_LATITUDE, COLUMN_LONGITUDE, COLUMN_DESCRIPTION, COLUMN_LAST_UPDATE_TIME, COLUMN_CURRENT_STATUS, 
		COLUMN_VERSION};
