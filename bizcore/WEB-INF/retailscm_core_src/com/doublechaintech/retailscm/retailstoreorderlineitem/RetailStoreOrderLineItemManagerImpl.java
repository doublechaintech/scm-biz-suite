...
public class RetailStoreOrderLineItemManagerImpl extends CustomRetailscmCheckerManager implements RetailStoreOrderLineItemManager, BusinessHandler{
	...
	public Object prepareContextForUserApp(BaseUserContext userContext,Object targetUserApp) throws Exception{
	 ...
	 public Object summaryView(RetailscmUserContext userContext, String retailStoreOrderLineItemId) throws Exception{
		RetailStoreOrderLineItem retailStoreOrderLineItem = loadRetailStoreOrderLineItem( userContext, retailStoreOrderLineItemId, viewTokens());
	 ...
	 public Object analyze(RetailscmUserContext userContext, String retailStoreOrderLineItemId) throws Exception{
		RetailStoreOrderLineItem retailStoreOrderLineItem = loadRetailStoreOrderLineItem( userContext, retailStoreOrderLineItemId, analyzeTokens());
		markVisited(userContext, retailStoreOrderLineItem);
  ...
  @Override
  public List<RetailStoreOrderLineItem> searchRetailStoreOrderLineItemList(RetailscmUserContext ctx, RetailStoreOrderLineItemRequest pRequest){
  ...
  @Override
  public RetailStoreOrderLineItem searchRetailStoreOrderLineItem(RetailscmUserContext ctx, RetailStoreOrderLineItemRequest pRequest){
    pRequest.limit(0, 1);
